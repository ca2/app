...
namespace acme
{
   ...
   CLASS_DECL_ACME void black_body(float* r, float* g, float* b, ::u32 dwTemp);
 ...
 /*  bool system::on_application_menu_action(const char * pszCommand)
   ...
   ::e_status system::initialize_system(::matter * pobject, app_core * pappcore)
   {
...
//
//   ::e_status system::initialize_system(::matter* pobjectContext, ::app_core* pappcore)
//   {
//
