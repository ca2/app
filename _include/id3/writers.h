...
class ID3_CPP_EXPORT ID3_OStreamWriter : public ID3_Writer
{
   ...
   pos_type _beg;
protected:
   ::file::file & getWriter() const { return _stream; }
public:
   ID3_OStreamWriter(::file::file& writer) : _stream(writer), _beg(_stream.tellp()) { ; }
...
class ID3_CPP_EXPORT ID3_OFStreamWriter : public ID3_OStreamWriter
{
   ::file::file& _file;
public:
   ID3_OFStreamWriter(::file::file& writer)
...
protected:
   ::file::file & getWriter() const { return _stream; }
public:
   ID3_IOStreamWriter(::file::file & writer) : _stream(writer), _beg(_stream.tellp()) { ; }
...
class ID3_CPP_EXPORT ID3_FStreamWriter : public ID3_IOStreamWriter
{
   ::file::file& _file;
public:
   ID3_FStreamWriter(::file::file& writer)
