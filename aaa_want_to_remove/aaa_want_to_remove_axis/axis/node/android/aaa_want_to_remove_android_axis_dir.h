...
namespace android
{
   ...
   namespace axis
   {
      ...
      public:
         ...
         //         virtual bool  rls_pattern(::aura::application *  papp, const ::string & lpcsz, const ::string & lpcszPattern, string_array * pstraPath = nullptr, string_array * pstraTitle = nullptr, string_array * pstraRelative = nullptr, bool_array * pbaIsDir = nullptr, i64_array * piaSize = nullptr, enum_extract eextract = e_extract_first);
         //         virtual bool  rls(::aura::application *  papp, const ::string & lpcsz, string_array * pstraPath = nullptr, string_array * pstraTitle = nullptr, string_array * pstraRelative = nullptr, enum_extract eextract = e_extract_first);
