...
small_ipc_color::channel_base::small_ipc_color::channel_base()
{
   m_key = 0;
   m_iQueue = -1;
}
...
bool ::aura::ipc::tx::send(const char * pszMessage, DWORD tickTimeout)
{
...
bool ::aura::ipc::tx::send(i32 message, void * pdata, i32 len, DWORD tickTimeout)
{
...
void * small_ipc_rx_channel::on_receive(small_ipc_rx_channel * prxchannel, i32 message, void * pdata, i32 len)
{
