...
//      throw not_implemented();
 ...
 //    throw not_implemented();
  ...
  //    throw not_implemented();
   ...
   bool os::file_extension_get_open_with_list_keys(string_array & straKey, const char * pszExtension)
   {
   //   throw not_implemented();
      return false;
   ...
   bool os::file_extension_get_open_with_list_commands(string_array & straCommand, const char * pszExtension)
   {
  ...
  //    throw not_implemented();
   ...
   bool os::create_service(::object * pobject)
   {
  ...
  //    throw not_implemented();
   ...
   bool os::remove_service(::object * pobject)
   {
   //   throw not_implemented();
      return false;
   ...
   bool os::start_service(::object * pobject)
   {
    //  throw not_implemented();
      return false;
   ...
   bool os::stop_service(::object * pobject)
   {
  //    throw not_implemented();
      return false;
