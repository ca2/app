...
//   }
   ...
   void control::on_control_event(::user::control_event * pevent)
   {
      ...
      //if (pevent->m_puie==this && pevent->m_eevent == e_event::event_button_clicked)
      //{

      //   if (m_ppropertyCheck)
      //   {

      //      _001ToggleCheck(pevent->m_context);
      ...
      if (pform != nullptr)
      {
         ...
         if((::user::interaction *) pform != (::user::interaction *) this)
         {
      ...
      if (puiParent != nullptr && puiParent != pform)
      {
      ...
      if (puiOwner != nullptr && puiOwner != pform && puiOwner != puiParent)
      {
   ...
   //bool control::simple_process_on_cntrosystem_message(::message::message * pmessage, ::user::e_event eevent)
   //{

   //   return user::interaction::simple_process_system_message(pmessage, eevent);
