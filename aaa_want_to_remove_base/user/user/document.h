...
namespace user
{
   ...
   public:
      ...
      virtual bool on_filemanager_open(::filemanager::document * pmanager, var varFile);
      virtual bool on_filemanager_save(::filemanager::document * pmanager, var varFile, bool bReplace = true);
