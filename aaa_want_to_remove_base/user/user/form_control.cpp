...
namespace user
{
   ...
   bool form_control::OnCommandButton(__pointer(control) pcontrol,UINT uiNotificationCode,LPARAM lparam)
   ...
   bool form_control::OnCommandCheckBox(__pointer(control) pcontrol,UINT uiNotificationCode,LPARAM lparam)
   ...
   bool form_control::OnCommandComboBox(__pointer(control) pcontrol,UINT uiNotificationCode,LPARAM lparam)
   ...
   bool form_control::OnCommandEdit(__pointer(control) pcontrol,UINT uiNotificationCode,LPARAM lparam)
   ...
   bool form_control::_001SaveEdit(__pointer(control) pcontrol)
   {
   ...
   void form_control::update(::update * pupdate)
   {
      ...
      for(auto & pdescriptor : m_controldescriptorset.ptra())
      {
         ...
         __pointer(interaction) pcontrol = pdescriptor->m_pusercontrol;
   ...
   void form_control::_001Update(__pointer(control) pcontrol)
   {
      ASSERT(pcontrol != nullptr);
      if(pcontrol == nullptr)
         return;
   ...
   void form_control::_001UpdateDbFlags(__pointer(control) pcontrol)
   {
      ASSERT(pcontrol != nullptr);
      if(pcontrol == nullptr)
         return;
   ...
   void form_control::_001UpdateDbFlagsCheckBox(__pointer(control) pcontrol)
   {
   ...
   void form_control::_001UpdateCheckBox(__pointer(control) pcontrol)
   {
      ASSERT(pcontrol != nullptr);
      if(pcontrol == nullptr)
         return;
   ...
   void form_control::_001UpdateComboBox(__pointer(control) pcontrol)
   {
      ASSERT(pcontrol != nullptr);
      if(pcontrol == nullptr)
         return;
   ...
   void form_control::_001UpdateEdit(__pointer(control) pcontrol)
   {
      ASSERT(pcontrol != nullptr);
      if(pcontrol == nullptr)
         return;
   ...
   void form_control::_001UpdateSimpleList(__pointer(control) pcontrol)
   {
      ASSERT(pcontrol != nullptr);
      if(pcontrol == nullptr)
         return;
   ...
   bool form_control::_001Validate(__pointer(control) pcontrol,var & var)
   {
   ...
   bool form_control::_001OnBeforeSave(__pointer(control) pcontrol)
   {
   ...
   void form_control::data_on_after_change(::message::message * pmessage)
   {

      SCAST_PTR(::database::change_event,pchange,pmessage);

      if (already_handled(pchange->m_pupdate))
      {
   ...
   void form_control::_001OnInitializeForm(__pointer(control) pcontrol)
   {
   ...
   void form_control::_001OnButtonAction(__pointer(control) pcontrol)
   {
   ...
   void form_control::_001OnCreate(::message::message * pmessage)
   {
      ...
      auto pcreate = (::create *) pmessagecreate->m_lpcreatestruct->lpCreateParams;
      
      if(::is_set(pcreate))
      {
       
         m_pcallback = pcreate->m_varArgs["form_callback"].cast < ::user::form_callback >();
   ...
   void form_control::_001FillCombo(__pointer(control) pcontrol)
   {
   ...
   void form_control::on_control_event(::user::control_event * pevent)
   {
      ...
      else if(pevent->m_eevent == ::user::event_set_check && pevent->m_actioncontext.is_user_source())
      {
         ...
         __pointer(control) pcontrol = dynamic_cast <control *> (pevent->m_puie);
   ...
   bool form_control::_001IsPointInside(__pointer(control) pcontrol,point64 point)
   {
   ...
   void form_control::control_get_window_rect(__pointer(control) pcontrol,RECT * prect)
   ...
   void form_control::control_get_client_rect(__pointer(control) pcontrol,RECT * prect)
