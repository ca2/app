...
namespace user
{
   ...
   HACCEL frame_window::GetDefaultAccelerator()
   {
      ...
      HACCEL hAccel;
      __pointer(::user::document) pDoc = GetActiveDocument();
   ...
   void frame_window::BeginModalState()
   {
      ...
      __pointer(::user::interaction) pParent = EnsureTopLevel();
   ...
   void frame_window::_001OnCreate(::message::message * pmessage)
   {
      ...
      if (!(m_ewindowflag & window_flag_window_created))
      {
         ...
         __pointer(::create) pcreate((::create*) pcreatemessage->m_lpcreatestruct->lpCreateParams);
   ...
   void frame_window::OnInitialFrameUpdate(bool bMakeVisible)
   {
      ...
      if (bMakeVisible)
      {
         ...
         if (GetParent() == nullptr || !GetParent()->is_place_holder())
         {
   ...
   */
   ...
   void frame_window::_001OnActivate(::message::message * pmessage)
   {
      ...
      __pointer(::user::frame_window) pTopLevel = (GetStyle() & WS_CHILD) ? this : GetTopLevelFrame();
...
//#endif
   ...
   void frame_window::SetActiveView(::user::impact * pViewNew, bool bNotify)
   {
      ...
      __pointer(frame_window) point = GetParentFrame();

      if (point.is_set())
      {

         point->SetActiveView(pViewNew, bNotify);
   ...
   LRESULT frame_window::OnSetMessageString(WPARAM wParam, LPARAM lParam)
   {
      ...
      if (pMessageBar != nullptr)
      {
         ...
         __pointer(::user::frame_window) pFrameWnd = pMessageBar->GetParentFrame();
...
//    }
   ...
   void frame_window::_000OnDraw(::draw2d::graphics_pointer & pgraphics)
   {
               ...
               && !Session.savings().is_trying_to_save(::aura::resource_memory))
      {
         ...
         pgraphics->fill_rect(0, 0, 100, 100, ARGB(128, 255, 0, 0));
         ...
         pgraphics->fill_rect(0, 100, 100, 100, ARGB(128, 0, 0, 255));
