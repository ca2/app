...
namespace user
{
   ...
   impact_data * impact_host::create_impact(const ::id & id, const ::string & strTitle,  impact_creator * pcreator)
   {
      ...
      catch (exception_pointer e)
      {
         ...
         __pointer(exception) phostexception = e;
...
/*
   ...
   void impact_host::on_remove_child(::user::interaction* pinteraction)
   {
      ...
      __pointer(::experience::updown) pupdown = pinteraction;
      ...
      while(ppair != nullptr)
      {
         ...
         if(!ida.contains(ppair->element1()))
         {
            ...
            try
            {
               ...
               if(ppair->element2()->m_pholder != nullptr)
               {

                  ppair->element2()->m_pholder->display(display_none);
