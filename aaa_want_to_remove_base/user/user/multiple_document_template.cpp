...
namespace user
{
   ...
   void multiple_document_template::on_request(::create * pcreate)
   {
      ...
      if (pdocument == nullptr)
      {
         ...
         // TODO Translate
         System.message_box("failed to create ::user::document");
      ...
      if (pFrame == nullptr)
      {
         ...
         if (strId.find_ci("userex::message_box") < 0)
         {
            ...
            Application.sync_message_box("Failed to create ::user::document");
      ...
      else
      {
         ...
         if(!on_open_document(pdocument, pcreate))
         {
            ...
            pFrame->post_message(message_destroy_window);
            return;
