...
namespace dynamic_source
{
   ...
   public:
      ...
      __composite(::user::message_queue)                m_spqueue;
      ...
      __pointer(script_instance) get(const string & strName);
      ...
      var get_output_internal(::dynamic_source::script_interface * pinstanceParent, const string & strName);
      using thread::run;
