...
extern zipFile CLASS_DECL_ACID zipOpen OF((const char *pathname, i32 append));
/*
  create a zipfile.
...
extern zipFile CLASS_DECL_ACID zipOpen2 OF((const char *pathname,
      i32 append,
      zipcharpc* globalcomment,
      zlib_filefunc_def* pzlib_filefunc_def));

extern i32 CLASS_DECL_ACID zipOpenNewFileInZip OF((zipFile file,
      const char* filename,
...
extern i32 CLASS_DECL_ACID zipOpenNewFileInZip2 OF((zipFile file,
      const char* filename,
      const zip_fileinfo* zipfi,
      const void * extrafield_local,
      u32 size_extrafield_local,
...
extern i32 CLASS_DECL_ACID zipOpenNewFileInZip3 OF((zipFile file,
      const char* filename,
      const zip_fileinfo* zipfi,
      const void * extrafield_local,
      u32 size_extrafield_local,
...
extern i32 CLASS_DECL_ACID zipWriteInFileInZip OF((zipFile file,
      const void * buf,
      u32 len));
/*
...
extern i32 CLASS_DECL_ACID zipCloseFileInZip OF((zipFile file));
/*
  close the current file in the zipfile
*/


extern i32 CLASS_DECL_ACID zipCloseFileInZipRaw OF((zipFile file,
...
extern i32 CLASS_DECL_ACID zipClose OF((zipFile file,
