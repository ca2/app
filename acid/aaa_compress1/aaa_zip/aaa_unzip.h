...
extern i32 CLASS_DECL_ACID unzStringFileNameCompare OF ((const char* fileName1,
...
extern unzFile CLASS_DECL_ACID unzOpen OF((const char *path));
/*
...
extern unzFile CLASS_DECL_ACID unzOpen2 OF((const char *path,
...
extern i32 CLASS_DECL_ACID unzClose OF((unzFile file));
/*
...
extern i32 CLASS_DECL_ACID unzGetGlobalInfo OF((unzFile file,
...
extern i32 CLASS_DECL_ACID unzGetGlobalComment OF((unzFile file,
      char *szComment,
      uptr uSizeBuf));
/*
...
extern i32 CLASS_DECL_ACID unzGoToFirstFile OF((unzFile file));
/*
  set the current file of the zipfile to the first spfile->
  return UNZ_OK if there is no problem
*/

extern i32 CLASS_DECL_ACID unzGoToNextFile OF((unzFile file));
/*
...
extern i32 CLASS_DECL_ACID unzLocateFile OF((unzFile file,
...
extern i32 CLASS_DECL_ACID unzGetFilePos(
unzFile file,
unz_file_pos* file_pos);

extern i32 CLASS_DECL_ACID unzGoToFilePos(
unzFile file,
unz_file_pos* file_pos);

/* ****************************************** */

extern i32 CLASS_DECL_ACID unzGetCurrentFileInfo OF((unzFile file,
...
extern i32 CLASS_DECL_ACID unzOpenCurrentFile OF((unzFile file));
/*
  open for reading data the current file in the zipfile.
  If there is no error, the return value is UNZ_OK.
*/

extern i32 CLASS_DECL_ACID unzOpenCurrentFilePassword OF((unzFile file,
      const char* password));
/*
  open for reading data the current file in the zipfile.
...
extern i32 CLASS_DECL_ACID unzOpenCurrentFile2 OF((unzFile file,
      i32* method,
      i32* level,
      i32 raw));
/*
...
extern i32 CLASS_DECL_ACID unzOpenCurrentFile3 OF((unzFile file,
      i32* method,
      i32* level,
      i32 raw,
      const char* password));
...
extern i32 CLASS_DECL_ACID unzCloseCurrentFile OF((unzFile file));
/*
  close the file in zip opened with unzOpenCurrentFile
  Return UNZ_CRCERROR if all the file was read but the CRC is not good
*/

extern i32 CLASS_DECL_ACID unzReadCurrentFile OF((unzFile file,
      voidp buf,
      u32 len));
/*
...
extern iptr CLASS_DECL_ACID unztell OF((unzFile file));
/*
  Give the current position in uncompressed data
*/

extern i32 CLASS_DECL_ACID unzeof OF((unzFile file));
/*
  return 1 if the end of file was reached, 0 elsewhere
*/

extern i32 CLASS_DECL_ACID unzGetLocalExtrafield OF((unzFile file,
      voidp buf,
      u32 len));
/*
