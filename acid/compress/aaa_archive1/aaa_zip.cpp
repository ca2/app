...
/************************************************************/
extern zipFile CLASS_DECL_ACID zipOpen2 (
const char *pathname,
i32 append,
...
extern zipFile CLASS_DECL_ACID zipOpen (
const char *pathname,
i32 append)
{
...
extern i32 CLASS_DECL_ACID zipOpenNewFileInZip3 (
zipFile file,
const char* filename,
...
extern i32 CLASS_DECL_ACID zipOpenNewFileInZip2(
zipFile file,
const char* filename,
const zip_fileinfo* zipfi,
const void * extrafield_local,
...
extern i32 CLASS_DECL_ACID zipOpenNewFileInZip (
zipFile file,
const char* filename,
const zip_fileinfo* zipfi,
const void * extrafield_local,
...
extern i32 CLASS_DECL_ACID zipWriteInFileInZip (
zipFile file,
const void * buf,
u32 len)
{
...
extern i32 CLASS_DECL_ACID zipCloseFileInZipRaw (
zipFile file,
...
extern i32 CLASS_DECL_ACID zipCloseFileInZip (
zipFile file)
{
   return zipCloseFileInZipRaw (file,0,0);
}

extern i32 CLASS_DECL_ACID zipClose (
zipFile file,
