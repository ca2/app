...
//bool CLASS_DECL_ACID succeeded(const ::e_status & estatus);
//bool CLASS_DECL_ACID status_succeeded(i64 i);
//bool CLASS_DECL_ACID failed(const ::e_status & estatus);
//bool CLASS_DECL_ACID status_failed(i64 i);
...
#ifndef CLASS_DECL_ACID
#define CLASS_DECL_ACID
#endif // CLASS_DECL_ACID
