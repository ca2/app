...
namespace winrt
{
   ...
   rsa::rsa(const string& nParam)
   {
      ...
      ::winrt::Windows::Security::Cryptography::Core::AsymmetricKeyAlgorithmProvider::OpenAlgorithm(::winrt::Windows::Security::Cryptography::Core::AsymmetricAlgorithmNames::RsaPkcs1);
      ...
      //strRsaPrivateKey += chunk_split(::apexacesystem()->base64().encode(memKey));
      ...
      m_pkey = cipher->ImportPublicKey(memfile.get_memory()->get_os_crypt_buffer(), ::winrt::Windows::Security::Cryptography::Core::CryptographicPublicKeyBlobType::BCryptPublicKey);
...
::pointer<::crypto::rsa>__create_rsa(const string& str)
{
   ...
   return __allocate< ::winrt::rsa >(str);
