...
CLASS_DECL_ACID bool should_avoid_parsing_exception();
CLASS_DECL_ACID bool throw_parsing_exception(const ::scoped_string & scopedstrMessage);




CLASS_DECL_ACID bool throw_network_payload_parsing_exception(const ::scoped_string & scopedstrMessage);


CLASS_DECL_ACID void get_call_stack_frames(void ** stack, int & c);
...
CLASS_DECL_ACID bool __assert_failed_line(const ::ansi_character * pszFileName, int nLine);

CLASS_DECL_ACID void __assert_particle_ok(const ::particle * pparticle, const ::ansi_character * pszFileName, i32 nLine);

//CLASS_DECL_ACID void __dump(const ::particle * pparticle);
