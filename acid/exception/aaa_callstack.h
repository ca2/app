...
//class CLASS_DECL_ACID callstack :
...
//#if defined(ANDROID)
//CLASS_DECL_ACID string unwind_callstack(const ::scoped_string & scopedstrFormat = callstack_default_format(), i32 iSkip = CALLSTACK_DEFAULT_SKIP_TRIGGER, int iCount = -1);
//#else
//CLASS_DECL_ACID string get_callstack(const ::scoped_string & scopedstrFormat = callstack_default_format(), i32 iSkip = CALLSTACK_DEFAULT_SKIP_TRIGGER, void * caller_address = nullptr, int iCount = -1);
//#endif
