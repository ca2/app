...
//    informationf("parsing_exception");
...
CLASS_DECL_ACID bool get_avoid_parsing_exception()
{
...
CLASS_DECL_ACID void set_avoid_parsing_exception(bool bSet)
{
...
CLASS_DECL_ACID bool throw_parsing_exception(const ::string & strMessage)
{
...
CLASS_DECL_ACID bool throw_network_payload_parsing_exception(const ::string & strMessage)
{
