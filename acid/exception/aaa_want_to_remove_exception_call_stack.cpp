...
callstack::callstack(const ::scoped_string & scopedstrFormat, i32 iSkip, void * address, int iCount) :
...
CLASS_DECL_ACID ::pointer<callstack>get_callstack(e_callstack ecallstack, int iCallStackAddUp)
{
...
CLASS_DECL_ACID void set_callstack_mask(cflag < e_callstack > ecallstack)
{
...
CLASS_DECL_ACID e_callstack get_callstack_mask()
{
...
//CLASS_DECL_ACID bool is_callstack_enabled(e_callstack ecallstack)
//{
//
