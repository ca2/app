...
//CLASS_DECL_ACID void get_call_stack_frames(void** stack, int & frame_count)
//{
//
...
//
//
//CLASS_DECL_ACID ::string get_call_stack_trace(void ** stack, int c, const char* pszFormat)
//{
//
