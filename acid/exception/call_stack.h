...
class CLASS_DECL_ACID call_stack :
   public ::matter
{
public:
   ...
   call_stack(const ::scoped_string & scopedstrFormat = default_format(), i32 iSkip = CALL_STACK_DEFAULT_SKIP_TRIGGER, void * caller_address = nullptr, int iCount = -1);
   virtual ~call_stack();
   ...
   const char * get_dup(const ::scoped_string & scopedstrFormat = default_format(), i32 uiSkip = CALL_STACK_DEFAULT_SKIP_TRIGGER, int iCount = -1);
