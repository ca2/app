...
//#include "exception.h"
//#include "callstack.h"
//#include "acid/primitive/string/as_string.h"
...
//{
   ...
   // CLASS_DECL_ACID void throw_interface_only(const ::scoped_string & scopedstrMessage)
   // {
   ...
   // CLASS_DECL_ACID void throw_not_implemented(const ::scoped_string & scopedstrMessage)
   // {
...
//CLASS_DECL_ACID ::pointer<::exception>__trace_context_move_throw_exception(::matter * trace_context, ::exception * pexceptionNew)
//{
//
...
// CLASS_DECL_ACID bool avoid_bad_status_exception()
// {
...
// CLASS_DECL_ACID void set_avoid_bad_status_exception(bool bSet)
// {
...
//
//CLASS_DECL_ACID void throw_exception(const ::e_status & estatus, const ::scoped_string & scopedstrMessage, const ::scoped_string & scopedstrDetails, i32 iSkip, void * caller_address)
//{
//
...
CLASS_DECL_ACID void exception_message_box(::particle * pparticle, ::exception & exception, const ::string & strMoreDetails)
{
   ...
   auto pacenode = pparticle->node();

   auto processid = pacenode->current_process_identifier();
...
CLASS_DECL_ACID void throw_exception(const ::e_status & estatus, const ::scoped_string & scopedstrMessage, const ::scoped_string & scopedstrDetails, i32 iSkip)
{
...
CLASS_DECL_ACID void throw_exception(const ::e_status & estatus)
{
...
CLASS_DECL_ACID void copy(::string& str, const ::exception& exception)
{
