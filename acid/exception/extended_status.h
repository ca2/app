...
CLASS_DECL_ACID const char * status_short_description(const ::e_status & estatus);
...
CLASS_DECL_ACID ::pointer<::exception>__trace_context_move_throw_exception(::particle * pparticle, ::exception * pexceptionNew);
