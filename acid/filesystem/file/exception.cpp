...
CLASS_DECL_ACID void get_message(::string & strMessage, const ::error_code & errorcode);
...
namespace file
{
   ...
   static const char szUnknown[] = "unknown";
      ...
      //CLASS_DECL_ACID bool should_ignore_file_exception_callstack(const ::e_status & estatus)
      //{
