...
#include "acid/primitive/primitive/memory_container.h"
#include "file.h"
...
class CLASS_DECL_ACID memory_file :
...
//class CLASS_DECL_ACID memory_stream :
//   public binary_stream
//{
//public:
//
//
//   memory_stream() : binary_stream(__allocate< ::memory_file >()) {}
//   memory_stream(::memory_base & memory) : binary_stream(__allocate< ::memory_file >(memory)) {}
//
