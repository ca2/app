...
#include "acid/filesystem/file/plain_text_file_options.h"
...
CLASS_DECL_ACID void set_bypass_cache_if_empty(::payload & payloadFile);
CLASS_DECL_ACID bool get_bypass_cache_if_empty(const ::payload & payloadFile);
