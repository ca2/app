...
#include "framework.h"
#include "ace_file.h"
//#include "acid/networking/as_string.h"
...
CLASS_DECL_ACID string solve_relative(const ::string & strParam, bool * pbUrl)
{
...
//CLASS_DECL_ACID bool read_resource_as_file(const ::scoped_string & scopedstrFile,HINSTANCE hinst,::u32 nID,LPCTSTR pcszType);
