...
#include "acid/platform/scoped_restore.h"
...
CLASS_DECL_ACID bool matches_wildcard_criteria(const string_array & straCriteria, const ::string & strValue)
{
...
CLASS_DECL_ACID bool matches_wildcard_criteria_ci(const string_array & straCriteria, const ::string & strValue)
{
...
CLASS_DECL_ACID string normalize_wildcard_criteria(const ::string & strPattern)
{
