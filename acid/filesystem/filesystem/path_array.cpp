...
CLASS_DECL_ACID ::file::path_array & ascendants_path(const ::file::path & path, ::file::path_array & pathaFolder, ::file::path_array * ppathaRelative)
...
CLASS_DECL_ACID ::file::path_array & ascendants_path(::file::path_array & patha, const ::file::path & pathParam)
{
...
CLASS_DECL_ACID ::string_array & ascendants_name(::string_array & stra, const ::file::path & pathParam)
{
