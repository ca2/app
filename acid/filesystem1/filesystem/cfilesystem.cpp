// From acid/filesystem/file/_.cpp by camilo on 2021-08-09 
// From ace_windows/ace_file.cpp
// 04:38 BRT <3ThomasBorregaardSorensen
#include "../../../acid/framework.h"
#include "../../../acid/filesystem/filesystem/ace_file.h"
#include "ace_directory.h"
...
#include "../../../acid/exception/io.h"
#include "../../../acid/filesystem/file/file.h"
#include "../../../acid/filesystem/file/memory_map.h"
#include "../../../acid/platform/ini.h"
...
CLASS_DECL_ACID void exception_message_box(::particle * pparticle, ::exception & exception, const ::string & strMoreDetails);
...
void ace_file::ensure_exists(const ::file::path & path)
{
...
void ace_file::touch(const ::file::path & path)
{
...
void ace_file::touch_app_cloud(const ::file::path & path, const char * pszContentIdentifier)
{
...
void ace_file::clear_read_only(const ::file::path & path)
{
...
void ace_file::set_file_normal(const ::file::path & path)
{
...
bool ace_file::is_equal(const ::file::path & path1, const ::file::path & path2)
{
...
void ace_file::overwrite_if_different(const ::file::path & pathTarget, const ::file::path & pathSource)
{
...
file_pointer ace_file::get_file(const ::payload& payloadFile, ::file::e_open eopen, ::pointer < ::file::exception >* pfileexception)
{
   ...
   auto path = acepath()->defer_process_relative_path(pathFile);
...
file_pointer ace_file::get_reader(const ::payload& payloadFile, ::file::e_open eopen, ::pointer < ::file::exception >* pfileexception)
{
...
file_pointer ace_file::get_writer(const ::payload& payloadFile, ::file::e_open eopen, ::pointer < ::file::exception >* pfileexception)
{
...
string ace_file::as_string(const ::file::path & pathParam, strsize iReadAtMostByteCount, bool bNoExceptionIfNotFound)
{
   ...
   //auto path = acepath()->defer_process_relative_path(pathParam);
...
string ace_file::safe_get_string(const ::file::path & pathParam, strsize iReadAtMostByteCount, bool bNoExceptionIfNotFound)
{
...
string ace_file::get_temporary_file_name(const ::scoped_string & scopedstrName, const ::scoped_string & scopedstrExtension)
{
...
//void ace_file::write_memory_to_file(FILE * file, const void * pdata, memsize nCount, memsize * puiWritten)
//{
//
//   throw interface_only();
//
...
void ace_file::append(const ::file::path & pathFile, const block & block)
{

   ace_file::append_wait(pathFile, block, 0_s);

}


bool ace_file::exists(const ::file::path & pathParam)
{
...
//void ace_file::put_contents(const ::file::path & path, const ::scoped_string & scopedstr)
//{
//
//   throw ::interface_only();
//
...
void ace_file::get_temporary_file_name_template(char * szRet, strsize iBufferSize, const ::scoped_string & scopedstrName, const ::scoped_string & scopedstrExtension, const ::scoped_string & scopedstrTemplate)
{
...
filesize ace_file::get_size(const ::file::path & path)
{
...
filesize ace_file::get_size_fd(int iFile)
{
...
void ace_file::clear_application_data()
{
...
void ace_file::find_replace(const ::file::path & path, const ::property_set & set)
{
...
void ace_file::put_app_cloud_data(const ::file::path & path, const char * pszContentIdentifier, const ::block & block)
{
   
   auto pathAppCloud = acepath()->defer_get_icloud_container_path(path, pszContentIdentifier);
...
::memory ace_file::get_app_cloud_data(const ::file::path & path, const char * pszContentIdentifier)
{
...
bool ace_file::is_true(const ::file::path & path)
{
...
void ace_file::set_size(const ::file::path & pathName, filesize size)
{
...
void ace_file::set_size(int iFileDescriptor, filesize size)
{
...
//void ace_file::set_size(FILE * pfile, filesize size)
//{
//
//   throw ::interface_only();
//
...
void ace_file::transfer(const ::file::path & pathNewName, const ::file::path & pathOldName)
{
...
void ace_file::erase(const ::file::path & pathParam)
{
...
void ace_file::defer_erase(const ::file::path& path)
{
...
bool ace_file::safe_erase(const ::file::path& path)
{
...
void ace_file::copy(const ::file::path & pathNew, const ::file::path & pathExisting, bool bOverwrite)
{

   if (acedirectory()->is(pathExisting))
   {
      ...
      acedirectory()->create(pathNew);

      ::file::listing listing;

      listing.set_listing(pathExisting, e_depth_recursively);

      acedirectory()->enumerate(listing);
      ...
      for (i32 i = 0; i < listing.size(); i++)
      {
         ...
         if (acedirectory()->is(strSrc))
         {

            acedirectory()->create(strDst);

         }
         else
         {

            if (!acedirectory()->is(strDst.folder()))
            {

               acedirectory()->create(strDst.folder());
...
void ace_file::_copy(const ::file::path & pathDup, const ::file::path & pathSrc, bool bOverwrite)
{
...
bool ace_file::text_is_different(const ::file::path & path1, const ::file::path & path2, ::string * pstr1, ::string * pstr2)
{
...
bool ace_file::copy_if_text_is_different(const ::file::path & pathTarget, const ::file::path & pathSource, const ::procedure & procedureRunIfFilesAreDifferentAndAfterCopy)
{
...
bool ace_file::_memory_map_file_copy(const ::file::path & pathTarget, const ::file::path & pathSource)
{
...
void ace_file::_read_write_file_copy(const ::file::path & pathTarget, const ::file::path & pathSource, ::memsize sizeBuffer)
{
...
class ::time ace_file::modification_time(const ::file::path & path)
{
...
void ace_file::set_modification_time(const ::file::path & path, const class ::time& time)
{
...
//
//::time ace_file::modification_time(const ::file::path & path)
//{
//
//   throw ::interface_only();
//
...
void ace_file::synchronize(const ::file::path & path1, const ::file::path & path2)
{
...
void ace_file::save_stra(const ::file::path & pathName, const string_array & stra)
{
...
void ace_file::load_stra(const ::file::path & pathName, string_array & stra, bool bAddEmpty)
{
...
void ace_file::put_contents(const ::file::path & path, const memory_base & memory)
{
...
void ace_file::put_contents(const ::file::path & path, const ::scoped_string & scopedstrContents)
{
...
void ace_file::put_block(const ::file::path & path, const block & block)
{
...
void ace_file::put_now(const ::file::path& path)
{
...
void ace_file::put_time(const ::file::path& path, const ::earth::time& time)
{
...
::earth::time ace_file::as_time(const ::file::path& path)
{
...
::earth::time ace_file::safe_time(const ::file::path& path)
{
...
void ace_file::as_block(block & block, const ::file::path & path)
{
...
string ace_file::first_line(const ::file::path & path)
{
...
string_array ace_file::lines(const ::file::path & pathParam)
{
...
void ace_file::set_line(const ::file::path & pathParam, ::collection::index iLine, const ::scoped_string & scopedstrLine)
{
   ...
   m_pacedirectory->create(path.folder());
...
//string ace_file::get_temporary_file_name(const ::scope_string & strName, const ::scoped_string & scopedstrExtension)
//{
//
//#ifdef WINDOWS
//
...
//void ace_file::write(FILE * file, const void * pdata, memsize nCount, memsize * puiWritten)
//{
//
//#if OSBIT > 32
//
...
void ace_file::append(const ::string & strFile, const block & block)
{
...
bool ace_file::_exists(const ::file::path & path)
{
...
void ace_file::_erase(const ::file::path & path)
{
...
::file::path ace_file::time_put_contents(const ::file::path& pathFolder, const ::string& strPrefix, const ::string& strExtension, const ::string& str)
{
...
::pointer<::handle::ini>ace_file::get_ini(const ::payload & payloadFile)
{
...
::property_set ace_file::parse_standard_configuration(const ::payload & payloadFile)
{
