...
#include "../../../acid/filesystem/filesystem/link.h"
...
::string ace_path::icloud_container_identifier(const char * psz_iCloudContainerIdentifier)
{
...
//::string ace_path::icloud_container_id_from_app_id(const char * pszAppId)
//{
//   
...
::file::path ace_path::defer_get_icloud_container_path(const ::file::path & path, const char * pszAppId)
{
   
   if(acedirectory()->is_icloud_container(path, pszAppId))
   {
   ...
   return acedirectory()->icloud_container2(pszAppId) / path;
   
}


void ace_path::defer_get_icloud_container_path_name(::string & strName, ::string & str_iCloudContainerIdentifier, const ::file::path & path)
{
   
   str_iCloudContainerIdentifier = icloud_container_identifier(str_iCloudContainerIdentifier);
   
   if(!acedirectory()->is_icloud_container(path, str_iCloudContainerIdentifier))
   {
   ...
   strName.begins_eat(acedirectory()->icloud_container2(str_iCloudContainerIdentifier));
...
string ace_path::from(string str)
{
...
//bool ace_path::final_is_same(const ::file::path & path1, const ::file::path & path2)
//{
//
...
void ace_path::safe_real_path(::file::path & path)
{
...
::file::path ace_path::get_uniform_resource_locator(const ::file::path& path)
{
...
::file::path ace_path::safe_get_real_path(const ::file::path & path)
{
...
::file::path ace_path::_safe_real_path(const ::file::path & path)
{
...
::file::path ace_path::real_path(const ::file::path & path)
{
...
::file::path ace_path::_real_path(const ::file::path & path)
{
...
bool ace_path::case_insensitive_real_path_begins_eat(string & str, const ::scoped_string & scopedstrPrefix)
{
   ...
   else
   {
      ...
      strFull = acepath()->real_path(str);

      string strFullPath;

      strFullPath = acepath()->real_path(strPath);
...
bool ace_path::real_path_is_same(const ::file::path & path1, const ::file::path & path2)
{
...
::file::enum_type ace_path::get_type(const ::file::path & path)
{
...
::file::enum_type ace_path::safe_get_type(const ::file::path & path)
{
...
void ace_path::create_symbolic_link(const ::scoped_string & scopedstrLink, const ::scoped_string & scopedstrSource)
{
...
bool ace_path::is_symbolic_link(const ::scoped_string & scopedstrLink)
{
...
::file::path ace_path::symbolic_link_destination(const ::scoped_string & scopedstrLink)
{
...
bool ace_path::has_custom_icon(const ::file::path & path)
{
...
::file::path ace_path::defer_process_relative_path(const ::file::path & path, const ::file::path & pathFolderParam)
{
   ...
   if(pathFolder.is_empty())
   {
      ...
      pathFolder = m_pacedirectory->m_pathFolder;
...
bool ace_path::defer_process_protocol_path(::file::path & path)
{
...
::file::path ace_path::get_absolute_path(const ::scoped_string& scopedstr)
{
...
bool ace_path::is_absolute_path(const ::scoped_string & scopedstr)
{
...
::pointer < ::file::link > ace_path::resolve_link(const ::file::path &path, ::file::e_link elink)
{
   
   if(path.case_insensitive_ends(".desktop"))
   {

      auto stra = acefile()->lines(path);
...
void ace_path::rename(const ::file::path& pathNewName, const ::file::path& pathOldName)
{
...
::file::path ace_path::get_sequence_path(const ::file::path& path, ::collection::index iSequence, int iZeroPaddingWidth)
{
...
void ace_path::defer_free_name_by_renaming_to_last_in_sequence(const ::file::path& path, int iZeroPaddingWidth)
{
...
::file::e_type ace_path::executable_type(const ::file::path & path)
{
...
void ace_path::determine_executable(::file::path & path)
{
...
::file::path ace_path::defer_apply_working_directory(const ::file::path &path, const ::file::path &working_directory)
{
...
::file::path ace_path::_path_get_path(const scoped_string & scopedstrCommand, const ::scoped_string & scopedstrPath, string_to_string_lookup * plookupEnvironment)
{
...
//   }
   ...
   while(get_next_path(next_path, pathRange))
   {
      ...
      else if (pathProposed.m_etype & ::file::e_type_doesnt_exist)
      {
         ...
         if (acedirectory()->is_accessible(pathProposed.folder()))
         {
...
::string ace_path::get_default_path()
{
...
bool ace_path::get_next_path(::scoped_string & scopedstr, ::string::RANGE & rangePath)
{
...
::file::path ace_path::path_get_path(const scoped_string & scopedstrCommand, string_to_string_lookup * plookupEnvironment)
{
...
::file::path ace_path::path_try_get_path(const scoped_string & scopedstrCommand, string_to_string_lookup * plookupEnvironment)
{
...
::file::path ace_path::windows_posix_path(const ::file::path & path)
{
