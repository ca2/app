...
namespace color
{
   ...
   */
   ...
   void color::get_hls(double & h, double & l, double & s) const
   {
      ...
      if(dHParam > 1.0)
      {
         ::acid::get()->platform()->informationf("dHParam > 1.0");
      }
      if(dLParam > 1.0)
      {
         ::acid::get()->platform()->informationf("dLParam > 1.0");
      }
      if(dSParam > 1.0)
      {
         ::acid::get()->platform()->informationf("dSParam > 1.0");
      }
      */
...
CLASS_DECL_ACID::color::color _020GetColor(::collection::index i)
{
...
CLASS_DECL_ACID::color::color as_color(const ::scoped_string& scopedstr)
{
