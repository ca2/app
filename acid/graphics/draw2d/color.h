...
#include "color32.h"
#include "opacity.h"
#include "acid/graphics/image/color_indexes.h"
...
//color(const ::color::color & color) { this->m_u32 =h color.m_u32;  m_flags = color.m_flags; }
   ...
   CLASS_DECL_ACID extern color transparent;
   CLASS_DECL_ACID extern color black;
   CLASS_DECL_ACID extern color red;
   CLASS_DECL_ACID extern color green;
   CLASS_DECL_ACID extern color blue;
   CLASS_DECL_ACID extern color yellow;
   CLASS_DECL_ACID extern color cyan;
   CLASS_DECL_ACID extern color magenta;
   CLASS_DECL_ACID extern color gray;
   CLASS_DECL_ACID extern color white;
...
//CLASS_DECL_ACID   ::color::color RGB_color(unsigned char r, unsigned char g, unsigned char b);

// Returns a color value from red, green, blue values. Alpha will be set to 1.0f.
//CLASS_DECL_ACID ::color::color RGBf_color(float r, float g, float b);

// Returns a color value from red, green, blue and m_u8Opacity values.
//CLASS_DECL_ACID ::color::color RGBA_color(unsigned char r, unsigned char g, unsigned char b, unsigned char a);

// Returns a color value from red, green, blue and m_u8Opacity values.
//CLASS_DECL_ACID::color::color RGBAf_color(float r, float g, float b, float a);

// Linearly interpolates from color c0 to c1, and returns resulting color value.
CLASS_DECL_ACID::color::color LerpRGBA_color(color c0, color c1, float u);

// Sets transparency of a color value.
CLASS_DECL_ACID::color::color TransRGBA_color(color c0, unsigned char a);

// Sets transparency of a color value.
CLASS_DECL_ACID::color::color TransRGBAf(color c0, float a);

// Returns color value specified by hue, saturation and lightness.
// HSL values are all in range [0..1], m_u8Opacity will be set to 255.
CLASS_DECL_ACID::color::color HSL_color(float h, float s, float l);
...
CLASS_DECL_ACID ::color::color HSLA_color(float h, float s, float l, unsigned char a);
...
//CLASS_DECL_ACID void __exchange(::stream & s, ::color::color & color);
//
//
//
//CLASS_DECL_ACID void __exchange(::stream & s, ::color::hls & hls);


CLASS_DECL_ACID ::payload & assign(::payload & payload, const ::color::hls & hls);
