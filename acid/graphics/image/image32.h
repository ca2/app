...
CLASS_DECL_ACID void vertical_swap_copy_image32(::image32_t * pimage32Dst, int cx, int cy, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc);
CLASS_DECL_ACID void copy_image32(::image32_t * pimage32Dst, int cx, int cy, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc);
CLASS_DECL_ACID void copy_image32(::image32_t * pimage32Dst, int x, int y, int cx, int cy, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc);
...
CLASS_DECL_ACID void vertical_swap(pixmap * ppixmap);
CLASS_DECL_ACID void vertical_swap_copy_image32(::image32_t * pimage32Dst, int cx, int cy, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc = -1);
CLASS_DECL_ACID void vertical_swap_copy_image32_swap_red_blue(::image32_t * pimage32Dst, int cx, int cy, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc = -1);
CLASS_DECL_ACID void copy_image32(::image32_t * pimage32Dst, int cx, int cy, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc = -1);
CLASS_DECL_ACID void copy_image32(::image32_t * pimage32Dst, int x, int y, int cx, int cy, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc = -1);
CLASS_DECL_ACID void copy_image32(::image32_t * pimage32Dst, const size_i32 & size, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc = -1);
CLASS_DECL_ACID void copy_image32(::image32_t * pimage32Dst, const ::point_i32 & point, const size_i32 & size, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc = -1);
CLASS_DECL_ACID void copy_image32(::image32_t * pimage32Dst, const ::rectangle_i32 & rectangle, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc = -1);
CLASS_DECL_ACID void copy_image32_swap_red_blue(::image32_t * pimage32Dst, int cx, int cy, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc = -1);
CLASS_DECL_ACID void _001ProperCopyColorref(::image32_t * pimage32Dst, int cx, int cy, int iStrideDst, const ::image32_t * pimage32Src, int iStrideSrc = -1);
...
namespace draw2d
{
   ...
   CLASS_DECL_ACID void image_copy(::image * imagethis, ::image * pimage);
   CLASS_DECL_ACID void image_create(::particle * pparticle, ::image *& image);
   CLASS_DECL_ACID void image_create_image(::image * pimage, const size_i32 & size);
   CLASS_DECL_ACID unsigned int * image_get_data(::image * pimage);
   CLASS_DECL_ACID graphics * image_get_graphics(::image * pimage);
