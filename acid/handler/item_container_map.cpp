// From acid/user/user/container.h by camilo on 2023-07-21 12:33 <3ThomasBorregaardSorensen!!
...
::pointer < ::item_container > item_container_map::item_container(::collection::index iId)
{
