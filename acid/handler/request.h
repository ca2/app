...
#include "acid/user/user/e_window_flag.h"
...
#include "acid/graphics/graphics/output_purpose.h"


class CLASS_DECL_ACID request :
...
public:
   ...
   ::pointer<::acid::context>       m_pcontextFork;
   string                           m_strExe;
   string                           m_strApp;
   string                           m_strAppType;
   ...
   ::acid::application * create_get_app(::acid::application * pappFallback = nullptr);
