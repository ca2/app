...
#include "acid/platform/_main_hold_base.h"
...
//#else
//   ::static_object_factory < ::acid::system > m_factorySystem{ ::system_setup::flag_system };
//#endif
...
////#ifdef SYSTEM_NAMESPACE
////         //::static_object_factory < ::SYSTEM_NAMESPACE::system > m_factorySystem{ ::system_setup::flag_system };
////      factory()->add_factory_item< ::SYSTEM_NAMESPACE::system, ::acid::system >();
////#else
