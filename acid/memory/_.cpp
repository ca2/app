...
CLASS_DECL_ACID void * memory_transfer(void * dst, const void * src, memsize iSize)
{
...
CLASS_DECL_ACID void * memory_set(void * p, i32 i, memsize iSize)
{
...
CLASS_DECL_ACID void * memory_and(void * p, const void * p1, const void * p2, memsize iSize)
{
...
CLASS_DECL_ACID void * memory_copy(void * dst, const void * src, memsize iSize)
{
...
CLASS_DECL_ACID::std::strong_ordering memory_order(const void * p1, const void * p2, memsize iLen)
{
...
CLASS_DECL_ACID::wide_character * wide_memory_copy(::wide_character * dst, const ::wide_character * src, memsize iSize)
{
...
CLASS_DECL_ACID void * reverse_memory(void * p, memsize iLen)
{
...
CLASS_DECL_ACID void * reverse_memory_copy(void * dst, const void * src, memsize size)
{
