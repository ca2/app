...
CLASS_DECL_ACID const void * memory_find(const void* l, memsize l_len, const void* s, memsize s_len);
...
CLASS_DECL_ACID void * memory_and(void * p, const void * point1, const void * point2, memsize iSize);
...
CLASS_DECL_ACID void * reverse_memory(void * p, memsize iSize);
CLASS_DECL_ACID void * reverse_memory_copy(void * p, const void * point1, memsize iSize);


CLASS_DECL_ACID::std::strong_ordering memory_order(const void * sz1, const void * sz2, memsize iSize);
