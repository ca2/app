...
CLASS_DECL_ACID void * x86_memory_pool_alloc(memsize s);
CLASS_DECL_ACID void x86_memory_pool_freec(void * p);


class CLASS_DECL_ACID x86_oriented_memory_allocator
{
public:
   ...
   void * alloc(int iSize)
   {
      ...
      return ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(iSize);
...
public:
   ...
   static x86_cache_oriented_memory_pool * new_pool()
   {
      ...
      void * p = ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(iSize * 2);
   ...
   {
      ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free(p->m_p);
   }
   ...
   void * alloc(::collection::count c)
   {
      ...
      {
         pb = (::u8 *) ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(c);
...
CLASS_DECL_ACID x86_cache_oriented_memory_pool * x86_cache_oriented_get_thread_memory_pool()
{
