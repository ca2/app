...
//
//
//CLASS_DECL_ACID void * ace_memory_realloc(void * pParam, memsize s)
//{
//
//
//#if OSBIT == 32
...
//
//
//CLASS_DECL_ACID void ace_memory_free(void * pParam)
//{
//
//   u8 * pdata = (u8 *)pParam;
//
...
//
//
//CLASS_DECL_ACID memsize ace_memory_size(void * pParam)
//{
//
...
void operator delete(void * ptr, std::align_val_t) noexcept
{
   ...
   ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free(ptr);
