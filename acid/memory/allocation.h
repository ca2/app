...
//CLASS_DECL_ACID void * ace_memory_alloc(memsize s);
//CLASS_DECL_ACID void * ace_memory_realloc(void * p, memsize s);
//CLASS_DECL_ACID void    ace_memory_free(void * p);
//CLASS_DECL_ACID memsize  ace_memory_size(void * p);



//CLASS_DECL_ACID void  ace_set_alloc(PFN_MEMORY_ALLOC palloc, PFN_MEMORY_REALLOC prealloc, PFN_MEMORY_FREE pfree, PFN_MEMORY_SIZE psize);
