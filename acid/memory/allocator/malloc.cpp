...
namespace heap
{
   ...
   void malloc_allocator::initialize_allocator(::acid::acid * pace)
   {
   ...
   void malloc_allocator::check_bounds(u8 * p)
   {
      ...
      if (memory_order(&p[sizeof(uptr)], a, sizeof(a)) != 0)
      {
         ...
         m_pace->m_pplatform->informationf("memory corruption before allocation");
      ...
      if (memory_order(&p[sizeof(uptr) + 256 + *pinteraction], a, sizeof(a)) != 0)
      {
         ...
         m_pace->m_pplatform->informationf("memory corruption after allocation");
