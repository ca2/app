...
///CLASS_DECL_ACID ::file::path memory_counter_base_path(::matter * pmatter);


//CLASS_DECL_ACID void initialize_memory_counter();
//CLASS_DECL_ACID void finalize_memory_counter();
//CLASS_DECL_ACID ::memory_counter * get_memory_counter();
