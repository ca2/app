...
//   {
//
//      ::collection::count c = get_mem_info(&piUse, &pszFile, &pszCallStack, &puiLine, &psize);
//
//      memblocka bla;
//
//      int j;
...
//
//   auto pacedirectory = this->platform()->acedirectory();
//
//   this->platform()->acefile()->put_contents(pacedirectory->system() / "m.html", get_mem_info_report1());
//
//}
//
//#undef print
