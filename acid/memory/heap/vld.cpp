...
//
//
//#define ALIGN_BYTE_COUNT (sizeof(memsize) * 2)
//
//
//#else
//
//
////#define ALIGN_BYTE_COUNT (sizeof(memsize))
//
...
//   }
//
//   ::acid::set_maximum(pblock->m_uiLine);
//
...
//   {
//
//      void * pusermessage = g_pheap->alloc_debug(heap_memory::aligned_provision_get_size(size), nBlockUse, szFileName, nLine);
//
//      if (pusermessage == nullptr)
//      {
//
...
//#if !defined(MCHECK)
//
//#undef ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate
//
//void * ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(memsize size)
//{
//
...
//{
//
//   return ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(size * bytes);
//
//}
//
//
...
//#if !defined(MCHECK) && !defined(__VLD) && !defined(__MCRTDBG)
//
//void ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free(void * pmemory)
//{
//
...
//
//   ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free(pmemory);
//
//#elif MEMDLEAK
//   memdleak_block * pblock = &((memdleak_block *)pmemory)[-1];
//
...
//   {
//
//      ::acid::get()->platform()->informationf("wrong free");
//
//   }
//#endif
//
...
//
//
//void * memory_reallocate(void * p, memsize nSize)
//{
//
...
//
//
//void * memory_reallocate_debug(void * p, memsize size, i32 nBlockUse, const char * szFileName, i32 nLine)
//{
//
//
...
//}
//
//void ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free(void * p)
//{
...
//{
//
//   ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free(pvoid);
//
//}
//
//
