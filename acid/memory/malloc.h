...
namespace acid
{
   ...
   public:
      ...
      POINTER calloc(::collection::count c)
      {
   ...
   public:
      ...
      POINTER alloc(size_t size)
      {
         ...
         if (m_p != nullptr)
         {
            ...
            m_p = (POINTER) ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->reallocate(m_p, size);

         }
         else
         {

            m_p = (POINTER) ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(size);
      ...
      POINTER calloc(::collection::count c)
      {
         ...
         m_p = ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(m_iSize);
      ...
      void free()
      {
         ...
         ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free(m_p);
...
//template < typename POINTER >
//::acid::malloc < POINTER > __malloc(POINTER p)
//{
//
//   return ::acid::malloc < POINTER >(p);
//
//}
