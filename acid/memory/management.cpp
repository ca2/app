...
//
//
//   class CLASS_DECL_ACID system_memory_allocator :
...
//   };
   ...
   class CLASS_DECL_ACID default_memory_allocator :
      virtual public allocator
   {
   public:
      ...
      void * allocate(memsize iSize, const char * pszAnnotation = nullptr) override
      {
         ...
         return ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(iSize, pszAnnotation);
   ...
   management::management()
   {
      ...
      m_paceDestroyOnDestroy = nullptr;
   ...
   void management::initialize_memory_management(::acid::acid * pace)
   {
...
//      s_allocatora[::heap::e_allocator_default] = _new_allocator(::heap::e_allocator_default);
  //    s_allocatora[::heap::e_allocator_memory] = _new_allocator(::heap::e_allocator_memory);
    //  s_allocatora[::heap::e_allocator_malloc] = _new_allocator(::heap::e_allocator_malloc);
      ...
      //m_pmemoryallocateMain = __allocate < ::acid::get()->m_pheapmanagement->memory >(::heap::e_memory_main)->allocate);
      //m_pmemoryallocateSecondary = __allocate < ::acid::get()->m_pheapmanagement->memory >(::heap::e_memory_main)->allocate);
      //m_pmemoryallocateArray = __allocate < ::acid::get()->m_pheapmanagement->memory >(::heap::e_memory_main)->allocate);
      //m_pmemoryallocateProperty = __allocate < ::acid::get()->m_pheapmanagement->memory >(::heap::e_memory_main)->allocate);
      //m_pmemoryallocateString = __allocate < ::acid::get()->m_pheapmanagement->memory >(::heap::e_memory_main)->allocate);
