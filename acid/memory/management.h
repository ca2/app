...
namespace heap
{
   ...
   class CLASS_DECL_ACID management
   {
   protected:
   ...
   public:
      ...
      ::acid::acid *    m_paceDestroyOnDestroy;
      ...
      void initialize_memory_management(::acid::acid * pace);
...
//   class CLASS_DECL_ACID heap_base
//   {
//   public:
//
//
...
//         {
//
//            m_p = ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(uiSize);
//
//         }
//         else
//         {
