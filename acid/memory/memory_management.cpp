...
////#include "::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate.h"
//#include "memory.h"
...
////
////
////CLASS_DECL_ACID void * manage_memory_reallocate(enum_memory_heap ememoryheap, void* p, memsize nSize)
////{
////
...
////
////
////CLASS_DECL_ACID void manage_memory_free(enum_memory_heap ememoryheap, void* p)
////{
////
