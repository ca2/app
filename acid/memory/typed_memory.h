...
namespace heap
{
   ...
   public:
      ...
      inline ::heap::allocator* allocator() { return ::acid::get()->m_pheapmanagement->m_pallocator; }
   ...
   public:
      ...
      inline ::heap::memory * memory() { return ::acid::get()->m_pheapmanagement->memory(t_ememory); }
