...
#include "acid/nano/user/details_window.h"
#include "acid/nano/user/popup_button.h"
#include "acid/user/user/mouse.h"
...
CLASS_DECL_ACID int message_box_to_windows_message_box(enum_message_box emessagebox);
CLASS_DECL_ACID enum_dialog_result windows_message_box_result_to_dialog_result(int iResult);
#endif
...
CLASS_DECL_ACID ::atom message_box_synchronous(::particle * pparticle, const ::scoped_string & scopedstrMessage, const ::scoped_string & scopedstrTitle, const ::e_message_box & emessagebox, const ::scoped_string & scopedstrDetails)
{
...
CLASS_DECL_ACID void message_box_asynchronous(::function < void(const ::atom & atom) > function, ::particle * pparticle, const ::scoped_string & scopedstrMessage, const ::scoped_string & scopedstrTitle, const ::e_message_box & emessagebox, const ::scoped_string & scopedstrDetails)
{
