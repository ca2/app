...
#include "acid/user/user/drag.h"
#include "acid/user/user/tool.h"
...
void window::display_temporary_file_with_text(const ::string & str)
{
   ...
   ::file::path pathFolder = acedirectory()->home() / "application" / strAppId / "details";
   
   auto pathDetails = acefile()->time_put_contents(pathFolder, "details", "txt", str);
