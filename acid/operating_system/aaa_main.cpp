...
#include "acid/platform/version.h"
...
CLASS_DECL_ACID void process_set_args(int argc, platform_char ** argv)
{
...
CLASS_DECL_ACID platform_char *** process_get_pargv()
{
...
CLASS_DECL_ACID platform_char ** process_get_argv()
{
