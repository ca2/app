...
//CLASS_DECL_ACID i64 oswindow_id(oswindow w);
...
//CLASS_DECL_ACID int_bool destroy_window(oswindow oswindow);
//CLASS_DECL_ACID oswindow get_window(oswindow oswindow, int iWindow);
//CLASS_DECL_ACID oswindow get_desktop_window();
//CLASS_DECL_ACID int_bool show_window(oswindow oswindow, int iShow);
//CLASS_DECL_ACID int_bool set_foreground_window(oswindow oswindow);
//
//
//#ifdef WINDOWS_DESKTOP
//CLASS_DECL_ACID bool get_gui_thread_info(PGUITHREADINFO pinfo);
//#endif
//
//
//
