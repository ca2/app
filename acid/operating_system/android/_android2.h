...
CLASS_DECL_ACID void * __node_library_touch(const ::file::path & path, string & strMessage);
CLASS_DECL_ACID void * __node_library_open(const ::file::path & path, string & strMessage);
...
//CLASS_DECL_ACID ::u32 get_last_error();
//CLASS_DECL_ACID void set_last_error(::u32 dw);
