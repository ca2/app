#include "framework.h"
#include "_os_impl.h"
//#include "acid/user/user/interaction_thread.h"
//#include "acid/user/user/interaction_prodevian.h"
...
//
//   if (::aceacesystem()->get_session()->get_focus_ui())
//   {
//
//      wd16_string wstr(utf16, length);
//
//      ::aceacesystem()->get_session()->get_focus_ui()->on_text_composition(wstr);
//
//   }
//   else
//   {
...
//
//   ::user::interaction* puserinteractionHost = ::aceacesystem()->get_session()->m_puserinteractionHost;
//
