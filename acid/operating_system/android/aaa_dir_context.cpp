...
namespace android
{
   ...
   void dir_context::initialize(::particle * pparticle)
   {
      ...
      estatus = __refer(m_pdirsystem, ::aceacesystem()->m_pdirsystem);
      ...
      estatus = __refer(m_pfilesystem, ::aceacesystem()->m_pfilesystem);
   ...
   ::file::listing & dir_context::root_ones(::file::listing & listing)
   {
      ...
      listing.m_straTitle.add("File ::aceacesystem()");
   ...
   // return ::aceacesystem()->get_module_folder();
   ...
   //{
   //
   // return ::aceacesystem()->get_ca2_module_folder();
   //
   //}
   ...
   void dir_context::init_system()
   {
      ...
      ::file::path pathInstall = ::aceacesystem()->m_pathCacheDir;
...
pacedirectory->system() / "home");

      //nodeos_set_temp(         auto psystem = system();

         auto pacedirectory = psystem->m_pacedirectory;

pacedirectory->system() / "temp");
...
pacedirectory->system() / ".ca2/app/appdata";
      string strRelative;
      strRelative = install();
...
//   }
   ...
   //::file::path dir_context::default_userfolder(::acid::application *  papp, const string & lpcszPrefix, const string & lpcszLogin)
   //{
