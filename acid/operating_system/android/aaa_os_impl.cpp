...
//   }
//
//   if (::aceacesystem()->get_session() == nullptr)
//   {
//
...
//   }
//
//   if (::aceacesystem()->get_session()->m_puserinteractionHost == nullptr)
//   {
//
...
//   }
//
//   if (::aceacesystem()->get_session()->m_puserinteractionHost->m_pimpl == nullptr)
//   {
//
...
//   }
//
//   if (::aceacesystem()->get_session()->m_puserinteractionHost->get_window_graphics() == nullptr)
//   {
//
...
//   }
//
//   auto pbuffer = dynamic_cast <::graphics::double_buffer *> (::aceacesystem()->get_session()->m_puserinteractionHost->get_window_graphics());
//
//   if(pbuffer == nullptr)
//   {
//
...
//void os_application_system_run(::acid::system* psystem);
...
//
//   ::aceacesystem()->get_session()->defer_initialize_host_window(rectangle);
//
