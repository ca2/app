...
//       }
//       else if(::aceacesystem()->m_pdumpcontext->GetDepth() > 0)
//       {
//          // long form
//          pparticle->dump(*::aceacesystem()->m_pdumpcontext);
//          *::aceacesystem()->m_pdumpcontext << "\n";
//       }
//       if(false) // else
//       {
...
//          *::aceacesystem()->m_pdumpcontext << sz;
//       }
//    }
//    catch(...)
//    {
...
//    if (nRptType == _CRT_ASSERT || ::aceacesystem()->m_pdumpcontext->m_pfile == nullptr)
//       return false;
...
//    // non-nullptr m_pFile, so go through ::aceacesystem()->m_pdumpcontext for the message
//    *pResult = false;
//    *::aceacesystem()->m_pdumpcontext << szMsg;
