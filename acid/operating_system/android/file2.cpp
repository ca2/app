...
//CLASS_DECL_ACID void dll_processes(u32_array & dwa, string_array & straProcesses, const ::scoped_string & scopedstrDll)
//{
//
//
//
...
//{
//
//   return ::file::path(getenv("HOME")) /  ".acid" / "time";
//
//}
//
//
...
//
//pacedirectory->localconfig() / "favorites";
//
//// }
...
int lockf(int fd, int cmd, off_t ignored_len) 
{
 ...
 CLASS_DECL_ACID bool _os_may_have_alias(const ::scoped_string & scopedstr)
 {
...
//{
//
//   ::aceacesystem()->m_pathCacheDir = pszDir;
//
//}
//
//extern "C"
...
//{
//
//   return ::aceacesystem()->m_pathCacheDir;
//
//}
