...
//i32 CLASS_DECL_ACID __android_main(::acid::system * psystem, i32 argc, char * argv[])
//{
//
//   if(!defer_au_init())
//      return -1;
...
//
//
//   ::android::main_init_data * pinitmaindata  = __new< ::android::main_init_data >();
//
//
...
//
//
//i32 CLASS_DECL_ACID ca2_main(::acid::system * psystem, HINSTANCE hInstance, HINSTANCE hPrevInstance, const char * lpCmdLine, i32 nCmdShow)
//{
//   try
//   {
//
