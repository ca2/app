...
//{
//
//   critical_section_lock cs(::acid::g_pcsGlobal);
//
...
CLASS_DECL_ACID void process_get_os_priority(i32 * piOsPolicy, sched_param * pparam, i32 iCa2Priority);
...
//      char *   cmd_line;
//
//      cmd_line = (char *) ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(strlen(pszCmdLine ) + 1 );
//
//      if(cmd_line == nullptr)
//      {
//
