...
//
//CLASS_DECL_ACID unichar * GetCommandLineW()
//{
//
...
//
//CLASS_DECL_ACID bool shell_execute_sync(const ::file::path & path, const ::scoped_string & scopedstrParam, ::time timeTimeout)
//{
//
//   string strCmdLine;
//
