...
//
//
//CLASS_DECL_ACID void thread_get_os_priority(i32 * piOsPolicy, sched_param * pparam, i32 iCa2Priority);
//
//CLASS_DECL_ACID void process_get_os_priority(i32 * piOsPolicy, sched_param * pparam, i32 iCa2Priority);
//
//CLASS_DECL_ACID i32 thread_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);
//
//CLASS_DECL_ACID i32 process_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);
//
//
...
//
//
////CLASS_DECL_ACID pDWORD current_itask()
////{
////
...
////
////
////CLASS_DECL_ACID HANDLE main_user_htask()
////{
////   return g_hMainThread;
////
////}
////CLASS_DECL_ACID ::u32 main_user_itask()
////{
...
/////*
////
////CLASS_DECL_ACID ::u32 WINAPI GetThreadId(htask_t Thread)
////{
////
////   synchronous_lock mlThreadId(g_pmutexThreadIdLock);
////
...
////}
////
////CLASS_DECL_ACID htask_t  WINAPI get_thread_handle(::u32 dw)
////{
////
////   synchronous_lock mlThreadIdHandle(g_pmutexThreadIdHandleLock);
////
...
////
/////*
////CLASS_DECL_ACID int_bool WINAPI PostThreadMessageW(::u32 idThread,::u32 Msg,WPARAM wParam,LPARAM lParam)
////{
////
...
////*/
////
////CLASS_DECL_ACID int_bool WINAPI PostMessageW(oswindow oswindow,::u32 Msg,WPARAM wParam,LPARAM lParam)
////{
////
...
////}
////
////CLASS_DECL_ACID ::u32 GetCurrentThreadId()
////{
////
