...
#include "main.h"
#include "acid/constant/user.h"
#include "acid/platform/acid.h"
#include "acid/platform/application.h"
#include "acid/platform/system.h"
//aaa_//#include "acid/operating_system/_.h"
//#include "acid/operating_system/_os.h"
//#include "acid/update.h"
...
//{
//
//   ::aceacesystem()->call_subject(id_app_activated);
//
//}
...
//{
//
//   ::aceacesystem()->on_open_file(::e_type_empty, "");
//
//}
...
//         }
//
//         stra[i] = ::aceacesystem()->url().::url::decode(stra[i]);
//
//      }
//
//   }
//
//   ::aceacesystem()->defer_accumulate_on_open_file(stra, pszExtra);
//
//}
...
//   {
//
//      ::aceacesystem()->on_open_file(psza[0], pszExtra);
//
//      ::free((void *) psza[0]);
//
//      ::free(psza);
...
//      stra.c_add((char **) psza, iCount, false);
//
//      ::aceacesystem()->on_open_file(stra, pszExtra);
//
//   }
//
//}
...
//#if defined(ANDROID)
//
//   return acepath()->app_module().folder();
//
...
//   {
//
//      //         str = ::dir::pathfind(getenv("DYLD_LIBRARY_PATH"), "libace.dylib", "rfs"); // readable - normal file - non zero size_f64
//      //
//      //         if(str.has_char())
//      //         {
...
//      //
//      //
//      //         str = ::dir::pathfind(getenv("DYLD_FALLBACK_LIBRARY_PATH"), "libace.dylib", "rfs"); // readable - normal file - non zero size_f64
//      //
//      //         if(str.has_char())
//      //         {
//      //            str = ::file::path(str).folder();
