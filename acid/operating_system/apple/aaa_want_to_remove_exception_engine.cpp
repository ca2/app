...
// // //   CLASS_DECL_ACID class ::exception_engine & engine()
// // //   {
// // //
...
// //          if (!dwModBase)
// //          {
// //          //::acid::get()->platform()->informationf("engine::stack_next :: StackWalk returned true but the address doesn't belong to a module in the process.");
// //          return;
// //          if (bRetry)
// //          {
...
// //       //if(!::acefile()->exists("C:\\acid\\exception_engine.txt"))
// //       //{
// //       //   return false;
// //       //}
