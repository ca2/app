...
#include "acid/platform/constraint.h"
...
CLASS_DECL_ACID enum_trace_level trace_level_constraint(enum_trace_level elevel)
{
...
CLASS_DECL_ACID const char * trace_level_name(enum_trace_level elevel)
{
...
CLASS_DECL_ACID char trace_level_char(enum_trace_level elevel)
{
...
//
//
//CLASS_DECL_ACID void set_last_error(::e_status estatus)
//{
//
...
//CLASS_DECL_ACID void information(const ::scoped_string & scopedstr)
//{
//
//
//}
...
CLASS_DECL_ACID void output_error_message(const ::scoped_string & strMessageParam, const ::scoped_string & strTitleParam, int iMessageBox)
{
