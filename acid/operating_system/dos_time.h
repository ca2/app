...
CLASS_DECL_ACID dostime_t   minimum_dos_time();
CLASS_DECL_ACID dostime_t   maximum_dos_time();
CLASS_DECL_ACID posix_time      dos_time_unix_time(dostime_t dostime);
CLASS_DECL_ACID dostime_t   dos_time(int year, int month, int day, int hour, int minute, int second);
CLASS_DECL_ACID dostime_t   unix_time_dos_time(posix_time unix_time);
