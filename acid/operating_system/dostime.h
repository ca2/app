...
CLASS_DECL_ACID dos_time_t   minimum_dos_time();
CLASS_DECL_ACID dos_time_t   maximum_dos_time();
CLASS_DECL_ACID posix_time      dos_time_unix_time(dos_time_t dostime);
CLASS_DECL_ACID dos_time_t   dos_time(int year, int month, int day, int hour, int minute, int second);
CLASS_DECL_ACID dos_time_t   unix_time_dos_time(posix_time unix_time);
