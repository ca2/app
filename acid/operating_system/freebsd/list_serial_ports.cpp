...
#include "acid/platform/serial.h"
...
//static string read_line(const string& file);
   ...
   string usb_sysfs_friendly_name(::matter * pmatter, const string & sys_usb_path)
   {
      ...
      auto pacefile = psystem->m_pacefile;

      device_number = atoi(pacefile->first_line(sys_usb_path + "/devnum"));

      string manufacturer = pacefile->first_line(sys_usb_path + "/manufacturer");

      string product = pacefile->first_line(sys_usb_path + "/product");

      string serial = pacefile->first_line(sys_usb_path + "/serial");
