...
//      {
//
//         ::acid::get()->platform()->informationf("app-core/clockverse");
//
//      }
//
...
//
//
//CLASS_DECL_ACID void call_async(const ::file::path & path, const ::scoped_string & scopedstrParam, const ::scoped_string & scopedstrDir, ::e_display edisplay, bool bPrivileged, unsigned int * puiPid)
//{
//
//   string strCmdLine;
//
...
//      {
//
//         ::acid::get()->platform()->informationf("os/linux_process.cpp app_get_pid (" + string(psz) + ")");
//
//         atom_array ia;
//
//         ::file::path_array stra;
