...
//      //      add_factory_item < application                >   (::type < ::acid::application >(), 1);
...
//      //add_factory_item < thread               >   (::type < ::thread_impl >());
////      add_factory_item < window               >   (::type < ::window >());
//      add_factory_item < os                         >   (::type < ::acid::os >(), 1);
////      add_factory_item < port_forward               >   (::type < ::net::port_forward >(), 1);
////      add_factory_item < crypto                      >   (::type < ::crypto::crypto >(), 1);
////      add_factory_item < copydesk                   >   (::type < ::acid::copydesk >(), 1);
//  //    add_factory_item < ::ios2::printer                   >   (::type < ::user::printer >(), 1);
//
//   }
//
//
...
//   // add_factory_item < application        , ::acid::application), 1);
...
//   // add_factory_item < thread             , ::thread_impl));
//   // add_factory_item < window             , ::window));
//   // add_factory_item < port_forward       , ::net::port_forward), 1);
//   // add_factory_item < crypto             , ::crypto::crypto), 1);
//   // add_factory_item < copydesk           , ::acid::copydesk), 1);
//   // add_factory_item < ::ios2::printer    , ::user::printer), 1);
//
