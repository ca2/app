...
//
//
//      //i32 iRet = ::acid::application::term_instance();
//
//
//      int iRet = 0;
//
...
//   }
   ...
   LRESULT application::ProcessWndProcException(::exception::acid* e, const MESSAGE* pMsg)
   {
...
//      user::interaction_ptr_array wndptra = ::aceacesystem()->frames();
...
//
//      //      string strExeName;
//      //string strTitle = ::aceacesystem()->load_string("::aceacesystem()->title");
//      // get the exe title from the full path name [no extension]
//      //    strExeName = ::aceacesystem()->get_module_title();
//
//
//
...
//
////         ::aceacesystem()->m_strCmdLine = strCmdLine;
//
//         SetCurrentHandles();
//
//         __init_thread();
