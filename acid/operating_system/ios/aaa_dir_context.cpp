...
pacedirectory->is(stra[i]))
   ...
   //   bool dir::rm(::acid::application *   papp, const ::file::path & psz, bool bRecursive)
   //   {
   //      if(bRecursive)
   //      {
...
//   }
   ...
   ::file::path dir_context::time()
   {
      ...
      return ::aceacesystem()->m_pdirsystem->m_pathModule;
...
//   }
   ...
   ::file::path dir_context::ca2module()
   {
      ...
      return ::aceacesystem()->m_pdirsystem->m_pathCa2Module;
...
//      m_strCa2 = ::file::path(getenv("HOME")) / "Library/papp Support";
      ...
      ::aceacesystem()->m_strIosHome = pathHome;

      m_pdirsystem->m_pathHome = m_pdirsystem->m_strCa2/"Documents";

      //nodeos_set_home(::aceacesystem()->m_strIosHome);
...
//      m_pathUser = m_strCa2 / ".ca2/user";
   ...
   void dir_context::init_context()
   {
      ...
      ::aceacesystem()->m_strIosTemp = strTime;

      //nodeos_set_temp(::aceacesystem()->m_strIosTemp);
