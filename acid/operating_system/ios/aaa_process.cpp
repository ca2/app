...
void node::create_process(const char * _cmd_line, int * pprocessId)
{
   ...
   cmd_line = (char *) ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(strlen(_cmd_line ) + 1 );
...
CLASS_DECL_ACID int call_async(
...
CLASS_DECL_ACID u32 call_sync(const ::file::path & path, const ::scoped_string & scopedstrParam, const ::scoped_string & scopedstrDir, ::e_display edisplay, const ::duration & durationTimeout, ::property_set & set)
{
