...
CLASS_DECL_ACID bool __node_aura_pre_init()
{

//   ace_set_alloc(ace_memory_alloc, &ace_memory_realloc, &acid, <#size_t s#>, <#PFN_MEMORY_REALLOC prealloc#>, <#PFN_MEMORY_FREE pfree#>, <#PFN_MEMORY_SIZE psize#>)
//
   return true;
...
CLASS_DECL_ACID bool __node_pos_init()
{
...
CLASS_DECL_ACID bool __node_pre_term()
{
...
CLASS_DECL_ACID bool __node_pos_term()
{
...
CLASS_DECL_ACID bool __node_aura_pos_init()
{
...
CLASS_DECL_ACID bool __node_aura_pre_term()
{
...
CLASS_DECL_ACID bool __node_aura_pos_term()
{
...
//   {
//
//      ace_set_alloc(&::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate, &memory_reallocate, &::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free, &memory_size);
//
//   }
//
//
