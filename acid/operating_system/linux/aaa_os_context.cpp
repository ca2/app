...
#include "_linux.h"
#include "acid/operating_system/linux/gnome_gnome.h"
#include <unistd.h>
...
namespace linux
{
   ...
   string os_context::get_command_line()
   {
      ...
      return ::aceacesystem()->get_command_line();
...
//      throw ::not_implemented();
   ...
   bool os_context::get_default_browser(string & strId, ::file::path & path, string & strParam)
   {
      ...
      string str = ::aceacesystem()->process().get_output("/bin/sh -c \"xdg-settings get default-web-browser\"");
      ...
      //string str = ::aceacesystem()->process().get_output("xdg-settings get default-web-browser");
...
//         }
   ...
   void os_context::list_process(::file::path_array & patha, u32_array & uaPid)
   {
      ...
      ::acid::get()->platform()->informationf("linux::os_context::list_process");
