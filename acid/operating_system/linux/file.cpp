...
// CLASS_DECL_ACID bool context::os_resolve_alias(::file::path & path, const ::scoped_string & scopedstr, ::user::primitive * pinteraction, bool bNoUI, bool bNoMount)
// {
...
//CLASS_DECL_ACID bool context::os_is_alias(const ::file::path & path)
//{
//
//    if(is_null(path))
//    {
