...
//{
//
//   return ::aceacesystem()->get_session()->m_bAcceptsFirstResponder ? 1 : 0;
//
//}
//
...
//
//
//CLASS_DECL_ACID ::user::interaction_impl * oswindow_get(oswindow oswindow)
//{
//
//   if(oswindow == nullptr)
//   {
...
//{
//
//   ::acid::del(g_poswindowdataptra);
//
//   ::acid::del(g_pmutexOsWindowData);
//
//}
//
//
