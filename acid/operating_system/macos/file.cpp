...
//
//CLASS_DECL_ACID bool _os_resolve_alias(::particle * pparticle, ::file::path & path, const ::scoped_string & scopedstr, ::user::primitive * pinteraction, bool bNoUI, bool bNoMount)
//{
//
