...
//
//
//int_bool acepath()->is_file_or_dir(const ::file::path & path1, ::file::enum_type * petype)
//{
//
//   struct stat st;
//
...
//{
//
//   string str = acefile()->as_string(path, iReadAtMostByteCount);
//
//   string_array stra;
//
//   stra.add_lines(str);
...
//
//
//CLASS_DECL_ACID string file_get_mozilla_firefox_plugin_container_path()
//{
...
[[noreturn]] CLASS_DECL_ACID void throw_file_errno_exception(const ::file::path & path, ::file::e_open eopen, const ::scoped_string & scopedstr, c_error_number cerrornumber)
{
