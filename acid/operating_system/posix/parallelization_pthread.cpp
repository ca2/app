...
#include "acid/parallelization/message_queue.h"
...
//#ifdef LINUX
//#include "acid/operating_system/linux/_user.h"
//#endif
...
//CLASS_DECL_ACID void thread_get_os_priority(i32 * piOsPolicy, sched_param * pparam, ::enum_priority epriority);
//
//CLASS_DECL_ACID void process_get_os_priority(i32 * piOsPolicy, sched_param * pparam, ::enum_priority epriority);
//
//CLASS_DECL_ACID::enum_priority thread_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);
//
//CLASS_DECL_ACID::enum_priority process_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);
...
//   }
   ...
   message_queue * pmq = ::acid::get()->m_ptaskmessagequeue->get_message_queue(idthread, false);
...
//CLASS_DECL_ACID int_bool WINAPI mq_post(message_queue * pmq, oswindow oswindow, ::u32 Msg, WPARAM wParam, LPARAM lParam)
//CLASS_DECL_ACID int_bool WINAPI mq_post(message_queue * pmq, ::u32 Msg, WPARAM wParam, LPARAM lParam)
//{
//
...
// CLASS_DECL_ACID htask_t GetCurrentThread()
// {
...
// CLASS_DECL_ACID itask_t GetCurrentThreadId()
// {
