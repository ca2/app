...
#include "acid/primitive/datetime/earth_zone_time.h"
#ifdef FREEBSD
#undef _C11_SOURCE
...
#ifdef HAVE_UNISTD_H
#include "acid/primitive/datetime/microsecond_sleep.h"
#include <unistd.h>
#endif
...
// CLASS_DECL_ACID void precision_wait(const class time & time)
// {
...
//CLASS_DECL_ACID void precision_wait_nanoseconds(::u64 u)
//{
//
//   struct timespec req;
//
