...
//CLASS_DECL_ACID string audio_get_default_implementation_name()
//{
//
//   return "audio_xaudio";
//
...
//      }
//
//      ::acid::get()->platform()->informationf("Failed to ::CoInitializeEx(nullptr, COINIT_MULTITHREADED) at __node_pre_init");
//
//      return false;
//
//   }
