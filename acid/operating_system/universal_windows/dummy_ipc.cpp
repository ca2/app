...
//      {
//
//         m_strBaseChannel = "acid\\appdata\\inteprocess_channel\\" + string(pszKey);
//
...
//
//         ::winrt::Windows::Storage::StorageFile ^ file = ::wait(folderTopic->CreateFileAsync(wstring("acid.topic"),::winrt::Windows::Storage::CreationCollisionOption::OpenIfExists));
//
//         string strMessage;
//
...
//
//         ::winrt::Windows::Storage::StorageFile ^ f = ::wait(m_pp->folderTopic->GetFileAsync(wstring("acid.topic")));
//
//         if(f != nullptr)
//         {
//
...
//         {
//
//            ::winrt::Windows::Storage::StorageFile ^ f = ::wait(result->Folder->GetFileAsync(wstring("acid.topic")));
//
//            if(f != nullptr)
//            {
//
