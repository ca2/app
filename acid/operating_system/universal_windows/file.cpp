...
//int_bool acefile()->put_contents(const ::file::path & path, const char* contents, memsize len)
//{
//
//            auto psystem = system();
//
...
//
//pacedirectory->create(::file_path_folder(path));
//
//   wstring wstr(path);
//
...
//
//   char * szImage = (char *)::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(iImageSize);
//
...
// //    HMODULE hModule = GetModuleHandle(_T("acid.dll"));
// //    if(!hModule)
// //    {
// //       information(L"GetModuleHandle(_T(\"acid.dll\")); failed");
// //       return 0;
// //    }
// //    string csFilePath;
...
// // extern "C" CLASS_DECL_ACID void GetOpenedFiles(const ::wide_character * lpPath,OF_TYPE Filter,OF_CALLBACK CallBackProc,uptr pUserContext)
// // {
...
//
////
////int_bool acefile()->exists(const ::file::path & path1)
////{
////
////   string str(path1);
////   str.replace("/","\\");
...
//
//
////int_bool acefile()->put_contents(const ::file::path & path,const char * contents,::collection::count len)
////{
////
////            auto psystem = system();
//
...
//
//
//string acefile()->as_string(const ::file::path & path, strsize iReadAtMostByteCount)
//{
//
//   string str;
//
...
//
//CLASS_DECL_ACID memsize read_buffer(void* p, ::winrt::Windows::Storage::Streams::IBuffer^ ibuf, memsize size, memsize pos)
//{
//   
