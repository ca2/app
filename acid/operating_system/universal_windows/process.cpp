...
//CLASS_DECL_ACID int ui_open_url(const ::scoped_string & scopedstrUrl)
//{
//
//   string strUrl(pszUrl);
//
//   auto uri = ref __new< ::winrt::Windows::Foundation::Uri >(strUrl);
//
//   ::winrt::Windows::aceacesystem()::Launcher::LaunchUriAsync(uri);
//
//   return 0;
//
//}
