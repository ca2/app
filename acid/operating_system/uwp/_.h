...
//CLASS_DECL_ACID void reset_message_cache();
...
//CLASS_DECL_ACID void __trace_message(const ::scoped_string & scopedstrPrefix, ::message::message * pmessage);

//CLASS_DECL_ACID void __trace_message(const ::scoped_string & scopedstrPrefix, MESSAGE * lpmsg);
