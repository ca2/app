#include "framework.h"
#include "acid/graphics/draw2d/common.h"
#include "_uwp.h"
#include <shlobj.h>


CLASS_DECL_ACID bool node_save_image(::winrt::Windows::Storage::Streams::IRandomAccessStream^ stream, ::image* pimage, ::save_image* psaveimage);

bool node_save_image(::image * pimage, ::winrt::Windows::Storage::Streams::IRandomAccessStream ^stream, ::acid::application * papp);


CLASS_DECL_ACID bool node_save_image(::winrt::Windows::Storage::Streams::IRandomAccessStream ^ randomAccessStream, const ::image * pimage, ::save_image * psaveimage);
...
namespace universal_windows
{
   ...
   bool copydesk::_has_filea()
   {
      ...
      defer_main_thread([&bHasFile, this]()
      {
         ...
         //   ::winrt::Windows::Storage::Streams::IBuffer ^ buffer = ref aaa_primitive_new ::winrt::Windows::Storage::Streams::Buffer(sizeof(HGLOBAL));
   ...
   bool copydesk::_has_image()
   {
      ...
      return ::aceacesystem()->imaging()._desk_has_image();
   ...
   bool copydesk::_desk_to_image(::image * pimage)
   {
      ...
      return ::aceacesystem()->imaging()._desk_to_image(pimage);
   ...
   bool copydesk::_image_to_desk(const ::image * pimage)
   {
      ...
      return ::aceacesystem()->imaging()._image_to_desk(pimage);
