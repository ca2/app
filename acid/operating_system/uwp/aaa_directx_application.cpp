...
#include "acid/operating_system/universal_windows/_winrt.h"
#include "_uwp.h"
#include "buffer.h"
...
using namespace ::winrt::Windows::aceacesystem();
using namespace ::winrt::Windows::Graphics::Display;
using namespace ::winrt::Windows::aceacesystem()::Threading;
...
namespace universal_windows
{
   ...
   directx_framework_impact::directx_framework_impact(::acid::system * psystem, ::String ^ strId)
   {
...
//      psystem->get_session()->m_frameworkview = this;
   ...
   void directx_framework_impact::OnActivated(CoreApplicationView^ applicationView, IActivatedEventArgs^ args)
   {
      ...
      if (args != nullptr)
      {
         ...
         if (args->Kind == ActivationKind::Protocol)
         {
            ...
            //auto papp = m_pcontext->application();
   ...
   {
      if (args->VirtualKey == ::winrt::Windows::aceacesystem()::VirtualKey::Shift)
      {
   ...
   directx_application_source::directx_application_source(::acid::system * paxissystem, const ::string & strId)
   {
   ...
   directx_application_source ^ new_directx_application_source(::acid::system * paurasystem, const ::string & strId)
   {
