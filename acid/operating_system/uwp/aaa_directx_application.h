...
namespace universal_windows
{
   ...
   internal:
      ...
      directx_framework_impact(::acid::system * psystem,String ^ strId);
      ...
      ::acid::system * get_context_system() const;
   ...
   internal:
      ...
      directx_application_source(::acid::system * paxissystem,const ::string & strId);
   ...
   CLASS_DECL_ACID directx_application_source ^ new_directx_application_source(::acid::system * psystem, const ::string & str);
