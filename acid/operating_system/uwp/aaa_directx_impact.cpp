...
namespace universal_windows
{
   ...
   void impact::SetWindow(CoreWindow^ window)
   {
      ...
      m_tokenKeyDown = m_window->KeyDown += ref aaa_primitive_new TypedEventHandler < ::winrt::Windows::UI::Core::CoreWindow^, ::winrt::Windows::UI::Core::KeyEventArgs^>(this, &impact::CoreWindow_KeyDown);

      m_tokenPointerPressed = m_window->PointerPressed += ref aaa_primitive_new TypedEventHandler < ::winrt::Windows::UI::Core::CoreWindow^, ::winrt::Windows::UI::Core::PointerEventArgs^>(this, &impact::CoreWindow_PointerPressed);
   ...
   void impact::SetSelection(CoreTextRange selection)
   {
      ...
      //Update the UI to show the aaa_primitive_new selection.
      UpdateTextUI();
   }


   // Change the selection and notify CoreTextEditContext of the aaa_primitive_new selection.
   ...
   {
      // Set the aaa_primitive_new selection to the value specified by the system.
   ...
   void impact::EditContext_FormatUpdating(CoreTextEditContext ^sender, CoreTextFormatUpdatingEventArgs ^ args)
   {
      ...
      {
         //TextDecoration underline = aaa_primitive_new TextDecoration(args.Range,args.UnderlineType.Value,args.UnderlineColor.Value);
   ...
   void impact::CoreWindow_KeyDown(::winrt::Windows::UI::Core::CoreWindow^ sender, KeyEventArgs ^args)
   {
      ...
      // to become the aaa_primitive_new selection. Start with the current selection.
   ...
   {
      //BorderPanel->BorderBrush = _internalFocus ? aaa_primitive_new ::winrt::Windows::UI::Xaml::Media::SolidColorBrush(::winrt::Windows::UI::Colors::Green) : null;
   }
   ...
   //   Point point = transform.TransformPoint(aaa_primitive_new Point());
