...
bool CLASS_DECL_ACID vfxResolveShortcut(string & strTarget, const ::scoped_string & scopedstrSource, ::user::primitive * puiMessageParentOptional = nullptr);
...
namespace universal_windows
{
   ...
   class CLASS_DECL_ACID os_context :
      public ::os_context
   {
   public:
