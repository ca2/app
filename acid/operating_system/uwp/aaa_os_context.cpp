...
namespace universal_windows
{
   ...
   bool os_context::defer_register_ca2_plugin_for_mozilla()
   {
      ...
      if(keyPlugins.OpenKey(HKEY_LOCAL_MACHINE, "SOFTWARE\\MozillaPlugins", true))
      {
         ...
         if(keyPlugin.OpenKey(keyPlugins, "@ca2.software/npca2", true))
         {
            ...
            keyPlugin.SetValue("Path", ::aceacesystem()->m_strCa2Module("npca2.dll"));
            keyPlugin.SetValue("ProductName", "ca2 plugin for NPAPI");
            keyPlugin.SetValue("Vendor", "ca2 Desenvolvimento de Software Ltda.");
            keyPlugin.SetValue("Version", papp->acefile()->as_string(pcontext->m_papexcontext->dir()->ca2("appdata/x86/ca2_build.txt")));
         ...
         main_async([strUrl]()
            {
               ...
               ::winrt::Windows::Foundation::Uri^ uri = ref aaa_primitive_new ::winrt::Windows::Foundation::Uri(strUri);
   ...
   void os_context::create_service()
   {
      ...
      SC_HANDLE hdlServ = ::CreateService(
                          ...
                          "acid-" + papp->m_strAppName,               // name of service
