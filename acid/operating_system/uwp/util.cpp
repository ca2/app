...
/*bool CLASS_DECL_ACID __custom_log_font(::u32 nIDS, LOGFONT* pLogFont)
{
...
bool CLASS_DECL_ACID __is_combo_box_control(oswindow hWnd, ::u32 nStyle)
{
   if (hWnd == nullptr)
      return false;
...
bool CLASS_DECL_ACID __compare_class_name(oswindow hWnd, const char * lpszClassName)
{
...
oswindow CLASS_DECL_ACID __child_window_from_point(oswindow hWnd, ::point_i32 point_i32)
{
   ASSERT(hWnd != nullptr);
...
void CLASS_DECL_ACID __set_window_text(::user::interaction * hWndCtrl, const char * lpszNew)
{
...
void CLASS_DECL_ACID __delete_object(HGDIOBJ* pObject)
{
...
/*
void CLASS_DECL_ACID __cancel_modes(oswindow hWndRcvr)
{
