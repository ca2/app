...
void windowing_output_debug_string(const ::scoped_string & scopedstrDebugString)
{
   ...
   if(g_bWindowingOutputDebugString)
   {
      ...
      //informationf(scopedstrDebugString);
...
//CLASS_DECL_ACID void update_application_session_cursor(void * pvoidApp, const point_i32 & pointCursor)
//{
//
//   ::acid::application * papp = (::acid::application *) pvoidApp;
//
...
CLASS_DECL_ACID string message_box_result_to_string(enum_dialog_result edialogresult)
{
