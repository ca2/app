...
//
//CLASS_DECL_ACID string get_command_line(HANDLE handleProcess)
//{
//
...
//   {
//      ::acid::get()->platform()->informationf("Could not read the address of ProcessParameters!\n");
//      return "";
//   }
//
//
...
//   {
//      ::acid::get()->platform()->informationf("Could not read CommandLine!\n");
//      return "";
//   }
//
//   /* allocate memory to hold the command line */
//   WCHAR * commandLineContents = (WCHAR *)::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(ustrCommandLine.Length + sizeof(WCHAR));
//   /* read the command line */
//   if (!ReadProcessMemory(handleProcess, ustrCommandLine.Buffer, commandLineContents, ustrCommandLine.Length, nullptr))
//   {
//      ::acid::get()->platform()->informationf("Could not read the command line string!\n");
//      return "";
//   }
...
//CLASS_DECL_ACID_WINDOWS_COMMON::u32 get_current_process_id()
//{
//
//   return ::GetCurrentProcessId();
//
