...
string CLASS_DECL_ACID windows_get_short_file_name(const string & strPath)
{
...
CLASS_DECL_ACID::file::path get_module_path(HANDLE hProcess, HMODULE hmodule)
{
...
//    ::acid::malloc < unichar * > pwszPath1;

//    ::acid::malloc < unichar * > pwszPath2;
