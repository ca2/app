...
namespace windows
{
   ...
   CLASS_DECL_ACID string last_error_message()
   {
   ...
   CLASS_DECL_ACID string last_error_message(DWORD dwError)
   {
...
[[ noreturn ]] CLASS_DECL_ACID void throw_last_error_exception(const ::file::path & path, ::file::e_open eopen, DWORD lasterror, const ::scoped_string & scopedstrErrorMessage)
{
