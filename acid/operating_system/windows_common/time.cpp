...
#include "acid/operating_system/ansi/datetime_c.h"
...
#include "acid/platform/nanosecond_timer.h"
#include "acid/_operating_system.h"
#include "acid/operating_system/shared_posix/time.h"
...
//CLASS_DECL_ACID void sleep(const class time & time)
//{
//
//   auto ::time = time.::time();
//
...
CLASS_DECL_ACID void preempt_second(::i64 i)
{
...
CLASS_DECL_ACID void preempt_millisecond(::i64 i)
{
...
CLASS_DECL_ACID void preempt_microsecond(::i64 i)
{
...
CLASS_DECL_ACID void preempt_nanosecond(::i64 i)
{
...
// CLASS_DECL_ACID void precision_wait(const class time & timeWait)
// {
...
//CLASS_DECL_ACID system_time as_system_time(const ::posix_time & posixtime)
//{
//   
...
//CLASS_DECL_ACID file_time as_file_time(const ::posix_time & time)
//{
//
...
//
//CLASS_DECL_ACID int_bool get_file_time(HANDLE hFile, LPFILETIME pCreationTime, LPFILETIME lpLastAccessTime, LPFILETIME lpLastWriteTime)
//{
//
...
//
//
//CLASS_DECL_ACID void file_time_to_system_time(system_time * psystemtime, const ::file_time & filetime)
//{
//
