...
namespace x11
{
   ...
   namespace nano
   {
      ...
      namespace user
      {
         ...
         CLASS_DECL_ACID void set_itask(itask_t itask);

         CLASS_DECL_ACID void set_htask(htask_t htask);

         CLASS_DECL_ACID void set_thread(htask_t htask);

         CLASS_DECL_ACID itask_t x11_itask();


         CLASS_DECL_ACID void set_thread()
         {
         ...
         CLASS_DECL_ACID bool is_x11_thread()
         {
         ...
         CLASS_DECL_ACID htask_t x11_htask()
         {
