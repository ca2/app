   ...
   namespace nano
   {
      namespace user
      {
         ...
         xcb_atom_t display::intern_atom(const ::scoped_string & scopedstrAtomName, bool bCreate)
         {
            ...
            ::acid::malloc preply(xcb_intern_atom_reply(m_pconnection, cookie, nullptr));
         ...
         xcb_atom_t display::intern_atom(::x11::enum_atom eatom, bool bCreate)
         {
            ...
            if (atom == XCB_ATOM_NONE)
            {
               ...
               if(eatom == ::x11::e_atom_net_active_window)
               {
                  ...
                  ::acid::get()->platform()->informationf("e_atom_net_active_window");
         ...
         long display::_window_get_long_property(xcb_window_t window, xcb_atom_t property, xcb_atom_t type)
         {
            ...
            ::acid::malloc preply(xcb_get_property_reply(m_pconnection, cookie, nullptr));
         ...
         bool display::message_loop_step()
         {
            ...
            ::acid::malloc pevent(xcb_poll_for_event(m_pconnection));
         ...
         void display::init_task()
         {
            ...
            ::acid::malloc preply(xcb_render_query_pict_formats_reply(m_pconnection, cookie, nullptr));
         ...
         ::e_status display::_request_check(xcb_void_cookie_t cookie)
         {
            ...
            ::acid::malloc perror(xcb_request_check(m_pconnection, cookie));
         ...
         bool display::_list_has_atom(xcb_window_t window, xcb_atom_t propertyList, xcb_atom_t propertyItem)
         {
            ...
            ::acid::malloc preply(xcb_get_property_reply(
               m_pconnection,
               cookie,
               nullptr
            ));
         ...
         ::e_status display::_set_mouse_capture(xcb_window_t window)
         {
            ...
            ::acid::malloc preply(xcb_grab_pointer_reply(m_pconnection, cookie, nullptr));
         ...
         ::e_status display::_get_window_attributes(xcb_get_window_attributes_reply_t * pattributes, xcb_window_t window)
         {
            ...
            ::acid::malloc preply(xcb_get_window_attributes_reply(m_pconnection, cookie, nullptr));
         ...
         ::e_status display::_get_window_geometry(xcb_get_geometry_reply_t * pgeometry, xcb_window_t window)
         {
            ...
            ::acid::malloc preply(xcb_get_geometry_reply(m_pconnection, cookie, nullptr));
