...
#include "acid/nano/user/window_implementation.h"
...
namespace parallelization
{
   ...
   //CLASS_DECL_ACID comparable_eq_array<itask_t> * s_piaThread2 = nullptr;
   //CLASS_DECL_ACID pointer_array < thread > * s_pthreadptra2 = nullptr;
   //CLASS_DECL_ACIDcritical_section * s_pcs2 = nullptr;


   //CLASS_DECL_ACID void init_multitasking()
   //{
   ...
   //CLASS_DECL_ACID void term_multitasking()
   //{

   //   __node_term_multitasking();

   //   //::acid::del(s_pthreadptra2);

   //   //::acid::del(s_piaThread2);

   //   //::acid::del(s_pcs2);

   //}

   //CLASS_DECL_ACID bool thread_id_registered(itask_t atom)
   //{
   ...
   //CLASS_DECL_ACID ::task_pointer calc_parent(::thread * pthread)
   //{
...
//
//CLASS_DECL_ACID ::task * get_thread_raw()
//{
//
//   return ::get_task();
//
...
//
//CLASS_DECL_ACID void set_thread_get_run(PFN_THREAD_GET_RUN pthreadrun)
//{
//
...
namespace parallelization
{
   ...
   //CLASS_DECL_ACID bool post_quit_and_wait(const class time & time)
   //{
...
CLASS_DECL_ACID void call(const ::procedure & procedure)
{
...
CLASS_DECL_ACID ::task * _get_task()
{
...
CLASS_DECL_ACID ::task * get_task()
{
   ...
   //   auto pplatform = ::acid::get()->platform();
...
//CLASS_DECL_ACID ::thread * get_thread()
//{
//
...
CLASS_DECL_ACID void set_task(task * ptask)
{

   auto ptaskOld = t_ptask;
#if REFERENCING_DEBUGGING

   ::allocator::add_referer({ ::acid::get()->platform(), __FUNCTION_FILE_LINE__ });
#endif
...
CLASS_DECL_ACID void task_release()
{
