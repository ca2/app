...
//class CLASS_DECL_ACID thread_ptra :
...
//#include "acid/platform/predicate_holder.h"
//
//
...
//
//
//CLASS_DECL_ACID ::pointer<mutex>open_mutex(::matter * pmatter, const char * lpszName);
//
//
...
//
//
//#include "acid/platform/implementable.h"
//
//
//#include "acid/parallelization/task.h"
//
//
//#include "acid/parallelization/task_keep.h"
//
//
//#include "acid/parallelization/task_payload.h"
//
//
//namespace windowing
//{
...
//
//
//CLASS_DECL_ACID void post_message(::windowing::window * pwindow, const ::atom & atom, wparam wparam, lparam lparam);
//
//
//class thread;
//
...
//CLASS_DECL_ACID void thread_release();
//
//
//
//#ifdef __cplusplus_winrt
//
//#include "acid/operating_system/universal_windows/parallelization_winrt.h"
//
//#endif
//
//
...
//
//CLASS_DECL_ACID void set_get_thread_name(LPFN_GET_THREAD_NAME);
//string get_task_name(::thread* pthread);
//
//CLASS_DECL_ACID void thread_name_abbreviate(string & strName, int len);
//
//
//CLASS_DECL_ACID::pointer < ::mutex >& message_dispatch_mutex();
//
//
//
//#ifdef WINDOWS
...
////
////CLASS_DECL_ACID bool __task_sleep(task* ptask, ::duration ::duration);
////
////CLASS_DECL_ACID bool __task_sleep(::task* ptask, synchronization* psync);
////
////CLASS_DECL_ACID bool __task_sleep(task* ptask, ::duration ::duration, synchronization* psync);
////
////CLASS_DECL_ACID bool task_sleep(const ::duration & duration, synchronization* psync);
//CLASS_DECL_ACID bool task_sleep(const class ::wait & wait);
//
//
...
//
//
//#include "acid/primitive/promise/signalization.h"
//
//
//#include "acid/platform/synchronized_predicate_routine.h"
//
//
//
//
