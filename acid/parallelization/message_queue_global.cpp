...
//CLASS_DECL_ACID int_bool post_ui_message(const MESSAGE & message)
//{
//
...
//CLASS_DECL_ACID int_bool mq_erase_window_from_all_queues(::windowing::window * pwindow)
//{
//
...
//
//
//CLASS_DECL_ACID void mq_clear(itask_t idthread)
//{
//
...
void mq_post_thread_message(itask_t idthread, const ::atom & atom, wparam wparam, lparam lparam)
{
   ...
   auto pmessagequeue = ::acid::get()->m_ptaskmessagequeue->get_message_queue(idthread, true);
...
//CLASS_DECL_ACID int_bool mq_peek_message(MESSAGE * pMsg, oswindow oswindow, ::u32 wMsgFilterMin, ::u32 wMsgFilterMax, ::u32 wRemoveMsg)
//{
//
...
CLASS_DECL_ACID ::e_status mq_get_message(MESSAGE * pMsg, oswindow oswindow, ::u32 wMsgFilterMin, ::u32 wMsgFilterMax)
{

   auto pmessagequeue = acid::get()->m_ptaskmessagequeue->current_task_message_queue(true);
