...
//
//pacedirectory->create(::file::path(strName).folder());
//
//      ::acefile()->put_contents(strName, strName);
//
//      string strTest = acefile()->as_string(strName);
//
//      //int isCreator = 0;
//
...
//#ifdef ANDROID
//
//         path = system()->m_pacedirectory->system() / "tmp/ca2/lock/mutex" / string(pstrName);
//
//#else
//
...
//#ifdef ANDROID
//
//         path =  system()->m_pacedirectory->system() / "home/user/ca2/lock/mutex" / string(pstrName);
//
...
//      path /= pstrName;
//
//      system()->m_pacedirectory->create(path.folder());
//
...
//
//      ::acefile()->put_contents(path, m_pszName);
//
...
//   path /= lpszName;
//
//   auto pacedirectory = pmatter->acedirectory();
//
//   pacedirectory->create(path.folder());
//
...
//
//CLASS_DECL_ACID mutex * get_ui_destroyed_mutex()
//{
//
