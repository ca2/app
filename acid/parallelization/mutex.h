...
#undef ace_MUTEX_DEBUG

class CLASS_DECL_ACID mutex :
   virtual public particle
{
public:

#ifdef ace_MUTEX_DEBUG
   string                  m_strThread;
   itask_t                 m_itask;
#endif
...
CLASS_DECL_ACID void wait_until_mutex_does_not_exist(const char * lpszName);



CLASS_DECL_ACID ::pointer< ::mutex > get_ui_destroyed_mutex();
