...
#include "acid/exception/translator.h"
#include "acid/nano/user/window_implementation.h"
#include "acid/parallelization/synchronous_lock.h"
#include "acid/parallelization/task_message_queue.h"


#include "acid/exception/_text_stream.h"
...
CLASS_DECL_ACID void _do_tasks();
...
task::~task()
{
   ...
   ::acid::get()->platform()->informationf("Task destructor : " + strThreadName + " : (" + ::as_string(itask) + ")\n");
...
#endif
{
   ...
   try
   {
      ...
      if(pace)
      {
         ...
         auto ptaskmessagequeue = pace->m_ptaskmessagequeue;
...
CLASS_DECL_ACID bool __task_sleep(task* task)
{
...
CLASS_DECL_ACID bool __task_sleep(task* ptask, const class time & timeWait)
{
...
CLASS_DECL_ACID bool __task_sleep(::task* ptask, ::particle * pparticle)
{
...
CLASS_DECL_ACID bool __task_sleep(task* ptask, const class time & timeWait, ::particle * pparticle)
{
...
//CLASS_DECL_ACID bool task_sleep(const class time & time)
//{
//
//   auto ptask = ::get_task();
//
...
CLASS_DECL_ACID bool __simple_task_sleep()
{
...
//CLASS_DECL_ACID bool __simple_task_sleep(class ::wait wait)
//{
//
...
//
//
//CLASS_DECL_ACID bool __simple_task_sleep(synchronization* psync)
//{
//
//   while (task_get_run())
//   {
...
//
//
//CLASS_DECL_ACID bool __simple_task_sleep(class ::wait wait, synchronization* psync)
//{
//
...
//CLASS_DECL_ACID bool ace_task_sleep(::time ::time, synchronization* psync)
//{
//
//   if (::is_null(psync))
//   {
...
//PFN_task_sleep g_pfnThreadSleep = ace_task_sleep;

//CLASS_DECL_ACID bool tas_sleep(::time ::time, synchronization* psync)
//{
//
...
//
//CLASS_DECL_ACID void set_task_sleep(PFN_task_sleep pfnThreadSleep)
//{
//
...
//{
//
//   return ::acid::get()->m_pplatform->m_pfactory;
//
//}
...
::collection::index task_index(itask_t itask)
{
   ...
   return ::acid::get()->m_pplatform->task_index(itask);
