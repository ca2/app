...
//#include "acid/primitive/collection/procedure_array.h"
#include "counter.h"
...
class CLASS_DECL_ACID task :
   virtual public object,
   //virtual public synchronization_object,
   virtual public acid::implementable,
...
//
//class CLASS_DECL_ACID thread_local_particle :
...
CLASS_DECL_ACID string get_task_name(htask_t htask);

CLASS_DECL_ACID void set_get_task_name(LPFN_GET_TASK_NAME);

CLASS_DECL_ACID void task_set_name(const char * pszName);
CLASS_DECL_ACID void task_set_name(htask_t htask, const char * pszName);


CLASS_DECL_ACID string task_get_name();
CLASS_DECL_ACID string task_get_name(htask_t htask);
...
CLASS_DECL_ACID string get_task_name(::task * ptask);
