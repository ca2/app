...
//};
//
//CLASS_DECL_ACID lparam_debug & lparam_debug();
//
...
//
//   template < class APP >
//   ::pointer<::acid::application>single_application_library < APP > ::get_new_application(::particle * pparticle, const ::scoped_string & scopedstrAppId)
//   {
//
...
//
//      //int i = atoi(acefile()->as_string(path));
//
//      //acefile()->put_contents(path, as_string(i + 1));
//   }
//
//}
//
...
////#ifndef __DEBUG
////
////#include "acid/primitive/primitive/block.inl"
////
////#endif // !__DEBUG
//
////
