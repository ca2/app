...
class CLASS_DECL_ACID app_core :
...
public:
   ...
   virtual void initialize_application(::acid::application * papp, ::object* pparticle);
...
//CLASS_DECL_ACID long apex_apex(system * pmaindata);

//CLASS_DECL_ACID bool node_fill(system * pappcore);
...
//class CLASS_DECL_ACID apex_level
//{
//public:
//
//
