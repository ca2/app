...
CLASS_DECL_ACID void set_ThisDebug12321575()
{
...
namespace allocator
{
   ...
   CLASS_DECL_ACID ::allocator::accessor * g_pacessorDefault;
   ...
   //CLASS_DECL_ACID void task_on_operator_new(void * p, memsize s)
   //{
   //
   //   t_pOperatorNew = p;
   //   t_sOperatorNew = s;
...
void particle::disable_referencing_debugging()
{
   ...
   //      //::acid::get()->m_preferencingdebugging->m_item2a.erase_last(this);
...
CLASS_DECL_ACID bool refdbg_add_top_track(::particle * pparticle)
{
...
CLASS_DECL_ACID void refdbg_erase_top_track(::particle * pparticle)
{
...
//{
//
//   return ::acid::get()->platform()->__call__add_referer(referer);
//
//}
