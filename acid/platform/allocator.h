...
#include "acid/memory/allocator_base.h"
#include "acid/platform/acid.h"
#include "acid/primitive/string/c/strdup.h"
...
namespace allocator
{
   ...
   CLASS_DECL_ACID void __on_start_construct(void * p, memsize s, bool bParticleAndHeapAllocation);

   CLASS_DECL_ACID::particle * task_get_top_track();

   CLASS_DECL_ACID void on_construct_particle(::particle * pparticle);

   CLASS_DECL_ACID void on_after_construct_particle(::particle * pparticle);

   CLASS_DECL_ACID void __on_after_construct();

   CLASS_DECL_ACID void on_destruct_particle(::particle * pparticle);

   CLASS_DECL_ACID void __on_after_construct_particle(::particle * pparticle);
   ...
   public:
      ...
      template < typename T >
      inline static T * __new_array(::collection::count c)
      {
   ...
   CLASS_DECL_ACID extern ::allocator::accessor * g_pacessorDefault;
