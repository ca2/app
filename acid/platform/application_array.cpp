...
namespace acid
{
   ...
   application_array::application_array(const application_array & array) :
      pointer_array < ::acid::application >(array)
   {
   ...
   application_array & application_array::operator = (const application_array & array)
   {
      ...
      pointer_array < ::acid::application >::operator = (array);
   ...
   ::acid::application * application_array::find_by_app_id(const string & strAppId)
   {
   ...
   ::acid::application * application_array::find_running_defer_try_quit_damaged(const string & strAppId)
   {
   ...
   bool application_array::lookup(const string & strAppId, ::pointer<::acid::application>& papp)
   {
