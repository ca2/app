...
#include "system.h"
#include "acid/constant/message.h"
...
#include "acid/parallelization/multiple_lock.h"
...
namespace acid
{
   ...
   void application_container::add_application(::acid::application* papplication)
   {
   ...
   void application_container::erase_application(::acid::application* papplication)
   {
   ...
   ::pointer<::acid::application>application_container::instantiate_application(const ::string& strAppId)
   {
      ...
      ::pointer<::acid::application> papplication;
      ...
      if (::is_set(psystem->m_paceapplication))
      {

         string strStartupApplicationAppId = psystem->m_paceapplication->m_strAppId;
         ...
         papplication = psystem->m_paceapplication;
      ...
      //   ::acid::application::g_p->initialize_application(papp, this);
   ...
   ::pointer<::acid::application>application_container::create_application(const ::string& strAppId, ::request* prequest)
   {
   ...
   void application_container::on_instantiate_application(::acid::application* papplication)
   {
   ...
   ::pointer<::acid::application>application_container::assert_running(const ::string& strAppId)
   {
   ...
   //   ::pointer<::acid::application>application_container::start_application(const ::string & strAppId, ::request * prequest)
   //   {
   //
   ...
   //      string strBuild;
   //
   //      ::file::path pathExe = acefile()->module();
   //
   ...
   ::acid::application* application_container::get_application(const ::string& strAppId, bool bCreate, ::request* prequest)
   {
