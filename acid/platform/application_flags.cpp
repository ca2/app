...
#include "acid/platform/set_app_id.h"
#include "acid/platform/system.h"
#include "acid/platform/system_setup.h"
#include "acid/primitive/string/command_line.h"
...
//#ifdef ANDROID
//
//#include "acid/operating_system/android/_os_local.h"
//
//#endif
...
//CLASS_DECL_ACID bool windows_register_class(HINSTANCE hinstance);

//CLASS_DECL_ACID ATOM MyRegisterClass(HINSTANCE hInstance);
...
//{
//
//   auto estatus = ace_main_data::system_construct(argc, argv, envp);
//
//   if (!estatus)
//   {
//
...
//{
//
//   auto estatus = ace_main_data::system_construct(pCmdLine);
//
//   if (!estatus)
//   {
//
...
CLASS_DECL_ACID int_bool os_init_windowing();
CLASS_DECL_ACID void os_term_windowing();
...
//
//   if (acefile()->exists(::file::path(APP_CORE_BASE_DIR) / "wait_on_beg.txt"))
//   {
//
//      sleep(10_s);
//
//   }
//
//   if (acefile()->exists(::file::path(APP_CORE_BASE_DIR) / "beg_debug_box.txt"))
//   {
//
...
//CLASS_DECL_ACID void set_path_install_folder(const ::file::path & path);

CLASS_DECL_ACID void set_debug_pointer(void * p);
...
//
//   //   acedirectory()->set_path_install_folder(pathModule.folder(4));
//
//   //}
//
//   //on_command_line();
...
////
//  // ::file::path pathOutputDebugString = acedirectory()->system() / strAppId / "information.txt" ;
//
//   //::file::path pathGlobalOutputDebugString = acedirectory()->config() / "information.txt" ;
//
//   //::apex::g_bOutputDebugString = acefile()->exists(pathOutputDebugString)||  acefile()->exists(pathGlobalOutputDebugString);
//
//   //return true;
//
//}
...
//
//         m_plibrary = __allocate< ::acid::library >();
//
...
//
//
////::pointer<::acid::application>main::new_app()
////{
////
////   //if(::acid::application::g_p)
////   //{
////
////   //   return ::acid::application::g_p;
////
////   //}
////
////   if (!m_pfnnewmatterApplication)
...
//
//
//void main::initialize_application(::acid::application * papplication, ::particle * pparticle)
//{
//
