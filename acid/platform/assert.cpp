...
CLASS_DECL_ACID ::atom __cpp_assert_failed_line(const ::ansi_character * pszFileName, int iLineNumber);


CLASS_DECL_ACID string message_box_result_to_string(int iResult);
...
////{
////
////   auto posmessagebox = __allocate< ::acid::message_box_synchronous >(pszText, pszTitle, emessagebox);
////
...
CLASS_DECL_ACID bool __assert_failed_line(const char * pszFileName, int iLineNumber)
{
...
CLASS_DECL_ACID ::atom __cpp_assert_failed_line(const char * pszFileName, int iLineNumber)
{
