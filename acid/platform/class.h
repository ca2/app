...
#define STATIC_DOWNCAST_T(class_name, T1, matter) (static_cast<class_name<T1>*>(::acid::StaticDownCast(RUNTIME_CLASS_T(class_name, T1), matter)))
#define STATIC_DOWNCAST_T2(class_name, T1, T2, matter) (static_cast<class_name<T1, T2>*>(::acid::StaticDownCast(RUNTIME_CLASS_T2(class_name, T1, T2), matter)))
