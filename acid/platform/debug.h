...
acid 8 has two existing validation models
...
We added ENSURE because there were too many unreported error paths in acid and we wanted to bail out of more
...
ENSURE might seem slightly better. It is debuggable and consistent with acid in general. In fact, many parts of acid do just this.
...
//#include "acid/networking/sockets/trace_interface.h"


CLASS_DECL_ACID void __trace(enum_trace_level elevel, const ::scoped_string & scopedstrTag, const ::scoped_string & scopedstr, const ::scoped_string & scopedstrFile = nullptr, int iLine = -1);
...
CLASS_DECL_ACID i32 DECL_C debug_report(
i32 _ReportType,
...
// CLASS_DECL_ACID i32 FUNCTION_DEBUGBOX(const ::scoped_string & scopedstrMessage, const ::scoped_string & scopedstrTitle, i32 iFlags);

// CLASS_DECL_ACID i32 FUNCTION_DEBUGBOXW(const WCHAR * pszMessage, const WCHAR * pszTitle, i32 iFlags);
...
// Use!!
// #include "acid/inline/set_xxdebug_box.inl"
// and
// #include "acid/inline/clear_xxdebug_box.inl"




//void CLASS_DECL_ACID TRACELASTERROR();//



//CLASS_DECL_ACID string FormatMessageFromSystem(u32 dwError);
...
//class CLASS_DECL_ACID trace_interface //:
...
//
CLASS_DECL_ACID void os_trace(enum_trace_level elevel, const ::scoped_string & scopedstrTag, const ::scoped_string & scopedstrMessage);
//CLASS_DECL_ACID void trace(enum_trace_level elevel, const ::scoped_string & scopedstrTag, const ::scoped_string & scopedstr, const ::scoped_string & scopedstrFile = nullptr, int iLine = -1);
...
//extern CLASS_DECL_ACID ::pointer< ::mutex > g_pmutexMemoryCounters;
...
//{
//
//   return ::acid::constraint(elevel, e_trace_level_none, e_trace_level_count);
//
//}
