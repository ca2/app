...
#ifndef __cplusplus
#error acid requires C++ compilation (use a .cpp suffix)
#endif

#ifdef UNDER_CE
#error This version of acid is not currently supported for CE. Look for the CE specific version.
#endif
...
#ifdef UNICODE
#ifndef _UNICODE
#define _UNICODE        // _UNICODE is used by C-runtime/acid API headers
#endif
#endif
...
// rather only used as a acid class.  Additionally, the constructor and
...
///////////////////////////////////////////////////////////////////////////////
// By default, the wizards will generate  acid matter classes with this
...
#else
// If not linking to 80.DLL, use the static registrar and not building acid.dll
#ifndef _DLL_IMPL
...
#define API CLASS_DECL_ACID __declspec(nothrow) HRESULT __stdcall
#define API_(x)CLASS_DECL_ACID __declspec(nothrow) x __stdcall
#define APIINL API
#define APIINL_(x) API_(x)


#define offsetofclass(acid, derived) ((uptr)(static_cast<acid*>((derived*)_PACKING))-_PACKING)
...
//acid/ API code should use standard pointer to member standard syntax &MyClass::MyMethod, instead
