...
///         }
      ...
      //{
         ...
         //error() <<"acid::library::open Failed to open library " << ( bCa2Path ? " (ca2 path)" : "") << " with errors " << m_strMessage;

         //return false;

      //}

      //information() << "acid::library::open success : " << m_strMessage;
      ...
      if(platform()->is_verbose_log())
      {
         ...
         if(::is_set(m_plibrary))
         {
            ...
            information() << "acid::library::open success : \"" << m_strName << "\"";

         }
         else
         {

            information() << "acid::library::open failure : \"" << m_strName << "\"";

            information() << "acid::library::open failure message : \"" << m_strMessage << "\"";
   ...
   //::acid::library* library::loading_library()
   //{
   ...
   //   PFN_NEW_LIBRARY pfnNewaceLibrary = nullptr;
