...
//   //::pointer<::acid::library>         m_plibrary;
...
//   void system_end();
//
//   //::pointer<::acid::application>new_app();
//   //::pointer<::acid::application>new_app(const ::scoped_string & scopedstrAppId);
//
//
...
//
//   virtual void initialize_application(::acid::application* papplication, ::particle* pparticle);
//
//
//};
//
...
//class subsystem;
//
//CLASS_DECL_ACID void __main(::acid::application* papplication);
//
//
//namespace acid
//{
//
//
//   CLASS_DECL_ACID void create_system();
//   CLASS_DECL_ACID i32 run_system();
//
//
//} // namespace acid
//
...
//
//
//class CLASS_DECL_ACID app_flag
//{
//public:
//
//
//   app_flag(::main& main, const ::scoped_string & scopedstrFlag);
//
//
//};
//
