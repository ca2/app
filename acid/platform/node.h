...
namespace acid
{
   ...
   public:
      ...
      ::ace_posix::node *                                  m_pacePosix;
      ::apex_posix::node *                                  m_pApexPosix;
      ::aura_posix::node *                                  m_pAuraPosix;

      :: IDENTIFIER_SUFFIX_OPERATING_SYSTEM(ace_)::node *  m_pacePlatform;
      ...
      string_map < ::pointer<::acid::exclusive > >          m_mapExclusive;
#if defined(WITH_X11)
      ...
      //virtual ::pointer < ::particle > create_quit_particle(::pointer<::acid::node>& pnode);

      //virtual ::pointer < ::particle > create_quit_particle();
      virtual ::file::path get_default_base_integration_folder();
      
      ///virtual void implement(::pointer<::acid::node>& pnode, ::pointer<::acid::system> & psystem);
      ...
      virtual void start_application(::pointer<::acid::node> & pnode);


      virtual void ace_application_main(::acid::system * psystem);
      ...
      virtual ::pointer < ::acid::exclusive > _get_exclusive(::particle * pparticleContext, const ::string & strName, ::security_attributes * psecurityattributes = nullptr);

      virtual ::pointer < ::acid::exclusive > get_exclusive(::particle * pparticleContext, const ::string & strName, ::security_attributes * psecurityattributes = nullptr);
...
//      virtual void set_simple_ui_darkness(int iWeatherDarkness);
      ...
      virtual void create_app_shortcut(::acid::application * papplication);
...
//#endif
      ...
      //virtual ::pointer<::acid::exclusive> get_exclusive(string str, const security_attributes & securityattributes = nullptr);
...
//
//      //CLASS_DECL_ACID u32 call_sync(const ::string & pszPath, const ::string & pszParam, const ::string & pszDir, ::e_display edisplay, const class time & timeTimeout, ::property_set & set);
//
//#endif
...
//#endif
      ...
      //CLASS_DECL_ACID string consume_command_line_parameter(const ::string & pszCommandLine, const ::string * & pszEndPtr);
      //CLASS_DECL_ACID bool is_command_line_parameter_true(string& strValue, const ::string & pszCommandLine, const ::string & pszParam, bool bDefault = false);
      //CLASS_DECL_ACID bool get_command_line_parameter(string & strValue, const ::string & pszCommandLine, const ::string & pszParam);
      //CLASS_DECL_ACID bool get_command_line_parameter(string & strValue, const ::string & pszCommandLine, const ::string & pszParam, const ::string & pszDefault);
      //CLASS_DECL_ACID string get_command_line_parameter(const ::string & pszCommandLine, const ::string & pszParam);
...
//   virtual ::pointer < ::file::link > resolve_link(const ::file::path & path, ::file::e_link elink = ::file::e_link_all);
   ...
   virtual void register_user_auto_start(::acid::application * papplication, const string & strArguments, bool bRegister);
