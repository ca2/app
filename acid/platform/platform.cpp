...
CLASS_DECL_ACID void initialize_nano_http(::factory::factory * pfactory);
...
//
//
//   CLASS_DECL_ACID extern ::acid::acid * g_p;
//
//
} // namespace acid
#ifdef CUBE
...
namespace platform
{
   ...
   platform::platform(::acid::acid * pace) :
      m_pace(pace)
   {
   ...
   platform::~platform()
   {
      ...
      //if (::is_set(m_paceapplication))
      //{

      //   if (m_paceapplication->m_countReference > 0)
      //   {

      //      m_paceapplication->check
...
::acid::g_paAura = __new < ::array < matter* > >();
...
//#endif
   ...
   void platform::factory_initialize()
   {
      ...
      //::acid::acid::g_pstaticstatic->m_pfactorya = __new< factory_array >();
   ...
   ::factory::factory_pointer & platform::factory(const ::string & strLibraryRequest)
   {
      ...
      if (!plibrary)
      {
         ...
         plibrary = system()->__create_new < ::acid::library >();
   ...
   ::pointer<::acid::library> platform::create_library(const ::string & strLibrary)
   {
      ...
      auto plibrary = __create_new < ::acid::library >();
   ...
   ::pointer<::acid::library> & platform::library(const ::string & str)
   {
   ...
   void platform::delete_all_release_on_end()
   {
     ...
     // ::acid::del(m_pelementaddraReleaseOnEnd);
   ...
   //   m_pfactory.release();
   //
   //   //::acid::del(::acid::acid::g_pstaticstatic->m_pfactorya);
   //
   //   //::acid::del(::acid::acid::g_pstaticstatic->m_pfactory);
   //
   //}
