...
#include "acid/platform/release_time_for_project.h"
...
namespace acid
{
   ...
   using library_map = string_map < ::pointer < ::acid::library > >;
...
namespace platform
{
   ...
   class CLASS_DECL_ACID platform :
   ...
   public:
      ...
      ::acid::acid * acid() const { return ((platform *)this)->m_pace; }
      ...
      //virtual ::pointer<::acid::library> open_component_library(const ::string &pszComponent, const ::string &pszImplementation);

      virtual ::pointer<::acid::library> create_library(const ::string & strLibrary);

      virtual ::pointer<::acid::library> & library(const ::string & str);
      ...
      //virtual ::acid::system * __get_system() = 0;
      ...
      release_time_for_project as_release_time_for_project(const char* pszStatic);
       ...
       // [HERE]
       //  __node_library should be here at acid
       //
   ...
   //   ::acid::system * __get_system() override { return &m_system; }
   ...
   inline ::platform::platform * get() { return ::acid::get() ? ::acid::get()->platform() : nullptr; }


} // namespace platform


CLASS_DECL_ACID ::string as_string(const ::release_time_for_project& releasetimeforproject);
