   ...
   m_iSerial(g_iReferenceItemArraySerial++)
{
   ...
   if (::is_null(pparticleParent))
   {
      ...
      ::acid::get()->m_preferencingdebugging->add_item_array(this);
   ...
   if (g_bDefaultEnableObjectReferenceCountDebug)
   {
      ...
      else
      {
         ...
         if (!pace)
         {
            ...
            ::acid::get()->platform()->warningf("Something has gone wrong... acid doesn't exist");

         }

         auto preferencingdebugging = pace->m_preferencingdebugging;

         if (!preferencingdebugging)
         {

            ::acid::get()->platform()->warningf("Something is wrong... referencing debugging doesn't exist (anymore)?");
...
void particle::add_reference_item()
{
   ...
   critical_section_lock synchronouslock(&::acid::get()->m_preferencingdebugging->m_criticalsection);
...
//
//
//CLASS_DECL_ACID struct lparam_debug & lparam_debug()
//{
//
//    return g_lparamdbg;
//
...
//{
//
//   auto c = ::acid::get()->m_pobjectreferencecountdebuga->size();
//
//   {
//
//      ::string strDump;
...
CLASS_DECL_ACID::critical_section * refdbg_cs()
{
   ...
   return &::acid::get()->m_preferencingdebugging->m_criticalsection;
