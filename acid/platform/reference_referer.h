...
#include "acid/platform/_c.h"
#include "acid/primitive/primitive/interlocked_count.h"
#include "acid/primitive/string/c_string.h"


CLASS_DECL_ACID::i64 new_reference_referer_serial();


class CLASS_DECL_ACID reference_referer
{
public:
