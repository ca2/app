...
//CLASS_DECL_ACID critical_section* ::platform::get()->sequence_critical_section();

//CLASS_DECL_ACID void initialize_sequence_critical_section();
//
//CLASS_DECL_ACID void finalize_sequence_critical_section();
