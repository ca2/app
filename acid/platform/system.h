// Offloading apex(TBS)::app_core from deep stack stuff into acid(CSTBS) ::system 2022-02-22 by camilo at 07:19 <3ThomasBorregaardSorensen!!
#pragma once
...
#include "acid/parallelization/_types.h"
...
namespace acid
{
   ...
   public:
      ...
      //::pointer<::acid::application>     application();
      // ::pointer<::acid::application>     application();
      ...
      ::pointer<class ::acid::node>                                     m_pnode;
      ...
      ::pointer<class ::ace_directory>                                 m_pacedirectory;
      ::pointer<class ::ace_file>                                      m_pacefile;
      ::pointer<class ::ace_path>                                      m_pacepath;
      ...
      inline ::pointer<::acid::node> & node() { return m_pnode; }

      inline class ::base64 * base64() { return m_pbase64; };

      inline ::xml::xml * xml() { return m_pxml.get() ? m_pxml.get() : _xml(); }

      inline ::ace_file * acefile() const { return m_pacefile; }

      inline ::ace_directory * acedirectory() const { return m_pacedirectory; }

      inline ::ace_path * acepath() const { return m_pacepath; }
      ...
      ::acid::acid * acid() const { return m_pplatform->m_pace; }
      ...
      virtual ::pointer<::acid::session>on_create_session(::collection::index iEdge);

      virtual ::acid::session* session(::collection::index iEdge = 0);


      virtual void add_session(::collection::index iEdge, ::acid::session* psession);
      virtual void on_add_session(::acid::session* psession);
      ...
      virtual ::acid::application * get_main_app();
      ...
      virtual void system_construct(::acid::application * paceapplicationStartup);
      ...
      virtual ::pointer<::acid::application> new_app(const ::scoped_string & scopedstrAppId);
      ...
      virtual ::acid::library* on_get_library(const ::string& pszLibrary);




      //virtual ::pointer<::acid::library> & library(const ::string &strComponent, const ::string &strImplementation);
...
//   }
      ...
      //CLASS_DECL_ACID ::acid::library * lib(const ::scoped_string & scopedstr);
...
//CLASS_DECL_ACID string get_latest_deployment_number(const ::string & strBranch);
