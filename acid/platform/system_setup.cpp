...
CLASS_DECL_ACID ::string get_library_component(const string & strName)
{
...
::pointer<::acid::library>system_setup::create_library()
{
...
::pointer<::acid::library>system_setup::_create_library()
{
