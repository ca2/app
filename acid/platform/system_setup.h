...
//  Moved from Apex to acid on 2021-03-20 18:39 <3ThomasBS_
//
#pragma once
...
class CLASS_DECL_ACID system_setup
{
public:
...
public:
   ...
   ::pointer<::acid::library>_create_library() override { return __allocate< LIBRARY >(); }
...
class CLASS_DECL_ACID app_factory
{
public:
   ...
   static ::pointer<::acid::application>new_app(::particle * pparticle);
