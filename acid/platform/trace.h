...
class CLASS_DECL_ACID trace_category
{
public:
...
CLASS_DECL_ACID const char * get_windows_message_name(::u32 nMsg);
...
CLASS_DECL_ACID trace_function std_inline_log(enum_trace_level etracelevelInformation = e_trace_level_information);
