...
CLASS_DECL_ACID void trace_category_static_init(::acid::system * psystem);
CLASS_DECL_ACID void trace_category_static_term();
...
void trace_category_static_init(::acid::system * psystem)
{
...
void trace_category_static_term()
{
   ...
   ::acid::del(trace_category::s_ptracecategorya);
...
CLASS_DECL_ACID const char* trace_category_name(enum_trace_category etracecategory)
{
...
CLASS_DECL_ACID bool enable_trace_category(enum_trace_category etracecategory, bool bEnable)
{
...
CLASS_DECL_ACID int_bool c_enable_trace_category(enum_trace_category etracecategory, int_bool iEnable)
{
...
CLASS_DECL_ACID const ::particle * trace_object(enum_trace_category etracecategory)
{
