...
namespace acid
{
    ...
    ::acid::string string_formatf_arguments(const char *format, va_list args);
    ...
    ::acid::string application::get_distro()
    {
    ...
    ::acid::string application::get_version()
    {
    ...
    ::acid::string application::get_branch()
    {
...
return ;
        ...
        auto strEtcOsRelease = ::acid::file_as_string("/etc/os-release");
...
auto strXdgCurrentDesktop = acid::get_environment_variable("XDG_CURRENT_DESKTOP");
