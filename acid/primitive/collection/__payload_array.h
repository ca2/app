...
class CLASS_DECL_ACID payload_array :
...
//CLASS_DECL_ACID void var_array_skip_network_payload(const char *& pszJson);
CLASS_DECL_ACID void payload_array_skip_network_payload(::ansi_range & range);
