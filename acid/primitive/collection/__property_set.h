...
//CLASS_DECL_ACID void property_set_skip_network_payload(const char *& pszJson);
CLASS_DECL_ACID void property_set_skip_network_payload(::ansi_range & range);
