...
//#include "acid/primitive/collection/pointer_array_process.h"
#include "acid/primitive/primitive/compare_predicate.h"
//#include "acid/primitive/primitive/payload.h"
//#include "acid/primitive/primitive/payload_array.h"
...
namespace acid
{
   ...
   namespace array
   {
      ...
      inline bool equals_non_unique_unordered(const T1& t1, const T2& t2)
      {
         ...
         return ::acid::array::contains_array(t1, t2) && ::acid::array::contains_array(t2, t1);
   ...
   namespace array
   {
      ...
      ::collection::index add(string_array_base < Type, RawType, t_etypeContainer >& array, const ::payload& payload)
      {
         ...
         else if (payload.get_type() == ::e_type_string_array)
         {
            ...
            i = ::acid::array::add(array, payload.stra());

         }
         else if (payload.cast < string_array_base < Type, RawType, t_etypeContainer > >() != nullptr)
         {

            i = ::acid::array::add(array, *payload.cast < string_array_base < Type, RawType, t_etypeContainer > >());
         ...
         else if (payload.get_type() == ::e_type_payload_array)
         {
            ...
            for (::collection::index i = 0; i < payload.payloada().get_count(); i++)
            {
               ...
               ::collection::index iItem = ::acid::array::add(array, payload.payloada()[i]);
         ...
         else if (payload.get_type() == ::e_type_property_set)
         {
            ...
            for (auto& pproperty : payload.propset())
            {
               ...
               auto iItem = ::acid::array::add(array, *pproperty);
         ...
         else
         {
            ...
            i = ::acid::array::add(array, payload);
...
namespace acid
{
   ...
   namespace array
   {
      ...
      //   ::acid::array::set_sequence(a, start, end, increment);
      ...
      //      if (::acid::array::binary_search(a, aParam.element_at(i), iFind, &::numeric_compare < typename ::numeric_array < TYPE, t_etypeContainer >::BASE_ARG_TYPE >))
      //      {
