...
CLASS_DECL_ACID bool safe_destroy_element(::particle * pparticle);

CLASS_DECL_ACID bool safe_free_memory(void * ptype);
...
//#include "acid/parallelization/keep_task_payload.h"


#include "acid/platform/options.h"


typedef CLASS_DECL_ACID pointer_array < u32_array > dword_2darray;
typedef CLASS_DECL_ACID pointer_array < index_array > index_2darray;





#include "acid/primitive/comparison/less.h"
