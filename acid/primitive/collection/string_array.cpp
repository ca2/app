...
CLASS_DECL_ACID bool next_csv(string & str, const char * & psz)
{
...
CLASS_DECL_ACID char * const * alloc_c_string_array(const string_array & stra)
{
...
CLASS_DECL_ACID void free_c_string_array(char * const * ppszList, int iCount)
{
