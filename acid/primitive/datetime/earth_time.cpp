...
#include "acid/platform/definition.h"
#include "acid/primitive/datetime/_string.h"
...
CLASS_DECL_ACID SYSTEMTIME __SYSTEMTIME(const ::earth::time & time)
{
...
CLASS_DECL_ACID FILETIME & copy(FILETIME & filetime, const ::earth::time & time)
{
...
CLASS_DECL_ACID bool sort_of_ok_earth_time_from_international_string(const ::scoped_string& scopedstrTime)
{
