...
class CLASS_DECL_ACID file_time
{
public:
...
extern CLASS_DECL_ACID const char * const szInvalidDateTime;
extern CLASS_DECL_ACID const char * const szInvalidDateTimeSpan;

const i32 maxTimeBufferSize = 128;
const long maxDaysInSpan  =   3615897L;


//CLASS_DECL_ACID file_time_t get_file_time_now();


struct CLASS_DECL_ACID file_time_set
{
...
CLASS_DECL_ACID bool file_modified_timeout(const ::file::path & path, int iSeconds);


CLASS_DECL_ACID void get_file_time_set(const ::file::path & path, file_time_set & time);

CLASS_DECL_ACID void get_file_time_set(const ::file::path & path, file_time & creation, file_time & modified);

CLASS_DECL_ACID void set_modified_file_time(const ::file::path & path, const class ::time & time);

CLASS_DECL_ACID void set_modified_file_time(const ::file::path & path, const file_time & modified);
...
//CLASS_DECL_ACID file_time __file_time(const ::earth::time & time);
...
CLASS_DECL_ACID file_time as_local_file_time(const ::file_time & filetime);
