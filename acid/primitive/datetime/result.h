...
CLASS_DECL_ACID datetime::result operator + (const datetime::result & result1, const datetime::result & result2);
CLASS_DECL_ACID datetime::result operator - (const datetime::result & result1, const datetime::result & result2);
CLASS_DECL_ACID datetime::result operator * (const datetime::result & result1, double d);
CLASS_DECL_ACID datetime::result operator / (const datetime::result & result1, double d);
