...
namespace geometry2d
{
   ...
   //public:
      ...
      class CLASS_DECL_ACID begin_figure_item :
         virtual public item
      {
      public:
      ...
      class CLASS_DECL_ACID close_figure_item :
         virtual public item
      {
      public:
      ...
      class CLASS_DECL_ACID end_figure_item :
         virtual public item
      {
      public:
      ...
      class CLASS_DECL_ACID intersect_clip_item :
         virtual public item
      {
      public:
      ...
      class CLASS_DECL_ACID polygon_item :
         virtual public item
      {
      public:
      ...
      class CLASS_DECL_ACID poly_polygon_item :
         virtual public item
      {
      public:
      ...
      class CLASS_DECL_ACID combine_item :
         virtual public item
      {
      public:
      ...
      class CLASS_DECL_ACID round_rectangle_item :
         virtual public item
      {
      public:
