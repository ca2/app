...
CLASS_DECL_ACID i64 ceil_div(i64 num, i64 den);


CLASS_DECL_ACID double tri(double angle);
...
CLASS_DECL_ACID int ccvt_dup(char * buf,int nchar, double arg, int ndigits,int *decpt,int *sign,int eflag);
CLASS_DECL_ACID int ecvt_dup(char * buf,int nchar, double arg, int ndigits,int *decpt,int *sign);
CLASS_DECL_ACID int fcvt_dup(char * buf,int nchar, double arg, int ndigits,int *decpt,int *sign);
CLASS_DECL_ACID int gcvt_dup(char * buf,int nchar, double arg, int ndigits);
CLASS_DECL_ACID int max_cvt_dup(char *buf,int nchar,double arg,int ndigits,int *decpt,int *sign, int * pi);
...
namespace degree
{
   ...
   inline CLASS_DECL_ACID double to_radian(double dAngleDegrees)
   {
   ...
   inline CLASS_DECL_ACID double sin(double dAngleDegrees)
   {
   ...
   inline CLASS_DECL_ACID double cos(double dAngleDegrees)
   {
   ...
   inline CLASS_DECL_ACID double tan(double dAngleDegrees)
   {
...
CLASS_DECL_ACID int type_maximum_digits(enum_integer_type etype, int iBase = 10);
...
//CLASS_DECL_ACID int i8_maximum_digits(int iBase);
//CLASS_DECL_ACID int u8_maximum_digits(int iBase);
//
//CLASS_DECL_ACID int i16_maximum_digits(int iBase);
//CLASS_DECL_ACID int u16_maximum_digits(int iBase);
//
//CLASS_DECL_ACID int i32_maximum_digits(int iBase);
//CLASS_DECL_ACID int u32_maximum_digits(int iBase);
//
//CLASS_DECL_ACID int i64_maximum_digits(int iBase);
//CLASS_DECL_ACID int u64_maximum_digits(int iBase);
