...
//class CLASS_DECL_ACID class ::time
//{
//public:
//
//
...
////#ifdef WINDOWS
//DEFINE_UNIT(CLASS_DECL_ACID, lock_time, u32)
//DEFINE_UNIT(CLASS_DECL_ACID, tick_time, u32)
////#endif

//DEFINE_C_NUMBER(CLASS_DECL_ACID, filesize        , u64)
//DEFINE_C_NUMBER(CLASS_DECL_ACID, filesize    , u64)
//DEFINE_C_NUMBER(CLASS_DECL_ACID, filesize      ,  i64)
...
namespace numeric_info_internal
{
   ...
   template < typename T >
   class CLASS_DECL_ACID numeric_info < ::c_number < T > > :
