...
CLASS_DECL_ACID ::collection::index array_translate_a(index_biunique & ia, ::collection::index aNew, ::collection::index aOld)
{
...
CLASS_DECL_ACID index_array array_translate_a_array(index_biunique & ia, index_array iaNew, index_array iaOld)
{
