...
namespace numeric_info_internal
{
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < i8 > :
...
//      }
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < u8 > :
      public numeric_integer_base
   {
   public:
...
//      }
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < i16 > :
      public numeric_integer_base
   {
   public:
...
//      }
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < u16 > :
      public numeric_integer_base
   {
   public:
...
//      }
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < i32 > :
      public numeric_integer_base
   {
   public:
...
//      }
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < long > :
      public numeric_integer_base
   {
   public:
...
//      }
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < ::u32 > :
      public numeric_integer_base
   {
   public:
...
//      }
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < unsigned long > :
      public numeric_integer_base
   {
   public:
...
//      }
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < ::i64 > :
      public numeric_integer_base
   {
   public:
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < u64 >:
      public numeric_integer_base
   {
   public:
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < float >:
...
//      }
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < double >:
      public numeric_floating_base
   {
   public:
...
//      }
   ...
   template < >
   class CLASS_DECL_ACID numeric_info < std::strong_ordering > 
   {
   public:
