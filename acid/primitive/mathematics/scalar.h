...
#include "acid/constant/scalar.h"
...
class CLASS_DECL_ACID scalar_source :
...
//class CLASS_DECL_ACID real_scalar :
...
//
//
//class CLASS_DECL_ACID integer_scalar :
//   virtual public scalar_base
//{
//public:
//
