...
#if defined(WINDOWS)
//extern _locale_t ::acid::get_c_locale();
#else
#if defined(__APPLE__)
#include <xlocale.h>
#define _atof_l atof_l
#endif
//extern locale_t ::acid::get_c_locale();
#endif
...
#else
      return (::i8)_atof_l(m_str, ::acid::get_c_locale());
#endif
   case e_type_payload_pointer:
...
#else
      return (::u8)_atof_l(m_str, ::acid::get_c_locale());
#endif
   case e_type_payload_pointer:
...
#else
      return (::i16)_atof_l(m_str, ::acid::get_c_locale());
#endif
   case e_type_payload_pointer:
...
#else
      return (::u16)_atof_l(m_str, ::acid::get_c_locale());
#endif
   case e_type_payload_pointer:
...
::f32 payload::f32(::f32 fDefault) const
{
   ...
   #else
      return (::f32) _atof_l(m_str, ::acid::get_c_locale());
   #endif
   case e_type_payload_pointer:
...
::f64 payload::f64(::f64 dDefault) const
{
   ...
   else if(m_etype == ::e_type_string)
   {
      ...
      f64 = _atof_l(m_str, ::acid::get_c_locale());
...
//#else
//      return _atof_l(m_str, ::acid::get_c_locale()) / (::f64) ul;
//#endif
//   case ::e_type_payload_pointer:
...
//#else
//      return (::f64) ul / _atof_l(payload.m_str, ::acid::get_c_locale());
//#endif
//   case ::e_type_payload_pointer:
...
#else
      if(is_scalar()
            && (fmod(_atof_l(str, ::acid::get_c_locale()), 1.0) == 0.0
                && fabs(_atof_l(str, ::acid::get_c_locale())) <= pow(2.0, 31.0)))
#endif
      {
         str.trim();
         if(str.length() == 0)
...
void payload::consume_number(const char * & psz, const ::ansi_character * pszEnd)
{
   ...
   if(bFloat)
   {
      ...
      ::f64 f64 = _atof_l(strNumber, ::acid::get_c_locale());
