...
//::string CLASS_DECL_ACID operator + (const ::scoped_string & scopedstr, const property & prop);
//
//::payload CLASS_DECL_ACID operator - (i32 i, const property & prop);
//::payload CLASS_DECL_ACID operator - (u32 user, const property & prop);
//::payload CLASS_DECL_ACID operator - (i64 i, const property & prop);
//::payload CLASS_DECL_ACID operator - (u64 u, const property & prop);
//::payload CLASS_DECL_ACID operator - (double d, const property & prop);
//::payload CLASS_DECL_ACID operator - (const ::payload & payload, const property & prop);
...
class CLASS_DECL_ACID property : 
   public ::payload
{
public:
   ...
   void* operator new(size_t size)
   {
      ...
      return ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_property)->allocate(size);
   ...
   void operator delete(void * p)
   {
      ...
      return ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_property)->free(p);
...
CLASS_DECL_ACID void property_parse_network_payload_item(atom & atom, ::ansi_range & range);
CLASS_DECL_ACID void property_parse_network_payload_payload(::payload & payload, ::ansi_range & range);
CLASS_DECL_ACID void property_skip_network_payload_item(::ansi_range & range);
CLASS_DECL_ACID void property_skip_network_payload_payload(::ansi_range & range);


#include "acid/primitive/collection/ptr_array.h"
#include "acid/primitive/collection/auto_ptr_array.h"
...
//inline ::payload CLASS_DECL_ACID operator - (i32 i, const property& prop) { return operator - (i, (const ::payload &) prop); }
//inline ::payload CLASS_DECL_ACID operator - (u32 user, const property& prop) { return operator - (user, (const ::payload &)prop); }
//inline ::payload CLASS_DECL_ACID operator - (i64 i, const property& prop) { return operator - (i, (const ::payload &)prop); }
//inline ::payload CLASS_DECL_ACID operator - (u64 u, const property& prop) { return operator - (u, (const ::payload &)prop); }
//inline ::payload CLASS_DECL_ACID operator - (double d, const property& prop) { return operator - (d, (const ::payload &)prop); }
//inline ::payload CLASS_DECL_ACID operator - (const ::payload & payload, const property& prop) { return operator - (payload, (const ::payload &)prop); }
...
//inline ::payload CLASS_DECL_ACID operator + (u64 u, const property& prop) { return operator + (u, (const ::payload &)prop); }
//inline ::payload CLASS_DECL_ACID operator + (double d, const property& prop) { return operator + (d, (const ::payload &)prop); }
//inline ::payload CLASS_DECL_ACID operator + (const ::payload & payload, const property& prop) { return payload, (const ::payload &)prop); }
