...
//
//inline CLASS_DECL_ACID::std::strong_ordering atom_order(const atom * pid1,const atom * pid2)
//{
//
...
//inline CLASS_DECL_ACID atom & atom::operator += (const ::scoped_string & scopedstr) { return operator = (string(*this) + string(psz)); }
...
//inline string CLASS_DECL_ACID operator + (const ::scoped_string & scopedstr, const ::atom & atom);

//
//namespace acid
//{
//
//   CLASS_DECL_ACID ::atom atom(const ::scoped_string & scopedstr);
//
//}
//
//
//class CLASS_DECL_ACID __atom :
//public atom
//{
//
//public:
