...
#include "acid/platform/reference_item.h"
#include "acid/platform/reference_item_array.h"
CLASS_DECL_ACID::critical_section * refdbg_cs();
#endif
...
#
      ...
      catch (...)
      {
         ...
         ::acid::get()->platform()->informationf("exception release pparticle->release() \n");
...
//class CLASS_DECL_ACID global_particle :
...
inline i64 release(T *& p)
{
   ...
   catch (...)
   {
      ...
      ::acid::get()->platform()->informationf("exception release p = nullptr; \n");
