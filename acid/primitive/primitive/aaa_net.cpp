...
CLASS_DECL_ACID string url_decode(const ::string & strParam)
{
...
//CLASS_DECL_ACID string url_decode(const ::scoped_string & scopedstr)
//{
//
//   string str(psz);
//
...
//CLASS_DECL_ACID string url_encode(const ::scoped_string & scopedstr)
//{
//
//   string str;
//
