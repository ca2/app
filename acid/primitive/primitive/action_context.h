...
#include "acid/constant/source.h"
#include "acid/platform/message.h"


class CLASS_DECL_ACID action_context :
...
public:
   ...
   ::pointer<::acid::message>                m_pmessage;
...
//CLASS_DECL_ACID e_source translation_source(e_source esource, enum_context econtextDst, enum_context econtextSrc);
