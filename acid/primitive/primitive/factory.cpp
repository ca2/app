...
#include "acid/platform/simple_log.h"
...
//    CLASS_DECL_ACID factory_array * get_factory_item_array()
//    {
//
//       return ::acid::acid::g_pstaticstatic->m_pfactorya;
//
//    }
...
//    {
//
//       return &::acid::acid::g_pace->factory_;
//
//    }
   ...
   void factory::set_currently_loading_library()
   {
      ...
      //   m_plibrary = ::acid::library::loading_library();
   ...
   //   auto plibrary = ::acid::library::loading_library();
   // 
   //   if (::is_null(plibrary))
   //   {
...
//CLASS_DECL_ACID ::pointer< ::mutex > g_pmutexFactory = nullptr;
...
CLASS_DECL_ACID bool safe_destroy_element(matter * pmatter)
{
...
CLASS_DECL_ACID bool safe_free_memory(void * ptype)
{
   ...
   try
   {
      ...
      ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free(ptype);
...
//CLASS_DECL_ACID ::pointer<alloc_interface>& get_factory_item2(const ::string & strName)
//{
//
//   string_array stra;
//
...
//#ifdef __DEBUG
//#include "acid/inline/factory_item.cpp"
//#endif
