...
#include "acid/primitive/primitive/type.h"
#include "acid/primitive/collection/list_iterator.h"
//////#include "acid/exception/exception.h"
//#include "acid/platform/library.h"


CLASS_DECL_ACID ::string demangle(const char * pszMangledName);
...
namespace factory
{
   ...
   class CLASS_DECL_ACID factory_item_interface :
   ...
   //CLASS_DECL_ACID factory * get_factory();

   ///CLASS_DECL_ACID factory * get_factory(const ::atom & atomSource);
...
namespace factory
{
   ...
   //CLASS_DECL_ACID critical_section * &m_criticalsection;
   ...
   CLASS_DECL_ACID::factory::factory * loading_library_factory();
...
//
   ...
   //         ::acid::get()->platform()->informationf("loading into existing matter of same class type (1)");
   ...
   //            ::acid::get()->platform()->informationf("defer_new failed (1.1)");
   ...
   //            ::acid::get()->platform()->informationf("allocated matter type is different from streamed matter type (1.2)");
   ...
   //         ::acid::get()->platform()->informationf("loading into existing matter of same class type (2)");
   ...
   //            ::acid::get()->platform()->informationf("stream::alloc_object_from_text failed (2.1)");

   //         }
   //         else if (::type(p).name()) != atom.to_string()
   //         {

   //            ::acid::get()->platform()->informationf("allocated matter type is different from streamed matter type (2.2)");
