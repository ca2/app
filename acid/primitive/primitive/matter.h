...
//   inline matter(::acid::context * pcontext) : m_pcontext(pcontext), m_pmutex(nullptr), m_estatus(e_status_none), m_ematter(e_element_none), m_uError(0), m_eobject(e_object_none), m_pobjrefdbg(matter.m_pobjrefdbg) { }
//#else
...
//   inline matter(::acid::context * pcontext) : m_pcontext(pcontext), m_pmutex(nullptr), m_uError(0), m_eobject(e_object_none) { }
//#endif
...
//}
   ...
   //::acid::context * get_context() const { return (::acid::context *) m_pcontext; }
   //::acid::system * system() const;

   inline ::acid::application * get_app() { return _get_app(); }

   virtual ::acid::application * _get_app();
