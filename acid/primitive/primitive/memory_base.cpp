...
namespace acid
{
   ...
   //CLASS_DECL_ACID void transfer_to(::file::file * pfileOut, memory_base & mem, memsize uiBufferSize)
   //{
   ...
   //CLASS_DECL_ACID void transfer_from_begin(::file::file * pfileIn, memory_base & mem, memsize uiBufferSize)
   //{

   //   pfileIn->seek_to_begin();

   //   ::acid::transfer_from(pfileIn, mem, uiBufferSize);

   //}


   //CLASS_DECL_ACID void transfer_from(::file::file * pfileIn, memory_base & mem, memsize uiBufferSize)
   //{
...
//CLASS_DECL_ACID stream & operator << (stream & stream, memory_container & memcontainer)
//{
//
...
//CLASS_DECL_ACID stream & operator << (stream & stream, memory_base & mem)
//{
//
//   ::acid::transfer_to(stream, mem);
//
//   return stream;
//
//}
