...
//#include "acid/platform/obj_ref_debug_impl.h"
//#endif
//#include "acid/constant/idpool.h"
//#include "acid/primitive/text/_.h"
#include "acid/primitive/primitive/set_bit.h"
//#include "acid/primitive/string/hex.h"
#include "acid/primitive/text/text.h"
#include "acid/primitive/collection/atom_map.h"
#include "acid/parallelization/manual_reset_event.h"
#include "acid/parallelization/queue.h"
#include "acid/parallelization/synchronously_keep_bit.h"
...
void object::add_task(::object* pobjectTask)
{
   ...
   if (strType.contains("prodevian"))
   {
      ...
      ::acid::get()->platform()->informationf("task added to prodevian\n");

   }
   else if (strType.contains("user::thread"))
   {

      ::acid::get()->platform()->informationf("task added to user::thread\n");
...
void object::erase_task_and_set_task_new_parent(::object* pobjectTask, ::object * pobjectTaskNewParent)
{
   ...
   critical_section_lock criticalsectionlock(&::acid::get()->m_preferencingdebugging->m_criticalsection);
   ...
   if (m_pparticleaChildrenTask->erase(pobjectTask) <= 0)
   {
      ...
      ::acid::get()->platform()->informationf("not a child");
...
CLASS_DECL_ACID::pointer < ::mutex >* get_children_mutex();
...
//
//
//CLASS_DECL_ACID void object_on_add_composite(const element* pusermessage)
//{
//
...
//::apex::system* objectacesystem() const
//{
//
//
//}
...
//::acid::application * object::get_app() const
//{
//
//   //return m_pcontext && m_pcontext->m_paceapplication ? m_pcontext->m_paceapplication : nullptr;
//   
...
//
//
//::acid::session * object::get_session() const
//{
//
