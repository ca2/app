...
#include "acid/parallelization/create_task_attributes.h"
...
public:
   ...
   //::pointer<::apex::application>                           m_paceapplication;
   ...
   //inline ::acid::system* system() const;
   ...
   //inline ::application* application() { return m_paceapplication; }
...
//   void destroy() override;
   ...
   inline ::acid::context* get_context() const { return m_pcontext; }

   //inline ::thread* get_thread() const { return m_pthread; }

   //inline ::application* get_app() const { return m_paceapplication; }
   ...
   //inline ::application * application() const { return m_paceapplication; }
...
//#endif
   ...
   //::acid::application * get_app() const;

   //::acid::session * get_session() const;
...
//CLASS_DECL_ACID void call_sync(const ::procedure_array& routinea);
