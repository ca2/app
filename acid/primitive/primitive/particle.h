...
#include "acid/primitive/primitive/e_flag.h"
#include "acid/platform/allocator.h"
...
//CLASS_DECL_ACID ::factory::factory * get_system_factory();
...
#include "acid/platform/trace_statement.h"
...
class CLASS_DECL_ACID particle :
...
//   virtual void delete_this();
   ...
   ::acid::system * system() const;
   ::acid::session * session() const;
   ::acid::application * application() const;
   ::acid::node * node() const;
   ::acid::context * context() const;
   ...
   ::ace_file * acefile() const;
   ::ace_path * acepath() const;
   ::ace_directory * acedirectory() const;
...
//
//
//CLASS_DECL_ACID ::trace_statement information();
//CLASS_DECL_ACID ::trace_statement warning();
//CLASS_DECL_ACID ::trace_statement error();
//CLASS_DECL_ACID ::trace_statement fatal();
//
//
//CLASS_DECL_ACID void informationf(const ::ansi_character * pszFormat, ...);
//CLASS_DECL_ACID void warningf(const ::ansi_character * pszFormat, ...);
//CLASS_DECL_ACID void errorf(const ::ansi_character * pszFormat, ...);
//CLASS_DECL_ACID void fatalf(const ::ansi_character * pszFormat, ...);
//
//
...
//
//
//   CLASS_DECL_ACID ::reference_referer * aaa_defer_add_referer(const ::reference_referer & referer);
//   CLASS_DECL_ACID ::reference_referer * aaa_add_referer(const ::reference_referer & referer);
//   CLASS_DECL_ACID ::reference_referer * aaa_defer_get_referer(::particle * p, const ::reference_referer & referer);
//   CLASS_DECL_ACID ::reference_referer * aaa_get_referer();
//   CLASS_DECL_ACID ::reference_referer * aaa_pop_referer();
//   CLASS_DECL_ACID void aaa_defer_erase_referer();
//   CLASS_DECL_ACID void aaa_erase_referer(::reference_referer * preferer);
//
//
//   CLASS_DECL_ACID void aaa_add_releaser(::reference_referer * preferer);
//   CLASS_DECL_ACID::reference_referer * aaa_get_releaser();
//   CLASS_DECL_ACID::reference_referer * aaa_pop_releaser();
//   CLASS_DECL_ACID void aaa_defer_erase_releaser();
//   CLASS_DECL_ACID void aaa_erase_releaser(::reference_referer * preferer);
//
//
//} // namespace allocator
//
...
inline ::particle* refdbg_this() { return (::particle*)::acid::get()->platform(); }

CLASS_DECL_ACID ::allocator::accessor * __call__add_referer(const ::reference_referer & referer, ::reference_referer ** ppreferer = nullptr);
