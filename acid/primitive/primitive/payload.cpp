#include "framework.h"
//#include "acid/primitive/string/get_string.h"
#include "payload.h"
...
#include "acid/platform/locale.h"
#include "acid/primitive/datetime/system_time.h"
#include "acid/primitive/datetime/earth_gregorian_time.h"
////#include "acid/primitive/datetime/earth_time.h"
#include "acid/primitive/primitive/memory.h"
//#include "acid/primitive/string/_conv.h"
#include "acid/primitive/string/from_integer.h"
#include "acid/primitive/string/international.h"
#include "acid/primitive/string/network_payload.h"
#include "acid/primitive/string/str.h"
#include "acid/exception/not_implemented.h"
//#include "acid/array.h"
#include "acid/_operating_system.h"


#include "acid/primitive/collection/_container.h"



CLASS_DECL_ACID void copy(::string & str, const ::payload & payload)
{
...
CLASS_DECL_ACID void copy(::payload & payload, const int & i)
{
...
CLASS_DECL_ACID  void copy(::payload & payload, const ::string & str)
{
...
class ::payload & payload::operator = (const class ::payload & payload)
{
   ...
   if(&payload != this)
   {
      ...
      if (etypeSource == e_type_path)
      {
         ...
         m_ppath = new ::file::path_object(*payload.m_ppath);

      }
      else if (etypeSource == e_type_property_set)
      {

         m_ppropertyset = new ::property_set(*payload.m_ppropertyset);

      }
      else if (etypeSource == e_type_i32_array)
      {

         m_pia = new ::i32_array(*payload.m_pia);

      }
      else if (etypeSource == e_type_i64_array)
      {

         m_pi64a = new ::i64_array(*payload.m_pi64a);
      ...
      else if (etypeSource == e_type_string_array)
      {
         ...
         m_pstra = new ::string_array(*payload.m_pstra);
...
//   {
//
//      return ::acid::is_true(m_str);
//
//   }
//   else if (m_etype == e_type_pstring)
//   {
//
//      return m_pstr != nullptr && ::acid::is_true(*m_pstr);
//
//   }
//   else if (m_etype == e_type_atom)
//   {
//
//      return (m_atom.is_text() && ::acid::is_true(m_atom.m_psz)) || (m_atom.is_integer() && m_atom.m_i != 0);
//
//   }
//   else if (m_etype == e_type_patom)
//   {
//
//      return m_patom != nullptr && ((m_patom->is_text() && ::acid::is_true(m_patom->m_psz)) || (m_patom->is_integer() && m_patom->m_i != 0));
//
//   }
//   else if (m_etype == e_type_i32_array)
//   {
...
//   {
//
//      return m_pstra != nullptr && (m_pstra->get_count() >= 2 || (m_pstra->get_count() == 1 && ::acid::is_true(m_pstra->element_at(0))));
//
//   }
//   else if (m_etype == e_type_f32)
//   {
...
//   {
//
//      return m_ppropertyset != nullptr && ::acid::array::every::is_true(m_ppropertyset->values());
//
//   }
//   else if (m_etype == e_type_time)
//   {
...
void unit_test_primitive_var_ace_block_arg(::payload payload)
{
...
void unit_test_primitive_var_ace_block()
{
   ...
   debug_primitive_var_ace_block_arg(r2);
...
CLASS_DECL_ACID ::string get_string(const ::payload & payload)
{
...
//   {
//
//      ::acid::array::intersection(payload.ia(), ia(), payload2.ia());
//
//   }
//   else if (m_etype == ::e_type_string_array || payload2.m_etype == ::e_type_string_array)
//   {
//
//      ::acid::array::intersection(payload.stra(), stra(), payload2.stra());
//
//   }
//   else if (m_etype == ::e_type_payload_array || payload2.m_etype == ::e_type_payload_array)
//   {
//
//      ::acid::array::intersection(payload.payloada(), payloada(), payload2.payloada());
//
//   }
//   else if (is_double() || payload2.is_double())
//   {
...
CLASS_DECL_ACID void copy(string * pstring, const ::payload * ppayload)
{
...
CLASS_DECL_ACID::string as_string(const ::payload & payload)
{
...
CLASS_DECL_ACID subparticle * as_subparticle(const payload & payload)
{
