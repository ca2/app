...
#include "acid/primitive/time/time/posix_time.h"
#include "acid/graphics/draw2d/color.h"
#include "ptr.h"
#include "acid/memory/memory.h"
#include "acid/memory/raw_block.h"
#include "acid/platform/procedure.h"
#include "acid/primitive/collection/numeric_array.h"
#include "acid/filesystem/filesystem/path_object.h"
#include  "acid/filesystem/filesystem/path_array.h"
//#include "acid/primitive/datetime/file_time.h"
#include "acid/primitive/string/sz.h"
...
public:
   ...
   //   bool strictly_different(bool b) const;
      ...
      //friend bool CLASS_DECL_ACID strict_equal(const ::scoped_string & scopedstr,const payload & payload);
      //friend bool CLASS_DECL_ACID strict_equal(const ::string & str,const payload & payload);
      //friend bool CLASS_DECL_ACID strict_equal(double d,const payload & payload);
      //friend bool CLASS_DECL_ACID strict_equal(::i32 i,const payload & payload);
      //friend bool CLASS_DECL_ACID strict_equal(bool b,const payload & payload);

      //friend bool CLASS_DECL_ACID strict_different(const ::scoped_string & scopedstr,const payload & payload);
      //friend bool CLASS_DECL_ACID strict_different(const ::string & str,const payload & payload);
      //friend bool CLASS_DECL_ACID strict_different(double d,const payload & payload);
      //friend bool CLASS_DECL_ACID strict_different(::i32 i,const payload & payload);
      //friend bool CLASS_DECL_ACID strict_different(bool b,const payload & payload);
...
#include "acid/primitive/collection/__payload_array.h"


#include "__payload_reference.h"
#include "acid/primitive/collection/__property_set.h"
...
//{
   ...
   //inline CLASS_DECL_ACID void from(::string & str, const payload & payload)
   //{
...
//CLASS_DECL_ACID void var_skip_number(const char *& psz);
CLASS_DECL_ACID void payload_skip_number(::ansi_range & range);
//CLASS_DECL_ACID void var_skip_identifier(const char *& psz);
CLASS_DECL_ACID void payload_skip_identifier(::ansi_range & range);
//CLASS_DECL_ACID void var_skip_network_payload(const char *& pszJson);
CLASS_DECL_ACID void payload_skip_network_payload(::ansi_range & range);
