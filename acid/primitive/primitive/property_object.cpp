...
CLASS_DECL_ACID void debug_debug_reference()
{
...
//   }
   ...
   ::acid::get()->platform()->informationf(network_payload1);
   ...
   ::acid::get()->platform()->informationf(network_payload2);

   ::acid::get()->platform()->informationf("debug_debug_reference end");
