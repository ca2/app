...
namespace url
{
   ...
   CLASS_DECL_ACID bool query_get_param(string& strParam, const ::ansi_character * pszKey, const ::ansi_character * pszUrl)
   {
...
//#endif
//
//CLASS_DECL_ACID int_bool freerdp_get_credentials(void * instance, char** username,char** password,char** domain, const ::ansi_character * pszServerName, int bInteractive)
//{
//
...
//CLASS_DECL_ACID bool is_url(const ::ansi_character * pszCandidate)
//{
//
...
//CLASS_DECL_ACID string ::url::decode(const ::ansi_character * psz)
//{
//
//   string str(psz);
//
...
//CLASS_DECL_ACID bool url_query_get_param(string& strParam, const ::ansi_character * pszKey, const ::ansi_character * pszUrl)
//{
//
//   const ::ansi_character * pszBeg;
//   const ::ansi_character * pszEnd;
