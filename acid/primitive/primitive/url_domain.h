...
class CLASS_DECL_ACID url_domain_base
{
public:
...
class CLASS_DECL_ACID url_domain :
...
bool CLASS_DECL_ACID server_is_top_domain(const char * pszTop1, strsize iLen1, const char * pszTop2, strsize iLen2);

inline bool CLASS_DECL_ACID server_is_top_domain(string strTop1, string strTop2)
{
