...
CLASS_DECL_ACID inline strsize safe_strlen(void * p, strsize n)
{
...
CLASS_DECL_ACID string demangle(const ::scoped_string & scopedstr);

CLASS_DECL_ACID void copy(::string & str, const subparticle & subparticle)
{
...
CLASS_DECL_ACID void erase_sharp_comment(::string_array& stra)
{
