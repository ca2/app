...
CLASS_DECL_ACID i64 strtoi(const ::scoped_string & scopedstr);
CLASS_DECL_ACID i64 strtoi(const ::wide_character * psz);
...
//   {
//
//      *ppsz = (char *)::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(iNewBufferSize + 1);
//
//   }
//
