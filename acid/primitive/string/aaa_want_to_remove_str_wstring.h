...
#include "acid/primitive/primitive/memory_c.h"



CLASS_DECL_ACID wstring operator + (const wstring & wstr1, const wstring & wstr2);
CLASS_DECL_ACID wstring operator + (const wstring & str, const unichar * psz);
CLASS_DECL_ACID wstring operator + (const unichar * psz, const wstring & str);


CLASS_DECL_ACID wstring gen_utf8_to_16(const ::scoped_string & scopedstr);


//class CLASS_DECL_ACID wstring_data
//{
//protected:
//
//
...
//         return;
//      ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free(pdata);
//
//   }
//
//
