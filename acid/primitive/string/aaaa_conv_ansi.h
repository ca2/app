...
inline CLASS_DECL_ACID string string_from_strdup(const ::ansi_character * psz);
...
CLASS_DECL_ACID void to_string(string& str, const unsigned long & ul);
CLASS_DECL_ACID void to_string(string& str, const long int & i);
