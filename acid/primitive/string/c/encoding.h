...
#include "acid/primitive/string/x/x_defines.h"
#include "acid/primitive/string/x/x_tables.h"
...
CLASS_DECL_ACID strsize wd16_to_wd32_len(const ::wd16_character* pcwsz, strsize input_size = -1);
CLASS_DECL_ACID strsize wd16_to_wd32(::wd32_character* pwsz, const ::wd16_character* pcwsz, strsize input_size = -1);


CLASS_DECL_ACID ::wd32_character* wd16_to_wd32_dup(const ::wd16_character* pcwsz, strsize input_size = -1);



CLASS_DECL_ACID strsize wd32_to_wd16_len(const ::wd32_character* pcwsz, strsize input_size = -1);
CLASS_DECL_ACID strsize wd32_to_wd16(::wd16_character * pwsz, const ::wd32_character* pcwsz, strsize input_size = -1);

CLASS_DECL_ACID ::wd16_character* wd32_to_wd16_dup(const ::wd16_character* pcwsz, strsize input_size = -1);





CLASS_DECL_ACID strsize utf16_len(const ::wd16_character* psz);
CLASS_DECL_ACID const ::wd16_character * unicode_next(const ::wd16_character* psz);
inline const ::wd16_character * unicode_prior(const ::wd16_character * psz, const ::wd16_character * pszBeg);


CLASS_DECL_ACID strsize ansi_to_wd16_len(const ::ansi_character * psz, strsize srclen = -1);
CLASS_DECL_ACID strsize ansi_to_wd16(::wd16_character* pwsz, const ::ansi_character * psz, strsize srclen = -1);

CLASS_DECL_ACID ::wd16_character * ansi_to_wd16_dup(const char * input, strsize input_size);


CLASS_DECL_ACID strsize wd16_to_ansi_len(const ::wd16_character* pwsz, strsize srclen = -1);
CLASS_DECL_ACID strsize wd16_to_ansi(char* psz, const ::wd16_character* pwsz, strsize srclen = -11);

CLASS_DECL_ACID char * wd16_to_ansi_dup(const ::wd16_character * input, strsize input_size);


CLASS_DECL_ACID strsize utf32_len(const ::wd32_character* psz);
...
CLASS_DECL_ACID strsize ansi_to_wd32_len(const ::ansi_character * psz, strsize srclen = -1);
CLASS_DECL_ACID strsize ansi_to_wd32(::wd32_character* pwsz, const ::ansi_character * psz, strsize srclen = -1);

CLASS_DECL_ACID ::wd32_character* ansi_to_wd32_dup(const char* pcwsz, strsize input_size = -1);


CLASS_DECL_ACID strsize wd32_to_ansi_len(const ::wd32_character* pwsz, strsize srclen = -1);
CLASS_DECL_ACID strsize wd32_to_ansi(char* psz, const ::wd32_character* pwsz, strsize srclen = -1);

CLASS_DECL_ACID char * wd32_to_ansi_dup(const ::wd32_character * input, strsize input_size);
