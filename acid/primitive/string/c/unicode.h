...
//CLASS_DECL_ACID bool _str_safe_precmp(int & i, const ::ansi_character * pszA, const ::ansi_character * pszB);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::ansi_character *, const ::ansi_character * psource, strsize srclen);


// template <  >
CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd16_character *, const ::wd16_character * psource, strsize srclen);



CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd16_character *, const ::wd32_character * psource, strsize srclen);



CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd32_character *, const ::wd32_character * psource, strsize srclen);



CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd32_character *, const ::wd16_character * psource, strsize srclen);



CLASS_DECL_ACID strsize utf_to_utf_length(const ::ansi_character *, const ::wd16_character * psource, strsize srclen);



CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd16_character *, const ::ansi_character * psource, strsize srclen);



CLASS_DECL_ACID strsize utf_to_utf_length(const ::ansi_character *, const ::wd32_character * psource, strsize srclen);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd32_character *, const ::ansi_character * psource, strsize srclen);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::ansi_character *, const ::ansi_character * psource);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd16_character *, const ::wd16_character * psource);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd16_character *, const ::wd32_character * psource);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd32_character *, const ::wd32_character * psource);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd32_character *, const ::wd16_character * psource);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::ansi_character *, const ::wd16_character * psource);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::ansi_character *, const ::wd32_character * psource);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd16_character *, const ::ansi_character * psource);


CLASS_DECL_ACID strsize utf_to_utf_length(const ::wd32_character *, const ::ansi_character * psource);


CLASS_DECL_ACID void utf_to_utf(::ansi_character * ptarget, const ::ansi_character * psource, strsize srclen);


CLASS_DECL_ACID void utf_to_utf(::wd16_character * ptarget, const ::wd16_character * psource, strsize srclen);


CLASS_DECL_ACID void utf_to_utf(::wd16_character * ptarget, const ::wd32_character * psource, strsize srclen);


CLASS_DECL_ACID void utf_to_utf(::wd32_character * ptarget, const ::wd32_character * psource, strsize srclen);


CLASS_DECL_ACID void utf_to_utf(::wd32_character * ptarget, const ::wd16_character * psource, strsize srclen);


CLASS_DECL_ACID void utf_to_utf(::ansi_character * ptarget, const ::wd16_character * psource, strsize srclen);


CLASS_DECL_ACID void utf_to_utf(::ansi_character * ptarget, const ::wd32_character * psource, strsize srclen);


CLASS_DECL_ACID void utf_to_utf(::wd16_character * ptarget, const ::ansi_character * psource, strsize srclen);


CLASS_DECL_ACID void utf_to_utf(::wd32_character * ptarget, const ::ansi_character * psource, strsize srclen);


CLASS_DECL_ACID void utf_to_utf(::ansi_character * ptarget, const ::ansi_character * psource);


CLASS_DECL_ACID void utf_to_utf(::wd16_character * ptarget, const ::wd16_character * psource);


CLASS_DECL_ACID void utf_to_utf(::wd32_character * ptarget, const ::wd16_character * psource);


CLASS_DECL_ACID void utf_to_utf(::wd32_character * ptarget, const ::wd32_character * psource);


CLASS_DECL_ACID void utf_to_utf(::wd16_character * ptarget, const ::wd32_character * psource);


CLASS_DECL_ACID void utf_to_utf(::ansi_character * ptarget, const ::wd16_character * psource);


CLASS_DECL_ACID void utf_to_utf(::ansi_character * ptarget, const ::wd32_character * psource);


CLASS_DECL_ACID void utf_to_utf(::wd16_character * ptarget, const ::ansi_character * psource);


CLASS_DECL_ACID void utf_to_utf(::wd32_character * ptarget, const ::ansi_character * psource);
