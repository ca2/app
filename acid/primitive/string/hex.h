...
CLASS_DECL_ACID bool ishexdigit(char ch);
...
namespace hex
{
   ...
   CLASS_DECL_ACID string to_asc(const ::string & strHex);
   CLASS_DECL_ACID string from_asc(const string& strAsc);


   CLASS_DECL_ACID i64 to_i64(const ::scoped_string & scopedstr);

   CLASS_DECL_ACID u64 to_u64(const string & pcsz);

   CLASS_DECL_ACID u32 to_u32(const ::string & str);

   inline CLASS_DECL_ACID i32 to_nibble(char ch)
   {
   ...
   constexpr CLASS_DECL_ACID char nibble_lower_case_from(::u8 b)
   {
   ...
   constexpr CLASS_DECL_ACID char nibble_upper_case_from(::u8 b)
   {
   ...
   constexpr CLASS_DECL_ACID void lower_case_from(char * sz, ::u8 b)
   {
   ...
   constexpr CLASS_DECL_ACID void upper_case_from(char * sz, ::u8 b)
   {
   ...
   constexpr CLASS_DECL_ACID void lower_case_from(char * sz, const void * p, memsize s)
   {
   ...
   constexpr CLASS_DECL_ACID void upper_case_from(char * sz, const void * p, memsize s)
   {
       const u8 * pb = (const u8 *) p;
       while(s)
       {
