...
//#include "acid/operating_system/cross/windows/e.h"
...
#define ERROR_NO_UNICODE_TRANSLATION     1113L
      ...
      string CLASS_DECL_ACID multibyte_to_multibyte(::u32 uCodePageDest, ::u32 uCodePageSrc, const ::scoped_string & scopedstr)
      {
