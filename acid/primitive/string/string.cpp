...
#include "framework.h"
//#include "string.h"
//#include "acid/primitive/comparison/compare_elements.hh"



//template <  >
//CLASS_DECL_ACID iptr CompareElements<const string & >(const string * pelement1, const string *pelement2)
//{
//
...
CLASS_DECL_ACID ::string localization_get(const ::string & str)
{
...
CLASS_DECL_ACID void foo123()
{

   ::acid::get()->platform()->informationf("foo123");
