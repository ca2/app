...
#ifdef   _STDIO_H_
#error "already included?!?! WHAT?!?! (After including acid/primitive/string/string_base.h(1))"
#endif
#include "string_meta_data.h"
#ifdef   _STDIO_H_
#error "already included?!?! WHAT?!?! (After including acid/primitive/string/string_base.h(2))"
#endif
#include "const_string_range.h"
#ifdef   _STDIO_H_
#error "already included?!?! WHAT?!?! (After including acid/primitive/string/string_base.h(3))"
#endif
#include "string_range.h"
#ifdef   _STDIO_H_
#error "already included?!?! WHAT?!?! (After including acid/primitive/string/string_base.h(4))"
#endif
#include "mutable_string_range.h"
#ifdef   _STDIO_H_
#error "already included?!?! WHAT?!?! (After including acid/primitive/string/string_base.h(5))"
#endif
#include "acid/primitive/primitive/function.h"
#ifdef   _STDIO_H_
#error "already included?!?! WHAT?!?! (After including acid/primitive/string/string_base.h(A))"
#endif
//#include "acid/memory/string_memory_allocator.h"
#include "acid/memory/memory.h"
#ifdef   _STDIO_H_
#error "already included?!?! WHAT?!?! (After including acid/primitive/string/string_base.h(C))"
#endif
...
//   string_base & operator = (string_base && string_base) { NATURAL_POINTER::operator=(::transfer(string_base)); return *this; }
   ...
   //   template < int t_nSize >
     // inline string_base & operator=(const static_string<CHARACTER, t_nSize > & ansistrSrc);
      ...
      // for most relevant and proper acid types
...
CLASS_DECL_ACID ::string _(const string & str);
