// Created by camilo on 2022-04-26 06:56 <3ThomasBorregaardSorensen!!
#pragma once

//
//class CLASS_DECL_ACID string_block :
//   public block
//{
//public:
//
...
//   bool operator == (const ::scoped_string & scopedstr)const { return compare(psz) == 0; }
//   bool operator != (const ::scoped_string & scopedstr) const { return!operator==(psz); }
//
//
//
//
