...
//class string_buffer;
#include "acid/primitive/primitive/natural_pointer.h"
...
template < >
CLASS_DECL_ACID natural_meta_data < string_meta_data < ::ansi_character > > * __nil < natural_meta_data < string_meta_data < ::ansi_character > > >();

template < >
CLASS_DECL_ACID natural_meta_data < string_meta_data < ::wd16_character > > * __nil < natural_meta_data < string_meta_data < ::wd16_character > > >();

template < >
CLASS_DECL_ACID natural_meta_data < string_meta_data < ::wd32_character > > * __nil < natural_meta_data < string_meta_data < ::wd32_character > > >();
...
//#include "acid/memory/string_memory_allocator.h"
