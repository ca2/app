...
CLASS_DECL_ACID::i64 string_to_signed(const ::wd16_character * pwsz)
{
...
CLASS_DECL_ACID::u64 string_to_natural(const ::wd16_character * pwsz)
{
...
CLASS_DECL_ACID ::f64 string_to_floating(const ::wd16_character * pwsz)
{
