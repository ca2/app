...
CLASS_DECL_ACID int is_surrogated(u32 character)
{
...
::wd32_character* wd16_to_wd32(const ::wd16_character * input, strsize input_size)
{
   ...
   ::wd32_character* v = (::wd32_character*)::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(sizeof(::wd32_character) * (s + 1));
