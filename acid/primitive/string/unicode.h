...
#include "acid/primitive/collection/range.h"


#if WCHAR_T_SIZE == 16

CLASS_DECL_ACID wstring wd32_to_wd16_str(const ::wd32_character * pcwsz, strsize input_size = -1);

#endif

CLASS_DECL_ACID string wd16_to_ansi_str(const ::wd16_character * pwsz, strsize srclen = -1);

CLASS_DECL_ACID string wd32_to_ansi_str(const ::wd32_character * pwsz, strsize srclen = -1);



CLASS_DECL_ACID string         get_utf8_char(const ::ansi_character * psz);
...
CLASS_DECL_ACID utf8_character         unicode_to_utf8(i64 ch);
CLASS_DECL_ACID strsize        unicode_to_utf8_length(i64 ch);
i32            unicode_to_utf8_2_or_more(::ansi_character * dest, i32 ch);


CLASS_DECL_ACID const ::ansi_character * utf8_dec(const ::ansi_character * pszBeg, const ::ansi_character * psz);
...
CLASS_DECL_ACID ::i32 unicode_to_lower_case(::i32 i);
CLASS_DECL_ACID ::i32 unicode_to_upper_case(::i32 i);
...
CLASS_DECL_ACID string string_from_strdup(const ::ansi_character * psz);
