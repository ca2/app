...
//
//   ::wd16_character* v = (::wd16_character*)::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(sizeof(::wd16_character) * (s + 1));
//
...
// CLASS_DECL_ACID const char* yoshi_strcat(const ::ansi_character * psz1, const ::ansi_character * psz2, bool bFree2)
// {
...
//    char* psz = (char*)::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(iLen);
