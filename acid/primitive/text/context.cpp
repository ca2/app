...
#include "acid/primitive/string/parse.h"
...
//      return true;
   ...
   //      {
   //         ::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->free(m_szMerge);
   //      }
   //   }
   ...
   //               {
   //                  m_szMerge = (char *)::acid::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate(m_iMaxSize);
