// From acid/handler/item.h by camilo on 2023-08-10 16:43 <3ThomasBorregaardSorensen!!
#pragma once
...
//#pragma pack(pop, user_ITEM)
   ...
   //struct CLASS_DECL_ACID ITEM_BASE :
   //   public ::particle,
   //   public ::user::ITEM
   //{
   ...
   //class CLASS_DECL_ACID item_base :
   ...
   //struct CLASS_DECL_ACID item_data :
...
CLASS_DECL_ACID bool is_item_equivalent(const ::user::item * pitem1, const ::user::item * pitem2);
