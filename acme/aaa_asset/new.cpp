...
void* MEMORY_DECL operator __new(size_t nSize, const ::file::path & path, i32 nLine) new_throw_spec
{
...
void* MEMORY_DECL operator __new(size_t nSize, i32 nType, const ::file::path & path, i32 nLine)
{
