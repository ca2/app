...
class CLASS_DECL_ACME compress_bz:
...
public:
   ...
   compress_bz(::generic * pobject, int iBlockSize, int iVerbosity, int iWorkFactor);
   virtual ~compress_bz();
...
class CLASS_DECL_ACME uncompress_bz :
   virtual public ::generic
{
public:


   uncompress_bz(::generic * pobject);
