...
namespace acme
{
 ...
 /*  bool system::on_application_menu_action(const char * pszCommand)
   ...
   ::estatus system::initialize_system(::generic * pobject, app_core * pappcore)
   {
...
//#endif
   ...
   void system::discard_to_factory(__pointer(generic) pca)
   {
...
//#endif
   ...
   void system::on_allocation_error(const ::string & str, ::generic * pobject)
   {
...
//
//   ::estatus system::initialize_system(::generic* pobjectContext, ::app_core* pappcore)
//   {
//
