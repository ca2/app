...
namespace openssl
{
   ...
   ::pointer < ::crypto::hasher_algorithm > __create_hasher_algorithm(enum_hash ehash)
   {
      ...
      {
      case e_hash_md5:
         return allocateø < ::openssl::hasher_algorithm(ehash, EVP_md5 > ());
      case e_hash_sha1:
         return allocateø < ::openssl::hasher_algorithm(ehash, EVP_sha1 > ());
      case e_hash_sha256:
         return allocateø < ::openssl::hasher_algorithm(ehash, EVP_sha256 > ());
      default:
         return {};
      }
   ...
   ::pointer<::crypto::hasher>hasher_algorithm::create_hasher()
   {
      ...
      return allocateø ::openssl::hasher(this);
