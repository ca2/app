...
runtime_check_exception::runtime_check_exception(const ::e_status& estatus, const ::array_base < error_code > & errorcodea, const_char_pointer pszMessage, const_char_pointer pszDetails, int iSkip, void* caller_address) :
