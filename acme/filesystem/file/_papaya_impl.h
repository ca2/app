...
//template < typename TYPE, typename ARG_TYPE, typename ALLOCATOR, ::enum_type t_etypeContainer >
//inline stream & operator >>(stream & stream, ::base_array < TYPE, ARG_TYPE, TYPED, MEMORY, t_etypeContainer > & array)
//{
//
...
//      //{
//
//      //   array.set_size((::collection::count) cSerialized);
//
//      //}
//
//   }
...
//template < typename TYPE, typename ARG_TYPE, typename ALLOCATOR, ::enum_type t_etypeContainer >
//inline stream & operator <<(stream & stream, const ::base_array < TYPE, ARG_TYPE, TYPED, MEMORY, t_etypeContainer > & array)
//{
//
//   ::collection::count c = array.get_count();
//
//   stream << c;
//
