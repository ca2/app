...
//inline ::file_result elemental::get_reader(const ::var & varFile, const ::efileopen & efileopen)
//{
//
...
//
//
//inline ::file_result elemental::get_writer(const ::var & varFile, const ::efileopen & efileopen)
//{
//
