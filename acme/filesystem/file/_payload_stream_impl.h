...
//inline void __var_exchange(payload_stream & s, const ::atom & atom, const scoped_string & str) { s.write_only(atom, psz); }
...
//inline void __exchange(::payload_stream& s, const scoped_string & str) { s.write_only(psz); }
