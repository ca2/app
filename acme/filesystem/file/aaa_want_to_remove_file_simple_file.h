...
//
//
//   class CLASS_DECL_ACME simple_file :
...
//
//
//   void CLASS_DECL_ACME throw_exception(::generic * pobject, ::estatus cause,LONG lOsError,const char * pszFileName = NULL);
