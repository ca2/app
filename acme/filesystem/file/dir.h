...
//   CLASS_DECL_ACME void ls(::file::path_array_base& patha, const ::file::path& path);
//   CLASS_DECL_ACME void ls_dir(::file::path_array_base& patha, const ::file::path& path);
//   CLASS_DECL_ACME void ls_file(::file::path_array_base& patha, const ::file::path& path);
//   CLASS_DECL_ACME void rls(::file::path_array_base& patha, const ::file::path& path);
//   CLASS_DECL_ACME void rls_dir(::file::path_array_base& patha, const ::file::path& path);
//
//
