...
//CLASS_DECL_ACME bool file_put(const char * path, ::generic & s, ::acme::application * papp = nullptr);
//CLASS_DECL_ACME bool file_as(::generic & s, const char * path, ::acme::application * papp = nullptr);
