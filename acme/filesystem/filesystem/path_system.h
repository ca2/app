...
public:
   ...
   virtual ::string icloud_container_identifier(const_char_pointer psz_iCloudContainerIdentifier);
   
   virtual ::file::path defer_get_icloud_container_path(const ::file::path & path, const_char_pointer psz_iCloudContainerIdentifier);
   ...
   virtual  string from(const ::scoped_string & scopedstr);
   ...
   virtual ::file::path get_sequence_path(const ::file::path& path, ::collection::index iSequence, ::i32 iZeroPaddingWidth = 1);
   virtual void defer_free_name_by_renaming_to_last_in_sequence(const ::file::path& path, ::i32 iZeroPaddingWidth = 1);
