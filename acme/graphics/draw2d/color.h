...
CLASS_DECL_ACME COLORREF alpha_color(BYTE bAlpha, COLORREF cr);
CLASS_DECL_ACME COLORREF alpha_color(BYTE bAlpha, enum_color ecolor);
CLASS_DECL_ACME COLORREF opaque_color(COLORREF cr);
CLASS_DECL_ACME COLORREF pure_color(enum_color ecolor);
CLASS_DECL_ACME COLORREF opaque_color(enum_color ecolor);
