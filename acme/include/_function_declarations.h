...
CLASS_DECL_ACME ansichar * __u64toansi(::u64 u, ansichar * buf, int iBase, ansichar ansichTen);

CLASS_DECL_ACME ansichar * __i64toansi(::i64 u, ansichar * buf, int iBase, ansichar ansichTen);
