...
//#ifdef CORE_LEVEL
//extern "C"
//CLASS_DECL_ACME ::i32_bool defer_core_init();
//extern "C"
//CLASS_DECL_ACME ::i32_bool defer_core_term();
//
//#endif
...
::i32 main(Array < String ^ > ^ refstra)
{
   ...
   ap(acme_main_data) pmaindata = allocateø acme_main_data(refstra);
   ...
   return (::i32)acme_acme(pmaindata);
...
::i32 acme_main(::i32 argc, char_pointer argv[], char_pointer pszCommandLine, bool bConsole, bool bDraw2d);
...
//
//
//         pacme = allocateø class acme_acme ();
//
//         pmaindata = allocateø acme_main_data(hinstance, hPrevInstance, pCmdLine, nCmdShow);
//
//#ifdef MAIN_RUNNER0
//
