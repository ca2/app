...
console::console(int argc, wchar_t* argv[])
{
   ...
   PFN_NEW_ACME_APPLICATION pfnNewAuraApplication = &new_aura_application;

#else

   PFN_NEW_ACME_APPLICATION pfnNewAuraApplication = nullptr;

#endif

#ifdef ACID_LIBRARY

   PFN_NEW_ACME_LIBRARY pfnNewLibrary = &new_aura_library;
