//Created by camilo on 2021-07-24 01:05 BRT <3ThomasBorregaardSorensen!!
   ...
   CLASS_DECL_ACME void* _memory_allocate_debug(memsize nSize, ::i32 nBlockUse, const_char_pointer szFileName, ::i32 nLine);
   CLASS_DECL_ACME void* _memory_reallocate_debug(void* p, memsize nSize, ::i32 nBlockUse, const_char_pointer szFileName, ::i32 nLine);
