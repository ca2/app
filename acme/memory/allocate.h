...
// set allocateø< hook, return old  >(never nullptr)
//CLASS_DECL_ACME __ALLOC_HOOK __set_alloc_hook(__ALLOC_HOOK pfnAllocHook);


CLASS_DECL_ACME ::i32 __cdecl __alloc_alloc_hook(::i32 nAllocType, void * pvData, size_t nSize, ::i32 nBlockUse, long lRequest, const ::u8 * szFilename, ::i32 nLine);
...
CLASS_DECL_ACME ::i32 c_cdecl øallocate_handler(size_t /* nSize */);
