...
CLASS_DECL_ACME void * __alloc_memory_debug(size_t nSize, bool bIsObject,  const char * pszFileName, i32 nLine);

CLASS_DECL_ACME void __free_memory_debug(void * pbData, bool bIsObject);

CLASS_DECL_ACME bool __default_alloc_hook(size_t, bool, LONG);
...
//{
//   void (*m_pfn)(element*,void *);
//   void * m_pContext;
//};

//CLASS_DECL_ACME void __do_for_all_objects_proxy(void * pObject, void * pContext);
//CLASS_DECL_ACME void __do_for_all_objects(void (c_cdecl *pfn)(element*, void *), void * pContext);
