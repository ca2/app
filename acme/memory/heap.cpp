...
namespace heap
{
   ...
   void * heap::allocate_debug(memsize size, ::i32 nBlockUse, const_char_pointer pszFile, ::i32 iLine, const_char_pointer pszAnnotation)
   {
...
//#include "__aligned_memory_allocate.h"
   ...
   void * heap::aligned_allocate_debug(memsize nSize, memsize * psizeAllocated, ::i32 nBlockUse, const_char_pointer szFileName, ::i32 nLine, memsize align, const_char_pointer pszAnnotation)
   {
...
//#include "__unaligned_memory_allocate.h"
    ...
    void * heap::unaligned_allocate_debug(memsize nSize, memsize * psizeAllocated, ::i32 nBlockUse, const_char_pointer szFileName, ::i32 nLine, const_char_pointer pszAnnotation)
    {
   ...
   //#include "__memory_allocate.h"
    ...
    //void * heap::allocate_debug(memsize nSize, ::i32 nBlockUse, const_char_pointer szFileName, ::i32 nLine)
    //{
    ...
    void * heap::reallocate_debug(void * p, memsize nSize, ::i32 nBlockUse, const_char_pointer szFileName, ::i32 nLine, const_char_pointer pszAnnotation)
    {
