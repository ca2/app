...
//
//   auto pacmedirectory = this->platform()->acmedirectory();
//
//   this->platform()->acmefile()->put_contents(pacmedirectory->system() / "m.html", get_mem_info_report1());
//
//}
//
//#undef print
...
//{
//
//   g_pmutgen = ::place(new ::critical_section());
//
//}
//
//
