...
//
//   ::heap::management::memory(::heap::e_memory_main)->free(pmemory);
//
//#elif MEMDLEAK
//   memdleak_block * pblock = &((memdleak_block *)pmemory)[-1];
//
...
//}
//
//void ::heap::management::memory(::heap::e_memory_main)->free(void * p)
//{
...
//{
//
//   ::heap::management::memory(::heap::e_memory_main)->free(pvoid);
//
//}
//
//
