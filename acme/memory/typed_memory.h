...
namespace heap
{
   ...
   public:
      ...
      inline TYPE* allocate(::collection::count c, ::collection::count * pcAllocated, const_char_pointer pszFile, ::i32 iLine)
      {
   ...
   public:
      ...
      inline TYPE * allocate(::collection::count c, const_char_pointer pszFile, ::i32 iLine)
      {
