...
//
// // merged from nano::user::elemental by camilo on 
...
//
// nano::user::elemental Created by camilo on 31/01/2022 22:42 <3ThomasBorregaardSorensen!!
// From nano::user::elemental merged at ::user::elemental by
...
namespace nano
{
   ...
   namespace user
   {
      ...
      ::nano::user::theme * elemental::nano_user_theme()
      {
      ...
      ::nano::user::main_window * elemental::nano_user_main_window()
      {
...
/*      void elemental::hide_window()
      ...
      void elemental::on_char(int iChar)
      {
         ...
         //   auto iFind = m_elementalaChildren.find_first(nano_windowing_window()->m_pnanouserinteractionFocus);

         //   iFind++;

         //   nano_windowing_window()->m_pnanouserinteractionFocus = m_elementalaChildren % iFind;
      ...
      ::nano::user::elemental * elemental::hit_test(::user::mouse * pmouse, ::user::e_zorder ezorder)
      {
      ...
      ::nano::user::elemental * elemental::on_hit_test(const ::point_i32 & point, ::user::e_zorder ezorder)
      {
      ...
      void elemental::add_child(::nano::user::elemental * pelementalChild)
      {
      ...
      ::nano::user::elemental * elemental::get_child_by_id(const ::atom & atom)
      {
      ...
      void elemental::on_mouse_move(::user::mouse * pmouse)
      {
         ...
         if (nano_windowing_window()->m_pnanouserinteractionHover)
         {
            ...
            pelemental = nano_windowing_window()->m_pnanouserinteractionHover;
         ...
         if (nano_windowing_window()->m_pnanouserinteractionCapture)
         {
            ...
            pelemental = nano_windowing_window()->m_pnanouserinteractionCapture;
...
/*       void elemental::create_drawing_objects()
      ...
      ::nano::user::elemental * elemental::nano_user_parent()
      {
      ...
      ::collection::count elemental::nano_user_button_count()
      {
         ...
         for (auto & pelemental : m_elementalaChildren)
         {
            ...
            auto pbutton = pelemental.cast < ::nano::user::button >();
      ...
      ::nano::user::button * elemental::nano_user_button_at(::collection::index i)
      {
      ...
      //::nano::user::elemental * elemental::nano_user_interaction()
      //{
      ...
      //::nano::windowing::window * elemental::nano_windowing_window()
      //{
      ...
      //      __construct(nano_windowing_window());

      //   }

      //   return nano_windowing_window();
