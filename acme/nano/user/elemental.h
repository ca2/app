...
namespace nano
{
   ...
   namespace user
   {
      ...
      public:
         ...
         ::pointer < ::nano::user::elemental >        m_pelementalParent;
         pointer_array < ::nano::user::elemental >    m_elementalaChildren;
         ...
         virtual ::nano::user::main_window * nano_user_main_window();
         ...
         virtual ::nano::user::elemental * hit_test(::user::mouse * pmouse, ::user::e_zorder ezorder);
         virtual ::nano::user::elemental * on_hit_test(const ::point_i32 & point, ::user::e_zorder ezorder);
         virtual void add_child(::nano::user::elemental * pchild);
         virtual ::nano::user::elemental * get_child_by_id(const ::atom & atom);
...
/*     ~interaction_base() override;*/
         ...
         ::nano::user::elemental * nano_user_parent();
