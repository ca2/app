      ...
      /*
            ...
            if(keyPlugins.OpenKey(HKEY_LOcaL_MACHINE, "SOFTWARE\\MozillaPlugins", true))
            {
               ...
               if(keyPlugin.OpenKey(keyPlugins, "@ca2.cc/npca2", true))
               {
                  ...
                  keyPlugin.SetValue("Version", papplication->file_as_string(get_context()->dir().ca2("appdata/x86/ca2_build.txt")));
...
//      ::exception::throw_not_implemented();
   ...
   void os_context::enum_draw2d_fonts(::write_text::font_enum_item_array& itema)
   {
      ...
      string strSystemFonts = get_context()->file().as_string("/system/etc/system_fonts.xml");
