...
////                     string strParams;
////
////                     //if(get_context()->file().resolve_link(strTarget, strFilePath, ::acme::get_system()->ui_from_handle))
...
//   e_folder ios::get_folder_type(::matter * pobject, const char * pcsz)
//   {
//
...
//   e_folder ios::get_folder_type(::matter * pobject, const unichar * lpcszPath)
//   {
//
//      string strPath;
//
...
//   }
   ...
   shell::e_folder shell::get_folder_type(::matter * pobject, const char * lpcszPath)
   {
