...
//   e_folder ios::get_folder_type(::generic * pobject, const char * pcsz)
//   {
//
...
//   e_folder ios::get_folder_type(::generic * pobject, const unichar * lpcszPath)
//   {
//
//      string strPath;
//
...
//   }
   ...
   shell::e_folder shell::get_folder_type(::generic * pobject, const char * lpcszPath)
   {
