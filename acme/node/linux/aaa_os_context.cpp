...
//      __throw(not_implemented());
   ...
   bool os_context::create_service(::generic * pobject)
   {
   ...
   bool os_context::remove_service(::generic * pobject)
   {
//      __throw(not_implemented());
      return false;
   ...
   bool os_context::start_service(::generic * pobject)
   {
      //__throw(not_implemented());
      return false;
   ...
   bool os_context::stop_service(::generic * pobject)
   {
      __throw(not_implemented());
      return false;
