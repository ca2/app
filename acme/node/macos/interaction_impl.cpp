...
namespace macos
{
   ...
   ::acme::application * g_pappPreTranslateMouseMessage = nullptr;
   ...
   void CLASS_DECL_ACME __pre_init_dialog(::user::interaction * pWnd, LPRECT lpRectOld, DWORD* pdwStyleOld);

   void CLASS_DECL_ACME __post_init_dialog(::user::interaction * pWnd, const RECT& rectOld, DWORD dwStyleOld);
...
#define NSWindowStyleMaskMiniaturizable (1 << 2)
   ...
   bool interaction_impl::pre_create_window(::user::create_struct& cs)
   {
      /*      if (cs.lpszClass == nullptr)
       {
/xcore/app/acme/node/macos/macos_interaction_impl.cpp:712:44: No member named 'get_window_rect' in 'user::interaction_impl'       // make sure the default user::interaction class is registered
...
//
   ...
   void interaction_impl::_001OnCreate(::message::message * pmessage)
   {
      ...
      if(::is_null(g_pappPreTranslateMouseMessage))
      {
         ...
         g_pappPreTranslateMouseMessage = System.value("pre_translate_mouse_message").cast < ::acme::application >();
...
//
   ...
   public:
      ...
      print_window(::generic * pobject, oswindow hwnd, HDC hdc, DWORD tickTimeout) :
         ::generic(pobject)
...
//   }
   ...
   oswindow interaction_impl::UnsubclassWindow()
   {
      ...
      //      *lplpfn = nullptr;
      //
      //      // and Detach the oswindow from the user::interaction generic
      //      return Detach();
   }
...
//   __STATIC void CLASS_DECL_ACME __post_init_dialog(
...
//   }
   ...
   CLASS_DECL_ACME void hook_window_create(::user::interaction * pinteraction)
   {
