...
CLASS_DECL_ACME ::e_status command_system(string & strOutput, string & strError, int & iExitCode, const char* psz, const ::duration & durationTimeout = ::duration::infinite());
