...
//{
//   static_cast<int>(STATUS_GUARD_PAGE_VIOLATION),            /* 80000001 (STATUS_GUARD_PAGE_VIOLATION) */
//   ERROR_NOACCESS,                         /* 80000002 (STATUS_DATATYPE_MISALIGNMENT) */
//   static_cast<int>(STATUS_BREAKPOINT),                      /* 80000003 (STATUS_BREAKPOINT) */
//   static_cast<int>(STATUS_SINGLE_STEP),                     /* 80000004 (STATUS_SINGLE_STEP) */
...
//   static_cast<int>(STATUS_NONCONTINUABLE_EXCEPTION),        /* c0000025 (STATUS_NONCONTINUABLE_EXCEPTION) */
//   static_cast<int>(STATUS_INVALID_DISPOSITION),             /* c0000026 (STATUS_INVALID_DISPOSITION) */
...
//   static_cast<int>(STATUS_ARRAY_BOUNDS_EXCEEDED),           /* c000008c (STATUS_ARRAY_BOUNDS_EXCEEDED) */
//   static_cast<int>(STATUS_FLOAT_DENORMAL_OPERAND),          /* c000008d (STATUS_FLOAT_DENORMAL_OPERAND) */
//   static_cast<int>(STATUS_FLOAT_DIVIDE_BY_ZERO),            /* c000008e (STATUS_FLOAT_DIVIDE_BY_ZERO) */
//   static_cast<int>(STATUS_FLOAT_INEXACT_RESULT),            /* c000008f (STATUS_FLOAT_INEXACT_RESULT) */
//   static_cast<int>(STATUS_FLOAT_INVALID_OPERATION),         /* c0000090 (STATUS_FLOAT_INVALID_OPERATION) */
//   static_cast<int>(STATUS_FLOAT_OVERFLOW),                  /* c0000091 (STATUS_FLOAT_OVERFLOW) */
//   static_cast<int>(STATUS_FLOAT_STACK_CHECK),               /* c0000092 (STATUS_FLOAT_STACK_CHECK) */
//   static_cast<int>(STATUS_FLOAT_UNDERFLOW),                 /* c0000093 (STATUS_FLOAT_UNDERFLOW) */
//   static_cast<int>(STATUS_INTEGER_DIVIDE_BY_ZERO),          /* c0000094 (STATUS_INTEGER_DIVIDE_BY_ZERO) */
//   ERROR_ARITHMETIC_OVERFLOW,              /* c0000095 (STATUS_INTEGER_OVERFLOW) */
//   static_cast<int>(STATUS_PRIVILEGED_INSTRUCTION),          /* c0000096 (STATUS_PRIVILEGED_INSTRUCTION) */
...
struct errentry
{
   ...
   int sysv_errno;  /* get_system() V error code */
};
...
int windows_error_to_errno(int iWindowsError)
{
   ...
   for (size_t u = 0; u < ERRTABLESIZE; u++)
   {
      ...
      if (iWindowsError == errtable[u].oscode)
      {

         return errtable[u].sysv_errno;
...
int errno_to_windows_error(int iErrorNumber)
{

   for (size_t u = 0; u < ERRTABLESIZE; u++)
   {

      if (iErrorNumber == errtable[u].sysv_errno)
      {

         return errtable[u].oscode;
