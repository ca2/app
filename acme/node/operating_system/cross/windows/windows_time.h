...
CLASS_DECL_ACME int_bool FileTimeToSystemTime(const FILETIME *ft, LPSYSTEMTIME syst);
CLASS_DECL_ACME int_bool SystemTimeToFileTime(const SYSTEMTIME *syst, LPFILETIME ft);
