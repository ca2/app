...
//   }
   ...
   void nano_window::create()
   {
      ...
      cgrect.size.width = m_pinterface->m_rectangle.width();
      cgrect.size.height = m_pinterface->m_rectangle.height();
      cgrect.origin.x = m_pinterface->m_rectangle.left;
      cgrect.origin.y = m_pinterface->m_rectangle.bottom - cgrect.size.height;
