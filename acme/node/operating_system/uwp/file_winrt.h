...
CLASS_DECL_ACME ::Windows::Storage::StorageFile ^ get_os_file(const char * lpcszFileName, ::u32 dwDesiredAcces, ::u32 dwShareMode, LPSECURITY_ATTRIBUTES lpSA, ::u32 dwCreationDisposition, ::u32 dwFlagsAndAttributes, HANDLE hTemplateFile);
...
CLASS_DECL_ACME memsize read_buffer(void* p, ::Windows::Storage::Streams::IBuffer^ ibuf, memsize size = -1, memsize pos = 0);
