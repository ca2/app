...
void * __node_library_open(const char * pszPath, string & strMessage)
{
   ...
   strError = "\n (1) LoadLibraryW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
   ...
   strError = "\n (2) LoadLibraryW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
   ...
   strError = "\n (3) LoadLibraryW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
   ...
   strError = "\n (4) LoadLibraryW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
   ...
   strError = "\n (5) LoadLibraryW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
   ...
   strError = "\n (6) LoadLibraryW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
...
void * __node_library_touch(const char * pszPath, string & strMessage)
{
   ...
   strError = "\n (1) GetModuleHandleW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
   ...
   strError = "\n (2) GetModuleHandleW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
   ...
   strError = "\n (3) GetModuleHandleW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
   ...
   strError = "\n (4) GetModuleHandleW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
   ...
   strError = "\n (5) GetModuleHandleW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
   ...
   strError = "\n (6) GetModuleHandleW " + path + " failed with (" + __str(uiError) + ") " + get_last_error_message(uiError);
...
void * __node_library_open_ca2(const char * psz, string & strMessage)
{
   ...
   else
   {
      ...
      strMessage = "Failed to Load Library (2) " + string(psz) + " with error (" + __str(uiError) +
                   ")" + get_last_error_message(uiError);
