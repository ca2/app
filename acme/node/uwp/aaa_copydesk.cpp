...
CLASS_DECL_ACME bool node_save_image(Windows::Storage::Streams::IRandomAccessStream^ stream, ::image* pimage, ::save_image* psaveimage);

bool node_save_image(::image * pimage, Windows::Storage::Streams::IRandomAccessStream ^stream, ::acme::application * papp);


CLASS_DECL_ACME bool node_save_image(Windows::Storage::Streams::IRandomAccessStream ^ randomAccessStream, const ::image * pimage, ::save_image * psaveimage);
