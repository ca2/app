...
namespace uwp
{
   ...
   //::file::path dir_system::usersystemappdata(::generic * pobject, const string & strPrefix)
   //{
   ...
   //::file::path dir_system::userdata(::generic * pobject)
   //{
   ...
   //::file::path dir_system::userfolder(::generic * pobject)
   //{
   ...
   //::file::path dir_system::default_os_user_path_prefix(::generic * pobject)
   //{
   ...
   //::file::path dir_system::default_userappdata(::generic * pobject,const string & lpcszPrefix,const string & lpcszLogin)
   //{
   ...
   //::file::path dir_system::default_userdata(::generic * pobject,const string & lpcszPrefix,const string & lpcszLogin)
   //{
   ...
   //::file::path dir_system::default_userfolder(::generic * pobject,const string & strPrefix,const string & strLogin)
   //{
   ...
   //::file::path dir_system::userquicklaunch(::generic* pobject)
   //{
   ...
   //::file::path dir_system::userprograms(::generic* pobject)
   //{
   ...
   //bool dir_system::has_subdir(::generic* pobject, const ::file::path& pszDir)
   //{
