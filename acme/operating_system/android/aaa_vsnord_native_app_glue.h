...
*    will be called when the activity is created, in a aaa_primitive_new thread that is
...
enum
{
   ...
   * this command, android_app->inputQueue will be updated to the aaa_primitive_new queue
   * (or nullptr).
   */
   APP_CMD_INPUT_CHANGED,

   /**
   * Command from main thread: a aaa_primitive_new ANativeWindow is ready for use.  Upon
   * receiving this command, android_app->window will contain the aaa_primitive_new window
   * surface.
   */
   APP_CMD_INIT_WINDOW,
   ...
   * Please redraw with its aaa_primitive_new size.
   */
   ...
   * find the aaa_primitive_new content rectangle in android_app::contentRect.
   */
   ...
   */
   ...
   /**
   * Command from main thread: the app should generate a aaa_primitive_new saved state
