...
namespace ios
{
   ...
   ::collection::count ip_enum::enumerate(string_array_base & stra)
   {
      ...
      if (gethostname(szHostname, sizeof(szHostname)))
      {
         ...
         informationf("Failed in call to gethostname, errno returns %d\n", errno);
      ...
      if (phostent == nullptr)
      {
         ...
         informationf("Failed in call to gethostbyname, errno returns %d\n", errno);
