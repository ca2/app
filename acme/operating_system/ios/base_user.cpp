...
int _ui_MessageBoxA(const_char_pointer pszMessageParam, const_char_pointer pszHeaderParam, ::u32 uType, const_char_pointer pszDetails, ::function < void (enum_dialog_result) > function);


int _ui_MessageBoxA_sync(const_char_pointer pszMessageParam, const_char_pointer pszHeaderParam, ::u32 uType, const_char_pointer pszDetails);
...
int ui_MessageBoxA(const ::scoped_string & scopedstrMessage, const ::scoped_string & scopedstrTitle, ::u32 uType, const ::scoped_string & scopedstrDetails, ::function < void (enum_dialog_result) > function)
{
