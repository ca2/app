...
namespace linux
{
   ...
   bool copydesk::_get_plain_text(string & str)
   {
      ...
      ::pointer<clipboard_data>pdata = øallocate clipboard_data(get_app(), clipboard_get_plain_text);
   ...
   bool copydesk::_has_filea()
   {
      ...
      ::pointer<clipboard_data>pdata = øallocate clipboard_data(get_app(), clipboard_get_file_target_count);
   ...
   bool copydesk::_get_filea(::file::path_array & patha, e_op & eop)
   {
      ...
      ::pointer<clipboard_data>pdata = øallocate clipboard_data(get_app(), clipboard_get_patha);
   ...
   bool copydesk::_set_filea(const ::file::path_array & patha, e_op eop)
   {
      ...
      ::pointer<clipboard_data>pdata = øallocate clipboard_data(get_app(), clipboard_set_patha);
   ...
   bool copydesk::_desk_to_image(::image::image *pimage)
   {
      ...
      ::pointer<clipboard_data>pdata = øallocate clipboard_data(get_app(), clipboard_get_image);
