...
static const int_sz g_iszaMessageName[] =
{
   ...
   __message_entry(::user::e_message_reposition),
   __message_entry(::user::e_message_size),
   __message_entry(::user::e_message_activate),
   __message_entry(::user::e_message_set_focus),
   __message_entry(::user::e_message_kill_focus),
   __message_entry(::user::e_message_enable),
   __message_entry(::user::e_message_paint),
   __message_entry(::user::e_message_close),
   __message_entry(::user::e_message_quit),
   __message_entry(::user::e_message_erase_background),
   __message_entry(::user::e_message_show_window),
   __message_entry(::user::e_message_set_cursor),
   __message_entry(::user::e_message_mouse_activate),
   __message_entry(::user::e_message_measure_item),
   __message_entry(::user::e_message_non_client_create),
   __message_entry(::user::e_message_non_client_destroy),
   __message_entry(::user::e_message_non_client_calc_size),
   __message_entry(::user::e_message_non_client_hit_test),
   __message_entry(::user::e_message_non_client_paint),
   __message_entry(::user::e_message_non_client_activate),
   __message_entry(::user::e_message_non_client_mouse_move),
   __message_entry(::user::e_message_non_client_left_button_down),
   __message_entry(::user::e_message_non_client_left_button_up),
   __message_entry(::user::e_message_key_down),
   __message_entry(::user::e_message_key_up),
   __message_entry(::user::e_message_char),
   __message_entry(::user::e_message_dead_char),
   __message_entry(::user::e_message_sys_key_down),
   __message_entry(::user::e_message_sys_key_up),
   __message_entry(::user::e_message_sys_char),
   __message_entry(::user::e_message_sys_dead_char),
   __message_entry(::user::e_message_key_last),
   __message_entry(::user::e_message_command),
   __message_entry(::user::e_message_timer),
   __message_entry(::user::e_message_scroll_x),
   __message_entry(::user::e_message_scroll_y),
   __message_entry(::user::e_message_initialize_menu_popup),
   __message_entry(::user::e_message_mouse_wheel),
   ...
   __message_entry(::user::e_message_scroll_y),
   __message_entry(::user::e_message_scroll_x),
   __message_entry(::user::e_message_window_position_changed),
   __message_entry(::user::e_message_window_position_changing),
   // ca2 API specific messages
   __message_entry(::user::e_message_size_parent),
   __message_entry(::user::e_message_set_message_string),
   __message_entry(::user::e_message_idle_update_command_user_interface),
   __message_entry(::user::e_message_command_help),
   __message_entry(::user::e_message_help_hit_test),
   __message_entry(::user::e_message_exit_help_mode),
   __message_entry(::user::e_message_context_menu),
   __message_entry(::user::e_message_display_change),
#ifdef WINDOWS_DESKTOP
...
__message_entry(WM_SIZING),
__message_entry(WM_MOVING),
__message_entry(::user::e_message_capture_changed),
