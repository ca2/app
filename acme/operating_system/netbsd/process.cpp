...
static ::i32 g_iAudioFd = -1;
static ::i32 g_iExitCode = 0;
static audio_info_t g_audioinfoInitial;

::i32 get_global_audio_fd()
{
   return g_iAudioFd;
}
void set_global_audio_fd(::i32 iAudioFd)
{
   g_iAudioFd = iAudioFd;
}
::i32 get_global_exit_code()
{
   return g_iExitCode;
}
void set_global_exit_code(::i32 iExitCode)
{
...
extern "C" void netbsd_cleanup(::i32 signo)
{
