...
/*   XImage *                      m_pimage;
   ...
   virtual void create(oswindow window, ::i64 cx, ::i64 cy, ::i32 iStride = -1);
   virtual void destroy();

   virtual void update_window(oswindow window, color32_t * pOsBitmapData, const ::i32_rectangle * lpcrect, ::i32 iStride = -1);
