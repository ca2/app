...
CLASS_DECL_ACME const ::ansi_character * ansi_pbrk(const ::ansi_character * psz, const ::ansi_character * pszCharsToFind) { return strpbrk(psz, pszCharsToFind); }
...
//   if (::is_null(psz)) return nullptr;
//
//   auto pszDup = (::ansi_character *) ::heap::management::memory(::heap::e_memory_main)->allocate(strlen(psz) + 1);
//
//   strcpy(pszDup, psz);
//
//   return pszDup;
...
//   if (len < 0) return nullptr;
//
//   auto pszDup = (::ansi_character *)::heap::management::memory(::heap::e_memory_main)->allocate(len + 1);
//
...
//         }
//
//         ::heap::management::memory(::heap::e_memory_main)->free(pszDup);
//
//         return i;
//
//      }
...
//
//   auto * psz = (::ansi_character *)::heap::management::memory(::heap::e_memory_main)->allocate(len);
//
//   *psz = '\0';
//
//   if (len1 > 0)
