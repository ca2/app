...
//    ::wait(::winrt::Windows::ApplicationModel::Core::CoreApplication::MainView->CoreWindow->Dispatcher->RunAsync(::winrt::Windows::UI::Core::CoreDispatcherPriority::Normal, ref allocateø< ::winrt::Windows::UI::Core::DispatchedHandler ([=] >()
//    {

//       ::winrt::Windows::UI::Popups::MessageDialog ^ msg = ref allocateø< ::winrt::Windows::UI::Popups::MessageDialog(wstring(scopedstrMessage), wstring >(scopedstrTitle));
