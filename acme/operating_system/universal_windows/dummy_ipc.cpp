...
//
//         m_pp->result->ContentsChanged += ref __new< TypedEventHandler < ::winrt::Windows::Storage::Search::IStorageQueryResultBase ^,Object ^ >([this] >(::winrt::Windows::Storage::Search::IStorageQueryResultBase ^ result,Object ^ o)
//         {
//
