...
//
//template < >
//inline void waiter_null_result(::u32 & u)
//{
//   u = NULL;
//}
//
...
//
//
//   T wait(::u32 dwMillis = U32_INFINITE_TIMEOUT, ::winrt::Windows::Foundation::AsyncStatus * pstatus = nullptr)
//   {
//
...
//   void wait(PRED pred,::u32 dwMillis = U32_INFINITE_TIMEOUT, ::winrt::Windows::Foundation::AsyncStatus * pstatus = nullptr)
//   {
//
...
//
//
//   void wait(::u32 dwMillis = U32_INFINITE_TIMEOUT, ::winrt::Windows::Foundation::AsyncStatus * pstatus = nullptr)
//   {
//
//      auto pholdThis = this;
//
