...
//CLASS_DECL_ACME void __trace_message(const scoped_string & strPrefix, ::message::message * pmessage);

//CLASS_DECL_ACME void __trace_message(const scoped_string & strPrefix, MESSAGE * lpmsg);
