...
namespace universal_windows
{
   ...
   internal:
      ...
      ::winrt::Windows::Foundation::::i32_point                m_pointLastCursor;
      ...
      directx_framework_impact(::platform::system * psystem,String ^ strId);
      ...
      ::platform::system * get_context_system() const;
   ...
   public:
      ...
      virtual ::winrt::Windows::Foundation::::i32_point get_cursor_position() override;
   ...
   internal:
      ...
      directx_application_source(::platform::system * paxissystem,const ::scoped_string & scopedstrId);
   ...
   CLASS_DECL_ACME directx_application_source ^ new_directx_application_source(::platform::system * psystem, const ::scoped_string & scopedstr);
