...
//__STATIC void CLASS_DECL_ACME __pre_init_dialog(::pointer<::user::interaction>pWnd, ::rectangle_i32 * lpRectOld, unsigned int* pdwStyleOld);
//__STATIC void CLASS_DECL_ACME __post_init_dialog(::pointer<::user::interaction>pWnd, const RECT32& rectangleOld, unsigned int dwStyleOld);
