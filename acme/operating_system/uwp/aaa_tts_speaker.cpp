...
namespace universal_windows
{
   ...
   namespace tts
   {
      ...
      bool speaker::initialize(string strLang)
      {
         ...
         //
         ::winrt::Windows::Media::SpeechSynthesis::SpeechSynthesizer ^ psynth = ref aaa_primitive_new ::winrt::Windows::Media::SpeechSynthesis::SpeechSynthesizer();
         if (psynth == nullptr)
         {
...
//            m_synth[strLang]->();
      ...
      //actual creation of the stream using the aaa_primitive_new voice synthesis stream
