...
void * wayland_get_display(::particle * pparticle)
{

   auto pdisplay = ::wayland::display::get(pparticle, false);
...
void initialize_wayland_display(::particle * pparticle, void * pwaylanddisplay)
{
   ...
   ::wayland::display::get(pparticle, false, (::wl_display *) pwaylanddisplay);

}


void * initialize_wayland_display(::particle * pparticle)
{
