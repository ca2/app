...
////      }
   ...
   ::wayland::nano_window_base * display_base::_get_active_window(::thread * pthread)
   {
...
//      return pwindow;
   ...
   ::wayland::nano_window_base * display_base::get_keyboard_focus()
   {
...
//      return pwindow;
   ...
   ::wayland::nano_window_base * display_base::_window(::wl_surface * pwlsurface)
   {
   ...
   void display_base::destroy_wayland_buffer(wayland_buffer & waylandbuffer)
   {
   ...
   void display_base::update_wayland_buffer(wayland_buffer & waylandbuffer, const ::size_i32 & size)
   {
   ...
   void display_base::update_wayland_buffer(wayland_buffer & waylandbuffer, ::pixmap * ppixmap)
   {
...
//{
   ...
   void
   display_base::__handle_pointer_leave(::wl_pointer * pwlpointer, ::wayland::nano_window_base * pwaylandwindowLeave)
   {
