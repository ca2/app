...
namespace wayland
{
   ...
   public:
      ...
      ::pointer < ::wayland::nano_window_base > m_pwindowPointerEnter;
      ::pointer < ::wayland::nano_window_base > m_pwindowPointerCapture;
      ...
      virtual ::wayland::nano_window_base * get_keyboard_focus();

      virtual ::wayland::nano_window_base * _get_keyboard_focus();

      virtual ::wayland::nano_window_base * _get_active_window(::thread * pthread);
