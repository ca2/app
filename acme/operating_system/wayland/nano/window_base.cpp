...
namespace wayland
{
                                     ...
                                     const char * token)
   {
      ...
      auto pwaylandwindow = (nano_window_base *) data;
...
//   };
   ...
   {
      auto pwindow = (nano_window_base *) data;
   ...
   nano_window_base::nano_window_base()
   {
   ...
   void nano_window_base::__activate_window(bool bNormalPriority)
   {
...
//         }
   ...
   void nano_window_base::__handle_pointer_enter(::wl_pointer * pwlpointer)
   {
   ...
   void nano_window_base::__handle_pointer_motion(::wl_pointer * pwlpointer, ::u32 millis)
   {
...
////            }
   ...
   void nano_window_base::__handle_pointer_button(::wl_pointer * pwlpointer, ::u32 linux_button, ::u32 pressed, ::u32 millis)
   {
...
//      }
   ...
   void nano_window_base::__defer_update_wayland_buffer()
   {
      ...
      if(m_uLastConfigureSerial && m_waylandbuffer.m_size != m_sizeWindow)
      {
         ...
         pdisplaybase->destroy_wayland_buffer(m_waylandbuffer);

         pdisplaybase->update_wayland_buffer(m_waylandbuffer, m_sizeWindow);
   ...
   void nano_window_base::__defer_xdg_surface_ack_configure()
   {
   ...
   void nano_window_base::__handle_xdg_surface_configure(::u32 serial)
   {
...
//      }
   ...
   void nano_window_base::__handle_xdg_toplevel_configure(::i32 width, ::i32 height, ::wl_array * pwlarrayState)
   {
   ...
   void nano_window_base::_update_window()
   {
...
//         wl_callback_add_listener(m_pwlcallbackFrame, &frame_listener, this);
      ...
      ::copy_image32((::image32_t *) m_waylandbuffer.m_pdata,
                     m_waylandbuffer.m_size,
                     m_waylandbuffer.m_stride,
...
//      m_pwlcallbackFrame = wl_surface_frame(pwindow->m_pwlsurface);
   ...
   bool nano_window_base::_perform_entire_reposition_process()
   {
...
//      }
   ...
   bool nano_window_base::_perform_entire_resizing_process(::experience::enum_frame eframeSizing)
   {
   ...
   void nano_window_base::__handle_keyboard_enter(::wl_keyboard *pwlkeyboard, uint32_t serial, ::wl_array *pwlarrayKeys)
   {
   ...
   void nano_window_base::__handle_keyboard_leave(::wl_keyboard *pwlkeyboard, uint32_t serial)
   {
   ...
   void nano_window_base::__handle_keyboard_key(::wl_keyboard *pwlkeyboard, uint32_t serial, uint32_t time, uint32_t key, uint32_t pressed)
   {
...
//            m_puserinteractionimpl->message_handler(pkey);
   ...
   void nano_window_base::_on_simple_key_message(::user::e_key ekey, ::enum_message emesssage)
   {

   }


   void nano_window_base::_on_text_composition(const ::scoped_string & scopedstrText)
   {
   ...
   void nano_window_base::__handle_keyboard_modifiers(::wl_keyboard *keyboard, uint32_t serial, uint32_t mods_depressed, uint32_t mods_latched, uint32_t mods_locked, uint32_t group)
   {
   ...
   void nano_window_base::_on_windowing_close_window()
   {
