...
bool __os_init_thread()
{
   ...
   ////         ::message_box(nullptr,"Failed to ::CoInitializeEx(nullptr, COINIT_APARTMENTTHREADED) at __node_pre_init","__node_pre_init failure",::user::e_message_box_icon_exclamation);
   ...
   ////      ::message_box(nullptr,"Failed to ::CoInitializeEx(nullptr, COINIT_MULTITHREADED) at __node_pre_init","__node_pre_init failure",::user::e_message_box_icon_exclamation);
