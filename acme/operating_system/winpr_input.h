...
#define VK_LAUNCH_APP1      0xB6 /* Windows 2000/XP: Start papp 1 key */
#define VK_LAUNCH_APP2      0xB7 /* Windows 2000/XP: Start papp 2 key */
...
/* see Remark in KEYBDINPUT, SendInput, ::user::e_message_key_down, and ::user::e_message_key_up */
