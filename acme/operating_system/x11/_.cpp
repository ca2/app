...
CLASS_DECL_ACME void set_x11_itask(itask_t itask);


CLASS_DECL_ACME void set_x11_htask(htask_t htask);

CLASS_DECL_ACME void set_x11_thread(htask_t htask);
