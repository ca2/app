...
enum_synchronization_result WaitForSingleObject(HSYNC hsync, ::u32 dwMilliseconds);

enum_synchronization_result WaitForSingleObjectEx(HSYNC hsync, ::u32 dwMilliseconds, int_bool bAlertable);
