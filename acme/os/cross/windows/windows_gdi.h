...
typedef struct tagENHMETAHEADER
{
   ...
   SIZEL   szlDevice;          // Size of the generic device in pels
   SIZEL   szlMillimeters;     // Size of the generic device in millimeters
#if(WINVER >= 0x0400)
...
#endif /* WINVER >= 0x0400 */
#if(WINVER >= 0x0500)
   SIZEL   szlMicrometers;     // Size of the generic device in micrometers
#endif /* WINVER >= 0x0500 */
