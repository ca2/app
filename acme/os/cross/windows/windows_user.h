...
CLASS_DECL_ACME int_bool CopyRect(LPRECT prectDest, LPCRECT pcrectSrc);
CLASS_DECL_ACME int_bool PtInRect(LPCRECT prect, POINT point);
CLASS_DECL_ACME int_bool SetRect(LPRECT prect, i32 x1, i32 y1, i32 x2, i32 y2);
CLASS_DECL_ACME int_bool SetRectEmpty(LPRECT prect);
CLASS_DECL_ACME int_bool EqualRect(LPCRECT prect1, LPCRECT prect2);
CLASS_DECL_ACME int_bool InflateRect(LPRECT prect, i32 x, i32 y);
CLASS_DECL_ACME int_bool OffsetRect(LPRECT prect, i32 x, i32 y);
CLASS_DECL_ACME int_bool IntersectRect(LPRECT prect, LPCRECT prect1, LPCRECT prect2);
//CLASS_DECL_ACME int_bool x_intersect_rect(LPRECT prect, LPCRECT prect1, LPCRECT prect2);
//CLASS_DECL_ACME int_bool y_intersect_rect(LPRECT prect, LPCRECT prect1, LPCRECT prect2);
CLASS_DECL_ACME int_bool UnionRect(LPRECT prect, LPCRECT prect1, LPCRECT prect2);
CLASS_DECL_ACME int_bool SubtractRect(LPRECT prect, LPCRECT prect1, LPCRECT prect2);
...
CLASS_DECL_ACME int_bool IsRectEmpty(LPCRECT lpcrect);
