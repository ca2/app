...
//
   ...
   //g_source_set_callback(idle_source, &linux_start_system, (::acme::system *) m_psystem, nullptr);
...
CLASS_DECL_ACME void main_branch(::generic * prunnable, e_priority epriority)
{
