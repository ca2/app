...
CLASS_DECL_ACME void main_sync_runnable(::generic * pobjectRunnable, ::duration durationTimeout)
{

   __pointer(generic) prunnable = pobjectRunnable;
...
CLASS_DECL_ACME void main_async_runnable(::generic * prunnableParam)
{

   __pointer(generic) prunnable = prunnableParam;
