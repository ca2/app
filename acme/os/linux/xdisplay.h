...
CLASS_DECL_ACME i32 osdisplay_find(Display * pdisplay);
CLASS_DECL_ACME osdisplay_data * osdisplay_get(Display * pdisplay);
CLASS_DECL_ACME bool osdisplay_remove(Display * pdisplay);


class CLASS_DECL_ACME xdisplay
{
public:
