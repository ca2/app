...
namespace windows
{
   ...
   public:
	   ...
	   port_forward(::generic * pobject);
	   virtual ~port_forward();
	
	   virtual HRESULT ListenForUpnpChanges(::net::port_forward_change_callbacks *pCallbacks = nullptr);  // nullptr==default generic; if you provide your own pointer to a port_forward_change_callbacks-derived generic it is deleted for you automatically
