...
string module_path_from_pid(u32 pid)
{
   ...
   //   CloseHandle(hModuleSnap);           // clean the snapshot element
...
//CLASS_DECL_ACME bool launch_application(::element * pobject, const string & strAppId, const string & strParams, int iBitCount)
//{
//
//   ::file::path path;
//
