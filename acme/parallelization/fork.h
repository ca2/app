...
inline auto new_predicateicate_task(::particle * pparticle, PRED pred)
{
   ...
   return allocateø predicate_task < PRED >  (pparticle, pred);
...
//   {
//
//      auto ppredtask = allocateø forking_count_task < PRED > (iOrder, iOrder + iStart, iScan, iCount, pred, pobjectTaskEnd);
//
//      ppredtask->begin();
//
//   }
...
//   {
//
//      auto ppredtask = allocateø forking_for_task < PRED > (pobjectParent, iOrder, iOrder + iStart, iScan, iCount, pred);
//
...
//   {
//
//      auto ppredtask = allocateø predicate_task < PRED > (pobjectParent, pred);
//
