...
public:
   ...
   ::message_queue * get_message_queue(const class ::task_index & taskindex, bool bCreate);
   void erase_message_queue(const class ::task_index & taskindex);
   void clear_message_queue(const class ::task_index & taskindex);
