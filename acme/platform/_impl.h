...
//
//   ::matter* pobjectReceiver = dynamic_cast <::matter*> (preceiverDerived);
//
...
//   }
//
//   matter * preceiver = dynamic_cast <matter*>(preceiverDerived);
//
...
//inline void matter::set_context(::context* pcontext)
//{
//
...
//
//
//inline void matter::set_context_thread(::thread* pthread)
//{
//
...
//
//
//inline void matter::set_context_app(::acme::application* pappContext)
//{
//
...
//
//
//inline void matter::set_context_session(::acme::session* psessionContext)
//{
//
...
//
//
//inline void matter::set_context_system(::acme::system* psystemContext)
//{
//
