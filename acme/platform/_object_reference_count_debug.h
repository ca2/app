...
#define REF_DBG_POINTER (::particle *)(::iptr)1
#define REF_DBG_VAR (::particle *)(::iptr)1
#define REF_DBG_COMMA_POINTER , REF_DBG_POINTER
#define OBJECT_REFERENCE_COUNT_DEBUG_PARAMETERS_DEFINITION ::particle * pReferer, const char *pszObjRefDbg
#define OBJECT_REFERENCE_COUNT_DEBUG_PARAMETERS ::particle * pReferer = ((::particle*)(::iptr)1), const char *pszObjRefDbg = nullptr
#define OBJECT_REFERENCE_COUNT_DEBUG_COMMA_PARAMS_DEFINITION , OBJECT_REFERENCE_COUNT_DEBUG_PARAMETERS_DEFINITION
...
#define OBJECT_REFERENCE_COUNT_DEBUG_THIS ((::particle *) this)
#define OBJECT_REFERENCE_COUNT_DEBUG_COMMA_THIS , OBJECT_REFERENCE_COUNT_DEBUG_THIS
#define OBJECT_REFERENCE_COUNT_DEBUG_THIS_NOTE(note) ((::particle *) this), note
...
#define OBJECT_REFERENCE_COUNT_DEBUG_COMMA_PARAMS_DEFINITION
#define OBJECT_REFERENCE_COUNT_DEBUG_PARAMETERS_DEFINITION
