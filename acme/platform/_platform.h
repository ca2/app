...
namespace acme
{
   ...
   CLASS_DECL_ACME void format_strings(string& rString, const ::scoped_string & scopedstrFormat, const_char_pointer const* rgpsz, ::i32 nString);

   CLASS_DECL_ACME bool extract_sub_string(string& rString, const ::scoped_string & scopedstrFullString, ::i32 iSubString, ::i8 chSep = '\n');
