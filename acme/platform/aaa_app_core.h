...
// Not even aaa_primitive_new/delete/strings/ids can be used after it goes out of scope.
...
public:
   ...
   virtual void initialize_application(::platform::application * papp, ::object* pparticle);
