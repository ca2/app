...
namespace platform
{
   ...
   void acme_application_layer::application_on_status(::e_status estatus, ::particle* pparticle, long long ll, void* p)
   {
   }


   void acme_application_layer::on_error_icloud_not_available(::particle* pparticle, long long ll, void* p)
   {
   }
