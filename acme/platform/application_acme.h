...
// #endif
      ...
      virtual void application_on_status(::e_status estatus, ::particle * pparticle = nullptr, huge_integer hi = 0, void * p = nullptr);


      virtual void on_error_icloud_not_available(::particle * pparticle = nullptr, huge_integer hi = 0, void * p = nullptr);
