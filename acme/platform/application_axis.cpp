...
namespace platform
{
      ...
      ::pointer < ::geo::geo > axis_application_layer::create_geo()
      {
...
//      // void dump(dump_context & dumpcontext) const override;
      ...
      ::simpledb::server * axis_application_layer::simpledb()
      {
...
return nullptr;
      ...
      //virtual void set_locale(const ::scoped_string & scopedstr, const ::action_context & action_context);

      //virtual void set_schema(const ::scoped_string & scopedstr, const ::action_context & action_context);
...
*/
      ...
      ::account::user * axis_application_layer::get_user(::file::path pathUrl, bool bFetch, bool bInteractive)
      {
...
return nullptr;
      ...
      ::account::user * axis_application_layer::interactive_get_user(::file::path pathUrl)
      {
      ...
      ::account::user * axis_application_layer::noninteractive_get_user(::file::path pathUrl)
      {
   ...
   //    //::platform::type control_type_from_id(const ::atom& atom, ::user::enum_control_type& econtroltype) override;
