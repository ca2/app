...
inline bool is_equivalent_in_equivalence_sink(enum_display edisplay1, enum_display edisplay2) { return equivalence_sink(edisplay1) == equivalence_sink(edisplay2); }


inline bool is_docking_appearance(enum_display edisplay) { return edisplay > 0 && edisplay & e_display_docking_mask; }
