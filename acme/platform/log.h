...
namespace acme
{
   ...
   public:
      ...
      bool                                m_bTrace;
      __pointer(::acme::trace::trace)   m_ptrace;
      ::mutex                    m_mutexTrace;
      ...
      virtual void __tracea(::generic * pcontextobject, e_trace_level elevel, const char * pszFunction, const char * pszFileName, i32 iLine, const char * psz) override;
   ...
   CLASS_DECL_ACME i32 SimpleDebugReport(i32, const char *, i32, const char *, const char * pszFormat, va_list list);
