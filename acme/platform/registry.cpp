...
static Value *get_values_object(RegXKey *key, bool create) {
...
static Value *get_value_entry(RegXKey *key, const char *name, bool create) {
...
extern "C" int RegXOpen(const char *filename, RegX **out_reg) {
...
extern "C" int RegXFlush(RegX *reg) {
...
extern "C" void RegXClose(RegX *reg) {
    if (!reg) return;
    RegXFlush(reg);
    delete reg;
}
...
extern "C" int RegXCreateKey(RegX *reg, const char *path, RegXKey **out_key) {
...
extern "C" int RegXDeleteKey(RegX *reg, const char *path) {
    if (!reg || !path) return REGX_ERR_INVALID_ARG;
...
extern "C" int RegXSetString(RegXKey *key, const char *name, const char *value) {
...
extern "C" int RegXSetDword(RegXKey *key, const char *name, uint32_t value) {
...
extern "C" int RegXSetBinary(RegXKey *key, const char *name, const void *data, size_t size) {
...
extern "C" int RegXGetString(RegXKey *key, const char *name, char *buf, size_t *inout_len) {
...
extern "C" int RegXGetDword(RegXKey *key, const char *name, uint32_t *out_value) {
...
extern "C" int RegXGetBinary(RegXKey *key, const char *name, void *buf, size_t *inout_len) {
    if (!key || !name || !inout_len) return REGX_ERR_INVALID_ARG;
...
extern "C" int RegXDeleteValue(RegXKey *key, const char *name) {
    if (!key || !name) return REGX_ERR_INVALID_ARG;
...
extern "C" int RegXValueExists(RegXKey *key, const char *name) {
...
extern "C" int RegXGetValueType(RegXKey *key, const char *name, RegXType *out_type) {
...
extern "C" const char *RegXStrError(int status) {
    switch (status) {
