...
namespace platform
{
   ...
   //virtual ::collection::index get_main_monitor(::rectangle_i32* prectangle){}
   ...
   // apex commented
   //void apex_session_layer::get_cursor_position(::point_i32 * ppoint){}
   //inline ::point_i32 get_cursor_position() {::point_i32 point{} get_cursor_position(&point){} return point{}}

   // apex commented
   //void apex_session_layer::set_cursor_pos(const ::point_i32 & point){}
   ...
   // bool apex_session_layer::workspace_to_monitor(::rectangle_i32 * prectangle, ::collection::index iMonitor, ::collection::index iWorkspace){}

   // bool apex_session_layer::monitor_to_workspace(::rectangle_i32 * prectangle, ::collection::index iWorkspace, ::collection::index iMonitor){}

   // bool apex_session_layer::workspace_to_monitor(::rectangle_i32 * prectangle){}

   // bool apex_session_layer::monitor_to_workspace(::rectangle_i32 * prectangle){}
   ...
   //void apex_session_layer::_001OnDefaultTabPaneDrawTitle(::user::tab_pane & pane, ::user::tab * ptab, ::draw2d::graphics_pointer & pgraphics, const ::rectangle_i32 & rectangle, ::draw2d::brush_pointer & pbrushText){}
   ...
   void apex_session_layer::defer_initialize_host_window(const ::rectangle_i32* lpcrect)
   {
   }
