//
// Created by camilo on 2024-10-24 11:25 <3ThomasBorregaardSorensen!!
//
#include "framework.h"
...
namespace platform
{
   ...
   class ::fs::data* aura_session_layer::fs()
   {
return nullptr;
   ...
   bool aura_session_layer::on_create_frame_window()
   {
      return false;
   }
   ...
   void aura_session_layer::on_finally_focus_set(::user::interaction_base* pelementalFocus)
   {
   }
   ...
   ::user::interaction_base* aura_session_layer::get_bound_ui(::atom idImpact)
   {
   ...
   void aura_session_layer::on_show_user_input_popup(::user::interaction* pinteraction)
   {
   ...
   ::write_text::font_list* aura_session_layer::get_single_column_font_list()
   {
   ...
   ::user::interaction* aura_session_layer::get_request_parent_ui(::user::interaction* pinteraction, ::request* prequest)
   {
   ...
   bool aura_session_layer::place(::user::main_frame* pmainframe, ::request* prequest)
   {
