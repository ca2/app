...
namespace platform
{
   ...
   ::thread_storage* system::_thread_storage_unlocked(const ::task_index& taskindex)
   {
      ...
      auto ppairThreadStorage = m_mapThreadStorage.find(taskindex);
   ...
   void system::on_initialize_particle()
   {
      ...
      //m_pcleanuptask = allocateø  ::parallelization::cleanup_task();
   ...
   ::platform::system_factory* system::system_factory()
   {
      ...
      if (!m_psystemfactory)
      {
         ...
         construct_newø(m_psystemfactory);
   ...
   void system::create_os_node(::platform::application* papplication)
   {
      ...
      papplication->constructø(m_pnode);
   ...
   ::platform::remoting * system::remoting()
   {
...
void system::open_internet_link(const ::scoped_string & scopedstrUrl, const ::scoped_string & scopedstrProfile, const ::scoped_string & scopedstrTarget)
   ...
   //      //auto pmessageboxpayload = __initialize_new ::message_box_payload(exception.m_strMessage, m_strAppId, e_message_box_ok, exception.m_strDetails);
   ...
   void system::report_system_instance()
   {
      ...
      if (strAppId.has_character())
      {
         ...
         file_system()->put_contents(path, this->command_line_text());
...
//      }
   ...
   void system::post(const ::procedure& procedure)
   {
