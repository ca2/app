...
//      }
     ...
     virtual::prototype::prototype * prototype() override;
      ...
      ::pointer<BASE_TYPE> create(const ::scoped_string & scopedstrComponent, const ::scoped_string & scopedstrImplementation)
      {
         ...
         auto & pfactory = this->factory(scopedstrComponent, scopedstrImplementation);
...
//   }
      ...
      virtual void on_open_file(const ::scoped_string & scopedstrFile) override;
      ...
      virtual string get_latest_deployment_number(const ::scoped_string & scopedstrBranch) override;
