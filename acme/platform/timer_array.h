...
namespace acme
{
   ...
   public:
      ...
      virtual bool create_timer(::object * pobject, uptr uEvent, ::millisecond millisEllapse, PFN_TIMER pfnTimer = nullptr, bool bPeriodic = true, void * pvoidData = nullptr);
      virtual bool delete_timer(uptr uEvent);

      virtual bool set_timer(::object * pobject, uptr uEvent, ::millisecond millisEllapse, PFN_TIMER pfnTimer = nullptr, bool bPeriodic = true, void * pvoidData = nullptr);
