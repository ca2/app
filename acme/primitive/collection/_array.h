...
namespace acme
{
   ...
   namespace array
   {
      ...
      ////inline ::index add(string_array & stra, const ::scoped_string & scopedstr) { return stra.add_item(psz); }
      ...
      ////inline ::index add(::file::path_array & patha, const ::scoped_string & scopedstr) { return patha.add_item(psz); }
