...
namespace test_compilation_some_container_functions
{
   ...
   //void test_compilation_some_quick_sort_functions()
   //{

   //   compare_interface compareinterface;

   //   ::generic::container::quick_sort(compareinterface.m_ia, &compareinterface, &compare_interface::_001Compare);
