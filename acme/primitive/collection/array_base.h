...
const TYPE ** ITEM ## _data() const { return (TYPE **) CONTAINER.get_data(); } \
...
public:
   ...
   void on_destruct_element(TYPE * p OBJ_REF_DBG_COMMA_PARAMS) { ALLOCATOR::destruct(p  OBJ_REF_DBG_COMMA_ARGS); }
