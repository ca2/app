...
public:
   ...
   //inline auto ptra(::collection::index iStart = 0, ::collection::index iEnd = -1) const { return ARRAY_BASE::values(iStart, iEnd); }

   //inline auto values(::collection::index iStart = 0, ::collection::index iEnd = -1) { return ref_iterator(iStart, iEnd, this); }

   //inline auto values(::collection::index iStart = 0, ::collection::index iEnd = -1) const { return const_ref_iterator(iStart, iEnd, this); }
   ...
   //ref_iterator_range refa(::collection::index iStart = 0, ::collection::count cCount = -1) { return ref_iterator(ref_it(iStart), ref_it(iStart, cCount)); }
   ...
   TYPE& first_ref(::collection::index n = 0) const
   {
   ...
   TYPE& first_ref(::collection::index n = 0)
   {
   ...
   TYPE& last_ref(::collection::index n = -1) const
   {
   ...
   TYPE& last_ref(::collection::index n = -1)
   {
