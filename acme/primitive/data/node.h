...
namespace data
{
   ...
   public:
      ...
      payload attribute(const ::scoped_string & scopedstr) const { return m_set[scopedstr]; }
      ::property& attribute(const ::scoped_string & scopedstr) { return m_set[scopedstr]; }



      node* node_at(::collection::index i) { return m_nodea[i]; }
      ::collection::count get_node_count() const { return m_nodea.get_count(); }
