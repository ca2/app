...
//                     || (pcontext != nullptr && pcontext->m_pcontext->matches(idCalendarDay,strText1))
//                     || (pcontext != nullptr && pcontext->m_pcontext->matches(idCalendarDays,strText1)))
//               {
//                  span.m_iDay = atoi(strNumber);
//               }
//               else if(strText1 == "week" || strText1 == "weeks"
//                       || (pcontext != nullptr && pcontext->m_pcontext->matches(idCalendarWeek,strText1))
//                       || (pcontext != nullptr && pcontext->m_pcontext->matches(idCalendarWeeks,strText1)))
//               {
//                  span.m_iDay = atoi(strNumber) * 7;
//               }
//               else if(strText1 == "hour" || strText1 == "hours" || strText1 == "hora" || strText1 == "horas"
//                       || (pcontext != nullptr && pcontext->m_pcontext->matches(idCalendarHour,strText1))
//                       || (pcontext != nullptr && pcontext->m_pcontext->matches(idCalendarHour,strText1)))
//               {
//                  span.m_iHour = atoi(strNumber);
//               }
//               else if(strText1 == "year" || strText1 == "years"
//                       || (pcontext != nullptr && pcontext->m_pcontext->matches(idCalendarYear,strText1))
//                       || (pcontext != nullptr && pcontext->m_pcontext->matches(idCalendarYears,strText1)))
//               {
//                  span.m_iYear = atoi(strNumber);
//               }
//               else if(strText1 == "now"
//                       || (pcontext != nullptr && pcontext->m_pcontext->matches(idCalendarNow,strText1)))
//               {
...
//            (pcontext != nullptr && pcontext->m_pcontext->begins_eat(str,"calendar:today"))))
//      {
...
//            (pcontext != nullptr && pcontext->m_pcontext->begins_eat(str,"calendar:tomorrow"))))
//      {
//         time = ::datetime::time::get_current_time();
//         time = ::datetime::time(time.GetYear(),time.GetMonth(),time.GetDay(),0,0,0);
...
//            (pcontext != nullptr && pcontext->m_pcontext->begins_eat(str,"calendar:yesterday"))))
//      {
//         time = ::datetime::time::get_current_time();
//         time = ::datetime::time(time.GetYear(),time.GetMonth(),time.GetDay(),0,0,0);
//         time -= ::datetime::time_span(1,0,0,0);
...
//            (pcontext != nullptr && pcontext->m_pcontext->begins_eat(str,"calendar:now"))))
//      {
//         
//         time = ::datetime::time::get_current_time();
//         
