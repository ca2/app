...
namespace datetime
{
   ...
   public:
      ...
      time_span(const ::millisecond & millisecond) noexcept;
   ...
   inline time_span::time_span(const ::millisecond & millisecond) noexcept :
      m_timeSpan(millisecond.integral_second())
   {
   }
