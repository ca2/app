...
inline floating_microsecond operator "" _us(long double d) { return (FLOATING_MICROSECOND)d; }
inline floating_microsecond operator "" _μs(long double d) { return (FLOATING_MICROSECOND)d; }
