...
inline ::pointer<___shape<HOLDEE >> __create_shape(const enum_shape & eshape)
{
   ...
   case e_shape_begin_clip:
      return ::place(new begin_clip_shape<HOLDEE> ());
   case e_shape_intersect_clip:
      return ::place(new intersect_clip_shape<HOLDEE> ());
   case e_shape_begin_figure:
      return ::place(new begin_figure_shape<HOLDEE> ());
   case e_shape_close_figure:
      return ::place(new close_figure_shape<HOLDEE> ());
   case e_shape_end_figure:
      return ::place(new end_figure_shape<HOLDEE> ());
   default:
