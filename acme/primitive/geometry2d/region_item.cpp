...
namespace geometry2d
{
   ...
   void region::item::max_bounding_box(::rectangle_f64 & rectangle)
   {
   ...
   void region::rectangle_item::max_bounding_box(::rectangle_f64 & rectangle)
   {
   ...
   void region::ellipse_item::max_bounding_box(::rectangle_f64 & rectangle)
   {
   ...
   void region::polygon_item::max_bounding_box(::rectangle_f64 & rectangle)
   {
   ...
   void region::poly_polygon_item::max_bounding_box(::rectangle_f64 & rectangle)
   {
   ...
   void region::combine_item::max_bounding_box(::rectangle_f64 & rectangle)
   {
      // "fake" implementation

      m_pregion1->max_bounding_box(rectangle);
      m_pregion2->max_bounding_box(rectangle);
   ...
   void region::round_rectangle_item::max_bounding_box(::rectangle_f64 & rectangle)
   {
