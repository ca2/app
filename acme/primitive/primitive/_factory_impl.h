...
namespace factory
{
   ...
   //         ::output_debug_string("loading into existing generic of same class type (1)");
   ...
   //            ::output_debug_string("allocated generic type is different from streamed generic type (1.2)");
   ...
   //         ::output_debug_string("loading into existing generic of same class type (2)");
   ...
   //            ::output_debug_string("allocated generic type is different from streamed generic type (2.2)");
...
inline __pointer(BASE_TYPE) __create()
{
   ...
   __pointer(::generic) ptypeNew = pfactory->call_new();
...
template < typename BASE_TYPE >
inline __pointer(BASE_TYPE) __create(::generic * pobject)
{
...
template < typename TYPE >
inline __pointer(TYPE) __create_new(::generic * pobjectContext)
{
