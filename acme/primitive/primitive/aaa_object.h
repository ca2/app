...
//#endif
   ...
   //virtual void message_box_timeout(const ::string & pszMessage, const ::string & pszTitle = nullptr, const ::duration & durationTimeout = ::duration::infinite(), const ::e_message_box & emessagebox = e_message_box_ok, const ::future & process = ::future());
   //{
   ...
   //virtual ::image_pointer load_matter_image(const ::string & pszMatter, bool bSync = true, bool bCache = true, bool bCreateHelperMaps = false);
   ...
   //virtual ::image_pointer load_thumbnail(const ::string & pszPath);
...
//   }
   ...
   virtual void add_composite(::element * pelement OBJECT_REFERENCE_COUNT_DEBUG_COMMA_PARAMS) override;
   virtual void add_reference(::element * pelement OBJECT_REFERENCE_COUNT_DEBUG_COMMA_PARAMS) override;


   virtual void release_composite2(::element * pelement OBJECT_REFERENCE_COUNT_DEBUG_COMMA_PARAMS) override;
   virtual void finalize_composite(::element * pelement OBJECT_REFERENCE_COUNT_DEBUG_COMMA_PARAMS) override;
   virtual void release_reference(::element * pelement OBJECT_REFERENCE_COUNT_DEBUG_COMMA_PARAMS) override;
...
CLASS_DECL_APEX void call_sync(const ::routine_array & routinea);
