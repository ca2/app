...
public:
   ...
   virtual ::file_transport get_writer(const ::payload& varFile, const ::file::e_open & eopen = ::file::e_open_write | ::file::e_open_binary | ::file::e_open_defer_create_directory | ::file::e_open_no_truncate | ::file::e_open_create);
