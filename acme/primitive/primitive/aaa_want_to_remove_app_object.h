...
public:
   ...
   virtual ::generic * get_object() const;
   ...
   virtual ::generic * source_channel() override;
   ...
   virtual void set_trait_result(::u64 uId, ::u64 uTrait, ::generic * preference);
   ...
   generic & operator =(const ::trait & trait)
   {
