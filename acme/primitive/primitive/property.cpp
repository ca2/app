...
//}
//
//bool property::array_contains(const ::scoped_string & scopedstr, index first, index last) const
//{
//   return array_contains(psz, first, last);
//}
//
//bool property::array_contains_ci(const ::scoped_string & scopedstr, index first, index last) const
//{
...
void on_property_construct(property * pproperty)
{
   ...
   infomration("prop" + as_string(g_interlockedcountProperty.operator i64()) + "\n");
...
void on_property_destruct(property* pproperty)
{
   ...
   if (g_propertya.get_size() % 100 == 0)
   {
      ...
      infomration("PROPS("+as_string(g_propertya.get_size())+")\n");
      ...
      for (auto p : g_propertya)
      {
         ...
         infomration("prop(\"" + p->m_atom.to_string() + "\")=\""+p->to_string()+"\";\n");
