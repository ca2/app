...
//    - plus: doesn't generic parent property set? m_ppropertyset
//class CLASS_DECL_ACME property : public var
...
////   //property(property_set * pset, const id & strName, const var & var, ::generic * pobject = nullptr);
