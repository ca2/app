...
CLASS_DECL_ACME ::string __string(const ansichar & ch);
CLASS_DECL_ACME ::string __string(const uchar & uch);


CLASS_DECL_ACME ::string __string(const i16 & i);
CLASS_DECL_ACME ::string __string(const u16 & i);
...
CLASS_DECL_ACME ::string __string(const unsigned long int & ul);
