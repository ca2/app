...
inline i32 __unicode_index(const char *& input, strsize * psrclen)
{
...
inline i32 unicode_index_len(const ansichar * pszUtf8, ::i32 & len)
{
...
//inline void string_assign(string & t, const ansichar * psz)
//{
//   t.assign(psz);
//}
//
//inline void string_assign(string & t, const widechar * psz)
//{
...
//}
//
//inline void string_assign(string & t, const string * pstr)
//{
//   t = *pstr;
//}
//
//inline void string_assign(string & t, const wstring * pwstr)
//{
...
inline i32 unicode_len(const ansichar * pszUtf8)
{
   ...
   if (unicode_index_len(pszUtf8, len) < 0)
   {
