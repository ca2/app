...
//CLASS_DECL_ACME const char* yoshi_strcat(const char* psz1, const char* psz2, bool bFree2 = false);
...
const char* wildcard_next_stop(const char* pszCriteria)
{
   ...
   CLASS_DECL_ACME int_bool matches_wildcard_criteria_dup(const char* pszCriteriaParam, const char* pszValue)
   {
      ...
      while (true)
      {
         ...
         {
            __throw(error_invalid_argument, "not_expected, check wildcard_next_stop function");
         }
   ...
   //CLASS_DECL_ACME const char* ansi_concatenate_and_duplicate(const char* psz1, const char* psz2)
   //{
   ...
   //CLASS_DECL_ACME const char* strcat_and_dup2(const char* psz1, const char* psz2)
   //{
