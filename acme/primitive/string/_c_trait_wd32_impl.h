...
inline i32 __wd32charishexadecimal(i32 i) { return wd32_char_is_digit(i) || (i >= 'a' && i <= 'f') || (i >= 'A' && i <= 'F'); }
inline i32 __wd32charisalphabetic(i32 i) { return (i >= 'a' && i <= 'z') || (i >= 'A' && i <= 'Z'); }
inline i32 __wd32charisalphanumeric(i32 i) { return wd32_char_is_alphabetic(i) || wd32_char_is_digit(i); }
