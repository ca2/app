...
inline ::std::strong_ordering _sz_count_compare(const CHARACTER * pA, const CHARACTER * pB, strsize sizeB, ORDERING ordering) noexcept
{
   ...
   while (true)
   {
      ...
      auto ordering = comparison.order(*pA, *pB);
...
constexpr ::std::strong_ordering _sz_count_compare(const CHARACTER * pA, const CHARACTER * pB, strsize sizeB) noexcept
{
   ...
   return _sz_count_compare(pA, pB, sizeB, compare_const_reference<CHARACTER>);
...
constexpr ::std::strong_ordering _count_sz_compare(const CHARACTER * pA, strsize sizeA, const CHARACTER * pB) noexcept
{
   ...
   return _count_sz_compare(pA, sizeA, pB, compare_const_reference<CHARACTER>);
...
template < typename ITERATOR_TYPE >
inline string_base < ITERATOR_TYPE > & string_base < ITERATOR_TYPE >::operator+=(const ansi_string & ansistrSrc)
{
...
template < typename ITERATOR_TYPE >
inline string_base < ITERATOR_TYPE > & string_base < ITERATOR_TYPE >::operator+=(const wd16_string & wd16strSrc)
{
...
template < typename ITERATOR_TYPE >
inline string_base < ITERATOR_TYPE > & string_base < ITERATOR_TYPE >::operator+=(const wd32_string & wd32strSrc)
{
...
template < typename ITERATOR_TYPE >
template < primitive_character CHARACTER2 >
inline string_base < ITERATOR_TYPE > & string_base < ITERATOR_TYPE >::assign(const ::string_range < const CHARACTER2 * > & range)
{

   this->assign(range.data(), range.size());
...
template < typename ITERATOR_TYPE >
inline string_base < ITERATOR_TYPE > & string_base < ITERATOR_TYPE >::append(::const_ansi_range ansirange)
{
...
template < typename ITERATOR_TYPE >
inline string_base < ITERATOR_TYPE > & string_base < ITERATOR_TYPE >::append(::const_wd16_range wd16range)
{
...
template < typename ITERATOR_TYPE >
inline string_base < ITERATOR_TYPE > & string_base < ITERATOR_TYPE >::append(::const_wd32_range wd32range)
{
...
inline ::std::strong_ordering string_base < ITERATOR_TYPE > ::case_insensitive_order(RANGE range, strsize len) const noexcept
{
   ...
   return ::string_range < const CHARACTER * >(*this).order({ range.begin(), minimum(range.size(), len) }, compare_character_ci<const CHARACTER >);
...
template < typename ITERATOR_TYPE >
inline ::std::strong_ordering string_base < ITERATOR_TYPE > ::order(strsize iStart, strsize iCount, RANGE range) const noexcept
{
   ...
   return string_compare(this->begin() + iStart, iCount, range.begin(), range.size());

}


template < typename ITERATOR_TYPE >
inline ::std::strong_ordering string_base < ITERATOR_TYPE > ::case_insensitive_order(strsize iStart, strsize iCount, RANGE range) const noexcept
{
   ...
   return case_insensitive_string_order(this->begin() + iStart, iCount, range.begin(), range.size());

}


template < typename ITERATOR_TYPE >
inline ::std::strong_ordering string_base < ITERATOR_TYPE > ::collate(strsize iStart, strsize iCount, RANGE range) const noexcept
{
   ...
   return string_collate(this->begin() + iStart, iCount, range.begin(), range.size());
...
template < typename ITERATOR_TYPE >
inline ::std::strong_ordering string_base < ITERATOR_TYPE > ::case_insensitive_collate(strsize iStart, strsize iCount, RANGE range) const noexcept
{
   ...
   return case_insensitive_string_collate(this->begin() + iStart, iCount, range.begin(), range.size());
...
template < typename ITERATOR_TYPE >
inline ::std::strong_ordering string_base < ITERATOR_TYPE > ::order(strsize iStart, strsize iCount, RANGE range, strsize iStart2, strsize iCount2) const noexcept
{
   ...
   return string_compare(this->begin() + iStart, iCount, range.begin() + iStart2, iCount2);

}


template < typename ITERATOR_TYPE >
inline ::std::strong_ordering string_base < ITERATOR_TYPE > ::case_insensitive_order(strsize iStart, strsize iCount, RANGE range, strsize iStart2, strsize iCount2) const noexcept
{
   ...
   return case_insensitive_string_order(this->begin() + iStart, iCount, range.begin() + iStart2, iCount2);

}


template < typename ITERATOR_TYPE >
inline ::std::strong_ordering string_base < ITERATOR_TYPE > ::collate(strsize iStart, strsize iCount, RANGE range, strsize iStart2, strsize iCount2) const noexcept
{
   ...
   return string_collate(this->begin() + iStart, iCount, range.begin() + iStart2, iCount2);

}


template < typename ITERATOR_TYPE >
inline ::std::strong_ordering string_base < ITERATOR_TYPE > ::case_insensitive_collate(strsize iStart, strsize iCount, RANGE range, strsize iStart2, strsize iCount2) const noexcept
{
   ...
   return case_insensitive_string_collate(this->begin() + iStart, iCount, range.begin() + iStart2, iCount2);
...
template < typename ITERATOR_TYPE >
inline string_base < ITERATOR_TYPE >  string_base < ITERATOR_TYPE > ::unichar_left(strsize nCount) const
{
...
template < typename ITERATOR_TYPE >
inline string_base < ITERATOR_TYPE >  string_base < ITERATOR_TYPE > ::unichar_mid(strsize iFirst, strsize nCount) const
{
...
//template < typename ITERATOR_TYPE >
//inline strsize string_base < ITERATOR_TYPE > ::erase(strsize iIndex, strsize nCount)
//{
//
...
template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > string_base < ITERATOR_TYPE >::Tokenize(RANGE rangeTokens, strsize & iStart) const
{
   ASSERT(iStart >= 0);
   ...
   if ((rangeTokens == nullptr) || (*rangeTokens == (char)0))
   {
      if (iStart < size())
      {
         return(string_base < ITERATOR_TYPE >(this->begin() + iStart));
      }
   }
   else
   {
      const CHARACTER * pszPlace = this->begin() + iStart;
...
//
//template < typename ITERATOR_TYPE >
//i32 string_base < ITERATOR_TYPE >::order(strsize iStart, strsize nCount, const CHARACTER* psz) const
//{
//   return substr(iStart, nCount).order(psz);
//}
//
//template < typename ITERATOR_TYPE >
//i32 string_base < ITERATOR_TYPE >::case_insensitive_order(strsize iStart, strsize nCount, const CHARACTER* psz) const
//{
//   return substr(iStart, nCount).case_insensitive_order(psz);
//}
//
//template < typename ITERATOR_TYPE >
//i32 string_base < ITERATOR_TYPE >::collate(strsize iStart, strsize nCount, const CHARACTER* psz) const
//{
//   return substr(iStart, nCount).collate(psz);
//}
//
//template < typename ITERATOR_TYPE >
//i32 string_base < ITERATOR_TYPE >::case_insensitive_collate(strsize iStart, strsize nCount, const CHARACTER* psz) const
//{
//   return substr(iStart, nCount).case_insensitive_order(psz);
//}
//
//template < typename ITERATOR_TYPE >
//i32 string_base < ITERATOR_TYPE >::order(strsize iStart, strsize nCount, const CHARACTER* psz, strsize start2, strsize count2) const
//{
//
//   return substr(iStart, nCount).order(string_base < ITERATOR_TYPE >(psz).substr(start2, count2));
//
//}
//
//
//template < typename ITERATOR_TYPE >
//i32 string_base < ITERATOR_TYPE >::case_insensitive_order(strsize iStart, strsize nCount, const CHARACTER* psz, strsize start2, strsize count2) const
//{
//
//   return substr(iStart, nCount).case_insensitive_order(string_base < ITERATOR_TYPE >(psz).substr(start2, count2));
//
//}
//
//
//template < typename ITERATOR_TYPE >
//i32 string_base < ITERATOR_TYPE >::collate(strsize iStart, strsize nCount, const CHARACTER* psz, strsize start2, strsize count2) const
//{
//
//   return substr(iStart, nCount).collate(string_base < ITERATOR_TYPE >(psz).substr(start2, count2));
//
//}
//
//template < typename ITERATOR_TYPE >
//i32 string_base < ITERATOR_TYPE >::case_insensitive_collate(strsize iStart, strsize nCount, const CHARACTER* psz, strsize start2, strsize count2) const
//{
//
//   return substr(iStart, nCount).case_insensitive_collate(string_base < ITERATOR_TYPE >(psz).substr(start2, count2));
//
//}

template < typename ITERATOR_TYPE >
bool string_base < ITERATOR_TYPE >::contains(RANGE range, strsize iStart, strsize nCount) const
{

   return find(range, iStart, nCount) >= 0;
...
//template < typename ITERATOR_TYPE >
//bool string_base < ITERATOR_TYPE >::contains(RANGE range, strsize iStart, strsize nCount, const CHARACTER ** ppszBeg, const CHARACTER ** ppszEnd) const
//{
//
...
//template < typename ITERATOR_TYPE >
//bool string_base < ITERATOR_TYPE >::contains(CHARACTER ch, strsize iStart, strsize nCount) const
//{
//
...
//template < typename ITERATOR_TYPE >
//bool string_base < ITERATOR_TYPE >::contains(::wide_character wch, strsize iStart, strsize nCount) const
//{
//
...
//template < typename ITERATOR_TYPE >
//bool string_base < ITERATOR_TYPE >::contains(i32 i, strsize iStart, strsize nCount) const // utf8 CHARACTER index
//{
//
...
//template < typename ITERATOR_TYPE >
//bool string_base < ITERATOR_TYPE >::contains(const CHARACTER* psz, strsize iStart, strsize nCount) const
//{
//
...
template < typename ITERATOR_TYPE >
bool string_base < ITERATOR_TYPE >::contains(CHARACTER ch, strsize iStart, strsize nCount, const CHARACTER ** ppszBeg) const
{
...
//template < typename ITERATOR_TYPE >
//bool string_base < ITERATOR_TYPE >::contains_ci(::wide_character wch, strsize iStart, strsize nCount) const
//{
//
...
//template < typename ITERATOR_TYPE >
//bool string_base < ITERATOR_TYPE >::contains_ci(i32 i, strsize iStart, strsize nCount) const// utf8 CHARACTER index
//{
//
...
bool string_base < ITERATOR_TYPE >::contains(RANGE range, strsize iStart, strsize nCount, const CHARACTER ** ppszBeg, const CHARACTER ** ppszEnd) const
{
   ...
   auto find = this->find(range, iStart, nCount);
...
template < typename ITERATOR_TYPE >
bool string_base < ITERATOR_TYPE >::contains_wci(RANGE range, strsize iStart, strsize nCount, const CHARACTER ** ppszBeg, const CHARACTER ** ppszEnd) const
{

   auto find = this->find_wci(range, iStart, nCount);
...
//template < typename ITERATOR_TYPE >
//bool string_base < ITERATOR_TYPE >::contains_wci(CHARACTER ch, strsize iStart, strsize nCount, const CHARACTER ** ppszBeg) const
//{
//
...
//{
//
//   auto find = this->find(range, iStart, nCount, ppszEnd);
//
//   if (find < 0)
//   {
//
...
//{
//
//   auto find = find_wci(range, iStart, nCount, ppszEnd);
//
//   if (find < 0)
//   {
//
...
//template < typename ITERATOR_TYPE >
//bool string_base < ITERATOR_TYPE >::contains_wci(CHARACTER wch, strsize iStart, strsize nCount) const
//{
//
...
//
//template < typename ITERATOR_TYPE >
//bool string_base < ITERATOR_TYPE >::contains_wci(i32 i, strsize iStart, strsize nCount) const// utf8 CHARACTER index
//{
//
//   return find_wci(unicode_to_utf8(i), iStart, nCount) >= 0;
//
...
template < typename ITERATOR_TYPE >
bool string_base < ITERATOR_TYPE >::contains_wci(RANGE range, strsize iStart, strsize nCount) const
{

   return find_wci(range, iStart, nCount) >= 0;
...
//template < typename ITERATOR_TYPE >
//string_base < ITERATOR_TYPE >& string_base < ITERATOR_TYPE >::erase(strsize iStart, strsize strsize)
//{
//
//   if (iStart < 0)
//   {
...
template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > & string_base < ITERATOR_TYPE >::erase(strsize iIndex, strsize nCount)
{
...
template < typename ITERATOR_TYPE >
strsize string_base < ITERATOR_TYPE >::replace_character(CHARACTER charNew, CHARACTER charOld, strsize iStart)
{
   strsize nCount = 0;
   ...
   if (charOld != charNew)
   {
      ...
      bool bCopied = false;
      CHARACTER * pszBuffer = const_cast<CHARACTER *>(this->begin() + iStart);  // We don't actually write to pszBuffer until we've called get_string_buffer().
...
//template < typename ITERATOR_TYPE >
//strsize string_base < ITERATOR_TYPE >::xxx_replace(CHARACTER charOld, CHARACTER charNew, strsize iStart)
//{
//
...
strsize string_base < ITERATOR_TYPE >::replace_with(RANGE rangeNew, RANGE rangeOld, strsize iStart)
{
   ...
   if (nCount > 0)
   {
      ...
      RANGE range(pszBuffer + iStart, pszBuffer + nOldLength);
...
template < typename ITERATOR_TYPE >
//template < raw_pointer_castable < CHARACTER > PCHARNEW, raw_pointer_castable < CHARACTER > PCHAROLD >
::count string_base < ITERATOR_TYPE >::replace_with_count(RANGE rangeNew, RANGE rangeOld, strsize iStart)
{
   // can't have is_empty or nullptr pszOld
   ...
   if (nCount > 0)
   {
      ...
      const CHARACTER * pszStart = pszBuffer + iStart;
...
template < typename ITERATOR_TYPE >
//template < raw_pointer_castable < CHARACTER > PCHARNEW, raw_pointer_castable < CHARACTER > PCHAROLD >
::count string_base < ITERATOR_TYPE >::replace_with_ci_count(RANGE rangeNew, RANGE rangeOld, strsize iStart)
{
   // can't have is_empty or nullptr pszOld
...
template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > & string_base < ITERATOR_TYPE >::replace(strsize iStart, strsize nCount, RANGE range)
{

   if (nCount < 0)
   {

      auto len = iStart + range.size();

      auto psz = get_string_buffer(len);

      string_count_copy(psz + iStart, range.begin(), range.size());
   ...
   else
   {
      ...
      auto len = iStart + range.size() + (size() - (iStart + nCount));

      auto psz = get_string_buffer(len);

      memmove(psz + iStart + range.size(), psz + iStart + nCount);
...
template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > & string_base < ITERATOR_TYPE >::replace(strsize iStart, strsize nCount, RANGE range, strsize nSubLen)
{
   ...
   if (nCount < 0)
   {
      ...
      auto len = iStart + nSubLen;

      auto psz = get_string_buffer(len);

      string_count_copy(psz + iStart, range.begin(), nSubLen);
   ...
   else
   {
      ...
      auto len = iStart + nSubLen + (size() - (iStart + nCount));

      auto psz = get_string_buffer(len);

      memmove(psz + iStart + nSubLen, psz + iStart + nCount);
...
// find the first occurrence of character 'ch', starting at strsize 'iStart'
template < typename ITERATOR_TYPE >
strsize string_base < ITERATOR_TYPE >::find(CHARACTER ch, strsize iStart, strsize nCount) const RELEASENOTHROW
{
   // iStart is in XCHARs
   ASSERT(iStart >= 0);
...
template < typename ITERATOR_TYPE >
strsize string_base < ITERATOR_TYPE >::scan_whitespace(strsize iStart) const RELEASENOTHROW
{
...
template < typename ITERATOR_TYPE >
strsize string_base < ITERATOR_TYPE >::span_whitespace(strsize iStart) const RELEASENOTHROW
{
...
template < typename ITERATOR_TYPE >
strsize string_base < ITERATOR_TYPE >::find_first(CHARACTER ch, strsize iStart) const RELEASENOTHROW
{
   
   return ::string_find_character(this->begin()+iStart, ch);
...
///
/// @brief Find the first occurrence of \p range, starting at \p iStart position and up 
/// to \p nCount characters from \p iStart.
...
/// @param iStart [in] position where to start the start.
/// @param iCount [in] amount of characters since \p iStart 
///    to continue searching for \p range
/// @param ppszTail [out,opt] address immediately after where \p range 
///    was found in the string.
/// @return position where \p range was found respecting \p iStart 
///    and \p iCount or -1 if not found.
/// 
template < typename ITERATOR_TYPE >
strsize string_base < ITERATOR_TYPE >::find(RANGE range, strsize iStart, strsize nCount) const RELEASENOTHROW
{

   return offset_of(RANGE(this->begin() + iStart, nCount).find(range));
   ...
   //if (_find_prefix(i, range, iStart, nCount, rangeLen, nEndExclusive))
   //{
...
strsize string_base < ITERATOR_TYPE >::find_unicode(RANGE range, strsize iStart, strsize nCount) const RELEASENOTHROW
{
   ...
   RANGE rangeScope{ this->begin() + iStart, count };
...
template < typename ITERATOR_TYPE >
strsize string_base < ITERATOR_TYPE >::scan(RANGE rangeCharacters, strsize iStart, strsize n) const RELEASENOTHROW
{

   auto p = string_scan({ this->begin() + iStart, size() - iStart }, rangeCharacters);
...
// find the first occurrence of any of the characters in string_base < ITERATOR_TYPE > 'pszCharSet'
template < typename ITERATOR_TYPE >
strsize string_base < ITERATOR_TYPE >::scan(const CHARACTER * pszCharacters, strsize iStart) const RELEASENOTHROW
{

   auto p = string_pbrk(this->begin() + iStart, pszCharacters);
...
//template < typename ITERATOR_TYPE >
//strsize string_base < ITERATOR_TYPE >::scan(RANGE rangeCharacters, strsize iStart) const RELEASENOTHROW
//{
//
//   return scan(rangeCharacters, iStart);
//
//}
//
//
...
//{
//
//   return scan(rangeCharacters, iStart, n);
//
//}
//
//
...
//template < typename ITERATOR_TYPE >
//strsize string_base < ITERATOR_TYPE >::rear_scan(const CHARACTER * pszCharSet, strsize iStart) const RELEASENOTHROW
//{
...
//// find the last occurrence of character 'ch'
//template < typename ITERATOR_TYPE >
//strsize string_base < ITERATOR_TYPE >::rear_find(const CHARACTER * ch, strsize iStart) const RELEASENOTHROW
//{
//   // find last single character
//   RANGE range = string_find_string_reverse(this->begin(), ch, iStart);
//
//   // return -1 if not found, distance from beginning otherwise
...
template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > string_base < ITERATOR_TYPE >::Mid(strsize iFirst, strsize nCount) const
{
   // nCount is in XCHARs
   ...
   ASSERT((nCount == 0) || ((iFirst + nCount) <= size()));

   // optimize case of returning entire string_base < ITERATOR_TYPE >
   if ((iFirst == 0) && ((iFirst + nCount) == size()))
   {
      return *this;
   }

   return(string_base < ITERATOR_TYPE >(this->begin() + iFirst, nCount));

}


template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > string_base < ITERATOR_TYPE >::substr(strsize iFirst, strsize nCount) const
{
...
template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > string_base < ITERATOR_TYPE >::Right(strsize nCount) const
{
   ...
   return(string_base < ITERATOR_TYPE >(this->begin() + nLength - nCount, nCount));
...
template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > string_base < ITERATOR_TYPE >::Left(strsize nCount) const
{
   ...
   return(string_base < ITERATOR_TYPE >(this->begin(), nCount));
...
template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > string_base < ITERATOR_TYPE >::scan_including(RANGE rangeCharacters, strsize iStart, strsize iCount) const
{

   auto i = scan(rangeCharacters, iStart, iCount);
...
template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > string_base < ITERATOR_TYPE >::span_excluding(RANGE rangeCharacters, strsize iStart, strsize iCount) const
{

   auto i = span(rangeCharacters, iStart, iCount);
...
template < typename ITERATOR_TYPE >
string_base < ITERATOR_TYPE > string_base < ITERATOR_TYPE >::unichar_substr(strsize iFirst, strsize nCount) const
{
...
//// find the first occurrence of character 'ch', starting at strsize 'iStart'
//inline strsize string::find(::ansi_character ch, strsize iStart) const RELEASENOTHROW
//{
//
//   const ::ansi_character * psz = strchr(&m_psz[iStart], ch);
//
//   return psz == nullptr ? -1 : psz - m_psz;
//
//}
