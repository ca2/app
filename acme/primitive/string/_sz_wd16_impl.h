...
//inline bool isalpha(wd16char ch) noexcept { return wd16_char_isalpha(ch); }
//inline bool isdigit(wd16char ch) noexcept { return wd16_char_isdigit(ch); }
//inline bool character_isspace(wd16char ch) noexcept { return wd16_char_isspace(ch); }
//
//inline wd16char tolower(wd16char ch) noexcept { return wd16_char_tolower(ch); }
//inline wd16char toupper(wd16char ch) noexcept { return wd16_char_toupper(ch); }
...
//inline wd16char character_tolower(wd16char wd16ch)
//{
//
//   return (wd16ch >= 'A' && wd16ch <= 'Z') ? (wd16ch - 'A' + 'a') : wd16ch;
//
//}
