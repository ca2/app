...
//inline bool isalpha(wd32char ch) noexcept { return wd32_char_isalpha(ch); }
//inline bool isdigit(wd32char ch) noexcept { return wd32_char_isdigit(ch); }
//inline bool  character_isspace(wd32char ch) noexcept { return wd32_char_isspace(ch); }
//
//inline wd32char  tolower(wd32char ch) noexcept { return wd32_char_tolower(ch); }
//inline wd32char  toupper(wd32char ch) noexcept { return wd32_char_toupper(ch); }
...
//inline wd32char character_tolower(wd32char wd32ch)
//{
//
//   return (wd32ch >= 'A' && wd32ch <= 'Z') ? (wd32ch - 'A' + 'a') : wd32ch;
//
//}
