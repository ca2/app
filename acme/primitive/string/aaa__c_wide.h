...
inline widechar               wide_char_tolower(i32 ch);
inline widechar               wide_char_tolower(i32 ch);
inline i32                    wide_char_isdigit(i32 ch);
inline i32                    wide_char_is_hexadecimal(i32 ch);
inline i32                    wide_char_isalpha(i32 ch);
inline i32                    wide_char_is_alnum(i32 ch);
inline i32                    wide_char_isspace(i32 ch);
