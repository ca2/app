...
inline widechar wide_char_tolower(i32 i) { return __MID_CHARBIT(wd, _char_tolower)(i); }
inline widechar wide_char_toupper(i32 i) { return __MID_CHARBIT(wd, _char_toupper)(i); }


inline i32 wide_char_isdigit(i32 i) { return __MID_CHARBIT(wd, _char_isdigit)(i); }
inline i32 wide_char_is_hexadecimal(i32 i) { return __MID_CHARBIT(wd, _char_is_hexadecimal)(i); }
inline i32 wide_char_isalpha(i32 i) { return __MID_CHARBIT(wd, _char_isalpha)(i); }
inline i32 wide_char_is_alnum(i32 i) { return __MID_CHARBIT(wd, _char_is_alnum)(i); }
inline i32 wide_char_isspace(i32 i) { return __MID_CHARBIT(wd, _char_isspace)(i); }
