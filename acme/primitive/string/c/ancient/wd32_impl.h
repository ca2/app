...
inline int __wd32ncoll(const wd32char * psz1, const wd32char * psz2, strsize s) { return wd32_ncmp(psz1, psz2, s); }

inline int __wd32icoll(const wd32char * psz1, const wd32char * psz2) { return wd32_icmp(psz1, psz2); }

inline int __wd32nicoll(const wd32char * psz1, const wd32char * psz2, strsize s) { return wd32_nicmp(psz1, psz2, s); }
