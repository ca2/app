...
CLASS_DECL_ACME ::ansi_character * ansi_lwr_s(::ansi_character * psz, strsize s);
CLASS_DECL_ACME ::ansi_character * ansi_upr(::ansi_character * psz);
CLASS_DECL_ACME ::ansi_character * ansi_upr_s(::ansi_character * psz, strsize s);
...
CLASS_DECL_ACME strsize wd16_len(const ::wd16_character * psz);
CLASS_DECL_ACME strsize wd32_len(const ::wd32_character * psz);
...
CLASS_DECL_ACME ::wd16_character * wd16_ncpy(::wd16_character * pszDst, const ::wd16_character * psz, strsize len);
CLASS_DECL_ACME ::wd32_character * wd32_ncpy(::wd32_character * pszDst, const ::wd32_character * psz, strsize len);
...
CLASS_DECL_ACME int wd16_ncmp(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s);
...
CLASS_DECL_ACME ::wd16_character * wd16_lwr_s(::wd16_character * psz, strsize s);
CLASS_DECL_ACME ::wd32_character * wd32_lwr_s(::wd32_character * psz, strsize s);
...
CLASS_DECL_ACME ::wd16_character * wd16_upr_s(::wd16_character * psz, strsize s);
CLASS_DECL_ACME ::wd32_character * wd32_upr_s(::wd32_character * psz, strsize s);
...
CLASS_DECL_ACME int wd16_nicmp(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s);
CLASS_DECL_ACME int wd32_nicmp(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s);
CLASS_DECL_ACME int wide_nicmp(const ::wide_character * psz1, const ::wide_character * psz2, strsize s);
...
CLASS_DECL_ACME int wd16_ncoll(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s);
CLASS_DECL_ACME int wd32_ncoll(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s);
CLASS_DECL_ACME int wide_ncoll(const ::wide_character * psz1, const ::wide_character * psz2, strsize s);
...
CLASS_DECL_ACME int wd16_nicoll(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s);
CLASS_DECL_ACME int wd32_nicoll(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s);
CLASS_DECL_ACME int wide_nicoll(const ::wide_character * psz1, const ::wide_character * psz2, strsize s);

CLASS_DECL_ACME strsize wd16_spn(const ::wd16_character * psz1, const ::wd16_character * psz2);
CLASS_DECL_ACME strsize wd32_spn(const ::wd32_character * psz1, const ::wd32_character * psz2);

CLASS_DECL_ACME strsize wd16_cspn(const ::wd16_character * psz1, const ::wd16_character * psz2);
CLASS_DECL_ACME strsize wd32_cspn(const ::wd32_character * psz1, const ::wd32_character * psz2);
