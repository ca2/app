...
CLASS_DECL_ACME ::ansi_character * ansi_lwr_s(::ansi_character * psz, strsize s) { _strlwr_s(psz, s); return psz; }

CLASS_DECL_ACME ::ansi_character * ansi_upr(::ansi_character * psz) { return _strupr(psz); }

CLASS_DECL_ACME ::ansi_character * ansi_upr_s(::ansi_character * psz, strsize s) { _strupr_s(psz, s); return psz; }

#else

CLASS_DECL_ACME ::ansi_character * ansi_lwr(::ansi_character * psz) { return __ansilwr(psz); }

CLASS_DECL_ACME ::ansi_character * ansi_lwr_s(::ansi_character * psz, strsize s) { __ansilwr_s(psz, s); return psz; }

CLASS_DECL_ACME ::ansi_character * ansi_upr(::ansi_character * psz) { return __ansiupr(psz); }

CLASS_DECL_ACME ::ansi_character * ansi_upr_s(::ansi_character * psz, strsize s) { __ansiupr_s(psz, s); return psz; }
...
//CLASS_DECL_ACME ::ansi_character * i64tostr(::u64 u, ::ansi_character * buf, int iBase, enum_digit_case edigitcase) { return __i64toansi(u, buf, iBase, edigitcase); }
...
CLASS_DECL_ACME strsize wd16_len(const ::wd16_character * psz) { return wcslen(psz); }
CLASS_DECL_ACME strsize wd32_len(const ::wd32_character * psz) { return __wd32len(psz); }
...
CLASS_DECL_ACME ::wd16_character * wd16_ncpy(::wd16_character * pszDst, const ::wd16_character * psz, strsize len) { return wcsncpy(pszDst, psz, len); }
CLASS_DECL_ACME ::wd32_character * wd32_ncpy(::wd32_character * pszDst, const ::wd32_character * psz, strsize len) { return __wd32ncpy(pszDst, psz, len); }
...
CLASS_DECL_ACME int wd16_ncmp(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s) { return wcsncmp(psz1, psz2, s); }
CLASS_DECL_ACME int wd32_ncmp(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s) { return __wd32ncmp(psz1, psz2, s); }
...
CLASS_DECL_ACME ::wd16_character * wd16_lwr_s(::wd16_character * psz, strsize s) { _wcslwr_s(psz, s);  return psz; }
CLASS_DECL_ACME ::wd32_character * wd32_lwr_s(::wd32_character * psz, strsize s) { __wd32lwr_s(psz, s);  return psz; }
...
CLASS_DECL_ACME ::wd16_character * wd16_upr_s(::wd16_character * psz, strsize s) { _wcsupr_s(psz, s);  return psz; }
CLASS_DECL_ACME ::wd32_character * wd32_upr_s(::wd32_character * psz, strsize s) { __wd32upr_s(psz, s);  return psz; }
...
CLASS_DECL_ACME int wd16_nicmp(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s) { return _wcsnicmp(psz1, psz2, s); }
CLASS_DECL_ACME int wd32_nicmp(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s) { return __wd32nicmp(psz1, psz2, s); }
CLASS_DECL_ACME int wide_nicmp(const ::wide_character * psz1, const ::wide_character * psz2, strsize s) { return wd16_nicmp(psz1, psz2, s); }
...
CLASS_DECL_ACME ::wd16_character * i64towd16(::i64 i, ::wd16_character * buf, int iBase, enum_digit_case edigitcase) { ::wd16_character * pend=nullptr; return __i64towd16(i, buf, iBase, edigitcase, pend); }
CLASS_DECL_ACME ::wd32_character * i64towd32(::i64 i, ::wd32_character * buf, int iBase, enum_digit_case edigitcase) { ::wd32_character * pend=nullptr; return __i64towd32(i, buf, iBase, edigitcase, pend); }
...
CLASS_DECL_ACME int wd16_ncoll(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s) { return _wcsncoll(psz1, psz2, s); }
CLASS_DECL_ACME int wd32_ncoll(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s) { return __wd32ncoll(psz1, psz2, s); }
...
CLASS_DECL_ACME int wd16_nicoll(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s) { return _wcsnicoll(psz1, psz2, s); }
CLASS_DECL_ACME int wd32_nicoll(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s) { return __wd32nicoll(psz1, psz2, s); }

CLASS_DECL_ACME strsize wd16_spn(const ::wd16_character * psz1, const ::wd16_character * psz2) { return wcsspn(psz1, psz2); }
CLASS_DECL_ACME strsize wd32_spn(const ::wd32_character * psz1, const ::wd32_character * psz2) { return __wd32spn(psz1, psz2); }

CLASS_DECL_ACME strsize wd16_cspn(const ::wd16_character * psz1, const ::wd16_character * psz2) { return wcscspn(psz1, psz2); }
CLASS_DECL_ACME strsize wd32_cspn(const ::wd32_character * psz1, const ::wd32_character * psz2) { return __wd32cspn(psz1, psz2); }

#elif WCHAR_T_SIZE == 32

CLASS_DECL_ACME strsize wd16_len(const ::wd16_character * psz) { return __wd16len(psz); }
CLASS_DECL_ACME strsize wd32_len(const ::wd32_character * psz) { return wcslen(psz); }
CLASS_DECL_ACME strsize wide_len(const ::wide_character * psz) { return wd32_len(psz); }
...
CLASS_DECL_ACME ::wd16_character * wd16_ncpy(::wd16_character * pszDst, const ::wd16_character * psz, strsize len) { return __wd16ncpy(pszDst, psz, len); }
CLASS_DECL_ACME ::wd32_character * wd32_ncpy(::wd32_character * pszDst, const ::wd32_character * psz, strsize len) { return wcsncpy(pszDst, psz, len); }
CLASS_DECL_ACME ::wide_character * wide_ncpy(::wide_character * pszDst, const ::wide_character * psz, strsize len) { return wd32_ncpy(pszDst, psz, len); }
...
CLASS_DECL_ACME int wd16_ncmp(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s) { return __wd16ncmp(psz1, psz2, s); }
CLASS_DECL_ACME int wd32_ncmp(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s)
{
#ifdef WINDOWS
...
CLASS_DECL_ACME int wide_ncmp(const ::wide_character * psz1, const ::wide_character * psz2, strsize s) { return wd32_ncmp(psz1, psz2, s); }
...
CLASS_DECL_ACME ::wd16_character * wd16_lwr_s(::wd16_character * psz, strsize s) { __wd16lwr_s(psz, s);  return psz; }
CLASS_DECL_ACME ::wd16_character * wd16_upr(::wd16_character * psz) { return __wd16upr(psz); }
CLASS_DECL_ACME ::wd16_character * wd16_upr_s(::wd16_character * psz, strsize s) { __wd16upr_s(psz, s);  return psz; }


#ifdef WINDOWS

CLASS_DECL_ACME ::wd32_character * wd32_lwr(::wd32_character * psz) { return wcslwr(psz); }
CLASS_DECL_ACME ::wd32_character * wd32_lwr_s(::wd32_character * psz, strsize s) { _wcslwr_s(psz, s);  return psz; }
CLASS_DECL_ACME ::wd32_character * wd32_upr(::wd32_character * psz) { return wcsupr(psz); }
CLASS_DECL_ACME ::wd32_character * wd32_upr_s(::wd32_character * psz, strsize s) { _wcsupr_s(psz, s);  return psz; }

CLASS_DECL_ACME ::wide_character * wide_lwr(::wd32_character * psz) { return wcslwr(psz); }
CLASS_DECL_ACME ::wide_character * wide_lwr_s(::wd32_character * psz, strsize s) { _wcslwr_s(psz, s);  return psz; }
CLASS_DECL_ACME ::wide_character * wide_upr(::wd32_character * psz) { return wcsupr(psz); }
CLASS_DECL_ACME ::wide_character * wide_upr_s(::wd32_character * psz, strsize s) { _wcsupr_s(psz, s);  return psz; }
...
CLASS_DECL_ACME ::wide_character * wide_lwr_s(::wide_character * psz, strsize s) { wd32_lwr_s(psz, s);  return psz; }
CLASS_DECL_ACME ::wide_character * wide_upr(::wide_character * psz) { return wd32_upr(psz); }
CLASS_DECL_ACME ::wide_character * wide_upr_s(::wide_character * psz, strsize s) { wd32_upr_s(psz, s);  return psz; }
...
CLASS_DECL_ACME int wd16_nicmp(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s) { return __wd16nicmp(psz1, psz2, s); }
CLASS_DECL_ACME int wd32_nicmp(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s)
{
#ifdef WINDOWS
...
CLASS_DECL_ACME int wide_nicmp(const ::wide_character * psz1, const ::wide_character * psz2, strsize s) { return wd32_nicmp(psz1, psz2, s); }
...
CLASS_DECL_ACME ::wd16_character * i64towd16(::i64 u, ::wd16_character * buf, int iBase, enum_digit_case edigitcase) { ::wd16_character *pend=nullptr;return __i64towd16(u, buf, iBase, edigitcase, pend); }
CLASS_DECL_ACME ::wd32_character * i64towd32(::i64 u, ::wd32_character * buf, int iBase, enum_digit_case edigitcase) { ::wd32_character *pend=nullptr;return __i64towd32(u, buf, iBase, edigitcase, pend); }
CLASS_DECL_ACME ::wide_character * i64towide(::i64 u, ::wide_character * buf, int iBase, enum_digit_case edigitcase) { ::wd32_character *pend=nullptr;return __i64towd32(u, buf, iBase, edigitcase, pend); }
...
CLASS_DECL_ACME int wd16_ncoll(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s) { return __wd16ncoll(psz1, psz2, s); }
CLASS_DECL_ACME int wd32_ncoll(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s) { return __wd32ncoll(psz1, psz2, s); }
CLASS_DECL_ACME int wide_ncoll(const ::wide_character * psz1, const ::wide_character * psz2, strsize s) { return wd32_ncoll(psz1, psz2, s); }
...
CLASS_DECL_ACME int wd16_nicoll(const ::wd16_character * psz1, const ::wd16_character * psz2, strsize s) { return __wd16nicoll(psz1, psz2, s); }
CLASS_DECL_ACME int wd32_nicoll(const ::wd32_character * psz1, const ::wd32_character * psz2, strsize s) { return __wd32nicoll(psz1, psz2, s); }
CLASS_DECL_ACME int wide_nicoll(const ::wide_character * psz1, const ::wide_character * psz2, strsize s) { return wd32_nicoll(psz1, psz2, s); }

CLASS_DECL_ACME strsize wd16_spn(const ::wd16_character * psz1, const ::wd16_character * psz2) { return __wd16spn(psz1, psz2); }
CLASS_DECL_ACME strsize wd32_spn(const ::wd32_character * psz1, const ::wd32_character * psz2) { return wcsspn(psz1, psz2); }
CLASS_DECL_ACME strsize wide_spn(const ::wide_character * psz1, const ::wide_character * psz2) { return wd32_spn(psz1, psz2); }

CLASS_DECL_ACME strsize wd16_cspn(const ::wd16_character * psz1, const ::wd16_character * psz2) { return __wd16cspn(psz1, psz2); }
CLASS_DECL_ACME strsize wd32_cspn(const ::wd32_character * psz1, const ::wd32_character * psz2) { return wcscspn(psz1, psz2); }
CLASS_DECL_ACME strsize wide_cspn(const ::wide_character * psz1, const ::wide_character * psz2) { return wd32_cspn(psz1, psz2); }
