...
CLASS_DECL_ACME ::ansi_character * ansi_duplicate(const ::ansi_character * psz); // ATTENTION - ::heap::management::memory(::heap::e_memory_main)->allocate
CLASS_DECL_ACME ::ansi_character * ansi_count_duplicate(const ::ansi_character * psz, strsize len); // ATTENTION - ::heap::management::memory(::heap::e_memory_main)->allocate
