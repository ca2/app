...
CLASS_DECL_ACME ::wd16_character *             wd16_duplicate(const ::wd16_character * src); // ATTENTION - ::acme::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate
CLASS_DECL_ACME ::wd16_character *             wd16_count_duplicate(const ::wd16_character * src, strsize srclen); // ATTENTION - ::acme::get()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate
