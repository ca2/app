...
CLASS_DECL_ACME const ::ansi_character * unicode_next(const ::ansi_character * psz);
...
CLASS_DECL_ACME ::ansi_character * unicode_next(::ansi_character * psz) { return (::ansi_character *)unicode_next((const ::ansi_character *)psz); }
CLASS_DECL_ACME ::wd16_character * unicode_next(::wd16_character * psz) { return (::wd16_character *)unicode_next((const ::wd16_character *)psz); }
CLASS_DECL_ACME ::wd32_character * unicode_next(::wd32_character * psz) { return (::wd32_character *)unicode_next((const ::wd32_character *)psz); }

CLASS_DECL_ACME const ::ansi_character * unicode_increment(const ::ansi_character *& psz) { return psz = unicode_next(psz); }
CLASS_DECL_ACME const ::wd16_character * unicode_increment(const ::wd16_character *& psz) { return psz = unicode_next(psz); }
CLASS_DECL_ACME const ::wd32_character * unicode_increment(const ::wd32_character *& psz) { return psz = unicode_next(psz); }


CLASS_DECL_ACME ::ansi_character * unicode_increment(::ansi_character *& psz) { return (::ansi_character *)unicode_increment((const ::ansi_character *&)psz); }
CLASS_DECL_ACME ::wd16_character * unicode_increment(::wd16_character *& psz) { return (::wd16_character *)unicode_increment((const ::wd16_character *&)psz); }
CLASS_DECL_ACME ::wd32_character * unicode_increment(::wd32_character *& psz) { return (::wd32_character *)unicode_increment((const ::wd32_character *&)psz); }


const ::ansi_character * unicode_prior(const ::ansi_character * psz, const ::ansi_character * pszBeg);
const ::wd16_character * unicode_prior(const ::wd16_character * psz, const ::wd16_character * pszBeg);
const ::wd32_character * unicode_prior(const ::wd32_character * psz, const ::wd32_character * pszBeg);


CLASS_DECL_ACME const ::index unicode_prior_index(::index i, const ::ansi_character * pszBeg) { auto p = unicode_prior(&pszBeg[i], pszBeg); return ::is_null(p) ? -1 : p - pszBeg; }
CLASS_DECL_ACME const ::index unicode_prior_index(::index i, const ::wd16_character * pszBeg) { auto p = unicode_prior(&pszBeg[i], pszBeg); return ::is_null(p) ? -1 : p - pszBeg; }
CLASS_DECL_ACME const ::index unicode_prior_index(::index i, const ::wd32_character * pszBeg) { auto p = unicode_prior(&pszBeg[i], pszBeg); return ::is_null(p) ? -1 : p - pszBeg; }


CLASS_DECL_ACME ::ansi_character * unicode_prior(::ansi_character * psz, const ::ansi_character * pszBeg) { return (::ansi_character *)unicode_prior((const ::ansi_character *&)psz, pszBeg); }
CLASS_DECL_ACME ::wd16_character * unicode_prior(::wd16_character * psz, const ::wd16_character * pszBeg) { return (::wd16_character *)unicode_prior((const ::wd16_character *&)psz, pszBeg); }
CLASS_DECL_ACME ::wd32_character * unicode_prior(::wd32_character * psz, const ::wd32_character * pszBeg) { return (::wd32_character *)unicode_prior((const ::wd32_character *&)psz, pszBeg); }


CLASS_DECL_ACME const strsize unicode_decrement(strsize & i, const ::ansi_character * pszBeg) { return i = unicode_prior_index(i, pszBeg); }
CLASS_DECL_ACME const strsize unicode_decrement(strsize & i, const ::wd16_character * pszBeg) { return i = unicode_prior_index(i, pszBeg); }
CLASS_DECL_ACME const strsize unicode_decrement(strsize & i, const ::wd32_character * pszBeg) { return i = unicode_prior_index(i, pszBeg); }


CLASS_DECL_ACME const ::ansi_character * unicode_decrement(const ::ansi_character *& psz, const ::ansi_character * pszBeg) { return psz = unicode_prior(psz, pszBeg); }
CLASS_DECL_ACME const ::wd16_character * unicode_decrement(const ::wd16_character *& psz, const ::wd16_character * pszBeg) { return psz = unicode_prior(psz, pszBeg); }
CLASS_DECL_ACME const ::wd32_character * unicode_decrement(const ::wd32_character *& psz, const ::wd32_character * pszBeg) { return psz = unicode_prior(psz, pszBeg); }


CLASS_DECL_ACME ::ansi_character * unicode_decrement(::ansi_character *& psz, const ::ansi_character * pszBeg = nullptr)
{
...
CLASS_DECL_ACME ::wd16_character * unicode_decrement(::wd16_character *& psz, const ::wd16_character * pszBeg = nullptr)
{
...
CLASS_DECL_ACME ::wd32_character * unicode_decrement(::wd32_character *& psz, const ::wd32_character * pszBeg = nullptr)
{
...
//CLASS_DECL_ACME bool _str_safe_precmp(int & i, const ::ansi_character * pszA, const ::ansi_character * pszB);
 ...
 strsize utf_to_utf_length(const ::ansi_character CLASS_DECL_ACME*, const ::ansi_character * psource, strsize srclen);
