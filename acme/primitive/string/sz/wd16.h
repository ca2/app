...
inline i32 string_count_compare(const wd16char * pszA, const wd16char * pszB, strsize len) noexcept;
inline i32 string_count_compare_ci(const wd16char * pszA, const wd16char * pszB, strsize len) noexcept;
...
inline strsize string_safe_length(const wd16char* psz, strsize sizeMaximumInterest) noexcept;
...
inline wd16char character_tolower(wd16char wd16ch) noexcept;
inline wd16char character_toupper(wd16char wd16ch) noexcept;


inline bool character_isalpha(wd16char ansich) noexcept;
inline bool character_isalnum(wd16char ansich) noexcept;
inline bool character_isdigit(wd16char ansich) noexcept;
inline bool character_isspace(wd16char ansich) noexcept;
...
inline void  flood_characters(wd16char * psz, wd16char ch, strsize len) noexcept;
...
CLASS_DECL_ACME ::i64 string_to_signed(const wd16char * psz);
CLASS_DECL_ACME ::u64 string_to_natural(const wd16char * psz);
