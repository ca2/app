...
//   {
//
//      if(it->string().case_insensitive_order(scopedstr) == 0)
//      {
//
//         return (property *) &it->m_var;
//
...
//   {
//
//      auto pproperty = allocateø property(nullptr);
//
//      this->add(pproperty);
//
//      pproperty->id() = atom;
...
//   {
//
//      auto pproperty = allocateø< property(::as_string(this->size >()));
//
//      add_item(pproperty);
//
//   }
...
CLASS_DECL_ACME ::pointer < ::property_set > create_network_arguments_property_set(const ::scoped_string& scopedstrNetworkArguments)
{
   ...
   auto ppropertysetNetworkArguments = system()->create_newø<::property_set>();
