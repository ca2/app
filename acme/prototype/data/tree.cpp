...
namespace data
{
   ...
   tree::tree()
   {
      ...
      m_pparent = __new ::data::tree_item ();
   ...
   void tree::_001OnItemContextMenu(::data::tree_item * pitem, const ::action_context & context, ::user::element * ptree, const ::point_i32 & point)
   {
