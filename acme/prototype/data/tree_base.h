...
namespace data
{
   ...
   public:
      ...
      virtual void _001OnItemContextMenu(tree_item_base * pitem, const ::action_context & action_context, ::user::element * ptree, const ::i32_point & point);
   ...
   //template < prototype_item ::item * >
   //void tree < ::item * >::_001OnItemContextMenu(::data::tree_item_base * pitem, const ::action_context & context, ::user::element * ptree, const ::i32_point & point)
   //{
