...
//      };
      ...
      posix_time strtotime(const ::text::context * pcontext, const ::scoped_string & scopedstr, posix_time time,::i32 iPath,::i32 & iPathCount, const class ::time& timezone = {});
      posix_time strtotime(const ::text::context * pcontext, const ::scoped_string & scopedstr, ::i32 iPath,::i32 & iPathCount, const class ::time& timezone = {});
      ...
      virtual result parse_time(const ::text::context* pcontext, const ::scoped_string & scopedstr, ::i32& iPath, ::i32& iPathCount, const class ::time& timeshift = {});
