...
//   UNIT_TYPE & y() {return this->y;}
   ...
   UNIT_TYPE get_dimension(enum_orientation eorientation, ::collection::index i)
   {
      ...
      return eorientation == e_orientation_horizontal ? (i == 0 ? this->left : this->right)
                                                      : (i == 0 ? this->top : this->bottom);
   ...
   UNIT_TYPE get_normal_dimension(enum_orientation eorientation, ::collection::index i)
   {
      ...
      return eorientation == e_orientation_vertical ? (i == 0 ? this->left : this->right)
                                                    : (i == 0 ? this->top : this->bottom);
   ...
   UNIT_TYPE get_first_dimension(enum_orientation eorientation)
   {
      ...
      return eorientation == e_orientation_horizontal ? (this->left) : (this->top);
   ...
   UNIT_TYPE get_first_normal_dimension(enum_orientation eorientation)
   {
      ...
      return eorientation == e_orientation_vertical ? (this->right) : (this->bottom);
   ...
   UNIT_TYPE get_second_dimension(enum_orientation eorientation)
   {
      ...
      return eorientation == e_orientation_horizontal ? (this->right) : (this->bottom);
   ...
   UNIT_TYPE get_total_dimension(enum_orientation eorientation)
   {
      ...
      return eorientation == e_orientation_horizontal ? this->left + this->right : this->top + this->bottom;
   ...
   UNIT_TYPE get_normal_total_dimension(enum_orientation eorientation)
   {
      ...
      return eorientation == e_orientation_vertical ? this->left + this->right : this->top + this->bottom;
...
//   inline rectangle_type operator-(const SHIFT_I32 & shift)  { return { (UNIT_TYPE)(this->left - shift.Δx), (UNIT_TYPE)(this->top - shift.Δy), (UNIT_TYPE)(this->right - shift.Δx), (UNIT_TYPE)(this->bottom - shift.Δy) }; }
   ...
   rectangle_type operator-(const SEQUENCE & s) const
   {
      ...
      rectangle_type rectangle(*this); rectangle.offset(-s.cx, -s.cy); return rectangle;
