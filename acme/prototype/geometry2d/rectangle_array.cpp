...
CLASS_DECL_ACME ::int_rectangle_array_base get_top_left_oriented_damaged_areas_by_resizing(const ::i32_rectangle & rectangleNew, const ::i32_rectangle & rectangleOld, bool bOnlyGrowing)
{
