...
//void memory_base::random_bytes(::collection::count c)
//{
//
//   if (c >= 0)
//   {
...
void memory_base::append_file(::file::file * pfileIn,memsize uiBufferSize)
{
   ...
   while (true)
   {
      ...
      auto amountRead = pfileIn->read(this->data() + position, uiBufferSize);
...
//   }
//
//   ::winrt::Windows::Storage::Streams::InMemoryRandomAccessStream ^ randomAccessStream = ref ___new ::winrt::Windows::Storage::Streams::InMemoryRandomAccessStream ();
//
...
::winrt::Windows::Storage::Streams::IBuffer ^ memory_base::get_os_buffer(memsize pos, memsize size) const
{
   ...
   ::winrt::Windows::Storage::Streams::DataWriter ^ writer = ref ___new ::winrt::Windows::Storage::Streams::DataWriter ();
...
void memory_base::set_os_buffer(::winrt::Windows::Storage::Streams::IBuffer ^ ibuf, memsize pos, memsize size)
{
   ...
   Array<uchar, 1U>^ a = ref ___new Array<uchar, 1U> (ibuf->Length);
...
::collection::index memory_base::find_line_prefix_index(const ::block& blockPrefix, ::collection::index iStart)
{
...
void memory_base::patch_line_suffix(const ::block& blockPrefix, const ::block& blockSuffix, ::collection::index iStart )
{
...
::collection::index memory_base::find_index(const ::block & block, ::collection::index iStart) const
{
...
::collection::index memory_base::reverse_find_index(const ::block & block, ::collection::index iStart) const
{
...
::collection::index memory_base::reverse_find_index_of_byte_not_in_block(const ::block & block, ::collection::index iStart) const
{
