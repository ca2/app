...
public:
   ...
   character(::ansi_character ::ansi_character) { m_wd32char = (::wd32_character) static_cast <unsigned char> (::ansi_character); }
   ...
   character(const ::scoped_string & scopedstrUtf8) { m_wd32char= parse_utf8(scopedstrUtf8); }
