...
//      void CLASS_DECL_ACME unicode_to_utf8(string_array_base & stra, string_array_base & stra);
  //    void CLASS_DECL_ACME utf8_to_unicode(string_array_base & stra, string_array_base & stra);
      ...
      //bool CLASS_DECL_ACME multibyte_to_multibyte(::u32 uCodePageDest, memory & str, ::u32 uCodePageSrc, const ::scoped_string & scopedstr, character_count nCount);


      bool CLASS_DECL_ACME multibyte_to_utf8(::u32 uCodePageSrc, memory & str, const ::scoped_string & scopedstr);

      //bool CLASS_DECL_ACME multibyte_to_utf8(::u32 uCodePageSrc, memory & str, const ::scoped_string & scopedstr, character_count nCount);


//      bool CLASS_DECL_ACME OEMToMultiByte(::u32 uCodePage, memory & str, const ::scoped_string & scopedstr);

//      bool CLASS_DECL_ACME OEMToMultiByte(::u32 uCodePage, memory & str, const ::scoped_string & scopedstr, character_count nCount);
      ...
      //bool CLASS_DECL_ACME utf8_to_multibyte(::u32 uCodePage, memory & str, const ::scoped_string & scopedstr, character_count nCount);
...
//CLASS_DECL_ACME bool multibyte_to_utf8(::u32 uCodePageSrc, memory & str, const ::scoped_string & scopedstr, character_count nCount);
//      {
//
//#ifdef WINDOWS
//
...
//      }
      ...
      //CLASS_DECL_ACME bool utf8_to_multibyte(::u32 uCodePage, memory & str, const ::scoped_string & scopedstr, character_count nCount);
//
//      {
