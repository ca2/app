...
CLASS_DECL_ACME ::wd32_character * __u64towd32(huge_natural u, ::wd32_character * buf, int iBase, enum_digit_case edigitcase, ::wd32_character *& end);

CLASS_DECL_ACME ::wd32_character * __huge_integertowd32(huge_integer i, ::wd32_character * buf, int iBase, enum_digit_case edigitcase, ::wd32_character *& end);
...
CLASS_DECL_ACME huge_integer __wd32toi64(const ::wd32_character * psz, ::wd32_character ** ppszEnd, int iBase);
CLASS_DECL_ACME huge_natural __wd32tou64(const ::wd32_character * psz, ::wd32_character ** ppszEnd, int iBase);
