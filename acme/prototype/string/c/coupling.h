...
//CLASS_DECL_ACME ::ansi_character * u64toansi(huge_natural u, ::ansi_character * buf, int iBase);
//CLASS_DECL_ACME ::ansi_character * i64toansi(huge_natural u, ::ansi_character * buf, int iBase);
