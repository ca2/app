...
//CLASS_DECL_ACME ::ansi_character * u64toansi(::u64 u, ::ansi_character * buf, ::i32 iBase);
//CLASS_DECL_ACME ::ansi_character * i64toansi(::u64 u, ::ansi_character * buf, ::i32 iBase);
