...
CLASS_DECL_ACME ::wd16_character *             wd16_count_duplicate(const ::wd16_character * src, strsize srclen); // ATTENTION - ::system()->m_pheapmanagement->memory(::heap::e_memory_main)->allocate
...
CLASS_DECL_ACME int                    wd16_count_compare(const ::wd16_character * sz1, const ::wd16_character * sz2, strsize iLen);
CLASS_DECL_ACME int                    wd16_count_compare_case_insensitive(const ::wd16_character * sz1, const ::wd16_character * sz2, strsize iLen);
...
CLASS_DECL_ACME int                    wd16_count_collate(const ::wd16_character * sz1, const ::wd16_character * sz2, strsize iLen);
CLASS_DECL_ACME int                    wd16_count_collate_case_insensitive(const ::wd16_character * sz1, const ::wd16_character * sz2, strsize iLen);
...
CLASS_DECL_ACME void                   wd16_from_u64(::wd16_character * psz, u64 u, int iBase = 10, enum_digit_case edigitcase = e_digit_case_lower);
CLASS_DECL_ACME void                   wd16_from_i64(::wd16_character * psz, i64 i, int iBase = 10, enum_digit_case edigitcase = e_digit_case_lower);

CLASS_DECL_ACME void                   wd16_from_u32(::wd16_character * psz, unsigned int u, int iBase = 10, enum_digit_case edigitcase = e_digit_case_lower);
CLASS_DECL_ACME void                   wd16_from_i32(::wd16_character * psz, int i, int iBase = 10, enum_digit_case edigitcase = e_digit_case_lower);

CLASS_DECL_ACME i64                    wd16_to_i64(const ::wd16_character * psz, const ::wd16_character ** ppszEnd = nullptr, int iBase = 10);
CLASS_DECL_ACME u64                    wd16_to_u64(const ::wd16_character * psz, const ::wd16_character ** ppszEnd = nullptr, int iBase = 10);
CLASS_DECL_ACME i64                    wd16_count_to_i64(const ::wd16_character * psz, const ::wd16_character ** ppszEnd, int iBase, strsize srclen);

CLASS_DECL_ACME int                    wd16_to_i32(const ::wd16_character * psz, const ::wd16_character ** ppszEnd = nullptr, int iBase = 10);
CLASS_DECL_ACME unsigned int                    wd16_to_u32(const ::wd16_character * psz, const ::wd16_character ** ppszEnd = nullptr, int iBase = 10);
CLASS_DECL_ACME int                    wd16_count_to_i32(const ::wd16_character * psz, const ::wd16_character ** ppszEnd, int iBase, strsize srclen);
