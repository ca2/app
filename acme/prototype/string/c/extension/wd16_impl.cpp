...
CLASS_DECL_ACME ::i32 wd16_count_compare(const ::wd16_character * psz, const ::wd16_character * sz2, character_count len)
{
...
CLASS_DECL_ACME ::i32 wd16_count_compare_case_insensitive(const ::wd16_character * psz, const ::wd16_character * sz2, character_count len)
{
...
CLASS_DECL_ACME ::i32 wd16_count_collate(const ::wd16_character * psz, const ::wd16_character * sz2, character_count len)
{
...
CLASS_DECL_ACME ::i32 wd16_count_collate_case_insensitive(const ::wd16_character * psz, const ::wd16_character * sz2, character_count len)
{
...
CLASS_DECL_ACME const ::wd16_character * wd16_concatenate_and_duplicate(const ::wd16_character * psz1, const ::wd16_character * psz2, ::i32 iFree1, ::i32 iFree2)
{
...
//CLASS_DECL_ACME wide_character * wd16_concatenate(wide_character * dest, const wide_character * cat);
//CLASS_DECL_ACME wide_character * wd16_copy(wide_character * dest, const wide_character * src);
//CLASS_DECL_ACME wide_character * wd16_count_copy(wide_character * dest, const wide_character * src, character_count n);
//CLASS_DECL_ACME ::i32 wd16_char_is_alnum(::i32 wch);
//CLASS_DECL_ACME count wd16_length(const wide_character * pwsz);
//CLASS_DECL_ACME count wd16_32len_dup(const wchar_t * pwsz);
//CLASS_DECL_ACME wide_character * wd16_find_char(const wide_character * sz, unichar ch);
//CLASS_DECL_ACME ::i32 wd16_compare(const wide_character * psz, const wide_character * sz2);
//CLASS_DECL_ACME ::i32 wd16_compare_case_insensitive(const wide_character * psz, const wide_character * sz2);
//CLASS_DECL_ACME ::wd16_character * wd16_find_string_case_insensitive(const wide_character * src, const wide_character * find);

//CLASS_DECL_ACME void wd16_from_u64_base(wide_character * sz, ::u64 i, ::i32 iBase);
//CLASS_DECL_ACME void wd16_from_int_base(wide_character * sz, ::i64 i, ::i32 iBase);


//CLASS_DECL_ACME void l64toa_dup(::wd16_character * sz, ::i64 i, ::i64 iBase);
//CLASS_DECL_ACME void i64toa_dup(::wd16_character * sz, ::i64 i);
//CLASS_DECL_ACME void wd16_reverse(wide_character * sz);
...
//CLASS_DECL_ACME errno_t wd16_lower(wide_character * sz, character_count size);
//CLASS_DECL_ACME errno_t wd16_upper(wide_character * sz, character_count size);
...
//CLASS_DECL_ACME void ansi_to_wd16(wide_character * pwsz, const ::wd16_character * psz);
//CLASS_DECL_ACME wide_character * utf8_to_unicode(const ::wd16_character * psz);
//CLASS_DECL_ACME ::wd16_character * unicode_to_utf8(const wide_character * psz);
