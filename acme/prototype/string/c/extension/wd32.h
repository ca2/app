...
CLASS_DECL_ACME void                   wd32_from_huge_natural(::wd32_character * psz, huge_natural u, int iBase = 10, enum_digit_case edigitcase = e_digit_case_lower);
CLASS_DECL_ACME void                   wd32_from_huge_integer(::wd32_character * psz, huge_integer i, int iBase = 10, enum_digit_case edigitcase = e_digit_case_lower);
...
CLASS_DECL_ACME huge_integer                    wd32_to_huge_integer(const ::wd32_character * psz, const ::wd32_character ** ppszEnd = nullptr, int iBase = 10);
CLASS_DECL_ACME huge_natural                    wd32_to_huge_natural(const ::wd32_character * psz, const ::wd32_character ** ppszEnd = nullptr, int iBase = 10);
CLASS_DECL_ACME huge_integer                    wd32_count_to_huge_integer(const ::wd32_character * psz, const ::wd32_character ** ppszEnd, int iBase, character_count srclen);
