...
CLASS_DECL_ACME int _string_compare(const_char_pointer pszA, const_char_pointer pszB) noexcept { return ansi_cmp(pszA, pszB); }
CLASS_DECL_ACME int case_insensitive__string_compare(const_char_pointer pszA, const_char_pointer pszB) noexcept { return ansi_icmp(pszA, pszB); }
...
CLASS_DECL_ACME int case_insensitive__string_count_compare(const_char_pointer pszA, const_char_pointer pszB, character_count len) noexcept { return ansi_nicmp(pszA, pszB, len); }
...
CLASS_DECL_ACME int string_compare(const_char_pointer pszA, const_char_pointer pszB) noexcept { int ordering = 0; if (string_compare_prefix(ordering, pszA, pszB)) return ordering; return _string_compare(pszA, pszB); }
CLASS_DECL_ACME int case_insensitive_string_compare(const_char_pointer pszA, const_char_pointer pszB) noexcept { int ordering = 0; if (string_compare_prefix(ordering, pszA, pszB)) return ordering; return case_insensitive__string_compare(pszA, pszB); }
CLASS_DECL_ACME int string_count_compare(const_char_pointer pszA, const_char_pointer pszB, character_count len) noexcept { int ordering = 0; if (string_compare_prefix(ordering, pszA, pszB)) return ordering; return _string_count_compare(pszA, pszB, len); }
CLASS_DECL_ACME int case_insensitive_string_count_compare(const_char_pointer pszA, const_char_pointer pszB, character_count len) noexcept {int ordering = 0; if (string_compare_prefix(ordering, pszA, pszB)) return ordering; return  case_insensitive__string_count_compare(pszA, pszB, len); }
