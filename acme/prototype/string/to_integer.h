...
//CLASS_DECL_ACME ::i32 ansi_count_to_i64(const_char_pointer sz, size_t iLen);
...
//CLASS_DECL_ACME ::i64 ansi_to_i64(const_char_pointer sz, char_pointer * pszEnd);
//CLASS_DECL_ACME ::i64 ansi_to_i64(const_char_pointer sz);


//CLASS_DECL_ACME ::u64 ansi_to_u64(const_char_pointer sz, char_pointer * pszEnd);
//CLASS_DECL_ACME ::u64 ansi_to_u64(const_char_pointer sz);


//CLASS_DECL_ACME ::i64 ansi_count_to_i64(const_char_pointer sz, char_pointer * pszEnd, size_t iLen);
//CLASS_DECL_ACME ::i64 ansi_count_to_i64(const_char_pointer sz, size_t iLen);
...
//CLASS_DECL_ACME ::i64 wide_to_i64(const wide_character * sz, const wide_character * * pszEnd, ::i32 iBase);
//CLASS_DECL_ACME ::i64 wide_to_i64(const wide_character * sz, const wide_character * * pszEnd);
//CLASS_DECL_ACME ::i64 wide_to_i64(const wide_character * sz);
