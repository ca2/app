...
::i32            get_utf8_char_length(const_char_pointer psz);
...
//inline ::i32 unicode_index(const ::wd32_character *& input, character_count * psrclen);


// return Unicode Index and
// number of characters need to be consumed to parse a Unicode Character
inline ::i32 unicode_index_length(const_char_pointer pszChar, ::i32 & len);
...
inline ::i32 consume_unicode_index_length(const_char_pointer &pszChar);
...
inline ::i32 unicode_index(const_char_pointer pszChar) { ::i32 len = 0; return unicode_index_length(pszChar, len); }
...
inline ::i32 unicode_len(const_char_pointer pszChar);
...
inline ::i32 char_unicode_len(const_char_pointer ,::wd32_character i) { return ansichar_unicode_len(i); }
...
//       bool to_numeric_value(const ::scoped_string & scopedstrUtf8Char, ::f32 *f);
