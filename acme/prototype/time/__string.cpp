...
//{
//
//   str.formatf("%" PRId64 "ns", integral.m_i32);
//
//   return str;
//
//}
...
//{
//
//   str.formatf("%" PRId64 "μs", integral.m_i32);
//
//   return str;
//
//}
...
//{
//
//   str.formatf("%" PRId64 "ms", integral.m_i32);
//
//   return str;
//
//}
...
//{
//
//   str.formatf("%" PRId64 "s", integral.m_i32);
//
//   return str;
//
//}
...
//{
//
//   str.formatf("%" PRId64 "minute(s)", integral.m_i32);
//
//   return str;
//
//}
...
//{
//
//   str.formatf("%" PRId64 "hour(s)", integral.m_i32);
//
//   return str;
//
//}
...
//{
//
//   str.formatf("%" PRId64 "day(s)", integral.m_i32);
//
//   return str;
//
//}
