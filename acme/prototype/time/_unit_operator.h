...
//inline integral_nanosecond operator %(const integral_nanosecond & time, INTEGRAL integral) { return integral_nanosecond((long long)(time.m_i % integral)); }
template < primitive_integral INTEGRAL >
inline integral_nanosecond operator /(const integral_nanosecond & time, INTEGRAL integral) { return integral_nanosecond((long long)(time.m_i / integral)); }
template < primitive_integral INTEGRAL >
inline integral_nanosecond operator *(const integral_nanosecond & time, INTEGRAL integral) { return integral_nanosecond((long long)(time.m_i * integral)); }
...
//template < primitive_integral INTEGRAL >
//inline integral_microsecond operator %(const integral_microsecond & time, INTEGRAL integral) { return integral_microsecond((long long)(time.m_i % integral)); }
template < primitive_integral INTEGRAL >
inline integral_microsecond operator /(const integral_microsecond & time, INTEGRAL integral) { return integral_microsecond((long long)(time.m_i / integral)); }
template < primitive_integral INTEGRAL >
inline integral_microsecond operator *(const integral_microsecond & time, INTEGRAL integral) { return integral_microsecond((long long)(time.m_i * integral)); }
...
//template < primitive_integral INTEGRAL >
//inline integral_millisecond operator %(const integral_millisecond & time, INTEGRAL integral) { return integral_millisecond((long long)(time.m_i % integral)); }
template < primitive_integral INTEGRAL >
inline integral_millisecond operator /(const integral_millisecond & time, INTEGRAL integral) { return integral_millisecond((long long)(time.m_i / integral)); }
template < primitive_integral INTEGRAL >
inline integral_millisecond operator *(const integral_millisecond & time, INTEGRAL integral) { return integral_millisecond((long long)(time.m_i * integral)); }
...
//template < primitive_integral INTEGRAL >
//inline integral_second operator %(const integral_second & time, INTEGRAL integral) { return integral_second((long long)(time.m_i % integral)); }
template < primitive_integral INTEGRAL >
inline integral_second operator /(const integral_second & time, INTEGRAL integral) { return integral_second((long long)(time.m_i / integral)); }
template < primitive_integral INTEGRAL >
inline integral_second operator *(const integral_second & time, INTEGRAL integral) { return integral_second((long long)(time.m_i * integral)); }
...
//template < primitive_integral INTEGRAL >
//inline integral_minute operator %(const integral_minute & time, INTEGRAL integral) { return integral_minute((long long)(time.m_i % integral)); }
template < primitive_integral INTEGRAL >
inline integral_minute operator /(const integral_minute & time, INTEGRAL integral) { return integral_minute((long long)(time.m_i / integral)); }
template < primitive_integral INTEGRAL >
inline integral_minute operator *(const integral_minute & time, INTEGRAL integral) { return integral_minute((long long)(time.m_i * integral)); }
...
//template < primitive_integral INTEGRAL >
//inline integral_hour operator %(const integral_hour & time, INTEGRAL integral) { return integral_hour((long long)(time.m_i % integral)); }
template < primitive_integral INTEGRAL >
inline integral_hour operator /(const integral_hour & time, INTEGRAL integral) { return integral_hour((long long)(time.m_i / integral)); }
template < primitive_integral INTEGRAL >
inline integral_hour operator *(const integral_hour & time, INTEGRAL integral) { return integral_hour((long long)(time.m_i * integral)); }
...
//inline integral_nanosecond operator %(const integral_nanosecond & time, FLOATING floating) { return integral_nanosecond((long long)(time.m_i % floating)); }
template < primitive_floating FLOATING >
inline integral_nanosecond operator /(const integral_nanosecond & time, FLOATING floating) { return integral_nanosecond((long long)(time.m_i / floating)); }
template < primitive_floating FLOATING >
inline integral_nanosecond operator *(const integral_nanosecond & time, FLOATING floating) { return integral_nanosecond((long long)(time.m_i * floating)); }
...
//template < primitive_floating FLOATING >
//inline integral_microsecond operator %(const integral_microsecond & time, FLOATING floating) { return integral_microsecond((long long)(time.m_i % floating)); }
template < primitive_floating FLOATING >
inline integral_microsecond operator /(const integral_microsecond & time, FLOATING floating) { return integral_microsecond((long long)(time.m_i / floating)); }
template < primitive_floating FLOATING >
inline integral_microsecond operator *(const integral_microsecond & time, FLOATING floating) { return integral_microsecond((long long)(time.m_i * floating)); }
...
//template < primitive_floating FLOATING >
//inline integral_millisecond operator %(const integral_millisecond & time, FLOATING floating) { return integral_millisecond((long long)(time.m_i % floating)); }
template < primitive_floating FLOATING >
inline integral_millisecond operator /(const integral_millisecond & time, FLOATING floating) { return integral_millisecond((long long)(time.m_i / floating)); }
template < primitive_floating FLOATING >
inline integral_millisecond operator *(const integral_millisecond & time, FLOATING floating) { return integral_millisecond((long long)(time.m_i * floating)); }
...
//template < primitive_floating FLOATING >
//inline integral_second operator %(const integral_second & time, FLOATING floating) { return integral_second((long long)(time.m_i % floating)); }
template < primitive_floating FLOATING >
inline integral_second operator /(const integral_second & time, FLOATING floating) { return integral_second((long long)(time.m_i / floating)); }
template < primitive_floating FLOATING >
inline integral_second operator *(const integral_second & time, FLOATING floating) { return integral_second((long long)(time.m_i * floating)); }
...
//template < primitive_floating FLOATING >
//inline integral_minute operator %(const integral_minute & time, FLOATING floating) { return integral_minute((long long)(time.m_i % floating)); }
template < primitive_floating FLOATING >
inline integral_minute operator /(const integral_minute & time, FLOATING floating) { return integral_minute((long long)(time.m_i / floating)); }
template < primitive_floating FLOATING >
inline integral_minute operator *(const integral_minute & time, FLOATING floating) { return integral_minute((long long)(time.m_i * floating)); }
...
//template < primitive_floating FLOATING >
//inline integral_hour operator %(const integral_hour & time, FLOATING floating) { return integral_hour((long long)(time.m_i % floating)); }
template < primitive_floating FLOATING >
inline integral_hour operator /(const integral_hour & time, FLOATING floating) { return integral_hour((long long)(time.m_i / floating)); }
template < primitive_floating FLOATING >
inline integral_hour operator *(const integral_hour & time, FLOATING floating) { return integral_hour((long long)(time.m_i * floating)); }
