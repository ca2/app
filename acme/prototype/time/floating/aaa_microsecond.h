...
//
//
//   integral_second integral_seconds() const { return integral_second((long long)(m_d / 1'000'000.0)); }
//   integral_nanosecond integral_nanoseconds() const { return integral_nanosecond((long long)(fmod(m_d, 1'000'000.0) * 1'000.0)); }
//
//
//};
//
