// Created by camilo on 2021-10-05 12:35 BRT <3ThomasBorregaardSorensen!![ THE ONE GOD ]
#pragma once
...
//
//
//   integral_second integral_seconds() const { return integral_second((huge_integer)(m_d * 60.0)); }
//   integral_nanosecond integral_nanoseconds() const { return integral_nanosecond((huge_integer)(fmod(m_d * 60.0, 1.0) * 1'000'000'000.0)); }
//
//
//};
//
