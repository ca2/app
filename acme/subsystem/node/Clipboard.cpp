...
namespace subsystem
{
   ...
   // Clipboard::Clipboard(const ::operating_system::window & operatingsystemwindow)
   //   //: m_hndClipboard(0), m_hwnd(hwnd)
   // {
   //    initialize_clipboard(operatingsystemwindow);
   // }
   Clipboard::Clipboard()
     //: m_hndClipboard(0), m_hwnd(hwnd)
   {
   ...
   void Clipboard::setHWnd(const ::operating_system::window & operatingsystemwindow)
   {
      ...
      m_pparticleThis->setHWnd(operatingsystemwindow);
   ...
   bool Clipboard::getString(::string & str)
   {
      ...
      return m_pparticleThis->getString(str);
   ...
   bool Clipboard::setString(const ::scoped_string & scopedstr)
   {
   ...
   ::string Clipboard::removeCR(const ::scoped_string & scopedstr)
   {
      ...
      return m_pparticleThis->removeCR(scopedstr);
