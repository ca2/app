...
enum enum_toolbar_button
{

   e_toolbar_button_none            = 0,
   e_toolbar_button_checked         = 0x01,
   e_toolbar_button_pressed         = 0x02,
   e_toolbar_button_enabled         = 0x04,
   e_toolbar_button_hidden          = 0x08,
   e_toolbar_button_indeterminate   = 0x10,
   e_toolbar_button_wrap            = 0x20,
   e_toolbar_button_ellipses        = 0x40,
   e_toolbar_button_marked          = 0x80,

};


enum enum_toolbar_button_style
{

   e_toolbar_button_style = e_toolbar_style_button,
   e_toolbar_button_style_separator = e_toolbar_style_separator,
   e_toolbar_button_style_checkbox = e_toolbar_style_check,
   e_toolbar_button_style_group = e_toolbar_style_group,
   e_toolbar_button_style_check_group = e_toolbar_button_style_group | e_toolbar_button_style_checkbox,
   e_toolbar_button_style_dropdown = e_toolbar_style_dropdown,
   e_toolbar_button_style_autosize = e_toolbar_style_autosize,
   e_toolbar_button_style_noprefix = e_toolbar_style_noprefix,
...
//#define TBBS_NOPREFIX   MAKELONG(TBSTYLE_NOPREFIX, 0) // no accel prefix for this button
   e_toolbar_button_style_checked = MAKELONG(0, e_toolbar_button_checked),
   e_toolbar_button_style_pressed = MAKELONG(0, e_toolbar_button_pressed),
   e_toolbar_button_style_disabled = MAKELONG(0, e_toolbar_button_enabled),
   e_toolbar_button_style_indeterminate = MAKELONG(0, e_toolbar_button_indeterminate),
   e_toolbar_button_style_hidden = MAKELONG(0, e_toolbar_button_hidden),
   e_toolbar_button_style_wrapped = MAKELONG(0, e_toolbar_button_wrap),
   e_toolbar_button_style_ellipses = MAKELONG(0, e_toolbar_button_ellipses),
   e_toolbar_button_style_marked = MAKELONG(0, e_toolbar_button_marked),
};
