...
dialog_implementation::dialog_implementation()
{
...
::string dialog_implementation::dialog_details() const
{
...
::string_array_base dialog_implementation::dialog_details_icon_urls() const
{
...
::string dialog_implementation::dialog_title() const
{
...
void dialog_implementation::on_dialog_response(const ::payload & payloadResult){
...
class ::time dialog_implementation::dialog_time_remaining_from_timeout() const
{
...
class ::time dialog_implementation::dialog_timeout() const
{
...
//
//}
   ::function<void(const ::payload &)> & dialog_implementation::dialog_response_callback()
{

   return m_functionOnDialogResult2;

}

   void dialog_implementation::set_dialog_type(::user_interface::enum_dialog edialog)
{
...
void dialog_implementation::set_dialog_response(const ::payload & payloadResult)
{
