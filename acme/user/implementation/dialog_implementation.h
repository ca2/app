...
class CLASS_DECL_ACME dialog_implementation :
virtual public ::user_interface::dialog
{
public:


      ::user_interface::enum_dialog                                        m_edialog;
      ::string                                           m_strTitle;
   ...
   //::pointer < ::acme::user::dialog::data > m_pdialogdata;

   
   dialog_implementation();
   ~dialog_implementation() override;




   ::function<void(const ::payload &)> & dialog_response_callback() override;

   void set_dialog_type(::user_interface::enum_dialog edialog) override;

   virtual void on_initialize_dialog() override;
   
   
   virtual ::string dialog_title() const override;


   virtual void on_dialog_finished() override;
   ...
   //virtual void display_dialog(::dialog * pdialog);
   virtual void wait_dialog_response(const class ::time & timeTimeout = ::time::infinity()) override;
   bool is_waiting_for_dialog_response() override;
   
   virtual void set_dialog_response(const ::payload & payloadResult) override;
   
   
   virtual void on_dialog_response(const ::payload & payloadResult) override;


   //virtual message_box * get_message_box_payload();
   
   virtual class ::time dialog_time_remaining_from_timeout() const override;
   virtual class ::time dialog_timeout() const override;
   virtual ::string dialog_details() const override;
   virtual ::string_array_base dialog_details_icon_urls() const override;
