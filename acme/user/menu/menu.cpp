...
//
//
//   void menu::update_flags(::i32 iFlags)
//   {
//
//      m_iFlags = iFlags;
//
...
//
//
//   void menu::hints(::i32 iFlags, const ::i32_point & point)
//   {
//
//      update_flags(iFlags);
//
...
//      }
//
//      if (!m_pmenuitem->create_buttons(pdraw2dgraphics, this))
//      {
//
//         ASSERT(false);
//
