...
message_box::message_box(const ::scoped_string &scopedstrMessage, const ::scoped_string &scopedstrTitle,
...
message_box::message_box(const ::exception &exception, const ::scoped_string &strMessage,
