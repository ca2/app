...
void window::create_window()
{
   ...
   auto puserinteraction = pwindow->m_pacmeuserinteraction;
   ...
   ::i32 x = puserinteraction->get_window_rectangle().left;
   
   ::i32 y = puserinteraction->get_window_rectangle().top;
   
   ::i32 cx = puserinteraction->get_window_rectangle().width();
   
   ::i32 cy = puserinteraction->get_window_rectangle().height();
   
   bool bVisible = puserinteraction->is_window_visible();
...
::acme::sandbox_windowing::windowing * window::sandbox_windowing()
{
   ...
   ::cast < ::acme::sandbox_windowing::windowing > psandboxwindowing = system()->acme_windowing();
...
void windowing::initialize_windowing()
{
   ...
   ::acme::windowing::windowing::initialize_windowing();
...
void windowing::finalize_windowing()
{
   ...
   ::acme::windowing::windowing::finalize_windowing();
...
void window::set_parent(::acme::windowing::window* pwindowNewParent)
{
   ...
   auto pwindowx11NewParent = dynamic_cast <::acme::sandbox_windowing::window*> (pwindowNewParent);
...
//bool window::_set_window_position(const class ::zorder & zorder, ::i32 x, ::i32 y, ::i32 cx, ::i32 cy, const ::user::e_activation & useractivation, bool bNoZorder, bool bNoMove, bool bNoSize, ::e_display edisplay, ::u32 nOverrideFlags)
//{
//   
//   //synchronous_lock sl(user_synchronization(), DEFAULT_SYNCHRONOUS_LOCK_SUFFIX);
//   
...
//   {
//      
//      ::pointer<::acme::user::interaction>pinteraction = m_puserinteraction;
//      
...
void window::set_mouse_capture()
{
   ...
   ::cast < ::acme::sandbox_windowing::windowing > pwindowing = system()->acme_windowing();
...
bool window::is_active_window()
{
   ...
   return ::acme::windowing::window::is_active_window();
