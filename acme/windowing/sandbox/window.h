...
public:
   ...
   virtual ::acme::sandbox_windowing::windowing * sandbox_windowing();
   ...
   virtual bool operating_system_window_is_child(const ::operating_system::window & operatingsystemwindowChildCandidate);

   virtual bool operating_system_window_is_descendant(const ::operating_system::window & operatingsystemwindowDescendantCandidate);
   ...
   void set_parent(::acme::windowing::window* pwindowNewParent) override;
...
//   bool _set_window_position(const class ::zorder & zorder, int x, int y, int cx, int cy, const ::user::e_activation & useractivation, bool bNoZorder, bool bNoMove, bool bNoSize, ::e_display edisplay, ::u32 nOverrideFlags = 0) override;
