...
//               }
//
//               if (!m_strAppId.begins_ci("app-acme/netnode") && m_strAppId != "app-acme/mydns")
//               {
//
//                  ApplicationUser;
//
...
//
   ...
   */
   ...
   /*void ::acme::FormatString1(string & rString, UINT nIDS, const char * psz1)
   ...
   void ::acme::FormatString2(string & rString, UINT nIDS, const char * psz1,
...
//
   ...
   /* i32 ::acme::message_box(const char * pszText, UINT nType, UINT nIDHelp)
...
//   }
   ...
   ::estatus application::init()
   {
      ...
      xxdebug_box("::acme::application::initialize ok", "::acme::application::initialize ok", MB_ICONINFORMATION);
...
m_tickHeartBeat.Now();
   ...
   */
   ...
   //::estatus application::add_library(::acme::library * plibrary)
   //{
   ...
   void application::data_on_after_change(::message::message * pmessage)
   {
      ...
      if (pchange->m_datakey.m_strDataKey == "ca2.savings")
      {
         ...
         Session.savings().m_eresourceflagsShouldSave = (::acme::e_resource) pchange->data_get().i32();
