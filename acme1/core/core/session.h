...
//   class session_docs;
   ...
   public:
      ...
      public:
         ...
         string                              m_strApp;
         string                              m_strQuery;
         __pointer(::acme::session)          m_pbergedgeParent;
      ...
      //virtual void on_app_request_bergedge_callback(::generic * pobject);
      ...
      __pointer(::acme::application) get_current_application();

   

      virtual void set_app_title(const char * pszAppId, const char * pszTitle);

      virtual __pointer(::acme::session) get_context_session();
