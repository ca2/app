...
//      __pointer(::acme::run_start_installer)              m_prunstartinstaller;
      ...
      virtual ::estatus  initialize_system(::generic * pobjectContext, app_core * pappcore) override;

      virtual void discard_to_factory(__pointer(generic) pca);
      ...
      virtual void on_allocation_error(const ::string & str, ::generic * pobjectSometimes) override;
...
// void CLASS_DECL_ACME __start_core_system_main(::acme::system * psystem);
