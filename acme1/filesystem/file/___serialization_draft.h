...
public:
   ...
   virtual void write_object(const ::id & id, const ::id & idFactory, ::generic * pobject)
   {
...
public:
   ...
   virtual void write_object(const ::id & id, const ::id & idFactory, ::generic * pobject) override
   {
