...
//inline ::file_result generic::get_reader(const ::var & varFile, const ::efileopen & efileopen)
//{
//
...
//
//
//inline ::file_result generic::get_writer(const ::var & varFile, const ::efileopen & efileopen)
//{
//
