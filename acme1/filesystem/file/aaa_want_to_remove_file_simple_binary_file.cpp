...
namespace file
{
   ...
   simple_binary_file::simple_binary_file(::generic * pobject) :
      generic(pobject)
   {
...
/////////////////////////////////////////////////////////////////////////////
   ...
   void CLASS_DECL_ACME throw_exception(::generic * pobject,::estatus cause,LONG lOsError,const char * lpszFileName /* == NULL */)
   {
      //#ifdef _DEBUG
      //   const char * lpsz;
   ...
   bool simple_binary_file::GetStatus(::file::file_status& rStatus) const
   {
      ...
      if (m_pfile != NULL)
      {
         ...
         /*         else
                  {
                     DWORD dwAttribute = ::GetFileAttributesW(::acme::international::utf8_to_unicode(m_strFileName));
         ...
         #ifdef _DEBUG
                        // acme API BUG: m_attribute is only a BYTE wide
                        if (dwAttribute & ~0xFF)
...
//         return FALSE;
//      }
//      ::acme::international::unicode_to_utf8(rStatus.m_strFullName, wstrFullName);*/
//
