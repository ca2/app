...
CLASS_DECL_ACME ::type __form_document_type();
...
namespace filemanager
{
   ...
   string create_manager_id(::generic* pobject)
   {
   ...
   ::estatus component::initialize_filemanager_component(::generic * pobjectContext)
   {
      ...
      //__throw(todo("acme"));
      ////Session.userex()->shell()->initialize(&Session);
...
//document * component::open_main(::acme::application * pappOnBehalfOf, ::id id, ::create * pcreate, ::fs::data * pfsdata, ::filemanager::__pointer(data) pdata, callback * pcallback)
//{
...
//document * component::open(::acme::application * pappOnBehalfOf, id id, ::create * pcreateParam, ::fs::data * pfsdata, ::filemanager::__pointer(data) pdata, callback * pcallback)
//{
