...
//::file::path dir_context::userfolder(::generic * pobject)
//{
...
::file::path dir_context::matter_from_locator(const ::file::patha & patha, const string_array & straMatterLocator, bool bDir)
{
   ...
   ::acme::str_context * pcontext = Session.str_context();
...
//::file::path dir_context::userappdata(::generic * pobject)
//{
...
//::file::path dir_context::userdata(::generic * pobject)
//{
...
//::file::path dir_context::default_os_user_path_prefix(::generic * pobject)
//{
