...
//
//#ifdef WINDOWS
//CLASS_DECL_ACME void file_read_n_number_dup(HANDLE hfile,MD5_CTX * pctx,i32 & iNumber);
//CLASS_DECL_ACME void file_read_gen_string_dup(HANDLE hfile,MD5_CTX * pctx,string & str);
//#else
//CLASS_DECL_ACME void file_read_n_number_dup(FILE * hfile,MD5_CTX * pctx,i32 & iNumber);
//CLASS_DECL_ACME void file_read_gen_string_dup(FILE * hfile,MD5_CTX * pctx,string & str);
//#endif
//
//
//
