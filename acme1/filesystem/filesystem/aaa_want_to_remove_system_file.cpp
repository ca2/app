#include "framework.h"
#include "acme/os/windows_common/file_c.h"
#include "acme/machine_event2.h"
#include "acme/machine_event_central2.h"
#include <stdio.h>

#define UTF8_BOM "\xef\xbb\xbf"

#include "acme/compress/zip/zip.h"
...
//CLASS_DECL_ACME void NESSIEinit(struct NESSIEstruct * const structpointer);
//CLASS_DECL_ACME void NESSIEadd(const uchar * const source, uptr sourceBits, struct NESSIEstruct * const structpointer);
//CLASS_DECL_ACME void NESSIEfinalize(struct NESSIEstruct * const structpointer, uchar * const result);
...
namespace file
{
   ...
   bool system_file::exists(::file::path path, ::generic * pobject)
   {
   ...
   //bool system_file::is_file_or_dir(::file::path path, ::generic * pobject, ::file::e_type * petype)
   //{
   ...
   bool system_file::is_file_or_dir(::file::path path, var * pvarQuery, ::file::e_type * petype, ::generic * pobject)
   {
   ...
   var system_file::length(const ::file::path & pszPath,::generic * pobject)
   {
   ...
   var system_file::length(const ::file::path & path,var * pvarQuery,::generic * pobject)
   {
   ...
   ::file::path system_file::time_square(::generic * pobject,const string & pszPrefix,const string & pszSuffix)
   {
   ...
   ::file::path system_file::time_log(::generic * pobject,const string & pszId)
   {
      return time(pobject, Context.dir().time_log(pszId), 9);
   }


   ::file::path system_file::time(::generic * pobject,const ::file::path & psz,i32 iMaxLevel,const string & pszPrefix,const string & pszSuffix, bool bTryDelete)
   {
...
restart:
   ...
   var system_file::as_json(::generic * pobject, const var & varFile)
   {
   ...
   string system_file::as_string(::generic * pobject, const var & varFile)
   {
   ...
   bool system_file::as_memory(::generic * pobject, const var & varFile, memory_base & mem)
   {
   ...
   void system_file::put_lines(const var & varFile, const string_array & stra, ::generic * pobject)
   {
   ...
   void system_file::put_lines_utf8(const var & varFile, const string_array & stra, ::generic * pobject)
   {
   ...
   void system_file::lines(string_array & stra, const var & varFile, ::generic * pobject)
   {
   ...
   bool system_file::put_contents(const var & varFile, const void * pvoidContents, ::count count, ::generic * pobject)
   {
...
retry_get_file:
   ...
   bool system_file::add_contents(const var & varFile,const void * pvoidContents,::count count,::generic * pobject)
   {
   ...
   bool system_file::put_contents(const var & varFile, const char * pcszContents, ::generic * pobject)
   ...
   bool system_file::add_contents(const var & varFile,const char * pcszContents,::generic * pobject)
   ...
   bool system_file::put_contents(const var & varFile, ::file::file * pfile, ::generic * pobject)
   {
   ...
   bool system_file::put_contents(const var & varFile, memory & mem, ::generic * pobject)
   {
   ...
   bool system_file::put_contents_utf8(const var & varFile, const char * pcszContents, ::generic * pobject)
   {
   ...
   ::status::result system_file::copy(var varTarget, var varSource,bool bFailIfExists,e_extract eextract,::generic * pobject)
   {
   ...
   ::status::result system_file::move(const ::file::path & pszNew,const ::file::path & psz,::generic * pobject)
   {
   ...
   ::status::result system_file::del(const ::file::path & psz,::generic * pobject)
   {
   ...
   ::file::path system_file::duplicate(const ::file::path & psz,::generic * pobject)
   {
      string strCopy("copy");
      string strNew;
   ...
   ::file::path system_file::paste(const ::file::path & pathLocation,const ::file::path & path,::generic * pobject)
   {
   ...
   void system_file::trash_that_is_not_trash(::file::patha & stra, ::generic * pobject)
   {
   ...
   void system_file::trash_that_is_not_trash(const ::file::path & psz,::generic * pobject)
   {
   ...
   bool system_file::get_status(const ::file::path & path, ::file::file_status & status, ::generic * pobject)
   {
   ...
   ::status::result system_file::set_status(const ::file::path & path, const ::file::file_status & status, ::generic * pobject)
   {
   ...
   ::status::result system_file::replace(const ::file::path & pszContext,const string & pszFind,const string & pszReplace,::generic * pobject)
   {
   ...
   bool system_file::transfer(::generic* pobject, ::file::file* pfileOut, ::file::file* pfileIn)
   {
   ...
   bool system_file::is_read_only(const ::file::path & psz, ::generic * pobject)
   {
   ...
   ::file::path system_file::sys_temp(const ::file::path & lpszName, const char * pszExtension, ::generic * pobject)
   {
   ...
   file_pointer system_file::time_square_file(::generic * pobject, const string & pszPrefix, const string & pszSuffix)
   {
   ...
   file_pointer system_file::get(const ::file::path & name,::generic * pobject)
   {
   ...
   ::status::result system_file::rename(const ::file::path & pszNew,const ::file::path & psz,::generic * pobject)
   {
   ...
   void system_file::dtf(const ::file::path  & pszFile,const ::file::path & pszDir,::generic * pobject)
   {
      listing ls(::get_context_application(pobject));
      ls.rls( pszDir);
   ...
   void system_file::dtf(const ::file::path & pszFile,::file::patha & stra,::generic * pobject)
   {
   ...
   void system_file::ftd(const ::file::path & pszDir,const ::file::path & pszFile,::generic * pobject)
   {
   ...
   bool system_file::resolve_link(::generic * pobject, ::file::path & pathTarget, const string & strSource, string * pstrDirectory, string * pstrParams, ::user::primitive * puiMessageParentOptional)
   {
   ...
   string system_file::md5(const var & varFile, ::generic * pobject)
   {
   ...
   string system_file::nessie(const var & varFile, ::generic * pobject)
   {
   ...
   ::estatus system_file::initialize(::generic * pobjectContext)
   {
   ...
   //bool system_file::prepare_output(::generic * pobject, ::stream & outputstream, path & pathDownloading, const ::stream & os)
   //{
   ...
   //bool system_file::prepare_input(::generic * pobject, ::stream & is, const path & pathIn)
   //{
   ...
   //bool system_file::prepare_input(::generic * pobject, ::stream & is, ::file::file * pfileIn)
   //{
   ...
   //bool system_file::prepare_input(::generic * pobject, ::stream & is)
   //{
   ...
   bool system_file::post_output(::generic * pobject, ::file::path pathOut, ::file::path pathDownloading)
   {
   ...
   file_result system_file::file_get_file(::generic * pobject, ::file::path path, const efileopen & eopenFlags)
   {
   ...
   file_result system_file::data_get_file(::generic * pobject, string strData, const efileopen & eopenFlags)
   {
   ...
   file_result system_file::zip_get_file(::generic * pobject, ::file::path path, const efileopen & eopenFlags)
   {
   ...
   file_result system_file::http_get_file(::generic * pobject, const var & varFile, const efileopen & eopenFlags)
   {
   ...
   ::file_result system_file::get_reader(::generic* pobject, const var& varFile, const efileopen & eopenFlags)
   {
   ...
   ::file_result system_file::get_writer(::generic* pobject, const var& varFile, const efileopen & eopenFlags)
   {
   ...
   file_result system_file::get_file(::generic * pobject, const var & varFile, const efileopen & eopenFlags)
   {
      ...
      try
      {
         ...
         else
         {
            ...
            //   __pointer(::acme::application) pappLookup;
   ...
   //bool system_file::transfer(::generic * pobject, const path & pszOutput, ::file::file * pfileIn)
   //{
   ...
   //bool system_file::transfer(::generic * pobject, const path & pszOutput, ::stream & istream)
   //{
   ...
   //bool system_file::transfer(::generic * pobject, file * pfileOut, const path & pszSource)
   ...
   //bool system_file::transfer(::generic * pobject, file * pfileOut, ::file::file * pfileIn)
   //{
   ...
   //bool system_file::transfer(::generic * pobject, file * pfileOut, ::stream & istream)
   //{
   ...
   //bool system_file::transfer(::generic * pobject, ::stream & os, const path & pszSource)
   ...
   //bool system_file::transfer(::generic * pobject, ::stream & os, ::file::file * pfileIn)
   //{
   ...
   //bool system_file::transfer(::generic * pobject, ::stream & os, ::stream & istream)
   //{
   ...
   //bool system_file::transfer(::generic* pobject, ::stream& os, ::file::file & reader)
   //{
   ...
   ::file::path system_file::dropbox_info_json(::generic * pobject)
   {
   ...
   ::file::path system_file::onedrive_global_ini(::generic * pobject)
   {
   ...
   ::file::path system_file::onedrive_cid_ini(::generic * pobject)
   {
