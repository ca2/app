...
#if defined _M_IX86
#define _ace_LINKER_SYMBOL_PREFIX "_"
#elif defined _M_X64 || defined _M_ARM || defined _M_ARM64
#define _ace_LINKER_SYMBOL_PREFIX ""
#else
...
extern CLASS_DECL_ACME int g_bace;
...
CLASS_DECL_ACME void output_debug_string(const wchar_t * pwsz);
...
//CLASS_DECL_ACME int get_ace_init();

//extern "C"
//CLASS_DECL_ACME int_bool defer_ace_init();

//extern "C"
//CLASS_DECL_ACME int_bool defer_ace_term();
...
//#include "acme/platform/ace_main_struct.h"
...
//CLASS_DECL_ACME i32 ace_run_system(::acme::system* psystem);


//CLASS_DECL_ACME ::estatus ace_run_system_init(::acme::system * psystem);
//CLASS_DECL_ACME ::estatus ace_run_system_proc(::acme::system * psystem);
//CLASS_DECL_ACME ::estatus ace_run_system_term(::acme::system * psystem);
...
//extern "C"
//CLASS_DECL_ACME void register_ace_library(const char * psz, ::acme::library * plibrary);
//
//
//extern "C"
//CLASS_DECL_ACME void register_get_new_ace_library(const char* psz, PFN_NEW_ace_LIBRARY pfnNewaceLibrary);
//
//
//#define DECLARE_NEW_ace_LIBRARY(X) extern "C" \
//::acme::library * X##_new_ace_library()
//
//
//#define REGISTER_GET_NEW_ace_LIBRARY(X) register_get_new_ace_library(#X, &X##_get_new_library)
//
...
namespace sockets // only usable from acme.dll and dependants
{

   class sockets; // only usable from acme.dll and dependants
...
namespace url
{
   ...
   class department; // only usable from acme.dll and dependants


} // namespace url


class compress_department; // only usable from acme.dll and dependants
...
#ifdef WINDOWS
CLASS_DECL_ACME bool defer_co_initialize_ex(bool bMultiThread, bool bDisableOleDDE = false);
#endif
...
//CLASS_DECL_ACME bool ace_init();
//CLASS_DECL_ACME bool ace_term();

CLASS_DECL_ACME bool __node_ace_pre_init();
CLASS_DECL_ACME bool __node_ace_pos_init();

CLASS_DECL_ACME bool __node_ace_pre_term();
CLASS_DECL_ACME bool __node_ace_pos_term();


//extern "C" CLASS_DECL_ACME PFN_NEW_ace_LIBRARY get_get_new_ace_library(const char * psz);
//extern "C" CLASS_DECL_ACME void register_get_new_ace_library(const char* psz, PFN_NEW_ace_LIBRARY pfnNewaceLibrary);
//
//
...
#include "acme/multithreading/_common.h"
...
//#include "acme/user/experience/_.h"
...
//#include "acme/user/userex/userex.h"
...
//CLASS_DECL_ACME void set_ace(void * p,::acme::application * papp);

//CLASS_DECL_ACME ::acme::application * get_ace(void * p);
