...
int main(Array < String ^ > ^ refstra)
{
   ...
   ap(ace_main_data) pmaindata = new ace_main_data(refstra);
...
//   {
//
//      __pointer(class ace_ace) pace;
//
//      __pointer(class ace_main_data) pmaindata;
//
//      {
//
...
//
//
//         pace = __new(class ace_ace);
//
//         pmaindata = __new(ace_main_data(hinstance, hPrevInstance, pCmdLine, nCmdShow));
//
//#ifdef MAIN_RUNNER0
//
