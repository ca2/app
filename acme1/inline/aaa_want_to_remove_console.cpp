...
console::console(int argc, wchar_t* argv[])
{
   ...
   PFN_NEW_ace_APPLICATION pfnNewaceApplication = &new_ace_application;

#else

   PFN_NEW_ace_APPLICATION pfnNewaceApplication = nullptr;

#endif

#ifdef ACID_LIBRARY

   PFN_NEW_ace_LIBRARY pfnNewLibrary = &new_ace_library;

#else

   PFN_NEW_ace_LIBRARY pfnNewLibrary = nullptr;
