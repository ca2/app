...
void application_common(::acme::system * psystem)
{
   ...
   pmainstruct->m_pfnNewaceApplication = &new_ace_application;

#endif

#ifdef ACID_LIBRARY

   pmainstruct->m_pfnNewLibrary = &new_ace_library;
...
public:
   ...
   virtual ::acme::application* new_application() override { return new APPLICATION; }
