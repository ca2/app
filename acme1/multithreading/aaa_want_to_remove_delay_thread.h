...
public:
   ...
   delay_thread(::generic * pobject, DWORD dwSleep = 1000) :
      ::generic(pobject)
   {
...
public:
   ...
   pred_delay_thread(::generic * pobject, PRED pred, DWORD dwSleep = 1000) :
      m_pred(pred),
      ::generic(pobject),
...
template < typename PRED >
delay_thread * pred_delay(::generic * pobject, tick tickDelay, PRED pred)
{
