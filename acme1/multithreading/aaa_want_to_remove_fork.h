...
public:
   ...
   pred_thread(::generic * pobject, PRED pred) :
      m_pred(pred)
   {
...
template < typename PRED >
inline auto new_pred_thread(::generic * pobject, PRED pred)
{
...
template < typename PRED >
__pointer(::thread) & fork(__pointer(::thread) & pthread, ::generic * pobject, PRED pred)
{
...
template < typename PRED >
::thread * fork(::generic * pobject, __pointer(generic) pholdref, PRED pred)
{
...
template < typename PRED >
::thread * fork(::generic * pobject, PRED pred)
{
...
template < typename PRED >
inline auto generic::fork(PRED pred)
{
...
template < typename PRED >
inline auto ::generic::new_pred_thread(PRED pred)
{
...
template < typename PRED >
::thread * pred_run(::generic * pobjectParent, bool bSync, PRED pred);
...
template < typename PRED >
::thread * & fork(::thread * & pthread, ::generic * pobject, PRED pred)
{
...
template < typename PRED >
::thread * fork(::generic * pobject, PRED pred, const char * pszTag, int iCallStackAddUp = 0, e_priority epriority = priority_normal)
{
...
template < typename PRED >
::thread * opt_fork(::generic * pobject,  PRED pred)
{
...
template < typename PRED >
inline __pointer(::thread) & generic::fork(__pointer(::thread) & pthread, PRED pred, const char * pszTag, int iCallStackAddUp)
{
...
template < typename PRED >
inline auto generic::fork(PRED pred, const char * pszTag, int iCallStackAddUp, e_priority epriority)
{
...
template < typename PRED >
inline ::thread_pointer generic::defer_fork(const char * pszTag, PRED pred)
{
...
template < typename PRED >
inline auto generic::opt_fork(PRED pred)
{
...
template < typename PRED >
inline ::thread_pointer generic::pred_run(bool bSync, PRED pred)
{
...
template < typename T >
inline void fork_release(::generic * pobjectParent, __pointer(T) & t)
{
...
CLASS_DECL_ACME DWORD_PTR translate_processor_affinity(int i);
...
public:
   ...
   forking_count_pred(::generic * pobject, index iOrder, index iIndex, ::count iScan, ::count cCount, PRED pred) :
   ::generic(pobject),
...
public:
   ...
   __pointer(generic)  m_pobjectTaskEnd;

   __pointer(generic)  m_pholdref;


   forking_count_thread(::generic * pobject, __pointer(generic) pholdref, index iOrder, index iIndex, ::count iScan, ::count iCount, PRED pred, ::generic * pobjectTaskEnd = nullptr) :
   ::generic(pobject),
   m_pholdref(pholdref),
   m_pred(pred),
   m_iOrder(iOrder),
   ...
   forking_count_thread(::generic * pobject, index iOrder, index iIndex, ::count iScan, ::count iCount, PRED pred, ::generic * pobjectTaskEnd = nullptr) :
   ::generic(pobject),
   m_pred(pred),
   m_iOrder(iOrder),
   m_iIndex(iIndex),
...
template < typename PRED >
auto fork_count(::generic * pobjectParent, ::count iCount, PRED pred, index iStart = 0)
{
...
::count fork_count_end_pred(::generic * pobjectParent, ::count iCount, PRED pred, PRED_END predEnd, ::duration duration = ::duration::infinite(), index iStart = 0)
{
...
public:
   ...
   forking_for_thread(::generic * pobject, index iOrder, index iIndex, ::count iScan, ::count iCount, PRED pred) :
   ::generic(pobject),
   m_pred(pred),
   m_iOrder(iOrder),
   m_iIndex(iIndex),
...
template < typename PRED >
auto fork_for(::generic * pobjectParent, ::count iCount, PRED pred, index iStart = 0)
{
...
template < typename PRED, typename PRED_END >
auto fork_for_end(::generic* pobjectParent, ::count iCount, PRED pred, PRED_END predEnd, index iStart = 0)
{
...
template < typename PRED >
__pointer_array(::thread) fork_proc(::generic * pobjectParent, PRED pred, index iCount = -1)
{
...
template < typename PRED >
::thread * pred_run(::generic * pobject, bool bSync, PRED pred)
{
...
template < typename PRED >
inline __pointer(::thread) & generic::defer_fork(__pointer(::thread) & pthread, PRED pred)
{
