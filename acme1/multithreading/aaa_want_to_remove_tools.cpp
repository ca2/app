...
thread_group::thread_group(::generic * pobject, ::e_priority epriority) :
   ::generic(pobject)
{
...
//CLASS_DECL_ACME ::thread_group * get_thread_group(::e_priority epriority)
//{
//
...
//
//
//CLASS_DECL_ACME ::thread_groupet * get_thread_groupet(::enum_thread_tool etool)
//{
//
...
//   generic(ptools->get_context_application()),
