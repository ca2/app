...
class CLASS_DECL_ACME tool_thread :
...
class CLASS_DECL_ACME thread_tool_item :
...
class CLASS_DECL_ACME thread_tool :
   virtual public ::generic
{
public:
...
class CLASS_DECL_ACME thread_group :
   virtual public ::generic
{
public:
   ...
   thread_group(::generic * pobject, ::e_priority epriority);
...
inline ::count fork_count_end(::generic* pobject, ::count iCount, PRED pred, index iStart = 0, ::e_priority epriority = ::priority_none);
