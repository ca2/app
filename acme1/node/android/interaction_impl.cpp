...
//CLASS_DECL_ACME thread_int_ptr < DWORD_PTR > t_time2;
//
//
...
///      ASSERT(HWND_TOP == nullptr);       // same as desktop
   ...
   /* trans   if (!::acme::HtmlHelp(NODE_WINDOW(pwindow)->get_handle(), pApp->m_pszHelpFilePath, nCmd, dwData))
   {
   // android System.message_box(__IDP_FAILED_TO_LAUNCH_HELP);
   System.message_box("Failed to launch help");
   }*/
   ...
   void interaction_impl::message_handler(::message::acme * pmessage)
   {
...
//void interaction_impl::on_delete(::generic * pinteraction)
//{
