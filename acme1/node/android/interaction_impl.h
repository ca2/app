...
namespace android
{
   ...
   class CLASS_DECL_ACME interaction_impl:
...
//      virtual void _001WindowMinimize();
      ...
      virtual bool OnCommand(::message::acme * pbase) override;
      virtual bool OnNotify(::message::acme * pbase) override;
      ...
      virtual void message_handler(::message::acme * pbase) override;
      ...
      //virtual bool OnChildNotify(::message::acme * pbase);
      // return TRUE if parent should not process this message
      //virtual bool ReflectChildNotify(::message::acme * pbase);
      //static bool ReflectMessage(oswindow oswindow_Child,::message::acme * pbase);
