...
::user::interaction_impl *  interaction_impl::from_os_data(void * pdata)
   ...
   /*__STATIC bool CLASS_DECL_BASE __modify_style(oswindow hWnd, i32 nStyleOffset,
    ...
    {
    ASSERT(hWnd != nullptr);
    DWORD uStyle = ::GetWindowLong(hWnd, nStyleOffset);
    DWORD dwNewStyle = (uStyle & ~dwRemove) | dwAdd;
...
//      }
   ...
   void interaction_impl::assert_valid() const
   {
      ...
      // the oswindow with a user::interaction generic by using ::macos::interaction_impl::from_handle.
      //
...
//                                       const ::rect & rect, LPCRECT lpClipRect)
//   {
//      /*      ASSERT(::is_window(get_handle()));
//
...
//   i32 interaction_impl::ScrollWindowEx(i32 dx, i32 dy, const ::rect & rectScroll, const ::rect & rectClip, ::draw2d::region* prgnUpdate, LPRECT lpRectUpdate, UINT flags)
//   {
//
//      __throw(not_implemented());
//      //      ASSERT(::is_window(get_handle()));
...
//         ptext->_001SetSel(iSelBeg, iSelEnd);
   ...
   void interaction_impl::queue_message_handler(::message::acme * pbaseParam)
   {

      defer_create_thread(this);
      
      __pointer(::message::acme) pbase = pbaseParam;
   ...
   void interaction_impl::on_host_message_handler(::message::acme * pbase)
   {
