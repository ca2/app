...
//   bool dir_context::rm(::generic * const ::file::path & psz, bool bRecursive)
//   {
//      if(bRecursive)
//      {
...
//   string dir_context::usersystemappdata(::generic * const char * lpcszPrefix, const char * pcsz, const char * lpcsz2)
//   {
//      UNREFERENCED_PARAMETER(pobject);
//      return path(appdata(lpcszPrefix), pcsz, lpcsz2);
//   }
//
//   string dir_context::appdata(::generic * const char * pcsz, const char * lpcsz2)
//   {
//      return path(userfolder(papp, "appdata"), pcsz, lpcsz2);
//   }
//
//   string dir_context::userdata(::generic * const char * pcsz, const char * lpcsz2)
//   {
...
//   string dir_context::default_userappdata(::generic * const char * lpcszPrefix, const char * lpcszLogin, const char * pszRelativePath)
//   {
//      return path(default_userfolder(papp, lpcszPrefix, lpcszLogin, "appdata"), pszRelativePath);
//   }
//
//   string dir_context::default_userdata(::generic * const char * lpcszPrefix, const char * lpcszLogin, const char * pszRelativePath)
//   {
//      return path(default_userfolder(papp, lpcszPrefix, lpcszLogin, "data"), pszRelativePath);
//   }
//
//   string dir_context::default_userfolder(::generic * const char * lpcszPrefix, const char * lpcszLogin, const char * pszRelativePath)
//   {
//
...
//   }
//
//   string dir_context::userquicklaunch(::generic * const char * lpcszRelativePath, const char * lpcsz2)
//   {
//      UNREFERENCED_PARAMETER(pobject);
//      string str;
//      /*SHGetSpecialFolderPath(
...
//   string dir_context::userprograms(::generic * const char * lpcszRelativePath, const char * lpcsz2)
//   {
//      UNREFERENCED_PARAMETER(pobject);
//      string str;
//      /*      SHGetSpecialFolderPath(
...
//    ::file::path dir_context::usersystemappdata(::generic * pobject,const char * lpcszPrefix)
//    {
//        UNREFERENCED_PARAMETER(pobject);
//        return appdata() / lpcszPrefix;
//    }
//
//    ::file::path dir_context::appdata(::generic * pobject)
//    {
...
//    ::file::path dir_context::default_userappdata(::generic * pobject,const string & lpcszPrefix,const string & lpcszLogin)
//    {
//        return default_userfolder(papp, lpcszPrefix, lpcszLogin) /  "appdata" ;
//    }
//
//    ::file::path dir_context::default_userdata(::generic * pobject,const string & lpcszPrefix,const string & lpcszLogin)
//    {
//        return default_userfolder(papp, lpcszPrefix, lpcszLogin) / "data";
//    }
//
//    ::file::path dir_context::default_userfolder(::generic * pobject,const string & lpcszPrefix,const string & lpcszLogin)
//    {
//
...
//    bool dir_context::has_subdir(::generic * const ::file::path & pszDir)
//    {
//
//        file_find file_find;
//
