...
namespace uwp
{
   ...
   directx_application::directx_application(::acme::system * psystem, ::String ^ strId)
   {
...
//      psystem->get_context_session()->m_directxapplication = this;
   ...
   directx_application_source ^ new_directx_application_source(::acme::system * pacesystem, const string & strId)
   {
      ...
      return ref new directx_application_source(pacesystem, str);
