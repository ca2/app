...
namespace uwp
{
   ...
   CLASS_DECL_ACME LRESULT CALLBACK __send_message_hook(int, WPARAM, LPARAM);
   //CLASS_DECL_ACME void _gen::StandardSubclass(oswindow);
   CLASS_DECL_ACME LRESULT CALLBACK __cbt_filter_hook(int, WPARAM, LPARAM);
   CLASS_DECL_ACME LRESULT __call_window_procedure(::user::interaction * pWnd, oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam);
   ...
   public:
      ...
      __pointer_array(::message::acme)                      m_messageaQueue;
...
//      void OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar);
      ...
      CLASS_DECL_ACME friend LRESULT CALLBACK __send_message_hook(int, WPARAM, LPARAM);
      //CLASS_DECL_ACME friend void _gen::StandardSubclass(oswindow);
      CLASS_DECL_ACME friend LRESULT CALLBACK __cbt_filter_hook(int, WPARAM, LPARAM);
      CLASS_DECL_ACME friend LRESULT __call_window_procedure(::user::interaction * pWnd, oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam);
      ...
      virtual void queue_message_handler(::message::acme * pbase) override;
