...
namespace uwp
{
   ...
   CLASS_DECL_ACME void        TimeToFileTime(::generic * pobject, const ::datetime::time& time, LPFILETIME pFileTime);
...
CLASS_DECL_ACME void __end_thread(::generic * pobject, UINT nExitCode, bool bDelete = TRUE);

CLASS_DECL_ACME void __init_thread();
//CLASS_DECL_ACME void __term_thread(::generic * pobject, HINSTANCE hInstTerm = nullptr);
