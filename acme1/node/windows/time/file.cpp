...
bool CLASS_DECL_ACME vfxGetInProcServer(const char * pszCLSID, string & str)
...
// turn a file, relative path or other into an absolute path
bool CLASS_DECL_ACME vfxFullPath(unichar * pszPathOut, const unichar * pszFileIn)
...
void CLASS_DECL_ACME vfxGetRoot(const unichar * pszPath, string& strRoot)
