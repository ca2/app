...
namespace windows
{
...

   {
      ...
      //if(::acme::file_context::FullPath(str, pszFileIn))
   ...
   bool file_context::FullPath(wstring & wstrFullPath, const wstring & wstrPath)
   {
      ...
      /*      if(::acme::file_context::FullPath(wstrFullPath, wstrPath))
      return true;*/
   ...
   //   {
   //      ::acme::TimeToFileTime(status.m_mtime,&lastWriteTime);
   ...
   //      {
   //         ::acme::TimeToFileTime(status.m_atime,&lastAccessTime);
   ...
   //      {
   //         ::acme::TimeToFileTime(status.m_ctime,&creationTime);
