...
namespace windows
{
   ...
   //CLASS_DECL_ACME LRESULT CALLBACK __send_message_hook(i32, WPARAM, LPARAM);
   //CLASS_DECL_ACME LRESULT CALLBACK __cbt_filter_hook(i32, WPARAM, LPARAM);
...
//
      ...
      ////virtual id   RunModalLoop(u32 dwFlags = 0,::generic * pliveobject = nullptr);
      //virtual bool ContinueModal() override;
      //virtual void EndModalLoop(id nResult) override;
      //virtual void EndAllModalLoops(id nResult);

      // Window-Management message handler member functions
      virtual bool OnCommand(::message::acme * pbase);
      virtual bool OnNotify(::message::acme * pbase);
      ...
      virtual bool ReflectMessage(oswindow oswindow_Child, ::message::acme * pbase);
      ...
      //CLASS_DECL_ACME friend LRESULT CALLBACK __send_message_hook(i32, WPARAM, LPARAM);
      //CLASS_DECL_ACME friend LRESULT CALLBACK __cbt_filter_hook(i32, WPARAM, LPARAM);
