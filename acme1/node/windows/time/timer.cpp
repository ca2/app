...
VOID CALLBACK ace_timer_TimerRoutine(PVOID pParam, BOOLEAN TimerOrWaitFired);
...
//
//   //if(!CreateTimerQueueTimer(&m_hTimer,m_hTimerQueue,(WAITORTIMERCALLBACK)ace_timer_TimerRoutine,this,m_dwMillis,0,WT_EXECUTEONLYONCE | WT_EXECUTELONGFUNCTION))
//   //{
//
//   //   release();
//
...
//   {
//
//      output_debug_string("there is timer on (ace_timer_TimerRoutine) and acme is going away (!g_bace)\n");
//
//      return;
//
//   }
