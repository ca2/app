...
*/
typedef void FN_ANDROID_MAIN(struct android_app* app);
typedef FN_ANDROID_MAIN * PFN_ANDROID_MAIN;
...
*
* 3/ the "android_app" generic holds an ALooper instance that already
...
struct android_app
{
   // The application can place a pointer to its own state generic
   // here if it likes.
   void* userData;
   ...
   // The ANativeActivity generic instance that this app is running in.
   ...
   // APP_CMD_RESUME, at which point it will be freed and savedState set to nullptr.
   // These variables should only be changed when processing a APP_CMD_SAVE_STATE,
   // at which point they will be initialized to nullptr and you can malloc your
