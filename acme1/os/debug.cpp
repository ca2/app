...
//CLASS_DECL_ACME void __tracea(::generic * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * psz)
//{
//
...
//CLASS_DECL_ACME void __tracef(::generic * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, ...)
//{
//
//   va_list list;
//
...
//CLASS_DECL_ACME void __tracev(::generic * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, va_list args)
//{
//
//   if (::is_null(::get_context_system()))
//   {
