...
//   ace_set_alloc(ace_memory_alloc, &ace_memory_realloc, &acme, <#size_t s#>, <#PFN_MEMORY_REALLOC prealloc#>, <#PFN_MEMORY_FREE pfree#>, <#PFN_MEMORY_SIZE psize#>)
//
   return true;
