...
#define LDR_DLL_NOTIFICATION_REASON_UNLOADED     2
   ...
   typedef struct _LDR_DLL_LOADED_NOTIFICATION_DATA
   {
      ...
      PCUNICODE_STRING BaseDllName;   //The acme file name of the DLL module.
      PVOID DllBase;                  //A pointer to the acme address for the DLL in memory.
...
static const char * moda[]= {"/ca2/stage/x86/libace.so", "/ca2/stage/x86/libbase.so", "/ca2/stage/x86/libcore.so", nullptr};
static bfd* abfda[64];
