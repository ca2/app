...
CLASS_DECL_ACME WINBOOL os_init_windowing();
...
CLASS_DECL_ACME WINBOOL show_window(oswindow oswindow, int iShow);
CLASS_DECL_ACME WINBOOL set_foreground_window(oswindow oswindow);
