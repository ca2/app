...
CLASS_DECL_ACME HFONT wingdi_CreatePointFont(int nPointSize, const char * pszFaceName, HDC hdc, LOGFONTW* lpLogFont = nullptr);


CLASS_DECL_ACME HFONT wingdi_CreatePointFontIndirect(LOGFONTW* pLogFont, HDC hdc);
