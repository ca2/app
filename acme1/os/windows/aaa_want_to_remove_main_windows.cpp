...
////#ifdef ACID_APP
////
////      PFN_NEW_ace_APPLICATION pfnNewaceApplication = &get_acid_app;
////
////#else
////
////      PFN_NEW_ace_APPLICATION pfnNewaceApplication = (PFN_NEW_ace_APPLICATION) ::GetProcAddress(hinstance, "new_ace_application");;
////
////#endif
//
////#ifdef ACID_LIBRARY
////
////      PFN_NEW_ace_LIBRARY pfnNewLibrary = &get_acid_library;
////
////#else
////
...
////#endif
//
//      //if (pfnNewaceApplication)
//      //{
//
//      //   pfnNewaceApplication = 
//
//      //}
//
//      //if (!pacemain)
