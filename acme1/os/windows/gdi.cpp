...
namespace draw2d
{
   ...
   //CLASS_DECL_ACME void wingdi_enum_fonts(::draw2d::font_enum_item_array & itema, bool bRaster, bool bTrueType, bool bOther)
   //{
...
//CLASS_DECL_ACME HBITMAP CreateAlphaBitmapV5(const ::image * pimage)
//{
//
//   if (!pimage->is_ok())
//   {
...
//CLASS_DECL_ACME HBITMAP CreateHBITMAP(pixmap * ppixmap)
//{
//
//   pixmap pixmap;
//
...
//CLASS_DECL_ACME HBITMAP CreateHBITMAP2(pixmap * ppixmap)
//{
//
