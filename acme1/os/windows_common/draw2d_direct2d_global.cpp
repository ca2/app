...
namespace draw2d_direct2d
{
   ...
   void plugin::initialize()
   {
      ...
      // Create the Direct3D 11 API device generic and a corresponding context.
      ...
      // Create the Direct2D device generic and a corresponding context.
      ::dx::throw_if_failed(
...
CLASS_DECL_ACME IDWriteFactory * global_draw_get_write_factory(bool bCreate)
{
