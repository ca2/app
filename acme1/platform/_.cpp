...
//string_map < PFN_NEW_ace_LIBRARY >* g_pmapNewaceLibrary = nullptr;


//::mutex* &::get_context_system()->m_mutexLibrary = nullptr;


//CLASS_DECL_ACME string_map < PFN_NEW_ace_LIBRARY >& __get_new_ace_library()
//{
//
//   return ::get_context_system()->m_mapNewaceLibrary;
//
//}
...
//CLASS_DECL_ACME PFN_NEW_ace_LIBRARY get_get_new_ace_library(const char* psz)
//{
//
//   sync_lock sl(&::get_context_system()->m_mutexLibrary);
//
//   auto ppair = ::get_context_system()->m_mapNewaceLibrary.plookup(psz);
//
//   if (::is_null(ppair))
//   {
//
...
//   sync_lock sl(&::get_context_system()->m_mutexLibrary);
//
//   __get_new_ace_library()[psz] = pfnNewaceLibrary;
//
//}
...
CLASS_DECL_ACME int get_ace_init()
{
   ...
   return g_iaceRefCount;

}


//extern "C"
//CLASS_DECL_ACME::acme::system * ace_create_ace_system()
//{
//
...
// ::map < void*, void*, ::acme::application*, ::acme::application* >* g_pmapace = nullptr;


// void set_ace(void* p, ::acme::application* papp)
// {

//    g_pmapace->set_at(p, papp);

// }


// ::acme::application* get_ace(void* p)
// {

//    return g_pmapace->operator [](p);
