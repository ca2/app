...
namespace acme
{
   ...
   namespace ipc
   {
      ...
      class CLASS_DECL_ACME rx:
         virtual public acme
      {
      public:


         class CLASS_DECL_ACME receiver
         {
         public:
      ...
      CLASS_DECL_ACME string app_install(string strPlatform = "");
