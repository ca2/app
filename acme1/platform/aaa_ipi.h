...
namespace acme
{
   ...
   class CLASS_DECL_ACME ipi :
      virtual public generic,
      virtual public ::acme::ipc::rx::receiver
   {
   public:
      ...
      string                                       m_strApp;
      ::id                                         m_idApp;
      string_map < __pointer(::acme::ipc::tx) >    m_txmap;
      string_map < __pointer(::mutex) >            m_mapAppMutex;
      __pointer(::acme::ipc::rx)                   m_prx;
      ...
      virtual ::acme::ipc::tx & tx(const string & strApp, const ::id & idPid);
      ...
      using ::acme::ipc::rx::receiver::on_ipc_receive;

      virtual void on_ipc_receive(::acme::ipc::rx * prx, const char * pszMessage) override;
