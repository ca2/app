...
bool ace_defer_process_x_message(HTHREAD hthread,LPMESSAGE pMsg,oswindow oswindow,bool bPeek);
...
//#if defined(LINUX) // || defined(ANDROID)
//
//   if(ace_defer_process_x_message(hthread,pMsg,oswindow,!(wRemoveMsg & PM_REMOVE)))
//   {
//
//      return TRUE;
//
...
CLASS_DECL_ACME int_bool mq_post_message(oswindow oswindow, UINT message, WPARAM wparam, LPARAM lparam)
{
