...
void application_container::app_add(::acme::application * papp)
{
...
void application_container::app_remove(::acme::application * papp)
{
...
__pointer(::acme::application) application_container::instantiate_application(const char * pszAppId, ::create * pcreate)
{

   INFO("acme::application::instantiate_application");
...
__pointer(::acme::application) application_container::create_application(const char * pszAppId, bool bSynch, ::create * pcreate)
{

   __pointer(::acme::application) papp = instantiate_application(pszAppId, pcreate);
...
__pointer(::acme::application) application_container::create_platform(::acme::session * psession)
{
...
__pointer(::acme::application) application_container::assert_running(const char * pszAppId, const string & strLocale, const string & strSchema)
{
...
__pointer(::acme::application) application_container::start_application(const char * pszAppId, ::create * pcreate, const string & strLocale, const string & strSchema)
{
...
::acme::application * application_container::application_get(const char * pszAppId, bool bCreate, bool bSynch, ::create * pcreate)
   {
