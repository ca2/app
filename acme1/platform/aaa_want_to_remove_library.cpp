...
namespace acme
{
   ...
   ::estatus     library::initialize(::generic * pobjectContext)
   {
   ...
   ::estatus library::initialize_ace_library(::generic * pobjectContext,int iDesambig,const char * pszRoot, const char * pszName, const char * pszFolder)
   {
   ...
   bool library::open(const char * pszPath,bool bAutoClose,bool bCa2Path)
   {
      ...
      auto pfnNewaceLibrary = get_get_new_ace_library(pszPath);

      if (pfnNewaceLibrary != nullptr)
      {
   ...
   bool library::open_ca2_library(string strTitle)
   {
      ...
      PFN_NEW_ace_LIBRARY pfnNewaceLibrary = nullptr;
      ...
      if (!m_pca2library)
      {
         ...
         try
         {
            ...
            pfnNewaceLibrary = get_get_new_ace_library(m_strPath);
            ...
            if (pfnNewaceLibrary == nullptr)
            {
               ...
               if (strTitle.has_char())
               {
                  ...
                  get(pfnNewaceLibrary, strTitle + "_get_new_library");
            ...
            if (pfnNewaceLibrary == nullptr)
            {
               ...
               get(pfnNewaceLibrary, "get_new_library");
         ...
         try
         {
            ...
            m_pca2library = ::move(pfnNewaceLibrary());
      ...
      m_pca2library->initialize_ace_library(get_context_object(), 0, m_strRoot, m_strName, m_strFolder);
   ...
   __result(::acme::application) library::get_new_application(::generic * pobject, const char * pszAppId)
   {
      ...
      try
      {
         ...
         else
         {
            ...
            auto p = get<PFN_NEW_ace_APPLICATION>("new_ace_application");
...
//         }
   ...
   ::generic* library::new_object(::generic* pobjectContext, const char* pszClassId)
   {
   ...
   __pointer(::generic) library::create_object(::generic * pobjectContext, const char * pszClass)
   {
   ...
   ::generic* library::factory_new(::generic* pobjectContext, const char* lpszClass)
   {
   ...
   __pointer(::generic) library::factory_create(::generic * pobjectContext, const char * lpszClass)
   {
...
::acme::library * lib(const char * psz)
{
   ...
   __pointer(::acme::library) & plibrary = ::get_context_system()->m_mapLibCall[psz];
