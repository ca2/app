...
namespace acme
{
   ...
   public:
      ...
      virtual ::estatus     initialize_ace_library(::generic * pobjectContext, int iDesmabi, const char * pszRoot = nullptr, const char * pszName = nullptr, const char * pszFolder = nullptr);
