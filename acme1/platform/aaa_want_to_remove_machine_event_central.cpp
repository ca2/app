...
#include "acme/platform/machine_event_data2.h"
#include "acme/platform/machine_event2.h"
#include "acme/platform/machine_event_central2.h"
...
::estatus machine_event_central::initialize(::generic * pobjectContext)
{
