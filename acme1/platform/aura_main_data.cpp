...
void ace_main_data::system_construct(int argc, char** argv)
{
...
void ace_main_data::system_construct(int argc, wchar_t** argv)
{
...
void ace_main_data::system_construct(const char* pszCommandLine, const ::edisplay& edisplay)
{
...
void ace_main_data::system_construct(os_local* poslocal, const ::edisplay& edisplay)
{
...
void ace_main_data::system_construct(HINSTANCE hinstance, HINSTANCE hPrevInstance, LPTSTR pCmdLine, i32 nCmdShow)
{
...
void ace_main_data::system_construct(Array < String^ >^ refstra)
{
...
void ace_main_data::set_main_struct(const ace_main_struct & mainstruct)
{

   *((::ace_main_struct*)(this)) = mainstruct;

}


string ace_main_data::get_arg(int i)
{
...
bool ace_main_data::is_console_app() const
{
