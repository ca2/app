...
class CLASS_DECL_ACME ace_str_pool
{
public:
   ...
   const string AppCoreDeepfish = "app-acme/deepfish_";
...
namespace acme
{
   ...
   extern CLASS_DECL_ACME ace_str_pool* g_pacestrpool;


} // namespace acme


#define astr (*::acme::g_pacestrpool)
