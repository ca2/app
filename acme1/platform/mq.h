...
CLASS_DECL_ACME __pointer(mq) get_mq(ITHREAD id, bool bCreate);

void _c_simple_message_loop();


CLASS_DECL_ACME int_bool mq_post_thread_message(ITHREAD idthread, UINT message, WPARAM wparam, LPARAM lparam);
