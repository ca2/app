...
//
//
//   virtual void __tracea(::generic * pcontextobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, int iLine, const char * psz) = 0;
//
//
//};
...
public:
   ...
   //inline void __cdecl operator()(::generic * pcontextobject, const string & strContext, i32 iError, const string & strMessage) const
   //{
...
public:
   ...
   //inline void operator()(::generic * pcontextobject, const string & strContext, i32 iError, const string & strMessage) const
   //{
...
namespace acme
{
   ...
   namespace trace
   {
      ...
      public:
         ...
         //virtual ::estatus initialize(::generic* pcontextobject) override;
      ...
      //CLASS_DECL_ACME void __cdecl TRACE(const char * pszFormat,...);
      //CLASS_DECL_ACME void __cdecl TRACE(const unichar * pszFormat,...);
      //CLASS_DECL_ACME void __cdecl TRACE(uptr dwCategory,UINT nLevel,const char * pszFormat,...);
      //CLASS_DECL_ACME void __cdecl TRACE(uptr dwCategory,UINT nLevel,const unichar * pszFormat,...);
...
CLASS_DECL_ACME const char * get_windows_message_name(UINT nMsg);



//struct CLASS_DECL_ACME log_context :
//   virtual public ::generic
//{
//
//   e_trace_category     m_ecategory;
