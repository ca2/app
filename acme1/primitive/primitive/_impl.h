...
//inline ::image_result context_object::get_image(const var & varFile, ::u64 uTrait, PRED pred)
//{
//
...
//inline __result(BASE_TYPE) context_object::__create()
//{
//
...
//inline ::file_result context_object::get_reader(const var & varFile, efileopen eopen)
//{
//
...
//
//
//inline ::file_result context_object::get_writer(const var & varFile, efileopen eopen)
//{
//
...
//
//template < typename TYPE >
//inline ::estatus context_object::__construct(::thread_pointer & p, void (TYPE:: * pfn)(), e_priority epriority)
//{
//
