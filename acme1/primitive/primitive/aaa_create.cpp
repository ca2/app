...
create::create(::generic * pobject, arguments arguments) :
   ::generic(pobject)
{
...
create::create(::generic * pobject, string strAppId, var varFile, const var & varOptions, ::user::primitive * puiParent, ewindowflag ewindowflag, ::id id) :
   ::generic(pobject),
