...
namespace process
{
   ...
   void department::process_thread::construct_process_thread(::generic * pobjectParent, const string & strCmdLine, const ::duration & dur, bool * pbPotentialTimeout, string * pstrRead, bool bElevated)
   {
   ...
   department::process_processor::process_processor(::generic * pobject,const string & strCmdLine,const duration & dur,bool * pbPotentialTimeout,string * pstrRead,bool bElevated):
      ::generic(pobject)
   {
