...
namespace process
{
   ...
   public:
      ...
      public:
         ...
         virtual void construct_process_thread(::generic * pobjectParent, const string & strCmdLine, const ::duration & dur, bool * pbPotentialTimeout = nullptr, string * pstrRead = nullptr, bool bElevated = false);
      ...
      public:
         ...
         process_processor(::generic * pobject, const string & strCmdLine, const ::duration & dur, bool * pbPotentialTimeout = nullptr, string * pstrRead = nullptr, bool bElevated = false);
