...
// (0x0360 - 0x037F are reserved for acme API)
...
//  some versions of Windows.  To remain compatible, acme API does not
//  use messages in that range.
#define WM_RESERVED_0370    0x0370
#define WM_RESERVED_0371    0x0371
#define WM_RESERVED_0372    0x0372

// WM_SOCKET_NOTIFY and WM_SOCKET_DEAD are used internally by acme API's
...
// Note: Messages 0x037C - 0x37E reserved for future acme API use.
#define WM_RESERVED_037C    0x037C
#define WM_RESERVED_037D    0x037D
#define WM_RESERVED_037E    0x037E

// WM_FORWARDMSG - used by acme to forward a message to another interaction_impl for processing
...
//#include "acme/user/window_state.h"
//#include "acme/user/callback.h"
//#include "acme/user/primitive.h"

//#include "acme/user/style_base.h"
//#include "acme/user/style.h"
