...
public:
   ...
   zip_context(::context_object * pcontextobject);
   virtual ~zip_context();
   ...
   virtual bool extract_all(const char * pszDir,::payload varFile, ::file::patha * ppatha = nullptr, string_array * pstraFilter = nullptr,bool_array * pbaBeginsFilterEat = nullptr);
