...
//bool CLASS_DECL_APEX succeeded(const ::estatus & estatus);
//bool CLASS_DECL_APEX status_succeeded(i64 i);
//bool CLASS_DECL_APEX failed(const ::estatus & estatus);
//bool CLASS_DECL_APEX status_failed(i64 i);
