...
namespace winrt
{
   ...
   hasher::hasher(::Windows::Security::Cryptography::Core::CryptographicHash^ phash, enum_hash ehash) :
      m_phash(phash), 
      m_ehash(ehash)
   {
   ...
   String^ hasher::get_os_provider_name(enum_hash ehash)
   {
      ...
      {
      case e_hash_md5:
         return ::Windows::Security::Cryptography::Core::HashAlgorithmNames::Md5;
      case e_hash_sha1:
         return ::Windows::Security::Cryptography::Core::HashAlgorithmNames::Sha1;
      case e_hash_sha256:
   ...
   ::Windows::Security::Cryptography::Core::HashAlgorithmProvider^ hasher::get_os_provider(enum_hash ehash)
   {

      return ::Windows::Security::Cryptography::Core::HashAlgorithmProvider::OpenAlgorithm(get_os_provider_name(ehash));
