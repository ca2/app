...
namespace winrt
{
   ...
   public:
      ...
      ::Windows::Security::Cryptography::Core::HashAlgorithmProvider ^ m_pprovider;
      enum_hash m_ehash;


      hasher_algorithm(::Windows::Security::Cryptography::Core::HashAlgorithmProvider^ pprovider, enum_hash ehash);
