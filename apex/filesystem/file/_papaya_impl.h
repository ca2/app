...
//inline ::file_result object::get_reader(const ::var & varFile, const ::efileopen & efileopen)
//{
//
...
//
//
//inline ::file_result object::get_writer(const ::var & varFile, const ::efileopen & efileopen)
//{
//
