...
//CLASS_DECL_APEX bool file_put(const char * path, ::object & s, ::aura::application * papp = nullptr);
//CLASS_DECL_APEX bool file_as(::object & s, const char * path, ::aura::application * papp = nullptr);
