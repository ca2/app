...
#define string_STRCAT2_beg_char_end(strCat, ch, str1, str2, beg1, end1, beg2, end2) \
   { \
      ...
      ::file::listing & system_dir::root_ones(::file::listing & listing, ::object * pobject)
      {
      ...
      ::file::listing & system_dir::ls(::object * pobject, listing & l)
      {
      ...
      ::file::listing & system_dir::ls_relative_name(::object * pobject, listing & l)
      {
      ...
      bool system_dir::has_subdir(::object * pobject, const ::file::path & pathFolder)
      {
      ...
      bool system_dir::is_cached(bool & bIs, const ::file::path & path, ::object * pobject)
      {
...
//         bIs = bHasSubFolder;
      ...
      bool system_dir::is(const ::file::path & pathParam,::object * pobject)
      {
      ...
      bool system_dir::is_impl(const ::file::path & path, ::object * pobject)
      {
...
//            m_isdirmap.set(path, bHasSubFolder, get_last_error());
      ...
      bool system_dir::name_is(const ::file::path & strPath,::object * pobject)
      {
...
//
      ...
      bool system_dir::mk(const ::file::path & path,::object * pobject)
      {
      ...
      bool system_dir::rm(::object * pobject,const ::file::path & path,bool bRecursive)
      {
      ...
      string system_dir::locale_schema_matter(::object * pobject, const string & strLocale, const string & strSchema, const ::file::path & pathRoot, const ::file::path & pathDomain)
      {
      ...
      void system_dir::matter_ls(::object * pobject, const ::file::path & path, ::file::patha & stra)
      {
      ...
      void system_dir::matter_ls_file(::object * pobject,const ::file::path & str,::file::patha & stra)
      {
      ...
      string system_dir::matter_from_locator(::object * pobject, const ::file::patha & patha, const string_array & straMatterLocator, bool bDir)
      {
...
ret:
      ...
      string system_dir::matter_from_locator(::object * pobject, ::file::path path, const string_array & straMatterLocator, bool bDir)
      {
      ...
      //::file::path system_dir::usersystemappdata(::object * pobject, const string & pcszPrefix)
      ...
      //::file::path system_dir::default_userappdata(::object * pobject, const string & pcszPrefix, const string & lpcszLogin)
      ...
      //::file::path system_dir::default_userdata(::object * pobject, const string & pcszPrefix, const string & lpcszLogin)
      ...
      //::file::path system_dir::default_userfolder(::object * pobject, const string & pcszPrefix, const string & lpcszLogin)
      ...
      bool system_dir::is_inside_time(const ::file::path & pszPath,::object * pobject)
      {
         UNREFERENCED_PARAMETER(pszPath);
         __throw(interface_only_exception("this is an interface"));
      }

      bool system_dir::is_inside(const ::file::path & pszDir,const ::file::path & pszPath,::object * pobject)
      {
