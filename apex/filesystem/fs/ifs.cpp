...
bool ifs::enumerate(::file::listing_base & listing)
{
   ...
   ////   m_mapdirFolder[strDir] = allocateø string_array_base();
   ////if(m_mapdirFolderName[strDir].is_null())
   ////   m_mapdirFolderName[strDir] = allocateø string_array_base();
   ////if(m_mapdirFile[strDir].is_null())
   ////   m_mapdirFile[strDir] = allocateø string_array_base();
   ...
   ////   m_mapdirFolderDir[strDir] = allocateø bool_array();
...
file_pointer ifs::get_file(const ::payload & payloadFile, ::file::e_open eopen, ::pointer < ::file::exception >* ppfileexception)
{
   ...
   auto pfile = allocateø ifs_file( payloadFile);
