...
void ifs_file::get_file_data()
{
   ...
   strUrl = "http://file.ca2.site/ifs/get?path=" + ::url::encode(m_path);
...
void ifs_file::set_file_data()
{
   ...
   if(m_payloadFile["xmledit"].cast < ::memory_file > () != nullptr)
   {
      ...
      strUrl = "http://file.ca2.site/ifs/xmledit?path=" + ::url::encode(m_payloadFile["url"].as_string());
      ...
      strUrl = "http://file.ca2.site/ifs/set?path=" + ::url::encode(m_payloadFile["url"].as_string());
   ...
   strUrl = "http://file.ca2.site/ifs/set?path=" + ::url::encode(m_path);
