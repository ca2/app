...
extern CLASS_DECL_APEX int g_bAura;
...
inline CLASS_DECL_APEX int c_is_null(const void * p)
{
   return ((uptr)p) < 65536;
...
#include "apex/primitive/comparison/_c.h"
#else
...
#include "apex/primitive/primitive/_c_memory.h"

#include "apex/primitive/string/_c.h"

#include "apex/primitive/datetime/_c.h"

#include "apex/filesystem/file/_c.h"

#include "apex/const/thread.h"
...
CLASS_DECL_APEX i32 get_os_thread_priority(::e_priority epriority);
CLASS_DECL_APEX i32 get_os_priority_class(::e_priority epriority);
CLASS_DECL_APEX ::e_priority get_os_thread_scheduling_priority(i32 iCa2Priority);
CLASS_DECL_APEX ::e_priority get_os_class_scheduling_priority(i32 iCa2Priority);



//#include "apex/primitive/datetime/mktime.h"
#include "apex/primitive/api/api.h"
...
CLASS_DECL_APEX void __tracea(::generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, int iLine, const char * psz);
CLASS_DECL_APEX void __tracef(::generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, int iLine, const char * psz, ...);
CLASS_DECL_APEX void __tracev(::generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, int iLine, const char * psz, va_list vargs);
...
#include "apex/platform/aura_main_struct.h"
...
//CLASS_DECL_APEX i32 aura_run_system(::apex::system* psystem);


//CLASS_DECL_APEX ::estatus aura_run_system_init(::apex::system * psystem);
//CLASS_DECL_APEX ::estatus aura_run_system_proc(::apex::system * psystem);
//CLASS_DECL_APEX ::estatus aura_run_system_term(::apex::system * psystem);
...
extern "C"
CLASS_DECL_APEX void register_aura_library(const char * psz, ::apex::library * plibrary);
...
//CLASS_DECL_APEX bool aura_init();
//CLASS_DECL_APEX bool aura_term();
...
extern "C" CLASS_DECL_APEX PFN_NEW_AURA_LIBRARY get_get_new_aura_library(const char * psz);
extern "C" CLASS_DECL_APEX void register_get_new_aura_library(const char* psz, PFN_NEW_AURA_LIBRARY pfnNewAuraLibrary);
...
#include "apex/primitive/string/international_locale_schema.h"
...
CLASS_DECL_APEX void set_aura(void * p,::apex::application * papp);

CLASS_DECL_APEX ::apex::application * get_aura(void * p);
...
#include "apex/compress/compress.h"
