...
//#ifdef CORE_LEVEL
//extern "C"
//CLASS_DECL_APEX ::i32_bool defer_core_init();
//extern "C"
//CLASS_DECL_APEX ::i32_bool defer_core_term();
//
//#endif
...
::i32 main(Array < String ^ > ^ refstra)
{
   ...
   return (::i32)apex_apex(pmaindata);
...
::i32 apex_main(::i32 argc, char_pointer argv[], char_pointer pszCommandLine, bool bConsole, bool bDraw2d);
