...
CLASS_DECL_APEX void * x86_memory_pool_alloc(memsize s);
CLASS_DECL_APEX void x86_memory_pool_freec(void * p);


class CLASS_DECL_APEX x86_oriented_memory_allocator
{
public:
...
CLASS_DECL_APEX x86_cache_oriented_memory_pool * x86_cache_oriented_get_thread_memory_pool()
{
