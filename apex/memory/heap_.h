...
namespace heap
{
   ...
   class CLASS_DECL_APEX system_memory_allocator
   {
   public:
   ...
   class CLASS_DECL_APEX default_memory_allocator
   {
   public:
...
//   class CLASS_DECL_APEX heap_base
//   {
//   public:
//
//
