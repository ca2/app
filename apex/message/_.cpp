...
//   }
   ...
   CLASS_DECL_APEX bool is_idle_message(::message::message * pmessage)
   {
      ...
      if(pmessage->m_emessage == ::user::e_message_mouse_move || pmessage->m_emessage == ::user::e_message_non_client_mouse_move)
      {
      ...
      return pmessage->m_emessage != ::user::e_message_paint && pmessage->m_emessage != 0x0118;
   ...
   CLASS_DECL_APEX bool is_idle_message(MESSAGE * pmsg)
   {
      ...
      // redundant ::user::e_message_mouse_move and ::user::e_message_non_client_mouse_move
      if(pmsg->m_emessage == ::user::e_message_mouse_move || pmsg->m_emessage == ::user::e_message_non_client_mouse_move)
      ...
      // ::user::e_message_paint and WM_SYSTIMER (caret blink)
      return pmsg->m_emessage != ::user::e_message_paint && pmsg->m_emessage != 0x0118;
...
//   }
   ...
   enum_prototype get_message_prototype(enum_message emessage, unsigned int /* uCode */ )
   {
