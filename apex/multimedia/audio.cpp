...
CLASS_DECL_APEX void set_get_new_audio(PFUNCTION_GET_NEW_AUDIO pgetnewaudio)
{
...
CLASS_DECL_APEX ::aura::audio * get_new_audio()
{
...
CLASS_DECL_APEX ::aura::audio * get_context_audio(::object * pobjectContext)
{
...
CLASS_DECL_APEX bool has_audio()
{
