...
#define CLASS_DECL_APEX  _CLASS_DECL_EXPORT
#define LIBIDN_BUILDING
#else
#define CLASS_DECL_APEX  _CLASS_DECL_IMPORT
#endif
#endif
...
CLASS_DECL_APEX LPWAVEOUT waveout_open(int iChanel, LPAUDIOFORMAT pformat, LPWAVEOUT_CALLBACK pcallback);

CLASS_DECL_APEX int waveout_start(LPWAVEOUT pwaveout);

CLASS_DECL_APEX int waveout_write(LPWAVEOUT pwaveout, const void * pdata, unsigned int s);

CLASS_DECL_APEX int waveout_stop(LPWAVEOUT pwaveout);

CLASS_DECL_APEX int waveout_close(LPWAVEOUT pwaveout);
