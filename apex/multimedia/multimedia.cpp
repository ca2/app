...
CLASS_DECL_APEX void set_get_new_multimedia(PFUNCTION_GET_NEW_MULTIMEDIA pgetnewmultimedia)
{
...
CLASS_DECL_APEX::aura::multimedia * get_new_multimedia()
{
...
CLASS_DECL_APEX::aura::multimedia * get_context_multimedia(::object * pobjectContext)
{
...
CLASS_DECL_APEX bool has_multimedia()
{
