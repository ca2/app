...
namespace multimedia
{
   ...
   class CLASS_DECL_APEX information
   {
   public:
...
namespace aura
{
   ...
   class CLASS_DECL_APEX multimedia :
...
CLASS_DECL_APEX void set_get_new_multimedia(PFUNCTION_GET_NEW_MULTIMEDIA pfunction);


extern "C"
CLASS_DECL_APEX::aura::multimedia * get_get_new_multimedia();
