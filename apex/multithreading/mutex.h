...
CLASS_DECL_APEX __pointer(::mutex) open_mutex(const char * lpszName);

class CLASS_DECL_APEX mutex :
   virtual public sync
{
public:
...
CLASS_DECL_APEX void wait_until_mutex_does_not_exist(const char * lpszName);



CLASS_DECL_APEX ::mutex * get_ui_destroyed_mutex();
...
namespace install
{
   ...
   class CLASS_DECL_APEX admin_mutex :
#ifdef WINDOWS_DESKTOP
      public null_dacl_security_attributes,
#endif
      public ::mutex
