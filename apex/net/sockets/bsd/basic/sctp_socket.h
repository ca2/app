...
namespace sockets
{
   ...
   public:
      ...
      SctpSocket(base_socket_handler& h,i32 type);
      ~SctpSocket();

      /** bind() */
      i32 Bind(const string &,port_t);
      i32 Bind(const ::net::address & address);
      /** sctp_bindx() */
      i32 AddAddress(const string &,port_t);
      i32 AddAddress(const ::net::address & address);
      /** sctp_bindx() */
      i32 RemoveAddress(const string &,port_t);
      i32 RemoveAddress(const ::net::address & address);
      ...
      i32 AddConnection(const ::net::address & address);
   #endif
