...
class CLASS_DECL_APEX url_domain_axis
{
public:
...
class CLASS_DECL_APEX url_domain :
...
bool CLASS_DECL_APEX server_is_top_domain(const char * pszTop1, strsize iLen1, const char * pszTop2, strsize iLen2);

inline bool CLASS_DECL_APEX server_is_top_domain(string strTop1, string strTop2)
{
