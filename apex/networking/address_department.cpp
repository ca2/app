...
namespace net
{
   ...
   */
   ...
   /*
   ::net::address address_department::CreateAddress(struct sockaddr *sa,socklen_t sa_len)
   {
      retur
      switch (sa -> sa_family)
      {
   ...
   */
   ...
   bool address_department::reverse(string& hostname, const ::net::address& address)
   {
   ...
   //string address_department::reverse_name(const ::net::address & address, bool bSynch, const ::duration& duration)
   //{
   //
   //   string strHostname;
   //
   ...
   string address_department::reverse_name(const ::net::address& address)
   {
   ...
   string address_department::canonical_name(const ::net::address& address)
   {
   ...
   string address_department::service_name(const ::net::address& address)
   {
