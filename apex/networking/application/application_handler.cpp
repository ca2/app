...
namespace networking
{
   ...
   ::e_status application_handler::on_html_response(::networking::application_socket * psocket, string & strHtml, const ::scoped_string & scopedstrUrl, const ::property_set& setPost)
   {
