...
\ingroup basic */
   ...
   public:
      ...
      virtual void set_detach_socket_type(const ::platform::type & type);
      ...
      \lparam port Port (0 is random)
      \lparam depth Listen queue depth */
      virtual ::i32 Bind(const ::scoped_string & scopedstrInterface, ::networking::port_t port, ::i32 depth = 20);
      ...
      \lparam protocol Network protocol
      \lparam depth Listen queue depth */
      virtual ::i32 Bind(const ::scoped_string & scopedstrInterface, ::networking::port_t port, const string& protocol, ::i32 depth = 20);
