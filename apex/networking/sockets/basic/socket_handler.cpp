...
//   i32 socket_handler::Resolve(base_socket * pbasesocket, const string & host, ::networking::port_t port)
//   {
//
//      // check cache
//
...
//   i32 socket_handler::Resolve6(base_socket * pbasesocket, const string & host, ::networking::port_t port)
//   {
//
//      // check cache
//
