...
//      return m_slave;
  ...
  ::i32 socket_handler::select(const class time & timeWait)
  {
     ...
     return -1;
//     ::i32 n = system()->networking()->_select(this, wait);
//
//
//     auto tick2 = ::time::now();
//
...
//   ::i32 socket_handler::Resolve(base_socket * pbasesocket_id, const ::scoped_string & scopedstrHost, ::networking::port_t port)
//   {
//
//      // check cache
//
...
//   ::i32 socket_handler::Resolve6(base_socket * pbasesocket_id, const ::scoped_string & scopedstrHost, ::networking::port_t port)
//   {
//
//      // check cache
//
