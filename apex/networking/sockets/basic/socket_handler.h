...
//      synchronization & GetMutex() const override;
      ...
      //::i32 Resolve(base_socket *,const ::scoped_string & scopedstrHost,::networking::port_t port) override;
      //::i32 Resolve6(base_socket *,const ::scoped_string & scopedstrHost,::networking::port_t port) override;
