...
namespace sockets
{
   ...
   public:
      ...
      ::pointer < ::sockets::http_callback > m_phttpcallback;
      ...
      virtual void on_websocket_text(const ::scoped_string & scopedstr);
      virtual void on_websocket_data2(const ::block & block);
