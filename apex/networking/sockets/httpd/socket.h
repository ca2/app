...
namespace httpd
{
   ...
   public:
      ...
      ::platform::type                       m_typeSocketThread;
      ...
      //virtual bool read_file(const ::file::path & path,pointer_array < ::i32_array_base > * prangea = nullptr,const ::scoped_string & scopedstrContentType = nullptr);
