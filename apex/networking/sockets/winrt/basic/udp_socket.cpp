...
#define myCMSG_SPACE(l) (myALIGN(sizeof(struct cmsghdr)) + myALIGN(l))
   ...
   ::net::address udp_socket::GetRemoteAddress()
   {
      ...
      return ::net::address(get_app(), m_datagramsocket->Information->RemoteAddress->CanonicalName, m_datagramsocket->Information->RemotePort);
   ...
   ::net::address udp_socket::GetLocalAddress()
   {
      ...
      return ::net::address(get_app(), m_datagramsocket->Information->LocalAddress->CanonicalName, m_datagramsocket->Information->LocalPort);
