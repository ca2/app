...
namespace VistaTools
{
   ...
   int_bool CLASS_DECL_APEX IsVista();
   ...
   */
   ...
   pbElevated
      [out] [optional] Pointer to a int_bool var that, if non-nullptr, receives the result.
