...
namespace macos
{
   ...
   ::apex::application * g_pappPreTranslateMouseMessage = nullptr;
   ...
   void CLASS_DECL_APEX __pre_init_dialog(::user::interaction * pWnd, LPRECT lpRectOld, DWORD* pdwStyleOld);

   void CLASS_DECL_APEX __post_init_dialog(::user::interaction * pWnd, const RECT& rectOld, DWORD dwStyleOld);
...
#define NSWindowStyleMaskMiniaturizable (1 << 2)
   ...
   bool interaction_impl::pre_create_window(::user::create_struct& cs)
   {
      /*      if (cs.lpszClass == nullptr)
       {
/xcore/app/apex/node/macos/macos_interaction_impl.cpp:712:44: No member named 'get_window_rect' in 'user::interaction_impl'       // make sure the default user::interaction class is registered
...
//
   ...
   void interaction_impl::_001OnCreate(::message::message * pmessage)
   {
      ...
      if(::is_null(g_pappPreTranslateMouseMessage))
      {
         ...
         g_pappPreTranslateMouseMessage = System.value("pre_translate_mouse_message").cast < ::apex::application >();
...
//   }
   ...
   CLASS_DECL_APEX void hook_window_create(::user::interaction * pinteraction)
   {
