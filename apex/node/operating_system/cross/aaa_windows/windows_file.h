...
#ifdef _UWP
CLASS_DECL_APEX BOOL WINAPI LockFile(HANDLE hfile, u32 dwLo, u32 dwHi, u32 dwCountLo, u32 dwCountHi);
CLASS_DECL_APEX BOOL WINAPI UnlockFile(HANDLE hfile, u32 dwLo, u32 dwHi, u32 dwCountLo, u32 dwCountHi);
#endif
