...
#define MUI_MERGE_SYSTEM_FALLBACK           0x10     // GetThreadPreferredUILanguages merges in parent and apex languages
...
typedef enum _NORM_FORM
{
   ...
   NormalizationC      = 0x1,     // Each apex plus combining characters to the canonical precomposed equivalent.
   NormalizationD      = 0x2,     // Each precomposed character to its canonical decomposed equivalent.
   NormalizationKC     = 0x5,     // Each apex plus combining characters to the canonical precomposed
