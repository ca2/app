...
//         m_puserinteraction->get_context_application()->step_timer();
      ...
      {
      ::apex::application ** ppapp= (::apex::application **) pbase->m_lparam;
...
*/
   ...
   ///* trans oswindow CLASS_DECL_APEX __get_parent_owner(::user::interaction * hWnd)
   //{
  ...
  /*   void interaction_impl::_001OnDeferPaintLayeredWindowBackground(::image * pimage)
   ...
   bool interaction_impl::GrayCtlColor(HDC hDC,oswindow hWnd,UINT nCtlColor,HBRUSH hbrGray,COLORREF clrText)
   {
      ...
      //   //         TRACE(::apex::trace::category_AppMsg, 0, "Warning: hDC is nullptr in interaction_impl::GrayCtlColor; WM_CTLCOLOR not processed.\n");
      //   return FALSE;
      //}
...
//      m_puserinteraction->m_iModal = m_puserinteraction->m_iModalCount;
      ...
      ::apex::application * pappThis1 = dynamic_cast <::apex::application *> (get_context_application());
      ::apex::application * pappThis2 = dynamic_cast <::apex::application *> (get_context_application());
...
//      return ::PostMessageW(get_handle(),message,wParam,lParam) != FALSE;
   ...
   */
   ...
   CLASS_DECL_APEX LRESULT __call_window_procedure(::user::interaction * pinteraction, oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam)
   {
      ...
      catch(::exception::apex * pe)
      {
         ...
         //         TRACE(::apex::trace::category_AppMsg, 0, "Warning: Uncaught exception in message_handler (returning %ld).\n", spbase->get_lresult());
...
WNDPROC CLASS_DECL_APEX __get_window_procedure()
{
...
__STATIC void CLASS_DECL_APEX __pre_init_dialog(
...
__STATIC void CLASS_DECL_APEX __post_init_dialog(
...
CLASS_DECL_APEX void hook_window_create(::user::interaction * pWnd)
{
...
CLASS_DECL_APEX const char * __register_window_class(UINT nClassStyle,
...
__STATIC bool CLASS_DECL_APEX __register_with_icon(WNDCLASS* pWndCls,
...
bool CLASS_DECL_APEX __end_defer_register_class(LONG fToRegisterParam, const char ** ppszClass)
{
...
__activation_window_procedure(oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam)
{
   ...
   catch(::exception::apex * pe)
   {
      ...
      //      TRACE(::apex::trace::category_AppMsg, 0, "Warning: Uncaught exception in __activation_window_procedure (returning %ld).\n",
      //       lResult);
      ::exception_pointer esp(pe);
   }
...
bool CLASS_DECL_APEX __register_class(WNDCLASS* lpWndClass)
{
   WNDCLASS wndcls;
   ...
   {
      //      TRACE(::apex::trace::category_AppMsg, 0, "Can't register interaction_impl class named %s\n",
