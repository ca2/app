...
namespace uwp
{
   ...
   CLASS_DECL_APEX LRESULT CALLBACK __send_message_hook(int, WPARAM, LPARAM);
   //CLASS_DECL_APEX void _gen::StandardSubclass(oswindow);
   CLASS_DECL_APEX LRESULT CALLBACK __cbt_filter_hook(int, WPARAM, LPARAM);
...
//      void OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar);
      ...
      CLASS_DECL_APEX friend LRESULT CALLBACK __send_message_hook(int, WPARAM, LPARAM);
      //CLASS_DECL_APEX friend void _gen::StandardSubclass(oswindow);
      CLASS_DECL_APEX friend LRESULT CALLBACK __cbt_filter_hook(int, WPARAM, LPARAM);
