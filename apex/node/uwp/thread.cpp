...
//__STATIC void CLASS_DECL_APEX __pre_init_dialog(__pointer(::user::interaction) pWnd, LPRECT lpRectOld, u32* pdwStyleOld);
//__STATIC void CLASS_DECL_APEX __post_init_dialog(__pointer(::user::interaction) pWnd, const RECT& rectOld, u32 dwStyleOld);
