...
/*bool CLASS_DECL_APEX __custom_log_font(UINT nIDS, LOGFONT* pLogFont)
{
...
bool CLASS_DECL_APEX __is_combo_box_control(oswindow hWnd, UINT nStyle)
{
   if (hWnd == nullptr)
      return FALSE;
...
oswindow CLASS_DECL_APEX __child_window_from_point(oswindow hWnd, POINT point)
{
   ASSERT(hWnd != nullptr);
