...
void CLASS_DECL_APEX __cdecl _null_se_translator(u32 uiCode, EXCEPTION_POINTERS * ppointers);
bool CLASS_DECL_APEX __windows_init();
i32 CLASS_DECL_APEX __windows_main(::apex::system * psystem, ::create * pmaininitdata);
...
CLASS_DECL_APEX bool __is_valid_atom(const wchar_t * psz);
...
CLASS_DECL_APEX i32 app_main(::apex::system * psystem, HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR pCmdLine, ::edisplay edisplay);
