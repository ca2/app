...
public:
   ...
   handle_map(::context_object * pcontextobject);
   virtual ~handle_map()
   {
      delete_temp();
   }
...
{
public:
   oswindow_map(::context_object * pcontextobject) : handle_map < ::windows::oswindow_handle, ::windows::window >(pobject) {}
};
...
template < class HT, class CT >
handle_map < HT, CT > ::handle_map(::context_object * pcontextobject) :
   ::object(pobject),
