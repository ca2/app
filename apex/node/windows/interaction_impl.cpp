...
#include "apex/os/windows/windowing.h"
#include "apex/os/windows/top_level_enum.h"
#include "apex/os/windows/imm_context.h"
#include "apex/node/windows/buffer.h"
#include "apex/const/timer.h"
...
CLASS_DECL_APEX int g_iMouseDown = 0;

//CLASS_DECL_APEX thread_iptr < DWORD_PTR > t_time1;
//CLASS_DECL_APEX thread_iptr < DWORD_PTR > t_time2;


//extern CLASS_DECL_APEX thread_int_ptr < DWORD_PTR > t_time1;
...
const char * gen_OldWndProc = "::apex::OldWndProc423";

//CLASS_DECL_APEX bool hook_window_create(::windows::interaction_impl * pwindow);
...
namespace windows
{
   ...
   __STATIC bool CLASS_DECL_APEX __modify_style(oswindow oswindow, i32 nStyleOffset,
   ...
   ///* trans   if (!::apex::HtmlHelp((pwindow)->get_handle(), pApp->m_pszHelpFilePath, nCmd, dwData))
   //{
   //// linux System.message_box(__IDP_FAILED_TO_LAUNCH_HELP);
   //System.message_box("Failed to launch help");
   //}*/
...
//
//
//CLASS_DECL_APEX bool unhook_window_create()
//{
//
...
void CLASS_DECL_APEX _handle_activate(::user::interaction_impl * pwindow, WPARAM nState, ::user::interaction_impl * pWndOther)
{
...
namespace windows
{
   ...
   void interaction_impl::message_handler(::message::base * pbase)
   {
      ...
      {
      __pointer(::apex::application)* ppapp= (__pointer(::apex::application)*) pbase->m_lparam;
...
wstring CLASS_DECL_APEX windows_get_user_interaction_window_class(::user::interaction * pinteraction)
{
   ...
   wndcls.hInstance = GetModuleHandleW(L"apex.dll");
...
bool CLASS_DECL_APEX windows_register_with_icon(WNDCLASSEXW * pwndclass, const unichar * pszClassName, UINT nIDIcon)
...
CLASS_DECL_APEX wstring windows_register_window_class(::object * pobject, UINT nClassStyle, HCURSOR hCursor, HBRUSH hbrBackground, HICON hIcon)
{
...
CLASS_DECL_APEX bool windows_register_class(WNDCLASSEXW * pwndclass)
{
