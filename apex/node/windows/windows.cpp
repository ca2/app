...
namespace windows
{
   ...
   bool CLASS_DECL_APEX shell_get_special_folder_path(oswindow oswindow,::file::path &str,i32 csidl,bool fCreate)
   {
   ...
   ::file::path CLASS_DECL_APEX shell_get_special_folder_path(i32 csidl, bool fCreate, oswindow oswindow)
   {
