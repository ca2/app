...
//    if (nRptType == _CRT_ASSERT || ::apex::get_system()->m_pdumpcontext->m_pfile == nullptr)
//       return false;
...
//    // non-nullptr m_pFile, so go through ::apex::get_system()->m_pdumpcontext for the message
//    *pResult = false;
//    *::apex::get_system()->m_pdumpcontext << szMsg;
