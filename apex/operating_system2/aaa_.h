...
//{
//
//   string CLASS_DECL_APEX get_window_text_timeout(::windowing::window * pwindow, class ::time tickTimeout = 1000);
//
//} // namespace str
...
////{
////
////   return ::place(new pcre_context_impl( iSizeData));
////
////}
//////
////
...
////
////   auto putil = ::place(new pcre_util_impl(pcreContextImpl));
////
////   putil->compile(str);
////
////   return putil;
...
////
////   auto pcode = ::place(new pcre_code_impl(pimpl));
////
////   pcode->compile(str);
////
////   return pcode;
