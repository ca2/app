...
//
//CLASS_DECL_APEX bool _os_resolve_alias(::particle * pparticle, ::file::path & path, const ::scoped_string & scopedstr, ::user::prototype * pinteraction, bool bNoUI, bool bNoMount)
//{
//
