...
void android_fill_plasma(AndroidBitmapInfo * info, void * pixels, double  t)
{
   ...
   if (::apexacmesystem() == nullptr)
   {
      ...
      informationf("android_fill_plasma : apex_system is null");
   ...
   if (::apexacmesystem()->get_session() == nullptr)
   {
      ...
      informationf("android_fill_plasma : context_session is null");
   ...
   if (::apexacmesystem()->get_session()->m_puserinteractionHost == nullptr)
   {
      ...
      informationf("android_fill_plasma : Host Window is null");
   ...
   if (::apexacmesystem()->get_session()->m_puserinteractionHost->m_pimpl == nullptr)
   {
      ...
      informationf("android_fill_plasma : Host Window impl is null");
   ...
   if (::apexacmesystem()->get_session()->m_puserinteractionHost->get_window_graphics() == nullptr)
   {
      ...
      //   informationf("android_fill_plasma : get_window_graphics returned null");

      return;

   }

   auto pbuffer = dynamic_cast <::graphics::double_buffer *> (::apexacmesystem()->get_session()->m_puserinteractionHost->get_window_graphics());

   if(pbuffer == nullptr)
   {

      informationf("android_fill_plasma : double_buffer is null");
   ...
   if (!::is_ok(pimage))
   {
      ...
      informationf("android_fill_plasma : image is null or empty");
   ...
   //informationf("android_fill_plasma OK (area="+as_string(pbuffer->m_spimageBuffer.area())+")");
