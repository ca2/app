...
//      //      add_factory_item < application                >   (::type < ::apex::application >(), 1);
...
//   // add_factory_item < copydesk           , ::apex::copydesk), 1);
