...
bool m_bDirty;
   ...
   virtual bool round_window_on_text(const ::scoped_string & scopedstrText, long iSel, long iEnd) = 0;
   ...
   virtual void round_window_set_title(const ::scoped_string & scopedstrTitle);
   ...
   virtual void round_window_edit_on_set_focus(int l, int t, int r, int b, const ::scoped_string & scopedstrText, long iSelBeg, long iSelEnd);
   virtual void round_window_edit_on_kill_focus();

   virtual void round_window_set_text(const ::scoped_string & scopedstrText);
