...
CLASS_DECL_APEX memsize read_buffer(void* p, ::winrt::Windows::Storage::Streams::IBuffer^ ibuf, memsize size, memsize pos)
{
   
   ::winrt::Windows::Storage::Streams::DataReader^ r = ::winrt::Windows::Storage::Streams::DataReader::FromBuffer(ibuf);
   
   Array<uchar, 1U>^ a = ref aaa_primitive_new Array<uchar, 1U>(ibuf->Length);
...
CLASS_DECL_APEX memory_file_pointer create_memory_file(::winrt::Windows::Storage::Streams::IInputStream^ stream)
{
   ...
   while (pthread && pthread->task_get_run())
   {
      ...
      ::winrt::Windows::Storage::Streams::IBuffer^ buffer = ref aaa_primitive_new ::winrt::Windows::Storage::Streams::Buffer(1_mb);
