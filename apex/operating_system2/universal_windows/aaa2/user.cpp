...
//
//   ::wait(::winrt::Windows::ApplicationModel::Core::CoreApplication::MainView->CoreWindow->Dispatcher->RunAsync(::winrt::Windows::UI::Core::CoreDispatcherPriority::Normal, ref øallocate< ::winrt::Windows::UI::Core::DispatchedHandler([=, &pointCursor, &iRet] >()
//   {
//
//      try
//      {
...
//          ref øallocate< ::winrt::Windows::UI::Core::DispatchedHandler([] >()
//   {
//
