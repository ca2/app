...
//CLASS_DECL_APEX void hfile_set_size(HANDLE h, long long iSize);
...
//CLASS_DECL_APEX HANDLE WinFindFirstFileA(const_char_pointer  pwsz, WIN32_FIND_DATAA * pdata);
//CLASS_DECL_APEX HANDLE WinFindFirstFileW(const unichar * pwsz, WIN32_FIND_DATAW * pdata);
