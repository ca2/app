...
//
//         ::winrt::Windows::Storage::StorageFile ^ file = ::wait(folderTopic->CreateFileAsync(wstring("apex.topic"),::winrt::Windows::Storage::CreationCollisionOption::OpenIfExists));
//
//         string strMessage;
//
...
//
//         ::winrt::Windows::Storage::StorageFile ^ f = ::wait(m_pp->folderTopic->GetFileAsync(wstring("apex.topic")));
//
//         if(f != nullptr)
//         {
//
...
//
//
//         //::winrt::Windows::Storage::Search::QueryOptions ^ options = ref ___new ::winrt::Windows::Storage::Search::QueryOptions ();
//
