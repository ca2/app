...
namespace universal_windows
{
   ...
   public:
      ...
      //virtual bool  ls_pattern(const ::scoped_string & scopedstr,const_char_pointer lpcszPattern,string_array_base * pstraPath = nullptr,string_array_base * pstraTitle = nullptr,bool_array * pbaIsDir = nullptr,long_long_array_base * piaSize = nullptr);
      using ::directory_context::ls;
      virtual ::file::listing_base & ls(::file::listing_base & listing) override;
      //virtual bool  rls_pattern(const ::scoped_string & scopedstr,const_char_pointer lpcszPattern,string_array_base * pstraPath = nullptr,string_array_base * pstraTitle = nullptr,string_array_base * pstraRelative = nullptr,bool_array * pbaIsDir = nullptr,long_long_array_base * piaSize = nullptr,enum_extract eextract = e_extract_first);
