...
namespace universal_windows
{
   ...
   public:
      ...
      //virtual bool  ls_pattern(const ::scoped_string & scopedstr,const char * lpcszPattern,string_array * pstraPath = nullptr,string_array * pstraTitle = nullptr,bool_array * pbaIsDir = nullptr,huge_integer_array * piaSize = nullptr);
      using ::directory_context::ls;
      virtual ::file::listing & ls(::file::listing & listing) override;
      //virtual bool  rls_pattern(const ::scoped_string & scopedstr,const char * lpcszPattern,string_array * pstraPath = nullptr,string_array * pstraTitle = nullptr,string_array * pstraRelative = nullptr,bool_array * pbaIsDir = nullptr,huge_integer_array * piaSize = nullptr,enum_extract eextract = e_extract_first);
