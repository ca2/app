...
//__STATIC void CLASS_DECL_APEX __pre_init_dialog(::pointer<::user::interaction>pWnd, ::int_rectangle * lpRectOld, unsigned int* pdwStyleOld);
//__STATIC void CLASS_DECL_APEX __post_init_dialog(::pointer<::user::interaction>pWnd, const ::int_rectangle &rectangleOld, unsigned int dwStyleOld);
