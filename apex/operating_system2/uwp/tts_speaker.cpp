...
namespace universal_windows
{
   ...
   namespace tts
   {
      ...
      bool speaker::initialize(string strLang)
      {
         ...
         //
         ::winrt::Windows::Media::SpeechSynthesis::SpeechSynthesizer ^ psynth = ref ___new ::winrt::Windows::Media::SpeechSynthesis::SpeechSynthesizer ();
         if (psynth == nullptr)
         {
         ...
         for (unsigned int index = 0; index < voices->Size; index++)
         {
            ...
            if (case_insensitive_string_begins(strL, strLang))
            {
               try
               {
                  psynth->Voice = voice;
