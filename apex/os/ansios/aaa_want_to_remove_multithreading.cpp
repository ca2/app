...
////}
////
////CLASS_DECL_APEX HTHREAD  WINAPI get_thread_handle(DWORD dw)
////{
////
////   sync_lock mlThreadIdHandle(g_pmutexThreadIdHandleLock);
////
...
////
/////*
////CLASS_DECL_APEX int_bool WINAPI PostThreadMessageW(DWORD idThread,UINT Msg,WPARAM wParam,LPARAM lParam)
////{
////
...
////*/
////
////CLASS_DECL_APEX int_bool WINAPI PostMessageW(oswindow oswindow,UINT Msg,WPARAM wParam,LPARAM lParam)
////{
////
...
////}
////
////CLASS_DECL_APEX UINT GetCurrentThreadId()
////{
////
