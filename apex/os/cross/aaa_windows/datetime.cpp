 ...
 *   Nothing.
 */
CLASS_DECL_APEX void WINAPI RtlTimeToTimeFields(
 ...
 *
 * PARAMS
 *   SystemTime [I] ::apex::get_system() time to convert.
 ...
 *   Nothing.
 */
CLASS_DECL_APEX void GetSystemTimeAsFileTime(
 ...
 *  Nothing.
 */
CLASS_DECL_APEX void GetSystemTime(LPSYSTEMTIME systime)
{
   FILETIME ft;
   LARGE_INTEGER t;
