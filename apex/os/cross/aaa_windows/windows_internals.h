...
CLASS_DECL_APEX NTSTATUS WINAPI LdrGetDllHandle(LPCWSTR, WINULONG, const UNICODE_STRING*, HMODULE*);
...
CLASS_DECL_APEX NTSTATUS WINAPI LdrLoadDll(LPCWSTR, ::u32, const UNICODE_STRING*, HMODULE*);
...
CLASS_DECL_APEX NTSTATUS WINAPI LdrQueryImageFileExecutionOptions(const UNICODE_STRING*, LPCWSTR, WINULONG, void*, WINULONG, WINULONG*);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlAppendUnicodeToString(UNICODE_STRING *, LPCWSTR);
...
CLASS_DECL_APEX int_bool WINAPI RtlCreateUnicodeString(PUNICODE_STRING, LPCWSTR);
...
CLASS_DECL_APEX int_bool WINAPI RtlDoesFileExists_U(LPCWSTR);
CLASS_DECL_APEX int_bool WINAPI RtlDosPathNameToNtPathName_U(PCWSTR, PUNICODE_STRING, PWSTR*, CURDIR*);
CLASS_DECL_APEX WINULONG WINAPI RtlDosSearchPath_U(LPCWSTR, LPCWSTR, LPCWSTR, WINULONG, LPWSTR, LPWSTR*);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlUnicodeToMultiByteN(char *, ::u32, LPDWORD, LPCWSTR, ::u32);
CLASS_DECL_APEX NTSTATUS WINAPI RtlUnicodeToMultiByteSize(PWINULONG, PCWSTR, WINULONG);
CLASS_DECL_APEX NTSTATUS WINAPI RtlUnicodeToOemN(char *, ::u32, LPDWORD, LPCWSTR, ::u32);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlUpcaseUnicodeToMultiByteN(char *, ::u32, LPDWORD, LPCWSTR, ::u32);
CLASS_DECL_APEX NTSTATUS WINAPI RtlUpcaseUnicodeToOemN(char *, ::u32, LPDWORD, LPCWSTR, ::u32);
