...
CLASS_DECL_APEX NTSTATUS WINAPIV DbgPrint(LPCSTR fmt, ...);
CLASS_DECL_APEX NTSTATUS WINAPIV DbgPrintEx(WINULONG iComponentId, WINULONG Level, LPCSTR fmt, ...);
...
CLASS_DECL_APEX NTSTATUS WINAPI LdrLoadDll(LPCWSTR, DWORD, const UNICODE_STRING*, HMODULE*);
...
//    CLASS_DECL_APEX NTSTATUS WINAPI NtAdjustPrivilegesToken(HANDLE, int_bool, PTOKEN_PRIVILEGES, DWORD, PTOKEN_PRIVILEGES, PDWORD);
...
CLASS_DECL_APEX NTSTATUS WINAPI NtCreateSemaphore(PHANDLE, ACCESS_MASK, const OBJECT_ATTRIBUTES*, LONG, LONG);
...
CLASS_DECL_APEX NTSTATUS WINAPI NtEnumerateKey(HANDLE, WINULONG, KEY_INFORMATION_CLASS, void *, DWORD, DWORD *);
...
CLASS_DECL_APEX NTSTATUS WINAPI NtFlushInstructionCache(HANDLE, LPCVOID, SIZE_T);
CLASS_DECL_APEX NTSTATUS WINAPI NtFlushKey(HANDLE);
CLASS_DECL_APEX NTSTATUS WINAPI NtFlushVirtualMemory(HANDLE, LPCVOID*, SIZE_T*, WINULONG);
...
CLASS_DECL_APEX NTSTATUS WINAPI NtOpenProcessToken(HANDLE, DWORD, HANDLE *);
CLASS_DECL_APEX NTSTATUS WINAPI NtOpenProcessTokenEx(HANDLE, DWORD, DWORD, HANDLE *);
...
CLASS_DECL_APEX NTSTATUS WINAPI NtOpenThreadToken(HANDLE, DWORD, int_bool, HANDLE *);
CLASS_DECL_APEX NTSTATUS WINAPI NtOpenThreadTokenEx(HANDLE, DWORD, int_bool, DWORD, HANDLE *);
...
CLASS_DECL_APEX NTSTATUS WINAPI NtQueryInformationFile(HANDLE, PIO_STATUS_BLOCK, PVOID, LONG, FILE_INFORMATION_CLASS);
...
CLASS_DECL_APEX NTSTATUS WINAPI NtQueryKey(HANDLE, KEY_INFORMATION_CLASS, void *, DWORD, DWORD *);
...
CLASS_DECL_APEX NTSTATUS WINAPI NtQueryValueKey(HANDLE, const UNICODE_STRING *, KEY_VALUE_INFORMATION_CLASS, void *, DWORD, DWORD *);
CLASS_DECL_APEX NTSTATUS WINAPI NtQueryVirtualMemory(HANDLE, LPCVOID, MEMORY_INFORMATION_CLASS, PVOID, SIZE_T, SIZE_T*);
...
CLASS_DECL_APEX NTSTATUS WINAPI NtSetInformationThread(HANDLE, THREADINFOCLASS, LPCVOID, WINULONG);
...
CLASS_DECL_APEX NTSTATUS WINAPI NtTerminateProcess(HANDLE, LONG);
CLASS_DECL_APEX NTSTATUS WINAPI NtTerminateThread(HANDLE, LONG);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlActivateActivationContext(DWORD, HANDLE, ULONG_PTR*);
CLASS_DECL_APEX NTSTATUS WINAPI RtlAddAce(PACL, DWORD, DWORD, PACE_HEADER, DWORD);
CLASS_DECL_APEX NTSTATUS WINAPI RtlAddAccessAllowedAce(PACL, DWORD, DWORD, PSID);
CLASS_DECL_APEX NTSTATUS WINAPI RtlAddAccessAllowedAceEx(PACL, DWORD, DWORD, DWORD, PSID);
CLASS_DECL_APEX NTSTATUS WINAPI RtlAddAccessDeniedAce(PACL, DWORD, DWORD, PSID);
CLASS_DECL_APEX NTSTATUS WINAPI RtlAddAccessDeniedAceEx(PACL, DWORD, DWORD, DWORD, PSID);
CLASS_DECL_APEX NTSTATUS WINAPI RtlAddAtomToAtomTable(RTL_ATOM_TABLE, const WCHAR*, RTL_ATOM*);
CLASS_DECL_APEX NTSTATUS WINAPI RtlAddAuditAccessAce(PACL, DWORD, DWORD, PSID, int_bool, int_bool);
CLASS_DECL_APEX NTSTATUS WINAPI RtlAddAuditAccessAceEx(PACL, DWORD, DWORD, DWORD, PSID, int_bool, int_bool);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlAllocateAndInitializeSid(PSID_IDENTIFIER_AUTHORITY, BYTE, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, PSID *);
...
#endif
CLASS_DECL_APEX WCHAR WINAPI RtlAnsiCharToUnicodeChar(LPSTR *);
CLASS_DECL_APEX DWORD WINAPI RtlAnsiStringToUnicodeSize(const STRING *);
CLASS_DECL_APEX NTSTATUS WINAPI RtlAnsiStringToUnicodeString(PUNICODE_STRING, PCANSI_STRING, int_bool);
CLASS_DECL_APEX NTSTATUS WINAPI RtlAppendAsciizToString(STRING *, LPCSTR);
...
CLASS_DECL_APEX LONG WINAPI RtlCompareString(const STRING*, const STRING*, int_bool);
CLASS_DECL_APEX LONG WINAPI RtlCompareUnicodeString(const UNICODE_STRING*, const UNICODE_STRING*, int_bool);
...
CLASS_DECL_APEX DWORD WINAPI RtlComputeCrc32(DWORD, const BYTE*, INT);
...
CLASS_DECL_APEX int_bool WINAPI RtlCopySid(DWORD, PSID, PSID);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlCreateAcl(PACL, DWORD, DWORD);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlCreateSecurityDescriptor(PSECURITY_DESCRIPTOR, DWORD);
CLASS_DECL_APEX NTSTATUS WINAPI RtlCreateTimerQueue(PHANDLE);
CLASS_DECL_APEX NTSTATUS WINAPI RtlCreateTimer(PHANDLE, HANDLE, RTL_WAITORTIMERCALLBACKFUNC, PVOID, DWORD, DWORD, WINULONG);
CLASS_DECL_APEX int_bool WINAPI RtlCreateUnicodeString(PUNICODE_STRING, LPCWSTR);
CLASS_DECL_APEX int_bool WINAPI RtlCreateUnicodeStringFromAsciiz(PUNICODE_STRING, LPCSTR);
...
CLASS_DECL_APEX void WINAPI RtlDeactivateActivationContext(DWORD, ULONG_PTR);
CLASS_DECL_APEX NTSTATUS WINAPI RtlDecompressBuffer(WINUSHORT, PWINUCHAR, WINULONG, PWINUCHAR, WINULONG, PWINULONG);
CLASS_DECL_APEX NTSTATUS WINAPI RtlDeleteAce(PACL, DWORD);
...
CLASS_DECL_APEX DWORD WINAPI RtlFreeSid(PSID);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlGetAce(PACL, DWORD, LPVOID *);
...
CLASS_DECL_APEX DWORD WINAPI RtlGetLastWin32Error(void);
CLASS_DECL_APEX DWORD WINAPI RtlGetLongestNtPathLength(void);
...
CLASS_DECL_APEX DWORD WINAPI RtlGetThreadErrorMode(void);
...
CLASS_DECL_APEX PVOID WINAPI RtlImageDirectoryEntryToData(HMODULE, int_bool, WORD, WINULONG *);
CLASS_DECL_APEX PIMAGE_NT_HEADERS WINAPI RtlImageNtHeader(HMODULE);
CLASS_DECL_APEX PIMAGE_SECTION_HEADER WINAPI RtlImageRvaToSection(const IMAGE_NT_HEADERS *, HMODULE, DWORD);
CLASS_DECL_APEX PVOID WINAPI RtlImageRvaToVa(const IMAGE_NT_HEADERS *, HMODULE, DWORD, IMAGE_SECTION_HEADER **);
...
CLASS_DECL_APEX int_bool WINAPI RtlIsTextUnicode(LPCVOID, INT, INT *);
...
CLASS_DECL_APEX DWORD WINAPI RtlLengthRequiredSid(DWORD);
CLASS_DECL_APEX WINULONG WINAPI RtlLengthSecurityDescriptor(PSECURITY_DESCRIPTOR);
CLASS_DECL_APEX DWORD WINAPI RtlLengthSid(PSID);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlMultiByteToUnicodeN(LPWSTR, DWORD, LPDWORD, LPCSTR, DWORD);
CLASS_DECL_APEX NTSTATUS WINAPI RtlMultiByteToUnicodeSize(DWORD*, LPCSTR, UINT);
...
CLASS_DECL_APEX UINT WINAPI RtlOemStringToUnicodeSize(const STRING*);
CLASS_DECL_APEX NTSTATUS WINAPI RtlOemStringToUnicodeString(UNICODE_STRING*, const STRING*, int_bool);
CLASS_DECL_APEX NTSTATUS WINAPI RtlOemToUnicodeN(LPWSTR, DWORD, LPDWORD, LPCSTR, DWORD);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlQueryInformationAcl(PACL, LPVOID, DWORD, ACL_INFORMATION_CLASS);
...
CLASS_DECL_APEX void WINAPI RtlRestoreLastWin32Error(DWORD);
CLASS_DECL_APEX void WINAPI RtlSecondsSince1970ToTime(DWORD, LARGE_INTEGER *);
CLASS_DECL_APEX void WINAPI RtlSecondsSince1980ToTime(DWORD, LARGE_INTEGER *);
...
CLASS_DECL_APEX void WINAPI RtlSetLastWin32Error(DWORD);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlSetThreadErrorMode(DWORD, LPDWORD);
...
CLASS_DECL_APEX LPDWORD WINAPI RtlSubAuthoritySid(PSID, DWORD);
...
CLASS_DECL_APEX DWORD WINAPI RtlUnicodeStringToAnsiSize(const UNICODE_STRING*);
...
CLASS_DECL_APEX DWORD WINAPI RtlUnicodeStringToOemSize(const UNICODE_STRING*);
CLASS_DECL_APEX NTSTATUS WINAPI RtlUnicodeStringToOemString(POEM_STRING, PCUNICODE_STRING, int_bool);
CLASS_DECL_APEX NTSTATUS WINAPI RtlUnicodeToMultiByteN(LPSTR, DWORD, LPDWORD, LPCWSTR, DWORD);
CLASS_DECL_APEX NTSTATUS WINAPI RtlUnicodeToMultiByteSize(PWINULONG, PCWSTR, WINULONG);
CLASS_DECL_APEX NTSTATUS WINAPI RtlUnicodeToOemN(LPSTR, DWORD, LPDWORD, LPCWSTR, DWORD);
...
CLASS_DECL_APEX NTSTATUS WINAPI RtlUpcaseUnicodeToMultiByteN(LPSTR, DWORD, LPDWORD, LPCWSTR, DWORD);
CLASS_DECL_APEX NTSTATUS WINAPI RtlUpcaseUnicodeToOemN(LPSTR, DWORD, LPDWORD, LPCWSTR, DWORD);
CLASS_DECL_APEX NTSTATUS WINAPI RtlUpdateTimer(HANDLE, HANDLE, DWORD, DWORD);
...
CLASS_DECL_APEX int_bool WINAPI RtlValidateHeap(HANDLE, WINULONG, LPCVOID);
CLASS_DECL_APEX NTSTATUS WINAPI RtlVerifyVersionInfo(const RTL_OSVERSIONINFOEXW*, DWORD, DWORDLONG);
...
//CLASS_DECL_APEX  NTSTATUS  WINAPI vDbgPrintEx(WINULONG,WINULONG,LPCSTR,__ms_va_list);
//CLASS_DECL_APEX  NTSTATUS  WINAPI vDbgPrintExWithPrefix(LPCSTR,WINULONG,WINULONG,LPCSTR,__ms_va_list);

/* 32-bit only functions */

#ifndef _WIN64
CLASS_DECL_APEX LONGLONG WINAPI RtlConvertLongToLargeInteger(LONG);
CLASS_DECL_APEX ULONGLONG WINAPI RtlConvertUlongToLargeInteger(WINULONG);
CLASS_DECL_APEX LONGLONG WINAPI RtlEnlargedIntegerMultiply(INT, INT);
CLASS_DECL_APEX ULONGLONG WINAPI RtlEnlargedUnsignedMultiply(UINT, UINT);
CLASS_DECL_APEX UINT WINAPI RtlEnlargedUnsignedDivide(ULONGLONG, UINT, UINT *);
CLASS_DECL_APEX LONGLONG WINAPI RtlExtendedMagicDivide(LONGLONG, LONGLONG, INT);
CLASS_DECL_APEX LONGLONG WINAPI RtlExtendedIntegerMultiply(LONGLONG, INT);
CLASS_DECL_APEX LONGLONG WINAPI RtlExtendedLargeIntegerDivide(LONGLONG, INT, INT *);
CLASS_DECL_APEX LONGLONG WINAPI RtlLargeIntegerAdd(LONGLONG, LONGLONG);
CLASS_DECL_APEX LONGLONG WINAPI RtlLargeIntegerArithmeticShift(LONGLONG, INT);
CLASS_DECL_APEX ULONGLONG WINAPI RtlLargeIntegerDivide(ULONGLONG, ULONGLONG, ULONGLONG *);
CLASS_DECL_APEX LONGLONG WINAPI RtlLargeIntegerNegate(LONGLONG);
CLASS_DECL_APEX LONGLONG WINAPI RtlLargeIntegerShiftLeft(LONGLONG, INT);
CLASS_DECL_APEX LONGLONG WINAPI RtlLargeIntegerShiftRight(LONGLONG, INT);
CLASS_DECL_APEX LONGLONG WINAPI RtlLargeIntegerSubtract(LONGLONG, LONGLONG);
