...
CLASS_DECL_APEX void __simple_tracev(generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, va_list args);
CLASS_DECL_APEX void __simple_tracea(generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char *pszFileName, i32 iLine, const char * psz);
...
CLASS_DECL_APEX void __tracea(::generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * psz)
{
...
CLASS_DECL_APEX void __tracef(::generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, ...)
{
...
CLASS_DECL_APEX void __tracev(::generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, va_list args)
{
