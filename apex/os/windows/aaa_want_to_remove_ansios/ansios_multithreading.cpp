...
bool apex_defer_process_x_message(HTHREAD hthread,LPMESSAGE lpMsg,oswindow oswindow,bool bPeek)
{
...
CLASS_DECL_APEX void set_main_thread_id(ITHREAD uiThread)
{
...
CLASS_DECL_APEX ITHREAD get_main_thread_id()
{
...
CLASS_DECL_APEX int_bool WINAPI PostThreadMessage(ITHREAD iThreadId,UINT Msg,WPARAM wParam,LPARAM lParam)
{
