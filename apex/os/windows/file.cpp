...
//
//
////extern "C" CLASS_DECL_APEX void GetOpenedFiles(LPCWSTR pPath, OF_TYPE Filter, OF_CALLBACK CallBackProc, uptr pUserContext)
////
////{
////   string csPath = pPath;
////
...
int_bool file_is_equal_path(const char * psz1,const char * psz2)
{
   ...
   ::apex::malloc < unichar * > pwszPath1;

   ::apex::malloc < unichar * > pwszPath2;
...
CLASS_DECL_APEX bool read_resource_as_memory(memory & m, HINSTANCE hinstance, UINT nID, const char * pcszType, strsize iReadAtMostByteCount)
