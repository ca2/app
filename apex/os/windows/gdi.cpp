...
namespace draw2d
{
   ...
   CLASS_DECL_APEX void wingdi_enum_fonts(::draw2d::font_enum_item_array & itema, bool bRaster, bool bTrueType, bool bOther)
   {
...
CLASS_DECL_APEX HBITMAP CreateAlphaBitmapV5(const ::image * pimage)
{
...
CLASS_DECL_APEX HBITMAP CreateHBITMAP(pixmap * ppixmap)
{
...
CLASS_DECL_APEX HBITMAP CreateHBITMAP2(pixmap * ppixmap)
{
