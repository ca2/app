...
CLASS_DECL_APEX bool os_init_imaging()
{
...
CLASS_DECL_APEX void os_term_imaging()
{
...
CLASS_DECL_APEX WINBOOL imaging::window_set_mouse_cursor(oswindow , HCURSOR hcursor)
{
