...
bool CLASS_DECL_APEX __is_combo_box_control(oswindow oswindow, UINT nStyle)
{
   if (oswindow == nullptr)
      return FALSE;
...
bool CLASS_DECL_APEX __compare_class_name(oswindow oswindow, const char * pszClassName)
...
oswindow CLASS_DECL_APEX __child_window_from_point(oswindow oswindow, const ::point & pointParam)
{
