...
CLASS_DECL_APEX wstring windows_register_window_class(::object * pobject, UINT nClassStyle, HCURSOR hCursor = 0, HBRUSH hbrBackground = 0, HICON hIcon = 0);
...
CLASS_DECL_APEX bool windows_register_with_icon(WNDCLASSEXW* pwndclass, const unichar * pszClassName, UINT nIDIcon);
