...
namespace apex
{
   ...
   template < class APP >
   __result(::apex::application) single_application_library < APP > ::get_new_application(::object * pobject, const char * pszAppId)
   {
...
namespace apex
{
   ...
   inline void delobj(T * & p)
   {
      ...
      // catch all (...) here in apex::del ... but should remove try catch from all underlying calls (frees, memory_frees, memory_dbg_frees).
...
CLASS_DECL_APEX inline ::context * get_context(::object * pobject)
{
...
CLASS_DECL_APEX inline ::apex::application * get_context_application(::object * pobject)
{
...
CLASS_DECL_APEX inline ::apex::session * get_context_session(::object * pobject)
{
...
CLASS_DECL_APEX inline ::apex::system * get_context_system(::object * pobject)
{
