...
//
//#ifndef __cplusplus
//#error apex requires C++ compilation (use a .cpp suffix)
//#endif
//
//#ifdef UNDER_CE
//#error This version of apex is not currently supported for CE. Look for the CE specific version.
//#endif
//
//
//#ifdef _UNICODE
...
//#ifdef UNICODE
//#ifndef _UNICODE
//#define _UNICODE        // _UNICODE is used by C-runtime/apex API headers
//#endif
//#endif
//
//
...
//
//apex 8 has two existing validation models
//
...
//
//We added ENSURE because there were too many unreported error paths in apex and we wanted to bail out of more
...
//
//ENSURE might seem slightly better. It is debuggable and consistent with apex in general. In fact, many parts of apex do just this.
...
//// rather only used as a apex class.  Additionally, the constructor and
...
/////////////////////////////////////////////////////////////////////////////////
//// By default, the wizards will generate aaa_primitive_new apex object classes with this
...
//#else
//// If not linking to 80.DLL, use the static registrar and not building apex.dll
//#ifndef _DLL_IMPL
...
//#endif
//
//#define API CLASS_DECL_APEX __declspec(nothrow) HRESULT __stdcall
//#define API_(x)CLASS_DECL_APEX __declspec(nothrow) x __stdcall
//#define APIINL API
//#define APIINL_(x) API_(x)
//
//
//#define offsetofclass(apex, derived) ((uptr)(static_cast<apex*>((derived*)_PACKING))-_PACKING)
//
///////////////////////////////////////////////////////////////////////////////
...
//#endif
//
////apex/ API code should use standard pointer to member standard syntax &MyClass::MyMethod, instead
