...
//#endif
   ...
   if (strUid.has_char())
   {
      ...
      output_error_message("going to seteuid to: " + __str(uid), "going to seteuid", e_message_box_ok);

      if (seteuid(uid) == 0)
      {

         output_error_message("uid=" + __str(uid), "seteuid success", e_message_box_ok);
