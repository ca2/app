...
// #endif
      ...
      //virtual void message_box_synchronous(::user::interaction_base * puiOwner, const ::string & pszMessage, const ::string & pszTitle = nullptr, const ::e_message_box & emessagebox = e_message_box_ok, ::callback callback = ::callback());
...
/// bHandled true if some action was done in response to this new additional instance creation
      ...
      virtual bool platform_open_by_file_extension(::collection::index iEdge, const ::string & pszPathName, ::request * prequest = nullptr);
      ...
      virtual ::pointer<::progress::real>show_progress(::user::interaction * puiParent, const ::string & strTitle, ::collection::count iProgressCount);
