...
//{
   ...
   public:
      ...
      ::collection::index find_child_with_name(const char * pszName) const;
...
//      
//
//      void add_item(::collection::index iIndex, const ::scoped_string & scopedstrName, const ::atom & atom, const ::scoped_string & scopedstrMacosAccelerator, const ::scoped_string & scopedstrDescription);
//
//      
//   };
