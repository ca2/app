...
namespace async
{
   ...
   struct CLASS_DECL_APEX registration_token : public token
   {

   };


   struct CLASS_DECL_APEX cancellation_token : public token
   {
      ...
      template < class T >
      registration_token register_callback(T * point_i32, void(T::*pfnCancel)())
      {
