...
#define STATIC_DOWNCAST_T(class_name, T1, object) (static_cast<class_name<T1>*>(::apex::StaticDownCast(RUNTIME_CLASS_T(class_name, T1), object)))
#define STATIC_DOWNCAST_T2(class_name, T1, T2, object) (static_cast<class_name<T1, T2>*>(::apex::StaticDownCast(RUNTIME_CLASS_T2(class_name, T1, T2), object)))
