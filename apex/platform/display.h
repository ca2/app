...
//CLASS_DECL_APEX e_display equivalence_sink(e_display edisplay);
...
//CLASS_DECL_APEX int windows_show_window(e_display edisplay, e_activation eactivation);
//CLASS_DECL_APEX e_display windows_show_window_to_edisplay(int iShowWindow, e_activation & eactivation);


//CLASS_DECL_APEX string __str(e_display edisplay);
