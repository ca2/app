...
CLASS_DECL_APEX void main_async_runnable(::context_object * pobjectTask);
CLASS_DECL_APEX void main_sync_runnable(::context_object * pobjectTask, ::duration durationTimeout = one_minute());
