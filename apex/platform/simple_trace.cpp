...
CLASS_DECL_APEX void __simple_tracev(::generic_object * pobjectContext, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, va_list args);
...
CLASS_DECL_APEX bool enable_trace_category(e_trace_category ecategory, bool bEnable)
{
...
CLASS_DECL_APEX::generic_object * general_trace_object()
{
...
CLASS_DECL_APEX::generic_object * trace_object(e_trace_category ecategory)
{
