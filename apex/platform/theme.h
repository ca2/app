...
namespace apex
{
   ...
   class CLASS_DECL_APEX theme_listener :
   ...
   public:
      ...
      //   CRASH!!!???
      //
      //   Is initialize_contextualized_theme called from apex::application
      //
