...
CLASS_DECL_APEX bool safe_destroy_element(object * pobject);
...
class CLASS_DECL_APEX map_word_to_ptr :
...
class CLASS_DECL_APEX map_ptr_to_word :
...
class CLASS_DECL_APEX map_ptr_to_ptr :
...
class CLASS_DECL_APEX map_word_to_ob :
...
class CLASS_DECL_APEX map_string_to_ptr :
...
class CLASS_DECL_APEX map_string_to_ob :
...
#include "apex/platform/pred_callback.h"


#include "var_array.h"
#include "apex/primitive/primitive/property.h"
...
typedef CLASS_DECL_APEX __pointer_array(u32_array) dword_2darray;
typedef CLASS_DECL_APEX __pointer_array(index_array) index_2darray;


#include "apex/primitive/geometry2d/point_array.h"
#include "apex/primitive/geometry2d/size_array.h"
#include "apex/primitive/geometry2d/rect_array.h"


#include "apex/primitive/geometry2d/polygon.h"


#include "apex/primitive/comparison/less.h"
...
class CLASS_DECL_APEX time_array :
