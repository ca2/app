...
template<class TYPE, class ARG_TYPE, class ALLOCATOR >
raw_array < TYPE, ARG_TYPE, ALLOCATOR >::raw_array(::object * pobject) 
   //:
   //::object(pobject)
{
...
raw_array < TYPE, ARG_TYPE, ALLOCATOR >::raw_array(const raw_array <TYPE, ARG_TYPE, ALLOCATOR> & a)// :
   // object(a.get_context_application())
{
...
//      ::apex::memcpy_s(pNewData, (size_t)nNewMax * sizeof(TYPE),
...
//         // copy new data from old
//         ::apex::memcpy_s(pNewData, m_nSize * sizeof(TYPE),
