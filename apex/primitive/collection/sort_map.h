...
//   }
//
//   return pnode->element2();  // return new context_object
//
//}
//
//template < class KEY, class ARG_KEY, class VALUE, class ARG_VALUE, class COMPARE, bool m_bMultiKey >
...
//}
//
//typedef CLASS_DECL_APEX sort_attrib_map < sort_map < i32, i32, i32, i32 > > sort_int_to_int;
//typedef CLASS_DECL_APEX sort_attrib_map < sort_map < i32, i32, string, const string & > > sort_int_to_string;
//typedef CLASS_DECL_APEX sort_string_map < void *, void * > sort_string_to_ptr;
//
//template < class T >
//class CLASS_DECL_APEX sort_string_to_pointer :
...
//
//
//typedef CLASS_DECL_APEX sort_string_map < iptr, iptr > sort_string_to_intptr;
//
//typedef CLASS_DECL_APEX sort_string_map < string, const string & > sort_string_to_string_map;
//
//
//
//
