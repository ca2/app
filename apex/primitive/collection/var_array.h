...
class CLASS_DECL_APEX var_array :
   public array < var >
{
public:
...
CLASS_DECL_APEX void var_array_skip_json(const char *& pszJson);
CLASS_DECL_APEX void var_array_skip_json(const char *& pszJson, const char * pszEnd);
