...
namespace data
{
   ...
   string simple_item::data_item_get_text(elemental * pobject) const
   {
      UNREFERENCED_PARAMETER(pobject);
      return m_str;
   }
   
   index simple_item::data_item_get_image(elemental * pobject) const
   {
   ...
   image_list * simple_item::data_item_get_image_list(elemental * pobject) const
   {
