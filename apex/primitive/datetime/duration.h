...
class CLASS_DECL_APEX duration
{
public:
...
class CLASS_DECL_APEX one_second :
   public duration
{
public:
...
class CLASS_DECL_APEX one_minute :
   public duration
{
public:
...
class CLASS_DECL_APEX one_hour :
   public hours
{
public:
...
inline bool CLASS_DECL_APEX operator >(const duration & duration1, const duration & duration2)
{
