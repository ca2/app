...
namespace datetime
{
   ...
   class CLASS_DECL_APEX file_time:
      public FILETIME
   {
   public:
   ...
   extern CLASS_DECL_APEX const char * const szInvalidDateTime;
   extern CLASS_DECL_APEX const char * const szInvalidDateTimeSpan;
...
CLASS_DECL_APEX FILETIME get_file_time_now();


struct CLASS_DECL_APEX file_time
{
...
CLASS_DECL_APEX bool file_modified_timeout(const char * path, int iSeconds);


CLASS_DECL_APEX bool get_file_time(const char * psz,file_time & time);

CLASS_DECL_APEX bool get_file_time(const char * psz,FILETIME & creation,FILETIME & modified);

CLASS_DECL_APEX bool set_modified_file_time(const char* psz, const ::datetime::time & time);

CLASS_DECL_APEX bool set_modified_file_time(const char* psz, const FILETIME& modified);
