...
#ifdef __DEBUG
CLASS_DECL_APEX dump_context & operator <<(dump_context & dumpcontext, ::datetime::time time);
CLASS_DECL_APEX dump_context & operator <<(dump_context & dumpcontext, ::datetime::time_span time);
#endif




inline CLASS_DECL_APEX ::datetime::time_span operator - (const duration & duration, const ::datetime::time & time)
{
...
inline CLASS_DECL_APEX ::datetime::time operator + (const duration & duration, const ::datetime::time & time)
{
