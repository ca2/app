...
//
//
//CLASS_DECL_APEX bool null_intersect_rect(RECT * prect,const rect & rect1,const rect & rect2)
//{
//
...
//
//
//CLASS_DECL_APEX bool top_left_null_intersect_rect(RECT * prect,const rect & rect1,const rect & rect2)
//
//{
...
//
//
//CLASS_DECL_APEX double width(const ::rectd & rect)
//
//{
...
//}
//
//CLASS_DECL_APEX double height(const ::rectd & rect)
//
//{
...
//
//
//CLASS_DECL_APEX bool deflate(RECT * prect, const ::rect & rect)
//
//{
...
//
//
//CLASS_DECL_APEX bool copy(POINT64 * pptDst,const point & pointSrc)
//
//{
//
//   pptDst->x = lpptSrc->x;
...
//
//
//CLASS_DECL_APEX bool copy(LPPOINT pptDst,const POINT64 * lpptSrc)
//
//{
//
