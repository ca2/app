...
//#ifdef WINDOWS
DEFINE_UNIT(CLASS_DECL_APEX,lock_duration,u32)
DEFINE_UNIT(CLASS_DECL_APEX,tick_duration,u32)
//#endif

//DEFINE_C_NUMBER(CLASS_DECL_APEX, filesize        , u64)
//DEFINE_C_NUMBER(CLASS_DECL_APEX, filesize    , u64)
//DEFINE_C_NUMBER(CLASS_DECL_APEX, filesize      ,  i64)
...
namespace numeric_info_internal
{
   ...
   template < typename T >
   class CLASS_DECL_APEX numeric_info < ::c_number < T > > :
