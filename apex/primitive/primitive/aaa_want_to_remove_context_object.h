...
struct CLASS_DECL_APEX context_object :
   virtual public context_object
{
   ...
   ::apex::application *                  get_context_application(); // Context Application
   ::eobject                              m_eobject;
   //::id                                   m_id;
   ...
   ::apex::application * get_context_application() const { return get_context_application(); }
