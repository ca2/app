...
namespace factory
{
   ...
   class CLASS_DECL_APEX factory_interface :
   ...
   CLASS_DECL_APEX extern factory_array * g_pfactorya;
   CLASS_DECL_APEX extern critical_section * g_pcsFactory;
   CLASS_DECL_APEX extern factory_map * g_pfactorymap;


   CLASS_DECL_APEX void factory_init();

   CLASS_DECL_APEX void factory_close();

   CLASS_DECL_APEX void factory_term();
