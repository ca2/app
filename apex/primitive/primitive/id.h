...
#include "apex/primitive/comparison/hash.h"
...
inline CLASS_DECL_APEX iptr id_strcmp(const id * pid1,const id * pid2)
{
...
inline CLASS_DECL_APEX id & id::operator += (const char * psz) { return operator = (string(*this) + string(psz)); }
