...
public:
   ...
   memory(::object * pobjectContext = nullptr) { m_memory.m_pprimitivememory = this; m_bAligned = false; }
   ...
   memory(memory_container * pcontainer, memsize size = 0, UINT uAllocFlags = 0);
