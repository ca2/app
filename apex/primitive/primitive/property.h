...
string CLASS_DECL_APEX operator + (const char * psz, const property & prop);

var CLASS_DECL_APEX operator - (i32 i, const property & prop);
var CLASS_DECL_APEX operator - (u32 user, const property & prop);
var CLASS_DECL_APEX operator - (i64 i, const property & prop);
var CLASS_DECL_APEX operator - (u64 ui, const property & prop);
var CLASS_DECL_APEX operator - (double d, const property & prop);
var CLASS_DECL_APEX operator - (const var & var, const property & prop);
...
class CLASS_DECL_APEX property : public var
{
public:
...
CLASS_DECL_APEX void property_parse_json_id(id & id, const char *& pszJson, const char * pszEnd);
CLASS_DECL_APEX void property_parse_json_value(::var & var, const char *& pszJson, const char * pszEnd);
CLASS_DECL_APEX void property_skip_json_id(const char *& pszJson, const char * pszEnd);
CLASS_DECL_APEX void property_skip_json_value(const char *& pszJson, const char * pszEnd);
...
inline var CLASS_DECL_APEX operator - (i32 i, const property& prop) { return operator - (i, (const ::var &) prop); }
inline var CLASS_DECL_APEX operator - (u32 user, const property& prop) { return operator - (user, (const ::var &)prop); }
inline var CLASS_DECL_APEX operator - (i64 i, const property& prop) { return operator - (i, (const ::var &)prop); }
inline var CLASS_DECL_APEX operator - (u64 ui, const property& prop) { return operator - (ui, (const ::var &)prop); }
inline var CLASS_DECL_APEX operator - (double d, const property& prop) { return operator - (d, (const ::var &)prop); }
inline var CLASS_DECL_APEX operator - (const var& var, const property& prop) { return operator - (var, (const ::var &)prop); }
