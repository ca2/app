...
class CLASS_DECL_APEX property_set :
...
CLASS_DECL_APEX void property_set_skip_json(const char *& pszJson);
CLASS_DECL_APEX void property_set_skip_json(const char *& pszJson, const char * pszEnd);
...
//
   ...
   //class CLASS_DECL_APEX localini :
   //   public ini
   //{
   //public:
