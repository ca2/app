...
CLASS_DECL_APEX bool demangle(string & str, const char * psz);
CLASS_DECL_APEX bool demangle(string & str);

namespace str
{


   CLASS_DECL_APEX string demangle(const char * psz);


} // namespace str


class CLASS_DECL_APEX type
{
public:
...
inline CLASS_DECL_APEX string get_demangle(const char * lpszName)
{
