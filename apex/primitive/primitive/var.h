...
public:
   ...
   var(::generic_object * pobject);
   var(const ::generic_object & object);
   var(::image * pimage);
   ...
   ::e_type set_element(::generic_object * pobject);
...
#undef DECL_VAR_FLAG
   ...
   inline var & operator = (::generic_object * p)
   {
   ...
   var & operator = (const ::generic_object & o);
...
//   var & operator = (const string_composite & reference);
   ...
   ::generic_object * element()
   {
      if (m_etype == type_element) { return m_p; }
      return cast < ::generic_object >();
   }

   ::generic_object * element() const { return ((var *)this)->element(); }
   ...
   friend bool CLASS_DECL_APEX strict_equal(const char * psz,const var & var);
   friend bool CLASS_DECL_APEX strict_equal(const string & str,const var & var);
   friend bool CLASS_DECL_APEX strict_equal(double d,const var & var);
   friend bool CLASS_DECL_APEX strict_equal(::i32 i,const var & var);
   friend bool CLASS_DECL_APEX strict_equal(bool b,const var & var);

   friend bool CLASS_DECL_APEX strict_different(const char * psz,const var & var);
   friend bool CLASS_DECL_APEX strict_different(const string & str,const var & var);
   friend bool CLASS_DECL_APEX strict_different(double d,const var & var);
   friend bool CLASS_DECL_APEX strict_different(::i32 i,const var & var);
   friend bool CLASS_DECL_APEX strict_different(bool b,const var & var);
   ...
   //void exchange_from(const ::generic_object & generic_object) { propset().exchange(generic_object); }
   ...
   friend var CLASS_DECL_APEX operator - (::i32 i,const var & var);
   friend var CLASS_DECL_APEX operator - (::u32 ui,const var & var);
   friend var CLASS_DECL_APEX operator - (::i64 l,const var & var);
   friend var CLASS_DECL_APEX operator - (::u64 ul,const var & var);
   friend var CLASS_DECL_APEX operator - (double d,const var & var);
   friend var CLASS_DECL_APEX operator - (const var & var1,const var & var2);
...
namespace str
{
   ...
   inline CLASS_DECL_APEX void from(string & str, const var & var)
   {
...
CLASS_DECL_APEX void var_skip_number(const char *& psz);
CLASS_DECL_APEX void var_skip_number(const char *& psz, const char * pszEnd);
CLASS_DECL_APEX void var_skip_identifier(const char *& psz);
CLASS_DECL_APEX void var_skip_identifier(const char *& psz, const char * pszEnd);
CLASS_DECL_APEX void var_skip_json(const char *& pszJson);
CLASS_DECL_APEX void var_skip_json(const char *& pszJson, const char * pszEnd);
