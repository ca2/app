...
CLASS_DECL_APEX int_bool matches_wildcard_criteria(const ansichar * pszCriteria, const char * pszValue);
CLASS_DECL_APEX int_bool matches_wildcard_criteria_ci(const ansichar * pszCriteria, const char * pszValue);


CLASS_DECL_APEX void ansi_parse_command_line(ansichar * cmdstart, ansichar ** argv, ansichar * args, i32 * numargs, i32 * numchars);
...
CLASS_DECL_APEX const ansichar *       wildcard_next_stop(const ansichar * pszCriteria);


CLASS_DECL_APEX int_bool               wildcard_matches_criteria(const ansichar * pszCriteria, const ansichar * pszValue);
CLASS_DECL_APEX int_bool               wildcard_matches_criteria_ci(const ansichar * pszCriteria, const ansichar * pszValue);
