...
inline string CLASS_DECL_APEX operator + (const char * psz, const ::string & str);
inline string CLASS_DECL_APEX operator + (ansichar ansich, const ::string & str);
inline string CLASS_DECL_APEX operator + (wd16char wd16ch, const ::string & str);
inline string CLASS_DECL_APEX operator + (wd16char wd32ch, const ::string & str);
