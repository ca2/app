...
CLASS_DECL_APEX ansichar * __u64toansi(::u64 u, ansichar * buf, int iBase);

CLASS_DECL_APEX ansichar * __i64toansi(::i64 u, ansichar * buf, int iBase);
...
CLASS_DECL_APEX i64 __ansitoi64(const ansichar * psz, ansichar ** ppszEnd, i32 iBase);
CLASS_DECL_APEX u64 __ansitou64(const ansichar * psz, ansichar ** ppszEnd, i32 iBase);
CLASS_DECL_APEX i32 __ansitoi32(const ansichar * psz, ansichar ** ppszEnd, i32 iBase);
CLASS_DECL_APEX u32 __ansitou32(const ansichar * psz, ansichar ** ppszEnd, i32 iBase);
