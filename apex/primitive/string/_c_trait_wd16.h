...
inline i32                    __wd16charisalphabetic(i32 i);
inline i32                    __wd16charisalphanumeric(i32 i);
...
CLASS_DECL_APEX wd16char * __u64towd16(::u64 u, wd16char * buf, int iBase);

CLASS_DECL_APEX wd16char * __i64towd16(::i64 i, wd16char * buf, int iBase);
...
inline int __wd16ncoll(const wd16char * psz1, const wd16char * psz2, size_t s);

inline int __wd16icoll(const wd16char * psz1, const wd16char * psz2);

inline int __wd16nicoll(const wd16char * psz1, const wd16char * psz2, size_t s);
...
CLASS_DECL_APEX i64 __wd16toi64(const wd16char * psz, wd16char ** ppszEnd, i32 iBase);
CLASS_DECL_APEX u64 __wd16tou64(const wd16char * psz, wd16char ** ppszEnd, i32 iBase);
CLASS_DECL_APEX i32 __wd16toi32(const wd16char * psz, wd16char ** ppszEnd, i32 iBase);
CLASS_DECL_APEX u32 __wd16tou32(const wd16char * psz, wd16char ** ppszEnd, i32 iBase);
