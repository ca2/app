...
inline i32                    __wd32charisalphabetic(i32 i);
inline i32                    __wd32charisalphanumeric(i32 i);
...
CLASS_DECL_APEX wd32char * __u64towd32(::u64 u, wd32char * buf, int iBase);

CLASS_DECL_APEX wd32char * __i64towd32(::i64 i, wd32char * buf, int iBase);
...
CLASS_DECL_APEX i64 __wd32toi64(const wd32char * psz, wd32char ** ppszEnd, i32 iBase);
CLASS_DECL_APEX u64 __wd32tou64(const wd32char * psz, wd32char ** ppszEnd, i32 iBase);
CLASS_DECL_APEX i32 __wd32toi32(const wd32char * psz, wd32char ** ppszEnd, i32 iBase);
CLASS_DECL_APEX u32 __wd32tou32(const wd32char * psz, wd32char ** ppszEnd, i32 iBase);
