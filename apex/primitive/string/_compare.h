...
namespace str
{
   ...
   bool CLASS_DECL_APEX begins_ci_iws(const string & str, const string & strPrefix);
   bool CLASS_DECL_APEX begins_ci_iws(const wstring & wstr, const wstring & wstrPrefix);
   ...
   bool CLASS_DECL_APEX while_begins_with_chars_eat_ci(string & str, const char * pcszChars);
   ...
   bool CLASS_DECL_APEX eat_before(wstring & wstrBefore, wstring wstrSeparator, wstring & wstr, bool bEatEverythingIfNotFound = false);
   bool CLASS_DECL_APEX eat_before_let_separator(wstring & wstrBefore, wstring wstrSeparator, wstring & wstr, bool bEatEverythingIfNotFound = false);
