...
CLASS_DECL_APEX i64 strtoi(const char * psz);
CLASS_DECL_APEX i64 strtoi(const widechar * psz);
...
inline ::ansistring CLASS_DECL_APEX operator + (ansichar ansich, const ::ansistring & str2)
{
...
inline ::ansistring CLASS_DECL_APEX operator + (wd16char wd16ch, const ::ansistring & str)
{
...
inline ::ansistring CLASS_DECL_APEX operator + (wd32char wd32ch, const ::ansistring & str)
{
