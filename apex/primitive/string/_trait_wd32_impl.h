...
namespace str
{
   ...
   //   // nLen is in XCHARs
   //   ::apex::memcpy_s(pszDest,(size_t) (nDestLength*sizeof(wd32char)), pszSrc,(size_t) (nSrcLength*sizeof(wd32char)));
   //}
   //
   //void  char_traits::ConvertTochar(wd32char * pszDest, strsize nDestLength, const wd32char * pszSrc, strsize nSrcLength) noexcept
   //{
   ...
   u32 format_message(u32 dwFlags, LPCVOID pSource, u32 dwMessageID, u32 dwLanguageID, wd32char * pszBuffer, u32 nSize, va_list * pArguments) noexcept
   {
