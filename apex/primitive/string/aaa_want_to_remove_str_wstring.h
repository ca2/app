...
#include "apex/primitive/primitive/memory_c.h"



CLASS_DECL_APEX wstring operator + (const wstring & wstr1, const wstring & wstr2);
CLASS_DECL_APEX wstring operator + (const wstring & str, const unichar * psz);
CLASS_DECL_APEX wstring operator + (const unichar * psz, const wstring & str);


CLASS_DECL_APEX wstring gen_utf8_to_16(const char * psz);


//class CLASS_DECL_APEX wstring_data
//{
//protected:
//
//
