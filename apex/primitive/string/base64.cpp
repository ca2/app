...
CLASS_DECL_APEX char* _crypto_base64_encode(const BYTE* data, int length)
{
   int c;
   const BYTE* q;
   char* point;
...
CLASS_DECL_APEX void _crypto_base64_decode(const char* enc_data, int length, BYTE** dec_data, int* res_length)
{
