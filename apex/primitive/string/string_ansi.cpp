...
()nFixedChars;
()pData;
//   TRACE(::apex::trace::category_String, 0, _T( "fixed_string_manager::allocate() spilling to heap.  %d chars (fixed size = %d chars)\n" ), nActualChars, nFixedChars );
...
()nFixedChars;
()pData;
//   TRACE(::apex::trace::category_String, 0, _T( "fixed_string_manager::Reallocate() spilling to heap.  %d chars (fixed size = %d chars)\n" ), nActualChars, nFixedChars );
...
//   // nLen is in XCHARs
//   ::apex::memcpy_s(pszDest,(size_t) (nDestLength*sizeof(char)), pszSrc,(size_t) (nSrcLength*sizeof(char)));
//}
//
...
//
//      ::apex::memmove_s(pszBuffer + iIndex, (size_t) nCopy, pszBuffer + iIndex + nCount, (size_t) nCopy);
//
...
//   ::apex::memmove_s(pszBuffer + iIndex + 1, nNewLength - iIndex, pszBuffer + iIndex, nNewLength - iIndex);
//
//   pszBuffer[iIndex] = ch;
//
//   release_string_buffer(nNewLength);
...
//      char * pszBuffer = GetBuffer(nNewLength);
//      // move existing bytes down
//      ::apex::memmove_s(pszBuffer + iIndex + nInsertLength,(nNewLength - iIndex - nInsertLength + 1)*sizeof(char),
//                        pszBuffer + iIndex,(nNewLength - iIndex - nInsertLength + 1)*sizeof(char));
//      ::apex::memcpy_s(pszBuffer + iIndex,nInsertLength*sizeof(char),
...
//            ::apex::memmove_s(pszTarget + nReplacementLen,nBalance*sizeof(char),
//                              pszTarget + nSourceLen,nBalance*sizeof(char));
//            ::apex::memcpy_s(pszTarget,nReplacementLen*sizeof(char),
...
//      ::apex::memmove_s(pszBuffer,(nDataLength + 1)*sizeof(char),
...
////#endif
//
//bool string::load_string(::object * pobject,id id)
//{
