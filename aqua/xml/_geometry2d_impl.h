...
inline ::xml::input_tree & operator >> (::xml::input_tree & xmlif, poi32_array_base < POINT_TYPE > & pointa)
{
...
template < typename POINT_TYPE >
inline ::xml::output_tree & operator << (::xml::output_tree & xmlof, poi32_array_base < POINT_TYPE > & pointa)
{
   ...
   for (auto & point : pointa)
   {
      ...
      strPoint.formatf(strFormat, point.x, point.y);
