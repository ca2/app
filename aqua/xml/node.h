...
namespace xml
{
   ...
   public:
      ...
      node *                  get_child( const_char_pointer pszName);
      ...
      node *                  get_child(const_char_pointer pszName, ::collection::index & iStartPosition);
      string                  get_child_value(const_char_pointer pszName);
      string                  get_child_text(const_char_pointer pszName, disp_option * opt = nullptr);

      node::array             children(const_char_pointer pszName);
      node::array &           children();

      ::property *            GetChildAttr(const_char_pointer pszName, const_char_pointer attrname);
      string                  GetChildAttrValue(const_char_pointer pszName, const_char_pointer attrname);
      ...
      // search node
      node *                  rear_find( const_char_pointer pszName, ::i32 iDepth = -1);
      ...
      //node *                create_node( const_char_pointer pszName = nullptr, const_char_pointer value = nullptr );
