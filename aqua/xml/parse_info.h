...
namespace xml
{
   ...
   public:
      ...
      ::i8                 m_chEscape;          // [set] escape character (default '\\')
   ...
   CLASS_DECL_AQUA char_pointer LoadOtherNodes( node * node, bool* pbRet, const ::scoped_string & scopedstrXml, parse_info * pi = nullptr);
