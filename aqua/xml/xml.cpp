...
namespace xml
{
   ...
   xml::xml()
   {
      ...
      m_pentitiesHashDefault = ::place(new string_to_string());
   ...
   void xml::init1()
   {
      ...
      m_poptionDefault     = ::place(new disp_option(m_pentities));

      m_pparseinfoDefault  = ::place(new parse_info(m_pentities));
...
//    o.m_pdocument = ::place(new ::xml::document(pparticle));
...
//    i.m_pdocument = ::place(new xml::document(pparticle));
