...
namespace xml
{
   ...
   void xml::init1()
   {
      ...
      m_poptionDefault     = __allocate disp_option(m_pentities);

      m_pparseinfoDefault  = __allocate parse_info(m_pentities);
...
//    o.m_pdocument = __allocate ::xml::document(pparticle);
...
//    i.m_pdocument = __allocate xml::document(pparticle);
