...
extern zipFile CLASS_DECL_AURA zipOpen OF((const char *pathname, i32 append));
/*
  create a zipfile.
...
extern i32 CLASS_DECL_AURA zipOpenNewFileInZip OF((zipFile file,
      const char* filename,
...
extern i32 CLASS_DECL_AURA zipOpenNewFileInZip2 OF((zipFile file,
      const char* filename,
      const zip_fileinfo* zipfi,
      const void * extrafield_local,
      u32 size_extrafield_local,
...
extern i32 CLASS_DECL_AURA zipOpenNewFileInZip3 OF((zipFile file,
      const char* filename,
      const zip_fileinfo* zipfi,
      const void * extrafield_local,
      u32 size_extrafield_local,
...
extern i32 CLASS_DECL_AURA zipWriteInFileInZip OF((zipFile file,
      const void * buf,
      u32 len));
/*
...
extern i32 CLASS_DECL_AURA zipCloseFileInZip OF((zipFile file));
/*
  close the current file in the zipfile
*/


extern i32 CLASS_DECL_AURA zipCloseFileInZipRaw OF((zipFile file,
...
extern i32 CLASS_DECL_AURA zipClose OF((zipFile file,
