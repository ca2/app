...
*/
extern i32 CLASS_DECL_AURA unzStringFileNameCompare (
...
extern i32 CLASS_DECL_AURA unzClose (unzFile file)
{
   unz_s* s;
   if (file==nullptr)
...
/*
  ...
  return UNZ_OK if there is no problem. */
extern i32 CLASS_DECL_AURA unzGetGlobalInfo (unzFile file,
...
/*
  ...
  return UNZ_OK if there is no problem.
*/
extern i32 CLASS_DECL_AURA unzGetCurrentFileInfo (
unzFile file,
unz_file_info *pfile_info,
char *szFileName,
uptr fileNameBufferSize,
...
/*
  ...
  return UNZ_OK if there is no problem
*/
extern i32 CLASS_DECL_AURA unzGoToFirstFile (unzFile file)
{
   i32 err=UNZ_OK;
   unz_s* s;
   if (file==nullptr)
...
*/
extern i32 CLASS_DECL_AURA unzGoToNextFile (unzFile file)
{
   unz_s* s;
   i32 err;
...
*/
extern i32 CLASS_DECL_AURA unzLocateFile (
unzFile file,
...
*/
extern i32 CLASS_DECL_AURA unzOpenCurrentFile3 (unzFile file, i32 * method, i32 * level, i32 raw, const char * password)
{
   i32 err=UNZ_OK;
   u32 iSizeVar;
   unz_s* s;
...
extern i32 CLASS_DECL_AURA unzOpenCurrentFile (
unzFile file)
{
   return unzOpenCurrentFile3(file, nullptr, nullptr, 0, nullptr);
}

extern i32 CLASS_DECL_AURA unzOpenCurrentFilePassword (
unzFile file,
const char* password)
{
...
extern i32 CLASS_DECL_AURA unzOpenCurrentFile2 (
unzFile file,
i32* method,
i32* level,
i32 raw)
...
*/
extern i32 CLASS_DECL_AURA unzReadCurrentFile  (
unzFile file,
voidp buf,
u32 len)
{
...
*/
extern iptr CLASS_DECL_AURA unztell (
unzFile file)
{
   unz_s* s;
   file_in_zip_read_info_s* pfile_in_zip_read_info;
...
*/
extern i32 CLASS_DECL_AURA unzeof (
unzFile file)
{
   unz_s* s;
   file_in_zip_read_info_s* pfile_in_zip_read_info;
...
/*
  ...
  the return value is the number of bytes copied in buf, or (if <0)
    the error code
*/
extern i32 CLASS_DECL_AURA unzGetLocalExtrafield (
unzFile file,
voidp buf,
u32 len)
{
...
*/
extern i32 CLASS_DECL_AURA unzCloseCurrentFile (
unzFile file)
{
   i32 err=UNZ_OK;
...
*/
extern i32 CLASS_DECL_AURA unzGetGlobalComment (
unzFile file,
char *szComment,
uptr uSizeBuf)
{
