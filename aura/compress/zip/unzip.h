...
extern i32 CLASS_DECL_AURA unzStringFileNameCompare OF ((const char* fileName1,
...
extern i32 CLASS_DECL_AURA unzClose OF((unzFile file));
/*
...
extern i32 CLASS_DECL_AURA unzGetGlobalInfo OF((unzFile file,
...
extern i32 CLASS_DECL_AURA unzGetGlobalComment OF((unzFile file,
      char *szComment,
      uptr uSizeBuf));
/*
...
extern i32 CLASS_DECL_AURA unzGoToFirstFile OF((unzFile file));
/*
  set the current file of the zipfile to the first spfile->
  return UNZ_OK if there is no problem
*/

extern i32 CLASS_DECL_AURA unzGoToNextFile OF((unzFile file));
/*
...
extern i32 CLASS_DECL_AURA unzLocateFile OF((unzFile file,
...
extern i32 CLASS_DECL_AURA unzGetFilePos(
unzFile file,
unz_file_pos* file_pos);

extern i32 CLASS_DECL_AURA unzGoToFilePos(
unzFile file,
unz_file_pos* file_pos);

/* ****************************************** */

extern i32 CLASS_DECL_AURA unzGetCurrentFileInfo OF((unzFile file,
...
extern i32 CLASS_DECL_AURA unzOpenCurrentFile OF((unzFile file));
/*
  open for reading data the current file in the zipfile.
  If there is no error, the return value is UNZ_OK.
*/

extern i32 CLASS_DECL_AURA unzOpenCurrentFilePassword OF((unzFile file,
      const char* password));
/*
  open for reading data the current file in the zipfile.
...
extern i32 CLASS_DECL_AURA unzOpenCurrentFile2 OF((unzFile file,
      i32* method,
      i32* level,
      i32 raw));
/*
...
extern i32 CLASS_DECL_AURA unzOpenCurrentFile3 OF((unzFile file,
      i32* method,
      i32* level,
      i32 raw,
      const char* password));
...
extern i32 CLASS_DECL_AURA unzCloseCurrentFile OF((unzFile file));
/*
  close the file in zip opened with unzOpenCurrentFile
  Return UNZ_CRCERROR if all the file was read but the CRC is not good
*/

extern i32 CLASS_DECL_AURA unzReadCurrentFile OF((unzFile file,
      voidp buf,
      u32 len));
/*
...
extern iptr CLASS_DECL_AURA unztell OF((unzFile file));
/*
  Give the current position in uncompressed data
*/

extern i32 CLASS_DECL_AURA unzeof OF((unzFile file));
/*
  return 1 if the end of file was reached, 0 elsewhere
*/

extern i32 CLASS_DECL_AURA unzGetLocalExtrafield OF((unzFile file,
      voidp buf,
      u32 len));
/*
