...
//{
//
//   return pcontext->file().output(get_application(), pfileOut, p, pfnOuput, pfileIn);
//
//}
...
//   return pcontext->file().output(get_application(), pathOut, p, pfnOuput, pfileIn);
...
//   return pcontext->file().output(get_application(), pathOut, point, pfnOuput, istream);
...
//   return pcontext->file().output(get_application(), pfileOut, point, pfnOuput, pathIn);
...
//   return pcontext->file().output(get_application(), os, p, pfnOuput, pathIn);
...
//   return pcontext->file().output(get_application(), os, p, pfnOuput, pfileIn);
...
//   return pcontext->file().output(get_application(), os, point, pfnOuput, istream);
