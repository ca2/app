...
CLASS_DECL_AURA string solve_relative(const string & strParam, bool * pbUrl)
{
...
CLASS_DECL_AURA bool solve_relative_inline(string & str, bool & bUrl, bool & bOnlyNativeFileSep, strsize * iaSlash, int * piSlashCount)
{
...
CLASS_DECL_AURA bool file_append_wait_dup(const string & strFile, const char * psz, strsize s, DWORD tickTimeout)
{
