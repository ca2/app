...
public:
   ...
   virtual void write_object(const ::id & id, const ::id & idFactory, ::context_object * pobject)
   {
      exchange("id", idFactory);
      exchange("", pobject);
   }

   virtual __pointer(::context_object) read_object(const ::id & id)
   {
      ::id idFactory;
      exchange("id", idFactory);
      auto pobject = __id_create<::context_object>(idFactory);
      exchange("", pobject);
      return pobject;
   }
...
public:
   ...
   virtual void write_object(const ::id & id, const ::id & idFactory, ::context_object * pobject) override
   {
          ...
          exchange(value) read / write value
       {
          ...
          stream
           ...
           write(u64) m_pfile->write(u64)
              ...
              stream & operator >> (stream & stream, context_object & o)
           {
           ...
           stream & operator >> (stream & s, context_object & o)
           {
