...
//CLASS_DECL_AURA memory file_as_memory(const char * path);
//CLASS_DECL_AURA memsize file_as_memory(const char * path, void * p, memsize s);
//CLASS_DECL_AURA string file_as_string(const char * path);
...
///CLASS_DECL_AURA string solve_relative(const string & str);
//CLASS_DECL_AURA string defer_solve_relative(const char * pszRelative, const char * pszAbsolute);
