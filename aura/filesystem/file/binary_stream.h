...
class CLASS_DECL_AURA binary_stream :
...
//   string fileName() { return GetFilePath(); }
   ...
   virtual void write(const generic_object * pobject) override;
   virtual void write(const generic_object& object) override;
   ...
   virtual void read(generic_object& object) override;
   ...
   //virtual void write_file(const ::file::path & path, const ::generic_object & object);
   //virtual void read_file(const ::file::path & path, ::generic_object & object);

   //virtual void write_link(const string & strLink, __pointer(::generic_object) & object);
   //virtual void read_link(const string & strLink, __pointer(::generic_object) & object);

   virtual void write_link(const ::generic_object * preference, const string & strLink, bool bReadOnly, ::object * pobjectSaveOptions = nullptr);

   virtual bool write_link(const ::generic_object * preference) override;
   virtual void read_link(::generic_object * preference) override;


   virtual bool get_object_link(const ::generic_object * preference, string & strLink, bool & bReadOnly) override;
   virtual void set_object_link(const ::generic_object * preference, const string & strLink, bool bReadOnly) override;
   ...
   virtual __pointer(::generic_object) create_object_from_text(string strText) override;
