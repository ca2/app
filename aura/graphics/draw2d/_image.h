...
//
//   virtual bool gradient_fill(color32_t clr1, color32_t clr2, const point_i32 & point1, const point_i32 & point2)= 0;
...
//
//
//   inline bool fill_rect_dim(i32 x, i32 y, i32 w, i32 h, color32_t cr) { return fill_rectangle(::rectangle_dimension(x, y, w, h), cr); }
//   inline bool fill_rect_dim(i32 x, i32 y, i32 w, i32 h, i32 R, i32 G, i32 B) { return fill_rectangle(::rectangle_dimension(x, y, w, h), R, G, B); }
