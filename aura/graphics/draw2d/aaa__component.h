...
//
//
//CLASS_DECL_AURA void draw_freetype_bitmap(::image * pm_p, i32 greekdeltax, i32 greekdeltay, void * pftbitmap, int x, int y);
//CLASS_DECL_AURA void draw_freetype_bitmap(::image * pm_p, i32 greekdeltax, i32 greekdeltay, void * pftbitmap, int x, int y, byte a, byte rectangle, byte g, byte b);
//
//
//
//#include "brush.h"
