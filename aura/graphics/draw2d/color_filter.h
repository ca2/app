...
public:
   ...
   color_filter(const class ::color_filter & colorfilter) : 
      ...
      m_pcolormatrix(
         colorfilter.m_pcolormatrix ? øraw_new color_matrix(*colorfilter.m_pcolormatrix):nullptr)
   {
   ...
   color_matrix & matrix() { if (!m_pcolormatrix) m_pcolormatrix = øraw_new color_matrix(); return *m_pcolormatrix; }
   ...
   color_filter & operator = (const color_filter & colorfilter)
   {
      ...
      if (colorfilter.m_pcolormatrix)
      {
         ...
         else
         {
            ...
            m_pcolormatrix = øraw_new color_matrix(*colorfilter.m_pcolormatrix);
