...
//      m_puserinteraction = nullptr;
   ...
   ::i32_size graphics::image_source_size(const ::double_size & sizeDst, enum_image_selection eimageselection) const
   {
   ...
   //   return ::i32_point((int)m_pointOrigin.x, (int)m_pointOrigin.y);
   ...
   bool graphics::TextOutAlphaBlend(double x, double y, const ::scoped_string & scopedstr)
   {
      ...
      if (m_pimageAlphaBlend->is_set())
      {
         ...
         ::i32_rectangle rectangleText(i32_point((int)x, (int)y), size);
