...
//{
//
//   return pcontext->m_pcontext->load_image(varFile, bCache, bSync);
//
//}
//
//
...
//   }
//
//   estatus = pcontext->m_pcontext->_load_image(pimage, varFile, bSync, bCreateHelperMaps);
//
...
//   }
//
//   estatus = pcontext->m_pcontext->_load_matter_image(pimage, pszMatter, bSync, bCreateHelperMaps);
//
//   if (!estatus)
//   {
//
...
//   }
//
//   auto estatus = pcontext->m_pcontext->_load_matter_icon(pimage, straMatter, strIcon);
//
//   if (!estatus)
//   {
//
...
//   }
//
//   auto estatus = pcontext->m_pcontext->_load_thumbnail(pimage, varFile, w, h);
//
//   if (!estatus)
//   {
//
...
//   }
//
//   auto estatus = pcontext->m_pcontext->_load_thumbnail(pimage, pszPath);
//
//   if (!estatus)
//   {
//
...
//   }
//
//   auto estatus = pcontext->m_pcontext->_load_dib(pimage, pathDib);
//
//   if (!estatus)
//   {
//
