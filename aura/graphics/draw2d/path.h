...
//      virtual bool harc(const ::point_f64 & point, double w, const ::angle_f64 & angle);
      ...
      //virtual bool add_lines(const ::point_i32 * ppoint, ::collection::count nCount);
      virtual bool add_lines(const ::point_f64 * ppoint, ::collection::count nCount);


      //virtual bool add_polygon(const ::point_i32* ppoint, ::collection::count nCount);
      virtual bool add_polygon(const ::point_f64 * ppoint, ::collection::count nCount);
