               ...
               for (; y < yEnd; y += ySkip)
               {
                  ...
                  for (; x < xEnd; x++)
                  {
                     ...
                     if (src_transparency[x])
                     {
                        if (x1 >= 0)
                        {
                           ::memcpy_dup(&((COLORREF *)pdst3)[x1], &((COLORREF *)psrc3)[x1], (x - x1) * sizeof(COLORREF));
                           x1 = -1;
                        }
                        ...
                        //if (0)
                        {
                           ...
                           if (x == xBoundary8 && x != xBoundary1)
                           {
                              ...
                              while (x + DIB_BLEND_ZERO_BLOCK_SIZE_EIGHTH <= xEnd8
                                     && __memcmp(&(((COLORREF *)psrc3)[x]), craZero, DIB_BLEND_ZERO_BLOCK_SIZE_EIGHTH * 4) == 0)
                              {
                           ...
                           if (x == xBoundary1)
                           {
                              ...
                              while (x + DIB_BLEND_ZERO_BLOCK_SIZE <= xEnd
                                     && __memcmp(&(((COLORREF *)psrc3)[x]), craZero, sizeof(craZero)) == 0)
                              {
