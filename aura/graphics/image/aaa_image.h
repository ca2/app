...
//
//
//CLASS_DECL_AURA void cra_from_quada(colorref_array & colorrefa, WINRGBQUAD * prgbquad, ::i32 iCount);
//
//
//CLASS_DECL_AURA void vertical_swap(pixmap * ppixmap);
//CLASS_DECL_AURA void vertical_swap_copy_image32(::color32_t * pimage32Dst, ::i32 cx, ::i32 cy, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc = -1);
//CLASS_DECL_AURA void vertical_swap_copy_image32_swap_red_blue(::color32_t * pimage32Dst, ::i32 cx, ::i32 cy, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc = -1);
//CLASS_DECL_AURA void copy_image32(::color32_t * pimage32Dst, ::i32 cx, ::i32 cy, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc = -1);
//CLASS_DECL_AURA void copy_image32(::color32_t * pimage32Dst, ::i32 x, ::i32 y, ::i32 cx, ::i32 cy, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc = -1);
//CLASS_DECL_AURA void copy_image32(::color32_t * pimage32Dst, const ::i32_size & size, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc = -1);
//CLASS_DECL_AURA void copy_image32(::color32_t * pimage32Dst, const ::i32_point & point, const ::i32_size & size, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc = -1);
//CLASS_DECL_AURA void copy_image32(::color32_t * pimage32Dst, const ::i32_rectangle & rectangle, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc = -1);
//CLASS_DECL_AURA void copy_image32_swap_red_blue(::color32_t * pimage32Dst, ::i32 cx, ::i32 cy, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc = -1);
//CLASS_DECL_AURA void _001ProperCopyColorref(::color32_t * pimage32Dst, ::i32 cx, ::i32 cy, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc = -1);
//
//
//
//namespace draw2d
...
//   CLASS_DECL_AURA void image_create_image(::image::image *pimage, const ::i32_size & size);
//   CLASS_DECL_AURA ::u32 * image_get_data(::image::image *pimage);
...
//
//
//CLASS_DECL_AURA enum_rotate_flip exif_orientation_rotate_flip(::i32 orientation);
//
//
...
////
////
////   static ::f32 Cosines[360];
////   static ::f32 Sines[360];
...
////   //virtual bool overlay_frame(::i32 iFrame)= 0;
...
////
////
////   //virtual bool load_thumbnail(::payload payloadFile, ::i32 w, ::i32 h)= 0;
////
////
...
////   virtual image load_thumbnail(::payload payloadFile, ::i32 w, ::i32 h) = 0;
...
////
////   virtual bool set_origin(const ::i32_point & point)= 0;
////   virtual bool set_font_factor(::f64 dFactor)= 0;
...
////
////   virtual ::i32_size get_size() const= 0;
////
////
////
////   virtual bool rate_rgb(::i32 iMul, ::i32 iDiv)= 0;
...
////   virtual bool blend(const ::i32_point & pointDst, ::image::image *pimageSrc, const ::i32_point & pointSrc, ::image::image *pimageAlf, const ::i32_point & pointDstAlf, const ::i32_size & size)= 0;
////   virtual bool precision_blend(const ::i32_point & pointDst, ::image::image *pimageAlf, const ::i32_point & pointAlf, const ::i32_size & size)= 0;
////   virtual bool precision_blend(const ::i32_point & pointDst, ::image::image *pimageAlf, const ::i32_point & pointAlf, const ::i32_size & size, ::u8 bA)= 0;
////   virtual bool blend(const ::i32_point & pointDst, ::image::image *pimageAlf, const ::i32_point & pointAlf, const ::i32_size & size)= 0;
////   virtual bool blend(const ::i32_point & pointDst, ::image::image *pimageAlf, const ::i32_point & pointAlf, const ::i32_size & size, ::u8 bA)= 0;
...
////   virtual bool BitBlt(::i32 cxParam, ::i32 cyParam, ::image::image *pimage, ::i32 op)= 0;
...
////
////   virtual bool hue_offset(::f64 dRate)= 0;
////
...
////
////   virtual bool mult_alpha(const ::i32_point & point, const ::i32_size & size)= 0;
////   virtual bool div_alpha(const ::i32_point & point, const ::i32_size & size)= 0;
////
////   virtual bool rotate(::image::image *pimage, const ::i32_rectangle & rectangle, ::f64 dAngle, ::f64 dScale)= 0;
////
////   virtual bool rotate(::image::image *pimage, ::f64 dAngle, ::f64 dScale)= 0;
////   virtual bool rotate(::image::image *pimage, ::f64 dAngle)= 0;
////   virtual bool Rotate034(::image::image *pimage, ::f64 dAngle, ::f64 dScale)= 0;
////
...
////
////
////   virtual bool saturation(::f64 dRate)= 0;
////   virtual bool lightness(::f64 dRate) = 0;
////   virtual bool opacity(::f64 dRate) = 0;
////
////
...
////
////   virtual bool gradient_fill(::color::color clr1, ::color::color clr2, const i32_point & point1, const i32_point & point2)= 0;
////   virtual bool gradient_horizontal_fill(::color::color clr1, ::color::color clr2, ::i32 start, ::i32 end)= 0;
////   virtual bool gradient_vertical_fill(::color::color clr1, ::color::color clr2, ::i32 start, ::i32 end)= 0;
...
////
////   virtual bool create(const ::i32_size & size, ::eobject eobjectCreate = DEFAULT_CREATE_IMAGE_OBJECT_FLAG, ::i32 iGoodStride = -1)= 0;
...
////   virtual bool channel_multiply(::f64 dRate, ::color::enum_channel echannel, bool bIfAlphaIgnorePreDivPosMult = false)= 0;
...
////   virtual bool channel_multiply(::color::enum_channel echannel, ::image::image *pimage, const ::i32_rectangle & rectangle, bool bIfAlphaIgnorePreDivPosMult = false)= 0;
////
////   virtual bool channel_from(::color::enum_channel echannel, ::image::image *pimage, const ::i32_rectangle & rectangle)= 0;
////
...
////
////   virtual bool create_nanosvg(char_pointer pszXml, ::f64 dDpi = 0.0) = 0;
////   virtual bool nanosvg(char_pointer pszXml, ::f64 dDpi = 0.0)= 0;
////
...
////
////   virtual bool lighten(::f64 dRate)= 0;
////
////   virtual bool copy(::image::image *pimage, ::i32 x, ::i32 y)= 0;
////   virtual bool PasteRect(::image::image *pimage, ::i32 x, ::i32 y)= 0;
////
////   virtual bool fill_rectangle(const ::i32_rectangle & rectangle, ::color32_t color32)= 0;
////
////   virtual bool fill_rectangle(const ::i32_rectangle & rectangle, ::i32 R, ::i32 G, ::i32 B)= 0;
////
////
////   virtual bool fill_glass_rect(const ::i32_rectangle & rectangle, ::i32 R, ::i32 G, ::i32 B, ::i32 A)= 0;
////
////   virtual bool fill_stippled_glass_rect(const ::i32_rectangle & rectangle, ::i32 R, ::i32 G, ::i32 B)= 0;
////
////
...
////
////   virtual bool create_frame(const ::i32_size & size, ::i32 iFrameCount)= 0;
...
////
////
////   virtual bool create_circle(::image::image *pimage, ::i32 diameter)= 0;
////   virtual bool create_framed_square(::image::image *pimage, ::i32 inner, ::i32 outer, ::color32_t color32)= 0;
////
////
////   virtual bool invert_rgb(const ::i32_rectangle & rectangle)= 0;
...
////
////
////   inline bool fill_rect_dim(::i32 x, ::i32 y, ::i32 w, ::i32 h, ::color32_t color32) { return fill_rectangle(i32_rectangle_dimension(x, y, w, h), color32); }
////   inline bool fill_rect_dim(::i32 x, ::i32 y, ::i32 w, ::i32 h, ::i32 R, ::i32 G, ::i32 B) { return fill_rectangle(i32_rectangle_dimension(x, y, w, h), R, G, B); }
////   inline bool fill_rect_coord(::i32 x1, ::i32 y1, ::i32 x2, ::i32 y2, ::color32_t color32) { return fill_rectangle(::i32_rectangle(x1, y1, x2, y2), color32); }
////   inline bool fill_rect_coord(::i32 x1, ::i32 y1, ::i32 x2, ::i32 y2, ::i32 R, ::i32 G, ::i32 B) { return fill_rectangle(::i32_rectangle(x1, y1, x2, y2), R, G, B); }
////
////
...
////};
////
//////inline void copy_image32(::color32_t * pimage32Dst, const ::i32_size & size, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc)
////{
////
...
//
//
//inline CLASS_DECL_AURA void copy_image32(::color32_t * pimage32Dst, const ::i32_point & point, const ::i32_size & size, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc)
//{
//
...
//
//
//inline CLASS_DECL_AURA void copy_image32(::color32_t * pimage32Dst, const ::i32_rectangle & rectangle, ::i32 iStrideDst, const ::color32_t * pimage32Src, ::i32 iStrideSrc)
//{
//
