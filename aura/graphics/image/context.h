...
namespace image
{
   ...
   public:
      ...
      virtual ::image::image_pointer create_image_from_data(const ::pixmap_t & pixmap, ::draw2d::domain * pdraw2ddomain, ::enum_flag eflagFlag = DEFAULT_CREATE_IMAGE_FLAG);
      ...
      virtual ::i32 create_image_integer(const ::pixmap_t & pixmap, ::draw2d::domain * pdraw2ddomain);
      ...
      virtual ::image::image_pointer load_thumbnail(const ::payload & payloadFile, ::draw2d::domain * pdraw2ddomain, ::i32 w, ::i32 h);
      ...
      virtual void _load_thumbnail(::image::image *pimage, ::draw2d::domain * pdraw2ddomain, const ::payload & payloadFile, ::i32 w, ::i32 h);
