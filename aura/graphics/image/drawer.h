...
namespace image
{
   ...
   public:
      ...
      //template < prototype_point POINT, ::image::image_source_pointer IMAGE_SOURCE_POINTER >
      ...
      //template < prototype_rectangle RECTANGLE, ::image::image_source_pointer IMAGE_SOURCE_POINTER >
      ...
      //template < prototype_size SIZE, ::image::image_source_pointer IMAGE_SOURCE_POINTER, prototype_point POINT >
      ...
      //template < prototype_rectangle RECTANGLE, ::image::image_source_pointer IMAGE_SOURCE_POINTER, prototype_point POINT >
      ...
      //template < prototype_size SIZE, ::image::image_source_pointer IMAGE_SOURCE_POINTER >
      //inline void draw(const SIZE & sizeDst, IMAGE_SOURCE_POINTER pimagesource, ::image::image_drawing imagedrawing = nullptr)
      //{
      ...
      //template < ::image::image_source_pointer IMAGE_SOURCE_POINTER, prototype_rectangle RECTANGLE >
      ...
      //template < ::image::image_source_pointer IMAGE_SOURCE_POINTER, prototype_size SIZE_SRC >
      ...
      //template < prototype_size SIZE, ::image::image_source_pointer IMAGE_SOURCE_POINTER, prototype_rectangle RECTANGLE >
      ...
      //template < prototype_rectangle RECTANGLE_DST, ::image::image_source_pointer IMAGE_SOURCE_POINTER, prototype_rectangle RECTANGLE_SRC >
      ...
      //template < prototype_size SIZE_DST, ::image::image_source_pointer IMAGE_SOURCE_POINTER, prototype_size SIZE_SRC >
