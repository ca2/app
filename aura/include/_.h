...
CLASS_DECL_AURA ::generic_object * general_trace_object();
...
CLASS_DECL_AURA void __tracea(::generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, int iLine, const char * psz);
CLASS_DECL_AURA void __tracef(::generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, int iLine, const char * psz, ...);
CLASS_DECL_AURA void __tracev(::generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, int iLine, const char * psz, va_list vargs);
CLASS_DECL_AURA const char * trace_category_name(e_trace_category ecategory);


CLASS_DECL_AURA ::generic_object * trace_object(e_trace_category ecategory);
...
extern "C"
CLASS_DECL_AURA void register_aura_library(const char * psz, ::aura::library * plibrary);
...
::aura::library * X##_new_aura_library()
