...
namespace android
{
   ...
   public:
      ...
      virtual bool create_window_ex(::user::interaction * pinteraction, __pointer(::user::system_struct) pusersystem, ::user::primitive * puiParent = nullptr, ::id id = ::id()) override;
