...
- (id) initWithFrame: (NSRect) frame andAuraWindow: (AuraWindow *) roundwindow
{
...
//  // {
//      
//      //      m_paurawindow->round_window_on_become_first_responder();
//      
//    //  return YES;
//      
//  // }
...
//   ansi_concatenate(sz, "\n");
//   ansi_concatenate(sz, "-----------------------------------------------------------------------------\n");
//   sprintf(szFormat, "AuraWindowFrameView::keyDown : %s\n", [characters UTF8String]);
...
//   ansi_concatenate(sz, "\n");
//   ansi_concatenate(sz, "-----------------------------------------------------------------------------\n");
//   sprintf(szFormat, "AuraWindowFrameView::keyUp : %s\n", [characters UTF8String]);
//   ansi_concatenate(sz, szFormat);
//   ansi_concatenate(sz, "-----------------------------------------------------------------------------\n");
//   ansi_concatenate(sz, "\n");
//   ansi_concatenate(sz, "\n");
