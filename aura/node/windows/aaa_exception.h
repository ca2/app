...
namespace aura
{
   ...
   NOINLINE DECLSPEC_NO_RETURN inline void WINAPI gen_ThrowLastWin32(::layered * pobjectContext)
   {
   ...
   // Throw a atl_exception corresponding to the result of ::get_last_error
   NOINLINE inline void WINAPI gen_ThrowLastWin32(::layered * pobjectContext)
   {
      DWORD dwError = ::get_last_error();
      __throw(hresult_exception(HRESULT_FROM_WIN32( dwError ) ));
   }
