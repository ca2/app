...
/* ::aura::get_system() Information Class 0x00 */
...
/* ::aura::get_system() Information Class 0x01 */
...
/* ::aura::get_system() Information Class 0x02 */
...
/* ::aura::get_system() Information Class 0x03 */
...
/* ::aura::get_system() Information Class 0x08 */
...
/* ::aura::get_system() Information Class 0x0b */
...
/* ::aura::get_system() Information Class 0x10 */
...
/* ::aura::get_system() Information Class 0x15 */
...
/* ::aura::get_system() Information Class 0x17 */
...
/* ::aura::get_system() Information Class 0x05 */
...
/* Characteristics of a File ::aura::get_system() */
...
CLASS_DECL_AURA NTSTATUS WINAPI LdrGetDllHandle(const widechar *, WINULONG, const UNICODE_STRING*, HMODULE*);
...
CLASS_DECL_AURA NTSTATUS WINAPI LdrLoadDll(const widechar *, ::u32, const UNICODE_STRING*, HMODULE*);
...
CLASS_DECL_AURA NTSTATUS WINAPI LdrQueryImageFileExecutionOptions(const UNICODE_STRING*, const widechar *, WINULONG, void*, WINULONG, WINULONG*);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlAppendUnicodeToString(UNICODE_STRING *, const widechar *);
...
CLASS_DECL_AURA int_bool WINAPI RtlCreateUnicodeString(PUNICODE_STRING, const widechar *);
...
CLASS_DECL_AURA int_bool WINAPI RtlDoesFileExists_U(const widechar *);
CLASS_DECL_AURA int_bool WINAPI RtlDosPathNameToNtPathName_U(PCWSTR, PUNICODE_STRING, PWSTR*, CURDIR*);
CLASS_DECL_AURA WINULONG WINAPI RtlDosSearchPath_U(const widechar *, const widechar *, const widechar *, WINULONG, LPWSTR, LPWSTR*);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlUnicodeToMultiByteN(char *, ::u32, LPDWORD, const widechar *, ::u32);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUnicodeToMultiByteSize(PWINULONG, PCWSTR, WINULONG);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUnicodeToOemN(char *, ::u32, LPDWORD, const widechar *, ::u32);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeToMultiByteN(char *, ::u32, LPDWORD, const widechar *, ::u32);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeToOemN(char *, ::u32, LPDWORD, const widechar *, ::u32);
