...
/* ::auraacmesystem() Information Class 0x00 */
...
/* ::auraacmesystem() Information Class 0x01 */
...
/* ::auraacmesystem() Information Class 0x02 */
...
/* ::auraacmesystem() Information Class 0x03 */
...
/* ::auraacmesystem() Information Class 0x08 */
...
/* ::auraacmesystem() Information Class 0x0b */
...
/* ::auraacmesystem() Information Class 0x10 */
...
/* ::auraacmesystem() Information Class 0x15 */
...
/* ::auraacmesystem() Information Class 0x17 */
...
/* ::auraacmesystem() Information Class 0x05 */
...
/* Characteristics of a File ::auraacmesystem() */
...
CLASS_DECL_AURA NTSTATUS WINAPIV DbgPrint(const ::string & fmt, ...);
CLASS_DECL_AURA NTSTATUS WINAPIV DbgPrintEx(WINULONG iComponentId, WINULONG Level, const ::string & fmt, ...);
...
CLASS_DECL_AURA NTSTATUS WINAPI LdrGetDllHandle(const ::wide_character *, WINULONG, const UNICODE_STRING*, HMODULE*);
...
CLASS_DECL_AURA NTSTATUS WINAPI LdrLoadDll(const ::wide_character *, ::u32, const UNICODE_STRING*, HMODULE*);
...
CLASS_DECL_AURA NTSTATUS WINAPI LdrQueryImageFileExecutionOptions(const UNICODE_STRING*, const ::wide_character *, WINULONG, void*, WINULONG, WINULONG*);
...
//    CLASS_DECL_AURA NTSTATUS WINAPI NtAdjustPrivilegesToken(HANDLE, int_bool, PTOKEN_PRIVILEGES, ::u32, PTOKEN_PRIVILEGES, PDWORD);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtCreateSemaphore(PHANDLE, ACCESS_MASK, const OBJECT_ATTRIBUTES*, ::i32, ::i32);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtEnumerateKey(HANDLE, WINULONG, KEY_INFORMATION_CLASS, void *, ::u32, ::u32 *);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtFlushInstructionCache(HANDLE, const void *, SIZE_T);
CLASS_DECL_AURA NTSTATUS WINAPI NtFlushKey(HANDLE);
CLASS_DECL_AURA NTSTATUS WINAPI NtFlushVirtualMemory(HANDLE, const void **, SIZE_T*, WINULONG);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtMapimpactOfSection(HANDLE, HANDLE, PVOID*, WINULONG, SIZE_T, const LARGE_INTEGER*, SIZE_T*, SECTION_INHERIT, WINULONG, WINULONG);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtOpenProcessToken(HANDLE, ::u32, HANDLE *);
CLASS_DECL_AURA NTSTATUS WINAPI NtOpenProcessTokenEx(HANDLE, ::u32, ::u32, HANDLE *);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtOpenThreadToken(HANDLE, ::u32, int_bool, HANDLE *);
CLASS_DECL_AURA NTSTATUS WINAPI NtOpenThreadTokenEx(HANDLE, ::u32, int_bool, ::u32, HANDLE *);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtQueryInformationFile(HANDLE, PIO_STATUS_BLOCK, PVOID, ::i32, FILE_INFORMATION_CLASS);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtQueryKey(HANDLE, KEY_INFORMATION_CLASS, void *, ::u32, ::u32 *);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtQueryValueKey(HANDLE, const UNICODE_STRING *, KEY_VALUE_INFORMATION_CLASS, void *, ::u32, ::u32 *);
CLASS_DECL_AURA NTSTATUS WINAPI NtQueryVirtualMemory(HANDLE, const void *, MEMORY_INFORMATION_CLASS, PVOID, SIZE_T, SIZE_T*);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtSetInformationKey(HANDLE, const i32, PVOID, WINULONG);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtSetInformationThread(HANDLE, THREADINFOCLASS, const void *, WINULONG);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtTerminateProcess(HANDLE, ::i32);
CLASS_DECL_AURA NTSTATUS WINAPI NtTerminateThread(HANDLE, ::i32);
...
CLASS_DECL_AURA NTSTATUS WINAPI NtUnmapimpactOfSection(HANDLE, PVOID);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAccessAllowedAceEx(PACL, ::u32, ::u32, ::u32, PSID);
CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAccessDeniedAce(PACL, ::u32, ::u32, PSID);
CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAccessDeniedAceEx(PACL, ::u32, ::u32, ::u32, PSID);
CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAtomToAtomTable(RTL_ATOM_TABLE, const WCHAR*, RTL_ATOM*);
CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAuditAccessAce(PACL, ::u32, ::u32, PSID, int_bool, int_bool);
CLASS_DECL_AURA NTSTATUS WINAPI RtlAddAuditAccessAceEx(PACL, ::u32, ::u32, ::u32, PSID, int_bool, int_bool);
...
CLASS_DECL_AURA ::u32 WINAPI RtlAnsiStringToUnicodeSize(const STRING *);
CLASS_DECL_AURA NTSTATUS WINAPI RtlAnsiStringToUnicodeString(PUNICODE_STRING, PCANSI_STRING, int_bool);
CLASS_DECL_AURA NTSTATUS WINAPI RtlAppendAsciizToString(STRING *, const ::string &);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlAppendUnicodeToString(UNICODE_STRING *, const ::wide_character *);
...
CLASS_DECL_AURA int_bool WINAPI RtlCopySid(::u32, PSID, PSID);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlCreateAcl(PACL, ::u32, ::u32);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlCreateSecurityDescriptor(PSECURITY_DESCRIPTOR, ::u32);
CLASS_DECL_AURA NTSTATUS WINAPI RtlCreateTimerQueue(PHANDLE);
CLASS_DECL_AURA NTSTATUS WINAPI RtlCreateTimer(PHANDLE, HANDLE, RTL_WAITORTIMERCALLBACKFUNC, PVOID, ::u32, ::u32, WINULONG);
CLASS_DECL_AURA int_bool WINAPI RtlCreateUnicodeString(PUNICODE_STRING, const ::wide_character *);
CLASS_DECL_AURA int_bool WINAPI RtlCreateUnicodeStringFromAsciiz(PUNICODE_STRING, const ::string &);
...
CLASS_DECL_AURA void WINAPI RtlDeactivateActivationContext(::u32, ULONG_PTR);
CLASS_DECL_AURA NTSTATUS WINAPI RtlDecompressBuffer(WINUSHORT, PWINUCHAR, WINULONG, PWINUCHAR, WINULONG, PWINULONG);
CLASS_DECL_AURA NTSTATUS WINAPI RtlDeleteAce(PACL, ::u32);
...
CLASS_DECL_AURA int_bool WINAPI RtlDoesFileExists_U(const ::wide_character *);
CLASS_DECL_AURA int_bool WINAPI RtlDosPathNameToNtPathName_U(PCWSTR, PUNICODE_STRING, PWSTR*, CURDIR*);
CLASS_DECL_AURA WINULONG WINAPI RtlDosSearchPath_U(const ::wide_character *, const ::wide_character *, const ::wide_character *, WINULONG, LPWSTR, LPWSTR*);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlDuplicateUnicodeString(i32, const UNICODE_STRING*, UNICODE_STRING*);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlFindCharInUnicodeString(i32, const UNICODE_STRING*, const UNICODE_STRING*, WINUSHORT*);
...
CLASS_DECL_AURA ::u32 WINAPI RtlFreeSid(PSID);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlGetAce(PACL, ::u32, LPVOID *);
...
CLASS_DECL_AURA ::u32 WINAPI RtlGetLastWin32Error(void);
CLASS_DECL_AURA ::u32 WINAPI RtlGetLongestNtPathLength(void);
...
CLASS_DECL_AURA ::u32 WINAPI RtlGetThreadErrorMode(void);
...
CLASS_DECL_AURA PVOID WINAPI RtlImageDirectoryEntryToData(HMODULE, int_bool, ::u16, WINULONG *);
CLASS_DECL_AURA PIMAGE_NT_HEADERS WINAPI RtlImageNtHeader(HMODULE);
CLASS_DECL_AURA PIMAGE_SECTION_HEADER WINAPI RtlImageRvaToSection(const IMAGE_NT_HEADERS *, HMODULE, ::u32);
CLASS_DECL_AURA PVOID WINAPI RtlImageRvaToVa(const IMAGE_NT_HEADERS *, HMODULE, ::u32, IMAGE_SECTION_HEADER **);
...
CLASS_DECL_AURA int_bool WINAPI RtlIsTextUnicode(const void *, ::i32, ::i32 *);
...
CLASS_DECL_AURA ::u32 WINAPI RtlLengthRequiredSid(::u32);
CLASS_DECL_AURA WINULONG WINAPI RtlLengthSecurityDescriptor(PSECURITY_DESCRIPTOR);
CLASS_DECL_AURA ::u32 WINAPI RtlLengthSid(PSID);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlMultiByteToUnicodeN(LPWSTR, ::u32, LPDWORD, const ::string &, ::u32);
CLASS_DECL_AURA NTSTATUS WINAPI RtlMultiByteToUnicodeSize(::u32*, const ::string &, ::u32);
...
CLASS_DECL_AURA ::u32 WINAPI RtlOemStringToUnicodeSize(const STRING*);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlQueryInformationAcl(PACL, LPVOID, ::u32, ACL_INFORMATION_CLASS);
...
CLASS_DECL_AURA void WINAPI RtlRestoreLastWin32Error(::u32);
CLASS_DECL_AURA void WINAPI RtlSecondsSince1970ToTime(::u32, LARGE_INTEGER *);
CLASS_DECL_AURA void WINAPI RtlSecondsSince1980ToTime(::u32, LARGE_INTEGER *);
...
CLASS_DECL_AURA void WINAPI RtlSetLastWin32Error(::u32);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlSetThreadErrorMode(::u32, LPDWORD);
...
CLASS_DECL_AURA ::u32 WINAPI RtlUnicodeStringToAnsiSize(const UNICODE_STRING*);
...
CLASS_DECL_AURA ::u32 WINAPI RtlUnicodeStringToOemSize(const UNICODE_STRING*);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUnicodeStringToOemString(POEM_STRING, PCUNICODE_STRING, int_bool);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUnicodeToMultiByteN(char *, ::u32, LPDWORD, const ::wide_character *, ::u32);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUnicodeToMultiByteSize(PWINULONG, PCWSTR, WINULONG);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUnicodeToOemN(char *, ::u32, LPDWORD, const ::wide_character *, ::u32);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeToMultiByteN(char *, ::u32, LPDWORD, const ::wide_character *, ::u32);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeToOemN(char *, ::u32, LPDWORD, const ::wide_character *, ::u32);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUpdateTimer(HANDLE, HANDLE, ::u32, ::u32);
...
CLASS_DECL_AURA int_bool WINAPI RtlValidateHeap(HANDLE, WINULONG, const void *);
CLASS_DECL_AURA NTSTATUS WINAPI RtlVerifyVersionInfo(const RTL_OSVERSIONINFOEXW*, ::u32, DWORDLONG);
...
//CLASS_DECL_AURA  NTSTATUS  WINAPI vDbgPrintEx(WINULONG,WINULONG, const ::string &,__ms_va_list);
//CLASS_DECL_AURA  NTSTATUS  WINAPI vDbgPrintExWithPrefix(const ::string &,WINULONG,WINULONG, const ::string &,__ms_va_list);

/* 32-bit only functions */

#ifndef _WIN64
CLASS_DECL_AURA ::i64 WINAPI RtlConvertLongToLargeInteger(::i32);
CLASS_DECL_AURA ULONGLONG WINAPI RtlConvertUlongToLargeInteger(WINULONG);
CLASS_DECL_AURA ::i64 WINAPI RtlEnlargedIntegerMultiply(::i32, ::i32);
CLASS_DECL_AURA ULONGLONG WINAPI RtlEnlargedUnsignedMultiply(::u32, ::u32);
CLASS_DECL_AURA ::u32 WINAPI RtlEnlargedUnsignedDivide(ULONGLONG, ::u32, ::u32 *);
CLASS_DECL_AURA ::i64 WINAPI RtlExtendedMagicDivide(::i64, ::i64, ::i32);
CLASS_DECL_AURA ::i64 WINAPI RtlExtendedIntegerMultiply(::i64, ::i32);
CLASS_DECL_AURA ::i64 WINAPI RtlExtendedLargeIntegerDivide(::i64, ::i32, ::i32 *);
CLASS_DECL_AURA ::i64 WINAPI RtlLargeIntegerAdd(::i64, ::i64);
CLASS_DECL_AURA ::i64 WINAPI RtlLargeIntegerArithmeticShift(::i64, ::i32);
CLASS_DECL_AURA ULONGLONG WINAPI RtlLargeIntegerDivide(ULONGLONG, ULONGLONG, ULONGLONG *);
CLASS_DECL_AURA ::i64 WINAPI RtlLargeIntegerNegate(::i64);
CLASS_DECL_AURA ::i64 WINAPI RtlLargeIntegerShiftLeft(::i64, ::i32);
CLASS_DECL_AURA ::i64 WINAPI RtlLargeIntegerShiftRight(::i64, ::i32);
CLASS_DECL_AURA ::i64 WINAPI RtlLargeIntegerSubtract(::i64, ::i64);
