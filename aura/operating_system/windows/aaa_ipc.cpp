...
namespace aura
{
   ...
   namespace ipc
   {
      ...
      LRESULT CALLBACK s_rx_message_queue_proc(oswindow oswindow,const ::atom & atom,wparam wparam,lparam lparam);
      ...
      bool rx::create(const ::string & pszKey)
      {
         ...
         //auto pappcore = ::aura::get_system()->m_pappcore;

         //auto pmaindata = pappcore->m_pmaindata;

         HINSTANCE hinstance = ::aura::get_system()->m_hinstance;
