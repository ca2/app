...
//
//
//CLASS_DECL_AURA htask_t get_current_htask()
//{
//
...
//
//
////CLASS_DECL_AURA pDWORD get_current_itask()
////{
////
...
////
////
////CLASS_DECL_AURA HANDLE get_main_user_htask()
////{
...
////}
////
////CLASS_DECL_AURA htask_t  WINAPI get_thread_handle(::u32 dw)
////{
////
////   synchronous_lock mlThreadIdHandle(g_pmutexThreadIdHandleLock);
////
