...
//
//
//   void * system::operating_system_library_touch(const ::string & pszPath, string & strMessage)
//   {
//
...
//
//
//   void * system::operating_system_library_open(const ::string & pszPath, string & strMessage)
//   {
//
...
//
//
//void * system::operating_system_library_open_ca2(const ::string & pszPath, string & strMessage)
//{
//
//   string strPath(pszPath);
//
