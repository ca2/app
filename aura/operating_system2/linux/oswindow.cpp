...
void oswindow_data::set_wm_class(const ::string & psz)
{
...
bool oswindow_data::bamf_set_icon(::apex::application * papp)
{
...
Atom oswindow_data::intern_atom(const ::string & pszAtomName, bool bCreate)
{
...
bool oswindow_data::_set_window_pos(class ::zorder zorder, i32 x, i32 y, i32 cx, i32 cy, ::u32 nFlags)
{
   ...
   if(bMove)
   {
      ...
      if(bSize)
      {
         ...
         FORMATTED_  FORMATTED_INFORMATION("XMoveResizeWindow (%d, %d) - (%d, %d)", x, y, cx, cy);
