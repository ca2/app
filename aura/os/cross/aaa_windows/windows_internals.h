...
CLASS_DECL_AURA NTSTATUS WINAPI LdrLoadDll(LPCWSTR, ::u32, const UNICODE_STRING*, HMODULE*);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlUnicodeToMultiByteN(char *, ::u32, LPDWORD, LPCWSTR, ::u32);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUnicodeToMultiByteSize(PWINULONG, PCWSTR, WINULONG);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUnicodeToOemN(char *, ::u32, LPDWORD, LPCWSTR, ::u32);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeToMultiByteN(char *, ::u32, LPDWORD, LPCWSTR, ::u32);
CLASS_DECL_AURA NTSTATUS WINAPI RtlUpcaseUnicodeToOemN(char *, ::u32, LPDWORD, LPCWSTR, ::u32);
