...
CLASS_DECL_AURA NTSTATUS WINAPIV DbgPrint(const char * fmt, ...);
CLASS_DECL_AURA NTSTATUS WINAPIV DbgPrintEx(WINULONG iComponentId, WINULONG Level, const char * fmt, ...);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlAppendAsciizToString(STRING *, const char *);
...
CLASS_DECL_AURA int_bool WINAPI RtlCreateUnicodeStringFromAsciiz(PUNICODE_STRING, const char *);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlMultiByteToUnicodeN(LPWSTR, ::u32, LPDWORD, const char *, ::u32);
CLASS_DECL_AURA NTSTATUS WINAPI RtlMultiByteToUnicodeSize(::u32*, const char *, ::u32);
...
CLASS_DECL_AURA NTSTATUS WINAPI RtlOemToUnicodeN(LPWSTR, ::u32, LPDWORD, const char *, ::u32);
...
//CLASS_DECL_AURA  NTSTATUS  WINAPI vDbgPrintEx(WINULONG,WINULONG,const char *,__ms_va_list);
//CLASS_DECL_AURA  NTSTATUS  WINAPI vDbgPrintExWithPrefix(const char *,WINULONG,WINULONG,const char *,__ms_va_list);
