...
CLASS_DECL_AURA ::u32 WINAPI RtlComputeCrc32(::u32, const byte*, INT);
...
CLASS_DECL_AURA int_bool WINAPI RtlIsTextUnicode(const void *, INT, INT *);
...
CLASS_DECL_AURA ::i64 WINAPI RtlEnlargedIntegerMultiply(INT, INT);
...
CLASS_DECL_AURA ::i64 WINAPI RtlExtendedMagicDivide(::i64, ::i64, INT);
CLASS_DECL_AURA ::i64 WINAPI RtlExtendedIntegerMultiply(::i64, INT);
CLASS_DECL_AURA ::i64 WINAPI RtlExtendedLargeIntegerDivide(::i64, INT, INT *);
CLASS_DECL_AURA ::i64 WINAPI RtlLargeIntegerAdd(::i64, ::i64);
CLASS_DECL_AURA ::i64 WINAPI RtlLargeIntegerArithmeticShift(::i64, INT);
...
CLASS_DECL_AURA ::i64 WINAPI RtlLargeIntegerShiftLeft(::i64, INT);
CLASS_DECL_AURA ::i64 WINAPI RtlLargeIntegerShiftRight(::i64, INT);
