...
public:
   ...
   virtual bool os_resolve_alias(::file::path & path, const ::string & psz, ::user::prototype * pinteraction, bool bNoUI = false, bool bNoMount = false);

   //CLASS_DECL_AURA bool os_is_folder_alias(::particle * pparticle, const ::string & psz, bool bNoUI = false, bool bNoMount = false);

   virtual bool _os_resolve_alias(::file::path & path, const ::string & psz, ::user::prototype * pinteraction, bool bNoUI, bool bNoMount);
