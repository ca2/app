...
::collection::count regex::matches(string_array_base& stra, const ::scoped_string & scopedstr)
{
...
//index regex::match(string_array_base & stra, const ::scoped_string & scopedstrParam, character_count iSize)
//{
//
//   stra.erase_all();
//
