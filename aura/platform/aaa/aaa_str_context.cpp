...
//#endif
//
//      auto strMain = pcontext->m_pcontext->dir().install() / "app/_appmatter/main";
//
//      if (!load(strMain))
//      {
//
...
//      {
//
//         //pcontext->m_pcontext->defer_ok(this);
//
//         if(pcontext->m_pcontext->m_pschema != nullptr)
//         {
//
//            str = (*pcontext->m_pcontext->m_pschema)[id];
//            if(str.has_char())
//               return str;
//
//         }
//
//         if(pcontext->m_pcontext->m_pschemaLocale != nullptr)
//         {
//            str = (*pcontext->m_pcontext->m_pschemaLocale)[id];
//            if(str.has_char())
//               return str;
//         }
//
//         for(i32 i = 0; i < pcontext->m_pcontext->m_schemaptra.get_count(); i++)
//         {
//
//            str = (*pcontext->m_pcontext->m_schemaptra[i])[id];
//            if(str.has_char())
//               return str;
//
//         }
//
//      }
//      if(pcontext != nullptr && pcontext->m_pcontext->m_pschemaSchemaEn != nullptr)
//      {
//         str = (*pcontext->m_pcontext->m_pschemaSchemaEn)[id];// lang=pszStyle style=en
//         if(str.has_char())
//            return str;
//      }
...
//      if(str.has_char())
//         return str;
//      if(pcontext != nullptr && pcontext->m_pcontext->m_pschemaSchemaStd != nullptr)
//      {
//         str = (*pcontext->m_pcontext->m_pschemaSchemaStd)[id];// lang=pszStyle style=en
//         if(str.has_char())
//            return str;
//      }
//
...
//      memory mem;
//
//      pcontext->m_pcontext->file().as_memory(pszFilePath,mem);
//
//
//      strsize len;
//
