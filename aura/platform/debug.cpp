...
void system_call_update_wallpaper_changed()
{
   ...
   ::aura::system::g_p->call_update(id_wallpaper_changed);
...
void system_call_update_app_activated()
{
   ...
   ::aura::system::g_p->call_update(id_app_activated);
...
void system_call_update_app_changed_occlusion_state()
{
   ...
   ::aura::system::g_p->call_update(id_app_changed_occlusion_state);
