...
//      virtual ::collection::index get_main_monitor(::i32_rectangle * prectangle = nullptr) override;
      ...
      ::particle * defer_initialize_host_window(const ::i32_rectangle * lprect = nullptr) override;
      ...
      //bool is_mouse_button_pressed(const ::user::keyboard_state & keyboardstate) override;
