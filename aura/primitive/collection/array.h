...
public:
   ...
   explicit array(::object * pobjectContext = nullptr, ::count nGrowBy = 0);
...
public:
   ...
   nodefctr_array(::aura::application * papp = nullptr, ::count nGrowBy = 32) : array < TYPE, ARG_TYPE, ::constructor::nodef < TYPE > > (papp, nGrowBy) {}
