...
typedef CLASS_DECL_AURA string_array_base < string > string_array;
typedef CLASS_DECL_AURA string_array_base < wstring > wstring_array;
...
CLASS_DECL_AURA bool next_csv(string & str, const string_array & stra);
CLASS_DECL_AURA void add_csv(string_array & stra, const string & str);
...
namespace stra
{
   ...
   inline CLASS_DECL_AURA string_array from_strdup(ansichar ** ppParam)
   {
