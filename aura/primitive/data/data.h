...
typedef CLASS_DECL_AURA __pointer_array(::generic_object) object_array;
...
namespace data
{
   ...
   typedef CLASS_DECL_AURA __pointer_array(listener) listener_array;
   typedef CLASS_DECL_AURA id_map < __pointer(data) > data_map;
