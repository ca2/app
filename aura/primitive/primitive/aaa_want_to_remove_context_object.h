...
struct CLASS_DECL_AURA context_object :
   virtual public context_object
{
   ...
   ::aura::application *                  get_context_application(); // Context Application
   ::eobject                              m_eobject;
   //::id                                   m_id;
   ...
   ::aura::application * get_context_application() const { return get_context_application(); }
