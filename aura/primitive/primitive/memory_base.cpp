...
namespace papaya
{
   ...
   CLASS_DECL_AURA void transfer_to(::file::file * pfileOut, memory_base & mem, memsize uiBufferSize)
   {
   ...
   CLASS_DECL_AURA void transfer_from_begin(::file::file * pfileIn, memory_base & mem, memsize uiBufferSize)
   {
   ...
   CLASS_DECL_AURA void transfer_from(::file::file * pfileIn, memory_base & mem, memsize uiBufferSize)
   {
...
CLASS_DECL_AURA stream & operator << (stream & stream, memory_container & memcontainer)
{
...
//CLASS_DECL_AURA stream & operator << (stream & stream, memory_base & mem)
//{
//
