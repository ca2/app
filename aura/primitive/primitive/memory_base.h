...
#include "aura/filesystem/file/serializable.h"
...
public:
   ...
   memory_base(memory_base&& base) { memcpy(&m_memory, &base.m_memory, sizeof(MEMORY)); xxf_zero(base.m_memory); }
   virtual ~memory_base();
   ...
   virtual ::generic_object * clone() const override;
