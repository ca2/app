...
::object * property_set::source_channel()
{

   return set("source_channel").cast < ::object >();
...
namespace handle
{
   ...
   //localini::localini(::object * pobject)
   //{
