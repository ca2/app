...
namespace user
{
   ...
   ::rectangle_f64 interaction::get_padding(style * pstyle, enum_element eelement, ::user::enum_state estate) const
   {
      ...
      if (get_control_type() == ::user::e_control_type_button)
      {
         ...
         ::rectangle_f64 rectDefaultPadding(16.0, 8.0, 16.0, 8.0);
      ...
      else
      {
         ...
         ::rectangle_f64 rectDefaultPadding(2.0, 2.0, 2.0, 2.0);
   ...
   ::rectangle_f64 interaction::get_margin(style * pstyle, enum_element eelement, ::user::enum_state estate) const
   {
      ...
      if (m_flagNonClient.has(non_client_focus_rect))
      {
         ...
         ::rectangle_f64 rectDefaultMargin(dFocusHeightWidth, dFocusHeightWidth, dFocusHeightWidth, dFocusHeightWidth);

         return rectDefaultMargin;

      }

      ::rectangle_f64 rectDefaultMargin(0.0, 0.0, 0.0, 0.0);
...
//      }
   ...
   bool interaction::is_host_top_level() const
   {
      ...
      if (m_puserinteractionParent != get_context_session()->m_puiHost)
      {
   ...
   ::user::primitive * interaction::set_parent(::user::primitive * puiParent)
   {
      ...
      else // puiParent != nullptr
      {
         ...
         if (pparent)
         {
            ...
            pparent->get_child_rect(rectWindow);
      ...
      try
      {
         ...
         if (!m_pimpl->m_bDestroying)
         {
            ...
            if (puiptraChild)
            {
               ...
               for (index i = 0; i < puiptraChild->interaction_count(); i++)
               {
   ...
   void interaction::user_interaction_on_destroy()
   {
      ...
      if (puiParent != nullptr)
      {
         ...
         try
         {
            ...
            if (puiParent->m_bUserPrimitiveOk)
            {
               ...
               puiptraChild->remove_interaction(this);

               puiParent->m_puiptraChild = puiptraChild;
      ...
      if (m_puiptraChild)
      {
         ...
         for (i32 i = 0; i < puiptraChild->interaction_count(); i++)
         {

            auto pinteraction = puiptraChild->interaction_at(i);
...
//      }
   ...
   void interaction::default_message_handler(::message::base * pbase)
   {
      ...
      m_pimpl->default_message_handler(pbase);
...
//#endif
   ...
   ::user::interaction * interaction::get_child_by_id(id id, i32 iLevel)
   {
      ...
      for (index i = puiptraChild->interaction_last_index(); i >= 0; i--)
      {

         auto pinteraction = puiptraChild->get_interaction(i);
   ...
   ::user::interaction * interaction::child_from_point(const ::point_i32 & point)
   {
      ...
      ::user::interaction * puserinteractionParent = this;
      ...
      if (puiptraChild)
      {
         ...
         for (auto & puserinteractionChild : puiptraChild->interactiona())
         {
            ...
            if (puserinteractionChild->_001IsClientPointInside(pointClient))
            {

               puserinteractionParent = puserinteractionChild;
   ...
   void interaction::route_message_to_descendants(::message::message * pmessage)
   {
      ...
      for (auto & puiChild : puiptraChild->interactiona())
      {
   ...
   bool interaction::create_host()
   {
      ...
      try
      {
        ...
        /* auto psession = Session;
         ...
         if (puiParent == nullptr && psession->m_puiHost.is_set() && psession->m_puiHost != this)
         {

            puiParent = __user_interaction(psession->m_puiHost);
...
//#endif
            ...
            //pusersystem->m_createstruct.hwndParent = ::is_set(puiParent) ? puiParent->get_safe_handle() : nullptr;
 ...
 //        }
   ...
   bool interaction::create_child(::user::interaction * puserinteractionParent)
   {
      ...
      try
      {
         ...
         //if (puserinteractionParent == nullptr && this != puiHost && ::is_set(puiHost))
         //{

         //   puserinteractionParent = __user_interaction(psession->m_puiHost);

         //}

         //if ((WS_CHILD & pusersystem->m_createstruct.style) == 0 && (!puiParent || puiParent != psession->m_puiHost))
         //{
         ...
         //   if (!m_pimpl->create_window_ex(this, pusersystem, puiParent, id))
         //   {
         ...
         //{
            ...
            //if (puserinteractionParent == nullptr && this != psession->m_puiHost && psession->m_puiHost.is_set())
            //{
            ...
            //::rectangle_i32 rectFrame(0, 0, 0, 0);

            //if (IsRectEmpty(&rectangle))
            //{

            //   if (rectFrame.is_null() && ::is_set(puserinteractionParent) && puserinteractionParent->is_place_holder())
            //   {

            //      puserinteractionParent->get_client_rect(rectFrame);
   ...
   ::user::interaction * interaction::get_next_window(bool bIgnoreChildren, const ::user::interaction * puserinteractionStop) const
   {
      ...
      if(!bIgnoreChildren)
      {
         ...
         if (puiptraChild && puiptraChild->has_interaction())
         {
            ...
            auto puserinteractionFirstChild = puiptraChild->first_interaction();
      ...
      auto iFind = puiptraChild->find_first_interaction(this);
      ...
      if (iFind >= puiptraChild->interaction_count())
      {
      ...
      auto puserinteractionNextSibling = puiptraChild->interaction_at(iFind + 1);
   ...
   ::user::frame * interaction::frame() const
   {
      ...
      do
      {
         ...
         if (pinteraction->is_frame_window())
         {
            ...
            return __user_frame(pinteraction);
  ...
  //    if (get_parent() != NULL)
      {
         ...
         auto puiptraChildNew = __new(::user::interaction_array(*m_puiptraChild));
         ...
         m_puiptraChild = puiptraChildNew;
...
//#endif
   ...
   ::size_f64 interaction::_001CalculateAdjustedFittingSize(::draw2d::graphics_pointer & pgraphics)
   {
      ...
      ::rectangle_f64 rectPadding = get_padding(pstyle);
...
#undef INFO_LAYOUT_DISPLAY
   ...
   bool interaction::has_focus() const
   {
      ...
      if (pimpl->m_puserinteractionFocus != this)
      {
   ...
   bool interaction::set_focus()
   {
      ...
      auto estatus = pwindowThis->set_focus();
      ...
      pimpl->m_puserinteractionFocus = this;
   ...
   bool interaction::has_capture() const
   {
   ...
   bool interaction::is_active() const
   {
   ...
   void interaction::sketch_to_design(::draw2d::graphics_pointer& pgraphics, bool & bUpdateBuffer, bool & bUpdateWindow)
   {
      ...
      if (m_puiptraChild)
      {
         ...
         for (auto pchild : puiptraChild->interactiona())
         {
   ...
   bool interaction::on_set_parent(::user::primitive * puiParent)
   {
      ...
      if (m_puserinteractionParent == puiParent)
      {
      ...
      try
      {
               ...
               && m_puserinteractionParent != puiParent)
         {
            ...
            auto puiptraChildNew = __new(::user::interaction_array(*m_puserinteractionParent->m_puiptraChild));
            puiptraChildNew->remove_interaction(this);
            m_puserinteractionParent->m_puiptraChild = puiptraChildNew;
   ...
   ::user::interaction * interaction::last_child()
   {
      try
      {
         ...
         if (!puiptraChild || puiptraChild->has_no_interaction())
            ...
            return puiptraChild->last_interaction();
      }
      catch (...)
      {
      }
   ...
   ::user::interaction * interaction::next_sibling()
   {
      try
      {
         ...
         index i = puiptraChild->interactiona().find_first(this);
         if (i < 0)
            return nullptr;
         i++;
         if (i >= puiptraChild->interaction_count())
            return nullptr;
         else
            return puiptraChild->interaction_at(i);
   ...
   ::user::interaction * interaction::next_sibling(::user::interaction * pinteraction)
   {
      ...
      {
         auto puiptraChild = m_puiptraChild;
         index i = puiptraChild->find_first_interaction(pinteraction);
         if (i < 0)
            return nullptr;
         i++;
restart:
...
restart:
      ...
      else
      {
         try
         {
            return m_puiptraChild->interaction_at(i);
         }
         catch (...)
         {
            goto restart;
   ...
   bool interaction::keyboard_focus_OnKillFocus(oswindow oswindowNew)
   {
      ...
      send_message(e_message_kill_focus, (wparam) (iptr) oswindowNew);
   ...
   ::user::interaction * interaction::get_wnd() const
   {
      ...
      if(get_context_session() != nullptr
          && m_puserinteractionParent == get_context_session()->m_puiHost)
      {
...
//}
   ...
   void interaction::sketch_prepare_window_full_screen(const ::rectangle_i32 & rectHint)
   {
   ...
   index interaction::best_monitor(RECTANGLE_I32 * prectangle, const ::rectangle_i32 & rectangle, bool bSet, ::e_activation eactivation, ::zorder zorderParam)
   {
      ...
      if (get_parent() != nullptr)
      {
         ...
         get_parent()->get_client_rect(rectNew);
   ...
   index interaction::get_zoneing(::rectangle_i32 * prectangle, const ::rectangle_i32 & rectParam, edisplay edisplay)
   {
   ...
   index interaction::get_best_zoneing(edisplay & edisplay, ::rectangle_i32 * prectangle, const ::rectangle_i32 & rectRequest, bool bPreserveSize)
   {
...
//      }
   ...
   bool interaction::layout_tooltip(bool bForceShow)
   {
      ...
      //psession->get_best_monitor(rectMonitor, rectThisWindow);
...
//}
...

   {
      ...
      ::rectangle_i32 rectFinal(rectangle);
   ...
   bool interaction::_001InitialFramePosition()
   {
      ...
      if (m_bExtendOnParent ||
         (m_bExtendOnParentIfClientOnly && Application.is_true("client_only")))
      {
   ...
   bool interaction::_001InitialFramePosition(RECTANGLE_I32 * lprect, const rectangle_f64 & rectOptionalRateOrSize)
   {
      ...
      && abs(rectRate.top) < 10.0)
      {
         ...
         rectRate *= rectangle_f64(rectMainMonitor.width(), rectMainMonitor.height(), rectMainMonitor.width(), rectMainMonitor.height());
