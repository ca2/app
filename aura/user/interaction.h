...
namespace user
{
   ...
   public:
      ...
      ::millis                                    m_tickMouseMoveSkip;
      ::point                                   m_pointMouseMoveSkip;
      ::millis                                    m_tickMouseMovePeriod;
      ...
      ::millis                                    m_tickMouseMove;
      ::millis                                    m_tickMouseMoveIgnore;
      ...
      millis                                      m_tickLastFullUpdate;
      bool                                      m_bSizeMove;
      millis                                      m_tickLastVisualChange;
