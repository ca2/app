...
namespace user
{
   ...
   class CLASS_DECL_AURA language_map :
   ...
   public:
      ...
      virtual bool set_language(::aura::application * papp, string strLang);
      virtual bool set_default_language(::aura::application * papp);
