...
namespace user
{
   ...
   void plain_edit::constrain_context_offset(::f64_point & point, ::user::enum_layout elayout)
   {
...
//               information() << str3;
      ...
      ::f64_rectangle rectangleX = this->rectangle();
      ...
      //   ::i32 iVerticalOffsetModule = (::i32) fmod(pointOffset.y, m_dLineHeight);
   ...
   void plain_edit::on_message_create(::message::message * pmessage)
   {
      ...
      if (m_ptree == nullptr)
      {
         ...
         set_root(allocateø ::user::plain_text_tree(), true);

         m_ptree->m_pfile = allocateø ::memory_file();
   ...
   character_count plain_edit::_001_get_text_length()
   {
   ...
   void plain_edit::get_text(string & str)
   {
      ...
      char_pointer psz = str.get_buffer((character_count)(iSize + 1));
   ...
   void plain_edit::set_selection_text(const ::scoped_string & scopedstr, const ::action_context & context)
   {
   ...
   void plain_edit::_001SetSelEnd(character_count iSelEnd, const ::action_context & actioncontext)
   {
   ...
   void plain_edit::_ensure_selection_visible_x(::draw2d::graphics_pointer & pgraphics)
   {
      ...
      else if (xEnd - get_context_offset().x < rectangleX.width() - iBorder * 2)
      {
         ...
         xContext = (::i32)maximum(0, xEnd - rectangleX.width() + iBorder * 2);
   ...
   void plain_edit::set_text_selection(character_count iBeg, character_count iEnd, const ::action_context & action_context)
   {
   ...
   void plain_edit::set_edit_file(::file::file * pfile)
   {

      {
         ...
         _synchronous_lock writing(m_ptree->synchronization(), DEFAULT_SYNCHRONOUS_LOCK_SUFFIX);
   ...
   void plain_edit::on_message_mouse_leave(::message::message * pmessage)
   {
      ...
      if (!m_pitemHover || m_pitemHover->m_item.m_eelement != e_element_none)
      {
         ...
         m_pitemHover = allocateø ::item(e_element_none);
   ...
   void plain_edit::plain_edit_on_context_offset_layout(::draw2d::graphics_pointer & pgraphics, ::collection::index iOnlyLineToUpdate)
   {
      ...
      //character_count iProperBeg = m_iaLineStart[m_iCurrentPageLineEnd - 1];
...
//   }
   ...
   character_count plain_edit::plain_edit_line_char_hit_test(::draw2d::graphics_pointer & pgraphics, ::i32 px, ::collection::index iLine)
   {
      ...
      for (;;)
      {
         ...
         ::i32 iMid = (lim2 - lim1) * 3 / 4;

         if (px >= lim1 && px <= lim1 + iMid)
         {

            iSel = m_iaLineStart[iLine] + (scopedstrPrevious - psz);
         ...
         else if (px >= lim1 + iMid && px <= lim2)
         {
            ...
            iSel = m_iaLineStart[iLine] + (scopedstrEnd - psz);
   ...
   void plain_edit::_001_get_impact_sel(character_count & iSelBeg, character_count & iSelEnd)
   {
   ...
   void plain_edit::plain_edit_create_line_index(::draw2d::graphics_pointer & pgraphics)
   {
      ...
      char_pointer buf = (char_pointer )m.data();
   ...
   void plain_edit::plain_edit_on_delete_surrounding_text(::draw2d::graphics_pointer & pgraphics, character_count beforeLength, character_count afterLength)
   {
      ...
      if (!m_bReadOnly)
      {
         ...
         if (afterLength > 0 && iSelEnd < m_ptree->m_peditfile->get_length())
         {
            ...
            MacroRecord(allocateø plain_text_file_command());
   ...
   void plain_edit::plain_edit_on_delete(::draw2d::graphics_pointer & pgraphics, bool bBackIfSelectionEmpty)
   {
      ...
      if (!m_bReadOnly)
      {
         ...
         if (i1 != i2 || bBackIfSelectionEmpty)
         {
            ...
            psetsel = allocateø plain_text_set_sel_command();
   ...
   //   auto psetsel = allocateø plain_text_set_sel_command();
...

      {
...

         {
            ...
            else if (pkey->m_ekey == ::user::e_key_back)
            {
               ...
               if (is_window_enabled())
               {
                  ...
                  if (!m_bReadOnly)
                  {
                     ...
                     //         psz = maximum((char_pointer )buf, (char_pointer )&buf[iCur - 1]);
            ...
            else if (is_window_enabled())
            {
               ...
               //                     {
               //                        str = (::i8)((pkey->m_ekey - ::user::e_key_a) + 'a');
   ...
   void plain_edit::get_text_composition_area(::i32_rectangle & rectangle)
   {
      ...
      ::f64 y = m_iLastSelectionEndLine * m_dLineHeight - get_context_offset().y;

      ::f64 y2 = y + m_dLineHeight;

      ::i32_point point((::i32)x, (::i32)y);
   ...
   {
      ::pointer<::user::plain_text_group_command>pgroupcommand = allocateø plain_text_group_command();
   ...
   void plain_edit::set_text(const ::scoped_string & scopedstrParam, const ::action_context & action_context)
   {
   ...
   ::pointer<::item>plain_edit::on_allocate_item()
   {
      ...
      return allocateø plain_text_command();
   ...
   void plain_edit::set_root(plain_text_tree * pdata, bool bOwnData)
   {
      ...
      _synchronous_lock lockRoot(synchronization(), DEFAULT_SYNCHRONOUS_LOCK_SUFFIX);
   ...
   //::f64_size plain_edit::get_total_size(::user::enum_layout elayout)
   //{
   ...
   string plain_edit::plain_edit_get_line(::draw2d::graphics_pointer & pgraphics, ::collection::index iLine)
   {
         ...
         && iLine < m_iaLineFlags.get_count())
      {
         ...
         char_pointer psz = strLine.get_buffer(iLineLen);
   ...
   void plain_edit_style::on_update(::draw2d::graphics_pointer & pgraphics, ::user::style * pstyle, ::user::interaction * puserinteraction)
   {
      ...
      puserinteraction->constructø(m_ppenCaret);

      puserinteraction->constructø(m_pbrushText);

      puserinteraction->constructø(m_pbrushTextCr);

      puserinteraction->constructø(m_pbrushTextSel);

      puserinteraction->constructø(m_pbrushTextEmpty);
   ...
   //   {
   //
   //      m_psimpleimm = allocateø simple_imm(this);
   //
   //   }
   //
   //   return m_psimpleimm;
