...
namespace user
{
   ...
   public:
      ...
      __pointer(::thread)                        m_pthreadUserImpl;
      ...
      //virtual bool defer_set_window_pos(zorder zorder, const ::rect & rect, UINT nFlags) override; // only set_windows_pos if get_parent()->screen_to_client(get_window_rect) different of rect(x, y, cx, cy)      virtual bool set_placement(RECT * prect);

      //virtual bool defer_set_window_pos(zorder zorder, i32 x,i32 y,i32 cx,i32 cy,UINT nFlags) override; // only set_windows_pos if get_parent()->screen_to_client(get_window_rect) different of rect(x, y, cx, cy)      virtual bool set_placement(RECT * prect);
...
//      virtual ::user::interaction * get_wnd() const;
      ...
      virtual void redraw_add(::object * point);
      virtual void redraw_remove(::object * point);
