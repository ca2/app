...
namespace user
{
   ...
   void control::install_message_routing(::channel* pchannel)
   {
      ...
      IGUI_MSG_LINK(WM_CREATE, pchannel, this, &::user::control::_001OnCreate);
      //      IGUI_MSG_LINK(WM_MOUSEMOVE, pchannel, this, &::user::control::_001OnMouseMove);
      //
      //#ifdef WINDOWS
      //
      //      IGUI_MSG_LINK(WM_MOUSELEAVE, pchannel, this, &::user::control::_001OnMouseLeave);
      //
      //#else
      //
      ...
      //#endif
      //
      IGUI_MSG_LINK(WM_KEYDOWN, pchannel, this, &::user::control::_001OnKeyDown);

      IGUI_MSG_LINK(WM_ENABLE, pchannel, this, &::user::control::_001OnEnable);
      IGUI_MSG_LINK(WM_SETFOCUS, pchannel, this, &::user::control::_001OnSetFocus);
      IGUI_MSG_LINK(WM_KILLFOCUS, pchannel, this, &::user::control::_001OnKillFocus);
   ...
   void control_cmd_ui::Enable(bool bOn)
   {
      ...
      __pointer(::user::interaction) pcontrol = pwnd->get_child_by_id(m_idControl);

      __pointer(control) pcontrolex = (pcontrol.m_p);
