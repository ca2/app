...
namespace user
{
   ...
   void interaction::on_initialize_particle()
   {
      ...
      ::user::prototype::on_initialize_particle();
...
//         }
   ...
   ::user::interaction_impl * interaction::get_host_user_interaction_impl()
   {
   ...
   //   auto pdescriptor = ::place(new control_descriptor(arguments));
   ...
   //   //auto pdescriptor = ::place(new control_descriptor());
...
//      }
   ...
   ::user::prototype * interaction::get_bind_ui()
   {
   ...
   bool interaction::on_before_set_parent(::user::prototype * puserinteractionParent)
   {
   ...
   ::user::prototype * interaction::set_parent(::user::prototype * puserinteractionParent)
   {
...
//      }
   ...
   void interaction::notify_on_destroy(::property_object * pparticle)
   {
      ...
      ::user::prototype::notify_on_destroy(pparticle);
...
<< timeElapsed.integral_millisecond() << ")!!\n");
   ...
   void interaction::queue_graphics_call(const ::function<void(::draw2d::graphics_pointer &)> & function)
   {
      ...
      m_pgraphicscalla->add(::place(new ::draw2d::graphics_call(function)));
...
//         }
   ...
   void interaction::erase(::graphics::output_purpose * poutputpurpose)
   {
      ...
      pimplHost->erase(poutputpurpose);
   ...
   void interaction::add_graphical_output_purpose(::particle * pparticle, ::graphics::enum_output_purpose epurpose)
   {
      ...
      if(!pimplHost)
      {
         ...
         m_pusersystem->add(::place(new ::graphics::output_purpose(pparticle, epurpose)));

         return;

      }

      pimplHost->add_graphical_output_purpose(pparticle, epurpose);
   ...
   void interaction::erase_graphical_output_purpose(::particle * pparticle)
   {
      ...
      pimplHost->erase_graphical_output_purpose(pparticle);
...
//      }
//
//      return m_pprimitiveimpl->most_demanding_graphical_output_purpose();
//
//   }


   bool interaction::has_screen_output_purpose() const
   {
      ...
      return m_pprimitiveimpl->has_screen_output_purpose();

   }


   bool interaction::has_graphical_output_purpose() const
   {
      ...
      return m_pprimitiveimpl->has_graphical_output_purpose();

   }


   bool interaction::has_fps_output_purpose() const
   {
      ...
      return m_pprimitiveimpl->has_fps_output_purpose();
...
//      }
      ...
      //m_pitemClient = ::place(new ::item(e_element_client));
      ...
      if (m_bDefaultEditHandling || m_bDefaultKeyboardMultipleSelectionHandling)
      {
         ...
         if (pkey)
         {
            ...
            if (m_bDefaultEditHandling && pkey->m_ekey == ::user::e_key_delete)
            {
               ...
               auto pcommand = ::place(new ::message::command("edit_delete"));
...
//
   ...
   ::property_object * interaction::parent_property_set_holder() const
   {
      ...
      return ::user::prototype::parent_property_set_holder();
   ...
   //::user::prototype * interaction::get_keyboard_focus()
   //{
   ...
   /*bool interaction::is_text_composition_active()
      ...
      //   return ::user::prototype::get_form_property_set();
   ...
   void interaction::post_non_client_destroy()
   {
      ...
      ::user::prototype::post_non_client_destroy();
...
//                                              bStretch);
   ...
   ::user::prototype * interaction::set_owner(::user::prototype * pprimitive)
   {
   ...
   void interaction::on_add_owned(::user::prototype * pprimitive)
   {
   ...
   float interaction::preferred_dpi_x()
   {
      ...
      if (::is_null(pwindow))
      {
         ...
         return ::user::prototype::preferred_dpi_x();
   ...
   float interaction::preferred_dpi_y()
   {
      ...
      if (::is_null(pwindow))
      {
         ...
         return ::user::prototype::preferred_dpi_y();
   ...
   float interaction::preferred_density()
   {
      ...
      if (::is_null(pwindow))
      {
         ...
         return ::user::prototype::preferred_density();
...
#undef false
   ...
   void interaction::layout_children_zorder()
   {
      ...
      auto puiptraChildNew = ::place(new ::user::interaction_array(*m_puserinteractionpointeraChild));
...
//      auto type = ::type(this);
   ...
   void interaction::message_handler(::message::message * pmessage)
   {
      ...
      if (type.name().contains("list_box"))
      {
         ...
         ::acme::get()->platform()->informationf("list_box");
   ...
   void interaction::on_configuration_change(::user::prototype * pprimitiveSource)
   {
...
//   {
//
//      return m_pprimitiveimpl->is_there_graphics_output_interest();
//
//   }
...
//      }
   ...
   void interaction::set_keyboard_focus()
   {
      ...
      if (pwindowThis->has_keyboard_focus())
      {
         ...
         if (pprimitiveimpl->m_puserinteractionToKillKeyboardFocus == this)
         {

            pprimitiveimpl->m_puserinteractionToKillKeyboardFocus.release();
...
//      }
   ...
   bool interaction::on_set_parent(::user::prototype * puserprimitiveParent)
   {
...
//                    ::user::interaction_array(*m_puserinteractionParent->m_puserinteractionpointeraChild));
   ...
   bool interaction::on_add_child(::user::interaction * puserinteractionChild)
   {
      ...
      //    puserinteractionpointeraChildNew = ::place(new ::user::interaction_array(*m_puserinteractionpointeraChild));
   ...
   bool interaction::on_set_owner(::user::prototype * pprimitive)
   {
      ...
      interaction::get_message(const ::atom & atom, wparam wparam, lparam lparam, ::message::enum_prototype eprototype)
   {
      ...
      if (::is_null(m_pprimitiveimpl))
      {
         ...
         return ::user::prototype::get_message(atom, wparam, lparam, eprototype);
   ...
   void interaction::on_simple_command(::message::simple_command * psimplecommand)
   {
      ...
      ::user::prototype::on_simple_command(psimplecommand);
   ...
   void interaction::on_command(::message::command * pcommand)
   {
      ...
      ::user::prototype::on_command(pcommand);
   ...
   bool interaction::_001OnBeforeEnterIconic()
   {
      ...
      return ::user::prototype::_001OnBeforeEnterIconic();
   ...
   bool interaction::_001OnBeforeEnterNormal()
   {
      ...
      return ::user::prototype::_001OnBeforeEnterNormal();
   ...
   bool interaction::_001OnBeforeEnterZoomed()
   {
      ...
      return ::user::prototype::_001OnBeforeEnterZoomed();
   ...
   bool interaction::_001OnBeforeEnterFullScreen()
   {
      ...
      return ::user::prototype::_001OnBeforeEnterFullScreen();
   ...
   void interaction::_001OnAfterEnterIconic()
   {
      ...
      ::user::prototype::_001OnAfterEnterIconic();
   ...
   void interaction::_001OnAfterEnterNormal()
   {
      ...
      ::user::prototype::_001OnAfterEnterNormal();
   ...
   void interaction::_001OnAfterEnterZoomed()
   {
      ...
      ::user::prototype::_001OnAfterEnterZoomed();
   ...
   void interaction::_001OnAfterEnterFullScreen()
   {
      ...
      ::user::prototype::_001OnAfterEnterFullScreen();
   ...
   bool interaction::_001OnBeforeExitIconic()
   {
      ...
      return ::user::prototype::_001OnBeforeExitIconic();
   ...
   bool interaction::_001OnBeforeExitNormal()
   {
      ...
      return ::user::prototype::_001OnBeforeExitNormal();
   ...
   bool interaction::_001OnBeforeExitZoomed()
   {
      ...
      return ::user::prototype::_001OnBeforeExitZoomed();
   ...
   bool interaction::_001OnBeforeExitFullScreen()
   {
      ...
      return ::user::prototype::_001OnBeforeExitFullScreen();
...
//      }
   ...
   //void interaction::set_keyboard_focus(::user::prototype * pprimitive)
   //{
   ...
   //void interaction::erase_keyboard_focus(::user::prototype * pprimitive)
   //{
...
//      }
   ...
   ::item_pointer interaction::stock_item(enum_element eelement)
   {
      ...
      if (!pitem)
      {
         ...
         tool().add_item(::place(new ::item(eelement)));
   ...
   void interaction::show_tooltip(const ::string & str, bool bError)
   {
      ...
      //      {
      //
      //         m_ptooltip = ::place(new tooltip(this));
      //
      //
...
//   }
   ...
   void interaction::enable_transparent_mouse_events(bool bEnable)
   {
      ...
      _synchronous_lock synchronouslock(puiTop->synchronization());
   ...
   //               auto pmouse = ::place(new message::mouse());
   ...
   void interaction::on_after_graphical_update()
   {
      ...
      ::user::prototype::on_after_graphical_update();
...
//               display_previous();
   ...
   void interaction::post_procedure(const ::procedure & procedure)
   {
      ...
      if (::is_null(m_pthreadUserInteraction))
      {
         ...
         ::user::prototype::post_procedure(procedure);
...
//         }
   ...
   void interaction::on_message_right_button_down(::message::message * pmessage)
   {
      ...
      auto pcontextmenu = ::place(new ::message::context_menu());
...
//      }
   ...
   bool interaction::is_mouse_hover() const
   {
      ...
      auto pwindowimpl = ((interaction *)this)->get_host_user_interaction_impl();
   ...
   double interaction::_001GetTopLeftWeightedOccludedOpaqueRate()
   {
      ...
      if (!m_pprimitiveimpl)
      {
         ...
         return ::user::prototype::_001GetTopLeftWeightedOccludedOpaqueRate();
   ...
   bool interaction::has_function(enum_control_function econtrolfunction)
   {
      ...
      //return ::user::prototype::has_function(econtrolfunction);
   ...
   void interaction::route_command(::message::command * pcommand, bool bRouteToKeyDescendant)
   {
      ...
      ::user::prototype::route_command(pcommand);
...
//   {
//
//      return m_pinteractionimpl ? m_pinteractionimpl->has_fps_interest() : false;
//
//   }
