...
namespace user
{
   ...
   public:
      ...
      ::user::interaction * find_first_typed(const ::type & typeatom);
   ...
   public:
      ...
      void send_message_to_descendants(::user::enum_message eusermessage, ::wparam wparam = {}, ::lparam lparam = {}, bool bRecursive = true);
