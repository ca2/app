      ...
      queue_graphics_call([this, pscroll](::draw2d::graphics_pointer & pgraphics)
         {
            ...
            if (pscroll->m_ecommand == e_scroll_command_line_left)
            {
               ...
               set_context_offset_x(pgraphics, (::i32)(get_context_offset().x - m_scrolldataHorizontal.m_iLine));

            }
            else if (pscroll->m_ecommand == e_scroll_command_page_left)
            {

               set_context_offset_x(pgraphics, (::i32)(get_context_offset().x - m_scrolldataHorizontal.m_iPage));
      ...
      queue_graphics_call([this, pscroll](::draw2d::graphics_pointer & pgraphics)
         {
            ...
            if (pscroll->m_ecommand == e_scroll_command_line_up)
            {
               ...
               set_context_offset_y(pgraphics, (::i32)(get_context_offset().y - m_scrolldataVertical.m_iLine));

            }
            else if (pscroll->m_ecommand == e_scroll_command_page_up)
            {

               set_context_offset_y(pgraphics, (::i32)(get_context_offset().y - m_scrolldataVertical.m_iPage));
