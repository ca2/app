...
namespace user
{
   ...
   public:
      ...
      ::f64_point get_parent_accumulated_scroll(enum_layout elayout = e_layout_design) override;

      virtual void post_scroll_message(enum_scroll_command ecommand, ::f64 dPosition = DOUBLE_MOST_NEGATIVE);
