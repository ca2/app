...
namespace user
{
   ...
   scroll_base_y::scroll_base_y()
   {
      ...
      //m_pscrollstateVertical = allocateø scroll_state();

      m_pscrolllayoutY = allocateø scroll_layout();
   ...
   void scroll_base_y::destroy()
   {
      ...
      m_pscrollbarY.defer_destroy_and_release();
      m_pscrolllayoutY.defer_destroy_and_release();
   ...
   //void scroll_base_y::layout_scroll_bar(::draw2d::graphics_pointer & pdraw2dgraphics)
...
//      ::i32 ifswp = SWP_SHOWWINDOW | SWP_NOCOPYBITS;
   ...
   //void scroll_base_y::on_change_context_offset(::draw2d::graphics_pointer & pdraw2dgraphics)
   //{
   ...
   ::i32 scroll_base_y::get_final_scroll_bar_y_thickness(::user::enum_layout elayout)
   {
   ...
   void scroll_base_y::scroll_y(::i32 iPosition)
   {
      ...
      /*    queue_graphics_call([this, nPos](::draw2d::graphics_pointer & pdraw2dgraphics)
             {
                ...
                set_context_offset_y(pdraw2dgraphics, nPos);
