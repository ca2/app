...
//
//      virtual ::pointer<::user::menu> _track_popup_menu(::user::interaction * pinteraction, ::menu::item * pmenuitem, ::i32 iFlags, const ::i32_point & point, const ::i32_size & sizeMinimum = ::i32_size(), ::channel * pchannelNotify = nullptr);
//
      ...
      virtual ::pointer<::form_document>  create_typed_form(::particle * pparticle, const ::platform::type & type, ::user::element * puserelementParent, const ::payload & payload = ::e_type_empty_argument, const ::payload & payloadArgs = ::e_type_empty_argument);
      ...
      virtual ::pointer<::form_document>  create_typed_child_form(::particle * pparticle, const ::platform::type & type, ::user::element * puserelementParent, const ::payload & payload = ::e_type_empty_argument, const ::payload & payloadArgs = ::e_type_empty_argument);
      ...
      ::pointer<::form_document>  create_typed_child_form(::particle * pparticle, const ::platform::type & type, ::user::impact_data * pimpactdata, ::payload payload = ::payload(::e_type_empty_argument));
