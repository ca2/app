...
namespace user
{
   ...
   ::type core_user_layer::default_type_mesh_data()
   {
...
return {};
   ...
   ::type core_user_layer::default_type_list_header()
   {
   ...
   ::type core_user_layer::default_type_list_data()
   {
...
return nullptr;
   ...
   ::type core_user_layer::get_pane_tab_impact_type_info()
   {
   ...
   //::type get_simple_child_frame_type_info(){}
