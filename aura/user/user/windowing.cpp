...
//#if DEBUG_LEVEL > 0
//
//      ::acme::get()->platform()->informationf("::user::g_pmapImpl erased oswindow");
//
//#endif
//
//   }
...
//#if DEBUG_LEVEL > 0
//
//      ::acme::get()->platform()->informationf("::user::g_pmapImpl erased pimpl->m_oswindow");
//
//#endif
//
//   }
...
//#if DEBUG_LEVEL > 0
//
//      ::acme::get()->platform()->informationf("::user::g_pmapHandle erased pimpl");
//
//#endif
//
//   }
...
//#if DEBUG_LEVEL > 0
//
//         ::acme::get()->platform()->informationf("psystem->m_pwindowmap erased oswindow");
//
//#endif
//
//      }
