...
//      i32 windows::thread::get_image_by_file_extension(oswindow oswindow, image_key & imagekey, COLORREF crBk)
//      {
//
...
//      }
      ...
      i32 windows::get_file_image(oswindow oswindow, image_key imagekey, const itemidlist & pidlAbsolute, const itemidlist & pidlChild, const unichar * pcszExtra, COLORREF crBk)
      ...
      i32 windows::get_file_image(oswindow oswindow, image_key imagekey, const unichar * pcszExtra, COLORREF crBk)
      ...
      int windows::add_icon_set(SHFILEINFOW * pinfo16, SHFILEINFOW * pinfo48, COLORREF crBk, bool & bUsed16, bool & bUsed48, int iImage)
      {
      ...
      int windows::add_icon_info(int iSize, SHFILEINFOW * pinfo16, SHFILEINFOW * pinfo48, COLORREF crBk, bool & bUsed16, bool & bUsed48, int iImage)
      {
      ...
      void windows::set_image_ico(string strIconLocation, i32 & iImage, COLORREF crBk)
      {
      ...
      void windows::set_image_resource(string strIconLocation, i32 & iImage, const image_key & imagekey, COLORREF crBk)
      {
