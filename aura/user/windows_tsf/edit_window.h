...
namespace tsf
{
   ...
   public:
      ...
      //void _SaveToFile(char_pointer pszFile);
      //void _LoadFromFile(char_pointer pszFile);
      ...
      STDMETHODIMP GetACPFromPoint(TsViewCookie vcView, const ::i32_point * pt, ::u32 dwFlags, ::i32 * pacp);
      STDMETHODIMP GetTextExt(TsViewCookie vcView, ::i32 acpStart, ::i32 acpEnd, ::i32_rectangle * prc, BOOL * pfClipped);
      STDMETHODIMP GetScreenExt(TsViewCookie vcView, ::i32_rectangle * prc);
