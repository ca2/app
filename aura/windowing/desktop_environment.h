...
namespace windowing
{
   ...
   public:
      ...
      //virtual void get_monitor_rectangle(::collection::index iMonitor, ::rectangle_i32 * prectangle);
      //virtual void get_workspace_rectangle(::collection::index iMonitor, ::rectangle_i32 * prectangle);
