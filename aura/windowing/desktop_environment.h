...
namespace windowing
{
   ...
   public:
      ...
      virtual void get_monitor_rectangle(::raw::index iMonitor, ::rectangle_i32 * prectangle);
      virtual void get_workspace_rectangle(::raw::index iMonitor, ::rectangle_i32 * prectangle);
