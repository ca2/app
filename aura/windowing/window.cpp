...
namespace windowing
{
   ...
   void window::message_handler(::message::message * pmessage)
   {
      ...
      if (pmessage->m_eusermessage == ::user::e_message_post_user)
      {
         ...
         if (pmessagePost->m_eusermessage == ::user::e_message_scroll_y)
         {
         ...
         else if (pmessagePost->m_eusermessage == ::user::e_message_text_composition)
         {
...
//      auto pusersystem = m_pacmeuserinteraction->m_pusersystem;
   ...
   void window::set_context_org(draw2d::graphics_pointer & pdraw2dgraphics)
   {
...
//   }
   ...
   void window::on_a_system_menu_item(::operating_system::a_system_menu_item * psystemmenuitem, ::user::activation_token * puseractivationtoken)
   {
      ...
      else if (strActionName == "close")
      {
         ...
         user_interaction()->post_message(::user::e_message_close);
   ...
   void window::on_layout(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
...
//   }
   ...
   void window::on_size(::i32 w, ::i32 h)
   {
      ...
      user_interaction()->post_message(::user::e_message_size, 1024, lparam);
   ...
   void window::window_update_screen()
   {
      ...
      if (edisplayOutput != edisplayDesign)
      {
         ...
         puserinteraction->send_message(::user::e_message_show_window, ::is_screen_visible(edisplayDesign) ? 1 : 0);
...
//    //}
//
//    //void window::PrintWindow(::draw2d::graphics_pointer & pdraw2dgraphics,::u32 nFlags) const
//    //{
...
//#endif
   ...
   void window::operating_system_create_host()
   {
      ...
      //      {
      //
      //         user_interaction()->send_message(::user::e_message_create, 0, (lparam) &pusersystem->m_createstruct);
      //
      //         user_interaction()->m_ewindowflag |= e_window_flag_window_created;
      //
      //      }
...
//   }
   ...
   //   USER_MESSAGE_LINK(::user::e_message_create, pchannel, this, &window::_001OnPrioCreate);
   ...
   void window::last_install_message_routing(::channel * pchannel)
   {
      ...
      if (!m_pacmeuserinteraction->m_bMessageOnlyWindow)
      {
         ...
         //USER_MESSAGE_LINK(::user::e_message_apply_visual, pchannel, this, &window::_001OnApplyVisual);


         //#ifndef LINUX
         USER_MESSAGE_LINK(::user::e_message_reposition, pchannel, this, &window::on_message_reposition);
         USER_MESSAGE_LINK(::user::e_message_size, pchannel, this, &window::on_message_size);
         ...
         //USER_MESSAGE_LINK(::user::e_message_set_focus, pchannel, this, &window::on_message_set_focus);
         USER_MESSAGE_LINK(::user::e_message_kill_focus, pchannel, this, &window::on_message_kill_focus);

      }

      USER_MESSAGE_LINK(::user::e_message_destroy_window, pchannel, this, &window::_001OnDestroyWindow);
   ...
   void window::install_message_routing(::channel * pchannel)
   {
      ...
      if (!user_interaction()->m_bMessageOnlyWindow)
      {
         ...
         USER_MESSAGE_LINK(::user::e_message_capture_changed, pchannel, this, &window::_001OnCaptureChanged);
   ...
   void window::destroy_impl_only()
   {
      ...
      if (!m_bDestroyImplOnly)
      {
         ...
         post_message(::user::e_message_destroy_window, 0, 0);
   ...
   //      user_interaction()->post_message(::user::e_message_destroy_window);
...
//#endif
   ...
   void window::do_message_handler(::message::message * pmessage)
   {
      ...
      else if (pmessage->m_eusermessage == ::user::e_message_mouse_move)
      {
         ...
         //informationf("window::message_handler ::user::e_message_mouse_move");
         //printf("g_iMouseMove = %d\n", g_iMouseMove);
...
//         }
   ...
   bool window::on_mouse_message(::message::mouse * pmouse)
   {
      ...
      else if (pmouse->m_eusermessage == ::user::e_message_left_button_up)
      {
      ...
      if (pmouse->m_eusermessage == ::user::e_message_mouse_move)
      {
      ...
      if (pmouse->m_eusermessage == ::user::e_message_left_button_down)
      {
      ...
      if (::is_set(pwindow))
      {
         ...
         if (pmouse->m_eusermessage == ::user::e_message_left_button_up)
         {
...
//   }
   ...
   //bool window::needs_to_draw(const ::i32_rectangle & rectangleHostNeedsToDraw, ::draw2d::graphics_pointer & pdraw2dgraphics)
   //{
...
//      m_pgraphicsthread->graphics_thread_redraw();
   ...
   //void window::DrawCaption(::draw2d::graphics_pointer & pdraw2dgraphics,const i32_rectangle & prc,::u32 uFlags)
   //{
   ...
   //void window::_001OnNcClip(::draw2d::graphics_pointer & pdraw2dgraphics)
   //{

   //   //::windowing::window_base::_001OnNcClip(pdraw2dgraphics);

   //}


   //void window::defer_do_graphics(::draw2d::graphics_pointer& pdraw2dgraphics)
   //{
...
//
//       //user_interaction()->defer_do_graphics(pdraw2dgraphics);
//
//       //{
//
...
// #endif
//
//          auto pbufferitem = pgraphicsgraphics->on_begin_draw(e_graphics_layout);
...
//             }
//
//             //::draw2d::graphics_pointer pdraw2dgraphics = pbufferitem->g();
//
...
//
//             pgraphicscontext->m_pgraphics->m_pgraphicsgraphics = pgraphicsgraphics;
//
//
//
...
// //                   pgraphicscontext->m_pgraphics->payload("set_transparent") = "";
// //
// //                   pgraphicscontext->m_pgraphics->m_pgraphicsgraphics = m_pgraphicsgraphics;
// //
// //                   pgraphicscontext->m_pgraphics->m_pgraphicsbufferitem = pbufferitem;
// //
...
// //                   //}
// //
// //                   //pdraw2dgraphics->m_pdraw2dhost = user_interaction();
// //
...
// //                         //pdraw2dgraphics->m_bDraw = bDraw;
// //
// //                         pgraphicscontext->m_pgraphics->m_bDraw = true;
// //
// //                         pgraphicscontext->m_pgraphics->m_bInheritDraw = true;
// //
// //                         //            pdraw2dgraphics->fill_solid_rectangle({ 0, 0, 200, 200 }, ::color::green);
// //
// //
...
// // #endif
// //                         ///xxxopengl  user_interaction()->_000TopCallOnDraw(pdraw2dgraphics);
// //
// //                         //xxxdirectx user_interaction()->_000TopCallOnDraw(pdraw2dgraphics);
// //                         user_interaction()->_000TopCallOnDraw(pgraphicscontext->m_pgraphics);
// //
...
// //          //m_pgraphics->update_buffer(rectangleWindow.size());
// //
// //          auto pbufferitem = pgraphicsgraphics->on_begin_draw(e_graphics_draw);
// //          //auto pparticleSynchronization = m_pgraphics->get_buffer_item()->m_pmutex;
// //
// //          if (!pbufferitem)
// //          {
...
//            //{
//
//            //::draw2d::graphics_lease pdraw2dgraphics;
//
...
//
//
//                  //   information() << "intrimpl::defer_do_graphics !m_pimageBufferItem";
//                  //   return;
//                  //}
//
//#ifdef MORE_LOG
...
//                        class ::time time22;
//                        time22.Now();
//                        frame_layout_stage(pdraw2dgraphics);
...
//               {
//
//                  //::draw2d::graphics_pointer pdraw2dgraphics = pbufferitem->acquire_graphics();
//                  auto pdraw2dgraphics = pbufferitem->acquire_graphics();
//                  //
//                  //          //pgraphicscontext->m_pgraphics = pbufferitem->g();
//                  //
...
//                     //                   //{
//                     //
//                     //                   //   //            ::pointer < ::graphics::bitmap_source_buffer >
//                     //                   pbitmapsourcebuffer = pdraw2dgraphics;
//                     //                   //   //
//                     //                   //   //            if(pbitmapsourcebuffer)
//                     //                   //   //            {
//                     //                   //   //
...
//                     //                         pgraphicscontext->m_pgraphics->m_bInheritDraw = true;
//                     //
//                     //                         //            pdraw2dgraphics->fill_solid_rectangle({ 0, 0, 200, 200 },
//                     //                         ::color::green);
//                     //
//                     //
//                     // #ifdef MORE_LOG
...
//                     //                         user_interaction()->_000TopCallOnDraw(pgraphicscontext->m_pgraphics);
//                     //
//                     //                         //pdraw2dgraphics->fill_solid_rectangle({ 0., 0., 100., 100. }, ::argb(0.5, 0.5,
//                     //                         0.8, 0.75));
//                     //
//                     //                         ////user_interaction()->_000CallOnDraw(pdraw2dgraphics);
//                     //
...
//         {
//
//            information() << "draw_frame exception: " << exception.get_message();
//
//         }
//         catch (...)
//         {
//
//            information() << "draw_frame unknown exception";
//
//         }
//
//      };
            ...
            try
            {
               ...
               //}
                     ...
                     //{
                        ...
                        //auto pdraw2dgraphics = pgraphicsgraphics->on_begin_draw();
...
//      //_synchronous_lock synchronous_lock(m_pmutexGraphics);
//
//      auto pdraw2dgraphics = pgraphicscontext->m_pgraphics;
//
//      draw_frame_layout(pdraw2dgraphics);
//
//      //             auto pgraphicsgraphics = m_pgraphicsgraphics;
//      //
//      // if (pgraphicsgraphics)
...
//
//
//      draw_frame_draw(pdraw2dgraphics);
//         //auto pparticleSynchronization = m_pgraphics->get_buffer_item()->m_pmutex;
//
//         // if (!pbufferitem)
//         // {
...
//   }
   ...
   void window::frame_layout_stage(::draw2d::graphics * pdraw2dgraphics)
   {
      ...
      //pdraw2dgraphics->start_layer(pgraphicscontext);
...

      {
         ...
         if (!pdraw2dgraphics->m_puserredraw)
         {

            construct_newø(pdraw2dgraphics->m_puserredraw);
      ...
      if (user_interaction())
      {
         ...
         else
         {
            ...
            pgraphicspointer = pdraw2dgraphics;
...
//pdraw2dgraphics->end_layer(m_pgraphicscontextDrawFrame);

   }


   void window::frame_draw_stage(::draw2d::graphics * pdraw2dgraphics)
   {
      ...
      if (user_interaction())
      {
         ...
         else
         {
            ...
            ///
            ///
            ::draw2d::graphics_pointer pgraphicspointer(pdraw2dgraphics);

            // pdraw2dgraphics->m_pgraphicscontext = pgraphicscontext;
      ...
      pdraw2dgraphics->end_layer(true);
...
//   void window::do_graphics(::draw2d::graphics_pointer& pdraw2dgraphics)
//   {
//
...
//         }
//
//         pdraw2dgraphics->m_puserinteraction = m_pacmeuserinteraction;
//
//         //draw2dlock.unlock();
//
//         pdraw2dgraphics->do_on_context([this, pgraphicsgraphics, &pdraw2dgraphics, &pbufferitem]()
//            {
//
//               //_synchronous_lock synchronous_lock(m_pmutexGraphics);
//
...
//                        debug() << "defer_do_graphics _000TopCallOnLayout";
//#endif
//                        user_interaction()->_000TopCallOnLayout(pdraw2dgraphics);
//
//                        //user_interaction()->_000CallOnDraw(pdraw2dgraphics);
//
//                        //                  if (!bDraw && m_redrawa.has_element())
...
//
//                        //xxxdirectx user_interaction()->_000TopCallOnDraw(pdraw2dgraphics);
//                        user_interaction()->_000TopCallOnDraw(pdraw2dgraphics);
//
//                        //pdraw2dgraphics->fill_solid_rectangle({ 0., 0., 100., 100. }, ::argb(0.5, 0.5, 0.8, 0.75));
//
//                        ////user_interaction()->_000CallOnDraw(pdraw2dgraphics);
...
//   }
   ...
   //void window::_000CallOnDraw(::draw2d::graphics_pointer & pdraw2dgraphics)
   //{
   ...
   //   if (user_interaction()->should_perform_layout(pdraw2dgraphics))
   //   {

   //      user_interaction()->perform_layout(pdraw2dgraphics);
   ...
   //      {
   //
   //         user_interaction()->post_message(::user::e_message_apply_visual);
   //
   //      }
   //
   //      //return true;
   ...
   ::graphics::graphics * window::get_graphics_graphics()
   {
   ...
   //            puserinteractionFocusOld->send_message(::user::e_message_kill_focus);
   ...
   //            puserinteractionFocusOld->send_message(::user::e_message_set_focus);
   ...
   //            puserinteractionFocusKillFocus->send_message(::user::e_message_kill_focus);
   ...
   //   //user_interaction()->message_call(::user::e_message_size, 0, process_state().m_size.lparam());
   ...
   void window::_001OnNcClip(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
      ...
      user_interaction()->_001OnTopNcClip(pdraw2dgraphics);
   ...
   //
   //
   //   void window::_000OnDraw(::draw2d::graphics_pointer & pdraw2dgraphics)
   //   {
   //
   //      if (user_interaction())
   //      {
   ...
   //
   //
   //   void window::_001DrawThis(::draw2d::graphics_pointer & pdraw2dgraphics)
   //   {
   //
   //      if (user_interaction())
   //      {
   //
   //         user_interaction()->_001DrawThis(pdraw2dgraphics);
   //
   //      }
   //
   //   }
   //
   //
   //   void window::_001DrawChildren(::draw2d::graphics_pointer & pdraw2dgraphics)
   //   {
   //
   //      if (user_interaction())
   //      {
   //
   //         user_interaction()->_001DrawChildren(pdraw2dgraphics);
   //
   //      }
   //
   //   }
   //
   //
   //   void window::draw_control_background(::draw2d::graphics_pointer & pdraw2dgraphics)
   //   {
   //
   //      if (user_interaction())
   //      {
   //
   //         user_interaction()->draw_control_background(pdraw2dgraphics);
   //
   //      }
   //
   //   }
...
#define _NEW_MESSAGE(TYPE) \
   ...
   ::pointer<::message::message>window::get_message(::user::enum_message eusermessage, ::wparam wparam, ::lparam lparam, ::user::enum_message_prototype eprototype)
   {

      return user_interaction()->get_message(eusermessage, wparam, lparam);
   ...
   //      switch (eprototype)
   //      {
   //      case ::user::e_message_prototype_none:
   //      {
   //
   ...
   //      }
   //      break;
   //      case ::user::e_message_prototype_create:
   //      {
   //         _NEW_MESSAGE(::message::create);
   //
   //      }
   //      break;
   //      case ::user::e_message_prototype_enable:
   //      {
   //         _NEW_MESSAGE(::message::enable);
   //
   //      }
   //      break;
   //      case ::user::e_message_prototype_non_client_activate:
   //      {
   ...
   //      }
   //      break;
   //      case ::user::e_message_prototype_timer:
   //      {
   //
   ...
   //      }
   //      break;
   //      case ::user::e_message_prototype_show_window:
   //      {
   ...
   //      }
   //      break;
   //      case ::user::e_message_prototype_set_cursor:
   //      {
   ...
   //      }
   //      break;
   //      case ::user::e_message_prototype_erase_background:
   //      {
   ...
   //      }
   //      break;
   //      case ::user::e_message_prototype_set_focus:
   //      {
   ...
   //      }
   //      break;
   //      case ::user::e_message_prototype_non_client_calc_size:
   //      {
   ...
   //      }
   //      break;
   //      case ::user::e_message_prototype_mouse_wheel:
   //      {
   ...
   //      }
   //      break;
   //      case ::user::e_message_prototype_size:
   //      {
   ...
   //      }
   //      break;
   //      case ::user::e_message_prototype_mouse_activate:
   //      {
   ...
   //      {
   //
   //         auto pmessage = ::channel::get_message(eusermessage, wparam, lparam, eprototype);
   //
   //         pmessageBase = pmessage;
   //
   //      }
   ...
   lresult window::message_handler(::user::enum_message eusermessage, ::wparam wparam, ::lparam lparam)
   {
      ...
      if (user_interaction())
      {
         ...
         pmessage = user_interaction()->get_message(eusermessage, wparam, lparam);

      }
      else
      {

         pmessage = get_message(eusermessage, wparam, lparam);
   ...
   void window::send_message_to_descendants(::user::enum_message eusermessage, ::wparam wparam, ::lparam lparam, bool bDeep, bool bOnlyPerm)
   {
      ...
      return user_interaction()->send_message_to_descendants(eusermessage, wparam, lparam, bDeep, bOnlyPerm);
