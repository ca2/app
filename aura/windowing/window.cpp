...
//   }
   ...
   void window::message_handler(::message::message * pmessage)
   {
      ...
      if (pmessage->m_atom == e_message_post_user)
      {
         ...
         m_pwindow->message_handler(pmessagePost);

         return;

      }

      m_pwindow->message_handler(pmessage);

   }


   void window::call_create_window(::windowing::window *pwindow)
   {
...
//      copy(cgrect, rectangle);
      ...
      m_pwindow->install_message_routing(puserinteraction);
...
//   }
   ...
   ::color::color window::screen_pixel(int x, int y) const
   {
      ...
      return m_pwindow->screen_pixel(x, y);
...
//    }
   ...
   void window::on_a_system_menu_item(::operating_system::a_system_menu_item * psystemmenuitem)
   {
      ...
      else if(strActionName == "close")
      {
         ...
         m_pwindow->m_puserinteraction->post_message(e_message_close);
...
//   }
   ...
   void window::_on_configure_notify_unlocked(const ::rectangle_i32 & rectangle)
   {
      ...
      m_pwindow->m_puserinteraction->_on_configure_notify_unlocked(rectangle);
   ...
   void window::_on_reposition_notify_unlocked(const ::point_i32 & point)
   {
      ...
      m_pwindow->m_puserinteraction->_on_reposition_notify_unlocked(point);
...
//      if(m_pwindowing->get_active_window(m_pwindow->m_puserinteraction->m_pthreadUserInteraction) != this)
//      {
//
//         return false;
//
...
//   }
   ...
   bool window::configure_window_unlocked()
   {
      ...
      auto & stateOutput = m_pwindow->m_puserinteraction->layout().m_statea[::user::e_layout_design];

      // Current/Previous Window State
      auto & stateWindow = m_pwindow->m_puserinteraction->layout().m_statea[::user::e_layout_window];
   ...
   bool window::strict_set_window_position_unlocked(bool & bChangedPosition, bool & bChangedSize)
   {
      ...
      auto rectangle = m_pwindow->m_puserinteraction->const_layout().parent_raw_rectangle(::user::e_layout_design);
...
//            information() << "Offset is Not Null";
   ...
   bool window::set_window_position_unlocked()
   {
      ...
      auto & stateDesign = m_pwindow->m_puserinteraction->layout().m_statea[::user::e_layout_design];
...
//   }
   ...
   void window::frame_toggle_restore()
   {
      ...
      m_pwindow->m_puserinteraction->frame_toggle_restore();
...
//            }
   ...
   void window::on_touch_down(int xHost, int yHost, int xAbsolute, int yAbsolute)
   {
      ...
      m_pwindow->m_puserinteraction->post_message(e_message_left_button_down, 0, lparam);
   ...
   void window::on_touch_drag(int xHost, int yHost, int xAbsolute, int yAbsolute)
   {
      ...
      m_pwindow->m_puserinteraction->post_message(e_message_mouse_move, 0, lparam);
   ...
   void window::on_touch_up(int xHost, int yHost, int xAbsolute, int yAbsolute)
   {
      ...
      m_pwindow->m_puserinteraction->post_message(e_message_left_button_up, 0, lparam);
   ...
   void window::on_size(int w, int h)
   {
      ...
      m_pwindow->m_puserinteraction->post_message(e_message_size, 0, lparam);
   ...
   void window::window_update_screen()
   {
      ...
      //if (m_bUpdateScreen && (bWindowsApplyVisual || !bStartWindowVisual))
      {
         ...
         m_pwindow->m_pgraphicsthread->graphics_thread_update_screen();
...
//      }
   ...
   ::trace_statement & window::trace_statement_prefix(::trace_statement & statement) const
   {
      ...
      if(m_pwindow)
      {
         ...
         if(m_pwindow->m_puserinteraction)
         {
            ...
            m_pwindow->m_puserinteraction->raw_trace_statement_prefix(statement);
   ...
   bool window::is_windowing_popup()
   {
      ...
      return ::is_set(m_pwindow->m_puserinteraction->m_puserinteractionOwner);
   ...
   ::size_i32 window::windowing_popup_size()
   {
      ...
      auto s = m_pwindow->m_puserinteraction->const_layout().sketch().size();
   ...
   bool window::is_satellite_window()
   {
      ...
      return m_pwindow->m_puserinteraction->m_ewindowflag & e_window_flag_satellite_window;
   ...
   ::nano::windowing::window * window::owner_window()
   {
      ...
      return m_pwindow->m_puserinteraction->m_puserinteractionOwner->window();
   ...
   ::string window::get_window_text()
   {
      ...
      return m_pwindow->m_puserinteraction->get_window_text();
...
void window::set_opacity(double dOpacity)
{
 ...
 //   }
    ...
    bool
       interaction_impl::__windows_message_bypass(::windowing::window * pwindow, ::u32 message, wparam wparam, lparam lparam,
                                                  lresult & lresult)
    {
 ...
 //      m_pgraphicsthread->graphics_thread_redraw();
    ...
    void
       interaction_impl::RedrawWindow(const ::rectangle_i32 & rectangleUpdate, ::draw2d::region * prgnUpdate, ::u32 flags)
    {
