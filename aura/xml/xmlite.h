...
namespace xml
{
   ...
   // bro      2002-10-29
   //========================================================
   CLASS_DECL_AURA char * _tcsechr( const char * psz, i32 ch, i32 escape );
   ...
   // bro      2002-10-29
   //========================================================
   CLASS_DECL_AURA i32 _tcselen( i32 escape, char * srt, char * end = nullptr ) ;
   ...
   // bro      2002-10-29
   //========================================================
   CLASS_DECL_AURA void _tcsecpy(char * psz, i32 escape, const char * srt, const char * end = nullptr);
   CLASS_DECL_AURA void _tcsecpy2(char * psz, char escape, const char * srt, const char * * end = nullptr);
   ...
   // bro      2002-10-29
   //========================================================
   CLASS_DECL_AURA char * _tcsepbrk( const char * psz, const char * chset, i32 escape );
   ...
   // bro      2002-10-29
   //========================================================
   CLASS_DECL_AURA i32 _tcsenicmp( const char * psz, const char * str, strsize len, i32 escape );
   ...
   // bro      2002-10-29
   //========================================================
   CLASS_DECL_AURA char * _tcsenistr( const char * psz, const char * str, strsize len, i32 escape );
   ...
   // bro      2002-10-29
   //========================================================
   CLASS_DECL_AURA char * _tcseistr( const char * psz, const char * str, i32 escape );
...
namespace xml
{
   ...
   inline i32 ch_isspace_dup(uchar uch)
   {
