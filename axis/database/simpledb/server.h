...
namespace simpledb
{
   ...
   public:
      ...
      virtual bool _data_server_load(::database::client * pclient, const ::database::key & id, get_memory getmemory, ::subject::subject * psubject = nullptr) override;
      virtual bool _data_server_save(::database::client * pclient, const ::database::key & id, block block, ::subject::subject * psubject = nullptr) override;


      virtual bool create_server_dataset();


      virtual ::e_status initialize_simpledb_server(::context_object * pcontextobject, const char * pszDatabase);
