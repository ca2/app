...
namespace simpledb
{
   ...
   public:
      ...
      virtual bool _data_server_load(::database::client * pclient, const ::database::key & id, get_memory getmemory, ::topic * psubject = nullptr) override;
      virtual void _data_server_save(::database::client * pclient, const ::database::key & id, block block, ::topic * psubject = nullptr) override;
