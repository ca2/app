...
namespace win
{
   ...
   CLASS_DECL_AURA string error_message(u32 dwError);
...
namespace exception
{
   ...
   CLASS_DECL_AURA void throw_interface_only(const char * pszMessage = nullptr);
   CLASS_DECL_AURA void throw_not_implemented(const char * pszMessage = nullptr);
...
/*void __do_for_all_objects(void (c_cdecl *pfn)(object* pObject, void * pContext),
   void * pContext);
void ::aura::DoForAllClasses(void (c_cdecl *pfn)(::type pClass,
...
CLASS_DECL_AURA int __assert_failed_line(const char * pszFileName, int nLine);

//CLASS_DECL_AURA void TRACE(e_trace_category ecategory, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * psz);
//CLASS_DECL_AURA void __tracef(e_trace_category ecategory, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, ...);
//CLASS_DECL_AURA void __tracev(e_trace_category ecategory, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, va_list args);
CLASS_DECL_AURA void __assert_valid_object(const ::context_object * pOb, const char * pszFileName, i32 nLine);

CLASS_DECL_AURA void __dump(const ::context_object * pOb);
