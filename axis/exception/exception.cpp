...
namespace exception
{
   ...
   CLASS_DECL_AURA void throw_interface_only(const char * pszMessage)
   {
   ...
   CLASS_DECL_AURA void throw_not_implemented(const char * pszMessage)
   {
...
CLASS_DECL_AURA __pointer(::exception::exception) __trace_context_move_throw_exception(::object * trace_context, ::exception::exception * pexceptionNew)
{
