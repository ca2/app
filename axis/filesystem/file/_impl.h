...
inline stream & operator <<(stream & s, const ::tick & tick)
{
...
inline stream & operator >>(stream & s, ::tick & tick)
{
...
__pointer(BASE_TYPE) __load_object(stream & stream)
{
   ...
   __pointer(context_object) p = stream.create_object_from_text(strText);
...
template < typename BASE_TYPE >
void object::save_to(const var & varFile, BASE_TYPE * pobject)
{
...
//
//inline void __io(property & property, ::context_object & context_object)
//{
//
//   context_object.exchange(property.propset());
//
//}
//
//template < typename TYPE >
...
//void var_stream::write_object(const ::id & id, ::id & idFactory, ::context_object * pobject)
//{
...
//
//__pointer(::context_object) var_stream::read_object(const ::id & id)
//{
//   var_stream stream(new ::var(&var()[id].propset()));
//   ::id idFactory;
//   stream.exchange("", idFactory);
//   auto pobject = __id_create<::object>(idFactory);
//   pobject->exchange(stream);
//   return pobject;
//}
...
inline void __exchange(::stream & s, ::context_object & object)
{
...
inline void __exchange(::var_stream & s, ::context_object & object) { object.exchange(s); }
