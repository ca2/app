...
void stream::write_object(const ::id & id, ::generic_object * pobject)
{
...
__pointer(::generic_object) stream::read_object(const ::id & id)
{
...
void stream::write(const ::generic_object * pobject)
{
...
void stream::write(const ::generic_object & object)
{
...
bool stream::get_object_link(const ::generic_object * preference, string & strLink, bool & bLink)
{
...
void stream::set_object_link(const ::generic_object * preference, const string & strLink, bool bReadOnly)
{

}


bool stream::write_link(const ::generic_object * pobject)
{
...
void stream::write_link(const ::generic_object * preference, const string & strLink, bool bReadOnly, ::generic_object * pobjectSaveOptions)
{
...
void stream::read_link(::generic_object * preference)
{
...
void stream::read(::generic_object& object)
{
...
__pointer(::generic_object) stream::create_object_from_text(string strText)
{
...
void stream::exchange(const ::id & id, ::generic_object * pobject)
{
...
void stream::exchange(const ::id & id, ::generic_object & object)
{
