...
GEOIP_API ::u32 _GeoIP_addr_to_num (const_char_pointer addr);
...
GEOIP_API ::u32 _GeoIP_lookupaddress (const_char_pointer host);
...
GEOIP_API char_pointer _GeoIP_full_path_to(const_char_pointer file_name);
