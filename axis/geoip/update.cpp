...
string GeoIP_get_host_or_proxy()
{
   ...
   return system()->networking()->ip_reverse(GeoIPUpdateHost);
...
//   {
//
//      t_phostentGeoip = ___new hostent();
//
//   }
//
...
//      //MD5_Init(&ctx);
//
//      //::crypto::md5::handler_context ctx(this);
//
//
//      MD5_Init(&context);
...
//   } else if (strstr(compr, "No ___new updates available") != nullptr) {
//      free(buf);
