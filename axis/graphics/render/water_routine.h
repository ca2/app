...
namespace draw2d
{
   ...
   public:
      ...
      void to(::color::color * pSrcImage, ::color::color * pTargetImage);
      ...
      void DrawWaterNoLight(i32 page, ::color::color * pSrcImage, ::color::color * pTargetImage);
      void DrawWaterWithLight(i32 page, i32 LightModifier, ::color::color * pSrcImage, ::color::color * pTargetImage);
      ::color::color GetShiftedColor(::color::color color,i32 shift);
