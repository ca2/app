...
namespace html
{
   ...
   public:
      ...
      virtual element * hit_test(html_data * phtmldata, const ::f32_point & point);
      virtual element * bound_hit_test(html_data * phtmldata, const ::f32_point & point);
      virtual element * bound_hit_test(html_data * phtmldata, const ::f32_point & point, ::f64 & dMin);
