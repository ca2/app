...
namespace html
{
   ...
   public:
      ...
      static ::f32 parse_dimension(const ::scoped_string & scopedstr);
      static bool parse_border_width(const ::scoped_string & scopedstr, ::f32 & f);
      ...
      static ::f32 _parse_dimension(const ::scoped_string & scopedstr);
      static bool _parse_border_width(const ::scoped_string & scopedstr, ::f32 & f);
      static bool _parse_border_color(const ::scoped_string & scopedstr, ::color::color & color32);

      bool get_dimension(bool bParent, const_ansi_range rangeName, const ::scoped_string & scopedstrSubClass, html_data * pdata, ::html::element * pelemental, ::f32 & f);
      bool get_surround_box(const_ansi_range rangeName, const ::scoped_string & scopedstrSubClass, html_data * pdata, ::html::element * pelemental, ::f32_rectangle & rectangle);
      ...
      bool get_alpha(const ::scoped_string & scopedstrSubClass, html_data * pdata, const ::html::element * pelemental, ::f64 & d);
      ...
      bool matches_border_width(e_tag etag, const ::scoped_string & scopedstrClass, const ::scoped_string & scopedstrSubClass, const_ansi_range rangeName, ::f32 & f);
