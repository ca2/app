...
namespace html
{
   ...
   void style_sheet::parse(html_data * pdata, const_ansi_range & range)
   {
      ...
      while(range.has_character())
      {
         ...
         auto pstyle = create_newø < class style >();
   ...
   style * style_sheet::rear_find(e_tag etag, const ::scoped_string & scopedstrClass, const ::scoped_string & scopedstrSubClass, const ::scoped_string & scopedstrName)
   {
   ...
   style * style_sheet::rfind_border_color(e_tag etag, const ::scoped_string & scopedstrClass, const ::scoped_string & scopedstrSubClass, const ::scoped_string & scopedstrName, ::color::color & color32)
   {
   ...
   bool style_sheet::greater(style * & pstyleRet, ::collection::index & iRet, ::payload & varRet, style * pstyle1, ::collection::index i1, const ::payload & var1, style * pstyle2, ::collection::index i2, const ::payload & var2) const
   {
   ...
   bool style_sheet::greater(const style * & pstyleRet, ::collection::index & iRet, ::payload & varRet, const style * pstyle1, ::collection::index i1, const ::payload & var1, const style * pstyle2, ::collection::index i2, const ::payload & var2) const
   {
