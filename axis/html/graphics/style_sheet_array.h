...
namespace html
{
   ...
   public:
      ...
      bool greater(style *& pstyleRet, ::raw::index & iRet, ::payload & varRet, style * pstyle1, ::raw::index i1, const ::payload & var1, style * pstyle2, ::raw::index i2, const ::payload & var2) ;
