...
/**
 lite_html_reader
  ...
  @todo add support for tag validation, a __new interface, that
...
// Construction/Destruction
   ...
   /**
    * Sets a __new event mask.
    *
    * @lparam dwNewEventMask - __new event mask
    *
   ...
   // sets a __new value for the specified option
