...
namespace html
{
   ...
   namespace impl
   {
      ...
      void element::OnLButtonDown(::message::message* pmessage)
      {
         ...
         ::pointer<::message::mouse>pmouse = phtml->m_pmessage;
      ...
      ::collection::index element::find(element* pelemental)
      {

         for (::collection::index i = 0; i < m_pelemental->m_pparent->m_elementalptra.get_count(); i++)
         {
      ...
      element* element::get_sibling(::collection::index i)
      {
      ...
      void element::layout_phase3(html_data* pdata)
      {
         ...
         pdata->m_pcoredata->m_layoutstate3.m_x = this->left() + width() + m_margin.right;

         pdata->m_pcoredata->m_layoutstate3.m_y = this->top();
      ...
      bool element::is_tag()
      {
         ...
         return m_pelemental->m_phtmlbase->get_type() == ::html::base::type_tag;
      ...
      bool element::is_value()
      {
         ...
         return m_pelemental->m_phtmlbase->get_type() == ::html::base::type_value;
