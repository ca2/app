...
void CLASS_DECL_AXIS vfxGetRoot(const widechar * pszPath, string& wstrRoot);
...
namespace linux
{
   ...
   public:
      ...
      virtual ::extended::status open(const ::file::path & pszFileName, const enumeration < ::file::e_open > & eflag) override;
