...
CLASS_DECL_AXIS void vfxThrowFileException(::object * pobject, const ::estatus & estatus, ::i32 lOsError, const char * lpszFileName = nullptr);

CLASS_DECL_AXIS ::file::exception * get_FileException(::object * pobject, const ::estatus & estatus, ::i32 lOsError, const char * lpszFileName = nullptr);
