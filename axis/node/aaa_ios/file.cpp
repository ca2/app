...
//   }
   ...
   ::extended::status file::open(const ::file::path& path, const ::file::e_open & eopenParam)
   {
      ...
      if ((eopen & ::file::e_open_defer_create_directory) && (eopen & ::file::e_open_write))
      {
         ...
         if(!pcontext->m_pcontext->dir().mk(path.folder()))
         {
...
//void CLASS_DECL_AXIS vfxThrowFileException(::object * pobject, ::e_status cause, ::i32 lOsError, const char * lpszFileName /* == nullptr */)
//{
//
...
//
//
//::file::exception * CLASS_DECL_AXIS get_FileException(::object * pobject, ::e_status cause, ::i32 lOsError, const char * lpszFileName /* == nullptr */)
//{
//
