...
namespace macos
{
   ...
   void CLASS_DECL_AXIS __pre_init_dialog(::user::interaction * pWnd, RECTANGLE_I32 * lpRectOld, ::u32* pdwStyleOld);
...
//   }
   ...
   i32 interaction_impl::ScrollWindowEx(i32 dx, i32 dy, LPCRECT32 lpRectScroll, LPCRECT32 lpRectClip, ::draw2d::region* prgnUpdate, RECTANGLE_I32 * lpRectUpdate, ::u32 flags)
   {
...
//   }
   ...
   void interaction_impl::round_window_draw(CGContextRef cgc, CGSize sizeWindowParam)
   {
      ...
      millis tickEllapsed = tickNow - m_millisLastRoundWindowDraw;
      ...
      m_millisLastRoundWindowDraw = tickNow;
