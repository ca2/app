...
#define EDEADLOCK       EDEADLK
  ...
  /*    ::file::file_status status;
   ...
   //::u32 CLASS_DECL_AXIS vfxGetFileName(const unichar * lpszPathName, unichar * lpszTitle, ::u32 nMax)
   //{
   ...
   //void CLASS_DECL_AXIS throw_exception(__pointer(::aura::application) papp, int cause, ::i32 lOsError, const char * lpszFileName /* == nullptr */)
   //{
