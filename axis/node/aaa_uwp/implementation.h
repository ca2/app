...
//CLASS_DECL_AXIS bool __end_defer_register_class(::i32 fToRegister, const char ** ppszClass);


// Temporary ::map management (locks temp ::map on current thread)
//CLASS_DECL_AXIS void ::ca2::LockTempMaps(::context_object * pcontextobject);
...
CLASS_DECL_AXIS bool __custom_log_font(::u32 nIDS, LOGFONT* pLogFont);
CLASS_DECL_AXIS bool __get_prop_sheet_font(string & strFace, ::u16& wSize, bool bWizard);

CLASS_DECL_AXIS bool __is_combo_box_control(oswindow hWnd, ::u32 nStyle);
...
CLASS_DECL_AXIS oswindow __child_window_from_point(oswindow, POINT32);
