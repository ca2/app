...
static void __post_init_dialog(::user::interaction * pWnd,const RECT32& rectOld,u32 dwStyleOld);
...
namespace uwp
{
   ...
   static bool __modify_style(oswindow hWnd,int nStyleOffset,u32 dwRemove,u32 dwAdd,::u32 nFlags)
   {
   ...
   //                                const RECT32& rect,::user::interaction* puiParent,id id,
...
//         m_puserinteraction->get_application()->step_timer();
      ...
      *ppapp = get_application();
            ...
            pusermessage->m_id == e_message_mouse_wheel)
      {
         ...
         //{
         //   psession = psystem->query_session(0);
...
*/
   ...
   //void interaction_impl::ScrollWindow(int xAmount,int yAmount,const ::rect & rect,LPCRECT32 lpClipRect)
   //{
  ...
  /*   void interaction_impl::_001OnDeferPaintLayeredWindowBackground(::image * pimage)
   ...
   {
      UNREFERENCED_PARAMETER(pmessage);
      //      psystem->get_event(m_pthread)->SetEvent();
   ...
   void interaction_impl::CenterWindow(::user::interaction * pAlternateOwner)
   {
      ...
      ////   if (hWndCenter == nullptr)
      ////   {
      ////      oswindow hwDefault = psystem->GetMainWnd()->_get_handle();
      ...
      ////   ::MapWindowPoints(hWndCenter->_get_handle(), hWndParent->_get_handle(), (POINT32*)&rcCenter, 2);
      ////}
...
//      return ::PostMessageW(get_handle(),message,wParam,lParam) != false;
   ...
   void interaction_impl::MapWindowPoints(::user::interaction_impl * puserinteractionTo,POINT32 * lpPoint,::u32 nCount)
   {
   ...
   void interaction_impl::MapWindowPoints(::user::interaction_impl * puserinteractionTo,RECTANGLE_I32 * lpRect)
   {
      ...
      //ASSERT(::is_window(get_handle()));
      //::MapWindowPoints(get_handle(), (oswindow) puserinteractionTo->get_os_data(), (POINT32 *)lpRect, 2);
   }
  ...
  bool interaction_impl::ReleaseDC(::image * pimage)
   ...
   bool interaction_impl::RedrawWindow(const ::rect& rectUpdate, ::draw2d::region* prgnUpdate, ::u32 flags)
   {
      ...
      //if(psystem->get_twf() == nullptr)
      //   return false;

      //if(psystem->get_twf()->m_bProDevianMode)
      //   return true;
   ...
   //int interaction_impl::ScrollWindowEx(int dx,int dy,const ::rect & rectScroll,const ::rect & rectClip,::draw2d::region* prgnUpdate,RECTANGLE_I32 * lpRectUpdate,::u32 flags)
   //{
   ...
   __pointer(::user::interaction_impl) interaction_impl::WindowFromPoint(POINT32 point)
   {
   ...
   void interaction_impl::SetCaretPos(POINT32 point)
   {
   ...
   void interaction_impl::_001OnSetCursor(::message::message * pmessage)
   {
      ...
      //__pointer(::user::message) pusermessage(pmessage);
      //if(psystem->get_cursor() != nullptr
      //   && psystem->get_cursor()->m_ecursor != cursor_system)
      //{
      //   ::SetCursor(nullptr);
      //}
   ...
   //   Default();
   //}
   int interaction_impl::OnMouseActivate(::user::interaction_impl *,::u32,::u32)
   {
      return (int)Default();
   }
   ...
   */
   ...
   CLASS_DECL_BASE LRESULT __call_window_procedure(::user::interaction * pinteraction, oswindow hWnd, ::u32 nMsg, WPARAM wParam, LPARAM lParam)
   {
...
lCallNextHook:
   ...
   void interaction_impl::_001BaseWndInterfaceMap()
   {
      ...
      Sys(get_application()).window_map().set((oswindow)(iptr)(void *)get_handle(),this);
...
::user::interaction * pWnd, const RECT32& rectOld, u32 dwStyleOld)
{
...
CLASS_DECL_BASE const char * __register_window_class(::u32 nClassStyle,
...
bool CLASS_DECL_BASE __end_defer_register_class(::i32 fToRegisterParam, const char ** ppszClass)
{
