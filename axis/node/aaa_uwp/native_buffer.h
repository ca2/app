...
namespace uwp
{
   ...
   class CLASS_DECL_AXIS native_buffer:
   ...
   public:
      ...
      virtual ::status::result open(::Windows::Storage::StorageFolder ^ folder, const ::file::path & lpszfileName, const ::file::e_open & eopen);
