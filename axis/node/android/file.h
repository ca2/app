...
//void CLASS_DECL_AXIS vfxGetRoot(const unichar* pszPath, string& wstrRoot);
//
...
namespace android
{
   ...
   //   void PASCAL ThrowOsError(::object * pobject, LONG lOsError, const char * lpszFileName = nullptr);
