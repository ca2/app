...
CLASS_DECL_AXIS __pointer(::user::primitive) __get_main_window();
//CLASS_DECL_AXIS HINSTANCE CLASS_DECL_AXIS System.m_hInstance;
...
CLASS_DECL_AXIS void vfxThrowFileException(::object * pobject, const ::estatus & estatus, LONG lOsError, const char * pszFileName = nullptr);
