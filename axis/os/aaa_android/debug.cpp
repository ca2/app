...
CLASS_DECL_AXIS void simple_debug_print(const char * psz)
{
...
CLASS_DECL_AXIS int os_trace_level(enum_trace_level elevel)
{
...
CLASS_DECL_AXIS void os_trace(enum_trace_level elevel, const char * pszTag, const char * pszMessage)
{
