...
CLASS_DECL_AXIS ::u32 WINAPI MsgWaitForMultipleObjects(::u32 nCount, const HANDLE * pHandles, BOOL fWaitAll, ::u32 dwMilliseconds, ::u32 dwWakeMask);

CLASS_DECL_AXIS ::u32 WINAPI MsgWaitForMultipleObjectsEx(::u32 nCount, const HANDLE* pHandles, ::u32 dwMilliseconds, ::u32 dwWakeMask, ::u32 dwFlags);
...
// CLASS_DECL_AXIS ::u32 WINAPI GetThreadId(htask_t Thread);

// CLASS_DECL_AXIS htask_t GetCurrentThread();

// CLASS_DECL_AXIS itask_t GetCurrentThreadId();
