...
//      {
//
//         m_strBaseChannel = "aura\\appdata\\ipi\\" + string(pszKey);
//
...
//
//         ::Windows::Storage::StorageFile ^ file = ::wait(folderTopic->CreateFileAsync(wstring("aura.topic"),::Windows::Storage::CreationCollisionOption::OpenIfExists));
//
//         string strMessage;
//
...
//
//         ::Windows::Storage::StorageFile ^ f = ::wait(m_pp->folderTopic->GetFileAsync(wstring("aura.topic")));
//
//         if(f != nullptr)
//         {
//
...
//         {
//
//            ::Windows::Storage::StorageFile ^ f = ::wait(result->Folder->GetFileAsync(wstring("aura.topic")));
//
//            if(f != nullptr)
//            {
//
