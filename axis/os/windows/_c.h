...
CLASS_DECL_AXIS bool GetPrimaryMonitorRect(RECT * prect);
...
CLASS_DECL_AXIS int WinRegGetValueW(HKEY hkey, LPCWSTR pSubKey, LPCWSTR lpValue, DWORD dwFlags, LPDWORD pdwType, PVOID pvData, LPDWORD pcbData);
