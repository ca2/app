...
//   {
//      message_box(nullptr,"Cannot find driver " + string(csFilePath),"Cannot find driver " + string(csFilePath),MB_OK);
//      return 0;
//   }
//
//
...
//
//
////extern "C" CLASS_DECL_AURA void GetOpenedFiles(LPCWSTR pPath, OF_TYPE Filter, OF_CALLBACK CallBackProc, uptr pUserContext)
////
////{
////   string csPath = pPath;
////
