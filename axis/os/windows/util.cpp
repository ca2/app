...
bool CLASS_DECL_AURA __compare_class_name(oswindow oswindow, const char * pszClassName)
...
oswindow CLASS_DECL_AURA __child_window_from_point(oswindow oswindow, const ::point & pointParam)
{
