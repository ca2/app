...
CLASS_DECL_AXIS string_map < __pointer(::aura::library) >& __library()
{
...
CLASS_DECL_AXIS::aura::library& get_library(const char* psz)
{
...
CLASS_DECL_AXIS void register_library(const char* psz, ::aura::library* plibrary)
{
