...
#include "aura/primitive/comparison/equals.h"
...
#include "aura/primitive/primitive/trait_pred.h"
...
inline string CLASS_DECL_AURA operator + (const char * psz, const ::id & id)
{
...
CLASS_DECL_AURA void object_on_add_composite(const generic_object * pbase);
