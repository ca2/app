...
public:
   ...
   callback(const ::id & id = ::id(), ::generic_object* p = nullptr) : function_base(id, p) {}
   ...
   callback(const ::id & id, PRED pred, ::generic_object * pobjectHold = nullptr) : function_base(id, __new(__pred_callback < PRED >(pred, pobjectHold))) { }
   template < typename PRED >
   callback(PRED pred, ::generic_object* pobjectHold = nullptr) : callback(::id(), pred, pobjectHold) { }
...
public:
   ...
   callback_template(::generic_object* p = nullptr) : ::callback(m_idObject, p) {}
   ...
   template < typename PRED >
   callback_template(PRED pred, ::generic_object* pobjectHold = nullptr) : ::callback(pred, pobjectHold) { }
