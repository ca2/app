...
void object::set_finish()
{
   ...
   else if (strTypeName == "aura::system")
   {

      output_debug_string("aura::system::set_finish");
...
CLASS_DECL_AURA ::estatus __call(::generic_object * pobjectTask)
{
...
void object::set_context_app(::aura::application* pappContext)
{
...
void object::set_context_session(::aura::session* psessionContext)
{
...
void object::set_context_system(::aura::system* psystemContext)
{
