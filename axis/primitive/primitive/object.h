...
protected:
   ...
   __pointer(::aura::application)                     m_pappContext;
   __pointer(::aura::session)                         m_psessionContext;
   __pointer(::aura::system)                          m_psystemContext;
...
public:
   ...
   inline ::aura::application * get_context_application() { return m_pappContext.m_p; }
   ...
   ::aura::application * get_context_application() const { return m_pappContext; }

   ::aura::session * get_context_session() const { return m_psessionContext; }

   ::aura::system * get_context_system() const { return m_psystemContext; }

   //::object * get_context_user() const { return m_puserContext; }

   ::aura::application * get_app() const { return get_context_application(); }
   ...
   virtual void set_context_app(::aura::application* pappContext);
   virtual void set_context_session(::aura::session* psessionContext);
   virtual void set_context_system(::aura::system* psystemContext);
   ...
   inline void set_context_app(::aura::application* pappContext);
   inline void set_context_session(::aura::session* psessionContext);
   inline void set_context_system(::aura::system* psystemContext);
...
CLASS_DECL_AURA ::estatus call_sync(const runnable_array & runnablea);
