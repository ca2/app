...
var CLASS_DECL_AURA operator - (i32 i, const property & prop);
var CLASS_DECL_AURA operator - (u32 user, const property & prop);
var CLASS_DECL_AURA operator - (i64 i, const property & prop);
var CLASS_DECL_AURA operator - (u64 ui, const property & prop);
...
class CLASS_DECL_AURA property : public var
{
public:
...
//    - plus: doesn't generic_object parent property set? m_ppropertyset
//class CLASS_DECL_AURA property : public var
...
////   //property(property_set * pset, const id & strName, const var & var, ::generic_object * pobject = nullptr);
...
////
////
////   property & operator =(::generic_object * p)
////   {
////
////      m_var = p;
////
...
CLASS_DECL_AURA void property_parse_json_id(id & id, const char *& pszJson, const char * pszEnd);
CLASS_DECL_AURA void property_parse_json_value(::var & var, const char *& pszJson, const char * pszEnd);
CLASS_DECL_AURA void property_skip_json_id(const char *& pszJson, const char * pszEnd);
CLASS_DECL_AURA void property_skip_json_value(const char *& pszJson, const char * pszEnd);


#include "aura/primitive/collection/ptr_array.h"
...
inline var CLASS_DECL_AURA operator - (i32 i, const property& prop) { return operator - (i, (const ::var &) prop); }
inline var CLASS_DECL_AURA operator - (u32 user, const property& prop) { return operator - (user, (const ::var &)prop); }
inline var CLASS_DECL_AURA operator - (i64 i, const property& prop) { return operator - (i, (const ::var &)prop); }
inline var CLASS_DECL_AURA operator - (u64 ui, const property& prop) { return operator - (ui, (const ::var &)prop); }
inline var CLASS_DECL_AURA operator - (double d, const property& prop) { return operator - (d, (const ::var &)prop); }
inline var CLASS_DECL_AURA operator - (const var& var, const property& prop) { return operator - (var, (const ::var &)prop); }
