...
CLASS_DECL_AURA bool demangle(string & str, const char * psz);
CLASS_DECL_AURA bool demangle(string & str);

namespace str
{


   CLASS_DECL_AURA string demangle(const char * psz);
...
public:
   ...
   type(const ::generic_object * pobject);
   ...
   bool operator == (const ::generic_object * pobject) const
   {
   ...
   //inline __pointer(generic_object) alloc(::object * pobject) const;
...
inline CLASS_DECL_AURA string get_demangle(const char * lpszName)
{
