...
//   var & operator = (const string_composite & reference);
   ...
   friend bool CLASS_DECL_AURA strict_equal(::i32 i,const var & var);
   ...
   friend bool CLASS_DECL_AURA strict_different(::i32 i,const var & var);
   ...
   friend var CLASS_DECL_AURA operator - (::i32 i,const var & var);
   friend var CLASS_DECL_AURA operator - (::u32 ui,const var & var);
   friend var CLASS_DECL_AURA operator - (::i64 l,const var & var);
   friend var CLASS_DECL_AURA operator - (::u64 ul,const var & var);
...
namespace str
{
   ...
   inline CLASS_DECL_AURA void from(string & str, const var & var)
   {
...
CLASS_DECL_AURA void var_skip_number(const char *& psz);
CLASS_DECL_AURA void var_skip_number(const char *& psz, const char * pszEnd);
CLASS_DECL_AURA void var_skip_identifier(const char *& psz);
CLASS_DECL_AURA void var_skip_identifier(const char *& psz, const char * pszEnd);
CLASS_DECL_AURA void var_skip_json(const char *& pszJson);
CLASS_DECL_AURA void var_skip_json(const char *& pszJson, const char * pszEnd);
