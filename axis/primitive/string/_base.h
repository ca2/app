...
inline string CLASS_DECL_AURA operator + (const char * psz, const ::string & str);
inline string CLASS_DECL_AURA operator + (ansichar ansich, const ::string & str);
inline string CLASS_DECL_AURA operator + (wd16char wd16ch, const ::string & str);
inline string CLASS_DECL_AURA operator + (wd16char wd32ch, const ::string & str);
