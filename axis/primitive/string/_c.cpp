...
const char* wildcard_next_stop(const char* pszCriteria)
{
   ...
   CLASS_DECL_AURA int_bool matches_wildcard_criteria_ci(const ansichar * pszCriteriaParam, const ansichar * pszValue)
   {
   ...
   CLASS_DECL_AURA int_bool matches_wildcard_criteria(const ansichar * pszCriteriaParam, const ansichar * pszValue)
   {
   ...
   //CLASS_DECL_AURA const char* ansi_concatenate_and_duplicate(const char* psz1, const char* psz2)
   //{
