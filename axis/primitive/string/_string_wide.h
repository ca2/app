...
template < typename TYPE >
inline CLASS_DECL_AURA wstring operator + (const wstring & wstr, const tostring < TYPE > & o);

template < typename TYPE >
inline CLASS_DECL_AURA wstring operator + (const tostring < TYPE > & o, const wstring & wstr);
