...
namespace user
{
   ...
   //   auto pdescriptor = allocateø ::user::control_descriptor();
...
//         }
   ...
   void form_control::_017OnAppLanguage()
   {
      ...
      //      {
      //         //               ::platform::type ti = typeid(descriptor.m_pcontrol);
   ...
   //   øconstruct_by_id(pparticle, pdescriptor->m_type);
...
//   }
   ...
   //void form_control::on_before_navigate(::payload & payloadFile,::u32 nFlags, const ::scoped_string & scopedstrTargetFrameName,byte_array& baPostedData, const ::scoped_string & scopedstrHeaders,bool* pbCancel)
   ...
   void form_control::on_timer(::timer * ptimer)
   {
      ...
      if(m_pcallback != nullptr)
      {
         ...
         auto pextendedtopic = allocateø ::extended_topic(id_timer);
...
//      }
   ...
   //::platform::type form_control::controltype_to_typeinfo(::user::enum_control_type econtroltype)
   //{
