...
namespace user
{
   ...
   void list_box::on_message_key_down(::message::message* pmessage)
   {
      ...
      else if (pkey->m_ekey == ::user::e_key_down)
      {
         ...
         m_pcombo->m_pitemHover = allocateø ::item(e_element_item, minimum(m_pcombo->m_pitemHover->m_item.m_iItem + 1, m_pcombo->_001GetListCount() - 1));

      }
      else if (pkey->m_ekey == ::user::e_key_up)
      {

         m_pcombo->m_pitemHover = allocateø ::item(e_element_item, maximum(m_pcombo->m_pitemHover->m_item.m_iItem - 1, 0));
   ...
   ::item_pointer list_box::on_hit_test(const ::int_point& point, ::user::e_zorder ezorder)
   {
      ...
      if (rectangleItem.contains(point))
      {
         ...
         return allocateø ::item(e_element_search_edit);
   ...
   void list_box::on_drop_down(const ::int_rectangle& rectangleWindow, const ::int_size& sizeFull)
   {
      ...
      if (!::is_set(m_pcombo->m_pitemHover))
      {
         ...
         m_pcombo->m_pitemHover = allocateø ::item(::e_element_item, 0);
...
//      }
   ...
   void list_box::set_current_item_by_atom(const ::atom& atom, const ::action_context& context)
   {
      ...
      set_current_item(allocateø ::item(::e_element_item, iSel), context);
   ...
   void list_box::set_current_item_by_index(::collection::index iIndex, const ::action_context& context)
   {
      ...
      set_current_item(allocateø ::item(::e_element_item, iIndex), context);
