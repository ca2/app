...
namespace xml
{
   ...
   CLASS_DECL_AXIS string from(const property* pprop, ::xml::disp_option* opt /*= &optDefault*/)
   {
   ...
   CLASS_DECL_AXIS string from(const property & prop, ::xml::disp_option * opt /*= &optDefault*/)
   {
      //   ::text_stream ostring;
