...
namespace xml
{
   ...
   public:
      ...
      node *                  get_child_with_attribute(const char * pcszName, const ::id & idAttribute, const var & varAttribute, index iStart = 0);
      ...
      ::property *            set_attribute(const ::id & id, const var & var = ::type_new);
