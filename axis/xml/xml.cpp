...
// CLASS_DECL_AXIS void xml_export(::object * pobject, string & strXml, xml::exportable & exportable)
// {
...
// CLASS_DECL_AXIS void xml_import(::object * pobject, xml::importable & importable, string & strXml)
// {
