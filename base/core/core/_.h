...
extern "C"
CLASS_DECL_BASE int_bool defer_core_init();
extern "C"
CLASS_DECL_BASE int_bool defer_core_term();
...
namespace base
{
   ...
   CLASS_DECL_BASE void format_strings(string & rString, const char * pszFormat, const char * const* rgpsz, i32 nString);

   CLASS_DECL_BASE bool extract_sub_string(string & rString, const char * pszFullString, i32 iSubString, char chSep = '\n');
