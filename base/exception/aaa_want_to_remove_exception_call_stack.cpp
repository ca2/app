...
CLASS_DECL_AURA  __pointer(callstack) get_callstack(const char* pszFormat, iptr iSkip, void* caller_address, iptr iCount)
{
...
CLASS_DECL_AURA __pointer(callstack) get_callstack(e_callstack ecallstack, int iCallStackAddUp)
{
...
//CLASS_DECL_AURA bool is_callstack_enabled(e_callstack ecallstack)
//{
//
