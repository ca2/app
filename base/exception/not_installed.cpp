...
// not_installed::not_installed(::object * pobject = ::get_app_object(), const char * pszAppId, const char * pszConfiguration, const char * pszPlatform, const char * pszLocale, const char * pszSchema) :
//    ::object(pobject),
//    ::callstack(pobject),
//    ::exception::exception()
// {
