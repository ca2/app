...
void binary_stream::write(const var & var)
{
   ...
   *this << i;
   ...
   case type_path:
   {
      ...
      __save_object(*this, var.cast < ::generic_object >());
...
void binary_stream::write(const generic_object * pobject)
{
...
void binary_stream::write(const generic_object& object)
{
...
//void binary_stream::write_file(const ::file::path & path, const ::generic_object & object)
//{
//
//   if (path.is_empty())
//   {
...
//
//
//void binary_stream::read_file(const ::file::path & path, ::generic_object & object)
//{
//
//   if (path.is_empty())
//   {
...
//void binary_stream::write_link(const string & strLink, const ::generic_object & object)
//{
//
//   ::file::path path = get_link_path(object);
//
//   if (path.is_empty())
//   {
//
...
//
//
//void binary_stream::read_link(const string & strLink, ::generic_object & object)
//{
//
...
//
//
//bool binary_stream::get_object_link(const ::generic_object & generic_object, string & strLink, bool & bLink)
//{
//
//   return false;
//
...
//
//
//void binary_stream::set_object_link(const ::generic_object & generic_object, const string & strLink, bool bReadOnly)
//{
//
//}
//
//
//void binary_stream::write_link(const ::generic_object & object)
//{
//
//   string strLink;
//
//   bool bReadOnly;
//
//   if (get_object_link(object, strLink, bReadOnly))
//   {
//
//      write_link(object, strLink, bReadOnly);
//
//   }
//
//   return;
...
//
//
//void binary_stream::write_link(const ::generic_object & object, const string & strLink, bool bReadOnly)
//{
//
//   write(bReadOnly);
//
...
//}
//
//void binary_stream::read_link(::generic_object & object)
//{
//
//   string strLink;
//
...
//   //}
//
//   set_object_link(object, strLink, bReadOnly);
//
//
//   if (strLink.has_char())
//   {
//
//      read_link(strLink, object);
//
//   }
//
//   return;
...
bool binary_stream::get_object_link(const ::generic_object * preference, string & strLink, bool & bLink)
{
...
void binary_stream::set_object_link(const ::generic_object * preference, const string & strLink, bool bReadOnly)
{

}


bool binary_stream::write_link(const ::generic_object * pobject)
{
...
void binary_stream::write_link(const ::generic_object * preference, const string & strLink, bool bReadOnly, ::object * pobjectSaveOptions)
{
...
void binary_stream::read_link(::generic_object * preference)
{
...
void binary_stream::read_var_body(var & var, e_type etype)
{
   ...
   case type_path:
   {
      ...
      var.set_element(::__load_object<::generic_object>(*this));
...
void binary_stream::read(generic_object & object)
{
...
__pointer(::generic_object) binary_stream::create_object_from_text(string strText)
{
   ...
   return get_context_object()->__id_create < ::generic_object >(id);
