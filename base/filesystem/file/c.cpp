...
CLASS_DECL_AURA bool file_save_stra(const char * lpszName, const string_array & stra)
{
...
CLASS_DECL_AURA bool file_load_stra(const char * lpszName, string_array & stra, bool bAddEmpty)
{
