...
//   m_pfile(pfile)
//   //::context_object(pfile->get_object()),
...
//
//
//stream::stream(e_create_new, ::object * pobject, index iVersion) :
...
////
////
////   byte_stream_memory_file::byte_stream_memory_file(::object * pobject) :
////      ::object(pobject)
////   {
////
////      m_pfile = this;
