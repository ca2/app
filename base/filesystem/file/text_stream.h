...
inline void __string_exchange(stream & s, var & var);
...
//inline void __string_exchange(text_stream & s, ::context_object & object);
...
class CLASS_DECL_AURA text_stream :
   public stream
{
public:
   ...
   //virtual void json_write(const ::context_object & object);
...
class CLASS_DECL_AURA string_stream :
   public text_stream
{
public:
   ...
   operator string & () {return __cast < string_file >(m_p)->m_str; }
