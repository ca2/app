...
namespace file
{
   ...
   struct CLASS_DECL_AURA path_os
   {
   ...
   CLASS_DECL_AURA bool begins_eat_ci(string & str, const char * pcszPrefix);
...
inline ::file::path CLASS_DECL_AURA operator / (const ansichar * psz, const ::file::path & pathConcat)
{
