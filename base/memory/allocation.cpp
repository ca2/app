...
//CLASS_DECL_AURA void * ace_memory_alloc(memsize s)
//{
//
//#if OSBIT == 32
//
...
//
//
//CLASS_DECL_AURA void * ace_memory_realloc(void * pParam, memsize s)
//{
//
//
//#if OSBIT == 32
...
//
//
//CLASS_DECL_AURA void ace_memory_free(void * pParam)
//{
//
//   u8 * pdata = (u8 *)pParam;
//
...
//
//
//CLASS_DECL_AURA memsize ace_memory_size(void * pParam)
//{
//
...
//
//
//CLASS_DECL_AURA void ace_set_alloc(PFN_MEMORY_ALLOC palloc, PFN_MEMORY_REALLOC prealloc, PFN_MEMORY_FREE pfree, PFN_MEMORY_SIZE psize)
//{
//
