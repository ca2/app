...
namespace sockets
{
   ...
   i32 SctpSocket::Bind(const ::net::address & ad)
   {
      if (!ad.IsValid())
      {
   ...
   i32 SctpSocket::AddAddress(const ::net::address & ad)
   {
      if (!ad.IsValid())
      {
         ERR("SctpSocket", -1, "invalid address");
   ...
   i32 SctpSocket::RemoveAddress(const ::net::address & ad)
   {
      if (!ad.IsValid())
      {
         ERR("SctpSocket", -1, "invalid address");
   ...
   i32 SctpSocket::open(const ::net::address & ad)
   {
      if (!ad.IsValid())
      {
         ERR("SctpSocket", -1, "invalid address");
   ...
   i32 SctpSocket::AddConnection(const ::net::address & ad)
   {
      if (!ad.IsValid())
      {
         ERR("SctpSocket", -1, "invalid address");
