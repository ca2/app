...
void array_base < TYPE, ARG_TYPE, ALLOCATOR >::free_extra()
{
   ...
   if(m_nSize != m_nMaxSize)
   {
      ...
      if(m_nSize != 0)
      {
         ...
         ::aura::memcpy_s(pNewData, (size_t)m_nSize * sizeof(TYPE),m_pData, (size_t)m_nSize * sizeof(TYPE));
      }
...
::index array_base < TYPE, ARG_TYPE, ALLOCATOR >::insert_at(::index nIndex,const TYPE & newElement,::count nCount /*=1*/)
{
   ...
   else
   {
      ...
      ::aura::memmove_s(m_pData + nIndex + nCount,(size_t) ((nOldSize - nIndex) * sizeof(TYPE)),m_pData + nIndex,(size_t)((nOldSize - nIndex) * sizeof(TYPE)));
