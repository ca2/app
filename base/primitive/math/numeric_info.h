...
namespace numeric_info_internal
{
   ...
   template < >
   class CLASS_DECL_AURA numeric_info < i8 > :
   ...
   template < >
   class CLASS_DECL_AURA numeric_info < u8 > :
      public numeric_integer_base
   {
   public:
   ...
   template < >
   class CLASS_DECL_AURA numeric_info < i16 > :
      public numeric_integer_base
   {
   public:
   ...
   template < >
   class CLASS_DECL_AURA numeric_info < u16 > :
      public numeric_integer_base
   {
   public:
   ...
   template < >
   class CLASS_DECL_AURA numeric_info < i32 > :
      public numeric_integer_base
   {
   public:
   ...
   template < >
   class CLASS_DECL_AURA numeric_info < u32 > :
      public numeric_integer_base
   {
   public:
   ...
   template < >
   class CLASS_DECL_AURA numeric_info < i64 > :
      public numeric_integer_base
   {
   public:
   ...
   template < >
   class CLASS_DECL_AURA numeric_info < u64 >:
      public numeric_integer_base
   {
   public:
