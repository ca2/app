...
//      {
//
//         output_debug_string("\nHI!! Shouldn't you use a generic_object find this by use generic_object and set a breakpoint here!!!\n");
//         m_id = property.m_id;
//
//      }
//
...
//
//
////property::property(property_set * pset, const id & id, const var &  var, ::generic_object * pobject) :
////   m_ppropertyset(pset),
////   m_var(var)
////{
////
...
//
//
////property_ptra::property_ptra(::object * pobject):
////   ::object(pobject)
////{
////   set_size(0, 64);
////}
