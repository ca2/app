...
CLASS_DECL_AURA void property_set_skip_json(const char *& pszJson);
CLASS_DECL_AURA void property_set_skip_json(const char *& pszJson, const char * pszEnd);
...
//
   ...
   //class CLASS_DECL_AURA localini :
   //   public ini
   //{
   //public:

   //   localini(::object * pobject);
