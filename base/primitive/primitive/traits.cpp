...
//
//
////void traits::set_action(::object * pobjectFork, const ::trait & traitPayload)
////{
////
...
////
////
////void traits::set_result(::u64 uId, ::u64 uPromisse, ::context_object * preference)
////{
////
////   if(uPromisse == 0)
////   {
...
////
////
////void trait::_notify(::object * pobject)
////{
////
...
////
////
////void trait::_call_notify(::object * pobject)
////{
////
...
////
////
////thread_pointer trait::_fork_notify(::object * pobject)
////{
////
////   if(m_pobjectTaskaNotify) return nullptr;
////
////   __pointer(::object) p(pobject);
////
...
////
////
////thread_spa trait::_fork_notify_each(::object * pobjectFork)
////{
////
////   thread_spa threada;
////
...
////
////
////void trait::fork(::object * pobject)
////{
////
////   if (is_traited())
////   {
