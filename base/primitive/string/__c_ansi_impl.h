...
//CLASS_DECL_AURA const ansichar * ansi_concatenate_duplicate_and_free(const ansichar * psz1, ansichar * psz2)
//{
//
...
//CLASS_DECL_AURA const ansichar * ansi_concatenate_free_and_duplicate(ansichar * psz1, const ansichar * psz2)
//{
//
//   strsize len1 = strlen(psz1);
//
...
//CLASS_DECL_AURA const ansichar * ansi_concatenat_free_duplicate_and_free(ansichar * psz1, ansichar * psz2)
//{
//
//   strsize len1 = strlen(psz1);
//
