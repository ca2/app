...
//CLASS_DECL_AURA const wd16char * wd16_concatenate_duplicate_and_free(const wd16char * psz1, wd16char * psz2)
//{
//
...
//CLASS_DECL_AURA const wd16char * wd16_concatenate_free_and_duplicate(wd16char * psz1, const wd16char * psz2)
//{
//
//   strsize len1 = wd16_len(psz1);
//
...
//CLASS_DECL_AURA const wd16char * wd16_concatenat_free_duplicate_and_free(wd16char * psz1, wd16char * psz2)
//{
//
//   strsize len1 = wd16_len(psz1);
//
...
//CLASS_DECL_AURA const void * memory_find_memory(const void * src, strsize srclen, const void * find, strsize findlen)
//{
//
