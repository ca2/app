...
CLASS_DECL_AURA strsize wd16_to_wd32_len(const wd16char* pcwsz, strsize input_size = -1);
CLASS_DECL_AURA strsize wd16_to_wd32(wd32char* pwsz, const wd16char* pcwsz, strsize input_size = -1);

CLASS_DECL_AURA wd32char* wd16_to_wd32_dup(const wd16char* pcwsz, strsize input_size = -1);



CLASS_DECL_AURA strsize wd32_to_wd16_len(const wd32char* pcwsz, strsize input_size = -1);
CLASS_DECL_AURA strsize wd32_to_wd16(wd16char * pwsz, const wd32char* pcwsz, strsize input_size = -1);

CLASS_DECL_AURA wd16char* wd32_to_wd16_dup(const wd16char* pcwsz, strsize input_size = -1);
...
CLASS_DECL_AURA strsize utf16_len(const wd16char* psz);
CLASS_DECL_AURA const wd16char* utf16_inc(const wd16char* psz);

CLASS_DECL_AURA strsize ansi_to_wd16_len(const char* psz, strsize srclen = -1);
CLASS_DECL_AURA strsize ansi_to_wd16(wd16char* pwsz, const char* psz, strsize srclen = -1);

CLASS_DECL_AURA wd16char * ansi_to_wd16_dup(const char * input, strsize input_size);


CLASS_DECL_AURA strsize wd16_to_ansi_len(const wd16char* pwsz, strsize srclen = -1);
CLASS_DECL_AURA strsize wd16_to_ansi(char* psz, const wd16char* pwsz, strsize srclen = -11);

CLASS_DECL_AURA char * wd16_to_ansi_dup(const wd16char * input, strsize input_size);





CLASS_DECL_AURA strsize utf32_len(const wd32char* psz);
CLASS_DECL_AURA const wd32char* utf32_inc(const wd32char* psz);

CLASS_DECL_AURA strsize ansi_to_wd32_len(const char* psz, strsize srclen = -1);
CLASS_DECL_AURA strsize ansi_to_wd32(wd32char* pwsz, const char* psz, strsize srclen = -1);

CLASS_DECL_AURA wd32char* ansi_to_wd32_dup(const char* pcwsz, strsize input_size = -1);


CLASS_DECL_AURA strsize wd32_to_ansi_len(const wd32char* pwsz, strsize srclen = -1);
CLASS_DECL_AURA strsize wd32_to_ansi(char* psz, const wd32char* pwsz, strsize srclen = -1);

CLASS_DECL_AURA char * wd32_to_ansi_dup(const wd32char * input, strsize input_size);
