...
CLASS_DECL_AURA string i64toa_dup(i64 i, i32 iBase);
CLASS_DECL_AURA string i64toa_dup(i64 i);

CLASS_DECL_AURA string ui64toa_dup(i64 i, i32 iBase);
CLASS_DECL_AURA string ui64toa_dup(i64 i);
