...
public:
   ...
   i32 SetTrackingPos(const ::point_i32 & point);
   i32 GetTrackSize(::size_i32 & size);
   bool GetTrackClientRect(::rectangle_i32 * prectangle);

   ::status < ::rectangle_i32 > get_track_rectangle() override;
   ...
   virtual bool scrollbar_action(const ::item * pitem);

   virtual bool scrollbar_lineA();
   virtual bool scrollbar_lineB();
   virtual bool scrollbar_pageB(const ::point_i32 & point);
   virtual bool scrollbar_pageA(const ::point_i32 & point);
