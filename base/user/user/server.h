...
namespace user
{
   ...
   public:
      ...
      virtual ::user::document* open_document_file(::apex::application* pappOnBehalfOf, var varFile, bool bMakeVisible = true, ::user::interaction* puiParent = nullptr, ewindowflag eflag = ewindowflag(), ::id id = ::id());
