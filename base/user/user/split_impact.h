...
//      // void dump(dump_context & dumpcontext) const override;
      ...
      template < class VIEW >
      inline ::pointer<VIEW>create_pane_impact(::raw::index iPane, atom atom = ::atom(), ::user::interaction * pviewLast = nullptr);
      ::pointer<::user::impact>create_pane_impact(const ::type_atom & typeatom, ::raw::index iPane, atom atom = ::atom(), ::user::interaction * pviewLast = nullptr);
