...
namespace user
{
   ...
   bool tab_callback::_001IsAddTab(tab * ptab, ::raw::index iTab)
   {
   ...
   void tab_callback::_001OnTabClick(tab * ptab, ::raw::index iTab)
   {
   ...
   void tab_callback::_001OnTabClose(tab * ptab, ::raw::index iTab)
   {
   ...
   ::user::interaction * tab_callback::_001GetTabWnd(::raw::index iTab)
   {
      __UNREFERENCED_PARAMETER(iTab);
      return nullptr;
   }
   ...
   void tab_callback::_001OnDropTab(::raw::index iTab, enum_position eposition)
   {
      __UNREFERENCED_PARAMETER(iTab);
