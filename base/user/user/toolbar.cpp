...
//      }
      ...
      for (index iItem = 0; iItem < children.get_size(); iItem++)
      {
         ...
         if (pchild->get_name() == "button")
         {
            ...
            ptoolitem->m_atom = pattributeId->get_string();
            ...
            if (pchild->attribute("hidden").get_string().case_insensitive_order("true") == 0)
            {
            ...
            if (pchild->attribute("enable_if_has_command_handler").has_char())
            {
               ...
               ptoolitem->m_bEnableIfHasCommandHandler = pchild->attribute("enable_if_has_command_handler").get_string().case_insensitive_order("true") == 0;
