...
ID3_C_EXPORT ID3_Frame* ID3_AddArtist(ID3_Tag*, const ::string &, bool replace = false);
ID3_C_EXPORT size_t     ID3_RemoveArtists(ID3_Tag*);

ID3_C_EXPORT char*      ID3_GetAlbum(const ID3_Tag*);
ID3_C_EXPORT ID3_Frame* ID3_AddAlbum(ID3_Tag*, const ::string &, bool replace = false);
ID3_C_EXPORT size_t     ID3_RemoveAlbums(ID3_Tag*);

ID3_C_EXPORT char*      ID3_GetTitle(const ID3_Tag*);
ID3_C_EXPORT ID3_Frame* ID3_AddTitle(ID3_Tag*, const ::string &, bool replace = false);
ID3_C_EXPORT size_t     ID3_RemoveTitles(ID3_Tag*);

ID3_C_EXPORT char*      ID3_GetYear(const ID3_Tag*);
ID3_C_EXPORT ID3_Frame* ID3_AddYear(ID3_Tag*, const ::string &, bool replace = false);
ID3_C_EXPORT size_t     ID3_RemoveYears(ID3_Tag*);

ID3_C_EXPORT char*      ID3_GetComment(const ID3_Tag*, const ::string & desc = NULL);
ID3_C_EXPORT ID3_Frame* ID3_AddComment(ID3_Tag*, const ::string &, bool = false);
ID3_C_EXPORT ID3_Frame* ID3_AddComment(ID3_Tag*, const ::string &, const ::string &, bool = false);
ID3_C_EXPORT ID3_Frame* ID3_AddComment(ID3_Tag*, const ::string &, const ::string &, const ::string &,
                                       bool = false);
ID3_C_EXPORT size_t     ID3_RemoveComments(ID3_Tag*, const ::string & = NULL);
...
//following routine courtesy of John George
ID3_C_EXPORT ID3_Frame* ID3_AddGenre(ID3_Tag*, const ::string &, bool replace = false);
ID3_C_EXPORT size_t     ID3_RemoveGenres(ID3_Tag*);

ID3_C_EXPORT char*      ID3_GetLyrics(const ID3_Tag*);
ID3_C_EXPORT ID3_Frame* ID3_AddLyrics(ID3_Tag*, const ::string &, bool = false);
ID3_C_EXPORT ID3_Frame* ID3_AddLyrics(ID3_Tag*, const ::string &, const ::string &, bool = false);
ID3_C_EXPORT ID3_Frame* ID3_AddLyrics(ID3_Tag*, const ::string &, const ::string &, const ::string &,
                                      bool = false);
ID3_C_EXPORT size_t     ID3_RemoveLyrics(ID3_Tag*);

ID3_C_EXPORT char*      ID3_GetLyricist(const ID3_Tag*);
ID3_C_EXPORT ID3_Frame* ID3_AddLyricist(ID3_Tag *, const ::string &, bool replace = false);
...
ID3_C_EXPORT ID3_Frame* ID3_AddSyncLyrics(ID3_Tag*, const uchar*, size_t,
                                          ID3_TimeStampFormat, const ::string &, bool = false);
ID3_C_EXPORT ID3_Frame* ID3_AddSyncLyrics(ID3_Tag*, const uchar*, size_t,
                                          ID3_TimeStampFormat, const ::string &, const ::string &,
                                          bool = false);
ID3_C_EXPORT ID3_Frame* ID3_AddSyncLyrics(ID3_Tag*, const uchar*, size_t,
                                          ID3_TimeStampFormat, const ::string &, const ::string &,
                                          ID3_ContentType, bool = false);
ID3_C_EXPORT ID3_Frame* ID3_GetSyncLyricsInfo(const ID3_Tag *tag, const ::string &lang,
                                              const char *desc, char &stampformat,
                                              char &type, size_t &size);
ID3_C_EXPORT ID3_Frame* ID3_GetSyncLyrics(const ID3_Tag* tag, const ::string & lang,
                                          const char* desc, const uchar* &pData, size_t& size);


//following routine courtesy of John George
ID3_C_EXPORT int ID3_GetPictureData(const ID3_Tag*, const ::string & TempPicPath);
...
ID3_C_EXPORT ID3_Frame* ID3_AddPicture(ID3_Tag*, const ::string & TempPicPath, const ::string & MimeType, bool replace = false);
ID3_C_EXPORT ID3_Frame* ID3_AddPicture(ID3_Tag*, const ::string & TempPicPath, const ::string & MimeType, ID3_PictureType pictype, const ::string & Description, bool replace = false);

//following routine courtesy of John George
ID3_C_EXPORT size_t ID3_RemovePictures(ID3_Tag*);

//following routine courtesy of John George
ID3_C_EXPORT size_t ID3_GetPictureDataOfPicType(ID3_Tag*, const ::string & TempPicPath, ID3_PictureType pictype);
