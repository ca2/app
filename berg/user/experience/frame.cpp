   ...
   void frame::on_initialize_appearance()
   {
      ...
      if (m_pframewindow->m_bWindowFrame)
      {
         ...
         if (!m_pcontrolbox)
         {
            ...
            m_pcontrolbox = createø < ::experience::control_box >(m_pexperience->m_pfactory);
...
//         }
   ...
   void frame::__defer_frame_placement_snapping()
   {
      ...
      strType = ::platform::type(m_pframewindow).name();
   ...
   void frame::sync_dock_grip_border()
   {
      ...
      string strType = ::platform::type(m_pframewindow).name();
