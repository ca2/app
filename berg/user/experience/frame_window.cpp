...
namespace experience
{
   ...
   void frame_window::install_message_routing(::channel * pchannel)
   {
      ...
      //USER_MESSAGE_LINK(::user::e_message_parent_left_button_f64_click, pchannel, this, &frame_window::on_message_parent_left_button_f64_click);
      ...
      USER_MESSAGE_LINK(::user::e_message_left_button_f64_click, pchannel, this, &frame_window::on_message_left_button_f64_click);
...
//   }
   ...
   void frame_window::on_message_left_button_f64_click(::message::message * pmessage)
   {
      ...
      m_pframe->on_message_left_button_f64_click(pmouse);
