...
namespace user
{
   ...
   class CLASS_DECL_BERG menu_list_window :
   ...
   public:
      ...
      virtual void layout_buttons(::menu::item * pitemParent, int iMaxWidth, ::i32_rectangle * prectangle, const ::i32_rectangle & lpcrectBound);
