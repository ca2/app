                          ...
                          try
                           {
                              ...
                              defer_constructø(m_pnotifyicon);
...
//
//      //auto estatus = 
//      defer_constructø(m_pimageAlpha);
//
//      //if(estatus.succeeded())
//      //{
//
      ...
      else
      {
         ...
         if (rectangleX.size() != m_pimageBk->size())
         {
...

            {
               ...
               pdraw2dgraphicsImageBk->clear(::argb(0, 200, 200, 190));
         ...
         if (m_pimageBlur->is_ok())
         {
...

            {
               ...
               auto pdraw2dgraphicsImageBlur = m_pimageBlur->acquire_graphics();

               pdraw2dgraphicsImageBlur->draw(imagedrawing);
...
void simple_frame_window::handle(::topic * ptopic, ::handler_context * phandlercontext)
{
