...
public:
   ...
   //::double_point_array get_arrowA(const ::i32_rectangle & rectangleX, ::draw2d::graphics_pointer & pgraphics);

   //::double_point_array get_arrowB(const ::i32_rectangle & rectangleX, ::draw2d::graphics_pointer & pgraphics);
   ...
   void UpdateBitmaps();
   //void OnDisplayChange(int iBitsPerPixel, ::i32_size sizeScreen);
   ...
   //int SetTrackingPos(const ::i32_point & point, ::draw2d::graphics_pointer & pgraphics);
   //int GetTrackSize(::i32_size & size, ::draw2d::graphics_pointer & pgraphics);
   ...
   void draw_mac_thumb_simple(::draw2d::graphics_pointer & pgraphics,const ::i32_rectangle & rectangleDraw,const ::i32_rectangle & lpcrectClip,unsigned char uchAlpha);

   void draw_mac_thumb_dots(::draw2d::graphics_pointer & pgraphics,const ::i32_rectangle & rectangleDraw,const ::i32_rectangle & lpcrectClip,unsigned char uchAlpha);
