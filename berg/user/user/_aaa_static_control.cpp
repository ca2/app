...
//
//      MESSAGE_LINK(::user::e_message_create, pchannel, this, &static_control::on_message_create);
//      MESSAGE_LINK(::user::e_message_left_button_down, pchannel, this, &static_control::on_message_left_button_down);
//      MESSAGE_LINK(::user::e_message_left_button_up, pchannel, this, &static_control::on_message_left_button_up);
//      MESSAGE_LINK(::user::e_message_mouse_move, pchannel, this, &static_control::on_message_mouse_leave);
//      MESSAGE_LINK(::user::e_message_mouse_leave, pchannel, this, &static_control::on_message_mouse_move);
//
//   }
//
