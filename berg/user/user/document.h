...
namespace user
{
   ...
   public:
      ...
      virtual ::pointer<::user::impact>get_typed_impact(const ::type & type, ::collection::index indexFind = 0);

      virtual ::pointer<::user::impact>get_typed_impact_with_id(const ::type & type,atom atom);
