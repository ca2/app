...
namespace user
{
   ...
   class CLASS_DECL_BERG document :
   ...
   public:
      ...
      virtual ::pointer<::user::impact>get_typed_impact(const ::platform::type & type, ::collection::index indexFind = 0);

      virtual ::pointer<::user::impact>get_typed_impact_with_id(const ::platform::type & type,atom atom);
