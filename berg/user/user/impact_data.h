...
namespace user
{
   ...
   class CLASS_DECL_BERG impact_data :
...
CLASS_DECL_BERG ::user::impact_data * __impact_data(::user::system * pusersystem);


CLASS_DECL_BERG ::user::impact_data * __impact_data(::message::create * pmessagecreate);
