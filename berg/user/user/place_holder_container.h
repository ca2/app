...
namespace user
{
   ...
   public:
      ...
      virtual ::user::place_holder * get_new_place_holder(const ::i32_rectangle & rectangleCreate);

      virtual bool erase_place_holder(::user::place_holder * pholder);


      virtual ::user::place_holder * place_hold(::user::interaction * pinteraction,const ::i32_rectangle & rectangleCreate);
