...
namespace user
{
   ...
   void split_impact::install_message_routing(::channel * pchannel)
   {
      ...
      USER_MESSAGE_LINK(::user::e_message_create, pchannel, this, &split_impact::on_message_create);

      //USER_MESSAGE_LINK(::user::e_message_size, pchannel, this, &split_impact::on_message_size);
      //USER_MESSAGE_LINK(::user::e_message_show_window, pchannel, this, &split_impact::on_message_show_window);
...
//      int i;
   ...
   bool split_impact::on_prepare_impact_data(::user::impact_data* pimpactdata)
   {
      ...
      ::pointer<::user::impact>split_impact::create_pane_impact(const ::type & typeatom, ::collection::index iPane, atom atom, ::user::interaction * pviewLast)
   {
