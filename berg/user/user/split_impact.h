...
namespace user
{
   ...
   class CLASS_DECL_BERG split_impact :
...
//      // void dump(dump_context & dumpcontext) const override;
      ...
      ::pointer<::user::impact>create_pane_impact(const ::platform::type & type, ::collection::index iPane, atom atom = ::atom(), ::user::interaction * pviewLast = nullptr);
