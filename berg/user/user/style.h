...
namespace berg
{
   ...
   public:
      ...
      virtual ::pointer<::user::menu_interaction>create_menu_button(::user::style_pointer& pstyle, ::draw2d::graphics_pointer &pdraw2dgraphics, ::menu::item* pitem);
      virtual bool prepare_menu(::draw2d::graphics_pointer& pdraw2dgraphics, ::menu::item * pitem);
      virtual bool prepare_menu_button(::draw2d::graphics_pointer& pdraw2dgraphics, ::menu::item * pitem);
      ...
      virtual bool _001TabOnDrawSchema01(::draw2d::graphics_pointer & pdraw2dgraphics, ::user::tab * ptab);
      virtual bool _001OnDrawMenuInteraction(::draw2d::graphics_pointer & pdraw2dgraphics, ::user::menu_interaction * pbutton);
      virtual void _001OnTabPaneDrawTitle(::user::tab_pane & pane, ::user::tab * ptab, ::draw2d::graphics_pointer & pdraw2dgraphics, const ::i32_rectangle & rectangle, ::draw2d::brush_pointer & pbrushText, const ::user::e_state & estate);

      virtual bool _001OnTabLayout(::draw2d::graphics_pointer& pdraw2dgraphics, ::user::tab * ptab);
