...
namespace berg
{
   ...
   public:
      ...
      ::pointer<::menu::item> menu_item_from_application_menu(::application_menu *papplicationmenu,
                                                               ::user::menu *pmenu) override;


      ::pointer<::menu::item> popup_menu_item_from_application_menu(::application_menu *papplicationmenu,
                                                                     ::user::menu *pmenu) override;


      void from_application_menu(::menu::item *pmenuitem, ::application_menu *papplicationmenu,
                                 ::user::menu *pmenu) override;

      //
      //      virtual ::pointer<::user::menu> _track_popup_menu(::user::interaction * pinteraction, ::menu::item *
      //      pmenuitem, int iFlags, const ::int_point & point, const ::int_size & sizeMinimum = ::int_size(),
      //      ::channel * pchannelNotify = nullptr);
      //

      void popup_from_application_menu(::menu::item *pmenuitem, ::application_menu *papplicationmenu,
                                       ::user::menu *pmenu) override;
      ...
      ::pointer<::menu::menu> menu_from_xml(::particle *pparticleContext,
                                             const ::scoped_string &scopedstrXml) override;


      void defer_instantiate_user_style(const ::scoped_string &scopedstrExperience = nullptr) override;
      ::user::style_pointer instantiate_user_style(const ::scoped_string &scopedstrExperience,
                                                   ::platform::application *papp = nullptr) override;
      ::user::style_pointer get_user_style(const ::scoped_string &scopedstrExperience,
                                             ::platform::application *papp = nullptr) override;
      ...
      ::pointer<::form_document> create_typed_form(::particle *pparticle, const ::type_atom &typeatom,
      ...
      //::pointer<::form_document>  create_form(::particle * pparticle, ::user::form_callback * pcallback,
      ...
      ::pointer<::form_document> create_form(::particle *pparticle, ::user::form *pform,
                                             ::user::form_callback *pformcallback,
                                             ::user::element *puserelementParent,
                                             const ::payload &payload = ::e_type_empty_argument,
                                             const ::payload &payloadArgs = ::e_type_empty_argument) override;
      //::pointer<::form_document>  create_child_form(::particle * pparticle, ::user::form_callback * pcallback,
      //:::pointer<::user::interaction>userinteractionParent, ::payload payload = ::payload(::e_type_empty_argument),
      //:::payload varArgs = ::e_type_empty_argument);
      ::pointer<::form_document>
      create_typed_child_form(::particle *pparticle, const ::type_atom &typeatom,
                              ::user::element *puserelementParent,
                              const ::payload &payload = ::e_type_empty_argument,
                              const ::payload &payloadArgs = ::e_type_empty_argument) override;
      ::pointer<::form_document> create_child_form(::particle *pparticle, ::user::form *pform,
                                                   ::user::form_callback *pformcallback,
                                                   ::user::element *puserelementParent,
                                                   const ::payload &payload = ::e_type_empty_argument,
                                                   const ::payload &payloadArgs = ::e_type_empty_argument) override;
      ...
      //::pointer<::form_document>  create_child_form(::particle * pparticle, ::user::impact_data * pimpactdata,
      ...
      create_typed_child_form(::particle *pparticle, const ::type_atom &typeatom, ::user::impact_data *pimpactdata,
                              ::payload payload = ::payload(::e_type_empty_argument));
