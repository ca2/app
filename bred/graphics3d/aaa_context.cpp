...
//
//       pmodel->initialize_gpu_gltf_model(this, model.m_path);
//
...
//    }
  ...
  ::pointer < ::graphics3d::renderable > context::get_skybox_cube_model()
   ...
   ::gpu::ibl::equirectangular_cubemap *context::equirectangular_cubemap()
   {
   ...
   gpu::ibl::specular_map *context::ibl_specular_map()
   {
