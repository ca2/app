// Created by camilo on 2026-07-24 09:46 <3ThomasBorregaardSørensen!! Mummi!! Bilbo!!
#pragma once
...
namespace graphics3d
{
      ...
      inline const ::gpu::property *simpler_render_properties()
   {

      static ::gpu::property s_propertya[] = {
         {"modelMatrix", ::gpu::e_type_mat4}, {nullptr, ::gpu::e_type_none}
   ...
   class CLASS_DECL_BRED texture_render_system : virtual public ::graphics3d::render_system
   {
   public:
      ...
      // wavefront_obj_render_system(::graphics3d::device *pdevice, VkRenderPass renderPass, aaaVkDescriptorSetLayout
      // globalSetLayout);
      ...
      void initialize_render_system(::graphics3d::engine_instance *pengine) override;
      ...
      virtual void on_before_draw_renderable(::gpu::context *pgpucontext, ::graphics3d::scene_base *pscene,
                                             ::graphics3d::scene_renderable *pscenerenderable);
