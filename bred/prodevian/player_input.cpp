...
namespace sandbox_game
{
      ...
      ::graphics3d::TransformComponent& transform)
   {
      ...
      if (pinput->isKeyPressed(::graphics3d::SandboxKey::D)) dir += right;
      if (pinput->isKeyPressed(::graphics3d::SandboxKey::Q)) dir -= up;
      if (pinput->isKeyPressed(::graphics3d::SandboxKey::E)) dir += up;
