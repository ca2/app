...
namespace sandbox_game
{
   ...
   void scene::initialize_scene(::sandbox::IWindowInput * pwindowinput, ::sandbox::IAssetProvider * passetprovider)
   {
   ...
   void scene::setSkyboxObject(::sandbox::ISceneObject * pobject)
   {
   ...
   void scene::loadSceneFile(const ::scoped_string& fileName)
   {
      ...
      for (auto& item : objects) 
      {
         ...
         ::pointer < ::sandbox::ISceneObject > psceneobject;
   ...
   ::pointer<::sandbox::ISceneObject> scene::createGameObject()
   {
   ...
   ::pointer<::sandbox::ISceneObject> game_layer::makePointLight(float intensity, float radius, glm::vec3 color)
   {
