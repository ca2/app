...
namespace coding
{
   ...
   public:
      ::string          m_strItem;
      ::string          m_strStatus;
      class ::time      m_timeBuild;
      class ::time      m_timeStore;
   };
   ...
   public:
      ...
      ::numeric_array_base < ::coding::enum_integrate >     m_eintegrateaOperatingSystem;
      ...
      ::coding::e_integrate                               m_eintegrate;
...
//#endif
      ...
      ::string_array                            m_straSummary;
      ::string_map < ::pointer < ::coding::summary_item > > m_mapSummaryItem;

      ::string                                  m_strFinishedStatus;
      
      class ::time                              m_timeTopicBuildStart;
      class ::time                              m_timeTopicStoreStart;
      ...
      virtual enum_task as_task_group(enum_integrate eintegrate);
      ...
      virtual class ::time get_topic_elapsed_time();

      virtual ::file::path integration_folder();


      ::coding::summary_item * summary_item(const ::scoped_string & scopedstrItem);
      ...
      virtual void integrate_port(::coding::item* pitem);

       virtual ::file::path port_base_folder();
...
//      virtual void integrate_macos_port(::coding::item* pitem);
      ...
      virtual void call_integrate_main(::coding::item* pitem);
      virtual void integrate_main2(::coding::item* pitem);

      virtual void on_initialize_application_build_tool_operating_system_integrate_list();
      virtual void on_initialize_application_build_tool_task_groups();

      virtual bool on_packaging(::string & strAppId, ::string & strTarget, ::string & strSource);

      virtual bool on_more_packaging(::string & strAppId, ::string & strTarget, ::string & strSource);
      ...
      void integration_summary(const ::scoped_string & scopedstrAppId, const ::scoped_string & scopedstrOk, bool bBuild);
      ...
      virtual bool on_integrate(::coding::item* pitem);
