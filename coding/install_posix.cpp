//
// From install_linux.cpp by camilo on 2024-06-21 21:59 <3ThomasBorregaardSorensen!!
//
#include "framework.h"
...
//
//      auto strRedir = context()->http_get_effective_url(strUrl);
//
...
//
//      m_strDropboxCommand = pathDropboxBin;
//
//      {
//
//         {
...
//
//               download_and_gzuntar(pathUrl, pathFolder);
//
//               node()->detached_command(pathFolder / ".dropbox-dist/dropboxd &", {});
//
//            }
//
...
//            }
//
//            if (!directory_system()->is(pathFolder / "Dropbox"))
//            {
//
//               set_status2("Waiting for Dropbox folder creation... please wait...");
//
//               while (!directory_system()->is(pathFolder / "Dropbox"))
//               {
//                  preempt(1_s);
//               }
//
...
//
//            directory_system()->change_current(pathFolder / "Dropbox");
//
//            int iTryStart = 0;
//
//            int iRetryStart = 3;
...
//   {
//
//      auto lines = _dropbox_defer_check_index_lines("box/___gnome_extensions");
//
//      if (lines.has_elements())
//      {
//
