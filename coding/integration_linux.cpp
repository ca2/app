   ...
   namespace coding
   {
      ...
      void integration::on_initialize_application_build_tool_operating_system_integrate_list()
      {
         ...
         m_eintegrateaOperatingSystem.copy_initializer_list(
            {
               //::coding::e_integrate_windows_openssl,
               //::coding::e_integrate_windows_ffmpeg,
               //::coding::e_integrate_windows_port,
            });
      ...
      void integration::integrate_main2(::coding::item * pitem)
      {
         ...
         auto strSystemSlashedIntegration = m_poperatingsystemsummary->m_strSystemAmbientReleaseArchitecture;

         if(!node()->has_posix_shell_command("cmake"))
         {
         ...
         auto bBuildOk = integrate_posix_with_result(m_strIntegration);
      ...
      bool integration::integrate_posix_with_result(const ::scoped_string &scopedstrRelease)
      {
         ...
         if(m_baPhaseEnable[::coding::e_phase_cmake])
         {
