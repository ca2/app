...
//       m_strVs = "2022";
//
//       m_eintegrateMask |= e_integrate_branch_microsoft;
//
// #endif
//
// #if defined(LINUX)
...
// #else
//
//       m_straTaskOrdinal.add("32-bit Debug");
//       m_straTaskOrdinal.add("32-bit Release");
//       m_straTaskOrdinal.add("32-bit StaticDebug");
//       m_straTaskOrdinal.add("32-bit StaticRelease");
//       m_straTaskOrdinal.add("64-bit Debug");
//       m_straTaskOrdinal.add("64-bit Release");
//       m_straTaskOrdinal.add("64-bit StaticDebug");
//       m_straTaskOrdinal.add("64-bit StaticRelease");
//
//
// #endif
//
//    }
   ...
   void integration::on_initialize_application_build_tool()
   {
      ...
      m_papp->on_initialize_operating_system_integrate_list(m_eintegrateaOperatingSystem);
...
//       {
//
//          ::string strDistro = node()->operating_system_summary()->m_strSystem;
//
//          ::string strDistroRelease = node()->operating_system_summary()->m_strSystemRelease;
//
//          ::string strBranch = node()->operating_system_summary()->m_strSystemBranch;
//
//          information() << "__SYSTEM_DISTRO : " << strDistro;
//
//          information() << "__SYSTEM_DISTRO_RELEASE : " << strDistroRelease;
//
//          information() << "__SYSTEM_DISTRO_BRANCH : " << strBranch;
//
//          bool bCheck;
//
...
//
//                }
//                else if (!(m_eintegrateMask & eintegrate))
//                {
//
//                   continue;
//
...
//
//                pitem->m_strRelease = strDistroRelease;
//
//       }
//
//    }
...
//                {
//
//                   set_integrate(pitem->m_eintegrate);
//
//                   try
//                   {
//
//                      /*                  if (pitem->m_eintegrate == e_integrate_netnode)
//                                     {
//
//                                        integrate_netnode(pitem->m_strName1);
//
//                                     }
//                                     else*/
...
//                         ////#if defined(INTEGRATE_WINDOWS)
//                         ////
//                         ////                     integrate_machine_box_windows(pitem->m_strName1);
//                         ////
//                         ////#else
//                         ////
//                         ////                     throw "todo";
...
//                         ////
//                      }
//                      else if(eintegrate == e_integrate_main)
//                      {
//
...
// #if defined(INTEGRATE_WINDOWS)
//
//                      else if (pitem->m_eintegrate == e_integrate_windows)
//                      {
//
//                         integrate_windows(pitem);
//
//                }
//                      else if (pitem->m_eintegrate == e_integrate_windows_port)
//                      {
//
//                         integrate_windows_port(pitem);
//
//                      }
//                      else if (pitem->m_eintegrate == e_integrate_windows_openssl)
//                      {
//
//                         integrate_windows_openssl(pitem);
//
//                      }
//                      else if (pitem->m_eintegrate == e_integrate_windows_ffmpeg)
//                      {
//
//                         integrate_windows_ffmpeg(pitem);
//
//                      }
//
// #endif
//
// #if defined(INTEGRATE_WINDOWS) && defined(INTEGRATE_LINUX)
//
//                      else
//
// #endif
//
// #if defined(INTEGRATE_LINUX)
//
//                         if (pitem->m_eintegrate & e_integrate_branch_linux)
//                         {
//
//                            bResultOk = integrate_posix_with_result(pitem->m_strRelease);
//
//                         }
//
// #endif
// #if defined(FREEBSD)
//
//                      if (pitem->m_eintegrate & e_integrate_branch_bsd)
//                      {
//
//                         integrate_posix(pitem->m_strRelease);
//
//                      }
//
// #endif
//
// #if (defined(INTEGRATE_WINDOWS) || defined(INTEGRATE_LINUX)) && defined(INTEGRATE_MACOS)
//
//                      else
//
// #endif
//
// // #if defined(INTEGRATE_MACOS)
//
// //                         if (pitem->m_eintegrate == e_integrate_macos)
// //                         {
//
// //                            integrate_macos(pitem);
//
// //                         }
//
// // #endif
...
//
//          node()->run_silent(pacmedirectory->system() / "env1.bat", "");
//
...
//          {
//
//             string strVar = pproperty->m_atom;
//
...
//       }
      ...
      //    // {
      //    //
      //    //    timeElapsed = m_timeTopicBuildStart.elapsed();
      //    //
      //    // }
      //    // else
      //    // {
      //    //
      //    //    timeElapsed = m_timeTopicStoreStart.elapsed();
      //    //
      //    // }
      //    //
      //    // {
      ...
      //    //    _synchronous_lock synchronouslock(this->synchronization());
      //    //
      //    //    m_itemtimeaSummary.insert_at(0,
      //    //       { scopedstrOk + " " + scopedstrAppId,
      //    //        timeElapsed });
      //    //
      //    // }
      //    //
      ...
      //    // }
      //    //
      //    // ::string strSummaryTime = system()->datetime()->date_time_text_for_file_with_no_spaces(m_timeTopicStart, posix_time(zero_t{}));
      //    //
      ...
      //    //
      //    // auto strSystemSlashedOperatingSystem = m_poperatingsystemsummary->m_strSlashedIntegration;
      //    //
      //    // pathSummaryFolder /= strSystemSlashedOperatingSystem;
      //    //
      //    // {
      //    //
      ...
      //
      //    pcommand->m_iStep = m_iCommandStep++;
      //
      // }
      ...
      //    _synchronous_lock synchronouslock(this->synchronization());
      //
      //    auto& ptaskgroup = m_taskgroup[(enum_task)(etask & e_task_group_mask)];
      //
      //    if (!ptaskgroup)
      //    {
      //
...
//       }
      ...
      //    m_bSpeaking = true;
      //
      //    system()->audio()->speak(scopedstrText);
      //
      // }
   ...
   //       #endif
   //       auto & ptask = taskmap[etask];
   //       ptask = allocateø task(
   //             ptaskgroup,
