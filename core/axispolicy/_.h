...
//
//CLASS_DECL_CORE bool __node_axis_pre_init();
//CLASS_DECL_CORE bool __node_axis_pos_init();
//
//CLASS_DECL_CORE bool __node_axis_pre_term();
//CLASS_DECL_CORE bool __node_axis_pos_term();
//
//
