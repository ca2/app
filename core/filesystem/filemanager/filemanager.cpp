...
#include "operation/info_impact.h"
#include "operation/list_impact.h"
#include "operation/child_frame.h"
#include "operation/impact.h"
#include "data.h"
#include "document.h"
#include "file_list.h"
...
namespace filemanager
{
   ...
   void filemanager::initialize_filemanager_component(::particle * pparticle)
   {
      ...
      factory()->add_factory_item <folder::list_impact >();
      ...
      user()->m_pbaseuser->add_impact_system(
         "filemanager", ::place(new ::user::multiple_document_template(
         "filemanager",
    ...
    /*  auto psession = get_session();
      ...
      user()->m_pbaseuser->add_impact_system(
         "filemanager_operation", ::place(new ::user::multiple_document_template(
         "filemanager",
   ...
   ::user::impact_system * filemanager::impact_system()
   {
      ...
      if (::is_null(user()->impact_system("filemanager_filemanager")))
      {
         ...
         user()->add_impact_system(
            "filemanager_filemanager", ::place(new ::user::multiple_document_template(
            "filemanager",
            ::type < document >(),
            ::type < frame >(),
               ::type < impact >())));
   ...
   ::pointer<data>filemanager::create_filemanager_data()
   {
      ...
      //pdata->m_pimpactsystem = m_pimpactsystemFileManager;

      return pdata;

   }

   void filemanager::filemanager_set_data(atom atom, data * pdata)
   {
   ...
   void filemanager::filemanager_load_project(const ::file::path & pathFilemanagerProject, ::request * prequest, ::fs::data * pfsdata, callback * pcallback)
   {
   ...
   void filemanager::filemanager_save_project()
   {
   ...
   document * filemanager::find_filemanager(::payload payloadFile)
   {
   ...
   document * filemanager::open_filemanager(::payload payloadFile, ::request * prequest, ::fs::data * pfsdata, callback * pcallback)
   {
   ...
   document * filemanager::restore_filemanager(::payload payloadFile, ::request * prequest, ::fs::data * pfsdata, callback * pcallback)
   {
   ...
   document * filemanager::add_filemanager(const ::file::path & pathFolder, ::request * prequest, ::fs::data * pfsdata, callback * pcallback)
   {
   ...
   bool filemanager::erase_filemanager(::payload payloadFile)
   {
   ...
   bool filemanager::erase_filemanager(document * pdocument)
   {
   ...
   //data * filemanager::filemanager)d(::atom atom)
   //{
