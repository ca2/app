...
//   }
   ...
   void folder_list::_001GetSubItemText(::user::mesh_subitem * psubitem)
   {
      ...
      psubitem->m_strText = m_foldera.GetFolder((::collection::index)psubitem->m_pitem->m_iItem).m_strName;
...
//#endif
   ...
   folder_list::Folder &
   folder_list::FolderArray::GetFolder(::collection::index i)
   {
      return this->element_at(i);
   }

   ::collection::count folder_list::FolderArray::GetFolderCount()
   {
   ...
   void folder_list::_001GetSubItemImage(::user::mesh_subitem * psubitem)
   {
      ...
      if (psubitem->m_iSubItem == 1)
      {
         ...
         psubitem->m_iImage = m_foldera.GetFolder((::collection::index)psubitem->m_pitem->m_iItem).m_iImage;
   ...
   ::collection::count folder_list::_001GetItemCount()
   {
   ...
   void folder_list::handle(::topic * ptopic, ::handler_context * phandlercontext)
   {
