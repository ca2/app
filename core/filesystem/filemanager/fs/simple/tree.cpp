   ...
   namespace fs
   {
      ...
      namespace simple
      {
         ...
         void tree::initialize(::particle * pparticle)
         {
            ...
            ::user::tree_data<::item>::initialize(pparticle);
...
//#endif
            ...
            //return estatus;
            m_iIconFolderNormal = m_pimagelist->add(::image::icon_payload(this, "icon://karaoke_library_folder_normal"));
            m_iIconFolderSelected = m_pimagelist->add(::image::icon_payload(this, "icon://karaoke_library_folder_selected"));
            m_iIconArtistNormal = m_pimagelist->add(::image::icon_payload(this, "icon://karaoke_library_artist_normal"));
            m_iIconArtistSelected = m_pimagelist->add(::image::icon_payload(this, "icon://karaoke_library_artist_selected"));
...
//         }
         ...
         void tree::parse(const ::string & pszSource)
         {
            ...
            ::pointer<::data::tree_item<::item>>ptreeitemParent;

            ::pointer<::data::tree_item<::item>>ptreeitemChild;
            ...
            for(int i = 0 ; i < pnodeFolder->get_children_count(); i++)
            {
               ...
               ::collection::index iNewItem = m_foldera.find_absolute(iFolder);
         ...
         ::pointer<::data::tree_item<::item>>tree::FindTreeItem(long long iFolder)
         {
            int iUser;
         ...
         int FolderArray::find_absolute(long long iFolder)
         {
         ...
         ::collection::index tree::_001GetItemImage(::pointer<::data::tree_item<::item>>pitem, bool bSelected)
         {
