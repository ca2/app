...
namespace filemanager
{
   ...
   public:
      ...
      void queue_copy(::file::listing & stra,const ::file::path & pathDest,const ::file::path & pathSourceBase,bool bExpand,bool bReplaceAll,bool bDeleteOriginOnSuccessfulCopy, ::pointer<::user::interaction>puiCallback = nullptr,const ::atom & atom = WM_USER,wparam wparam = 0x1000);
      void kick();
