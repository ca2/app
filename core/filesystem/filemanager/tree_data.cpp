...
namespace filemanager
{
   ...
   void tree_data::browse_sync(const ::action_context & context)
   {
      ...
      //               pitemChild = allocateø ::userfs::item(this);
      ...
      //         ptreeitemChild = allocateø ::data::tree_item();
...
return;
      ...
      for (::collection::index i = 0; i < patha.get_size(); i++)
      {
         ...
         if (!pchild)
         {
            ...
            auto pitemNew = allocateø ::userfs::item(this);
...
//#endif
   ...
   void tree_data::_001OnOpenItem(::data::tree_item_base * ptreeitembase, const ::action_context & context)
   {
      ...
      auto pfileitem = allocateø ::file::item(*puserfsitem);
