...
namespace userfs
{
   ...
   public:
      ...
      virtual index data_item_get_image(::context_object* pcontextobject) const override;
      virtual ::image_list * data_item_get_image_list(::context_object* pcontextobject) const override;
