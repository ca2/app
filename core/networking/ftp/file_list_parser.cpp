...
//#ifndef acmesystem()->m_pcoresystem->InsertTime
  
//#define acmesystem()->m_pcoresystem->InsertTime(ftpFileStatus) InsertTime(ftpFileStatus);
//#endif
   ...
   {
      ///////////////////////////*/*/*/*/
      auto now = m_tmBase.elapsed().m_posixtime;
