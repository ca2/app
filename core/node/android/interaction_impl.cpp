...
CLASS_DECL_CORE int g_iMouseDown = 0;
//
//CLASS_DECL_CORE thread_int_ptr < DWORD_PTR > t_time1;
//CLASS_DECL_CORE thread_int_ptr < DWORD_PTR > t_time2;
//
//
...
namespace android
{
   ...
   __STATIC bool CLASS_DECL_CORE __modify_style(oswindow oswindow,i32 nStyleOffset,
...
///      ASSERT(HWND_TOP == nullptr);       // same as desktop
   ...
   void interaction_impl::WinHelp(uptr dwData,::u32 nCmd)
   {
      ...
      {
      // android psystem->message_box(__IDP_FAILED_TO_LAUNCH_HELP);
...
//   }
   ...
   void interaction_impl::CenterWindow(::user::interaction * pAlternateOwner)
   {
      ...
      //         if (hWndCenter == nullptr)
      //         {
      //            oswindow hwDefault = psystem->GetMainWnd()->get_handle();
      //
      //            GetMonitorInfo(
