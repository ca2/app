...
CLASS_DECL_CORE void vfxThrowFileException(::object * pobject, const void & estatus, ::i32 lOsError, const char * lpszFileName = nullptr);

CLASS_DECL_CORE ::file::exception * get_FileException(::object * pobject, const void & estatus, ::i32 lOsError, const char * lpszFileName = nullptr);
