...
namespace ios
{
   ...
   CLASS_DECL_CORE LRESULT CALLBACK __send_message_hook(i32, WPARAM, LPARAM);
   CLASS_DECL_CORE LRESULT CALLBACK __cbt_filter_hook(i32, WPARAM, LPARAM);
...
//      static bool PASCAL ModifyStyle(oswindow hWnd, DWORD dwRemove, DWORD dwAdd, UINT nFlags);
      ...
      CLASS_DECL_CORE friend LRESULT CALLBACK __send_message_hook(i32, WPARAM, LPARAM);
      CLASS_DECL_CORE friend LRESULT CALLBACK __cbt_filter_hook(i32, WPARAM, LPARAM);
      CLASS_DECL_CORE friend LRESULT __call_window_procedure(::user::interaction *   pWnd, oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam);
