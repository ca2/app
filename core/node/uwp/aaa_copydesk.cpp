...
CLASS_DECL_CORE bool node_save_image(Windows::Storage::Streams::IRandomAccessStream^ stream, ::image* pimage, ::save_image* psaveimage);

bool node_save_image(::image * pimage, Windows::Storage::Streams::IRandomAccessStream ^stream, ::aura::application * papp);


CLASS_DECL_CORE bool node_save_image(Windows::Storage::Streams::IRandomAccessStream ^ randomAccessStream, const ::image * pimage, ::save_image * psaveimage);
