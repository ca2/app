...
/*bool CLASS_DECL_CORE __custom_log_font(UINT nIDS, LOGFONT* pLogFont)
{
...
bool CLASS_DECL_CORE __is_combo_box_control(oswindow hWnd, UINT nStyle)
{
   if (hWnd == nullptr)
      return FALSE;
...
bool CLASS_DECL_CORE __compare_class_name(oswindow hWnd, const char * lpszClassName)
{
...
oswindow CLASS_DECL_CORE __child_window_from_point(oswindow hWnd, POINT point)
{
   ASSERT(hWnd != nullptr);
...
void CLASS_DECL_CORE __set_window_text(::user::interaction * hWndCtrl, const char * lpszNew)
{
...
void CLASS_DECL_CORE __delete_object(HGDIOBJ* pObject)
{
...
/*
void CLASS_DECL_CORE __cancel_modes(oswindow hWndRcvr)
{
