...
//CLASS_DECL_CORE bool __end_defer_register_class(LONG fToRegister, const char ** ppszClass);
...
CLASS_DECL_CORE bool __custom_log_font(UINT nIDS, LOGFONT* pLogFont);
CLASS_DECL_CORE bool __get_prop_sheet_font(string & strFace, WORD& wSize, bool bWizard);

CLASS_DECL_CORE bool __is_combo_box_control(oswindow hWnd, UINT nStyle);
...
CLASS_DECL_CORE oswindow __child_window_from_point(oswindow, POINT);
