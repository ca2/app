...
//CLASS_DECL_CORE thread_iptr < DWORD_PTR > t_time1;
//CLASS_DECL_CORE thread_iptr < DWORD_PTR > t_time2;
...
void CLASS_DECL_CORE _handle_activate(::user::interaction_impl * pwindow, WPARAM nState, ::user::interaction_impl * pWndOther)
{
...
wstring CLASS_DECL_CORE windows_get_user_interaction_window_class(::user::interaction * pinteraction)
{
...
bool CLASS_DECL_CORE windows_register_with_icon(WNDCLASSEXW * pwndclass, const unichar * pszClassName, UINT nIDIcon)
...
CLASS_DECL_CORE wstring windows_register_window_class(::object * pobject, UINT nClassStyle, HCURSOR hCursor, HBRUSH hbrBackground, HICON hIcon)
{
...
CLASS_DECL_CORE bool windows_register_class(WNDCLASSEXW * pwndclass)
{
