...
CLASS_DECL_COREvoid os_shell_initialize();
...
CLASS_DECL_CORE void vfxThrowFileException(::object* pparticle, const ::e_status & estatus, ::i32 lOsError, const ::string & lpszFileName = nullptr);
