...
namespace android
{
   ...
   ::extended::status file::open(const ::file::path & lpszFileName, ::file::e_open eopen)
   {
      ...
      if((eopen & ::file::e_open_defer_create_directory) && (eopen & ::file::e_open_write))
      {
         ...
         dir()->create(lpszFileName.folder());
...
//         dwFlags |= O_EXLOCK;
      ...
      i32 hFile = ::open(m_strFileName, dwFlags | O_CLOEXEC, dwPermission); //::open(m_strFileName, dwAccess, dwShareMode, &sa, dwCreateFlag, FILE_ATTRIBUTE_NORMAL, nullptr);
      if(hFile == -1)
      {
...
//
//void CLASS_DECL_CORE vfxThrowFileException(::particle * pparticle, const ::e_status & estatus, ::i32 lOsError, const ::string & lpszFileName /* == nullptr */)
//{
//
