...
//      void throw_os_error(::particle * pparticle, ::i32 lOsError, const ::string & lpszFileName = nullptr);
//      void throw_err_no(::particle * pparticle, i32 nErrno, const ::string & lpszFileName = nullptr);
//
//
//   }  // namespace file_exception
//
