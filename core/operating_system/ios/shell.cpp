...
//   e_folder ios::get_folder_type(::particle * pparticle, const ::string & pcsz)
//   {
//
...
//   }
   ...
   //                  if (folder.element2().m_timeStart.elapsed() > 30000)
   //                  {
...
//   }
   ...
   shell::e_folder shell::get_folder_type(::particle * pparticle, const ::string & lpcszPath)
   {
