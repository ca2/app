      ...
      if (uwp_get_file_image(pimage48, strPath))
      {
...

         {
            ...
            else
            {
               ...
               pimage48->get_graphics()->stretch(::size_i32(48, 48), pimage16->get_graphics(), pimage16->rectangle());
         ...
         if (imagekey.m_cr == 0)
         {
            ...
            psystem->imaging().color_blend(m_pimagelist[48], m_pimagelistHover[48], rgb(255, 255, 240), 64);
