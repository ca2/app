...
//
//CLASS_DECL_CORE void WINAPI sleep(::u32 dw::times);
//
//#endif
...
CLASS_DECL_CORE htask_t get_main_user_htask();
...
//CLASS_DECL_CORE ::u32 WINAPI WaitForSingleObject( _In_ HANDLE hHandle, _In_ ::u32 dw::times );
...
//CLASS_DECL_CORE HANDLE WINAPI CreateMutexW(    _In_opt_ LPSECURITY_ATTRIBUTES lpMutexAttributes,    _In_ BOOL bInitialOwner,    _In_opt_ const ::wide_character * lpName    );
