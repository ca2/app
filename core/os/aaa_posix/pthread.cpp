...
CLASS_DECL_CORE::e_priority thread_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);

CLASS_DECL_CORE::e_priority process_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);
