...
void android_fill_plasma(AndroidBitmapInfo * info, void * pixels, double  t)
{
   ...
   if (::aura::system::g_p->get_context_session()->m_puiHost->m_pimpl == nullptr)
   {
   ...
   if (::aura::system::g_p->get_context_session()->m_puiHost->get_window_graphics() == nullptr)
   {
   ...
   auto pbuffer = dynamic_cast <::graphics::double_buffer *> (::aura::system::g_p->get_context_session()->m_puiHost->get_window_graphics());
...
void android_aura_main()
{
   ...
   ::aura::system::g_p->get_context_session()->defer_initialize_host_window(rect);
