...
// CLASS_DECL_CORE int_bool WINAPI GetMessage(LPMESSAGE pMsg, oswindow oswindow, UINT wMsgFilterMin, UINT wMsgFilterMax);

// CLASS_DECL_CORE int_bool WINAPI PeekMessage(LPMESSAGE pMsg, oswindow oswindow, UINT wMsgFilterMin, UINT wMsgFilterMax, UINT wRemoveMsg);

// CLASS_DECL_CORE int_bool WINAPI PostThreadMessage(ITHREAD idthread, UINT Msg, WPARAM wParam, LPARAM lParam);

// CLASS_DECL_CORE void mq_clear(ITHREAD hthread);


// #ifndef _UWP

// CLASS_DECL_CORE DWORD WINAPI GetThreadId(HTHREAD Thread);

// CLASS_DECL_CORE HTHREAD GetCurrentThread();

// CLASS_DECL_CORE ITHREAD GetCurrentThreadId();
