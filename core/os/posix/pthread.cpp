...
CLASS_DECL_CORE ITHREAD get_current_ithread()
{
...
CLASS_DECL_CORE void set_main_hthread(HTHREAD hThread)
{
...
CLASS_DECL_CORE void set_main_ithread(ITHREAD uiThread)
{
...
CLASS_DECL_CORE HTHREAD get_main_hthread()
{
...
CLASS_DECL_CORE ITHREAD get_main_ithread()
{
...
//CLASS_DECL_CORE int_bool WINAPI mq_post(mq * pmq, oswindow oswindow, UINT Msg, WPARAM wParam, LPARAM lParam)
//CLASS_DECL_CORE int_bool WINAPI mq_post(mq * pmq, UINT Msg, WPARAM wParam, LPARAM lParam)
//{
//
...
CLASS_DECL_CORE DWORD_PTR translate_processor_affinity(int iOrder)
{
