...
//#ifndef _UWP
//
//CLASS_DECL_CORE void WINAPI millis_sleep(::u32 dwMilliseconds);
//
//#endif
...
CLASS_DECL_CORE HANDLE create_file(const char * lpcszFileName, ::u32 dwDesiredAcces, ::u32 dwShareMode, LPSECURITY_ATTRIBUTES lpSA, ::u32 dwCreationDisposition, ::u32 dwFlagsAndAttributes, HANDLE hTemplateFile);
