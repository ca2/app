...
//CLASS_DECL_CORE int_bool WINAPI GetMessage(MESSAGE * lpMsg, oswindow oswindow, ::u32 wMsgFilterMin, ::u32 wMsgFilterMax);
...
CLASS_DECL_CORE BOOL WINAPI SetThreadPriority(htask_t hthread,int iPriority);

CLASS_DECL_CORE int WINAPI GetThreadPriority(htask_t hthread);
