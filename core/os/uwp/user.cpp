...
CLASS_DECL_CORE WINBOOL GetCursorPos(LPPOINT lppoint);


CLASS_DECL_CORE int_bool ui_get_cursor_pos(POINT * ppt)
{
...
namespace user
{
   ...
   CLASS_DECL_CORE COLORREF get_system_app_background_color()
   {
      ...
      auto color = ::aura::system::g_p->get_context_session()->m_directxapplication->m_puisettings->GetColorValue(Windows::UI::ViewManagement::UIColorType::Background);
