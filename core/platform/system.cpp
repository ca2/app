#include "framework.h"
#include "core/filesystem/filehandler/_data.h"
...
CLASS_DECL_CORE void multimedia_set_library_name(const char* psz)
{
...
CLASS_DECL_CORE ::user::interaction * create_system_message_window(::object * pobject);
#endif
...
CLASS_DECL_CORE void __simple_tracea(::generic_object * pobjectContext, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * psz);
...
//         if(list != nullptr)
   ...
   ::aura::session * system::session(index iEdge)
   {
...
//      for(i32 i = 0; i < appptra().get_size(); i++)
   ...
   bool system::assert_running_global(const char * pszAppName,const char * pszId)
   {
      if(string(pszId).has_char())
      {
         ...
         if(pmutex == nullptr)
         {
            ...
            ::aura::shell_launcher launcher(nullptr,nullptr, Context.dir().module()/strApp,strParameters,nullptr,display_normal);
      ...
      else
      {
         ...
         if(pmutex == nullptr)
         {
            ...
            ::aura::shell_launcher launcher(nullptr,nullptr,Context.dir().module()/strApp,nullptr,nullptr, display_normal);
   ...
   bool system::assert_running_local(const char * pszAppName,const char * pszId)
   {
      ...
      if(strId.has_char())
      {
         ...
         if(pmutex == nullptr)
         {
            ...
            ::aura::shell_launcher launcher(nullptr,nullptr, Context.dir().ca2module() / strApp,strParameters,nullptr, display_normal);
   ...
   __result(::aura::session) system::on_create_session(index iEdge)
   {

      __pointer(::aura::session) psession;
...
// #endif
   ...
   CLASS_DECL_CORE bool get_window_rect(::aura::system_window ^ pwindow, RECTD * prect)
   ...
   CLASS_DECL_CORE bool get_window_rect(::aura::system_window ^ pwindow, RECT * prect)
   {
...
CLASS_DECL_CORE ::file::path application_installer_folder(const ::file::path & pathExe, string strAppId, const char * pszPlatform, const char * pszConfiguration, const char * pszLocale, const char * pszSchema)
{
...
CLASS_DECL_CORE bool is_application_installed(const ::file::path & pathExe, string strAppId, string & strBuild, const char * pszPlatform, const char * pszConfiguration, const char * pszLocale, const char * pszSchema)
{
...
CLASS_DECL_CORE bool set_application_installed(const ::file::path & pathExe, string strAppId, const char * pszBuild, const char * pszPlatform, const char * pszConfiguration, const char * pszLocale, const char * pszSchema)
{
...
CLASS_DECL_CORE::file::path get_application_path(string strAppId, const char * pszPlatform, const char * pszConfiguration)
{
...
CLASS_DECL_CORE ::file::path get_last_run_application_path_file(string strAppId)
{
...
CLASS_DECL_CORE::file::path get_last_run_application_path(string strAppId)
{
...
CLASS_DECL_CORE bool set_last_run_application_path(string strAppId)
{
...
CLASS_DECL_CORE bool __rich_text_initialize();
...
namespace aura
{
   ...
   CLASS_DECL_CORE void black_body(float* r, float* g, float* b, DWORD dwTemp);
...
//
   ...
   void system::on_graphics_ready()
   {
      ...
      //if (User.shell()->m_bPendingUpdate)
      //{
