...
//      virtual bool wait_twf(tick tickTimeout = INFINITE);
   ...
   CLASS_DECL_CORE ::mutex * get_image_mutex();
...
//CLASS_DECL_CORE ::aura::system * create_aura_system(app_core * pappcore);
CLASS_DECL_CORE ::aura::system * create_aura_system();
