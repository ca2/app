...
namespace simple_ui
{
   ...
   void edit_box::install_message_routing(::channel * pchannel)
   {
      ...
      USER_MESSAGE_LINK(::user::e_message_key_down, pchannel, this, &edit_box::on_message_key_down);
      USER_MESSAGE_LINK(::user::e_message_key_up, pchannel, this, &edit_box::on_message_key_down);
      USER_MESSAGE_LINK(::user::e_message_left_button_down, pchannel, this, &edit_box::on_message_left_button_down);
      USER_MESSAGE_LINK(::user::e_message_left_button_up, pchannel, this, &edit_box::on_message_left_button_up);
