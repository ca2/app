...
namespace account
{
   ...
   void dialog::install_message_routing(::channel * pchannel)
   {
      ...
      MESSAGE_LINK(::user::e_message_create,pchannel,this,&dialog::on_message_create);
      MESSAGE_LINK(::user::e_message_char,pchannel,this,&dialog::on_message_character);
      MESSAGE_LINK(::user::e_message_left_button_down,pchannel,this,&dialog::on_message_left_button_down);
      MESSAGE_LINK(::user::e_message_left_button_up,pchannel,this,&dialog::on_message_left_button_up);
      MESSAGE_LINK(::user::e_message_mouse_move,pchannel,this,&dialog::on_message_mouse_move);
      MESSAGE_LINK(::user::e_message_show_window, pchannel, this, &dialog::on_message_show_window);
