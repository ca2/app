...
namespace hotplugin
{
            ...
            else
            {
               ...
               if(::hotplugin::get_aura_system()->m_bReady)
               {
                  ...
                  if(::hotplugin::get_aura_system()->get_result_status() != 0)
                  {
                     ...
                     str.formatf("::hotplugin::g_pbasesystem initialization error %d",::hotplugin::get_aura_system()->get_result_status());
            ...
            else
            {
               ...
               if(get_composer_system()->m_bReady)
               {
                  ...
                  if(get_composer_system()->get_result_status() != 0)
                  {
                     ...
                     str.formatf("m_pcomposersystem initialization error %d",get_composer_system()->get_result_status());
            ...
            else
            {
               ...
               if(m_paxishost->m_bReady)
               {
                  ...
                  if(m_paxishost->get_result_status() != 0)
                  {
                     ...
                     str.formatf("::hotplugin::composer::m_paxishost initialization error %d",::hotplugin::get_aura_system()->get_result_status());
   ...
   bool composer::open_link(const ::scoped_string & scopedstrLink,const ::scoped_string & scopedstrTarget)
   {
   ...
   bool composer::_open_link(const ::scoped_string & scopedstrLink,const ::scoped_string & scopedstrTarget)
   {
...
//      {
//
//         m_pcomposersystem = ___new ::axis::system (nullptr);
//
