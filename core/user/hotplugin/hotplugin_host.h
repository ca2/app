...
namespace hotplugin
{
   ...
   public:
      ...
      virtual void set_bitmap(::draw2d::graphics * pimage, const ::i32_rectangle & rectangle);


      virtual void paint_bitmap(::draw2d::graphics * pimage,const ::i32_rectangle & rectangle);
