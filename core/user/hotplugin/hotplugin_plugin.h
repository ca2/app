...
namespace hotplugin
{
   ...
   public:
      ...
      virtual bool client_to_screen(::i32_point * ppt) override;

      using ::user::interaction::screen_to_client;
      virtual bool screen_to_client(::i32_point * ppt) override;
      ...
      */
      ...
      virtual void ensure_bitmap_data(const ::i32_size & size, bool bCreateFile);
