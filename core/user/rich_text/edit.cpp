...
namespace user
{
   ...
   namespace rich_text
   {
      ...
      void edit::install_message_routing(::channel * pchannel)
      {
         ...
         MESSAGE_LINK(e_message_left_button_down, pchannel, this, &edit::_001OnLButtonDown);
         MESSAGE_LINK(e_message_left_button_up, pchannel, this, &edit::_001OnLButtonUp);
...
//#endif
  ...
  /*          if (puserinteractionFocusNew != nullptr)
      ...
      bool edit::_001IsPointInside(::point_i32 pointParam)
      {
