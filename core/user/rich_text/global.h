...
namespace user
{
   ...
   namespace rich_text
   {
      ...
      ::collection::index sel_line_x666(pointer_array < line > & span, ::collection::index iSel, ::f64 & x);
      ::collection::index line_caret_x(pointer_array < line >& span, ::collection::index iSel, ::f64& x);
