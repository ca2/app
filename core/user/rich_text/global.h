...
namespace user
{
   ...
   namespace rich_text
   {
      ...
      box * find_box(pointer_array < line > & span, ::raw::index iSel);
      ...
      ::raw::index sel_line(const pointer_array < line > & span, ::raw::index iSel);
      ::raw::index sel_line_x666(pointer_array < line > & span, ::raw::index iSel, double & x);
      ::raw::index line_caret_x(pointer_array < line >& span, ::raw::index iSel, double& x);
