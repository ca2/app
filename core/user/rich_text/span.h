...
namespace user
{
   ...
   namespace rich_text
   {
      ...
      public:
         ...
         // Sel* -> Selection
         // (selection index:
         //     __allocate< line = 1 sel index  >(only one sel index increment even for "\r\n")
         //     __allocate< line due wrap = 0 sel index  >(no sel increment index, m_bCaretRight hinting for the Caret through mouse selection)
