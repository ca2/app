...
i64 simple_pane_document::increment_reference_count(REFERENCING_DEBUGGING_PARAMETERS_DEFINITION)
{
...
i64 simple_pane_document::decrement_reference_count(REFERENCING_DEBUGGING_PARAMETERS_DEFINITION)
{
