...
namespace user
{
   ...
   public:
      ...
      bool _001HitTest_(const ::i32_point& point, ::collection::index & iItem, ::collection::index & iSubItem, ::collection::index & iListItem, ::user::enum_list_element& eelement) override;
      ...
      bool _001DisplayHitTest(const ::i32_point& point, ::collection::index & iItem, ::collection::index & iSubItem, ::collection::index & iListItem, ::user::enum_list_element& eelement) override;
