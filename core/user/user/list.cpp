...
//      pdrawitem->m_colorText = get_color(pstyle, ::e_element_item_text);
  ...
  //    pdrawitem->m_colorTextBackground = ::color::transparent;
   ...
   ::i32 list::_001CalcItemHeight(::user::style * pstyle, ::i32 iBaseHeight)
   {
...
//      m_iVScrollOffset = m_dItemHeight;
   ...
   bool list::_001SetColumnWidth(::collection::index iColumn, ::i32 iWidth)
   {
   ...
   //::i32 list::_001GetColumnWidth(::collection::index iColumn)
   //{
   ...
   ::collection::index list::_001CalcDisplayTopIndex()
   {
      ...
      if (_001DisplayHitTest(i32_point(0,
   ...
   bool list::_001HitTest_(const ::i32_point & point, ::collection::index & iItem, ::collection::index & iSubItem, ::collection::index & iListItem, ::user::mesh::enum_element &eelement)
   {
   ...
   bool list::_001HitTest_(const ::i32_point & point, ::collection::index & iItem, ::collection::index & iSubItem)
   {
   ...
   bool list::_001HitTest_(const ::i32_point & point, ::collection::index & iItem)
   {
   ...
   bool list::_001DisplayHitTest(const ::i32_point & point, ::collection::index & iItem, ::collection::index & iSubItem, ::collection::index & iListItem, ::user::mesh::enum_element &eelement)
   {
   ...
   bool list::_001DisplayHitTest(const ::i32_point & point, ::collection::index & iItemParam, ::collection::index & iSubItemParam)
   {
   ...
   bool list::_001DisplayHitTest(const ::i32_point & point, ::collection::index & iItemParam)
   {
...
//
      if (m_eview == impact_report)
      {
         ...
         ::f64 iy = point.y + (m_bHeaderCtrl ? -m_dItemHeight : 0);
   ...
   void list::index_item_rectangle(::user::draw_mesh_item * pdrawitem)
   {
      ...
      else if (m_eview == impact_icon)
      {
         ...
         pdrawitem->m_rectangleItem.left = (::i32)(sizeIconItem.cx * (pdrawitem->m_iDisplayItem % (maximum(1, rectangleX.width() / sizeIconItem.cx))));

         pdrawitem->m_rectangleItem.top = (::i32)(sizeIconItem.cy * (pdrawitem->m_iDisplayItem / (maximum(1, rectangleX.width() / sizeIconItem.cx))));

         pdrawitem->m_rectangleItem.bottom = (::i32)(pdrawitem->m_rectangleItem.top + sizeIconItem.cx);

         pdrawitem->m_rectangleItem.right = (::i32)(pdrawitem->m_rectangleItem.left + sizeIconItem.cy);
...
//      }
   ...
   void list::FilterInclude(::i32_array_base & array)
   {
      ASSERT(m_efilterstate == FilterStateSetup);
   ...
   bool list::do_drop(::collection::index iDisplayDrop, ::collection::index iDisplayDrag)
   {
      ...
      if (m_eview == impact_icon)
      {
         ...
         if (m_rangeSelection.get_item_count() > 0)
         {
            ...
            ::i32 iItemColumnCount = (::i32)maximum(1, rectangleX.width() / sizeIconItem.cx);
   ...
   ::i32_size list::get_list_icon_item_size()
   {

      ::i32_size sizeIcon = get_list_icon_size();

      ::i32_size sizeIconItem;

      auto pwindowing = system()->windowing();

      ::i32 cxSpacing = pwindowing->system_metrics_get_cx_icon_spacing();

      ::i32 cx = pwindowing->system_metrics_get_cx_icon() / 2 * 3;

      ::i32 cxIcon = sizeIcon.cx * cxSpacing / cx;

      ::i32 iColumnCount = get_rectangle().width() / cxIcon;
      ...
      ::i32 cySpacing = pwindowing->system_metrics_get_cy_icon_spacing();

      ::i32 cy = pwindowing->system_metrics_get_cy_icon() /2*3;

      sizeIconItem.cy = sizeIcon.cy * cySpacing / cy;

      ::i32 cyCaption = pwindowing->system_metrics_get_cy_caption();

      ::i32 cyCaptionScaled = sizeIcon.cy * cyCaption / cy;
   ...
   ::i32_size list::get_list_icon_size()
   {
   ...
   ::i32 list::_001GetGroupHeight(::collection::index iGroup)
   {
...
//      }
   ...
   //bool list::this->rectangle(::i32_rectangle * prectangle)
