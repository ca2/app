...
namespace user
{
   ...
   void step_slider::install_message_routing(::channel * pchannel)
   {
      ...
      MESSAGE_LINK(::user::e_message_create, pchannel, this, &step_slider::on_message_create);
//      //MESSAGE_LINK(::user::e_message_timer, pchannel, this, &step_slider::on_timer);
      MESSAGE_LINK(::user::e_message_left_button_down, pchannel, this, &step_slider::on_message_left_button_down);
      MESSAGE_LINK(::user::e_message_left_button_up, pchannel, this, &step_slider::on_message_left_button_up);
      MESSAGE_LINK(::user::e_message_mouse_move, pchannel, this, &step_slider::on_message_mouse_move);
   }
