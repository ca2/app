...
//#endif
   ...
   ::i32 toolbar_control::AddStrings(const ::scoped_string & scopedstrStrings)
   {
...
//#endif
   ...
   bool toolbar_control::GetItemRect(::i32 nIndex, ::i32_rectangle * prectangle)
   {
...
//#endif
   ...
   void toolbar_control::SetRows(::i32 nRows, bool bLarger, ::i32_rectangle * prectangle)
...
//#endif
   ...
   ::i32 toolbar_control::hit_test(::i32_point * ppt)
   {
...
//#endif
   ...
   bool toolbar_control::GetRect(::i32 nID, ::i32_rectangle * prectangle)
...
//#endif
   ...
   bool toolbar_control::MapAccelerator(::i8 chAccel, ::u32* pIDBtn)
   {
//#ifdef WINDOWS_DESKTOP
//
