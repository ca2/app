...
namespace core
{
   ...
   class CLASS_DECL_CORE user : virtual public ::bred::user
   //,
   ...
   public:
      ...
      // virtual pointer< ::sequence < ::conversation > > dialog_box(::particle * pparticle, const ::scoped_string &
      // scopedstrMatter, ::property_set & propertyset);


      // virtual pointer< ::sequence < ::conversation > > ui_message_box(::particle * pparticle,
      // ::user::interaction_base * puiOwner, const ::scoped_string & scopedstrMessage, const ::scoped_string &
      // scopedstrTitle = nullptr, const ::user::e_message_box & emessagebox = ::user::e_message_box_ok); virtual
      // pointer< ::sequence < ::conversation > > ui_message_box_timeout(::particle * pparticle,
      // ::user::interaction_base * puiOwner, const ::scoped_string & scopedstrMessage, const ::scoped_string &
      ...
      //      iFlags, const ::int_point & pointCursor) override;
      ...
      ////virtual string matter_as_string(const ::scoped_string & scopedstrMatter, const ::scoped_string &
      /// scopedstrMatter2); /virtual string directory()->matter(const ::scoped_string & scopedstrMatter, const
      ///::scoped_string & scopedstrMatter2);
      ...
      // virtual void locale_schema_matter(string_array_base & stra, const string_array_base & straMatterLocator,
      // const ::scoped_string & scopedstrLocale, const ::scoped_string & scopedstrSchema) override; virtual string
      // get_locale_schema_dir() override;
      ...
      // virtual bool open_by_file_extension(const ::scoped_string & scopedstrPathName, ::request * prequest =
      // nullptr);

      // virtual bool open_by_file_extension(::create * pcc);

      ////::pointer<::aura::application>get_new_application(::particle * pparticle, const ::scoped_string &
      /// scopedstrAppId);
      ...
      // virtual ::account::user * get_user(::file::path pathUrl = nullptr, bool bFetch = false, bool bInteractive =
      // true);
      ...
      // virtual bool workspace_to_monitor(::int_rectangle * prectangle, ::collection::index iMonitor,
      // ::collection::index iWorkspace);

      // virtual bool monitor_to_workspace(::int_rectangle * prectangle, ::collection::index iWorkspace,
      // ::collection::index iMonitor);
      ...
      // virtual void  get_monitor(int_rectangle_array_base & rectaMonitor, int_rectangle_array_base &
      // rectaIntersect, const ::int_rectangle & rectangle);

      // virtual ::collection::index initial_frame_position(::int_rectangle * prectangle, const ::int_rectangle &
      // rectangle, bool bMove, ::user::interaction * pinteraction);

      // virtual ::collection::index _get_best_zoneing(edisplay * pedisplay, ::int_rectangle * prectangle, const
      // ::int_rectangle & rectangle, bool bPreserveSize = false);

      // virtual ::collection::index get_best_monitor(::int_rectangle * prectangle, const ::int_rectangle &
      // rectangle, const ::user::activation & useractivation = {});

      // virtual ::collection::index get_best_workspace(::int_rectangle * prectangle, const ::int_rectangle&
      // rectangle, const ::user::activation & useractivation = {});

      // virtual ::collection::index get_good_iconify(::int_rectangle * prectangle, const ::int_rectangle &
      // rectangle);

      // virtual ::collection::index get_window_restore_1(::int_rectangle * prectangle, const ::int_rectangle &
      // rectangle, ::user::interaction * pinteraction, edisplay edisplayRestore);

      // virtual ::collection::index get_window_restore_2(::int_rectangle* prectangle, const ::int_rectangle&
      // rectangle, ::user::interaction* pinteraction, edisplay edisplayRestore);

      // virtual ::collection::index get_good_move(::int_rectangle * prectangle, const ::int_rectangle & rectangle,
      ...
      // ::draw2d::graphics_pointer & pgraphics, const ::int_rectangle & rectangle, ::draw2d::brush_pointer &
      // pbrushText);
      ...
      //: payload = ::payload(::e_type_empty_argument), ::payload varArgs = ::payload(::e_type_empty_argument));
      //::pointer<::user::document>  create_form(::pointer<::user::form>impact, ::user::form_callback* pcallback,
      //:::pointer<::user::interaction>serinteractionParent, ::payload payload = ::payload(::e_type_empty_argument),
      //:::payload varArgs = ::payload(::e_type_empty_argument)); :pointer<::user::document>
      //: create_child_form(::user::form_callback* pcallback, ::pointer<::user::interaction>userinteractionParent,
      //:::payload payload = ::payload(::e_type_empty_argument), ::payload varArgs =
      ...
      ////virtual bool open_by_file_extension(const ::scoped_string & scopedstrPathName, ::create* pcreate = nullptr)
      /// override; /virtual bool open_by_file_extension(::create* pcc) override;
      ...
      ////virtual ::user::menu_interaction * create_menu_button(::user::style_pointer & pstyle, ::menu::item * pitem)
      /// override;
