...
public:
   ...
   bool OnMouseMove(xfplayer_impact_line & viewline, ::user::e_key_state ekeystate, const ::i32_point & point);
   bool OnLButtonDown(xfplayer_impact_line & viewline, ::user::e_key_state ekeystate, const ::i32_point & point);
   bool OnLButtonUp(xfplayer_impact_line & viewline, ::user::e_key_state ekeystate, const ::i32_point & point);
