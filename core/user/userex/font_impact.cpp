...
namespace userex
{
   ...
   void font_impact::install_message_routing(::channel* pchannel)
   {
      ...
      MESSAGE_LINK(::user::e_message_create, pchannel, this, &font_impact::on_message_create);
      MESSAGE_LINK(::user::e_message_show_window, pchannel, this, &font_impact::on_message_show_window);
