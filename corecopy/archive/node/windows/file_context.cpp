...
namespace windows
{
...

   {
      ...
      //if(::aura::file_context::FullPath(str, pszFileIn))
   ...
   bool file_context::FullPath(wstring & wstrFullPath, const wstring & wstrPath)
   {
      ...
      /*      if(::aura::file_context::FullPath(wstrFullPath, wstrPath))
      return true;*/
   ...
   //   {
   //      ::aura::TimeToFileTime(status.m_mtime,&lastWriteTime);
   ...
   //      {
   //         ::aura::TimeToFileTime(status.m_atime,&lastAccessTime);
   ...
   //      {
   //         ::aura::TimeToFileTime(status.m_ctime,&creationTime);
