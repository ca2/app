...
// Operations
public:
   CT * from_handle(HANDLE h, CT * (* pfnAllocator) (__pointer(::aura::application), HANDLE) = nullptr, __pointer(::aura::application) papp = nullptr);
   void delete_temp();
...
template < class HT, class CT >
CT* handle_map < HT, CT >::from_handle(HANDLE h, CT * (*pfnAllocator) (__pointer(::aura::application), HANDLE), __pointer(::aura::application) papp)
{
...
// Note: out-of-line __DEBUG version is in winhand. c p p
#ifndef __DEBUG
template < class HT, class CT >
...
CLASS_DECL_AURA himagelist_map * afxMapHIMAGELIST(bool bCreate = FALSE);
//CLASS_DECL_AURA hdc_map * afxMapHDC(bool bCreate = FALSE);
//CLASS_DECL_AURA hgdiobj_map * afxMapHGDIOBJ(bool bCreate = FALSE);
//CLASS_DECL_AURA hmenu_map * afx_map_HMENU(bool bCreate = FALSE);
