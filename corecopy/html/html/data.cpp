...
::html::font * html_data::get_font(::html::elemental * pelemental)
{
...
i32 html_data::create_font(::html::elemental * pelemental)
{
...
html::elemental * html_data::get_element_by_id(id id)
{
...
bool html_data::open_document(const var & varFile)
{
...
//void html_data::on_before_navigate(var & varFile, u32 nFlags, const char * pszTargetFrameName, byte_array& baPostedData, const char * pszHeaders, bool* pbCancel)
//{
//
