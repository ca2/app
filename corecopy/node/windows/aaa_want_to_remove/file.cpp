...
bool CLASS_DECL_CORE vfxGetInProcServer(const char * pszCLSID, string & str)
...
// turn a file, relative path or other into an absolute path
bool CLASS_DECL_CORE vfxFullPath(unichar * pszPathOut, const unichar * pszFileIn)
...
void CLASS_DECL_CORE vfxGetRoot(const unichar * pszPath, string& strRoot)
...
UINT CLASS_DECL_CORE vfxGetFileName(const unichar * pszPathName, unichar * pszTitle, UINT nMax)
