...
CLASS_DECL_CORE bool __initialize(bool bDLL, DWORD dwVersion);

CLASS_DECL_CORE uptr keycode_to_char(uptr n);

CLASS_DECL_CORE uptr virtualkey_to_char(::Windows::System::VirtualKey e);

CLASS_DECL_CORE::user::e_key virtualkey_to_userkey(::Windows::System::VirtualKey e, bool& bSpecialKey);
