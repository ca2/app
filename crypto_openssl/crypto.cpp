...
//   }
   ...
   //::e_status crypto::encrypt(memory & storageEncrypt, const memory & storageDecrypt, const memory & key)
   //{
   ...
   //::e_status crypto::decrypt(memory& storageDecrypt, const memory& storageEncrypt, const memory& key)
   //{
