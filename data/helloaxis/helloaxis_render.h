...
/*      ::draw2d::fastblur               m_pimage;
      ...
      string get_helloaxis() { sync_lock slText(m_pmutexText);  string str(m_strHelloAxis.c_str()); return str; }
      ...
      virtual void helloaxis_render_full_view(::draw2d::graphics_pointer & pgraphics);
      virtual void helloaxis_render_lite_view(::draw2d::graphics_pointer & pgraphics);
