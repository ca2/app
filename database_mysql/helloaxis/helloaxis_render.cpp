...
/*         helloaxis_render(pdraw2dgraphicsImage);
   ...
   void render::helloaxis_render(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
      ...
      //   {
      //
      //      helloaxis_render_full_impact(pdraw2dgraphicsImage);
      //
      //   }
...
/*            m_pgraphicsImage->text_out((m_cx - i32_size->cx) / 2, (m_cy - i32_size->cy) / 2, strHelloAxis);
