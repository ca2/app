...
namespace direct2d
{
   ...
   //::e_status component::initialize(::context_object * pcontextobject)
   //{
   ...
   component * component::g_p = nullptr;
   ...
   void component::initialize() 
   {
      ...
      if (g_pdxgidebug == nullptr)
      {
         ...
         //g_pdirect2dplugin = new component;
...
typedef FN_DXGIGetDebugInterface * PFN_DXGIGetDebugInterface;
   ...
   Microsoft::WRL::ComPtr<IDWriteFactory>      component::s_pwritefactory;
   Microsoft::WRL::ComPtr<ID2D1Factory1>       component::s_pd2factory;
   ...
   IDWriteFactory * component::dwrite_factory(bool bCreate)
   {
   ...
   ID2D1Factory1 * component::d2d1_factory1(bool bCreate)
   {
   ...
   ID3D11Device * component::draw_get_d3d11_device()
   {
   ...
   ID3D11Device1 * component::draw_get_d3d11_device1()
   {
   ...
   ID3D11DeviceContext * component::draw_get_d3d11_device_context()
   {
   ...
   ID3D11DeviceContext1 * component::draw_get_d3d11_device_context1()
   {
   ...
   IDXGIDevice * component::draw_get_dxgi_device()
   {
   ...
   ID2D1Device * component::draw_get_d2d1_device()
   {
