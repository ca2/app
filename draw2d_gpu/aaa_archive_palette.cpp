...
namespace draw2d_gpu
{
   ...
   {
      //return dynamic_cast < palette * > (::draw2d_gpu::object::from_handle(papp, hPalette));
      return nullptr;
   }
   ...
   {
      //ASSERT(pgraphics != nullptr && (dynamic_cast<::draw2d_gpu::graphics * >(pgraphics))->get_handle1() != nullptr);
      //return attach(::CreateHalftonePalette((dynamic_cast<::draw2d_gpu::graphics * >(pgraphics))->get_handle1()));
      return false;
