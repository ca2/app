...
namespace draw2d_gpu
{
   ...
   bool bitmap::CreateBitmap(::draw2d::graphics * pdraw2dgraphics, ::i32 nWidth, ::i32 nHeight, ::u32 nPlanes, ::u32 nBitcount, const void * lpBits, ::i32 stride)
   {
...
//
//      return m_memoryDraw2dBitmap.data();
//
//   }
