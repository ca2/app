...
namespace draw2d_gpu
{
   ...
   class CLASS_DECL_DRAW2D_GPU image :
   ...
   public:
      ...
      virtual void create(const ::i32_size& size, ::enum_flag eflagCreate = DEFAULT_CREATE_IMAGE_FLAG, ::i32 iGoodStride = -1, bool bPreserve = false) override;
      ...
      //void rotate(::image::image *pimage, const ::i32_rectangle & rectangle, ::f64 dAngle, ::f64 dScale);
      //void rotate(::image::image *pimage, ::f64 dAngle, ::f64 dScale);
      //void Rotate034(::image::image *pimage, ::f64 dAngle, ::f64 dScale);
      ...
      //void ::color::e_channel_multiply(color::color::color::rgba::echannel echannel, ::f64 dRate);
      ...
      //void create_frame(::i32_size size, ::i32 iFrameCount);
