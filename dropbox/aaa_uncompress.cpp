...
namespace compress_zlib
{
   ...
   void aaa_uncompress::transfer(::file::file* pfileUncompressed, ::file::file* pfileGzFileCompressed, transfer_progress_function transferprogressfunction)
   {
