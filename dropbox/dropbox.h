...
// From compress to dropbox by camilo on 2026-30-20 05:49 BRT <3ThomasBorregaardSørensen!!
#pragma once
...
namespace dropbox
{
   ...
   class CLASS_DECL_DROPBOX dropbox :
   ...
   public:
      ...
      static ::dropbox::dropbox * get(::particle * pparticle);
