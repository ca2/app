...
namespace experience_anthill
{
   ...
   void frame_Minimal001::DrawGrip(::draw2d::graphics_pointer & pdraw2dgraphics, const ::i32_rectangle & rectangleX, enum_grip egrip)
   {
      ...
      //                                  pointC.x += 15;
      //
      //                                  pdraw2dgraphics->MoveTo(pointA);
      //                                  pdraw2dgraphics->LineTo(pointB);
      //                                  pdraw2dgraphics->LineTo(pointC);
      //
