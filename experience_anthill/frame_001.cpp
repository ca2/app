...
SizingNone:;
            ...
            void frame_001::draw_border_side(::draw2d::graphics_pointer & pgraphics, const ::rect & rectClientParam, enum_border eside)
            {
...
//               enum_dock edock = m_pframewindow->dock_manager()->GetDockState();
            ...
            void frame_001::GetBorderRect(const ::rect & rectClient, LPRECT32 lprect, enum_border eside)
            {
