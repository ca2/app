#include "framework.h"
#include "core/user/menu/central.h"
...
namespace experience
{
   ...
   //
      ...
      ::color theme::get_color(const ::user::interaction* pinteraction, ::user::e_element eelement, ::user::estate estate) const
      {
   ...
   void theme::_001OnTabPaneDrawTitle(::user::tab_pane & pane,::user::tab * ptab,::draw2d::graphics_pointer & pgraphics, const ::rect & rect, ::draw2d::brush_pointer & brushText)
   {
   ...
   bool theme::_001OnTabLayout(::draw2d::graphics_pointer & pgraphics, ::user::tab * ptab)
   {
...
//   }
   ...
   bool theme::_001DrawToolbarItem(::draw2d::graphics_pointer & pgraphics, ::index iItem, ::user::toolbar * ptoolbar)
   {
   ...
   void theme::_001DrawSimpleToolbarItem(::draw2d::graphics_pointer & pgraphics, ::index iItem, ::user::toolbar * ptoolbar)
   {
...
//      }
   ...
   void theme::_001DrawAnthillToolbarItem(::draw2d::graphics_pointer & pgraphics, ::index iItem, ::user::toolbar * ptoolbar)
   {
