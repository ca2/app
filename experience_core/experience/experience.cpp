...
//#endif
   ...
   ::pointer < ::experience::frame > experience::frame_experience(const ::scoped_string & scopedstrFrameSchema)
   {
      ...
      if(strSchema == "001")
      {
         ...
         return create_newø< ::experience_core::frame_001 >();

      }
      else if(strSchema == "002")
      {
               
         return create_newø< ::experience_core::frame_002 >();

      }
      else if(strSchema == "005")
      {
               
         return create_newø< ::experience_core::frame_005 >();

      }
      else if(strSchema == "008")
      {
               
         return create_newø< ::experience_core::frame_008 >();

      }
      else if(strSchema == "011")
      {
               
         return create_newø< ::experience_core::frame_011 >();

      }
      else if (strSchema == "022")
      {

         return create_newø < ::experience_core::frame_022>();

      }
      else if(strSchema == "Minimal001")
      {

         return create_newø< ::experience_core::frame_Minimal001 >();
