...
namespace experience_core
{
   ...
   //::item_pointer frame_001::experience_frame_hit_test(const ::i32_point & point, ::user::e_zorder ezorder)
   //{

   //   ::item_pointer pitemHitTest;
   ...
   //      {
   //         //auto pitem = 
   //         //auto puseritem = m_pframewindow->user_item(pitem);
...
//               auto edock = m_pframewindow->dock_manager()->GetDockState();
   ...
   //   rectangleSmall = m_pframewindow->client_rectangle();
   ...
   void frame_001::DrawGrip(::draw2d::graphics_pointer & pdraw2dgraphics, const ::i32_rectangle & rectangleXParam, enum_grip egrip)
   {
      ...
      case e_grip_top_left:
...

         {
            ...
            pdraw2dpath->set_current_point(pointA);
            pdraw2dpath->add_line(pointB);
            pdraw2dpath->add_line(pointC);
