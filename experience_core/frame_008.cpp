...
SizingNone:;
            ...
            void frame_008::draw_border_side(::draw2d::graphics_pointer & pgraphics, const ::rect & rectClient, e_border eside)
            {
               ...
               if(m_bHollow)
               {
                  ...
                  pgraphics->fill_solid_rect(rect, A_RGB(255, crMoveableBorder));//m_crMoveableBorderDkShadow);
            ...
            void frame_008::GetBorderRect(const ::rect & rectClient, LPRECT lprect, e_border eside)
            {
