...
namespace experience_core
{
   ...
   public:
      ...
      bool _001DrawSimpleScrollBar(::draw2d::graphics_pointer & pdraw2dgraphics, ::user::scroll_bar * pbar) override;

      bool _001OnDrawMainFrameBackground(::draw2d::graphics_pointer & pdraw2dgraphics, ::user::interaction * pinteraction) override;
