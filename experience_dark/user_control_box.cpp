...
void MetaControlBox::install_message_routing(::channel * pchannel)
{
   ...
   MESSAGE_LINK(::user::e_message_show_window, pchannel, this, &MetaControlBox::on_message_show_window);
   MESSAGE_LINK(::user::e_message_left_button_down, pchannel, this, &MetaControlBox::on_message_left_button_down);
   MESSAGE_LINK(::user::e_message_left_button_up, pchannel, this, &MetaControlBox::on_message_left_button_up);
//   MESSAGE_LINK(::user::e_message_size, pchannel, this, &MetaControlBox::on_message_size);
//   //MESSAGE_LINK(::user::e_message_timer, pchannel, this, &MetaControlBox::on_timer);
