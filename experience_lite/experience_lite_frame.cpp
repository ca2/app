#include "framework.h"
   ...
   namespace experience
   {
...

         {
            ...
            void frame::Glass(::draw2d::graphics_pointer & pgraphics, const RECT32 & lprect)
            {
...
/*               //pimage = create_image({rectClient.width(),  rectClient.height()});
            ...
            void frame::ColorGlass(::draw2d::graphics_pointer & pgraphics, const RECT32 & lprect, color32_t cr, byte bAlpha)
            {
