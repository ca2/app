...
//      virtual bool get_color(COLORREF & cr, ::user::e_color ecolor, ::user::interaction * pframewindow) override;
      ...
      void _001OnTabPaneDrawTitle(::user::tab_pane & pane,::user::tab * ptab,::draw2d::graphics_pointer & pgraphics,LPCRECT lpcrect,::draw2d::brush_pointer & brushText) override;
