...
//      auto crButtonShadow = pframewindow->get_color(pstyle, ::e_element_button_shadow);
//
//      pdraw2dgraphics->draw_inset_3d_rectangle(rectangle, crButtonFace.opaque(), crButtonDarkShadow.opaque());
//
//      rectangle.deflate(1, 1);
//
//      pdraw2dgraphics->draw_inset_3d_rectangle(rectangle, crButtonHilite.opaque(), crButtonShadow.opaque());
//
//      rectangle.deflate(1, 1);
//
//      rectangle.right--;
