...
namespace experience_tranquillum
{
      ...
      public ::experience::frame
   {
      ...
      ::i32_rectangle                        m_rectangleCaptionTextBk;
...
//               virtual void _001OnBeforeSize(const ::i32_rectangle & rectangleWindow) override;
      ...
      virtual bool get_element_rectangle(::i32_rectangle & rectangle, enum_element eelement) override;
      ...
      virtual void GetFrameRect(i32_rectangle & rectangle) override;
