...
//   }
   ...
   void frame_Minimal001::draw_border_side(::draw2d::graphics_pointer & pdraw2dgraphics, const ::i32_rectangle & rectangleX, enum_border eside)
   {
      ...
      if(is_translucid_style(estyle))
      {
         ...
         //imaging.color_blend(
            pdraw2dgraphics->fill_rectangle(rectangle, colorMoveableBorder & ::opacity(127));
      ...
      else
      {
         ...
         //imaging.color_blend(pdraw2dgraphics, rectangle, colorMoveableBorder, 127);

         pdraw2dgraphics->fill_rectangle(rectangle, colorMoveableBorder & 127_opacity);
   ...
   //void frame_Minimal001::GetBorderRectangle(const ::i32_rectangle & rectangleX, ::i32_rectangle * prectangle, enum_border eside)
