...
SizingNone:;
            ...
            void frame_001::draw_border_side(::draw2d::graphics_pointer & pgraphics, const ::rect & rectClient, e_border eside)
            {
...
//               e_dock edock = m_pframewindow->dock_manager()->GetDockState();
            ...
            void frame_001::DrawGrip(::draw2d::graphics_pointer & pgraphics, const ::rect & rectClientParam, e_grip egrip)
