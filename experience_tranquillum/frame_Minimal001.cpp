...
SizingNone:;
            ...
            void frame_Minimal001::draw_border_side(::draw2d::graphics_pointer & pgraphics, const ::rectangle_i32 & rectClient, enum_border eside)
            {
               ...
               if(is_translucid_style(estyle))
               {
                  ...
                  imaging.color_blend(pgraphics, rectangle_i32, colorMoveableBorder, 127);
            ...
            void frame_Minimal001::GetBorderRect(const ::rectangle_i32 & rectClient, RECTANGLE_I32 * prectangle, enum_border eside)
