...
//      m_fontEdit->create_point_font("MS Sans Serif", 9.0);
   ...
   bool theme::_001OnDrawMainFrameBackground(::draw2d::graphics_pointer & pgraphics, ::user::frame * pframe)
   {
   ...
   void theme::_001OnTabPaneDrawTitle(::user::tab_pane & pane,::user::tab * ptab,::draw2d::graphics_pointer & pgraphics,const ::rect & rectParam,::draw2d::brush_pointer & brushText)
   {
      ...
      if(straTitle.get_count() <= 1)
      {
         ...
         pgraphics->_DrawText(pane.get_title(), rectParam, DT_LEFT | DT_BOTTOM | DT_NOPREFIX);
...
//   }
   ...
   //void theme::_001DrawTranquillumToolbarItem(::draw2d::graphics_pointer & pgraphics, index iItem, ::user::toolbar * ptoolbar)
   //{
