...
//   }
   ...
   //      m_pbuffile1 = allocateø ::file::buffered_file(pfile, 1024 * 32);

   //      m_pbuffile2 = allocateø ::file::buffered_file(m_pbuffile1, 1024 * 32);
   ...
   //      m_pbuffile2 = allocateø ::file::buffered_file(pfile, 1024 * 32);
   ...
   //   auto pfile = system()->createø < ::file::file > ();
   ...
   //   m_pbuffile1 = allocateø ::file::buffered_file(pfile, 1024 * 256);

   //   m_pbuffile2 = allocateø ::file::buffered_file(m_pbuffile1, 1024 * 256);
