...
//   }
   ...
   //      m_pbuffile1 = ::place(new ::file::buffered_file(pfile, 1024 * 32));

   //      m_pbuffile2 = ::place(new ::file::buffered_file(m_pbuffile1, 1024 * 32));
   ...
   //      m_pbuffile2 = ::place(new ::file::buffered_file(pfile, 1024 * 32));
   ...
   //   m_pbuffile1 = ::place(new ::file::buffered_file(pfile, 1024 * 256));

   //   m_pbuffile2 = ::place(new ::file::buffered_file(m_pbuffile1, 1024 * 256));
