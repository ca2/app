...
extern i32 CLASS_DECL_FOLDER_ZIP unzStringFileNameCompare OF ((const char* fileName1,
...
extern unzFile CLASS_DECL_FOLDER_ZIP unzOpen OF((const char *path));
/*
...
extern unzFile CLASS_DECL_FOLDER_ZIP unzOpen2 OF((const char *path,
...
extern i32 CLASS_DECL_FOLDER_ZIP unzClose OF((unzFile file));
/*
...
extern i32 CLASS_DECL_FOLDER_ZIP unzGetGlobalInfo OF((unzFile file,
...
extern i32 CLASS_DECL_FOLDER_ZIP unzGetGlobalComment OF((unzFile file,
      char *szComment,
      uptr uSizeBuf));
/*
...
extern i32 CLASS_DECL_FOLDER_ZIP unzGoToFirstFile OF((unzFile file));
/*
  set the current file of the zipfile to the first spfile->
  return UNZ_OK if there is no problem
*/

extern i32 CLASS_DECL_FOLDER_ZIP unzGoToNextFile OF((unzFile file));
/*
...
extern i32 CLASS_DECL_FOLDER_ZIP unzLocateFile OF((unzFile file,
...
extern i32 CLASS_DECL_FOLDER_ZIP unzGetCurrentFileInfo OF((unzFile file,
...
extern i32 CLASS_DECL_FOLDER_ZIP unzOpenCurrentFile OF((unzFile file));
/*
  open for reading data the current file in the zipfile.
  If there is no error, the return value is UNZ_OK.
*/

extern i32 CLASS_DECL_FOLDER_ZIP unzOpenCurrentFilePassword OF((unzFile file,
      const char* password));
/*
  open for reading data the current file in the zipfile.
...
extern i32 CLASS_DECL_FOLDER_ZIP unzOpenCurrentFile2 OF((unzFile file,
      i32* method,
      i32* level,
      i32 raw));
/*
...
extern i32 CLASS_DECL_FOLDER_ZIP unzOpenCurrentFile3 OF((unzFile file,
      i32* method,
      i32* level,
      i32 raw,
      const char* password));
...
extern i32 CLASS_DECL_FOLDER_ZIP unzCloseCurrentFile OF((unzFile file));
/*
  close the file in zip opened with unzOpenCurrentFile
  Return UNZ_CRCERROR if all the file was read but the CRC is not good
*/

extern i32 CLASS_DECL_FOLDER_ZIP unzReadCurrentFile OF((unzFile file,
      voidp buf,
      u32 len));
/*
...
extern i32 CLASS_DECL_FOLDER_ZIP unzeof OF((unzFile file));
/*
  return 1 if the end of file was reached, 0 elsewhere
*/

extern i32 CLASS_DECL_FOLDER_ZIP unzGetLocalExtrafield OF((unzFile file,
      voidp buf,
      u32 len));
/*
