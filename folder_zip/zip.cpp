...
void * fstream)
{
   ...
   ziinit.filestream = fstream;/*(*(ziinit.z_filefunc.zopen_file))
...
extern ::i32 CLASS_DECL_FOLDER_ZIP zipOpenNewFileInZip3 (
zipFile file,
...
#    endif
   ...
   size_filename = (::u32) ansi_len(pszFilename);
   ...
   for (i=0; i<size_filename; i++)
      *(zi->ci.central_header+SIZECENTRALHEADER+i) = *(pszFilename+i);
   ...
   if ((err==ZIP_OK) && (size_filename>0))
      if (ZWRITE(zi->z_filefunc,zi->filestream,pszFilename,size_filename)!=size_filename)
         err = ZIP_ERRNO;
...
extern ::i32 CLASS_DECL_FOLDER_ZIP zipOpenNewFileInZip2(
zipFile file,
const_char_pointer pszFilename,
const zip_fileinfo* zipfi,
const void * extrafield_local,
...
::i32 raw)
{
   return zipOpenNewFileInZip3 (file, pszFilename, zipfi,
...
extern ::i32 CLASS_DECL_FOLDER_ZIP zipOpenNewFileInZip (
zipFile file,
const_char_pointer pszFilename,
const zip_fileinfo* zipfi,
const void * extrafield_local,
...
::i32 level)
{
   return zipOpenNewFileInZip2 (file, pszFilename, zipfi,
                                extrafield_local, size_extrafield_local,
                                extrafield_global, size_extrafield_global,
...
extern ::i32 CLASS_DECL_FOLDER_ZIP zipWriteInFileInZip (
zipFile file,
const void * buf,
::u32 len)
{
...
extern ::i32 CLASS_DECL_FOLDER_ZIP zipCloseFileInZipRaw (
zipFile file,
...
extern ::i32 CLASS_DECL_FOLDER_ZIP zipCloseFileInZip (
zipFile file)
{
   return zipCloseFileInZipRaw (file,0,0);
}

extern ::i32 CLASS_DECL_FOLDER_ZIP zipClose (
zipFile file,
