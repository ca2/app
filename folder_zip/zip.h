...
extern zipFile CLASS_DECL_FOLDER_ZIP zipOpen OF((const_char_pointer pszPathname, ::i32 append));
/*
  create a zipfile.
...
extern zipFile CLASS_DECL_FOLDER_ZIP zipOpen2 OF((const_char_pointer pszPathname,
      ::i32 append,
