...
namespace fs_raw_folder_protocol_google_drive
{
   ...
   ::string folder_sync::_google_drive(const ::scoped_string & scopedstr,
   ...
   ::string_array_base folder_sync::_google_drive_lines(const ::scoped_string & scopedstr, const ::function < void(const ::scoped_string&) >& callbackStatus)
   {
