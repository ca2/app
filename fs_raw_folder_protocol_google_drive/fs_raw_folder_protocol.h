// From fs_folder_sync_google_drive camilo on 2025-03-10 20:33 <3ThomasBorregaardSorensen!!
// From fs/folder_sync.h filesystem_google_drive.h by camilo on 2024-04-28 00:51 <3ThomasBorregaardSorensen!!
#pragma once
...
namespace fs_raw_folder_protocol_google_drive
{
   ...
   public:
      ...
      virtual ::file::path google_drive_info_network_payload();

      ::string protocol() override;

      //virtual ::string _google_drive(const ::scoped_string & scopedstr, const ::function < void(const ::scoped_string&) >& callbackStatus);
      //virtual ::string_array_base _google_drive_lines(const ::scoped_string & scopedstr, const ::function < void(const ::scoped_string&) >& callbackStatus);
