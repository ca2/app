...
namespace fs_raw_folder_protocol_google_drive
{
   ...
   void folder::calculate_installed()
   {
         ...
         ::file::path pathNetworkPayload = google_drive_info_network_payload();
         ...
         if (!file()->exists(pathNetworkPayload))
         {
            ...
            if (::system()->is_desktop_system())
            {
               ...
               auto pathTxt = pathUserConfig / "google_drive.txt";
   ...
   //::string folder::_google_drive(const ::scoped_string & scopedstr,
   ...
   //         node()->calculate_google_drive_installed();

   //         if (callbackStatus)
   //         {

   //            callbackStatus("Waiting for Google_Drive folder " + pathFolder + " creation...");
   ...
   //      ::file::path pathGoogle_DriveBin = pathHomeFolder / "bin/google_drive";
   ...
   //      strCommand = strGoogle_DriveCommand + " " + scopedstr;
   ...
   //               callbackStatus("Google_Drive daemon isn't running... Trying to start it...");
   ...
   //               callbackStatus("Google_Drive daemon isn't responding...");
   ...
   //::string_array_base folder::_google_drive_lines(const ::scoped_string & scopedstr, const ::function < void(const ::scoped_string&) >& callbackStatus)
   //{

   //   auto str = _google_drive(scopedstr, callbackStatus);
...
//      {
//
//         auto lines = _google_drive_lines("filestatus", callbackStatus);
//
//         bool bOk = true;
//
//         for (auto& line : lines)
...
//            }
//
//            auto google_driveLine = lines[iFind];
//
...
//         {
//
//            callbackStatus("Waiting for Google_Drive service to get up and running... please wait...");
//
//         }
//
//         auto stra = sync_exclusion_list(callbackStatus);
//
//         //auto stra = _google_drive_lines("exclude list_base", callbackStatus);
//
...
//      {
//
//         auto stra = _google_drive_lines("filestatus", callbackStatus);
//
//         bool bOk = true;
//
//         for (auto& line : lines)
...
////
////      node()->detached_command(pathHomeFolder / ".google_drive-dist/google_drived &", {});
////
////   }
//
//
...
//      {
//
//         str = _google_drive("ls", callbackStatus);
//
//      }
//      else
//      {
//
//         str = _google_drive("ls \"" + path + "\"", callbackStatus);
//
//      }
//
//      ::string_array_base stra;
...
////
////      auto strExcludeOutput = _google_drive("exclude add " + strExclude, callbackStatus);
////
////   }
////
////
...
////
////      auto strIncludeOutput = _google_drive("exclude remove " + strInclude, callbackStatus);
////
////   }
////
////
