...
// application_build_helper --inline-text "_001Blend.vert"
#pragma once


const char g_psz__001Blend_vert[] = R"vert_text(// ca2 reserves b0 for the global UBO and binds shared push properties at b1.
