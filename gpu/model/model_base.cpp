...
namespace gpu
{
   ...
   namespace model
   {
      ...
      //::pointer<::gpu::model::mesh> model_base::processMesh(aiMesh *mesh, const aiScene *scene)
      //{
      ...
      // loads the first texture of given type
      ::gpu::texture *model_base::loadMaterialTexture(const ::scoped_string &scopedstr, bool bSrgb)
      {
