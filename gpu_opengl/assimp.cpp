...
namespace assimp
{
   ...
   bool load_obj(const void * data, memsize size, array<::u16> & indexes, array<::floating_sequence3> & vertexes, array<::floating_sequence2> & uvs, array<::floating_sequence3> & normals)
   {
