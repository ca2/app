...
namespace gpu_opengl
{
   ...
   namespace ibl
   {
      ...
      // void SpecularMap::initialize_SpecularMap(const ::string &engineRoot, const unsigned int environmentCubemapId)
      // {
      //
      ...
      unsigned int SpecularMap::getPrefilteredEnvMapId()
      {
         ...
         ::cast <gpu_opengl::ibl::MipmapCubemapFramebuffer> pframebuffer = m_pprefilteredEnvMapFramebuffer;
      ...
      void SpecularMap::computeBrdfConvolutionMap()
      {
         ...
         m_pbrdfConvolutionFramebuffer->use();
      ...
      unsigned int SpecularMap::getBrdfConvolutionMapId()
      {
         ...
         ::cast <::gpu_opengl::ibl::BrdfConvolutionFramebuffer> pframebuffer = m_pbrdfConvolutionFramebuffer;
