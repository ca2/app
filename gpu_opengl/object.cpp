...
const_char_pointer opengl_error_string(::i32 iError)
{
...
//      {
//       
//         pszErrorN = (const_char_pointer )opengl_error_string(iErrorN);
//
//      }
//
//#ifdef __APPLE__
