...
namespace gpu_opengl
{
   ...
   public:
      ...
      //virtual void setInt(const ::scoped_string & scopedstrName, ::i32 value) override;

      //virtual void setFloat(const ::scoped_string & scopedstrName, ::f32 value) override;

      ////virtual void setVec2(const ::scoped_string & scopedstrName, const floating_sequence2& value) override;
      //virtual void setVec2(const ::scoped_string & scopedstrName, ::f32 x, ::f32 y) override;

      ////virtual void setVec3(const ::scoped_string & scopedstrName, const floating_sequence3& value) override;
      //virtual void setVec3(const ::scoped_string & scopedstrName, ::f32 x, ::f32 y, ::f32 z) override;

      ////virtual void setVec4(const ::scoped_string & scopedstrName, const floating_sequence4& value) override;
      //virtual void setVec4(const ::scoped_string & scopedstrName, ::f32 x, ::f32 y, ::f32 z, ::f32 w) override;
      ...
      //virtual void setMat2(const ::scoped_string & scopedstrName, const ::f32 p[2*2]) override;
      //virtual void setMat3(const ::scoped_string & scopedstrName, const ::f32 p[3*3]) override;
      //virtual void setMat4(const ::scoped_string & scopedstrName, const ::f32 p[4*4]) override;
      ...
      virtual GLint _get_uniform_location(const_char_pointer pszName, const_char_pointer debug) const;
      ...
      void _set_matrix2(const_char_pointer pszName, const floating_matrix2& matrix) const;
      void _set_matrix3(const_char_pointer pszName, const floating_matrix3& matrix) const;
      void _set_matrix4(const_char_pointer pszName, const floating_matrix4& matrix) const;
      ...
      void set_sequence4(const ::scoped_string& scopedstrName, ::f32 x, ::f32 y, ::f32 z, ::f32 w) override;
