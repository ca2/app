...
namespace vulkan
{
   ...
   void vulkan::initialize(::particle * pparticle)
   {
   ...
   ::pointer < ::gpu::context > vulkan::create_context(::particle * pparticle)
   {
   ...
   void vulkan::defer_init_gpu_library()
   {
...
#define FOURCC_DXT5 0x35545844 // Equivalent to "DXT5" in ASCII
   ...
   int vulkan::fread(void* data, int c, int s, ::file::file* pfile)
   {
   ...
   ::gpu::payload vulkan::load_dds(const ::scoped_string & scopedstrImagePath) 
   {
