...
/*         pdraw2dgraphicsImage->FillSolidRect(prender->m_rectangleX, argb(255, 255, 255, 255));

/*         prender->_006OnDraw(pdraw2dgraphicsImage);
...
INT_PTR CALLBACK About(HWND hDlg, ::user::enum_message eusermessage, ::wparam wparam, ::lparam lparam)
{
