...
//                                             point((m_rectClient.width() - m_pimageTemplate2->width()) / 2, (m_rectClient->height() - m_pimageTemplate2->height()) / 2)
...
//            m_pimage->g()->set_font(m_font);
//
//            m_pimage->g()->text_out((m_rectClient.width() - size.cx) / 2, (m_rectClient->height() - size->cy) / 2, strHelloAXIS);
//
//            if (m_dMinRadius > 3.0)
//            {
//
