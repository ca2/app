...
/*         helloaura_render(pgraphicsImage);
   ...
   void render::helloaura_render(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
      ...
      //   if(m_bLite)
      {
         ...
         helloaura_render_lite_impact(pdraw2dgraphics);
   ...
   void render::helloaura_render_lite_impact(::draw2d::graphics_pointer & pdraw2dgraphics)
   {

      return ::helloaura::render::helloaura_render_lite_impact(pdraw2dgraphics);
...
//
//      size = pdraw2dgraphics->get_text_extent(strHelloBase);
//
...
//      {
//
//         pdraw2dgraphics->text_out((m_cx - size.cx) / 2, (m_cy - size.cy) / 2, strHelloBase);
//
//      }
...
//      }
   ...
   void render::helloaura_render_full_impact(::draw2d::graphics_pointer & pdraw2dgraphics)
   {

      return ::helloaura::render::helloaura_render_full_impact(pdraw2dgraphics);
...
//
//      ::i32_size size = pdraw2dgraphics->get_text_extent(strHelloBase);
//
//      m_cxTarget = ::i32(size.cx * 1.2);
//      m_cyTarget = ::i32(size.cy * 1.2);
//
...
//#endif
//
//      if (strHelloBase == get_helloaura() && m_cx == m_rectangleX.width() && m_cy == m_rectangleX.height())
//      {
//
//         m_bFirstDone = true;
//
//      }
   ...
   void render::_006OnDraw(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
      ...
      return ::helloaura::render::_006OnDraw(pdraw2dgraphics);
