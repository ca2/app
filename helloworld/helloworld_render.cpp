...
/*         helloworld_render(pdraw2dgraphicsImage);
   ...
   void render::helloworld_render(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
      ...
      //   if(m_bLite)
      {
         ...
         helloworld_render_lite_impact(pdraw2dgraphics);

      }
      //   else
      //   {
      //
      //      helloworld_render_full_impact(pdraw2dgraphicsImage);
      //
      //   }
   ...
   void render::helloworld_render_lite_impact(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
...
//      else
      ...
      size = pdraw2dgraphics->get_text_extent(strHelloWorld);
...
//      else if (m_bAlternate)
      ...
      //if(!m_bAlternate)
      {
         ...
         pdraw2dgraphics->text_out((m_cx - size.cx) / 2, (m_cy - size.cy) / 2, strHelloWorld);
   ...
   void render::helloworld_render_full_impact(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
...
//
      ...
      ::i32_size size = pdraw2dgraphics->get_text_extent(strHelloWorld);
...
/*   //               pdraw2dgraphics->BitBlt(0, 0, pimage->width(), pimage->height(), pdraw2dgraphicsImage, 0, 0);
   ...
   //            strHelloWorld = m_pimpact->get_processed_helloworld().c_str();
   ...
   //            helloworld_fast_render(m_pimpact->get_processed_helloworld());
...
/*      return pimage;
   ...
   void render::helloworld_fast_render(const ::scoped_string & scopedstrHelloWorld)
   {
...
/*         m_pimageFast = create_image(sizeNew);
      ...
      ppath->add_string((m_cx - size.cx) / 2, (m_cy - size.cy) / 2, strHelloWorld, m_pfont);
   ...
   string render::get_helloaura()
   {
      ...
      return strHelloWorld = m_pimpact->get_processed_helloworld();
