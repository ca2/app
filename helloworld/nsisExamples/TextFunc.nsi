...
Function LeaveCustom
	...
	FileWrite $0 '	MessageBox ::user::e_message_box_ok "             Files differ" IDOK +2$\r$\n'
	FileWrite $0 '	MessageBox ::user::e_message_box_ok "           Files identical"$\r$\n'
	...
	endoninit:
	FileWrite $0 '	error:$\r$\n'
	FileWrite $0 '	MessageBox ::user::e_message_box_ok "Error"$\r$\n$\r$\n'
	FileWrite $0 '	end:$\r$\n'
	FileWrite $0 '	Quit$\r$\n'
	FileWrite $0 'FunctionEnd$\r$\n$\r$\n'
	#FunctionEnd#
	...
	GetDlgItem $0 $HWND 1203
	EnableWindow $0 0
	SendMessage $0 ${::user::e_message_enable} 1 0
...
;=Enter=
	...
	StrCpy $PROJECT ''
	goto done
	MessageBox MB_YESNO|::user::e_message_box_icon_exclamation "Compile error. Open log?" IDNO +2
	Exec 'notepad.exe $LOG'
