...
/*         WORD bpp = (WORD)FreeImage_GetBPP(pimage);
...
/*         cinfo.X_density = (UINT16) (0.5 + 0.0254 * FreeImage_GetDotsPerMeterX(pimage));
/*         cinfo.Y_density = (UINT16) (0.5 + 0.0254 * FreeImage_GetDotsPerMeterY(pimage));
