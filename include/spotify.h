 ...
 * @see sp_image_create
 */
SP_LIBEXPORT(const unsigned char *) sp_album_cover(sp_album *album, sp_image_size size_i32);
 ...
 *
 */
SP_LIBEXPORT(const unsigned char *) sp_artist_portrait(sp_artist *artist, sp_image_size size_i32);
