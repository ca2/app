...
namespace innate_subsystem
{
   ...
   public:
      ...
      // Draws text.
      virtual void drawText(const char *text, int cchText, ::i32_rectangle &rect, ::u32 format = 0, enum_align ealign = e_align_top_left) = 0;
   ...
   public:
      ...
      // Draws bitmap.
      void drawBitmap(BitmapInterface* bitmap, const ::i32_rectangle& rectangle) override
      {

         m_pgraphics->drawBitmap(bitmap, rectangle);

      }
      void drawBitmap(BitmapInterface* bitmap, const ::i32_point& point, const ::i32_rectangle& rectangleSrc) override
      {
      ...
      // Draws text.
      void drawText(const char* text, int cchText, ::i32_rectangle& rect, ::u32 format = 0, enum_align ealign = e_align_top_left) override
      {
