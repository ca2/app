...
//    void Tab::setDialog(DialogInterface *dialog)
//    {
//
//       m_pparticleThis->setDialog(dialog);
//
//    }
//
//
//    DialogInterface *Tab::getDialog()
//    {
//
//       return m_pparticleThis->getDialog();
//
//    }
//
//    //
