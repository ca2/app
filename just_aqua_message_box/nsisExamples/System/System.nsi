...
Section "ThisNameIsIgnoredSoWhyBother?"
     ...
     !insertmacro smMessageBox "i 0" "Message box with custom icon!" "System Example 1a" ${::user::e_message_box_ok} "i 103"
...
enumex: ; End of drives or user cancel
     ...
     System::Call 'user32::MessageBox(p $HWNDPARENT, t "Just direct MessageBox specification demo ;)", t "System Example 3", i ${::user::e_message_box_ok}) i.s'
     Pop $0
     ...
     MessageBox ::user::e_message_box_ok "Structure example: $\nint == $2 $\nstring == $3 $\nbyte == $4 $\nshort == $5 $\nsize == $6"
     System::Free $1
     ...
     MessageBox ::user::e_message_box_ok "GetFileSysTime example: file '$0', year $1, month $2, dow $3, day $4, hour $5, min $6, sec $7, ms $8"
...
;     Delete $TEMP\spltmp.wav
     ...
     pop $0
     MessageBox ::user::e_message_box_ok "Splash (callbacks) demo result $R0"
