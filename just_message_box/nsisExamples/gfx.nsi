...
Function customPage
	...
	MessageBox ::user::e_message_box_ok 'This is a nice custom "page" with yet another image :P'
...
Function un.customPage
	!insertmacro BIMAGE "${NSISDIR}\Contrib\Graphics\Header\win.bmp" /RESIZETOFIT
	MessageBox ::user::e_message_box_ok 'This is a nice uninstaller custom "page" with yet another image :P'
	#insert install options/start menu/<insert plugin name here> here
FunctionEnd
...
Section uninstall
	MessageBox ::user::e_message_box_ok "Bla"
SectionEnd
