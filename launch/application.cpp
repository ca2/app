...
IMPLEMENT_APPLICATION_FACTORY(launch);
...
namespace launch
{
   ...
   void application::do_launch()
   {
   
      construct_newø(m_plaunch);

      m_plaunch->m_plaunchapplication = this;

      m_plaunch->m_strLaunchAppId = m_strLaunchAppId;
   ...
   void application::on_going_to_launch()
   {
