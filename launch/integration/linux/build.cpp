...
namespace console_integration
{
   ...
   void build::initialize(::particle * pparticle)
   {
      ...
      m_papplication->m_pathOperatingSystemStorageFolder = directory_system()->home()/"workspace/operating_system/storage-linux";
...
//         m_papplication->bash("./build");
   ...
   //         m_papplication->bash(strCommand1);
      ...
      //   X86_PATH=$BASE_PREFIX/x86_64/lib/lib$LIBNAME.dylib
         ...
         auto pathOutput = directory_system()->home() / "workspace/operating_system/storage-linux/library" / strDylib;
