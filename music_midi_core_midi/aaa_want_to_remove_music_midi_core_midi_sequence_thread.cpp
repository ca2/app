...
namespace music
{
   ...
   //         IGUI_MSG_LINK(message_player_command, pchannel, this, &sequence_thread::OnCommand);
            IGUI_MSG_LINK(message_midi_sequence_event, psender, this, &sequence_thread::OnMidiSequenceEvent);
         }
   ...
   //      }
         ...
         void sequence_thread::PrerollRateAndWait(double dRate)
         {
            ...
            preroll.tkBase = (imedia_position) (i32) ((double) get_sequence()->m_tkLength * dRate);
            preroll.tkEnd  = get_sequence()->m_tkLength;
