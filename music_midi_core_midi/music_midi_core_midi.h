...
//::music::midi::message_out * music_midi_audio_unit_new_message_out(::object * pobject);
...
#include "music_midi_core_midi_translation.h"
...
#include "music_midi_core_midi_factory_exchange.h"


#include "music_midi_core_midi_midi.h"
