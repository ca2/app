...
begin
  ...
  NSISDialog(GetUserVariable(INST_0), 'The value of $0', ::user::e_message_box_ok);
  NSISDialog(PopString, 'pop', ::user::e_message_box_ok);
...
begin
  ...
  if NSPIM = NSPIM_UNLOAD then
    begin
      NSISDialog(PChar('NSPIM_UNLOAD is the final callback, goodbye...'), PChar('mynsiscallback'), ::user::e_message_box_ok);
    end;
end;
