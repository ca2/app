...
namespace nanoui
{
   ...
   public:
      ...
      /**
       * The callback to execute when a __new ::color::color is selected on the ColorWheel
       ...
       * called when a user selects a __new ::color::color using by clicking this Button.
       */
      Button* m_pick_button;

      /**
       * Remains the ::color::color of the active ::color::color selection, until the user picks a
       * __new ::color::color on the ColorWheel **and** selects the
