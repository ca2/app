...
public:
    ...
    *     for icons, etc.
    */
   virtual Vector2i preferred_size(::nano2d::context * pcontext, Widget * widget, bool bRecalcTextSize = true) = 0;
protected:
...
public:
   ...
   virtual Vector2i preferred_size(::nano2d::context * pcontext, Widget * widget, bool bRecalcTextSize = true) override;
