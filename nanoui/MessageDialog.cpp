...
namespace nanoui
{
   ...
   MessageDialog::MessageDialog(Widget* parent, Type type, const ::scoped_string& title,
      ...
      set_layout(::as(__new BoxLayout(e_orientation_vertical,
         e_alignment_middle, 10, 10)));
      set_modal(true);

      Widget* panel1 = __allocate Widget(this);
      panel1->set_layout(::as(__new BoxLayout(e_orientation_horizontal,
      ...
      panelB->set_layout(::as(__new BoxLayout(e_orientation_vertical,
      ...
      panel2->set_layout(::as(__new BoxLayout(e_orientation_horizontal,
