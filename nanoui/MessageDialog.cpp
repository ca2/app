...
namespace nanoui
{
   ...
   MessageDialog::MessageDialog(Widget* parent, Type type, const ::scoped_string& title,
      ...
      set_layout(__initialize_new BoxLayout(e_orientation_vertical,
         e_alignment_middle, ::i32_rectangle(10, 10, 10, 10), 10));
      set_modal(true);
      ...
      panelB->set_layout(__initialize_new BoxLayout(e_orientation_vertical, e_alignment_middle, ::i32_rectangle(0, 0, 0, 0), 5));
      if (functionExtras)
      {
      ...
      panel2->set_layout(__initialize_new BoxLayout(e_orientation_horizontal, e_alignment_middle, ::i32_rectangle(0, 0, 0, 0), 15));
