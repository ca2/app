...
namespace nanoui
{
   ...
   //}
   //
   //void Screen::set_size(const int_sequence2 & size) {
...
//      m_pixel_ratio = (float)m_fbsize[0] / (float)m_size[0];
   ...
   //   p += m_pos;
   //
   //   int_sequence2 rel(m_pointMouseLast.x, m_pointMouseLast.y);
   //
   //   rel += m_pos;
   //
