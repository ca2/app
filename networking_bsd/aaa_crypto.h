...
namespace crypto_openssl
{
   ...
   public:
      ...
      ::i32 get_hash_digest_length(enum_hash) const override;
...
CLASS_DECL_APEX void stunCalculateIntegrity_longterm(char_pointer hmac, const_char_pointer input, ::i32 length, const_char_pointer username, const_char_pointer realm, const_char_pointer password);

CLASS_DECL_APEX void stunCalculateIntegrity_shortterm(char_pointer hmac, const_char_pointer input, ::i32 length, const_char_pointer key);


CLASS_DECL_APEX void hmac_evp_sha1_1234(::u8 * hmac, ::u32 * hmacSize, const ::u8 * buf, size_t bufLen);
