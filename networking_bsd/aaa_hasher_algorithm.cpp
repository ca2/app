...
namespace crypto_openssl
{
   ...
   //   {
   //   case e_hash_md5:
   //      return aaa_primitive_new ::cryptopenssl::hasher_algorithm(ehash, EVP_md5());
   //   case e_hash_sha1:
   //      return aaa_primitive_new ::openssl::hasher_algorithm(ehash, EVP_sha1());
   //   case e_hash_sha256:
   //      return aaa_primitive_new ::openssl::hasher_algorithm(ehash, EVP_sha256());
   //   default:
   //      return nullptr;
   //   }
