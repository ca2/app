...
namespace crypto_openssl
{
   ...
   ::i32 rsa::public_encrypt(memory& out, const memory& in, string& strError)
   {
      ...
      ::i32 i = RSA_public_encrypt((::i32)in.get_size(), (const ::u8 * )(const_char_pointer )in.get_data(), out.get_data(), m_prsa, RSA_PKCS1_PADDING);
   ...
   ::i32 rsa::public_decrypt(memory& out, const memory& in, string& strError)
   {
      ...
      ::collection::count i = EVP_PKEY_decrypt(pctx, nullptr, &out_len, in.get_data(), (::i32)in.get_size());
      ...
      i = EVP_PKEY_decrypt(pctx, out.get_data(), &out_len, in.get_data(), (::i32)in.get_size());
