...
//      synchronization & GetMutex() const override;
      ...
      bool OkToAccept(::sockets::base_socket *i32_point) override;
      ...
      //::i32 Resolve(base_socket *,const ::scoped_string & scopedstrHost,port_t port) override;
      //::i32 Resolve6(base_socket *,const ::scoped_string & scopedstrHost,port_t port) override;
