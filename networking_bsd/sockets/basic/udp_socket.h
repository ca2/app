...
namespace sockets_bsd
{
   ...
   public:
      ...
      void SendTo(const ::scoped_string & scopedstrHost, ::networking::port_t, const ::scoped_string & scopedstr, ::i32 flags = 0);
   ...
   protected:
      ...
      ::i32 ReadTS(char_pointer ioBuf, ::i32 inBufSize, struct sockaddr * from, socklen_t fromlen, struct timeval * ts);
#endif
