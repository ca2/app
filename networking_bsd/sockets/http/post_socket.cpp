      ...
      else
      {
         ...
         else if (m_fields.has_property("network_payload"))
         {
            ...
            if (payload.get_type() == ::e_type_property_set)
            {
               ...
               if (strContentType.case_insensitive_find("application/json") < 0)
               {
                  ...
                  inheader("content-type") = "application/json" + ::str::has_character(strContentType, ";", strContentType);
         ...
         else
         {
            ...
            if (inheader("content-type").string().case_insensitive_find("application/x-www-form-urlencoded") < 0)
            {
               ...
               inheader("content-type") = "application/x-www-form-urlencoded" + ::str::has_character(inheader("content-type").string(), "; ");
