...
CLASS_DECL_AQUA bool axis_init();
CLASS_DECL_AQUA bool axis_term();

CLASS_DECL_AQUA bool __node_axis_pre_init();
CLASS_DECL_AQUA bool __node_axis_pos_init();

CLASS_DECL_AQUA bool __node_axis_pre_term();
CLASS_DECL_AQUA bool __node_axis_pos_term();
...
#include "aqua/primitive/data/data_tree_item.h"

#include "aqua/primitive/data/data_tree.h"

#include "aqua/primitive/data/data_simple_item.h"
