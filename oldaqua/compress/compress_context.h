...
class CLASS_DECL_AQUA compress_context :
...
//#ifdef WINDOWS
//CLASS_DECL_AQUA i32 my_open(const char * psz, i32 i);
//CLASS_DECL_AQUA FILE * my_fopen(const char * psz, const char * pszMode);
//#else
//CLASS_DECL_AQUA void _get_errno(i32 * perrno);
//CLASS_DECL_AQUA i32 my_open(const char * psz, i32 i);
//CLASS_DECL_AQUA FILE * my_fopen(const char * psz, const char * pszMode);
//#endif
