...
extern zipFile CLASS_DECL_AQUA zipOpen OF((const char *pathname, i32 append));
/*
  create a zipfile.
...
extern zipFile CLASS_DECL_AQUA zipOpen2 OF((const char *pathname,
      i32 append,
      zipcharpc* globalcomment,
      zlib_filefunc_def* pzlib_filefunc_def));

extern i32 CLASS_DECL_AQUA zipOpenNewFileInZip OF((zipFile file,
      const char* filename,
...
extern i32 CLASS_DECL_AQUA zipOpenNewFileInZip2 OF((zipFile file,
      const char* filename,
      const zip_fileinfo* zipfi,
      const void * extrafield_local,
      u32 size_extrafield_local,
...
extern i32 CLASS_DECL_AQUA zipOpenNewFileInZip3 OF((zipFile file,
      const char* filename,
      const zip_fileinfo* zipfi,
      const void * extrafield_local,
      u32 size_extrafield_local,
...
extern i32 CLASS_DECL_AQUA zipWriteInFileInZip OF((zipFile file,
      const void * buf,
      u32 len));
/*
...
extern i32 CLASS_DECL_AQUA zipCloseFileInZip OF((zipFile file));
/*
  close the current file in the zipfile
*/


extern i32 CLASS_DECL_AQUA zipCloseFileInZipRaw OF((zipFile file,
...
extern i32 CLASS_DECL_AQUA zipClose OF((zipFile file,
