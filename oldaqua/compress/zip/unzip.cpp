...
*/
extern i32 CLASS_DECL_AQUA unzStringFileNameCompare (
...
*/
extern unzFile CLASS_DECL_AQUA unzOpen2 (
const char *path,
...
extern unzFile CLASS_DECL_AQUA unzOpen (const char * path)
{
...
extern i32 CLASS_DECL_AQUA unzClose (unzFile file)
{
   unz_s* s;
   if (file==nullptr)
...
/*
  ...
  return UNZ_OK if there is no problem. */
extern i32 CLASS_DECL_AQUA unzGetGlobalInfo (unzFile file,
...
/*
  ...
  return UNZ_OK if there is no problem.
*/
extern i32 CLASS_DECL_AQUA unzGetCurrentFileInfo (
unzFile file,
unz_file_info *pfile_info,
char *szFileName,
uptr fileNameBufferSize,
...
/*
  ...
  return UNZ_OK if there is no problem
*/
extern i32 CLASS_DECL_AQUA unzGoToFirstFile (unzFile file)
{
   i32 err=UNZ_OK;
   unz_s* s;
   if (file==nullptr)
...
*/
extern i32 CLASS_DECL_AQUA unzGoToNextFile (unzFile file)
{
   unz_s* s;
   i32 err;
...
*/
extern i32 CLASS_DECL_AQUA unzLocateFile (
unzFile file,
...
*/
extern i32 CLASS_DECL_AQUA unzOpenCurrentFile3 (unzFile file, i32 * method, i32 * level, i32 raw, const char * password)
{
   i32 err=UNZ_OK;
   u32 iSizeVar;
   unz_s* s;
...
extern i32 CLASS_DECL_AQUA unzOpenCurrentFile (
unzFile file)
{
   return unzOpenCurrentFile3(file, nullptr, nullptr, 0, nullptr);
}

extern i32 CLASS_DECL_AQUA unzOpenCurrentFilePassword (
unzFile file,
const char* password)
{
...
extern i32 CLASS_DECL_AQUA unzOpenCurrentFile2 (
unzFile file,
i32* method,
i32* level,
i32 raw)
...
*/
extern i32 CLASS_DECL_AQUA unzReadCurrentFile  (
unzFile file,
voidp buf,
u32 len)
{
...
*/
extern iptr CLASS_DECL_AQUA unztell (
unzFile file)
{
   unz_s* s;
   file_in_zip_read_info_s* pfile_in_zip_read_info;
...
*/
extern i32 CLASS_DECL_AQUA unzeof (
unzFile file)
{
   unz_s* s;
   file_in_zip_read_info_s* pfile_in_zip_read_info;
...
/*
  ...
  the return value is the number of bytes copied in buf, or (if <0)
    the error code
*/
extern i32 CLASS_DECL_AQUA unzGetLocalExtrafield (
unzFile file,
voidp buf,
u32 len)
{
...
*/
extern i32 CLASS_DECL_AQUA unzCloseCurrentFile (
unzFile file)
{
   i32 err=UNZ_OK;
...
*/
extern i32 CLASS_DECL_AQUA unzGetGlobalComment (
unzFile file,
char *szComment,
uptr uSizeBuf)
{
