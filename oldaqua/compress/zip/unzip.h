...
extern i32 CLASS_DECL_AQUA unzStringFileNameCompare OF ((const char* fileName1,
...
extern unzFile CLASS_DECL_AQUA unzOpen OF((const char *path));
/*
...
extern unzFile CLASS_DECL_AQUA unzOpen2 OF((const char *path,
...
extern i32 CLASS_DECL_AQUA unzClose OF((unzFile file));
/*
...
extern i32 CLASS_DECL_AQUA unzGetGlobalInfo OF((unzFile file,
...
extern i32 CLASS_DECL_AQUA unzGetGlobalComment OF((unzFile file,
      char *szComment,
      uptr uSizeBuf));
/*
...
extern i32 CLASS_DECL_AQUA unzGoToFirstFile OF((unzFile file));
/*
  set the current file of the zipfile to the first spfile->
  return UNZ_OK if there is no problem
*/

extern i32 CLASS_DECL_AQUA unzGoToNextFile OF((unzFile file));
/*
...
extern i32 CLASS_DECL_AQUA unzLocateFile OF((unzFile file,
...
extern i32 CLASS_DECL_AQUA unzGetFilePos(
unzFile file,
unz_file_pos* file_pos);

extern i32 CLASS_DECL_AQUA unzGoToFilePos(
unzFile file,
unz_file_pos* file_pos);

/* ****************************************** */

extern i32 CLASS_DECL_AQUA unzGetCurrentFileInfo OF((unzFile file,
...
extern i32 CLASS_DECL_AQUA unzOpenCurrentFile OF((unzFile file));
/*
  open for reading data the current file in the zipfile.
  If there is no error, the return value is UNZ_OK.
*/

extern i32 CLASS_DECL_AQUA unzOpenCurrentFilePassword OF((unzFile file,
      const char* password));
/*
  open for reading data the current file in the zipfile.
...
extern i32 CLASS_DECL_AQUA unzOpenCurrentFile2 OF((unzFile file,
      i32* method,
      i32* level,
      i32 raw));
/*
...
extern i32 CLASS_DECL_AQUA unzOpenCurrentFile3 OF((unzFile file,
      i32* method,
      i32* level,
      i32 raw,
      const char* password));
...
extern i32 CLASS_DECL_AQUA unzCloseCurrentFile OF((unzFile file));
/*
  close the file in zip opened with unzOpenCurrentFile
  Return UNZ_CRCERROR if all the file was read but the CRC is not good
*/

extern i32 CLASS_DECL_AQUA unzReadCurrentFile OF((unzFile file,
      voidp buf,
      u32 len));
/*
...
extern iptr CLASS_DECL_AQUA unztell OF((unzFile file));
/*
  Give the current position in uncompressed data
*/

extern i32 CLASS_DECL_AQUA unzeof OF((unzFile file));
/*
  return 1 if the end of file was reached, 0 elsewhere
*/

extern i32 CLASS_DECL_AQUA unzGetLocalExtrafield OF((unzFile file,
      voidp buf,
      u32 len));
/*
