...
/************************************************************/
extern zipFile CLASS_DECL_AQUA zipOpen2 (
const char *pathname,
i32 append,
...
extern zipFile CLASS_DECL_AQUA zipOpen (
const char *pathname,
i32 append)
{
...
extern i32 CLASS_DECL_AQUA zipOpenNewFileInZip3 (
zipFile file,
const char* filename,
...
extern i32 CLASS_DECL_AQUA zipOpenNewFileInZip2(
zipFile file,
const char* filename,
const zip_fileinfo* zipfi,
const void * extrafield_local,
...
extern i32 CLASS_DECL_AQUA zipOpenNewFileInZip (
zipFile file,
const char* filename,
const zip_fileinfo* zipfi,
const void * extrafield_local,
...
extern i32 CLASS_DECL_AQUA zipWriteInFileInZip (
zipFile file,
const void * buf,
u32 len)
{
...
extern i32 CLASS_DECL_AQUA zipCloseFileInZipRaw (
zipFile file,
...
extern i32 CLASS_DECL_AQUA zipCloseFileInZip (
zipFile file)
{
   return zipCloseFileInZipRaw (file,0,0);
}

extern i32 CLASS_DECL_AQUA zipClose (
zipFile file,
