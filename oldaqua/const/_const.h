...
//bool CLASS_DECL_AQUA succeeded(const ::estatus & estatus);
//bool CLASS_DECL_AQUA status_succeeded(i64 i);
//bool CLASS_DECL_AQUA failed(const ::estatus & estatus);
//bool CLASS_DECL_AQUA status_failed(i64 i);
