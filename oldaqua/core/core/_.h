...
CLASS_DECL_AQUA int get_core_init();
extern "C"
CLASS_DECL_AQUA int_bool defer_core_init();
extern "C"
CLASS_DECL_AQUA int_bool defer_core_term();
...
namespace aura
{
   ...
   namespace static_start
   {
      ...
      CLASS_DECL_AQUA void init(void);

      CLASS_DECL_AQUA void term(void);
