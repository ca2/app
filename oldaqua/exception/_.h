...
namespace win
{
   ...
   CLASS_DECL_AQUA string error_message(u32 dwError);
...
namespace exception
{
   ...
   CLASS_DECL_AQUA void throw_interface_only(const char * pszMessage = nullptr);
   CLASS_DECL_AQUA void throw_not_implemented(const char * pszMessage = nullptr);
...
CLASS_DECL_AQUA dump_context & operator<<(dump_context & dumpcontext, const ::datetime::time_span & dateSpanSrc);
CLASS_DECL_AQUA dump_context & operator<<(dump_context & dumpcontext, const ::datetime::time & dateSrc);
...
CLASS_DECL_AQUA bool __enable_memory_tracking(bool bTrack);
...
CLASS_DECL_AQUA bool __enable_memory_leak_override(bool bEnable);
...
/*void __do_for_all_objects(void (c_cdecl *pfn)(object* pObject, void * pContext),
   void * pContext);
void ::aqua::DoForAllClasses(void (c_cdecl *pfn)(::type pClass,
...
CLASS_DECL_AQUA string __get_thread_note();
CLASS_DECL_AQUA void __set_thread_note(const char * pszNote);
...
CLASS_DECL_AQUA int __assert_failed_line(const char * pszFileName, int nLine);

//CLASS_DECL_AQUA void TRACE(e_trace_category ecategory, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * psz);
//CLASS_DECL_AQUA void __tracef(e_trace_category ecategory, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, ...);
//CLASS_DECL_AQUA void __tracev(e_trace_category ecategory, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, va_list args);
CLASS_DECL_AQUA void __assert_valid_object(const ::context_object * pOb, const char * pszFileName, i32 nLine);

CLASS_DECL_AQUA void __dump(const ::context_object * pOb);
