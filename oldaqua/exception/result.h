...
CLASS_DECL_AQUA const char * status_message(const ::estatus & estatus);
...
CLASS_DECL_AQUA __pointer(::exception::exception) __trace_context_move_throw_exception(::object * pobject, ::exception::exception * pexceptionNew);
