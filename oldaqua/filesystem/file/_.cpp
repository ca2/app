...
CLASS_DECL_AQUA string solve_relative(const string & strParam, bool * pbUrl)
{
...
CLASS_DECL_AQUA bool solve_relative_inline(string & str, bool & bUrl, bool & bOnlyNativeFileSep, strsize * iaSlash, int * piSlashCount)
{
...
//CLASS_DECL_AQUA bool read_resource_as_file(const char * pszFile,HINSTANCE hinst,UINT nID,LPCTSTR pcszType);
...
CLASS_DECL_AQUA bool file_append_wait_dup(const string & strFile, const char * psz, strsize s, DWORD tickTimeout)
{
