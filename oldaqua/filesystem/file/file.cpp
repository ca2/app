...
namespace file
{
   ...
   /// half-initialization (of file object)
   /// seeded (the file object has been...)
   /// (the file object) requires another call to effectively finish creating itself,
   ///
   /// Much probably another ::object with some assigned ::aura::application should be supplied
   /// to realize the file object.
   ...
   */
   ...
   CLASS_DECL_AQUA void set_no_cache(var& var)
   {
