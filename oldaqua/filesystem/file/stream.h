...
inline ::file::file & operator << (::file::file & file, const TYPE & t);
 ...
 inline void __exchange(::stream & s, ::generic_object & object);
...
struct CLASS_DECL_AQUA stream_meta :
   public ::object
{
...
//
//class CLASS_DECL_AQUA property_set_stream :
...
//class CLASS_DECL_AQUA stream_stack
//{
//public:
//
//
...
public:
   ...
   virtual void write_object(const ::id & id, ::generic_object * pobject);

   virtual __pointer(::generic_object) read_object(const ::id & id);
   ...
   virtual void write(const ::generic_object * pobject);
   virtual void write(const ::generic_object & object);
   ...
   //virtual void read(::generic_object * pobject);
   virtual void read(::generic_object & object);
   ...
   virtual void exchange(const ::id & id, ::generic_object * pobject);
   virtual void exchange(const ::id & id, ::generic_object & object);
...
//   virtual void seekg(filesize offset, ::file::e_seek eseek);
   ...
   virtual void write_link(const ::generic_object * preference, const string & strLink, bool bReadOnly, ::generic_object * pobjectSaveOptions = nullptr);

   virtual bool write_link(const ::generic_object * preference);
   virtual void read_link(::generic_object * preference);


   virtual bool get_object_link(const ::generic_object * preference, string & strLink, bool & bReadOnly);
   virtual void set_object_link(const ::generic_object * preference, const string & strLink, bool bReadOnly);
   ...
   virtual __pointer(::generic_object) create_object_from_text(string strText);
...
//
//inline stream & operator >> (stream & s, var & var) { s.read(var); return s; }
//
...
//
//inline stream & operator << (stream & s, const var & var) { s.write(var); return s; }
//
//inline stream & operator << (stream & s, const property & property) { s.write(property); return s; }
//
//inline stream & operator << (stream & s, const ::generic_object * pobject) { s.write(pobject); return s; }
//
//inline stream & operator << (stream & s, const ::generic_object & object) { s.write(object); return s; }
//
