...
//CLASS_DECL_AQUA void NESSIEinit(struct NESSIEstruct * const structpointer);
//CLASS_DECL_AQUA void NESSIEadd(const uchar * const source, uptr sourceBits, struct NESSIEstruct * const structpointer);
//CLASS_DECL_AQUA void NESSIEfinalize(struct NESSIEstruct * const structpointer, uchar * const result);
