...
#include "aqua/primitive/collection/collection_file_path_map.h"
...
namespace file
{
   ...
   namespace dir
   {
      ...
      class CLASS_DECL_AQUA is_dir_map :
      ...
      class CLASS_DECL_AQUA dir_system_heap
      {
      public:
