...
namespace file
{
   ...
   struct CLASS_DECL_AQUA listing_meta
   {
   ...
   class CLASS_DECL_AQUA relative_name_listing :
...
CLASS_DECL_AQUA bool matches_wildcard_criteria(const string_array & straCriteria, const string & strValue);
CLASS_DECL_AQUA bool matches_wildcard_criteria_ci(const string_array & straCriteria, const string & strValue);
