...
CLASS_DECL_AQUA void * x86_memory_pool_alloc(memsize s);
CLASS_DECL_AQUA void x86_memory_pool_freec(void * p);


class CLASS_DECL_AQUA x86_oriented_memory_allocator
{
public:
...
CLASS_DECL_AQUA x86_cache_oriented_memory_pool * x86_cache_oriented_get_thread_memory_pool()
{
...
CLASS_DECL_AQUA int_bool x86_cache_oriented_set_thread_memory_pool(int iPoolIndex)
{
...
CLASS_DECL_AQUA void x86_cache_oriented_destroy_all_memory_pools()
{
...
CLASS_DECL_AQUA void * x86_cache_oriented_memory_alloc(memsize s)
{
...
CLASS_DECL_AQUA void x86_cache_oriented_memory_free(void * p)
{
...
CLASS_DECL_AQUA void x86_cache_oriented_memory_reset()
{
