...
namespace heap
{
   ...
   class CLASS_DECL_AQUA system_memory_allocator
   {
   public:
   ...
   class CLASS_DECL_AQUA default_memory_allocator
   {
   public:
...
//   class CLASS_DECL_AQUA heap_base
//   {
//   public:
//
//
