...
plex_heap_alloc_array::~plex_heap_alloc_array()
{
   ...
   if(::aqua::g_pheap == this)
   {

      ::aqua::g_pheap = nullptr;
...
CLASS_DECL_AQUA void simple_debug_print(const char * psz);
...
class CLASS_DECL_AQUA plex_heap     // warning var length structure
{
public:
