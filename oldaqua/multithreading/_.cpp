...
namespace multithreading
{
   ...
   //CLASS_DECL_AQUA comparable_eq_array<ITHREAD> * s_piaThread2 = nullptr;
   //CLASS_DECL_AQUA __pointer_array(thread) * s_pthreadptra2 = nullptr;
   //CLASS_DECL_AQUA::critical_section * s_pcs2 = nullptr;
   ...
   CLASS_DECL_AQUA void term_multithreading()
   {
      ...
      //::aqua::del(s_pthreadptra2);

      //::aqua::del(s_piaThread2);
...
CLASS_DECL_AQUA ::thread * get_thread_raw()
{
...
::aqua::application * g_papp;


void set_global_application(::aqua::application* papp)
{
...
::aqua::application * get_global_application()
{
...
::aqua::application * get_context_application()
{
...
::aqua::session * get_context_session()
{
...
::aqua::system * g_paurasystem = nullptr;
...
CLASS_DECL_AQUA ::aqua::system * get_context_system()
{
   ...
   ::aqua::system * psystem = pthread->get_context_system();
...
bool do_events()
{
   ...
   do
   {
      ...
      try
      {
         ...
         ::aqua::system* psystem = ::get_context_system();
         ...
         if (::is_set(psystem))
         {
            ...
            try
            {
               ...
               ::aqua::session* psession = psystem->get_context_session();
...
CLASS_DECL_AQUA ::estatus call(::object * pobject)
{
