...
CLASS_DECL_AQUA ::estatus __call(::generic_object * pobject);
...
CLASS_DECL_AQUA bool thread_set_name(const char * psz);
CLASS_DECL_AQUA bool set_thread_name(HTHREAD hthread, const char* pszName);

// Use instead of PostQuitMessage in OLE server applications
CLASS_DECL_AQUA void __post_quit_message(i32 nExitCode);

typedef ::estatus     (*__THREADPROC)(void *);


CLASS_DECL_AQUA bool do_events();
//CLASS_DECL_AQUA bool do_events(const duration & duration);
...
class CLASS_DECL_AQUA thread_ptra :
...
CLASS_DECL_AQUA int_bool post_message(oswindow oswindow, UINT message, WPARAM wparam, LPARAM lparam);
...
//    CLASS_DECL_AQUA void os_tls_init();

//    CLASS_DECL_AQUA void os_tls_term();

//    CLASS_DECL_AQUA void os_tls_set(void * p);

//    CLASS_DECL_AQUA void * os_tls_get();
...
CLASS_DECL_AQUA ::thread * get_thread(ITHREAD idthread);
...
#include "aqua/os/uwp/multithreading_winrt.h"
