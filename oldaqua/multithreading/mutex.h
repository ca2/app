...
CLASS_DECL_AQUA __pointer(::mutex) open_mutex(const char * lpszName);

class CLASS_DECL_AQUA mutex :
   virtual public sync
{
public:
...
CLASS_DECL_AQUA void wait_until_mutex_does_not_exist(const char * lpszName);
...
namespace install
{
   ...
   class CLASS_DECL_AQUA admin_mutex :
#ifdef WINDOWS_DESKTOP
      public null_dacl_security_attributes,
#endif
      public ::mutex
