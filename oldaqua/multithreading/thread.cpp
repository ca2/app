...
CLASS_DECL_AQUA void forking_count_thread_null_end(int iOrder)
{
...
CLASS_DECL_AQUA bool thread_sleep(tick tick, sync * psync)
{
...
CLASS_DECL_AQUA bool thread_pump_sleep(DWORD dwMillis, sync * psync)
{
