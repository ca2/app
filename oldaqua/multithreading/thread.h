...
public:
   ...
   class CLASS_DECL_AQUA file_info :
...
namespace multithreading
{
   ...
   CLASS_DECL_AQUA void set_finish();
   CLASS_DECL_AQUA bool post_quit_and_wait(const duration & duration);


   CLASS_DECL_AQUA void set_finish(::thread * pthread);
   CLASS_DECL_AQUA bool post_quit_and_wait(::thread * pthread, const duration & duration);
...
CLASS_DECL_AQUA bool is_active(::thread * pthread);



CLASS_DECL_AQUA bool is_thread_on(ITHREAD id);
CLASS_DECL_AQUA void set_thread_on(ITHREAD id);
CLASS_DECL_AQUA void set_thread_off(ITHREAD id);



CLASS_DECL_AQUA bool thread_sleep(tick tick, sync * psync = nullptr);
CLASS_DECL_AQUA bool thread_pump_sleep(tick tick, sync * psync = nullptr);
CLASS_DECL_AQUA bool app_sleep(tick tick);
...
CLASS_DECL_AQUA void defer_create_thread(::object * pobjectContext);


CLASS_DECL_AQUA void thread_name_abbreviate(string & strName, int len);
