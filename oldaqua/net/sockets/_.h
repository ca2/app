...
namespace net
{
   ...
   CLASS_DECL_AQUA i32 family_len(i32 family);
...
extern "C"
CLASS_DECL_AQUA const SSL_METHOD * TLS_client_method();

extern "C"
CLASS_DECL_AQUA const SSL_METHOD * TLS_server_method();
...
CLASS_DECL_AQUA string ip_reverse(string str);