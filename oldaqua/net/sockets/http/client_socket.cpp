...
inline CLASS_DECL_AQUA void upper_pad_from(char* sz, const void* p, memsize s)
{
...
namespace sockets
{
   ...
   CLASS_DECL_AQUA string http_method_string(e_http_method emethod)
   {
   ...
   CLASS_DECL_AQUA e_http_method string_http_method(const string & str)
   {
