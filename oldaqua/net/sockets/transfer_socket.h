...
namespace sockets
{
   ...
   class CLASS_DECL_AQUA transfer_socket_exception :
   ...
   class CLASS_DECL_AQUA transfer_socket :
   ...
   class CLASS_DECL_AQUA read_socket :
   ...
   class CLASS_DECL_AQUA write_socket :
      virtual public transfer_socket
   {
   public:
   ...
   //class CLASS_DECL_AQUA http_transfer_socket :
   //   virtual public transfer_socket
   //{
   //public:
