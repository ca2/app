...
/*void CLASS_DECL_AQUA ::ca2::InitLocalData(HINSTANCE hInst)
{
   if (__thread_data != nullptr)
      __thread_data->AssignInstance(hInst);
}

void CLASS_DECL_AQUA __term_local_data(HINSTANCE hInst, bool bAll)
{
   if (__thread_data != nullptr)
...
void CLASS_DECL_AQUA __tls_add_ref()
{
   ++gen_TlsRef;
}

void CLASS_DECL_AQUA __tls_release()
{
