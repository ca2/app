...
//i32 CLASS_DECL_AQUA __android_main(::aqua::system * psystem, i32 argc, char * argv[])
//{
//
//   if(!defer_au_init())
//      return -1;
...
//
//
//i32 CLASS_DECL_AQUA ca2_main(::aqua::system * psystem, HINSTANCE hInstance, HINSTANCE hPrevInstance, const char * lpCmdLine, i32 nCmdShow)
//{
//   try
//   {
//
