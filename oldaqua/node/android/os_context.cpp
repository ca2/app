...
#include "aqua/graphics/draw2d/ttf_util.h"
               ...
               if (pnameset && pfileset)
               {
                  ...
                  if (pnameset->get_children_count() >= 1 && pfileset->get_children_count() >= 1)
                  {
                     ...
                     if (pfirstname && pfirstfile)
                     {
                        ...
                        ::aqua::g_pmapFontFaceName->set_at(strName, pitem->m_strFile);
      ...
      if (dAndroid >= 8.0)
      {
         ...
         if (estatus)
         {
            ...
            for (auto& path : patha)
            {
               ...
               ::aqua::g_pmapFontFaceName->set_at(strName, path);
