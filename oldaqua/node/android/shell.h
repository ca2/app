...
namespace android
{
   ...
   public:
      ...
      //
      //         //      string CLASS_DECL_AQUA _017FilePathGetParent(const char * pcsz);
      //
      ...
      //         //      void CLASS_DECL_AQUA GetChildren(string_array & stra, const char * lpcszPath);
