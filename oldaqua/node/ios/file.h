...
void CLASS_DECL_AQUA vfxGetRoot(const unichar * lpszPath, string& wstrRoot);
...
//      void throw_os_error(::object * pobject, LONG lOsError, const char * lpszFileName = nullptr);
