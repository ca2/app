...
namespace ios
{
   ...
   CLASS_DECL_AQUA LRESULT CALLBACK __send_message_hook(i32, WPARAM, LPARAM);
   CLASS_DECL_AQUA LRESULT CALLBACK __cbt_filter_hook(i32, WPARAM, LPARAM);
   CLASS_DECL_AQUA LRESULT __call_window_procedure(::user::interaction *   pWnd, oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam);


   class CLASS_DECL_AQUA interaction_impl :
...
//      static bool PASCAL ModifyStyle(oswindow hWnd, DWORD dwRemove, DWORD dwAdd, UINT nFlags);
      ...
      CLASS_DECL_AQUA friend LRESULT CALLBACK __send_message_hook(i32, WPARAM, LPARAM);
      CLASS_DECL_AQUA friend LRESULT CALLBACK __cbt_filter_hook(i32, WPARAM, LPARAM);
      CLASS_DECL_AQUA friend LRESULT __call_window_procedure(::user::interaction *   pWnd, oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam);
