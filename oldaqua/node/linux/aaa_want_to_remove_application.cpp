...
//   ::aqua::document * application::_001opendocumentfile(var varfile)
//   {
//
...
//      set_run();
   ...
   void application::impl_process_term() // default will 'delete this'
   {
      ...
      //i32 iRet = ::aqua::application::term_instance();
   ...
   /*
      ...
      LRESULT application::ProcessWndProcException(::exception::aqua* e, const MESSAGE* pMsg)
      {
