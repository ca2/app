...
//
   ...
   // IMPLEMENT_DYNAMIC(WinFileException, ::exception::aqua)
...
CLASS_DECL_AQUA bool vfxResolveShortcut(string & strTarget, const char * pszSource, __pointer(::user::primitive) puiMessageParentOptional)
{
