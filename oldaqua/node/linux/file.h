...
void CLASS_DECL_AQUA vfxGetRoot(const widechar * pszPath, string& wstrRoot);

void CLASS_DECL_AQUA vfxGetRoot(wstring & wstrRoot, const wstring & wstrPath);
...
//      //void PASCAL ThrowErrno(__pointer(::aqua::application) papp, i32 nErrno, const char * pszFileName = nullptr);
...
bool CLASS_DECL_AQUA vfxFullPath(wstring & wstrFullPath, const wstring & wstrPath);
