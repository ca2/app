...
//CLASS_DECL_AQUA void hook_window_create(::user::interaction * pWnd);
//CLASS_DECL_AQUA bool unhook_window_create();
//CLASS_DECL_AQUA void reset_message_cache();
...
//CLASS_DECL_AQUA void __trace_message(const char * pszPrefix, ::message::message * pmessage);

//CLASS_DECL_AQUA void __trace_message(const char * pszPrefix, LPMESSAGE lpmsg);
