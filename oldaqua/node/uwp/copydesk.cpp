#include "framework.h"
#include "aqua/graphics/draw2d/common.h"
#include "_uwp.h"
#include <shlobj.h>


CLASS_DECL_AQUA bool node_save_image(Windows::Storage::Streams::IRandomAccessStream^ stream, ::image* pimage, ::save_image* psaveimage);

bool node_save_image(::image * pimage, Windows::Storage::Streams::IRandomAccessStream ^stream, ::aqua::application * papp);


CLASS_DECL_AQUA bool node_save_image(Windows::Storage::Streams::IRandomAccessStream ^ randomAccessStream, const ::image * pimage, ::save_image * psaveimage);
