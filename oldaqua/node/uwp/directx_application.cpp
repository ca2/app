#include "framework.h"
#include "aqua/os/windows_common/draw2d_direct2d_global.h"
#include "aqua/os/uwp/_winrt.h"
#include "_uwp.h"
#include "buffer.h"
...
namespace uwp
{
   ...
   directx_application::directx_application(::aqua::system * psystem, ::String ^ strId)
   {
...
//      psystem->get_context_session()->m_directxapplication = this;
   ...
   directx_application_source::directx_application_source(::aqua::system * paxissystem, const string & strId)
   {
   ...
   directx_application_source ^ new_directx_application_source(::aqua::system * paurasystem, const string & strId)
   {
