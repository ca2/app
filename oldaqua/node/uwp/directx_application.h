...
namespace uwp
{
   ...
   internal:
      ...
      directx_application(::aqua::system * psystem,String ^ strId);
      ...
      ::aqua::system * get_context_system() const;
   ...
   internal:
      ...
      directx_application_source(::aqua::system * paxissystem,const string & strId);
   ...
   CLASS_DECL_AQUA directx_application_source ^ new_directx_application_source(::aqua::system * psystem, const string & str);
