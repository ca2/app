...
//         m_puserinteraction->get_context_application()->step_timer();
      ...
      {
      ::aqua::application ** ppapp= (::aqua::application **) pbase->m_lparam;
...
*/
   ...
   ///* trans oswindow CLASS_DECL_AQUA __get_parent_owner(::user::interaction * hWnd)
   //{
  ...
  /*   void interaction_impl::_001OnDeferPaintLayeredWindowBackground(::image * pimage)
   ...
   bool interaction_impl::GrayCtlColor(HDC hDC,oswindow hWnd,UINT nCtlColor,HBRUSH hbrGray,COLORREF clrText)
   {
      ...
      //   //         TRACE(::aqua::trace::category_AppMsg, 0, "Warning: hDC is nullptr in interaction_impl::GrayCtlColor; WM_CTLCOLOR not processed.\n");
      //   return FALSE;
      //}
...
//      m_puserinteraction->m_iModal = m_puserinteraction->m_iModalCount;
      ...
      ::aqua::application * pappThis1 = dynamic_cast <::aqua::application *> (get_context_application());
      ::aqua::application * pappThis2 = dynamic_cast <::aqua::application *> (get_context_application());
...
//      return ::PostMessageW(get_handle(),message,wParam,lParam) != FALSE;
   ...
   */
   ...
   CLASS_DECL_AQUA LRESULT __call_window_procedure(::user::interaction * pinteraction, oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam)
   {
      ...
      catch(::exception::aqua * pe)
      {
         __process_window_procedure_exception(pe, spbase);
         //         TRACE(::aqua::trace::category_AppMsg, 0, "Warning: Uncaught exception in message_handler (returning %ld).\n", spbase->get_lresult());
...
WNDPROC CLASS_DECL_AQUA __get_window_procedure()
{
...
__STATIC void CLASS_DECL_AQUA __pre_init_dialog(
...
__STATIC void CLASS_DECL_AQUA __post_init_dialog(
...
CLASS_DECL_AQUA const char * __register_window_class(UINT nClassStyle,
...
__STATIC bool CLASS_DECL_AQUA __register_with_icon(WNDCLASS* pWndCls,
...
bool CLASS_DECL_AQUA __end_defer_register_class(LONG fToRegisterParam, const char ** ppszClass)
{
...
__activation_window_procedure(oswindow hWnd, UINT nMsg, WPARAM wParam, LPARAM lParam)
{
   ...
   catch(::exception::aqua * pe)
   {
      ...
      //      TRACE(::aqua::trace::category_AppMsg, 0, "Warning: Uncaught exception in __activation_window_procedure (returning %ld).\n",
      //       lResult);
      ::exception_pointer esp(pe);
   }
...
bool CLASS_DECL_AQUA __register_class(WNDCLASS* lpWndClass)
{
   WNDCLASS wndcls;
   ...
   {
      //      TRACE(::aqua::trace::category_AppMsg, 0, "Can't register interaction_impl class named %s\n",
