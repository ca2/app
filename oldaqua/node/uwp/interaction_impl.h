...
namespace uwp
{
   ...
   CLASS_DECL_AQUA LRESULT CALLBACK __send_message_hook(int, WPARAM, LPARAM);
   //CLASS_DECL_AQUA void _gen::StandardSubclass(oswindow);
   CLASS_DECL_AQUA LRESULT CALLBACK __cbt_filter_hook(int, WPARAM, LPARAM);
...
//      void OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar);
      ...
      CLASS_DECL_AQUA friend LRESULT CALLBACK __send_message_hook(int, WPARAM, LPARAM);
      //CLASS_DECL_AQUA friend void _gen::StandardSubclass(oswindow);
      CLASS_DECL_AQUA friend LRESULT CALLBACK __cbt_filter_hook(int, WPARAM, LPARAM);
