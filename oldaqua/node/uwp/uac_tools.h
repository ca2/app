...
namespace VistaTools
{
   ...
   */
   ...
   pbElevated
      [out] [optional] Pointer to a bool var that, if non-nullptr, receives the result.
   ...
   */
   ...
   pszPath
      [in] Address of a nullptr-terminated string that specifies the name of the executable file that
         should be used to start the process.

   pszParameters
      [in] [optional] Address of a nullptr-terminated string that contains the command-line parameters for the process.
         If nullptr, no parameters are passed to the process.

   pszDirectory
      [in] [optional] Address of a nullptr-terminated string that specifies the name of the working directory.
...
#   error RunNonElevated must be used in a DLL project!
   ...
   pszPath
      [in] Address of a nullptr-terminated string that specifies the executable file that
         should be used to start the process.

   pszParameters
      [in] [optional] Address of a nullptr-terminated string that contains the command-line parameters for
