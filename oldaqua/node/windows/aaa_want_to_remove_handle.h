...
// Operations
public:
   CT * from_handle(HANDLE h, CT * (* pfnAllocator) (__pointer(::aqua::application), HANDLE) = nullptr, __pointer(::aqua::application) papp = nullptr);
   void delete_temp();
...
class CLASS_DECL_AQUA oswindow_map :
...
template < class HT, class CT >
CT* handle_map < HT, CT >::from_handle(HANDLE h, CT * (*pfnAllocator) (__pointer(::aqua::application), HANDLE), __pointer(::aqua::application) papp)
{
...
CLASS_DECL_AQUA oswindow_map * get_oswindow_map(bool bCreate = FALSE);
