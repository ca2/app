...
#define EDEADLOCK       EDEADLK
   ...
   bool file::get_status(::file::file_status& rStatus) const
   {
      ...
      if (m_handleFile != INVALID_HANDLE_VALUE)
      {
         ...
         // don't return an error for this because previous versions of aqua API didn't
...
bool CLASS_DECL_AQUA vfxGetInProcServer(const char * pszCLSID, string & str)
...
// turn a file, relative path or other into an absolute path
bool CLASS_DECL_AQUA vfxFullPath(unichar * pszPathOut, const unichar * pszFileIn)
...
void CLASS_DECL_AQUA vfxGetRoot(const unichar * pszPath, string& strRoot)
...
UINT CLASS_DECL_AQUA vfxGetFileName(const unichar * pszPathName, unichar * pszTitle, UINT nMax)
