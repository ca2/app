...
#include "aqua/os/windows_common/_file_c.h"
#include "aqua/os/windows_common/file.h"
...
namespace windows
{
...

   {
      ...
      //if(::aqua::file_context::FullPath(str, pszFileIn))
   ...
   bool file_context::FullPath(wstring & wstrFullPath, const wstring & wstrPath)
   {
      ...
      /*      if(::aqua::file_context::FullPath(wstrFullPath, wstrPath))
      return true;*/
   ...
   //   {
   //      ::aqua::TimeToFileTime(status.m_mtime,&lastWriteTime);
   ...
   //      {
   //         ::aqua::TimeToFileTime(status.m_atime,&lastAccessTime);
   ...
   //      {
   //         ::aqua::TimeToFileTime(status.m_ctime,&creationTime);
