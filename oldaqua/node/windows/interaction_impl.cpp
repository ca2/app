...
#include "aqua/user/interaction_thread.h"
#include "aqua/os/windows/windowing.h"
#include "aqua/os/windows/top_level_enum.h"
#include "aqua/os/windows/imm_context.h"
#include "aqua/node/windows/buffer.h"
#include "aqua/const/timer.h"
...
CLASS_DECL_AQUA int g_iMouseDown = 0;

//CLASS_DECL_AQUA thread_iptr < DWORD_PTR > t_time1;
//CLASS_DECL_AQUA thread_iptr < DWORD_PTR > t_time2;


//extern CLASS_DECL_AQUA thread_int_ptr < DWORD_PTR > t_time1;
...
const char * gen_OldWndProc = "::aqua::OldWndProc423";

//CLASS_DECL_AQUA bool hook_window_create(::windows::interaction_impl * pwindow);
...
namespace windows
{
   ...
   __STATIC bool CLASS_DECL_AQUA __modify_style(oswindow oswindow, i32 nStyleOffset,
   ...
   bool interaction_impl::_native_create_window_ex(::user::create_struct & cs)
   {
      ...
      ::aqua::application * papp = get_context_application();
   ...
   ///* trans   if (!::aqua::HtmlHelp((pwindow)->get_handle(), pApp->m_pszHelpFilePath, nCmd, dwData))
   //{
   //// linux System.message_box(__IDP_FAILED_TO_LAUNCH_HELP);
   //System.message_box("Failed to launch help");
   //}*/
...
//
//
//CLASS_DECL_AQUA bool unhook_window_create()
//{
//
...
void CLASS_DECL_AQUA _handle_activate(::user::interaction_impl * pwindow, WPARAM nState, ::user::interaction_impl * pWndOther)
{
...
namespace windows
{
   ...
   void interaction_impl::message_handler(::message::base * pbase)
   {
      ...
      {
      __pointer(::aqua::application)* ppapp= (__pointer(::aqua::application)*) pbase->m_lparam;
...
wstring CLASS_DECL_AQUA windows_get_user_interaction_window_class(::user::interaction * pinteraction)
{
   ...
   wndcls.hInstance = GetModuleHandleW(L"aqua.dll");
...
bool CLASS_DECL_AQUA windows_register_with_icon(WNDCLASSEXW * pwndclass, const unichar * pszClassName, UINT nIDIcon)
...
CLASS_DECL_AQUA wstring windows_register_window_class(::object * pobject, UINT nClassStyle, HCURSOR hCursor, HBRUSH hbrBackground, HICON hIcon)
{

   ::aqua::application * papp = ::get_context_application(pobject);
