...
#include "aqua/os/windows_common/cotaskptr.h"
...
namespace windows
{
   ...
   bool os_context::defer_register_ca2_plugin_for_mozilla()
   {
      ...
      try
      {
         ...
         key.open(key, "application/aqua", true);

         key.set("Description", "aqua Document");
...
CLASS_DECL_AQUA HRESULT os_create_link(::file::path pathObj, ::file::path pathLnk, string strDesc, ::file::path pathIco, int iIcon)
{
