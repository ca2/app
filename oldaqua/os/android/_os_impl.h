...
#define  LOG_TAG    "aqua : os : _os_binding"
...
CLASS_DECL_AQUA string get_string(jstring jstring);


CLASS_DECL_AQUA void set_context(JNIEnv* penv);
CLASS_DECL_AQUA JNIEnv* get_jni_env();

CLASS_DECL_AQUA void android_exchange();
