...
CLASS_DECL_AQUA i32 call_async(
const char * pszPath,
const char * pszParam,
const char * pszDir,
::edisplay edisplay,
...
//
//CLASS_DECL_AQUA unichar * GetCommandLineW()
//{
//
...
CLASS_DECL_AQUA bool shell_execute_sync(const char * pszPath, const char * pszParam, ::duration durationTimeout)
{
