...
//
//
//CLASS_DECL_AQUA void thread_get_os_priority(i32 * piOsPolicy, sched_param * pparam, i32 iCa2Priority);
//
//CLASS_DECL_AQUA void process_get_os_priority(i32 * piOsPolicy, sched_param * pparam, i32 iCa2Priority);
//
//CLASS_DECL_AQUA i32 thread_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);
//
//CLASS_DECL_AQUA i32 process_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);
//
//
...
//
//
////CLASS_DECL_AQUA pDWORD get_current_ithread()
////{
////
...
/////*
////
////CLASS_DECL_AQUA DWORD WINAPI GetThreadId(HTHREAD Thread)
////{
////
////   sync_lock mlThreadId(g_pmutexThreadIdLock);
////
...
////}
////
////CLASS_DECL_AQUA HTHREAD  WINAPI get_thread_handle(DWORD dw)
////{
////
////   sync_lock mlThreadIdHandle(g_pmutexThreadIdHandleLock);
////
...
////
/////*
////CLASS_DECL_AQUA int_bool WINAPI PostThreadMessageW(DWORD idThread,UINT Msg,WPARAM wParam,LPARAM lParam)
////{
////
...
////*/
////
////CLASS_DECL_AQUA int_bool WINAPI PostMessageW(oswindow oswindow,UINT Msg,WPARAM wParam,LPARAM lParam)
////{
////
...
////}
////
////CLASS_DECL_AQUA UINT GetCurrentThreadId()
////{
////
