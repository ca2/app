...
// CLASS_DECL_AQUA bool context::os_resolve_alias(::file::path & path, const char * psz, ::user::primitive * pinteraction, bool bNoUI, bool bNoMount)
// {
...
CLASS_DECL_AQUA bool context::os_is_alias(const char * path)
{
