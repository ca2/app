...
CLASS_DECL_AQUA i32 __cdecl _CrtReportBlockType(const void * p);

CLASS_DECL_AQUA i32 __cdecl _CrtSetReportMode(i32, i32);

CLASS_DECL_AQUA i32 __cdecl _CrtSetReportHook2(i32, i32(__cdecl*)(i32, char *, i32 *));

//CLASS_DECL_AQUA _CRT_DUMP_CLIENT DECL_C _CrtSetDumpClient(_CRT_DUMP_CLIENT _PFnNewDump);

CLASS_DECL_AQUA i32 __cdecl _CrtSetDbgFlag(i32);

CLASS_DECL_AQUA i32 __cdecl _CrtDumpMemoryLeaks();
...
//CLASS_DECL_AQUA int __cdecl debug_report(
//   int _ReportType,
