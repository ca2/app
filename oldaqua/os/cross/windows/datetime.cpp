 ...
 *   Nothing.
 */
CLASS_DECL_AQUA void WINAPI RtlTimeToTimeFields(
 ...
 */
CLASS_DECL_AQUA WINBOOL WINAPI LocalFileTimeToFileTime( const FILETIME *localft, LPFILETIME utcft )
{
   NTSTATUS status;
 ...
 */
CLASS_DECL_AQUA WINBOOL WINAPI FileTimeToLocalFileTime( const FILETIME *utcft, LPFILETIME localft )
{
   NTSTATUS status;
   LARGE_INTEGER local, utc;
 ...
 *   Nothing.
 */
CLASS_DECL_AQUA void GetSystemTimeAsFileTime(
 ...
 *  Nothing.
 */
CLASS_DECL_AQUA void GetSystemTime(LPSYSTEMTIME systime)
{
   FILETIME ft;
   LARGE_INTEGER t;
