...
CLASS_DECL_AQUA WINBOOL destroy_window(oswindow window);

CLASS_DECL_AQUA WINBOOL GetCursorPos(LPPOINT lppointCursor);

//CLASS_DECL_AQUA int_bool PostMessage(oswindow oswindow, UINT Msg, WPARAM wParam, LPARAM lParam);
...
CLASS_DECL_AQUA i32 WINAPI GetSystemMetrics(i32 nIndex);
...
CLASS_DECL_AQUA int_bool CopyRect(LPRECT prectDest, LPCRECT pcrectSrc);
CLASS_DECL_AQUA int_bool PtInRect(LPCRECT prect, POINT point);
CLASS_DECL_AQUA int_bool SetRect(LPRECT prect, i32 x1, i32 y1, i32 x2, i32 y2);
CLASS_DECL_AQUA int_bool SetRectEmpty(LPRECT prect);
CLASS_DECL_AQUA int_bool EqualRect(LPCRECT prect1, LPCRECT prect2);
CLASS_DECL_AQUA int_bool InflateRect(LPRECT prect, i32 x, i32 y);
CLASS_DECL_AQUA int_bool OffsetRect(LPRECT prect, i32 x, i32 y);
CLASS_DECL_AQUA int_bool IntersectRect(LPRECT prect, LPCRECT prect1, LPCRECT prect2);
//CLASS_DECL_AQUA int_bool x_intersect_rect(LPRECT prect, LPCRECT prect1, LPCRECT prect2);
//CLASS_DECL_AQUA int_bool y_intersect_rect(LPRECT prect, LPCRECT prect1, LPCRECT prect2);
CLASS_DECL_AQUA int_bool UnionRect(LPRECT prect, LPCRECT prect1, LPCRECT prect2);
CLASS_DECL_AQUA int_bool SubtractRect(LPRECT prect, LPCRECT prect1, LPCRECT prect2);
...
CLASS_DECL_AQUA int_bool TranslateMessage(const MESSAGE * pmsg);
CLASS_DECL_AQUA LRESULT DispatchMessage(const MESSAGE * pmsg);
...
CLASS_DECL_AQUA int_bool IsRectEmpty(LPCRECT lpcrect);

//#ifdef cplusplus
//
//CLASS_DECL_AQUA int_bool IsRectEmpty(const ::rect & rect);
//
//#endif
