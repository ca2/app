...
//
   ...
   //g_source_set_callback(idle_source, &linux_start_system, (::aqua::system *) m_psystem, nullptr);
   ...
   if(!psystem->begin_synch())
   {
      ...
      output_debug_string("Failed to begin_synch the system (::aqua::system or ::aqua::system derived)");
...
CLASS_DECL_AQUA void main_branch(::generic_object * prunnable, e_priority epriority)
{
