...
CLASS_DECL_AQUA void main_sync_runnable(::context_object * pobjectRunnable, ::duration durationTimeout)
{
...
CLASS_DECL_AQUA void main_async_runnable(::context_object * prunnableParam)
{
