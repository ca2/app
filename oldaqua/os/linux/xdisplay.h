...
CLASS_DECL_AQUA i32 osdisplay_find(Display * pdisplay);
CLASS_DECL_AQUA osdisplay_data * osdisplay_get(Display * pdisplay);
CLASS_DECL_AQUA bool osdisplay_remove(Display * pdisplay);


class CLASS_DECL_AQUA xdisplay
{
public:
