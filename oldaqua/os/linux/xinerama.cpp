...
CLASS_DECL_AQUA int xinerama_get_monitor_count();
CLASS_DECL_AQUA int xinerama_get_monitor_rect(index i, RECT * prect);

CLASS_DECL_AQUA int xinerama_get_screen_size(int& width, int& height);
...
::array < rect > get_ordered_monitor_recta(::object * pobject)
{
   ...
   ::aqua::system & system = Sys(pobject);
