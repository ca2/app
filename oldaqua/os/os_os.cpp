...
CLASS_DECL_AQUA string & get_command_line_string()
{
...
CLASS_DECL_AQUA void set_command_line_dup(const char * psz)
{
...
CLASS_DECL_AQUA void get_command_line_dup(char * psz, int iBuffer)
{
