...
CLASS_DECL_AQUA void thread_get_os_priority(i32 * piOsPolicy, sched_param * pparam, ::e_priority epriority);

CLASS_DECL_AQUA void process_get_os_priority(i32 * piOsPolicy, sched_param * pparam, ::e_priority epriority);

CLASS_DECL_AQUA::e_priority thread_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);

CLASS_DECL_AQUA::e_priority process_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);
...
CLASS_DECL_AQUA void set_main_hthread(HTHREAD hThread)
{
...
CLASS_DECL_AQUA void set_main_ithread(ITHREAD uiThread)
{
...
CLASS_DECL_AQUA HTHREAD get_main_hthread()
{
...
CLASS_DECL_AQUA ITHREAD get_main_ithread()
{
...
//CLASS_DECL_AQUA int_bool WINAPI mq_post(mq * pmq, oswindow oswindow, UINT Msg, WPARAM wParam, LPARAM lParam)
//CLASS_DECL_AQUA int_bool WINAPI mq_post(mq * pmq, UINT Msg, WPARAM wParam, LPARAM lParam)
//{
//
