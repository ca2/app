...
CLASS_DECL_AQUA float os_get_dpi()
{
...
CLASS_DECL_AQUA float point_dpi(oswindow hwnd, float points)
{
...
CLASS_DECL_AQUA float dpiy(oswindow hwnd, float y)
{
...
CLASS_DECL_AQUA float dpix(HWND hwnd, float x)
{
...
CLASS_DECL_AQUA float y_dpi(HWND hwnd, float y)
{
...
CLASS_DECL_AQUA float x_dpi(HWND hwnd, float x)
{
