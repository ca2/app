...
//      {
//
//         m_strBaseChannel = "aqua\\appdata\\ipi\\" + string(pszKey);
//
...
//
//         ::Windows::Storage::StorageFile ^ file = ::wait(folderTopic->CreateFileAsync(wstring("aqua.topic"),::Windows::Storage::CreationCollisionOption::OpenIfExists));
//
//         string strMessage;
//
...
//
//         ::Windows::Storage::StorageFile ^ f = ::wait(m_pp->folderTopic->GetFileAsync(wstring("aqua.topic")));
//
//         if(f != nullptr)
//         {
//
...
//         {
//
//            ::Windows::Storage::StorageFile ^ f = ::wait(result->Folder->GetFileAsync(wstring("aqua.topic")));
//
//            if(f != nullptr)
//            {
//
