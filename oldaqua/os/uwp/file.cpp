...
CLASS_DECL_AQUA memsize read_buffer(void* p, ::Windows::Storage::Streams::IBuffer^ ibuf, memsize size, memsize pos)
{
...
CLASS_DECL_AQUA memory_file_pointer create_memory_file(::Windows::Storage::Streams::IInputStream^ stream)
{
