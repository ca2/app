...
CLASS_DECL_AQUA void __cdecl _null_se_translator(unsigned int uiCode, EXCEPTION_POINTERS * ppointers);


//::aqua::application *     win_application_create(::aqua::application * pappSystem, const char * pszId);
//::aqua::application *     win_instantiate_application(::aqua::application * pappSystem, const char * pszId);
//int                     win_application_procedure(::aqua::application * pappSystem)
...
//int CLASS_DECL_AQUA win_main(::aqua::system * psystem, ::Array < ::String ^ > ^ args)
//{
//
//   if (!main_initialize())
//      return -1;
...
//int CLASS_DECL_AQUA ca2_main(HINSTANCE hInstance, HINSTANCE hPrevInstance, const char * lpCmdLine, int nCmdShow)
//{
//   try
//   {
//
//      _set_purecall_handler(_ca2_purecall);
//
//      ::aqua::system * psystem = new ::aqua::system();
//
//
//      //Sleep(30 * 1000);
//
...
void CLASS_DECL_AQUA __cdecl _null_se_translator(unsigned int uiCode, EXCEPTION_POINTERS * ppointers)
{
