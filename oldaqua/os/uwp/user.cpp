#include "framework.h"
#include "_winrt.h"
#include "aqua/node/uwp/_uwp.h"
#include "aqua/os/windows_common/draw2d_direct2d_global.h"


CLASS_DECL_AQUA int g_iMouse = -1;


CLASS_DECL_AQUA WINBOOL GetCursorPos(LPPOINT lppoint);
...
//UINT system_main(::aqua::system * psystem)
//{
//
//   try
//   {
...
namespace user
{
   ...
   CLASS_DECL_AQUA COLORREF get_system_app_background_color()
   {
   ...
   CLASS_DECL_AQUA double get_system_app_luminance()
   {
   ...
   CLASS_DECL_AQUA void os_update_dark_mode()
   {
