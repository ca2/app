...
CLASS_DECL_AQUA void thread_get_os_priority(int32_t * piOsPolicy, sched_param * pparam, int32_t iCa2Priority);

CLASS_DECL_AQUA void process_get_os_priority(int32_t * piOsPolicy, sched_param * pparam, int32_t iCa2Priority);

CLASS_DECL_AQUA int32_t thread_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);

CLASS_DECL_AQUA int32_t process_get_scheduling_priority(int iOsPolicy, const sched_param * pparam);
...
CLASS_DECL_AQUA void set_main_thread(HTHREAD hThread)
{
...
CLASS_DECL_AQUA void set_main_thread_id(ITHREAD uiThread)
{
...
CLASS_DECL_AQUA HTHREAD get_main_thread()
{
...
CLASS_DECL_AQUA ITHREAD get_main_thread_id()
{
...
CLASS_DECL_AQUA void attach_thread_input_to_main_thread(bool bAttach)
{
...
CLASS_DECL_AQUA int_bool WINAPI PostThreadMessage(ITHREAD iThreadId,UINT Msg,WPARAM wParam,LPARAM lParam)
{
...
CLASS_DECL_AQUA HTHREAD GetCurrentThread()
{
...
CLASS_DECL_AQUA ITHREAD GetCurrentThreadId()
{
...
namespace multithreading
{
   ...
   CLASS_DECL_AQUA int32_t priority()
   {
...
CLASS_DECL_AQUA DWORD_PTR translate_processor_affinity(int iOrder)
{
