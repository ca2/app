...
//#endif
int SendCtrlShiftQToChrome(HWND chrome, int iSleep, ::aqua::application * papp);
//int SendURLToChrome(HWND chrome, string strUrl, ::aqua::application * papp);
class block_input :
...
int SendCtrlShiftQToChrome(oswindow w, int iSleep, ::aqua::application * papp)
{
