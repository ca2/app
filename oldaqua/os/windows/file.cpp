...
//
//
//   HMODULE hModule = GetModuleHandle(_T("aqua.dll"));
//   if( !hModule )
//   {
//      output_debug_string( L"GetModuleHandle(_T(\"aqua.dll\")); failed" );
//      return 0;
//   }
//   wstring csFilePath;
...
//
//
////extern "C" CLASS_DECL_AQUA void GetOpenedFiles(LPCWSTR pPath, OF_TYPE Filter, OF_CALLBACK CallBackProc, uptr pUserContext)
////
////{
////   string csPath = pPath;
////
...
int_bool file_is_equal_path(const char * psz1,const char * psz2)
{
   ...
   ::aqua::malloc < unichar * > pwszPath1;

   ::aqua::malloc < unichar * > pwszPath2;
...
CLASS_DECL_AQUA bool read_resource_as_memory(memory & m, HINSTANCE hinstance, UINT nID, const char * pcszType, strsize iReadAtMostByteCount)
