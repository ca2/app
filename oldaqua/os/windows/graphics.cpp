...
CLASS_DECL_AQUA bool os_init_imaging()
{
...
CLASS_DECL_AQUA void os_term_imaging()
{
...
CLASS_DECL_AQUA WINBOOL imaging::window_set_mouse_cursor(oswindow , HCURSOR hcursor)
{
