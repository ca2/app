...
CLASS_DECL_AQUA himagelist_map * afxMapHIMAGELIST(bool bCreate = FALSE);
//CLASS_DECL_AQUA hdc_map * afxMapHDC(bool bCreate = FALSE);
//CLASS_DECL_AQUA hgdiobj_map * afxMapHGDIOBJ(bool bCreate = FALSE);
//CLASS_DECL_AQUA hmenu_map * afx_map_HMENU(bool bCreate = FALSE);
