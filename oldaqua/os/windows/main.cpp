...
CLASS_DECL_AQUA string ca2_command_line(HINSTANCE hinstance);

CLASS_DECL_AQUA HRESULT os_create_link(::file::path pathObj, ::file::path pathLink, string strDesc, ::file::path pathIcon = nullptr, int iIcon = 0);
...
CLASS_DECL_AQUA void main_async_runnable(::context_object * pobjectTaskParam)
{
...
CLASS_DECL_AQUA void main_sync_runnable(::context_object * pobjectTaskParam, ::duration durationTimeout)
{
