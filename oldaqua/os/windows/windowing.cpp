...
CLASS_DECL_AQUA int_bool os_init_windowing()
{
...
CLASS_DECL_AQUA i64 oswindow_id(HWND hwnd)
{
...
CLASS_DECL_AQUA WINBOOL show_window(oswindow oswindow, int iShowCmd)
{
...
/// from top to bottom
CLASS_DECL_AQUA __pointer(::user::oswindow_array) get_top_level_windows(bool bDesktop, bool bVisible)
{
...
CLASS_DECL_AQUA ::estatus _os_message_box(oswindow oswindow, const char* pszMessage, const char* pszTitle, ::emessagebox emessagebox, ::callback callback)
{
...
CLASS_DECL_AQUA ::estatus os_message_box(oswindow oswindow, const char * pszMessage, const char * pszTitle, ::emessagebox emessagebox, ::callback callback)
{
