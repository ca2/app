...
namespace aqua
{
   ...
   bool extract_sub_string(string& rString, const char* pszFullString, i32 iSubString, char chSep)
   {
      ...
      ::aqua::memcpy_s(rString.get_string_buffer(nLen), nLen * sizeof(char), pszFullString, nLen * sizeof(char));
...
//::aqua::system* create_aura_system()
//{
//
...
CLASS_DECL_AQUA u32 g_tickStartTime = 0;
...
//extern "C"
CLASS_DECL_AQUA void debug_print(const char* pszFormat, ...)
{
...
//string_map < __pointer(::aqua::library) >* g_pmapLibrary = nullptr;
...
CLASS_DECL_AQUA string_map < PFN_NEW_AURA_LIBRARY >& __get_new_aura_library()
{
...
CLASS_DECL_AQUA string_map < __pointer(::aqua::library) >& __library()
{
...
CLASS_DECL_AQUA PFN_NEW_AURA_LIBRARY get_get_new_aura_library(const char* psz)
{
...
CLASS_DECL_AQUA void register_library(const char* psz, ::aqua::library* plibrary)
{
...
extern "C"
CLASS_DECL_AQUA::aqua::system * aura_create_aura_system()
{

   return new ::aqua::system();
...
// ::map < void*, void*, ::aqua::application*, ::aqua::application* >* g_pmapAura = nullptr;


// void set_aura(void* p, ::aqua::application* papp)
// {
...
// ::aqua::application* get_aura(void* p)
// {
...
//CLASS_DECL_AQUA LPFN_CREATE_SYSTEM g_pfn_create_system;

//CLASS_DECL_AQUA const char* g_pszCooperativeLevel;

//CLASS_DECL_AQUA int g_iDerivedApplication = 0;
