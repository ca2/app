...
namespace aqua
{
   ...
   template < class APP >
   __result(::aqua::application) single_application_library < APP > ::get_new_application(::object * pobject, const char * pszAppId)
   {
...
CLASS_DECL_AQUA inline ::aqua::application * get_context_application(::object * pobject)
{
   ...
   ::aqua::application * papplication = pobject->get_context_application();
...
CLASS_DECL_AQUA inline ::aqua::session * get_context_session(::object * pobject)
{
   ...
   ::aqua::session * psessionContext = pobject->get_context_session();
...
CLASS_DECL_AQUA inline ::aqua::system * get_context_system(::object * pobject)
{
   ...
   ::aqua::system * psystemContext = pobject->get_context_system();
...
CLASS_DECL_AQUA inline ::object * get_app_object()
{
...
::image_pointer get_image(::object * pobject, const var & varFile, bool bAsync = false)
{
   ...
   sync_lock sl(::aqua::get_image_mutex());
...
#include "aqua/primitive/primitive/block.inl"
...
inline void object::set_context_app(::aqua::application* pappContext)
{
...
inline void object::set_context_session(::aqua::session* psessionContext)
{
...
inline void object::set_context_system(::aqua::system* psystemContext)
{
