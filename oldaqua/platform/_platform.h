...
namespace aqua
{
   ...
   CLASS_DECL_AQUA bool init_core();

   CLASS_DECL_AQUA bool term_core();
...
namespace aqua
{
   ...
   CLASS_DECL_AQUA void format_strings(string& rString, const char* pszFormat, const char* const* rgpsz, i32 nString);

   CLASS_DECL_AQUA bool extract_sub_string(string& rString, const char* pszFullString, i32 iSubString, char chSep = '\n');
...
#include "aqua/primitive/collection/std_iterator.h"
#include "aqua/primitive/collection/insert_iterator.h"
#include "aqua/primitive/collection/back_insert_iterator.h"
#include "aqua/primitive/collection/std_pair.h"
...
//#include "app/aqua/math/math_math.h"

#include "theme.h"

//#include "app/aqua/user/_.h"

#include "debug.h"

//#include "aqua/filesystem/filehandler/filehandler.h"
