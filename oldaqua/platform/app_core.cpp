...
//extern string_map < __pointer(::aqua::library) >* g_pmapLibrary ;
...
extern "C"
::aqua::system * aura_create_aura_system();


extern ::file::path * g_ppathInstallFolder;


CLASS_DECL_AQUA void set_debug_pointer(void * p);
...
//   get_context_system()->common_construct();
   ...
   ::aqua::g_bOutputDebugString = file_exists(pathOutputDebugString)||  file_exists(pathGlobalOutputDebugString);
...
//      //{
//
//      //   if ((hmodule = __node_library_touch("aqua", strMessage)) != nullptr)
//      //   {
//
...
//
//      //   //}
//      //   else if ((hmodule = __node_library_touch("aqua", strMessage)) != nullptr)
//      //   {
//
//      //      pfnDeferInit = (PFN_DEFER_INIT) __node_library_raw_get(hmodule, "defer_aura_init");
//
...
//CLASS_DECL_AQUA int aura_entry_point(int argc, char * argv[], const char * pszMainAppId)
//{
//
//   int iResult = 0;
//
...
//
//      auto psystem = __new(::aqua::system());
//
...
//CLASS_DECL_AQUA long aura_prefix(::aqua::system * psystem)
//{
//
...
//CLASS_DECL_AQUA long aura_fork(::aqua::system * psystem, PFN_NEW_AURA_APPLICATION pfnNewAuraApplication)
//{
//
//   //pmaindata->m_pappcore = __new(app_core(pmaindata));
//
...
//CLASS_DECL_AQUA long aura_aura(::aqua::system * psystem)
//{
//
//   if (!psystem->system_prep())
//   {
...
__result(::aqua::application) app_core::get_new_application(::object* pobjectContext)
{
   ...
   __pointer(::aqua::application) papp;
...
__result(::aqua::application) app_core::get_new_application(::object* pobjectContext, const char* pszAppId)
{
   ...
   __pointer(::aqua::library)& plibrary = ::get_context_system()->m_mapLibrary[strAppId];
      ...
      if (!papp)
      {
         ...
         if (!plibrary)
         {
            ...
            if (strAppId.is_empty())
            {
               ...
               papp = get_context_system()->__create < ::aqua::application > ();
      ...
      if (!papp)
      {
         ...
         else
         {
            ...
            if (is_verbose())
            {
               ...
               ::output_debug_string("\n\n::aqua::session::get_new_application assembled library path " + strLibrary + "\n\n");
            ...
            if (is_verbose())
            {
               ...
               ::output_debug_string("\n\n::aqua::session::get_new_application Found library : " + strLibrary + "\n\n");
...
//          {
//
//             ::output_debug_string("\n\n::aqua::session::get_new_application Failed to load library : " + strLibrary + "\n\n");
//
//             return nullptr;
//
//          }
            ...
            if (is_verbose())
            {
               ...
               ::output_debug_string("\n\n::aqua::session::get_new_application Opened library : " + strLibrary + "\n\n");
            ...
            //::output_debug_string("\n\n::aqua::session::get_new_application open_ca2_library failed(2) : " + strLibrary + "\n\n");
