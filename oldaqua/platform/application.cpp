...
#include "aqua/id.h"
#include "aqua/platform/version.h"
...
//#include "aqua/node/ansios/ansios.h"
#include "aqua/node/android/_.h"

//#elif defined(WINDOWS_DESKTOP)

//#include "aqua/node/windows/windows_registry.h"

#endif


#if defined(APPLE_IOS) || defined(_UWP)
CLASS_DECL_AQUA int ui_open_url(const char * psz);
#endif
...
//#endif
   ...
   void application::on_request(::create * pcreate)
   {
      ...
      if (is_serviceable())
      {
         ...
         ::aqua::application::on_service_request(pcreate);
      ...
      else
      {
         ...
         //__pointer(::aqua::session) pbergedge = pcreate->m_pcommandline->m_varQuery["bergedge_callback"].cast < ::aqua::session >();
         // todobergedge
...
//   string CLASS_DECL_AQUA application::get_cred(const string & strRequestUrl, const ::rect & rect, string & strUsername, string & strPassword, string strToken, string strTitle, bool bInteractive)
// {
...
//         }
   ...
   void application::term_thread()
   {
      ...
      INFO("aqua::application::term_thread");
...
//         }
         ...
         INFO("aqua::application::pre_run success");
      ...
      catch (...)
      {
         ...
         INFO("aqua::application::pre_run exception.4");
...
//   }
   ...
   void application::on_pos_run_thread()
   {
      ...
      //            ::aqua::session * psessionThis = dynamic_cast <::aqua::session *>(this);
      ...
      //            ::aqua::system * psystemThis = dynamic_cast <::aqua::system *>(this);
   ...
   void application::pos_run()
   {
      ...
      catch (...)
      {
         ...
         INFO("aqua::application::pos_run exception.4");
   ...
   ::estatus application::init_instance()
   {
      ...
      INFO("aqua::application::init_application .1");
...
//          var["prefix_html"] = "<img src=\"matter://system/exclusive.png\" width=80 height=80 style=\"display:block;\"><br/><br/>";
            ...
            INFO("aqua::application::init_application exit");
      ...
      INFO("aqua::application::init_application .2");
      ...
      if (!is_system() && !is_session())
      {
         ...
         string str;
         // if system locale has changed (compared to last recorded one by aqua)
         ...
         // if system schema has changed (compared to last recorded one by aqua)
   ...
   ::estatus application::application_pre_run()
   {
      ...
      INFO("aqua::application::application_pre_run");
...
//         System.install().remove_spa_start(m_strAppId);
   ...
   ::estatus application::process_init()
   {
      ...
      INFO("aqua::application::process_init");
      ...
      if (!ca_process_init())
      {
         ...
         FATAL("aqua::application::process_init .1");
      ...
      //   FATAL("aqua::application::process_init .2");
...
//      m_bAuraProcessInitializeResult = true;
      ...
      INFO("aqua::application::process_init success");
...
//      }
   ...
   ::estatus application::init_application()
   {
      ...
      INFO("aqua::application::init_application");
...
//      m_bAuraInitializeInstanceResult = true;
   ...
   __pointer(::aqua::ipi) application::create_ipi()
   {

      try
      {

         return __new(::aqua::ipi(m_strAppName));
...
//   }
   ...
   void application::term_application()
   {
      ...
      ::aqua::application_message signal(::aqua::application_message_term_instance);
...
//      return true;
   ...
   __pointer(::aqua::exclusive) application::get_exclusive(string strId, LPSECURITY_ATTRIBUTES psa)
   {
      ...
      if(!pexclusive)
      {
         ...
         pexclusive = __new(::aqua::exclusive(strId, psa));
   ...
   void application::locale_schema_matter(string_array & stra, const string_array & straMatterLocator, const string & strLocale, const string & strSchema)
   {
      ...
      ::aqua::str_context * pcontext = Session.str_context();
...
//
   ...
   //i32 application::hotplugin_host_starter_start_sync(const char * pszCommandLine, ::aqua::application * papp, hotplugin::host * phost, hotplugin::plugin * pplugin)
   //{
...
//      }
   ...
   //   ::aqua::application::SetCurrentHandles();
   ...
   //   return aqua::application::process_exception(e);
   ...
   ::estatus application::on_run()
   {
      ...
      try
      {
         ...
         ::aqua::application_message signal(::aqua::application_message_begin);
   ...
   //   return ::aqua::application::init_application();
   ...
   //   return ::aqua::application::application_pre_run();
   ...
   //   if (!::aqua::application::do_install())
   //   {
   ...
   //   bool bOk = aqua::application::do_uninstall();
   ...
   //   if (!aqua::application::on_uninstall())
   //   {
   ...
   //   if (!::aqua::application::os_native_bergedge_start())
   //   {
   ...
   //   aqua::application::on_request(pcreate);
   ...
   //   return ::aqua::application::run();

   //}


   //__pointer(::aqua::application) application::assert_running(const char * pszAppId)
   //{
   ...
   //   if (!::aqua::application::init_instance())
   //   {
...
//
   ...
   ::estatus application::init()
   {
      ...
      ::aqua::application_message signal(::aqua::application_message_init);
      ...
      if (is_system())
      {
         ...
         if (has_property("save_processing"))
         {
            ...
            Session.savings().save(::aqua::resource_processing);
         ...
         if (has_property("save_blur_back"))
         {
            ...
            Session.savings().save(::aqua::resource_blur_background);
         ...
         if (has_property("save_transparent_back"))
         {
            ...
            Session.savings().save(::aqua::resource_translucent_background);
      ...
      {
         // aqua level app install
         if (!Ex2OnAppInstall())
            return false;
      }
      else if (has_property("uninstall"))
      {
         // aqua level app uninstall
      ...
      //   }
         ...
         //xxdebug_box("::aqua::application::initialize ok", "::aqua::application::initialize ok", MB_ICONINFORMATION);
...
//   }
   ...
   i32 application::hotplugin_host_host_starter_start_sync(const char * pszCommandLine, ::aqua::application * papp, hotplugin::host * phost, hotplugin::plugin * pplugin)
   {
   ...
   //   {
   //
   //      return ::aqua::applciation::interactive_credentials(pcredentials);
   //
   //   }
   //
   //
...
namespace aqua
{
   ...
   //   auto estatus = ::aqua::application::initialize(pobjectContext);
   ...
   //::aqua::application * application::get_context_application() const
   //{
   ...
   */
   ...
   //   return ::aqua::application::on_run_exception(pexception))
   //   {
   ...
   */
   ...
   /*void ::aqua::FormatString1(string & rString, UINT nIDS, const char * psz1)
   ...
   void ::aqua::FormatString2(string & rString, UINT nIDS, const char * psz1,
   ...
   /////////////////////////////////////////////////////////////////////////////
   // Basic Help support (for backward compatibility to aqua API 2.0)
   ...
   /////////////////////////////////////////////////////////////////////////////
   // Context Help Mode support (backward compatibility to aqua API 2.0)
   ...
   void application::SetRegistryKey(UINT nIDRegistryKey)
   {
      ...
      //VERIFY(::aqua::LoadString(nIDRegistryKey, szRegistryKey));
...
//      return hAppKey;
   ...
   *pBytes = 0;
   ...
   // linux ::aqua::CRegKey rkSecKey(hSecKey);
   ...
   *ppData = new BYTE[*pBytes];
   ...
   //   ::aqua::file_system & application::file_system()
   // {
...
//   }
   ...
   //   bool bOk = ::aqua::application::on_uninstall();
   ...
   //::aqua::printer* application::get_printer(const char* pszDeviceName)
   //{
   ...
   //::aqua::application * application::get_context_system()
   //{
   ...
   __pointer(::aqua::application) papp = nullptr;
   ...
   */
   ...
   //__pointer(::aqua::application) application::create_application(const char * pszType,const char * pszId,bool bSynch,application_bias * pbias)
   //{

   //   __pointer(::aqua::application) pbaseapp = instantiate_application(pszType,pszId,pbias);

   //   if(pbaseapp == nullptr)
   //      return nullptr;

   //   ::aqua::application * papp = (pbaseapp);
   ...
   //::estatus application::add_library(::aqua::library * plibrary)
   //{
   ...
   void application::data_on_after_change(::database::client* pclient, const ::database::key& key, const var& var, ::update* pupdate)
   {
      ...
      if (key.m_strDataKey == "ca2.savings")
      {
         ...
         Session.savings().m_eresourceflagsShouldSave = (::aqua::e_resource) var.i32();
   ...
   __pointer(::aqua::application) application::create_platform(::aqua::session* psession)
   {
   ...
   //   ::aqua::application::_001OnFranceExit();
   ...
   ::type application::control_type_from_id(const ::id& id, ::user::e_control_type& econtroltype)
   {
      ...
      return ::aqua::application::control_type_from_id(id, econtroltype);
   ...
   //   }
      ...
      //   ::aqua::application::update(pupdate);
   ...
   //   auto pcontroller = ::aqua::application::defer_create_view(strView, puiParent, ewindowflag, id);
