...
namespace aqua
{
   ...
   class CLASS_DECL_AQUA application :
      ...
      virtual public ::aqua::context_thread,
...
//      virtual public ::user::impact_creator,
   ...
   public:
      ...
      // 2020-01-25: removing from ::aqua::system, placing here (at ::context)
      // 2020-07-23: now at ::aqua::application
      __pointer(::user::language_map)                 m_puserlanguagemap;

      ::aqua::application *                           m_pappParent;
      string                                          m_strAppName;
      ...
      // former ::aqua::application_interface // moved on 2015-05-23 Sammstag while listening to RocketBeansTV (a German channel?) at TwitchTV
      ...
      string_map < __pointer(::aqua::exclusive) >     m_mapExclusive;
      ...
      __composite(::aqua::theme)                      m_ptheme;
...
//      virtual ::estatus     interactive_credentials(::account::credentials * pcredentials) override;
      ...
      //virtual __pointer(::aqua::application) assert_running(const char * pszAppId) override;
      ...
      virtual i32 hotplugin_host_starter_start_sync(const char * pszCommandLine, ::aqua::application * papp, hotplugin::host * phost, hotplugin::plugin * pplugin = nullptr);
      virtual i32 hotplugin_host_host_starter_start_sync(const char * pszCommandLine, ::aqua::application * papp, hotplugin::host * phost, hotplugin::plugin * pplugin = nullptr);
      ...
      virtual __pointer(::aqua::exclusive) get_exclusive(string str, LPSECURITY_ATTRIBUTES psa);
...
//   virtual void merge(::handler * phandler);
      ...
      //using ::aqua::context_thread::message_box;
      ...
      virtual __pointer(::aqua::ipi) create_ipi();
...
//      virtual ::account::user * noninteractive_get_user(::file::path pathUrl = nullptr);
      ...
      //virtual ::aqua::application * get_context_application() const override;
      ...
      //virtual void close(::aqua::e_end eend) override; // close documents before exiting
...
//#endif
      ...
      virtual bool LoadSysPolicies(); // Override to load policies other than the system policies that aqua API loads.
...
//      virtual bool process_exception(::exception_pointer pe) override;
      ...
      //      virtual ::aqua::file_system & file_system();
      ...
      //::aqua::application * get_context_system();
      ...
      inline ::aqua::theme* theme() { return m_ptheme.get(); }
      ...
      //virtual ::aqua::printer* get_printer(const char* pszDeviceName) override;
      ...
      virtual __pointer(::aqua::application) create_platform(::aqua::session* psession) override;
      ...
      */
      ...
      //virtual ::estatus add_library(::aqua::library * plibrary);
      ...
      //__pointer(::aqua::application) get_context_system();

      //virtual __pointer(::aqua::application) assert_running(const char * pszAppdId);
      ...
      //i32 hotplugin_host_host_starter_start_sync(const char* pszCommandLine, ::aqua::application* papp, ::hotplugin::host* phost, ::hotplugin::plugin* pplugin) override;
      ...
      //using ::aqua::application::on_control_event;
...
CLASS_DECL_AQUA UINT c_cdecl application_thread_procedure(LPVOID pvoid);

typedef __pointer(::aqua::application) (*LPFN_instantiate_application)(__pointer(::aqua::application) pappParent, const char* pszId);

extern CLASS_DECL_AQUA LPFN_instantiate_application g_lpfn_instantiate_application;

#ifdef WINDOWS_DESKTOP

CLASS_DECL_AQUA BOOL LaunchAppIntoDifferentSession(const char* pszProcess, const char* pszCommand, const char* pszDir, STARTUPINFO* psi, PROCESS_INFORMATION* ppi, int iSession = -1);

CLASS_DECL_AQUA BOOL LaunchAppIntoSystemAcc(const char* pszProcess, const char* pszCommand, const char* pszDir, STARTUPINFO* psi, PROCESS_INFORMATION* ppi);
