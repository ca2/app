...
application_array::application_array(const application_array & array):
   __pointer_array(::aqua::application)(array)
{
...
application_array & application_array::operator = (const application_array & array)
{
   ...
   __pointer_array(::aqua::application)::operator = (array);
...
::aqua::application * application_array::find_by_app_name(string strAppName)
{
...
::aqua::application * application_array::find_running_defer_try_quit_damaged(string strAppName)
{

   __pointer(::aqua::application) papp = find_by_app_name(strAppName);
...
bool application_array::lookup(string strAppName, __pointer(::aqua::application) & papp)
{
