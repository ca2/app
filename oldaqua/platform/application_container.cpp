...
void application_container::app_add(::aqua::application * papp)
{
...
void application_container::app_remove(::aqua::application * papp)
{
...
__pointer(::aqua::application) application_container::instantiate_application(const char * pszAppId, ::create * pcreate)
{

   INFO("aqua::application::instantiate_application");
...
__pointer(::aqua::application) application_container::create_application(const char * pszAppId, bool bSynch, ::create * pcreate)
{

   __pointer(::aqua::application) papp = instantiate_application(pszAppId, pcreate);
...
__pointer(::aqua::application) application_container::create_platform(::aqua::session * psession)
{
...
__pointer(::aqua::application) application_container::assert_running(const char * pszAppId, const string & strLocale, const string & strSchema)
{
...
__pointer(::aqua::application) application_container::start_application(const char * pszAppId, ::create * pcreate, const string & strLocale, const string & strSchema)
{
...
::aqua::application * application_container::application_get(const char * pszAppId, bool bCreate, bool bSynch, ::create * pcreate)
   {
