...
extern "C" 
typedef ::aqua::library * NEW_AURA_LIBRARY();

typedef NEW_AURA_LIBRARY * PFN_NEW_AURA_LIBRARY;

extern "C" 
typedef ::aqua::application * NEW_AURA_APPLICATION();

typedef NEW_AURA_APPLICATION * PFN_NEW_AURA_APPLICATION;


typedef ::aqua::application* __NEW_AURA_APPLICATION();

typedef __NEW_AURA_APPLICATION* __PFN_NEW_AURA_APPLICATION;


struct CLASS_DECL_AQUA aura_main_struct
{
