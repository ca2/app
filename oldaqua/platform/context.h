...
namespace aqua { class context_thread; }


class CLASS_DECL_AQUA context :
...
public:
   ...
   //CLASS_DECL_AQUA bool os_is_folder_alias(::object * pobject, const char * psz, bool bNoUI = false, bool bNoMount = false);
   ...
   virtual string matter_locator(::aqua::application * papp);

   virtual void on_update_matter_locator();

   virtual void add_matter_locator(string strApp);
   virtual void add_matter_locator(::aqua::application * papp);
