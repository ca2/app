...
#include "aqua/net/sockets/trace_interface.h"
...
CLASS_DECL_AQUA i32 DECL_C debug_report(
i32 _ReportType,
...
// CLASS_DECL_AQUA i32 FUNCTION_DEBUGBOX(const char * pszMessage, const char * pszTitle, i32 iFlags);

// CLASS_DECL_AQUA i32 FUNCTION_DEBUGBOXW(const WCHAR * pszMessage, const WCHAR * pszTitle, i32 iFlags);
...
// Use!!
// #include "aqua/inline/set_xxdebug_box.inl"
// and
// #include "aqua/inline/clear_xxdebug_box.inl"




void CLASS_DECL_AQUA TRACELASTERROR();



CLASS_DECL_AQUA string FormatMessageFromSystem(u32 dwError);


#ifdef MEMDLEAK

CLASS_DECL_AQUA string get_mem_info_report1();
CLASS_DECL_AQUA ::count get_mem_info(i32 ** ppiUse, const char *** ppszFile, const char *** pszCallStack, u32 ** ppuiLine, size_t ** ppsize);
CLASS_DECL_AQUA ::count get_mem_info2(i32 ** ppiUse, const char *** ppszFile, DWORD64 ** ppuiStack[64], i64 ** ppiStack, i32 ** ppiLine, i64 ** ppiSize);
...
//class CLASS_DECL_AQUA trace_interface //:
...
CLASS_DECL_AQUA void os_trace(e_trace_level elevel, const char * pszTag, const char * pszMessage);
CLASS_DECL_AQUA void trace(e_trace_level elevel, const char * pszTag, const char * psz, const char * pszFile = nullptr, int iLine = -1);
...
extern CLASS_DECL_AQUA ::mutex * g_pmutexMemoryCounters;

CLASS_DECL_AQUA bool memcnts();

CLASS_DECL_AQUA ::file::path memcnts_base_path();
