...
namespace aqua
{
   ...
   void department::on_application_message(::message::message * pmessage)
   {
      ...
      try
      {
         if(papplicationsignal->m_esignal == ::aqua::application_message_process_init)
         {

            papplicationsignal->m_bOk = process_init();

         }
         else if(papplicationsignal->m_esignal == ::aqua::application_message_init)
         {

            papplicationsignal->m_bOk = init();

         }
         else if(papplicationsignal->m_esignal == ::aqua::application_message_init1)
         {

            papplicationsignal->m_bOk = init1();

         }
         else if(papplicationsignal->m_esignal == ::aqua::application_message_init2)
         {

            papplicationsignal->m_bOk = init2();

         }
         else if(papplicationsignal->m_esignal == ::aqua::application_message_init3)
         {

            papplicationsignal->m_bOk = init3();

         }
         else if(papplicationsignal->m_esignal == ::aqua::application_message_init_instance)
         {

            papplicationsignal->m_bOk = init_instance();

         }
         else if(papplicationsignal->m_esignal == ::aqua::application_message_term_instance)
         {
         ...
         else if(papplicationsignal->m_esignal == ::aqua::application_message_term3)
         {
         ...
         else if(papplicationsignal->m_esignal == ::aqua::application_message_term2)
         {
         ...
         else if(papplicationsignal->m_esignal == ::aqua::application_message_term1)
         {
         ...
         else if(papplicationsignal->m_esignal == ::aqua::application_message_process_term)
         {
