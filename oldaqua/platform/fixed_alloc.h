...
class CLASS_DECL_AQUA fixed_alloc_no_sync
{
public:
...
class CLASS_DECL_AQUA fixed_alloc_sync
{
public:
...
class CLASS_DECL_AQUA fixed_alloc
{
public:
...
class CLASS_DECL_AQUA fixed_alloc_array :
