...
namespace aqua
{
   ...
   class CLASS_DECL_AQUA ipi :
      virtual public object,
      virtual public ::aqua::ipc::rx::receiver
   {
   public:
      ...
      string                                       m_strApp;
      ::id                                         m_idApp;
      string_map < __pointer(::aqua::ipc::tx) >    m_txmap;
      string_map < __pointer(::mutex) >            m_mapAppMutex;
      __pointer(::aqua::ipc::rx)                   m_prx;
      ...
      virtual ::aqua::ipc::tx & tx(const string & strApp, const ::id & idPid);
      ...
      using ::aqua::ipc::rx::receiver::on_ipc_receive;

      virtual void on_ipc_receive(::aqua::ipc::rx * prx, const char * pszMessage) override;
