...
CLASS_DECL_AQUA string thread_get_name();
...
//   extern __pointer(::aqua::application) g_papp;

   CLASS_DECL_AQUA i32 SimpleDebugReport(i32 iReportType, const char * pszFileName,i32 iLine,const char *,const char * pszFormat, va_list list)
   {
#ifdef WIN32
   ...
   void log::__tracea(::generic_object * pobjectContext, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * psz)
   {
      ...
      ::aqua::trace::category * pcategory = nullptr;
            ...
            fork([this]()
               {
                  ...
                  if (!::file::app_module().contains_ci("logviewer") && file_exists(::dir::system() / "logviewer.txt"))
                  {
                     ...
                     call_async("C:\\aqua\\time\\x64\\basis\\app_core_logviewer.exe", "\"" + m_strLogPath + "\"", "C:\\aqua\\time\\x64\\basis", display_normal, false);
