...
namespace aqua
{
   ...
   public:
      ...
      bool                       m_bTrace;
      __composite(::aqua::trace::trace) m_ptrace;
      ::mutex                    m_mutexTrace;
   ...
   CLASS_DECL_AQUA i32 SimpleDebugReport(i32, const char *, i32, const char *, const char * pszFormat, va_list list);
