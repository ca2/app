...
//#endif
//
//CLASS_DECL_AQUA int_bool freerdp_get_credentials(void * instance, char** username,char** password,char** domain, const char * pszServerName, int bInteractive)
//{
//
//   ::aqua::application * papp = (::aqua::application *) instance;
//
//   ::account::user user;
//
