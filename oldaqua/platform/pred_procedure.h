...
CLASS_DECL_AQUA void main_async_runnable(::context_object * pobjectTask);
CLASS_DECL_AQUA void main_sync_runnable(::context_object * pobjectTask, ::duration durationTimeout = one_minute());
...
CLASS_DECL_AQUA void main_branch(::generic_object * pobjectTask, e_priority epriority);
