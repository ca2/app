...
//#include "aqua/papaya/papaya_zoneing.h"
...
#include "aqua/node/ios/interaction_impl.h"
...
namespace PLATFORM_NAMESPACE
{
   ...
   CLASS_DECL_AQUA ::user::interaction * create_host_window();
...
namespace aqua
{
   ...
   session::~session()
   {
      ...
      output_debug_string("aqua::session::~session()");
...
//m_strInstallToken = "base_session";
   ...
   ::estatus session::process_init()
   {
      ...
      INFO("aqua::session::process_init");
      ...
      if (!estatus)
      {
         ...
         INFO("aqua::str_context Failed to Allocate!!");

         return estatus;

      }

      INFO("aqua::str_context Succeeded to Allocate!!");

      INFO("aqua::session::process_init success");
   ...
   ::estatus session::init_session()
   {
      ...
      if (!estatus)
      {
         ...
         message_box("::aqua::session::init1 Failed");
   ...
   void session::on_request(::create * pcreate)
   {
      ...
      TRACE("::aqua::session::on_request(__pointer(::create)) " + string(type_name()));

      INFO("::aqua::session::on_request(__pointer(::create)) %s ", __c_str(THIS_FRIENDLY_NAME()));
      ...
      if (bCreate)
      {
         ...
         for (i32 i = 0; i < pcreate->m_pcommandline->m_varQuery["app"].stra().get_count(); i++)
         {
            ...
            ::aqua::application * papp = application_get(strApp, true, true, pcreate);
   ...
   bool session::open_by_file_extension(::create * pcreate)
   {
      ...
      ::aqua::application* papp = application_get(strId, true, true, pcreate);
   ...
   ::aqua::application * session::application_get(const char * pszAppId, bool bCreate, bool bSynch, ::create * pcreate)
   {
      ...
      else
      {
         ...
         catch (::exception_pointer pe)
         {
            ...
            // aqua::session, axis::session and ::base::session, could get more specialized handling in aqua::application (aqua::system)
...
//   __pointer(::aqua::application) session::get_new_application(::object * pobjectContext, const char * pszAppId)
//   {
//
...
//
//         __pointer(::aqua::library) & plibrary = &::get_context_system()->m_mapLibrary[pszAppId];
//
//         if (!plibrary)
//         {
//
...
ret:
   ...
   //::user::theme_pointer session::get_user_theme(const char * pszExperienceLibrary, ::aqua::application * papp)
   //{
...
//   ::user::theme_pointer session::instantiate_user_theme(const char * pszExperienceLibrary, ::aqua::application * papp)
//   {
//
//      INFO("aqua::session::instantiate_user_theme");
//
//      if (papp == nullptr)
//      {
//
...
//   }
   ...
   //         ERR("aqua::session::defer_instantiate_user_theme");
...
//      puserinteraction->post_redraw();
   ...
   ::estatus session::init2()
   {
      ...
      if (System.m_bUser)
      {
         ...
         //      FATAL("aqua::session::init2 Failed to create account department");
      ...
      if (is_remote_session())
      {
         ...
         //Session.savings().save(::aqua::resource_display_bandwidth);
         //Session.savings().save(::aqua::resource_blur_background);
         //Session.savings().save(::aqua::resource_blurred_text_embossing);
...
namespace aqua
{
   ...
   //   aqua::session::install_message_routing(pchannel);
   ...
   __pointer(::aqua::application) session::get_current_application()
   {
   ...
   //   ::aqua::application & app = App(pmainframe->get_context_application());
   ...
   __pointer(::aqua::session) session::get_context_session()
   {
   ...
   //   }
      ...
      //      bOk1 = ::aqua::session::on_uninstall();
      ...
      //   return ::aqua::application::allocate_new_service();
   ...
   ::estatus     session::main()
   {
      ...
      //return ::aqua::session::main();
      return ::thread::main();

   }


   //::aqua::session * session::query_bergedge()
   //{

   //   ::aqua::session * psession = nullptr;
   ...
   //   ::aqua::session::on_user_logon(puser);
...
//#endif
//
//      ::aqua::session::interactive_credentials(pcredentials);
//
//      if (pcredentials->m_estatus == ::success_credentials)
//      {
//
...
//   }
   ...
   //   m_psavings = __new(class ::aqua::savings(this));
   ...
   //   aqua::session::on_finally_focus_set(pelementalFocus);
