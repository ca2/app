...
namespace aqua
{
   ...
   public:
      ...
      class CLASS_DECL_AQUA map:
         virtual public isomap < index, __pointer(::aqua::session) >
      {
      ...
      __composite(::aqua::savings)                          m_psavings;

      var                                                   m_varTopicFile;
      var                                                   m_varCurrentViewFile;
      bool                                                  m_bShowPlatform;

      __composite(::aqua::str_context)                      m_puserstrcontext;
      ...
      ::aqua::str_context *                        str_context() { return m_puserstrcontext; }
      ...
      //__pointer(::aqua::application) get_new_application(::object * pobjectContext, const char * pszAppId);

      inline ::aqua::savings &                  savings()      { return *m_psavings; }
      ...
      ::aqua::application * application_get(const char * pszAppId, bool bCreate, bool bSynch, ::create * pcreate) override;
      ...
      //__pointer(::user::theme) instantiate_user_theme(const char * pszExperienceLibrary, ::aqua::application * papp = nullptr);
      //__pointer(::user::theme) get_user_theme(const char * pszExperienceLibrary, ::aqua::application * papp = nullptr);
      ...
      __pointer(::aqua::application) get_current_application();



      virtual void set_app_title(const char* pszAppId, const char* pszTitle);

      virtual __pointer(::aqua::session) get_context_session();
