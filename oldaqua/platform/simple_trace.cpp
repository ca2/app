...
CLASS_DECL_AQUA void __simple_tracea(::generic_object * pobjectContext, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * psz);
CLASS_DECL_AQUA void __simple_tracev(::generic_object * pobjectContext, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, va_list args);


//CLASS_DECL_AQUA void FUNCTION_DEBUGBOX(const char * pszMessage, const char * pszTitle, ::emessagebox emessagebox, ::callback callback)
//{
//
...
//CLASS_DECL_AQUA void FUNCTION_DEBUGBOXW(const WCHAR * pszMessage, const WCHAR * pszTitle, i32 iFlags, const ::function_arg& function)
//{
//
...
CLASS_DECL_AQUA void trace(e_trace_level elevel, const char * pszTag, const char * pszText, const char * pszFile, int iLine)
{
...
CLASS_DECL_AQUA::mutex * g_pmutexMemoryCounters = nullptr;
...
void simple_trace::__tracea(::generic_object * pobjectContext, e_trace_level elevel, const char * pszFunction, const char * pszFile, int iLine, const char * psz)
{
...
CLASS_DECL_AQUA bool enable_trace_category(e_trace_category ecategory, bool bEnable)
{
