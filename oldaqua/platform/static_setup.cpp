...
::aqua::application* static_setup::create_new_application()
{
...
::aqua::library* static_setup::create_new_library()
{
...
::aqua::application* static_setup::new_application()
{
...
::aqua::library* static_setup::new_library()
{
