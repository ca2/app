...
class CLASS_DECL_AQUA static_setup 
{
public:
   ...
   virtual ::aqua::application* create_new_application();
   virtual ::aqua::library* create_new_library();

   virtual ::generic_object* new_object();
   virtual ::aqua::application* new_application();
   virtual ::aqua::library* new_library();
...
public:
   ...
   virtual ::aqua::library* new_library() override { return new LIBRARY; }
