...
#include "aqua/net/sockets/_.h"
#include "aqua/memory/plex_heap1.h"
#include "aqua/memory/plex_heap_impl1.h"
#include "aqua/platform/app_core.h"
#include "aqua/primitive/primitive/malloc.h"
#include "aqua/astr.h"
...
namespace aqua
{
   ...
   CLASS_DECL_AQUA critical_section* g_pcsFont = nullptr;

   CLASS_DECL_AQUA string_to_string * g_pmapFontFaceName = nullptr;

   ::mutex* g_pmutexChildren;
   ::mutex* g_pmutexThreadWaitClose;
   //string_map < __pointer(::aqua::library) >* g_pmapLibrary;
...
//clock_serv_t   g_cclock;
   ...
   CLASS_DECL_AQUA aura_str_pool* g_paurastrpool;
...
//clock_serv_t   g_cclock;
      ...
      //::map < void *, void *,::aqua::application *, ::aqua::application * > * g_pmapAura;

      //string_map < __pointer(::aqua::library) > * g_pmapLibCall;
...
//::mutex * g_pmutexTlsData;
   ...
   aqua::aqua()
   {
      ...
      //xxdebug_box("aqua.dll base_static_start (0)", "box", MB_OK);
      ...
      //g_pmapAura =new ::map < void *,void *,::aqua::application *,::aqua::application * >;
      ...
      //g_pmapLibrary = new string_map < __pointer(::aqua::library) >();
      ...
      //g_pmapLibCall = new string_map < __pointer(::aqua::library) >();
   ...
   aqua::~aqua()
   {
      ...
      //::aqua::del(::thread::g_pmutex);

      //::aqua::del(::thread::g_pthreadmap);

      ::user::term_windowing();

      g_bAura = 0;

      ::aqua::del(g_paurastrpool);
      ...
      ::aqua::free(g_pszDemangle);

#endif

#ifndef WINDOWS

      ::aqua::del(g_pcsDemangle);
   ...
   //::aqua::system * aura_create_system(app_core * pappcore)
   //{

   //   auto psystem = new ::aqua::system();
...
//
//CLASS_DECL_AQUA ::mutex * draw2d_mutex()
//{
//
...
//CLASS_DECL_AQUA void init_draw2d_mutex()
//{
//
...
//CLASS_DECL_AQUA void terg_draw2d_mutex()
//{
//
//   ::aqua::del(s_pmutexDraw2d);
//
//}



CLASS_DECL_AQUA ::mutex * get_cred_mutex()
{

   return ::aqua::g_pmutexCred;
...
CLASS_DECL_AQUA COLORREF dk_red() // <3 tbs
{
...
CLASS_DECL_AQUA ::estatus  get_last_status()
{
