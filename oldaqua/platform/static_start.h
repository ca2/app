...
namespace aqua
{
   ...
   extern CLASS_DECL_AQUA critical_section* g_pcsGlobal;

   extern CLASS_DECL_AQUA string_to_string* g_pmapFontFaceName;

   extern CLASS_DECL_AQUA critical_section* g_pcsFont;
...
//void windows10_init();
   ...
   extern ::generic_object* g_ptrace;
...
//clock_serv_t   g_cclock;
   ...
   extern CLASS_DECL_AQUA array < generic_object* >* g_paAura;
