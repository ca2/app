#include "framework.h"
//#include "aqua/filesystem/filehandler/_data.h"
...
//#include "aqua/net/ftp/_.h"
#include "aqua/platform/profiler2.h"
#include "aqua/platform/static_setup.h"

//#ifdef _OPENGL
#include "aqua/gpu/gpu/_.h"
//#endif

extern ::aqua::system* g_paurasystem;
...
CLASS_DECL_AQUA void multimedia_set_library_name(const char* psz)
{
...
#ifdef CUBE
extern "C"
::aqua::library * experience_get_new_library();
#endif


void ___compile_test_sort_array_21304528734();

void enum_display_monitors(::aqua::system * psystem);

#ifdef WINDOWS_DESKTOP
CLASS_DECL_AQUA ::user::interaction * create_system_message_window(::object * pobject);
#endif
...
namespace aqua
{
   ...
   void system::common_construct()
   {
      ...
      create_factory < ::aqua::session >();
      create_factory < ::aqua::application >();
   ...
   ::estatus system::initialize(::object * pobjectContext)
   {
      ...
      auto estatus = ::aqua::context_thread::initialize(pobjectContext);
...
//      __node_axis_factory_exchange();
      ...
      //estatus = ::aqua::application::initialize(pobjectContext);
     ...
     //m_strInstallToken = "base_system";
      ...
      //#endif
            ...
            //estatus = ::aqua::application::initialize(pobject);
   ...
   __pointer(::aqua::library) system::open_component_library(const char* pszComponent, const char* pszImplementation)
   {
      ...
      __pointer(::aqua::library)& plibrary = ::get_context_system()->m_mapLibrary[pszComponent];
...
//      if (!bOk)
  //    {
   ...
   void system::session_add(index iEdge, ::aqua::session * psession)
   {
   ...
   void system::set_context_app(::aqua::application* pappContext)
   {
   ...
   void system::set_context_session(::aqua::session* psessionContext)
   {
   ...
   void system::set_context_system(::aqua::system* psystemContext)
   {
   ...
   //::aqua::library * system::on_get_library(const char * pszLibrary)
   //{
   ...
   bool system::on_get_thread_name(string& strThreadName)
   {
      ...
      return ::aqua::context_thread::on_get_thread_name(strThreadName);

   }



   ::aqua::library * system::get_library(const char * pszLibrary1, bool bOpenCa2)
   {
      ...
      __pointer(::aqua::library) & plibrary = ::get_context_system()->m_mapLibrary[strLibrary];
...
//               }
   ...
   system::~system()
   {
      ...
      //::aqua::del(m_purldepartment);

      //::aqua::del(m_pcompress);

      ::aqua::del(g_pmutexImage);

      //try
      //{

      //   ::aqua::del(m_pmachineeventcentral);
...
//      create_factory < manual_reset_event >();
      ...
      //if (!::aqua::application::process_init())
      //{
      ...
      INFO("aqua::session::process_init .3");
      ...
      if (!m_ptrace->process_init())
      {
         ...
         WARN("failed to process_init ::aqua::log trace");
...
//#else
      ...
      //__pointer(::aqua::library) plibrary;
      ...
      //__pointer(::aqua::library) & plibrary = ::get_context_system()->m_mapLibrary["draw2d"];
...
//#else
      ...
      //__pointer(::aqua::library)& plibrary = ::get_context_system()->m_mapLibrary["imaging"];
...
//#endif // CUBE
   ...
   ::estatus system::inline_init()
   {
      ...
      ::estatus estatus = ::aqua::context_thread::inline_init();
   ...
   ::estatus system::inline_term()
   {
      ...
      ::estatus estatus = ::aqua::context_thread::inline_term();
...
//#endif // LINUX
   ...
   void system::TermApplication()
   {
      ...
      //::aqua::application::TermApplication();
      ...
      // the "most elegant" is to let just ~system (::aqua::system destructor)...
      // ... do this call, but this requires all references to ::aqua::system ...
...
//}
   ...
   i32 system::_debug_logging_report(i32 iReportType, const char * pszFileName, i32 iLineNumber, const char * pszModuleName, const char * pszFormat,va_list list)
   {
      ...
      if(!m_ptrace || !m_ptrace->m_bExtendedLog)
      {
         ...
         return ::aqua::SimpleDebugReport(iReportType,pszFileName,iLineNumber,pszModuleName,pszFormat,list);
...
//   }
   ...
   ::aqua::session * system::session(index iEdge)
   {
...
//__pointer_array(::aqua::session) & system::basesessionptra()
//{
...
//      for(i32 i = 0; i < appptra().get_size(); i++)
      //    {
      //     ::aqua::application * papp = appptra()(i);
...
//      for(i32 i = 0; i < appptra().get_size(); i++)
   ...
   bool system::assert_running_global(const char * pszAppName,const char * pszId)
   {
      if(string(pszId).has_char())
      {
         ...
         if(pmutex == nullptr)
         {
            ...
            ::aqua::shell_launcher launcher(nullptr,nullptr, Context.dir().module()/strApp,strParameters,nullptr,display_normal);
      ...
      else
      {
         ...
         if(pmutex == nullptr)
         {
            ...
            ::aqua::shell_launcher launcher(nullptr,nullptr,Context.dir().module()/strApp,nullptr,nullptr, display_normal);
   ...
   bool system::assert_running_local(const char * pszAppName,const char * pszId)
   {
      ...
      if(strId.has_char())
      {
         ...
         if(pmutex == nullptr)
         {
            ...
            ::aqua::shell_launcher launcher(nullptr,nullptr, Context.dir().ca2module() / strApp,strParameters,nullptr, display_normal);
   ...
   __result(::aqua::session) system::on_create_session(index iEdge)
   {

      __pointer(::aqua::session) psession;
...
#error "CA2_PLATFORM_VERSION has unsupported definition"
   ...
   void system::on_request(::create * pcreate)
   {
      ...
      INFO("%s", ("::aqua::system::on_request session = " + string(psession->type_name()) + "("+__str((iptr) psession)+")\n\n").c_str());
...
//      return true;
   ...
   bool system::find_applications_to_cache(bool bSave)
   {
      ...
      /*      m_spfilehandler(new ::aqua::filehandler::handler(this));*/
...
//
//      ::output_debug_string("\n\n::aqua::system::find_applications_to_cache\n\n");
//
...
// #endif
   ...
   CLASS_DECL_AQUA bool get_window_rect(::aqua::system_window ^ pwindow, RECTD * prect)
   ...
   CLASS_DECL_AQUA bool get_window_rect(::aqua::system_window ^ pwindow, RECT * prect)
   {
   ...
   void system::enum_display_monitors()
   {
      ...
      ::EnumDisplayMonitors(nullptr, nullptr, &system::monitor_enum_proc, (LPARAM)(dynamic_cast < ::aqua::system * > (this)));
...

   {
      ...
      ::aqua::system * psystem = (::aqua::system *) dwData;
...
//         int iRet = call_sync("C:\\bergedge\\time\\stage\\visual_studio_automation_2017.exe",strParams, "C:\\bergedge\\time\\stage\\", display_none, 30, 1000, nullptr, 0);
   ...
   bool system::set_user_language(::aqua::application * papp, index iSel)
   {
   ...
   bool system::set_user_language(::aqua::application * papp, string strLang)
   {
...
//#endif
   ...
   ::estatus system::verb() // ambigous inheritance from ::aqua::system/::axis::application
   {
   ...
   //__pointer(::aqua::session) system::on_create_session()
   //{
   ...
   //   ::aqua::system::on_request(pcreate);
   ...
   //::aqua::session * system::query_session(index iEdge)
   //{
...
#ifdef WINDOWS_DESKTOP
//#include "aqua/os/windows/windows_system_interaction_impl.h"
#elif defined(_UWP)
...
namespace aqua
{
   ...
   CLASS_DECL_AQUA void black_body(float* r, float* g, float* b, DWORD dwTemp);

   /*  bool system::on_application_menu_action(const char * pszCommand)
     {
        return ::aqua::system::on_application_menu_action(pszCommand);
     }*/
     ...
     //   create_factory < ::aqua::session, ::aqua::session >();
  ...
  //   {
  //
  //      auto estatus = ::aqua::system::initialize_system(pobject, pappcore);
  //
  //      if (!estatus)
  //      {
  //
  ...
  //   }
   ...
   ::estatus system::init2()
   {
      ...
      //if(!::aqua::application::init2())
      //   return false;

      //auto estatus = ::aqua::system::init2();
   ...
   //   m_bInitApplicationResult = ::aqua::system::InitApplication();
...
//
   ...
   void system::on_map_application_library(::aqua::library& library)
   {
   ...
   //   //if (!::aqua::application::init_application())
   //   //{
   ...
   //   //m_pbergedgemap = __new(::aqua::session::map);
...
////
////#endif
//      //::aqua::application::term_application();
//      try
//      {
//
//         ::aqua::system::term_system();
...
//   }
   ...
   //   ::aqua::session * pbergedge = nullptr;
   ...
   estatus system::set_history(::aqua::history* phistory)
   {
   ...
   //   //   if (!::aqua::application::on_install())
   //   //   {
   ...
   ::estatus system::add_view_library(::aqua::library* plibrary)
   {
   ...
   //   return aqua::system::do_request(pcreate);
   ...
   //__pointer_array(::aqua::session) & system::planesessionptra()
   //{
...
//   {
//
//      auto estatus = ::aqua::system::initialize_system(pobjectContext, pappcore);
//
//      if (!estatus)
//      {
//
...
//   }
   ...
   //   return ::aqua::system::get_monitor_count();
...
//
//
//      return ::aqua::system::get_monitor_rect(iMonitor, prect);
//
...
//   }
   ...
   //   return ::aqua::system::get_wkspace_rect(iWkspace, prect);
   ...
   //
   //
   //      //::aqua::application * papp = ::get_context_application(get_object());
   //
   //      //if (papp == nullptr)
   //      //{
   //
   ...
   void system::update(::update* pupdate)
   {
      ...
      //        __pointer(::aqua::session) psession = m_psession;
...
::aqua::system* platform_create_system(HINSTANCE hinstance)
{
   ...
   return pobject.cast < ::aqua::system >();

}


::aqua::session * platform_create_session()
{
   ...
   return pobject.cast < ::aqua::session >();
