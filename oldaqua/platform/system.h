...
namespace aqua
{
   ...
   public:
      ...
      __pointer(::aqua::application)                     m_papplicationStartup;

      __composite(::aqua::system)                        m_psystemParent;
      ...
      __composite(class ::aqua::log)                     m_ptrace;
      __composite(math::math)                            m_pmath;
      __composite(geometry::geometry)                    m_pgeometry;

      __composite(::aqua::str)                           m_puserstr;

      ::aqua::session::map                               m_sessionmap;

      __composite(::gpu::approach)                       m_pgpu;

      ::mutex                                            m_mutexLibrary;
      string_map < __pointer(::aqua::library) >          m_mapLibrary;
      string_map < PFN_NEW_AURA_LIBRARY >                m_mapNewAuraLibrary;
      string_map < __pointer(::aqua::library) >          m_mapLibCall;
...
//      __composite(::net::email_department)               m_pemaildepartment;
      ...
      // 2020-01-25: removing from here (::aqua::system), placing at ::context
...
//#pragma message("at macos??")
      ...
      //    class ::aqua::stra                           m_stra;
      //    class ::aqua::service                        m_service;


      // class ::aqua::patch* m_ppatch;

      //      __pointer(::aqua::run_start_installer)              m_prunstartinstaller;

            //__pointer(::aqua::session::map)                     m_pbergedgemap;
            //__pointer_array(::aqua::session)                         m_planesessionptra;

      __composite(class ::aqua::history)                m_phistory;

      //      ::sockets::net                               m_net;
      //      __pointer(::aqua::filehandler::handler)  m_spfilehandler;
      ...
      strid_map < ::aqua::library* >              m_idmapCreateViewLibrary;

      __pointer_array(::aqua::library)                         m_libraryspa;
      ...
      virtual ::estatus verb() override; // ambigous inheritance from ::aqua::system/::axis::application
      ...
      //virtual __pointer(::aqua::session) on_create_session() override;
      ...
      //virtual ::aqua::session * query_session(index iEdge) override;
      ...
      __pointer(::aqua::library) open_component_library(const char* pszComponent, const char* pszImplementation);
      ...
      virtual ::aqua::library * on_get_library(const char * pszLibrary);

      virtual ::aqua::library * get_library(const char * pszLibrary, bool bOpenCa2 = false);


      virtual UINT os_post_to_all_threads(UINT uiMessage,WPARAM wparam = 0,lparam lparam = 0);


      virtual void session_add(index iEdge, ::aqua::session * psession);
      ...
      virtual __result(::aqua::session) on_create_session(index iEdge);

      virtual ::aqua::session * session(index iEdge = 0);
      ...
      virtual void on_map_application_library(::aqua::library & library);
...
//#pragma message("at macos??")
      ...
      virtual bool set_user_language(::aqua::application * papp, index iSel);
      virtual bool set_user_language(::aqua::application * papp, string strLang);
      ...
      //__pointer_array(::aqua::session) &    planesessionptra();
      ...
      estatus set_history(::aqua::history* phistory);


      //__pointer(::aqua::library) on_get_library(const char* pszLibrary) override;


      //virtual ::aqua::session *  get_platform(index iEdge,application_bias * pbiasCreation = nullptr);
...
//      ::aqua::stra                           & stra();
      //    ::aqua::service                        & service();
      ::aqua::history& hist();

      //class ::aqua::patch& patch();
...
//      virtual bool wait_twf(tick tickTimeout = INFINITE);
      ...
      virtual ::estatus add_view_library(::aqua::library* plibrary);
      ...
      virtual void set_context_app(::aqua::application* pappContext) override;
      virtual void set_context_session(::aqua::session* psessionContext) override;
      virtual void set_context_system(::aqua::system* psystemContext) override;
      ...
      //virtual void on_map_application_library(::aqua::library& library) override;
      ...
      //virtual ::aqua::library* load_library(const char* pszLibrary);

   };

   CLASS_DECL_AQUA ::mutex * get_image_mutex();
...
//#ifndef __DEBUG
//
//#include "aqua/inline/factory.cpp"
//
//#endif // __DEBUG



//CLASS_DECL_AQUA ::aqua::system * create_aura_system(app_core * pappcore);
CLASS_DECL_AQUA ::aqua::system * create_aura_system();
...
// void CLASS_DECL_AQUA __start_core_system_main(::base::system * psystem);

#ifdef _UWP

CLASS_DECL_AQUA int app_core_main(const char* psz);
