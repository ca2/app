...
class CLASS_DECL_AQUA nano_timer
{
public:
...
public:
   ...
   __reference(::aqua::timer_array)    m_ptimera;
...
//#endif
   ...
   timer(::aqua::timer_array * ptimera, uptr uiTimer = 0, PFN_TIMER pfnTimer = nullptr, void * pvoidData = nullptr, class sync * pmutex = nullptr);
   virtual ~timer();
