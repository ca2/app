...
namespace aqua
{
   ...
   namespace trace
   {
      ...
      CLASS_DECL_AQUA PFN_trace_v trace_v = &raw_trace_v;
      ...
      /*CLASS_DECL_AQUA void system_log_trace_v(const char *pszFileName, i32 nLine, u32 dwCategory, u32 nLevel, const char * pszFmt, va_list args)
      {
...
CLASS_DECL_AQUA void __simple_tracea(::generic_object * pobjectContext, e_trace_level elevel, const char * pszFunction, const char *pszFileName, i32 iLine, const char * psz)
{
...
CLASS_DECL_AQUA void __simple_tracev(::generic_object * pobjectContext, e_trace_level elevel, const char * pszFunction, const char *pszFileName, i32 iLine, const char * pszFormat, va_list args)
{
