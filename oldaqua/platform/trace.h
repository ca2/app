...
class CLASS_DECL_AQUA simple_trace :
...
class CLASS_DECL_AQUA trace_logger
{
public:
...
class CLASS_DECL_AQUA trace_logger_level :
   public trace_logger
{
public:
...
namespace aqua
{
   ...
   CLASS_DECL_AQUA void raw_trace_v(const char *pszFileName,i32 nLine,u32 dwCategory,u32 nLevel,const char * pszFmt,va_list args);
   ...
   namespace trace
   {
      ...
      class CLASS_DECL_AQUA category
      {
      public:
      ...
      //CLASS_DECL_AQUA void __cdecl TRACE(const char * pszFormat,...);
      //CLASS_DECL_AQUA void __cdecl TRACE(const unichar * pszFormat,...);
      //CLASS_DECL_AQUA void __cdecl TRACE(uptr dwCategory,UINT nLevel,const char * pszFormat,...);
      //CLASS_DECL_AQUA void __cdecl TRACE(uptr dwCategory,UINT nLevel,const unichar * pszFormat,...);
...
CLASS_DECL_AQUA const char * get_windows_message_name(UINT nMsg);



//struct CLASS_DECL_AQUA log_context :
//   virtual public ::object
//{
//
//   e_trace_category     m_ecategory;
