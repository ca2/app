...
CLASS_DECL_AQUA bool safe_destroy_element(object * pobject);
...
class CLASS_DECL_AQUA map_word_to_ptr :
...
class CLASS_DECL_AQUA map_ptr_to_word :
...
class CLASS_DECL_AQUA map_ptr_to_ptr :
...
class CLASS_DECL_AQUA map_word_to_ob :
...
class CLASS_DECL_AQUA map_string_to_ptr :
...
class CLASS_DECL_AQUA map_string_to_ob :
...
#include "aqua/platform/pred_callback.h"


#include "var_array.h"
#include "aqua/primitive/primitive/property.h"
...
typedef CLASS_DECL_AQUA __pointer_array(u32_array) dword_2darray;
typedef CLASS_DECL_AQUA __pointer_array(index_array) index_2darray;


#include "aqua/primitive/geometry2d/point_array.h"
#include "aqua/primitive/geometry2d/size_array.h"
#include "aqua/primitive/geometry2d/rect_array.h"


#include "aqua/primitive/geometry2d/polygon.h"


#include "aqua/primitive/comparison/less.h"
...
class CLASS_DECL_AQUA time_array :
