...
//class CLASS_DECL_AQUA object_ptra :
//   virtual public ::address_array < object * >
//{
//public:
//
//   typedef ::address_array < object * > BASE_TYPE;
//
//   inline object_ptra() {}
//   inline object_ptra(::object * pobject) : ::object(pobject) { }
//   inline object_ptra(const object_ptra & a) : ::object(a), BASE_TYPE(a) { }
//   inline object_ptra(const BASE_TYPE & a) : ::object((const ::object & )a), BASE_TYPE(a) { }
//   inline object_ptra(object_ptra && a): ::object(a), BASE_TYPE(::move(a)) { }
//
...
class CLASS_DECL_AQUA const_char_ptra :
...
typedef address_array < context_object * > simple_object_ptra;


typedef address_array < context_object * > reference_addressa;
