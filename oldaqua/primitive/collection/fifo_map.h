...
//}
//
//typedef CLASS_DECL_AQUA fifo_attrib_map < fifo_map < i32, i32, i32, i32 > > fifo_int_to_int;
//typedef CLASS_DECL_AQUA fifo_attrib_map < fifo_map < i32, i32, string, const string & > > fifo_int_to_string;
//typedef CLASS_DECL_AQUA fifo_string_map < void *, void * > fifo_string_to_ptr;
//
//template < class T >
//class CLASS_DECL_AQUA fifo_string_to_pointer :
...
//
//
//typedef CLASS_DECL_AQUA fifo_string_map < iptr, iptr > fifo_string_to_intptr;
//
//typedef CLASS_DECL_AQUA fifo_string_map < string, const string & > fifo_string_to_string_map;
//
//
//
