...
typedef CLASS_DECL_AQUA string_array_base < string > string_array;
typedef CLASS_DECL_AQUA string_array_base < wstring > wstring_array;


class CLASS_DECL_AQUA string2a:
...
CLASS_DECL_AQUA bool next_csv(string & str, const string_array & stra);
CLASS_DECL_AQUA void add_csv(string_array & stra, const string & str);
...
namespace stra
{
   ...
   inline CLASS_DECL_AQUA string_array from_strdup(ansichar ** ppParam)
   {
