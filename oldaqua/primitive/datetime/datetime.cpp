...
namespace datetime
{
   ...
   value span_strtotime(::object * pobject, const ::aqua::str_context * pcontext, const char * pszSpanExpression)
   {
   ...
   value strtotime(::object * pobject, const ::aqua::str_context * pcontext,const char * psz,i32 & iPath,i32 & iPathCount,bool bUTC)
   {
      ::datetime::time time;
      string str(psz);
      str.trim();
   ...
   string to_string(::object * pobject, const ::aqua::str_context * pcontext,const ::datetime::value & value)
   {
      string str;
      if(value.m_bSpan)
      {
...
extern "C"
CLASS_DECL_AQUA int c_localtime_offset()
{
