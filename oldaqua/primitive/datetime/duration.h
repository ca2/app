...
class CLASS_DECL_AQUA duration
{
public:
...
class CLASS_DECL_AQUA one_second :
   public duration
{
public:
...
class CLASS_DECL_AQUA one_minute :
   public duration
{
public:
...
class CLASS_DECL_AQUA one_hour :
   public hours
{
public:
...
inline bool CLASS_DECL_AQUA operator >(const duration & duration1, const duration & duration2)
{
