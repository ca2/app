...
namespace datetime
{
   ...
   class CLASS_DECL_AQUA file_time:
      public FILETIME
   {
   public:
   ...
   extern CLASS_DECL_AQUA const char * const szInvalidDateTime;
   extern CLASS_DECL_AQUA const char * const szInvalidDateTimeSpan;
...
CLASS_DECL_AQUA FILETIME get_file_time_now();


struct CLASS_DECL_AQUA file_time
{
...
CLASS_DECL_AQUA bool file_modified_timeout(const char * path, int iSeconds);


CLASS_DECL_AQUA bool get_file_time(const char * psz,file_time & time);

CLASS_DECL_AQUA bool get_file_time(const char * psz,FILETIME & creation,FILETIME & modified);

CLASS_DECL_AQUA bool set_modified_file_time(const char* psz, const ::datetime::time & time);

CLASS_DECL_AQUA bool set_modified_file_time(const char* psz, const FILETIME& modified);
