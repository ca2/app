...
CLASS_DECL_AQUA datetime::value operator + (const datetime::value & val1, const datetime::value & val2);
CLASS_DECL_AQUA datetime::value operator - (const datetime::value & val1, const datetime::value & val2);
CLASS_DECL_AQUA datetime::value operator * (const datetime::value & val1, double d);
CLASS_DECL_AQUA datetime::value operator / (const datetime::value & val1, double d);
