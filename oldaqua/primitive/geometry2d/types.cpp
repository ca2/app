...
//
//
//CLASS_DECL_AQUA bool null_intersect_rect(RECT * prect,const rect & rect1,const rect & rect2)
//{
//
...
//
//
//CLASS_DECL_AQUA bool top_left_null_intersect_rect(RECT * prect,const rect & rect1,const rect & rect2)
//
//{
...
//
//
//CLASS_DECL_AQUA double width(const ::rectd & rect)
//
//{
...
//}
//
//CLASS_DECL_AQUA double height(const ::rectd & rect)
//
//{
...
//
//
//CLASS_DECL_AQUA bool deflate(RECT * prect, const ::rect & rect)
//
//{
...
//
//
//CLASS_DECL_AQUA bool copy(POINT64 * pptDst,const point & pointSrc)
//
//{
//
//   pptDst->x = lpptSrc->x;
...
//
//
//CLASS_DECL_AQUA bool copy(LPPOINT pptDst,const POINT64 * lpptSrc)
//
//{
//
