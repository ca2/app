...
CLASS_DECL_AQUA i64 ceil_div(i64 num, i64 den);


CLASS_DECL_AQUA double tri(double angle);
...
CLASS_DECL_AQUA int ccvt_dup(char * buf,int nchar, double arg, int ndigits,int *decpt,int *sign,int eflag);
CLASS_DECL_AQUA int ecvt_dup(char * buf,int nchar, double arg, int ndigits,int *decpt,int *sign);
CLASS_DECL_AQUA int fcvt_dup(char * buf,int nchar, double arg, int ndigits,int *decpt,int *sign);
CLASS_DECL_AQUA int gcvt_dup(char * buf,int nchar, double arg, int ndigits);
CLASS_DECL_AQUA int max_cvt_dup(char *buf,int nchar,double arg,int ndigits,int *decpt,int *sign, int * pi);
...
namespace degree
{
   ...
   inline CLASS_DECL_AQUA double to_radian(double dAngleDegrees)
   {
   ...
   inline CLASS_DECL_AQUA double sin(double dAngleDegrees)
   {
   ...
   inline CLASS_DECL_AQUA double cos(double dAngleDegrees)
   {
   ...
   inline CLASS_DECL_AQUA double tan(double dAngleDegrees)
   {
