...
//#ifdef WINDOWS
DEFINE_UNIT(CLASS_DECL_AQUA,lock_duration,u32)
DEFINE_UNIT(CLASS_DECL_AQUA,tick_duration,u32)
//#endif

//DEFINE_C_NUMBER(CLASS_DECL_AQUA, filesize        , u64)
//DEFINE_C_NUMBER(CLASS_DECL_AQUA, filesize    , u64)
//DEFINE_C_NUMBER(CLASS_DECL_AQUA, filesize      ,  i64)
...
namespace numeric_info_internal
{
   ...
   template < typename T >
   class CLASS_DECL_AQUA numeric_info < ::c_number < T > > :
