#include "framework.h"
#include <time.h>
//#include "aqua/primitive/math/prime100k.h"
#ifdef LINUX
...
namespace aqua
{
   ...
   namespace papaya
   {
      ...
      i32 CLASS_DECL_AQUA time_seed();

      void CLASS_DECL_AQUA srand();
...
CLASS_DECL_AQUA void generate_random_bytes(void * p, memsize s)
{
...
CLASS_DECL_AQUA void generate_random_alphanumeric(void * p, memsize s)
{
...
CLASS_DECL_AQUA void transform_alphanumeric(void * p, memsize s)
{
