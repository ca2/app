...
index_biunique::index_biunique(::object * pobject) :
   biunique < index >(pobject)
{
}

int_biunique::int_biunique(::object * pobject) :
...
CLASS_DECL_AQUA index array_translate_a(index_biunique & ia, index aNew, index aOld)
{
...
CLASS_DECL_AQUA index_array array_translate_a_array(index_biunique & ia, index_array iaNew, index_array iaOld)
{
