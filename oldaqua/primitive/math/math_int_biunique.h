...
biunique < T, T_to_T > ::biunique(::object * pobject) :
   ::object(pobject)
{
   m_bBiunivoca = true;
   m_iEmptyA = -1;
...
class CLASS_DECL_AQUA index_biunique :
...
public:
   ...
   index_biunique(::object * pobject = nullptr);
   virtual ~index_biunique() {}
};

class CLASS_DECL_AQUA int_biunique :
...
public:
   ...
   int_biunique(::object * pobject = nullptr);
