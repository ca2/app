...
#include "aqua/primitive/comparison/equals.h"
...
inline type::type(const ::generic_object * pobject)
{

   m_strName = typeid(*(generic_object *)pobject).name();
...
#include "aqua/primitive/primitive/trait_pred.h"
...
inline CLASS_DECL_AQUA id id::operator + (const id & id) const
{
...
inline string CLASS_DECL_AQUA operator + (const char * psz, const ::id & id)
{
...
inline string CLASS_DECL_AQUA operator + (const char * psz, const var & var)
{
...
inline ::estatus object::__compose(__composite(BASE_TYPE) & pbase, const SOURCE * psource)
{
...
template < typename BASE_TYPE, typename SOURCE >
inline ::estatus object::__compose(__composite(BASE_TYPE) & pbase, const __pointer(SOURCE) & psource)
{
...
template < typename BASE_TYPE >
inline ::estatus object::__release(__composite(BASE_TYPE) & pcomposite)
{
...
template < typename BASE_TYPE >
inline ::estatus object::__release(__reference(BASE_TYPE) & preference)
{
...
inline ::estatus object::release_reference(__pointer(SOURCE) & psource)
{
...
CLASS_DECL_AQUA void object_on_add_composite(const generic_object * pbase);


template < typename BASE_TYPE >
inline ::estatus object::add_composite(__composite(BASE_TYPE) & pcomposite)
{
...
template < typename BASE_TYPE, typename SOURCE >
inline ::estatus object::__refer(__reference(BASE_TYPE) & preference, const __pointer(SOURCE) & psource, const char* pszObjRefDbg)
{
...
template < typename BASE_TYPE, typename SOURCE >
inline ::estatus object::__refer(__reference(BASE_TYPE) & preference, const ::primitive::member < SOURCE > & pmember, const char* pszObjRefDbg)
{
...
template < typename BASE_TYPE, typename SOURCE >
inline ::estatus object::__refer(__reference(BASE_TYPE) & preference, const SOURCE * psource, const char* pszObjRefDbg)
{
...
template < typename SOURCE >
inline ::estatus object::add_reference(__pointer(SOURCE) & psource)
{
...
template < typename SOURCE >
inline ::estatus object::add_reference(__reference(SOURCE) & preference)
{
...
inline ::estatus object::add_reference(SOURCE * psource)
{
   ...
   __pointer(::generic_object) pobject;
   ...
   return add_reference((::generic_object *) pobject.m_p);
...
inline void object::defer_set_context_object(::object * pobjectContext)
{
...
inline ::estatus context::load_from_file(::generic_object* pobject, const ::var& varFile, const var* pvarOptions)
{
...
inline ::estatus context::load_from_file(::generic_object* pobject, const ::var& varFile)
{
...
inline ::estatus context::save_to_file(const ::var& varFile, const var* pvarOptions, const ::generic_object * pobject)
{
...
inline ::estatus context::save_to_file(const ::var& varFile, const ::generic_object* pobject)
{
...
inline i64 generic_object::add_ref(OBJ_REF_DBG_PARAMS_DEF)
{
...
inline i64 generic_object::dec_ref(OBJ_REF_DBG_PARAMS_DEF)
{
...
inline i64 generic_object::release(OBJ_REF_DBG_PARAMS_DEF)
{
