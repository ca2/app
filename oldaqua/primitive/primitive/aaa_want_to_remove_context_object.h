...
inline ::object * trace_object(::context_object * pobjectContext) { return pobjectContext; }


using eobject = cflag < ::e_object >;


struct CLASS_DECL_AQUA context_object :
   virtual public context_object
{
   ...
   ::sticker *                            m_psticker;
   ::object *                             get_object(); // Context Object
   ::aqua::application *                  get_context_application(); // Context Application
   ::eobject                              m_eobject;
   //::id                                   m_id;
   __pointer(__pointer_array(::context_object))     m_preferencea;


   context_object() : get_object()(nullptr), get_context_application()(nullptr), m_psticker(nullptr) { }
   context_object(::object * pobjectContext);
   ...
   ::aqua::application * get_context_application() const { return get_context_application(); }

   ::object * get_context_object() const { return get_object(); }

   inline void set_context_object(::object * pobjectContext)
   {
   ...
   inline ::object * context_trace_object() const { return (::context_object *)this; }
   ...
   virtual void __tracea(context_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, int iLine, const char * psz);
   virtual void __tracef(context_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, ...);
   virtual void __tracev(context_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, va_list args);


   virtual e_trace_category trace_category(context_object * pcontext);
   virtual e_trace_category trace_category();




   virtual __pointer(::context_object) clone() const;
...
//   virtual string to_string() const;
   ...
   ::context_object & operator = (const var & var);
   ...
   static u32 s_thread_proc(void * p)
   {
      ...
      __pointer(context_object) pdata(p);
