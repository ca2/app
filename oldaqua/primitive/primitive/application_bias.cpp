...
//    SCAST_PTR(::aqua::application_message, papplicationsignal, pmessage);
...
// void application_bias::callback::on_application_bias_callback_signal(::aqua::application_message * papplicationsignal)
// {
