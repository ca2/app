...
namespace factory
{
   ...
   class CLASS_DECL_AQUA factory_interface :
   ...
   CLASS_DECL_AQUA extern factory_array * g_pfactorya;
   CLASS_DECL_AQUA extern critical_section * g_pcsFactory;
   CLASS_DECL_AQUA extern factory_map * g_pfactorymap;


   CLASS_DECL_AQUA void factory_init();

   CLASS_DECL_AQUA void factory_close();

   CLASS_DECL_AQUA void factory_term();
