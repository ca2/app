...
class CLASS_DECL_AQUA generic_object
{
public:
   ...
   ::eobject               m_eobject;
   ::object *              m_pobjectContext;


#if OBJ_REF_DBG
   inline generic_object() : m_pobjectContext(nullptr), m_pobjrefdbg(nullptr), m_countReference(0) { add_ref(OBJ_REF_DBG_THIS OBJ_REF_DBG_ADD_NOTE("Initial Reference")); }
   inline generic_object(const eobject& eobject) : m_pobjectContext(nullptr), m_pobjrefdbg(nullptr), m_countReference(0), m_eobject(eobject) { add_ref(OBJ_REF_DBG_THIS OBJ_REF_DBG_ADD_NOTE("Initial Reference (2)")); }
#else
   inline generic_object() : m_pobjectContext(nullptr), m_countReference(1) { }
   inline generic_object(const eobject & eobject) : m_pobjectContext(nullptr),m_countReference(1), m_eobject(eobject) { }
#endif
   ...
   void add_ref_history(generic_object* p, const char* pszObjRefDbg);
   void dec_ref_history(generic_object* p, const char* pszObjRefDbgNotUsedCurrently);
   void check_pending_releases();

#endif

   inline object* get_context_object() const { return m_pobjectContext; }
   virtual void set_context_object(::object* pobjectContext);
   ...
   virtual ::estatus add_composite(::generic_object* pobject);
   virtual ::estatus add_reference(::generic_object* pobject);


   virtual ::estatus release_composite(::generic_object* pobject);
   virtual ::estatus release_reference(::generic_object* pobject);
   ...
   inline ::generic_object * context_trace_object() const { return (::generic_object *)this; }

   virtual void __tracea(generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, int iLine, const char * psz);
   virtual void __tracef(generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, ...);
   virtual void __tracev(generic_object * pobject, e_trace_level elevel, const char * pszFunction, const char * pszFile, i32 iLine, const char * pszFormat, va_list args);

   virtual e_trace_category trace_category(generic_object * pcontext);
