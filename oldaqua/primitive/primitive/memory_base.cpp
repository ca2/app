...
namespace papaya
{
   ...
   CLASS_DECL_AQUA void transfer_to(::file::file * pfileOut, memory_base & mem, memsize uiBufferSize)
   {
   ...
   CLASS_DECL_AQUA void transfer_from_begin(::file::file * pfileIn, memory_base & mem, memsize uiBufferSize)
   {
   ...
   CLASS_DECL_AQUA void transfer_from(::file::file * pfileIn, memory_base & mem, memsize uiBufferSize)
   {
...
CLASS_DECL_AQUA stream & operator << (stream & stream, memory_container & memcontainer)
{
...
//CLASS_DECL_AQUA stream & operator << (stream & stream, memory_base & mem)
//{
//
