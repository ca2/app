...
//::user::document* object::open_new_document(::aqua::application* pappOnBehalfOf)
//{
//
...
//::user::document* object::open_document_file(::aqua::application* pappOnBehalfOf)
//{
//
...
//::user::document* object::open_document_file(::aqua::application* pappOnBehalfOf, const var& varFile, const ::var & varOptions, ::user::interaction* puiParent, ewindowflag eflag, ::id id)
//{
//
...
//::user::document* object::open_document_file(::aqua::application* pappOnBehalfOf, const var& varFile)
//{
//
...
void object::set_finish()
{
   ...
   else if (strTypeName == "aqua::system")
   {

      output_debug_string("aqua::system::set_finish");
...
CLASS_DECL_AQUA ::estatus __call(::generic_object * pobjectTask)
{
...
void object::set_context_app(::aqua::application* pappContext)
{
...
void object::set_context_session(::aqua::session* psessionContext)
{
...
void object::set_context_system(::aqua::system* psystemContext)
{
