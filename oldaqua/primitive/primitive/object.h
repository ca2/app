...
protected:
   ...
   __pointer(::aqua::application)                     m_pappContext;
   __pointer(::aqua::session)                         m_psessionContext;
   __pointer(::aqua::system)                          m_psystemContext;
...
public:
   ...
   inline ::aqua::application * get_context_application() { return m_pappContext.m_p; }
   ...
   ::aqua::application * get_context_application() const { return m_pappContext; }

   ::aqua::session * get_context_session() const { return m_psessionContext; }

   ::aqua::system * get_context_system() const { return m_psystemContext; }

   //::object * get_context_user() const { return m_puserContext; }

   ::aqua::application * get_app() const { return get_context_application(); }
   ...
   virtual void set_context_app(::aqua::application* pappContext);
   virtual void set_context_session(::aqua::session* psessionContext);
   virtual void set_context_system(::aqua::system* psystemContext);
   ...
   inline void set_context_app(::aqua::application* pappContext);
   inline void set_context_session(::aqua::session* psessionContext);
   inline void set_context_system(::aqua::system* psystemContext);
   ...
   //// former user::server
   //virtual ::user::document* open_new_document(::aqua::application* pappOnBehalfOf);
   virtual void on_request(::create* pcreate);
   //virtual ::user::document* open_document_file(::aqua::application* pappOnBehalfOf);
   //virtual ::user::document* open_document_file(::aqua::application* pappOnBehalfOf, const var& varFile, const var & varOptions, ::user::interaction* puiParent = nullptr, ewindowflag eflag = window_flag_none, ::id id = ::id());
   //virtual ::user::document* open_document_file(::aqua::application* pappOnBehalfOf, const var& varFile);
...
CLASS_DECL_AQUA ::estatus call_sync(const runnable_array & runnablea);
