...
class CLASS_DECL_AQUA procedure :
   public function_base
{
public:


   procedure(const ::id& id = ::id(), ::generic_object* p = nullptr) : function_base(id, p) {}
   ...
   procedure(const ::id& id, PRED pred, ::generic_object* pobjectHold = nullptr);
   template < typename PRED >
   procedure(PRED pred, ::generic_object* pobjectHold = nullptr);
...
public:
   ...
   procedure_template(::generic_object* p = nullptr) : ::procedure(m_idObject, p) {}
   ...
   template < typename PRED >
   procedure_template(PRED pred, ::generic_object* pobjectHold = nullptr) : ::procedure(pred, pobjectHold) { }
