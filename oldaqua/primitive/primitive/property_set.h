...
class CLASS_DECL_AQUA property_set :
...
CLASS_DECL_AQUA void property_set_skip_json(const char *& pszJson);
CLASS_DECL_AQUA void property_set_skip_json(const char *& pszJson, const char * pszEnd);
...
//
   ...
   //class CLASS_DECL_AQUA localini :
   //   public ini
   //{
   //public:
