...
////} // namespace papaya
//
//typedef CLASS_DECL_AQUA __pointer(::context_object) context_object_pointer;
//
//typedef CLASS_DECL_AQUA __pointer_array(::context_object) context_object_pointera;
//
//enum e_notify
//{
//  
