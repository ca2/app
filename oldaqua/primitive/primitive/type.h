...
CLASS_DECL_AQUA bool demangle(string & str, const char * psz);
CLASS_DECL_AQUA bool demangle(string & str);

namespace str
{


   CLASS_DECL_AQUA string demangle(const char * psz);


} // namespace str


class CLASS_DECL_AQUA type
{
public:
...
inline CLASS_DECL_AQUA string get_demangle(const char * lpszName)
{
