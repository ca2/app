...
//   var & operator = (const string_composite & reference);
   ...
   friend bool CLASS_DECL_AQUA strict_equal(const char * psz,const var & var);
   friend bool CLASS_DECL_AQUA strict_equal(const string & str,const var & var);
   friend bool CLASS_DECL_AQUA strict_equal(double d,const var & var);
   friend bool CLASS_DECL_AQUA strict_equal(::i32 i,const var & var);
   friend bool CLASS_DECL_AQUA strict_equal(bool b,const var & var);

   friend bool CLASS_DECL_AQUA strict_different(const char * psz,const var & var);
   friend bool CLASS_DECL_AQUA strict_different(const string & str,const var & var);
   friend bool CLASS_DECL_AQUA strict_different(double d,const var & var);
   friend bool CLASS_DECL_AQUA strict_different(::i32 i,const var & var);
   friend bool CLASS_DECL_AQUA strict_different(bool b,const var & var);
   ...
   friend var CLASS_DECL_AQUA operator - (::i32 i,const var & var);
   friend var CLASS_DECL_AQUA operator - (::u32 ui,const var & var);
   friend var CLASS_DECL_AQUA operator - (::i64 l,const var & var);
   friend var CLASS_DECL_AQUA operator - (::u64 ul,const var & var);
   friend var CLASS_DECL_AQUA operator - (double d,const var & var);
   friend var CLASS_DECL_AQUA operator - (const var & var1,const var & var2);
...
namespace str
{
   ...
   inline CLASS_DECL_AQUA void from(string & str, const var & var)
   {
...
CLASS_DECL_AQUA void var_skip_number(const char *& psz);
CLASS_DECL_AQUA void var_skip_number(const char *& psz, const char * pszEnd);
CLASS_DECL_AQUA void var_skip_identifier(const char *& psz);
CLASS_DECL_AQUA void var_skip_identifier(const char *& psz, const char * pszEnd);
CLASS_DECL_AQUA void var_skip_json(const char *& pszJson);
CLASS_DECL_AQUA void var_skip_json(const char *& pszJson, const char * pszEnd);
