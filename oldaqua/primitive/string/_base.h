...
//
   ...
   bool load_string(::object* pobject, id id);
...
inline string CLASS_DECL_AQUA operator + (const char * psz, const ::string & str);
inline string CLASS_DECL_AQUA operator + (ansichar ansich, const ::string & str);
inline string CLASS_DECL_AQUA operator + (wd16char wd16ch, const ::string & str);
inline string CLASS_DECL_AQUA operator + (wd16char wd32ch, const ::string & str);
