...
//CLASS_DECL_AQUA const char* yoshi_strcat(const char* psz1, const char* psz2, bool bFree2 = false);
...
const char* wildcard_next_stop(const char* pszCriteria)
{
   ...
   CLASS_DECL_AQUA int_bool matches_wildcard_criteria_dup(const char* pszCriteriaParam, const char* pszValue)
   {
   ...
   CLASS_DECL_AQUA int_bool matches_wildcard_criteria_ci(const ansichar * pszCriteriaParam, const ansichar * pszValue)
   {
   ...
   CLASS_DECL_AQUA int_bool matches_wildcard_criteria(const ansichar * pszCriteriaParam, const ansichar * pszValue)
   {
   ...
   //CLASS_DECL_AQUA const char* ansi_concatenate_and_duplicate(const char* psz1, const char* psz2)
   //{
   ...
   //CLASS_DECL_AQUA const char* strcat_and_dup2(const char* psz1, const char* psz2)
   //{
