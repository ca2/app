...
inline i32                    __ansicharisalphabetic(i32 i);
inline i32                    __ansicharisalphanumeric(i32 i);
...
CLASS_DECL_AQUA ansichar * __u64toansi(::u64 u, ansichar * buf, int iBase);

CLASS_DECL_AQUA ansichar * __i64toansi(::i64 u, ansichar * buf, int iBase);
...
inline int __ansincoll(const ansichar * psz1, const ansichar * psz2, size_t s);

inline int __ansiicoll(const ansichar * psz1, const ansichar * psz2);

inline int __ansinicoll(const ansichar * psz1, const ansichar * psz2, size_t s);
...
CLASS_DECL_AQUA i64 __ansitoi64(const ansichar * psz, ansichar ** ppszEnd, i32 iBase);
CLASS_DECL_AQUA u64 __ansitou64(const ansichar * psz, ansichar ** ppszEnd, i32 iBase);
CLASS_DECL_AQUA i32 __ansitoi32(const ansichar * psz, ansichar ** ppszEnd, i32 iBase);
CLASS_DECL_AQUA u32 __ansitou32(const ansichar * psz, ansichar ** ppszEnd, i32 iBase);
