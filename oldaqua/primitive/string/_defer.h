...
//inline CLASS_DECL_AQUA string operator + (const tostring < TYPE1 > & tostring1, const tostring < TYPE2 > & tostring2) { return __str(tostring1) + __str(tostring2); }


//template < typename TYPE >
//inline CLASS_DECL_AQUA string operator + (const string & str, const tostring < TYPE > & tostring) { return str + __str(tostring); }


//template < typename TYPE >
//inline CLASS_DECL_AQUA string operator + (const tostring < TYPE > & tostring, const string & str) { return __str(tostring) + str; }


//template < typename TYPE >
//inline CLASS_DECL_AQUA wstring operator + (const wstring & wstr, const tostring < TYPE > & o) { return wstr + wstring(o); }


//template < typename TYPE >
//inline CLASS_DECL_AQUA wstring operator + (const tostring < TYPE > & o, const wstring & wstr) { return wstring(o) + wstr; }


//template < typename TYPE >
//inline CLASS_DECL_AQUA string operator + (const tostring < TYPE > & tostring, const char * p) { return __str(tostring) + p; }


//template < typename TYPE >
//inline CLASS_DECL_AQUA string operator + (const char * p, const tostring < TYPE > & tostring) { return p + __str(tostring); }


//template < typename TYPE >
//inline CLASS_DECL_AQUA string operator + (const tostring < TYPE > & tostring, const wchar_t * p) { return __str(tostring) + string(p); }


//template < typename TYPE >
//inline CLASS_DECL_AQUA wstring operator + (const wchar_t * p, const tostring < TYPE > & tostring) { return wstring(p) + wstring(__str(tostring)); }
...
namespace hex
{
   ...
   inline CLASS_DECL_AQUA i32 to(char ch)
   {
