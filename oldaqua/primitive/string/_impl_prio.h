...
CLASS_DECL_AQUA i64 strtoi(const widechar * psz);
...
inline ::ansistring CLASS_DECL_AQUA operator + (ansichar ansich, const ::ansistring & str2)
{
...
inline ::ansistring CLASS_DECL_AQUA operator + (wd16char wd16ch, const ::ansistring & str)
{
...
inline ::ansistring CLASS_DECL_AQUA operator + (wd32char wd32ch, const ::ansistring & str)
{
