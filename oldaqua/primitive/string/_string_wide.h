...
#include "aqua/primitive/primitive/memory_c.h"
...
CLASS_DECL_AQUA wstring gen_utf8_to_16(const char * psz);



//class CLASS_DECL_AQUA wstring :
//   public wstring
//{
//public:
//
...
template < typename TYPE >
inline CLASS_DECL_AQUA wstring operator + (const wstring & wstr, const tostring < TYPE > & o);

template < typename TYPE >
inline CLASS_DECL_AQUA wstring operator + (const tostring < TYPE > & o, const wstring & wstr);
