...
CLASS_DECL_AQUA wstring wd32_to_wd16_str(const wd32char * pcwsz, strsize input_size = -1);

#endif

CLASS_DECL_AQUA string wd16_to_ansi_str(const wd16char * pwsz, strsize srclen = -1);

CLASS_DECL_AQUA string wd32_to_ansi_str(const wd32char * pwsz, strsize srclen = -1);
