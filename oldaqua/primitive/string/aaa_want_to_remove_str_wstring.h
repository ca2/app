...
CLASS_DECL_AQUA wstring operator + (const wstring & wstr1, const wstring & wstr2);
CLASS_DECL_AQUA wstring operator + (const wstring & str, const unichar * psz);
CLASS_DECL_AQUA wstring operator + (const unichar * psz, const wstring & str);


CLASS_DECL_AQUA wstring gen_utf8_to_16(const char * psz);


//class CLASS_DECL_AQUA wstring_data
//{
//protected:
//
//
