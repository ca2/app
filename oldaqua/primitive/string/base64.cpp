...
CLASS_DECL_AQUA char* _crypto_base64_encode(const BYTE* data, int length)
{
   int c;
   const BYTE* q;
   char* point;
...
CLASS_DECL_AQUA void _crypto_base64_decode(const char* enc_data, int length, BYTE** dec_data, int* res_length)
{
