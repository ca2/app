...
// (0x0360 - 0x037F are reserved for aqua API)
...
//  some versions of Windows.  To remain compatible, aqua API does not
//  use messages in that range.
#define WM_RESERVED_0370    0x0370
#define WM_RESERVED_0371    0x0371
#define WM_RESERVED_0372    0x0372

// WM_SOCKET_NOTIFY and WM_SOCKET_DEAD are used internally by aqua API's
...
// Note: Messages 0x037C - 0x37E reserved for future aqua API use.
#define WM_RESERVED_037C    0x037C
#define WM_RESERVED_037D    0x037D
#define WM_RESERVED_037E    0x037E

// WM_FORWARDMSG - used by aqua to forward a message to another interaction_impl for processing
...
{ message,0,0,0,::aqua::Sig_vv,\
   (__PMSG)(__PMSGW)(void (__MSG_CALLwindow::*)())&memberFxn },


#include "platform/drawable.h"
#include "aqua/user/check.h"
#include "aqua/user/text.h"
#include "aqua/user/window_state.h"
#include "aqua/user/callback.h"
#include "aqua/user/primitive.h"

#include "aqua/user/style_base.h"
#include "aqua/user/style.h"
