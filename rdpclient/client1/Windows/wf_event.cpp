...
void wf_sizing(wfContext* wfc, WPARAM wParam, LPARAM lParam)
{
	...
	{
		rectangle = (::i32_rectangle *) wParam;
		...
		switch(lParam)
		{
			...
			case WMSZ_BOTTOMRIGHT:
				// Adjust height
				i32_rectangle->bottom = i32_rectangle->top + wfc->height * (i32_rectangle->right - i32_rectangle->left) / wfc->instance->settings->DesktopWidth;
				break;
			...
			case WMSZ_TOPRIGHT:			
				// Adjust width
				i32_rectangle->right = i32_rectangle->left + wfc->width * (i32_rectangle->bottom - i32_rectangle->top) / wfc->instance->settings->DesktopHeight;
				break;

			case WMSZ_BOTTOMLEFT:
			case WMSZ_TOPLEFT:
				// adjust width
				i32_rectangle->left = i32_rectangle->right - (wfc->width * (i32_rectangle->bottom - i32_rectangle->top) / wfc->instance->settings->DesktopHeight);
...
//				else
//				{
//					// Set maximum window i32_size for resizing
//
...
//					// i32_rectangle of pixels that were invalidated.) 
//					ScrollWindowEx(wfc->hwnd, -xDelta, -yDelta, (const ::i32_rectangle *) nullptr,
//						(const ::i32_rectangle *) nullptr, (HRGN) nullptr, (PRECT) nullptr,
//						SW_INVALIDATE); 
