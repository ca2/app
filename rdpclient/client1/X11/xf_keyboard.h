...
void xf_keyboard_key_press(xfContext* xfc, ::u8 keycode, KeySym keysym);
void xf_keyboard_key_release(xfContext* xfc, ::u8 keycode);
void xf_keyboard_release_all_keypress(xfContext* xfc);
BOOL xf_keyboard_key_pressed(xfContext* xfc, KeySym keysym);
void xf_keyboard_send_key(xfContext* xfc, BOOL down, ::u8 keycode);
::i32 xf_keyboard_read_keyboard_state(xfContext* xfc);
BOOL xf_keyboard_get_key_state(xfContext* xfc, ::i32 state, ::i32 keysym);
