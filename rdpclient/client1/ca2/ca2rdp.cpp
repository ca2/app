...
{
   if(pcontext->m_pcontext->ca2rdpi == nullptr)
      return nullptr;
   return ::draw2d::image_get_graphics(pcontext->m_pcontext->ca2rdpi->surface);
...
{
//#ifdef _WIN32
//   if(pcontext->m_pcontext->primary == nullptr)
//      return nullptr;
//   return (color32_t *) pcontext->m_pcontext->primary->pdata;
//#else
   if(pcontext->m_pcontext->gdi == nullptr)
      return nullptr;
   /*   if(pcontext->m_pcontext->gdi->drawing == nullptr)
         return nullptr;
      if(pcontext->m_pcontext->gdi->drawing->bitmap == nullptr)
         return nullptr;
      return (color32_t *)pcontext->m_pcontext->gdi->drawing->bitmap->p*/
   return (color32_t *)pcontext->m_pcontext->gdi->primary_buffer;
   ;
//#endif
}
...
int ca2rdp_ctx_get_bitmap_size(ca2rdp_context * pcontext)
{
   ...
   return nullptr;
   return (color32_t *)pcontext->m_pcontext->gdi->drawing->bitmap->p*/
   return pcontext->m_pcontext->gdi->bitmap_size;
   ;
}
