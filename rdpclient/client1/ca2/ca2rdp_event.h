...
CLASS_DECL_AXIS_RDPCLIENT void ca2rdp_queue_event(void * input,int bKey, int down, ::u32 scancode, const ::atom & atom,::int_point pt);
CLASS_DECL_AXIS_RDPCLIENT int  ca2rdp_get_event(rdp_event_item & item,void * input);
CLASS_DECL_AXIS_RDPCLIENT void ca2rdp_send_event(void * input,int bKey,int down,::u32 scancode,const ::atom & atom,::int_point pt);
