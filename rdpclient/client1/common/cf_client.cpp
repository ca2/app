...
//   wfc->instance = instance;
   ...
   *        otherwise the screen will crash when connecting to an XP desktop.*/
   ...
   ///freerdp_set_param_uint32(settings,FreeRDP_KeyboardLayout,(::i32)GetKeyboardLayout(0) & 0x0000FFFF);
...
//		{
//			wfc->tile = af_image_new(wfc, 64, 64, 32, nullptr);
//		}
//	}
//
...
//}
//
//BOOL af_verify_certificate(freerdp* instance, char_pointer topic, char_pointer issuer, char_pointer fingerprint)
//{
//#if 0
//	::u32 mode;
//	::i32 read_size;
...
////
////	wfc->keyboardThread = CreateThread(nullptr, 0, af_keyboard_thread, (void*) wfc, 0, &wfc->keyboardThreadId);
////
...
////
////	wfc->thread = CreateThread(nullptr, 0, af_client_thread, (void*) instance, 0, &wfc->mainThreadId);
////
////	if (!wfc->thread)
////		return -1;
////
