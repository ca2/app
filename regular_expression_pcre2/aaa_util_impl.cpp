...
__pointer(::strsize_range_array) pcre_util_impl::matches_ranges(const string& str)
{
...
__pointer(::strsize_range_array) pcre_util_impl::matches_ranges(const ::string & psz, strsize len)
{
