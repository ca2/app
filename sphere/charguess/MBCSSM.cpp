...
static const PR::u32 Big5CharLenTable[] = {0, 1, 1, 2, 0};
...
static const PR::u32 EUCJPCharLenTable[] = {2, 2, 2, 3, 1, 0};
...
static const PR::u32 EUCKRCharLenTable[] = {0, 1, 2, 0};
...
static const PR::u32 EUCTWCharLenTable[] = {0, 0, 1, 2, 2, 2, 3};
...
static PR::u32 GB2312_cls [ 256 / 8 ] = {
//PCK4BITS(0,1,1,1,1,1,1,1),  // 00 - 07 
PCK4BITS(1,1,1,1,1,1,1,1),  // 00 - 07 
PCK4BITS(1,1,1,1,1,1,0,0),  // 08 - 0f 
PCK4BITS(1,1,1,1,1,1,1,1),  // 10 - 17 
...
static PR::u32 GB2312_st [ 2] = {
PCK4BITS(eError,eStart,     3,eError,eError,eError,eError,eError),//00-07 
PCK4BITS(eItsMe,eItsMe,eItsMe,eItsMe,eError,eError,eStart,eStart) //08-0f 
};

static const PR::u32 GB2312CharLenTable[] = {0, 1, 2, 0};
...
static PR::u32 GB18030_cls [ 256 / 8 ] = {
PCK4BITS(1,1,1,1,1,1,1,1),  // 00 - 07 
PCK4BITS(1,1,1,1,1,1,0,0),  // 08 - 0f 
PCK4BITS(1,1,1,1,1,1,1,1),  // 10 - 17 
PCK4BITS(1,1,1,0,1,1,1,1),  // 18 - 1f 
...
// 2 here. 
static const PR::u32 GB18030CharLenTable[] = {0, 1, 1, 1, 1, 1, 2};
...
static PR::u32 SJIS_st [ 3] = {
PCK4BITS(eError,eStart,eStart,     3,eError,eError,eError,eError),//00-07 
PCK4BITS(eError,eError,eError,eError,eItsMe,eItsMe,eItsMe,eItsMe),//08-0f 
PCK4BITS(eItsMe,eItsMe,eError,eError,eStart,eStart,eStart,eStart) //10-17 
};

static const PR::u32 SJISCharLenTable[] = {0, 1, 1, 2, 0, 0};
...
static PR::u32 UCS2BE_cls [ 256 / 8 ] = {
...
static const PR::u32 UCS2BECharLenTable[] = {2, 2, 2, 0, 2, 2};
...
static PR::u32 UCS2LE_cls [ 256 / 8 ] = {
PCK4BITS(0,0,0,0,0,0,0,0),  // 00 - 07 
PCK4BITS(0,0,1,0,0,2,0,0),  // 08 - 0f 
PCK4BITS(0,0,0,0,0,0,0,0),  // 10 - 17 
PCK4BITS(0,0,0,3,0,0,0,0),  // 18 - 1f 
...
static const PR::u32 UCS2LECharLenTable[] = {2, 2, 2, 2, 2, 2};
...
static const PR::u32 UTF8CharLenTable[] = {0, 1, 0, 0, 0, 0, 2, 3,
                            3, 3, 4, 4, 5, 5, 6, 6 };
