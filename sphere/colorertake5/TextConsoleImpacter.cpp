...
text_console_impacter::~text_console_impacter(){};
...
INPUT_RECORD ir;
  ...
  CHAR_INFO *buffer = __new_array< CHAR_INFO >(csbi.dwSize.X * csbi.dwSize.Y);
  ...
  do{
    ...
    do{
      ...
      if (ir.EventType == WINDOW_BUFFER_SIZE_EVENT){
        GetConsoleScreenBufferInfo(hCon, &csbi);
        delete[] buffer;
        buffer = __new_array< CHAR_INFO >(csbi.dwSize.X * csbi.dwSize.Y);
        break;
      };
