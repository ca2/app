...
namespace colorertake5
{
   ...
   */
   ...
   public:
      ...
      */
      void resize(::collection::count lineCount);
   ...
   protected:
      ...
      */
      ...
      ::collection::index getLineIndex(index lno) const;
      bool checkLine(::collection::index index) const;
