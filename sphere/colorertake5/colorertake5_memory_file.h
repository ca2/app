...
uptr ZCALLBACK mem_read_file_func (voidpf opaque, voidpf stream, void *buf, uptr this->get_size){
...
uptr ZCALLBACK mem_write_file_func (voidpf opaque, voidpf stream, const void *buf, uptr this->get_size)
{
  MemoryFile *mf = (MemoryFile*)opaque;
  return 0;
}
