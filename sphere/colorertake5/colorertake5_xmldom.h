...
namespace colorertak5
{
   ...
   public:
     ...
     ParseException(const string &msg, i32 line, i32 pos)
     {
       ...
       if (line > -1)
       {
          message += " at line: " + __str(line);
       }
       if (pos > -1)
       {
          message += ", pos: " + __str(pos);
       }
     };
   protected:
   };
...
//     Hashtable<const string*> entitiesHash;
  //   Hashtable<const string*> extEntitiesHash;
   ...
   protected:
     ...
     Document() : xml::node(xml::node::DOCUMENT_NODE, new string("#document")), documentElement(nullptr) {};
   ...
   protected:
     ...
     CharacterData(i32 type, const string *_data): xml::node(type, new string("#cdata")), data(_data) {};
