...
namespace console
{
   ...
   void prompt_impact::install_message_routing(::channel * pchannel)
   {
      ...
      MESSAGE_LINK(::user::e_message_create,pchannel,this,&prompt_impact::on_message_create);
      MESSAGE_LINK(::user::e_message_key_down,pchannel,this,&prompt_impact::on_message_key_down);
      MESSAGE_LINK(::user::e_message_key_up,pchannel,this,&prompt_impact::on_message_key_up);
      MESSAGE_LINK(::user::e_message_show_window,pchannel,this,&prompt_impact::on_message_show_window);
