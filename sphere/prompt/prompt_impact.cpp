...
namespace prompt
{
   ...
   void impact::install_message_routing(::channel * pchannel)
   {
      ...
      MESSAGE_LINK(::user::e_message_right_button_up, pchannel, this, &impact::on_message_right_button_up);
//

      MESSAGE_LINK(MessageOp, pchannel, this, &impact::_001OnOp);
      MESSAGE_LINK(::user::e_message_show_window, pchannel, this, &impact::on_message_show_window);
