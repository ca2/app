...
namespace app_app
{
   ...
   void main_window::_001OnDraw(::draw2d::graphics_pointer & pgraphics)
   {
      ...
      pgraphics->fill_rectangle(::rectangle_f64_dimension(x, y, dBase * 5.0, dBase * 5.0), ::rgba(127, 40, 150, 235));

      pgraphics->fill_rectangle(::rectangle_f64_dimension(x + dBase * 6.0, y, dBase * 5.0, dBase * 5.0), ::rgba(127, 40, 150, 235));
