...
//
 ...
 namespace subsystem
 {
    ...
    class CLASS_DECL_SUBSYSTEM OperatingSystem :
    ...
    //public:
       ...
       // secificatioin.
       virtual ::string getErrStr(const ::scoped_string &scopedstrSpecification) = 0;

       //
       // Sets path to special folder value to out argument.
       //
       // Valid values for specialFolderId argument are:
       //  - OperatingSystem::APPLICATION_DATA_SPECIAL_FOLDER
       //  - OperatingSystem::COMMON_APPLICATION_DATA_SPECIAL_FOLDER
       //
       ...
       virtual ::string getCurrentModuleFolderPath() = 0;
