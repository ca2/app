...
////   */
////  static DWORD getActiveConsoleSessionId(LogWriter *plogwriter);
////
////  /**
...
////  */
////  static DWORD getRdpSessionId(LogWriter *plogwriter);
////
////  /**
////  * @return true if sessionId is the RDP console session id.
////  */
////  static bool SessionIsRdpSession(DWORD sessionId, LogWriter *plogwriter);
////
////  /**
...
////   */
////  static HANDLE queryConsoleUserToken(LogWriter *plogwriter);
////
////  static HANDLE sessionUserToken(DWORD sessionId, LogWriter* plogwriter);
////
////  /**
...
////
////  static ::string getUserName(DWORD sessionId, LogWriter *plogwriter);
////  static ::string getCurrentUserName(LogWriter* plogwriter);
////
////  static bool sessionIsLocked(DWORD sessionId, LogWriter* plogwriter);
////
////  static HANDLE duplicateCurrentProcessUserToken(bool rdpEnabled, LogWriter* plogwriter);
////
////  static HANDLE duplicateUserImpersonationToken(HANDLE token, DWORD sessionId, LogWriter* plogwriter);
////
////  /**
...
////   */
////  static void initialize(LogWriter *plogwriter);
////
