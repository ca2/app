...
namespace subsystem
{
   ...
   class CLASS_DECL_SUBSYSTEM RegistryKey :
   ...
   //public:
      ...
      //
      ::platform::registry_key_interface *get_registry_key() const;
   ...
   //protected:
      ...
      ::pointer<::platform::registry_key_interface> m_pregistrykey;
      // Root registry key (local machine, current user, etc).
      ::pointer<::platform::registry_key_interface> m_pregistrykeyRoot;
      // Registry entry name.
      ::string m_entry;
