...
//#include "subsystem_acme/Screen.h"
...
namespace subsystem_apex
{
   ...
   public:
      ...
      virtual void initialize_dib_section(const ::subsystem_apex::PixelFormat & pf, const ::int_size & dim, const ::operating_system::window & operatingsystemwindow = {}) = 0;
