...
namespace datetime
{
   ...
   namespace calendar
   {
      ...
      void calendar::GetRectDay(::earth::time& time, ::i32_rectangle * lprect)
      {
      ...
      void calendar::GetRectDay(int32_t iWeekDay, int32_t iLine, ::i32_rectangle * lprect)
      {
      ...
      void calendar::set_pos(i32_point point, i32_size sz)
      {
      ...
      bool calendar::time_hit_test(::earth::time& timeRet, const i32_point & point)
      {
