 ...
 */
CLASS_DECL_CA2_TIME HRESULT FloatTimeFromStr(const char * strIn, LCID lcid, unsigned int dwFlags, DATE* pdateOut)
{
...
//xxx    else if (*strIn == ',' || isspaceW(*strIn))
  ...
  if (SUCCEEDED(hRet))
  {
     ...
     * For valid permutations, we set dwOffset to int_point to the first date field
