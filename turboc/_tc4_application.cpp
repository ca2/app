...
namespace tc4
{
   ...
   bool application::initialize_application()
   {
      ...
      this,
      "main",
      ::as_type < ::tc4::document >(),
      ::as_type < ::tc4::frame >(),       // top level SDI frame::windowing::window
      ::as_type < ::tc4::pane_impact >());
   ...
   unsigned int application::thread_proc_load_ai_font(void * pparam)
   {
      ...
      //pimpact->m_iErrorAiFont = FT_New_Face((FT_Library)Sys(pimpact->get_app()).ftlibrary(),Sess(pimpact->get_app()).directory()->matter_file("font/truetype/arialuni.ttf"),0,(FT_Face *)&pimpact->m_faceAi);
...
::acme::library * get_new_library(::particle * pparticle)
{
   ...
   return ___new ::apex::single_application_library < ::tc4::application >  (pparticle, "app-core");
