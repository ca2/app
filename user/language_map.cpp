...
namespace user
{
   ...
   ::estatus language_map::initialize(::object* pobjectContext)
   {
...
/// return selected language in the list
   ...
   bool language_map::set_default_language(::aura::application * papp)
   {
   ...
   bool language_map::set_language(::aura::application * papp, string strLang)
   {
