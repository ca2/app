...
extern void _graphfreemem (void *ptr, unsigned i32_size);
extern void *_graphgetmem (unsigned i32_size);
...
extern void i32_rectangle (int left, int top, int right, int bottom);
